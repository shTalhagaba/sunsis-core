                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                {!! Form::select('grade_1', $grades, null, ['class' => 'form-control gradesSelect']) !!}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                {!! Form::select('grade_2', $grades, null, ['class' => 'form-control gradesSelect']) !!}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <ul>
                                    ...
                                    <li>Consistently shows the ability to differentiate according to learner style and learner additional support needs.</li>
                                    <li> Consistently takes enrichment opportunities into consideration. </li>
                                    <li>Consistent evidence of holistic planning for formative and summative assessment methods required by the AO.</li>
                                </ul>
                            </td>
                            <td>
                                <ul>
                            ...
                            <td>
                                {!! Form::select('grade_3', $grades, null, ['class' => 'form-control gradesSelect']) !!}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <ul>
                                    <li>Assessment of evidence is consistently adhering to ELA's 2-week turnaround policy.</li>
                                    <li>Evidence of the impact of teaching is consistently seen</li>
                                    <li>Learners being stretched and challenged through feedback and assessments is consistent</li>
                                    <li>Evidence of embedding core skills and social responsibilities is consistent</li>
                            ...
                            <td>
                                <ul>
                                    <li>Assessment of evidence is regular, adhering to ELA's 2-week turnaround policy.</li>
                                    <li>Evidence of the impact of teaching is regularly seen</li>
                                    <li>Evidence that learners have been stretched and challenged through feedback and assessments is regularly seen.</li>
                                    <li>Evidence of embedding core skills and social responsibilities is regularly seen </li>
                            ...
                            <td>
                                <ul>
                                    <li>Assessment of evidence is irregular, non-adherence to ELA's 2-week turnaround policy.</li>
                                    <li>Evidence of the impact of teaching is irregular</li>
                                    <li>Evidence that learners have been stretched and challenged through feedback and assessments is irregular.</li>
                                    <li>Evidence of embedding core skills and social responsibilities is irregular </li>
                                    <li>Evidence of learner-centered feedback, based around the 3 I's is irregular</li>
                                    <li>Irregular use of a variety of assessment methods carried out</li>
                                </ul>
                            </td>
                            <td>
                                <ul>
                                    <li>Assessment of evidence is not adhering to ELA's 2-week turnaround policy.</li>
                                    <li>Evidence of the impact of teaching is not seen</li>
                                    <li>Evidence that learners have been stretched and challenged through feedback and assessments is not seen.</li>
                                    <li>Evidence of embedding core skills and social responsibilities is not seen </li>
                                    <li>Evidence of learner-centered feedback, based around the 3 I's is not seen</li>
                                    <li>Variations to assessment methods are not seen</li>
                                </ul>
                            </td>
                            <td>
                                {!! Form::select('grade_4', $grades, null, ['class' => 'form-control gradesSelect']) !!}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                {!! Form::select('grade_5', $grades, null, ['class' => 'form-control gradesSelect']) !!}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <ul>
                                    <li>Consistently few action points on OneFile</li>
                                    <li>No assessment decisions overturned </li>
                                    <li>No actions from audits</li>
                                    <li>Unit summaries by assessor and learner are consistently signed off timely</li>
                                </ul>
                            </td>
                            <td>
                                <ul>
                                    <li>Irregular action points on OneFile</li>
                            ...
                            <td>
                                <ul>
                                    <li>Regular or reoccurring action points on OneFile.</li>
                            ...
                            <td>
                                <ul>
                                    <li>Regular and reoccurring action points on OneFile.</li>
                            ...
                            <td>
                                {!! Form::select('grade_6', $grades, null, ['class' => 'form-control gradesSelect']) !!}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                {!! Form::select('grade_7', $grades, null, ['class' => 'form-control gradesSelect']) !!}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <ul>
                                    <li>Reviews are consistently timely at 8-10 weeks -Reviews are informative (all areas have been covered in detail inc. evidence of employer feedback) </li>
                            ...
                            <td>
                                <ul>
                                    ...
                                    <li>Reviews are informative (some areas have been covered in detail inc. evidence of employer feedback) </li>
                                    <li>Regular progression between reviews</li>
                                </ul>
                            </td>
                            <td>
                                <ul>
                                    <li>Reviews are irregular and failing the contractual requirements of 12 weeks</li>
                            ...
                            <td>
                                <ul>
                                    <li>Reviews are consistently falling behind contractual requirements or not taking place at all</li>
                                    <li> No amendments to CANO planner</li>
                                    <li>Learner not being seen beyond 8 weeks</li>
                                </ul>
                            </td>
                            <td>
                                {!! Form::select('grade_8', $grades, null, ['class' => 'form-control gradesSelect']) !!}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                {!! Form::select('grade_9', $grades, null, ['class' => 'form-control gradesSelect']) !!}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <ul>
                                    <li>Grade 1 - Exceptional Teaching and Learning Practice. Consistently above and beyond requirements</li>
                                </ul>
                            </td>
                            <td>
                                <ul>
                                    <li>Grade 2 - Good quality of Teaching and Learning Practice. Has some exceptional practice</li>
                                </ul>
                            </td>
                            <td>
                                <ul>
                                    <li>Grade 3 - Sufficient Teaching and Learning Practice. Requires areas of improvement</li>
                                </ul>
                            </td>
                            <td>
                                <ul>
                                    <li>Grade 4 - Insufficient Teaching and Learning Practice. Considered as ineffective</li>
                                </ul>
                            </td>
                            <td>
                                {!! Form::select('grade_10', $grades, null, ['class' => 'form-control gradesSelect']) !!}
                            </td>
                        </tr>
                        <tr>
                                <th colspan="2">
                                    <span class="text-bold text-right">Comments</span>
                                </th>
                                <td colspan="3">
                                ...
                                <td class="bg-success">
                                    <span class="bolder text-info">Total Score: </span><span class="bolder" id="overallScore"></span><br>
                                    <span class="bolder text-info">Overall Risk Grade: </span><span class="bolder" id="overallRiskGrade"></span><br>
                                </td>
                            </tr>
                    </tbody>
                </table>
...
<script>
    $(document).ready(function() {
        $('.gradesSelect').on('change', function() {
            ...
            // Calculate risk grade based on total score
            let riskGrade;
            if (totalScore <= 10) {
                riskGrade = '20%';
                ...
                riskGrade = 'Invalid Score';
            }
            $('#overallRiskGrade').text(riskGrade);
        });
    });
</script>
@endsection