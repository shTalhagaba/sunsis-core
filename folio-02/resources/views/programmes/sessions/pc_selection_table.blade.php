@php
    $already_selected_units_ids = $selectedProgrammeQualificationUnitIds ?? [];
    $already_selected_pcs = $selectedProgrammeQualificationUnitPcIds ?? [];
@endphp
    ...
    <div class="widget-box transparent ui-sortable-handle">
        <div class="widget-header">
            <h5 class="widget-title bolder">
                <i class="fa fa-graduation-cap"></i> {{ $qualification->qan }} {{ $qualification->title }}
            </h5>
        ...
        <div class="widget-body">
            <div class="widget-main">
                @foreach($qualification->units()->orderBy('unit_sequence')->get() AS $unit)
                <table class="table table-bordered table-hover">
                    <tr>
                        ...
                        <th class="brown" colspan="3">
							...
							<h5 style="display: inline;" class="bolder">[{{ $unit->unit_owner_ref }}, {{ $unit->unique_ref_number }}] {{ $unit->title }}</h5>
