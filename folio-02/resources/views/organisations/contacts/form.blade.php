    ...
    <div class="widget-body">
        <div class="widget-main">
            ...
            <div class="form-group row required {{ $errors->has('location_id') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-8">
                    {!! Form::select('location_id', $organisation->locations()->orderBy('title')->pluck('title', 'id'), null, [
            ...
            <div class="form-group row required {{ $errors->has('surname') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-8">
                    {!! Form::text('surname', null, ['class' => 'form-control col-xs-10 col-sm-5', 'maxlength' => '50']) !!}
            ...
            <div class="form-group row {{ $errors->has('department') ? 'has-error' : '' }}">
                ...
                <div class="col-sm-8">
                    {!! Form::text('department', null, ['class' => 'form-control col-xs-10 col-sm-5', 'maxlength' => '50']) !!}
