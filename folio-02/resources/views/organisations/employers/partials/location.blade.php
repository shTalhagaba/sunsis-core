<div class="widget-box {{ $location->is_legal_address == 1 ? 'widget-color-green' : '' }}">
    ...
    <div class="widget-body">
        <div class="widget-main">
            ...
            {!! $location->postcode != ''
                ? '<br><i class="fa fa-map-marker light-orange bigger-110"></i> ' . $location->postcode
                : '<br>' !!}
            {!! $location->telephone != ''
                ? '<br><i class="fa fa-phone light-orange bigger-110"></i> ' . $location->telephone
                : '<br>' !!}
            {!! $location->mobile != ''
                ? '<br><i class="fa fa-mobile light-orange bigger-110"></i> ' . $location->mobile
                : '<br>' !!}
            {!! $location->fax != '' ? '<br><i class="fa fa-fax light-orange bigger-110"></i> ' . $location->fax : '<br>' !!}
            <br>
            <h4 class="pull-right bigger" title="Learners Count" data-rel="tooltip"><i
                    class="fa fa-users green bigger-120"></i> {{ $location->students->count() }}</h4>
        ...
        <div class="widget-toolbox padding-8 clearfix">
            <button type="button" class="btn btn-white btn-primary btn-round btn-sm"
                onclick="window.location.href='{{ route('organisations.locations.edit', [$location->organisation, $location]) }}';">
