...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="row">
            <div class="col-xs-12">
                <button class="btn btn-sm btn-white btn-default btn-round" type="button" onclick="window.location.href='{{ route('students.show', $student) }}'">
            ...
            <div class="col-xs-12">
                <div class="info-div info-div-striped">
                    <div class="info-div-row">
                        ...
                        <div class="info-div-value"><span>{{ optional($student->latestAuth)->login_at }}</span></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-body">
                        ...
                        <div class="widget-main">
                            ...
                            <div class="alert alert-info">
                                <i class="fa fa-info-circle"></i> Updating username will result in the following actions:<br>
                                ...
                                <i class="fa fa-hand-o-right"></i> <small>Password will be reset and emailed to primary email.</small><br>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="widget-box widget-color-green">
                    <div class="widget-header">
                        <h4 class="widget-title">Login Credentials Emails</h4>
                    </div>
                    <div class="widget-body">
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="widget-box transparent">
                                    <div class="widget-header">
                                        <h4 class="widget-title">Send Welcome Email</h4>
                                    </div>
                                    <div class="widget-body">
                                        @if(\Session::has('message_send_welcome_email'))
                                        <div class="alert {{ \Session::get('alert-class', 'alert-info') }}">
                                            <button class="close" data-dismiss="alert">
                                                <i class="ace-icon fa fa-times"></i>
                                            </button>
                                            <i class="ace-icon fa {{ \Session::get('alert-icon', 'fa fa-check') }}"></i>
                                            {{ \Session::get('message_send_welcome_email') }}
                                        </div>
                                        @endif
                                        <div class="widget-main">
                                            <div class="alert alert-info">
                                                <i class="fa fa-info-circle"></i> Use this feature to send welcome email to the student:<br>
                                                <i class="fa fa-hand-o-right"></i> <small>This welcome email will contain the student's username.</small><br>
                                            </div>
                                            {!! Form::model($student, [
                                                'method' => 'POST',
                                                'url' => route('students.sendWelcomeEmail', $student),
                                                'class' => 'form-horizontal',
                                                'id' => 'frmSendWelcomeEmail'
                                                ]) !!}
                                            <button class="btn btn-sm btn-success btn-round" type="button" id="btnSendWelcomeEmail">
                                                <i class="ace-icon fa fa-send bigger-110"></i>Send Welcome Email
                                            </button>
                                            {!! Form::close() !!}
                                        </div>
                                    </div>
                            ...
                            <div class="col-xs-6">
                                <div class="widget-box transparent">
                                    ...
                                    <div class="widget-body">
                                        ...
                                        @endif
                                        @if ( false && $student->authentications()->count() > 0 )
                                        <div class="alert alert-info">
                                            <i class="fa fa-info-circle"></i>
                                            <small>
                                                This student has {{ $student->authentications()->count() }} login(s) in the system and the last login was at {{ optional($student->latestAuth)->login_at }}
                                        ...
                                        <div class="widget-main">
                                            <div class="alert alert-info">
                                                <i class="fa fa-info-circle"></i> Use this feature to reset the student password:<br>
                                                <i class="fa fa-hand-o-right"></i> <small>Password will be reset and emailed to the student's primary email.</small><br>
                                            </div>
                                            {!! Form::model($student, [
                                                'method' => 'PATCH',
                                            ...
                                            <button class="btn btn-sm btn-success btn-round" type="button" id="btnResetPassword">
                                                <i class="ace-icon fa fa-send bigger-110"></i>Send Reset Password Email
                                            </button>
                                            {!! Form::close() !!}
                                        </div>
                                        @endif
...
@section('page-inline-scripts')
   ...
   <script type="text/javascript">
    ...
    $("button[id=btnDisableAccess], button[id=btnEnableAccess], button[id=btnResetPassword], button[id=btnSendWelcomeEmail]").on('click', function(e){
        e.preventDefault();
