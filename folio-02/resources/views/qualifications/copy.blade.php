        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="widget-box">
                    ...
                    <div class="widget-header"><h4>Copy Qualification</h4></div>
                    <div class="widget-body">
                        <div class="widget-main">
                            <div class="form-group row required {{ $errors->has('new_qualification_title') ? 'has-error' : ''}}">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h5 class="bolder">Select the units and pcs you want to copy</h5>        
                                    </div>
                                </div>
                                ...
                                <table class="table table-bordered table-hover">
                                    <tr>
                                        ...
                                        <th class="brown"><i class="fa fa-folder fa-lg"></i><h5 style="display: inline;"> [{{ $unit->unit_owner_ref }}, {{ $unit->unique_ref_number }}] {{ $unit->title }}</h5>
                                    </tr>
