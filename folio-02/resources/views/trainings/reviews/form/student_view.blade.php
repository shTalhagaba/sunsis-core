...
@section('page-content')
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            @if( $training->isEditableByStudent() )
                @if($reviewForm->readyForLearnerSign())
                {!! Form::open([
                    'method' => 'PATCH',
                        ...
                        <div class="widget-box widget-color-green">
                            ...
                            <div class="widget-body">
                                <div class="widget-main">                               
                                    <div class="form-group row required{{ $errors->has('learner_comments') ? 'has-error' : '' }}">
                                        {!! Form::label('learner_comments', 'Learner comments', [
                                            'class' => 'col-sm-4 control-label no-padding-right',
                                        ]) !!}
                                        <div class="col-sm-8">
                                            {!! Form::textarea('learner_comments', $formData['learner_comments'] ?? null, [
                                                'class' => 'form-control',
                                                'placeholder' => 'Learner comments',
                                                'maxlength' => '1500',
                                                'required',
                                            ]) !!}
