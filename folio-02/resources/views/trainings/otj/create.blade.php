   ...
   <div class="page-header">
        <h1>
            ...
            <small>
                ...
                create a new off-the-job-hours record in the system
            </small>
        </h1>
    </div><!-- /.page-header -->
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="space"></div>
                    {!! Form::open([
                        'url' => route('trainings.otj.store', $training),
                        'class' => 'form-horizontal',
                        'files' => true,
                        'id' => 'frmOtj',
                    ]) !!}
                    @include('trainings.otj.form', ['isEditable' => true, 'showAssessmentPanel' => $showAssessmentPanel])
                    {!! Form::close() !!}
...
@push('after-scripts')
    <script>
        $("form[name=frmOtj]").on('submit', function(){
            var form = $(this);
