                                        ...
                                        <div class="col-sm-6">
                                            <div class="well well-sm">
                                                @if($_evi->getOriginal('evidence_type') == \App\Models\Training\TrainingRecordEvidence::TYPE_FILE)
                                                    <span>
                                                        <a href="{{ route('files.download',  encrypt($_evi->media->first()->id)) }}" target="_blank" style="cursor: pointer;">
                                                ...
                                                {{-- <span class="ace-settings-btn tn btn-xs btn-info" style="cursor: pointer"
                                                      onclick="window.open('{{ route('trainings.evidence.show', [$training_record, $_evi]) }}', '_blank')">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @foreach($pc->mapped_evidences AS $evidence)
                                                    @include('trainings.evidences.partials.evidence_popover', ['_evidence_popover' => $evidence])
                                                @endforeach
                                            </td>
                                            ...
                                            <td>
                                                @if(in_array($pc->id, $accepted_pcs_in_last_assessment))
                                                    {{ App\Models\Training\PortfolioUnitIqa::getDescription($pc->iqa_status) }}
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                <div class="info-div info-div-striped">
                                    ...
                                    <div class="info-div-row">
                                        <div class="info-div-name"> IQA Referred PCs: </div>
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                <div class="row">
                                    <div class="col-sm-6">
                                        {!! Form::open([
                                            'url' => route('trainings.unit.eqa.store', [$training_record, $unit]),
