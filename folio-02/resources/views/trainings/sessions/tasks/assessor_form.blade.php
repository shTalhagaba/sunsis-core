@if ($task->isEditableByLearner())
<div class="row">
    <div class="col-xs-12">
        {!! Form::model($task->getAttributes(), [
            'url' => route('trainings.sessions.tasks.save_assessment', [$training, $session, $task]),
...
<div class="row" style="margin-top: 2%; margin-bottom: 2%">
    <div class="col-xs-12">
        {!! Form::model($task->getAttributes(), [
            ...
            'role' => 'form',
            'files' => true,
            'id' => 'frmSessionTaskUploadEvidenceFeedback']) !!}

        {!! Form::hidden('id', $task->id) !!}
        {!! Form::hidden('tr_id', $training->id) !!}
        {!! Form::hidden('dp_session_id', $session->id) !!}
        {!! Form::hidden('file_upload_only', 1) !!}
        {!! Form::hidden('feedback_file', 1) !!}

        <div class="widget-box widget-color-green">
            <div class="widget-header"><h4 class="widget-title">Upload Feedback File</h4></div>
            <div class="widget-body">
                <div class="widget-main">
                    <p class="text-center text-info">
                        <i class="fa fa-info-circle"></i> 
                        You can upload <strong>feedback files</strong> for this task here. You can upload multiple files one by one.
                    </p>
                    <div class="form-group row {{ $errors->has('tr_task_feedback_file') ? 'has-error' : '' }}">
                        {!! Form::label('tr_task_feedback_file', 'Evidence', ['class' => 'col-sm-4 control-label no-padding-right']) !!}
                        <div class="col-sm-8">
                            @include(
                                'partials.ace_file_control',
                                ['aceFileControlRequired' => false, 'aceFileControlId' => 'tr_task_feedback_file', 'aceFileControlName' => 'tr_task_feedback_file']
                            )
                            {!! $errors->first('tr_task_feedback_file', '<p class="text-danger">:message</p>') !!}
                        </div>
                    </div>
                    <p class="text-center text-info">
                        <i class="fa fa-info-circle"></i> 
                        Please click on 'Upload Feedback File' to upload your selected file in this panel.
                    </p>
                </div>
                <div class="widget-toolbox clearfix">
                    <div class="center">
                        <button class="btn btn-xs btn-success btn-round" type="submit">
                            <i class="ace-icon fa fa-save bigger-110"></i> Upload Feedback File
                        </button>
                    </div>
                </div>
            </div>
...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="widget-box widget-color-green">
            <div class="widget-header"><h4 class="widget-title">Task Assessment</h4></div>
            <div class="widget-body">
                <div class="widget-main">
                    <p class="text-center text-info">
                        <i class="fa fa-info-circle"></i> 
                        Enter task assessment details.
                    </p>
                    <div class="form-group row required {{ $errors->has('status') ? 'has-error' : '' }}">
                        ...
                        <div class="col-sm-8">
                            {!! Form::select('status', [
                                App\Models\Training\TrainingDeliveryPlanSessionTask::STATUS_COMPLETED => 'Accepted',
                                App\Models\Training\TrainingDeliveryPlanSessionTask::STATUS_REFERRED => 'Referred',
                    ...
                    <div class="form-group row">
                        <div class="col-sm-8 col-sm-offset-4">
                            <div class="control-group">
                                <div class="checkbox">
                                    <label>
                                        <input name="assessor_signed"  type="checkbox" value="1" required >
                                        <span class="lbl bolder"> &nbsp; Tick this option to confirm your signature if you have completed an assessment of this task.</span>
