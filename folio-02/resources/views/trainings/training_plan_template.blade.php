...
@section('title', 'Student Training Plans')
...
<div class="page-header"><h1>Training Plans</h1></div><!-- /.page-header -->
<div class="row">
    <div class="col-xs-12">
        <button class="btn btn-sm btn-white btn-default btn-round" type="button" onclick="window.location.href='{{ route('trainings.show', $training_record) }}'">
                ...
                <div class="widget-box transparent">
                    <div class="widget-header">
                        <h5 class="widget-title">
                            Training Plans
                            <span data-rel="tooltip" title="Number of optional units" class="badge badge-info">{{ $training_record->training_plans->count() }}</span>
                        </h5>
                    </div>
                    <div class="widget-body">
                        <div class="widget-main">
                            {!! Form::open([
                                'url' => route('trainings.update_number_of_training_plans', $training_record),
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                @include('trainings.partials.training_plan_box', ['_plan' => $plan, 'edit_button' => true])
            </div>
            @endforeach
        </div>
...
$(document).ready(function(){
    ...
    $('#btnTest').on('click', function(){
        ...
        $.ajax({
            url: '{{ route('trainings.training_plans.update', $training_record) }}',
            type: 'POST',
            data: {plans: plans},
...
function preparePlanModalForEdit(plan)
{
    ...
    form.action = '/students/{{ $student->id }}/training/{{ $training_record->id }}/plans/'+plan.id;
