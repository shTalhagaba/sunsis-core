...
@section('breadcrumbs')
    {{ Breadcrumbs::render('eqa_samples.create') }}
@endsection
    ...
    <div class="page-header">
        <h1>
            ...
            <small>
                ...
                add new EQA sample in the system
            </small>
        </h1>
    </div><!-- /.page-header -->
    <div class="row">
        <div class="col-xs-12">
            ...
            <button class="btn btn-sm btn-white btn-default btn-round" type="button"
                    onclick="window.location.href='{{ route('eqa_samples.index') }}'">
