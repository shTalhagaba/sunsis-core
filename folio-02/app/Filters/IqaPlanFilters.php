...
class IqaPlanFilters extends QueryFilters
{
    protected $request;

    protected $filterKey = 'ViewIqaPlan_Filters';

    protected $defaultFilters = [
        'sort_by' => 'iqa_plans.learning_aim_title',
        'direction' => 'ASC',
        'per_page' => '20',
    ];
    ...
    {
        session(['iqa_plans_per_page' => $value]);
    }

    public function render()
    {
        $sortByOptions = [
            'iqa_plans.created_at' => 'Creation Date',
            'iqa_plans.learning_aim_qan' => 'Learning Aim QAN',
            'iqa_plans.learning_aim_title' => 'Learning Aim Title',
        ];

        $planVerifierIds = IqaPlan::pluck('verifier_id')->toArray();
        ...
        $planAssessorIds = IqaPlan::pluck('assessor_id')->toArray();
