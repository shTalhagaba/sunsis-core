...
class EventAccepted extends Notification
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        ...
        $message = '<p>' . $participant->full_name . ' [' . UserTypeLookup::getDescription($participant->user_type) . '] has accepted the following event.</p><br>';
    ...
    {
        return 'Event accepted by participant.';
    }
}
