...
class RemovedFromEvent extends Notification
{
    ...
    public function toArray($notifiable)
    {
        ...
        $message = '<p>' . $organiser->full_name . ' [' . UserTypeLookup::getDescription($organiser->user_type) . '] has removed you from the following event.</p>';
