...
class EventDeleted extends Notification
{
    ...
    public function toArray($notifiable)
    {
        ...
        $message = '<p>' . $creator->full_name . ' [' . UserTypeLookup::getDescription($creator->user_type) . '] has deleted the following event.</p><br>';
        $message .= '<p><span class="text-info bolder">Event Title: </span>' . $event->title . '</p>';
    ...
    {
        return 'Event deleted by organiser.';
    }
}