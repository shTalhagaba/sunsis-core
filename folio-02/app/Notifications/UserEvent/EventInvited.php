...
class EventInvited extends Notification
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        ...
        $message = '<p>' . $organiser->full_name . ' [' . UserTypeLookup::getDescription($organiser->user_type) . '] has invited you for the following event.</p>';
        $message .= '<p>Please access the event and accept/decline this invitation.</p><br>';
