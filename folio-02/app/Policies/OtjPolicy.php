...
class OtjPolicy
{
    ...
    public function edit(User $user, Otj $otj, TrainingRecord $training)
    {
        if( $otj->tr_id !== $training->id )
        {
            return false;
        }
    ...
    public function show(User $user, Otj $otj, TrainingRecord $training)
    {
        if( $otj->tr_id !== $training->id )
        {
            return false;
        ...
        {
            return $this->isInUserCaseload($user, $otj->training);
        }
    ...
    public function destroy(User $user, Otj $otj, TrainingRecord $training)
    {
        if( $otj->tr_id !== $training->id )
        {
            return false;
