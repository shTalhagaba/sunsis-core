               ...
               <div class="col-sm-10 col-sm-offset-1">
                  <div class="login-container" style="width: 75%">
                     <div class="center">
                        ...
                        <h4 class="blue" id="id-company-text">&copy; Perspective (UK) Ltd.</h4>
                     </div>
                                            ...
                                            <fieldset>
                                               <label class="block clearfix">
                                                   <span class="block input-icon input-icon-right">
                                                        <input id="emailo" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Username" />
                        ...
                        <div id="forgot-box" class="forgot-box widget-box no-border">
                           <div class="widget-body">
                              <div class="widget-main">
                                 ...
                                 <div class="space-6"></div>
                                 <p>
                                    Provide your email to receive instructions
                                 </p>
                                 <form name="frmResetPassword" id="frmResetPassword" method="POST" action="{{ route('password.email') }}">
                                    ...
                                    <fieldset>
                                       <label class="block clearfix">
                                           <span class="block input-icon input-icon-right">
                                               <input id="frm_reset_password_email" type="email" placeholder="Email" class="form-control @error('frm_reset_password_email') is-invalid @enderror" name="frm_reset_password_email" value="{{ old('frm_reset_password_email') }}" required autocomplete="frm_reset_password_email" autofocus />
