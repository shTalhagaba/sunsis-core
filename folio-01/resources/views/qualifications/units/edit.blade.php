...
@section('title', 'Edit Qualification Unit')
...
@section('breadcrumbs')
{{ Breadcrumbs::render('qualifications.units.edit', $qualification, $unit) }}
@endsection

@section('page-content')
<div class="page-header"><h1>Edit Qualification Unit</h1></div><!-- /.page-header -->
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <div class="row">
                        ...
                        <div class="widget-main">
                            <div class="profile-user-info profile-user-info-striped">
                                <div class="profile-info-row">
                                    ...
                                    <div class="profile-info-value"><span><span class="label label-md label-info arrowed-in-right arrowed-in">{{ $qualification->level }}</span></span>
                                    </div>
                                </div>
                                <div class="profile-info-row">
                                    <div class="profile-info-name"> Qualification Number & Title</div>
                                    <div class="profile-info-value"><span>{{ $qualification->qan }} {{ $qualification->title }}</span></div>
                                </div>
                                <div class="profile-info-row">
                                    <div class="profile-info-name"> Awarding Org. </div>
                                    <div class="profile-info-value"><span>{{ $qualification->owner_org_name }}</span></div>
                                </div>
                                <div class="profile-info-row">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="widget-box collapsed">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            @foreach($qualification->units AS $u)
                            <small>@include('qualifications.partials.unit_with_pcs', ['unit' => $u])</small>
                            @endforeach
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="widget-box">
                    <div class="widget-header">
                        <h5 class="widget-title">Edit Unit Details</h5> &nbsp;
                    </div>
                    <div class="widget-body">
                        <div class="widget-main">
                            {!! Form::model($unit->getAttributes(), [
                                'name' => 'frmEditUnit',
                                'id' => 'frmEditUnit',
                                'url' => route('qualifications.units.update', [$qualification, $unit->id]),
                            ...
                            <div class="form-group row required {{ $errors->has('unit_owner_ref') ? 'has-error' : ''}}">
                                ...
                                <div class="col-sm-8">
                                    {!! Form::text('unit_owner_ref', $unit->unit_owner_ref ?? 'Ref' . (intval($qualification->units()->count())+1), ['class' => 'form-control col-sm-8 inputLimiter', 'required', 'maxlength' => '15']) !!}
                            ...
                            <div class="form-group row required {{ $errors->has('title') ? 'has-error' : ''}}">
                                ...
                                <div class="col-sm-8">
                                    {!! Form::textarea('title', null, ['class' => 'form-control col-sm-8 inputLimiter', 'required', 'maxlength' => '850', 'rows' => 3]) !!}
                            ...
                            <div class="form-group row required {{ $errors->has('glh') ? 'has-error' : ''}}">
                                ...
                                <div class="col-sm-8">
                                    {!! Form::number('glh', $unit->glh ?? 0, ['class' => 'form-control col-sm-8', 'required', 'onkeypress' => 'return isNumberKey(event)', 'maxlength' => '4']) !!}
                            ...
                            <div class="form-group row required {{ $errors->has('unit_credit_value') ? 'has-error' : ''}}">
                                ...
                                <div class="col-sm-8">
                                    {!! Form::number('unit_credit_value', $unit->unit_credit_value ?? 0, ['class' => 'form-control col-sm-8', 'required', 'onkeypress' => 'return isNumberKey(event)', 'maxlength' => '4']) !!}
                            ...
                            <div class="form-group row {{ $errors->has('learning_outcomes') ? 'has-error' : ''}}">
                                ...
                                <div class="col-sm-8">
                                    {!! Form::textarea('learning_outcomes', $unit->learning_outcomes, ['class' => 'form-control col-sm-8 inputLimiter', 'required', 'maxlength' => '250', 'rows' => 3]) !!}
                                    {!! $errors->first('learning_outcomes', '<p class="text-danger">:message</p>') !!}
                                </div>
                            </div>
                            <hr>
                            <span class="lead">Add/Edit Performance Criteria</span>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 10%">
                                                ...
                                                {!! Form::select('min_req_evidences', array_combine( range(1,10), range(1,10) ), '') !!}
                                            </th>
                                            <th>PC Description</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @php $sequence = 0; @endphp
                                        @foreach($unit->pcs()->orderBy('pc_sequence')->get() AS $pc)
                                        @php
                                            $sequence++;
                                            $prefix = 'pc_'.$sequence.'_';
                                        @endphp
                                        <tr>
                                            <td>
                                                {{ $sequence }}
                                                {!! Form::hidden($prefix.'sequence', $sequence) !!}
                                            </td>
                                            <td>
                                                {!! Form::text($prefix.'reference', $pc->reference, ['class' => 'form-control inputLimiter', 'maxlength' => '15']) !!}
                                            </td>
                                            <td>
                                                {!! Form::select($prefix.'category', \App\Models\Qualifications\QualificationUnitPC::getDDLEvidenceCategories(), $pc->getOriginal("category"), ['class' => 'form-control', 'required']) !!}
                                            </td>
                                            <td>
                                                {!! Form::textarea($prefix.'title', $pc->title, ['class' => 'form-control inputLimiter', 'maxlength' => '850', 'rows' => '3']) !!}
                                            </td>
                                            <td>
                                                {!! Form::select($prefix.'min_req_evidences', array_combine( range(1,10), range(1,10) ), $pc->getOriginal("min_req_evidences"), ['class' => 'form-control', 'required']) !!}
                                            </td>
                                            <td>
                                                {!! Form::textarea($prefix.'description', $pc->description, ['class' => 'form-control inputLimiter', 'maxlength' => '500', 'rows' => 3]) !!}
                                            </td>
                                        </tr>
                                        @endforeach
                                        @for($i = $sequence + 1; $i <= $sequence + 20; $i++)
                                        @php
                                            $prefix = 'pc_'.$i.'_';
                                        @endphp
                                        <tr>
                                            ...
                                            <td>
                                                {!! Form::text($prefix.'reference', $unit->unit_owner_ref . 'Ref' . $i, ['class' => 'form-control inputLimiter', 'maxlength' => '15']) !!}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                {!! Form::select($prefix.'min_req_evidences', array_combine( range(1,10), range(1,10) ), null, ['class' => 'form-control']) !!}
                                            </td>
                                            <td>
...
function submitForm()
{
    ...
    if(valid_form)
        document.forms["frmEditUnit"].submit();
}
