...
<div class="page-header"><h1>Add Qualification Unit</h1></div><!-- /.page-header -->
<div class="row">
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <div class="row">
                ...
                <div class="widget-box collapsed">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            ...
                            <small>@include('qualifications.partials.unit_with_pcs')</small>
                            @endforeach
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="widget-box">
                    <div class="widget-header">
                        <h5 class="widget-title">Add New Unit Details</h5> &nbsp;
                    </div>
                    <div class="widget-body">
                        <div class="widget-main">
                            {!! Form::open([
                                'name' => 'frmAddUnit',
                                'id' => 'frmAddUnit',
                                'url' => route('qualifications.units.store', $qualification),
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {!! Form::select($prefix.'min_req_evidences', array_combine( range(1,10), range(1,10) ), null, ['class' => 'form-control', 'required']) !!}
                                            </td>
                                            <td>
