{!! Form::open(['url' => route('qualifications.index'), 'class' => 'form-horizontal', 'method' => 'GET']) !!}
<div class="row small">
	<div style="float: none; padding-top: 5px;" class="col-sm-12 center-block">
		<div class="row">
			<div class="col-sm-4">
				<div class="form-group row {{ $errors->has('keyword') ? 'has-error' : ''}}">
					{!! Form::label('keyword', 'Keyword or code', ['class' => 'col-sm-4 control-label no-padding-right']) !!}
					<div class="col-sm-8">
			...
			<div class="col-sm-4">
				<div class="form-group row {{ $errors->has('org_code_or_name') ? 'has-error' : ''}}">
					{!! Form::label('org_code_or_name', 'Awarding Org code or name', ['class' => 'col-sm-4 control-label no-padding-right']) !!}
					<div class="col-sm-8">
						{!! Form::text('org_code_or_name', $filters->org_code_or_name, ['class' => 'form-control col-xs-10 col-sm-5', 'maxlength' => '150']) !!}
						{!! $errors->first('org_code_or_name', '<p class="text-danger">:message</p>') !!}
					</div>
				</div>
            </div>
            <div class="col-sm-4">
				<div class="form-group row {{ $errors->has('level') ? 'has-error' : ''}}">
					{!! Form::label('level', 'Level', ['class' => 'col-sm-4 control-label']) !!}
					<div class="col-sm-8">
						{!! Form::select('level', \App\Models\Qualifications\Qualification::getQualificationLevels(), $filters->level, ['class' => 'form-control']) !!}
		...
		<div class="row">
            <div class="col-sm-4">
				<div class="form-group row {{ $errors->has('ssa') ? 'has-error' : ''}}">
					{!! Form::label('ssa', 'SSA', ['class' => 'col-sm-4 control-label']) !!}
					<div class="col-sm-8">
						{!! Form::select('ssa', \App\Models\Qualifications\Qualification::getQualificationSSA(), $filters->ssa, ['class' => 'form-control']) !!}
			...
			<div class="col-sm-4">
				<div class="form-group row {{ $errors->has('type') ? 'has-error' : ''}}">
					...
					<div class="col-sm-8">
						{!! Form::select('type', \App\Models\Qualifications\Qualification::getQualificationTypes(), $filters->type, ['class' => 'form-control']) !!}
			...
			<div class="col-sm-4">
				<div class="form-group row {{ $errors->has('status') ? 'has-error' : ''}}">
					...
					<div class="col-sm-8">
						{!! Form::select('status', \App\Models\Qualifications\Qualification::getQualificationStatus(), $filters->status, ['class' => 'form-control']) !!}
        ...
        <div class="row">
			<div class="col-sm-4">
                <div class="form-group row {{ $errors->has('sortBy') ? 'has-error' : ''}}">
                    ...
                    <div class="col-sm-8">
                        {!! Form::select('sortBy', ['title' => 'Title', 'qan' => 'QAN'], $filters->sortBy, ['class' => 'form-control']) !!}
...
<div class="clearfix center">
		...
		&nbsp; &nbsp; &nbsp;
		<button class="btn btn-sm btn-round" type="button" onclick="$(this).closest('form').find('input[type=text], textarea').val('');">
