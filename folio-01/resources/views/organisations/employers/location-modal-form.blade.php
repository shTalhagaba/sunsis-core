...
<div class="form-group row required {{ $errors->has('is_legal_address') ? 'has-error' : ''}}">
   ...
   <div class="col-sm-8">
       {!! Form::select('is_legal_address', ['0' => 'No', '1' => 'Yes'], null, ['class' => 'form-control col-xs-10 col-sm-5', 'required' => 'required']) !!}
...
<div class="form-group row required {{ $errors->has('legal_name') ? 'has-error' : ''}}">
   ...
   <div class="col-sm-8">
       {!! Form::text('title', null, ['class' => 'form-control col-xs-10 col-sm-5', 'required' => 'required', 'maxlength' => '100']) !!}
...
<div class="form-group row required {{ $errors->has('address_line_1') ? 'has-error' : ''}}">
   ...
   <div class="col-sm-8">
       {!! Form::text('address_line_1', null, ['class' => 'form-control col-xs-10 col-sm-5', 'required' => 'required', 'maxlength' => '100']) !!}
...
<div class="form-group row {{ $errors->has('address_line_2') ? 'has-error' : ''}}">
   ...
   <div class="col-sm-8">
       {!! Form::text('address_line_2', null, ['class' => 'form-control col-xs-10 col-sm-5', 'maxlength' => '100']) !!}
...
<div class="form-group row {{ $errors->has('address_line_3') ? 'has-error' : ''}}">
   ...
   <div class="col-sm-8">
       {!! Form::text('address_line_3', null, ['class' => 'form-control col-xs-10 col-sm-5', 'maxlength' => '100']) !!}
...
<div class="form-group row {{ $errors->has('address_line_4') ? 'has-error' : ''}}">
   ...
   <div class="col-sm-8">
       {!! Form::text('address_line_4', null, ['class' => 'form-control col-xs-10 col-sm-5', 'maxlength' => '100']) !!}
...
<div class="form-group row required {{ $errors->has('postcode') ? 'has-error' : ''}}">
   ...
   <div class="col-sm-8">
       {!! Form::text('postcode', null, ['class' => 'form-control col-xs-10 col-sm-5', 'maxlength' => '100', 'required' => 'required']) !!}
...
<div class="form-group row {{ $errors->has('telephone') ? 'has-error' : ''}}">
   ...
   <div class="col-sm-8">
       {!! Form::text('telephone', null, ['class' => 'form-control col-xs-10 col-sm-5', 'maxlength' => '100']) !!}
...
<div class="form-group row {{ $errors->has('mobile') ? 'has-error' : ''}}">
   ...
   <div class="col-sm-8">
       {!! Form::text('mobile', null, ['class' => 'form-control col-xs-10 col-sm-5', 'maxlength' => '100']) !!}
...
<div class="form-group row {{ $errors->has('fax') ? 'has-error' : ''}}">
   ...
   <div class="col-sm-8">
       {!! Form::text('fax', null, ['class' => 'form-control col-xs-10 col-sm-5', 'maxlength' => '100']) !!}
