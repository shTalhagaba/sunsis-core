...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="well well-sm">
            <button class="btn btn-sm btn-white btn-primary btn-round" type="button" onclick="window.location.href='{{ route('rp.index') }}'">
        ...
        <div class="row">
            <div class="col-sm-8">
                {!! Form::model($role, ['url' => route('roles.update', $role->id), 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH']) !!}
