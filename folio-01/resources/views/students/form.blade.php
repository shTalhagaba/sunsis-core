        ...
        <div class="widget-main">
            <div class="row">
                         ...
                         <div class="widget-main">
                           {!! Form::hidden('user_type', \App\Models\User::TYPE_STUDENT) !!}
                            <div class="form-group row required {{ $errors->has('firstnames') ? 'has-error' : ''}}">
                                ...
                                <div class="col-sm-8">
                                    {!! Form::text('firstnames', null, ['class' => 'form-control inputLimiter', 'required' => 'required', 'maxlength' => '100']) !!}
                            ...
                            <div class="form-group row required {{ $errors->has('surname') ? 'has-error' : ''}}">
                                ...
                                <div class="col-sm-8">
                                    {!! Form::text('surname', null, ['class' => 'form-control inputLimiter', 'required' => 'required', 'maxlength' => '100']) !!}
                           ...
                           <div class="form-group row {{ $errors->has('date_of_birth') ? 'has-error' : ''}}">
                            ...
                            <div class="form-group row {{ $errors->has('uln') ? 'has-error' : ''}}">
                                ...
                                <div class="col-sm-8">
                                    {!! Form::text('uln', null, ['class' => 'form-control inputLimiter', 'maxlength' => '10']) !!}
                                    {!! $errors->first('uln', '<p class="text-danger">:message</p>') !!}
                                </div>
                            </div>
                            <div class="form-group row required {{ $errors->has('primary_email') ? 'has-error' : ''}}">
                                {!! Form::label('primary_email', 'Primary Email', ['class' => 'col-sm-4 control-label', 'maxlength' => '255']) !!}
                                <div class="col-sm-8">
                                    {!! Form::email('primary_email', null, ['class' => 'form-control inputLimiter', 'required' => 'required']) !!}
                                    {!! $errors->first('primary_email', '<p class="text-danger">:message</p>') !!}
                                </div>
                            </div>
                            <div class="form-group row {{ $errors->has('secondary_email') ? 'has-error' : ''}}">
                                {!! Form::label('secondary_email', 'Secondary Email', ['class' => 'col-sm-4 control-label', 'maxlength' => '255']) !!}
                                <div class="col-sm-8">
                                    {!! Form::email('secondary_email', null, ['class' => 'form-control inputLimiter']) !!}
                            ...
                            <div class="form-group row {{ $errors->has('fb_id') ? 'has-error' : ''}}">
                                ...
                                <div class="col-sm-8">
                                    {!! Form::text('fb_id', null, ['class' => 'form-control inputLimiter']) !!}
                                    {!! $errors->first('fb_id', '<p class="text-danger">:message</p>') !!}
                                </div>
                            </div>
                            <div class="form-group row {{ $errors->has('twitter_handle') ? 'has-error' : ''}}">
                             {!! Html::decode(Form::label('twitter_handle', 'Twitter Handle <i class="ace-icon fa fa-twitter-square light-blue"></i>', ['class' => 'col-sm-4 control-label'])) !!}
                                <div class="col-sm-8">
                                    {!! Form::text('twitter_handle', null, ['class' => 'form-control inputLimiter']) !!}
                ...
                <div class="col-sm-6">
                      ...
                      <div class="widget-body">
                         <div class="widget-main">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-8">
                                    <code class="text-info"> {{ $student->email }}</code>
                                </div>
                            </div>
                            @else
                            ...
                            <div class="form-group row required {{ $errors->has('web_access') ? 'has-error' : ''}}">
                              {!! Form::label('web_access', 'Web Access', ['class' => 'col-sm-4 control-label']) !!}
                                <div class="col-sm-8">
                                    <label>
                                     {!! Form::checkbox('web_access', null, isset($student)&&($student->web_access)?true:false, ['class' => 'ace ace-switch ace-switch-7']) !!}
                                        <span class="lbl"></span>
                                     </label>
                                </div>
                            </div>
                   ...
                   <div class="widget-box">
                       <div class="widget-header"><h4 class="smaller">Employer and Location</h4></div>
                       <div class="widget-body">
                           <div class="widget-main">
                               <div class="form-group row required {{ $errors->has('employer_location') ? 'has-error' : ''}}">
                                  ...
                                  <div class="col-sm-10">
                                      {!! Form::select('employer_location', \App\Models\LookupManager::getEmployersLocationsDDL(), null, ['class' => 'form-control', 'placeholder' => '', 'required' => 'required']) !!}
             ...
             <div class="row">
                <div class="col-sm-6">
                   <div class="widget-box">
                      ...
                      <div class="widget-body">
                         <div class="widget-main">
                             <div class="col-sm-8 col-sm-offset-4"><span class="btn btn-xs btn-default btn-round" id="btnPopulateWorkAddressFromEmployer">Populate from selected employer</span></div><br><br>
