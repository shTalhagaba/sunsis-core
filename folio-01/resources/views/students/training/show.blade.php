    ...
    <div class="col-xs-12">
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-2 col-xs-12 text-center">
                    <div title="Months Elapsed" class="easy-pie-chart percentage" data-percent="{{ $training_record->months_elapsed }}" data-color="#87CEEB"
                    style="height: 100px; width: 100px; line-height: 74px; color: rgb(135, 206, 235);">
                        <span class="percent">{{ $training_record->months_elapsed }}</span> months
                                            ...
                                            <div class="widget-main">
                                                <div class="info-div info-div-striped">
                                                    ...
                                                    <div class="info-div-row">
                                                        ...
                                                        <div class="info-div-value">
                                                            <span class="profile-picture">
                                                                <img class="avatar img-responsive" src="{{ asset('uploads/avatars') }}/{{ $training_record->secondaryAssessor->avatar }}" alt="{{ $training_record->secondaryAssessor->firstnames }}" />
                                                            </span><br>
                                                    ...
                                                    @endif
                                                    @if(!is_null($training_record->verifierUser))
                                                    <div class="info-div-row">
            ...
            <div class="col-sm-12">
                <div class="tabbable">
                    <ul id="myTab" class="nav nav-tabs tab-color-blue background-blue padding-18 tab-size-bigger">
                        ...
                        <li><a href="#tabAudits" data-toggle="tab">Audit</a></li>
                    </ul>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane {{ $loop->first ? 'in active' : '' }}" id="tab{{ $portfolio->qan }}">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h4 class="lighter lead"><i class="fa fa-graduation-cap fa-lg"></i> {{ $portfolio->title }}</h4>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    @include('students.training.partials.portfolio_progress_bar')
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <h4 class="lighter">Units</h4>
                                    ...
                                    <div class="widget-box">
                                        <div class="widget-header">
                                            <span class="widget-title"><strong title="{{ $unit->id }}">[{{ $unit->unit_owner_ref }}, {{ $unit->unique_ref_number }}]</strong></span> &nbsp;
                                            ...
                                            <div class="widget-toolbar">
                                                ...
                                                <a href="#">
                                                    ...
                                                    onclick="$('.UnitPanel{{ $unit->id }}').widget_box('hide');">
                                                    </i>
                                                </a>
                                                <a href="#">
                                                    <i class="ace-icon fa-lg fa fa-chevron-down" title="Expand All" style="cursor: pointer;"
                                                    onclick="$('.UnitPanel{{ $unit->id }}').widget_box('show');">
                                                    </i>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="widget-body">
                                            <div class="widget-main">
                                                <p>{{ $unit->title }}</p>
                                                @include('students.training.partials.unit_progress_bar')
                                                <div class="space-4"></div>
                        ...
                        <div class="tab-pane" id="tabAudits">
                            @include('partials.audit_tabular_view', ['model' => $training_record])
                        </div> {{-- tabAudits --}}
                    </div>{{-- tab-content --}}
                </div>{{-- tabbable --}}
            </div> {{-- tab col --}}
