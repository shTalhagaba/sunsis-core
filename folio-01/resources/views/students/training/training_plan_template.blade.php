...
@section('breadcrumbs')
{{ Breadcrumbs::render('students.training.training_plans.edit', $student, $training_record) }}
@endsection
...
<div class="row">
    <div class="col-xs-12">
            ...
            <div class="col-xs-12">
                <div class="widget-box transparent">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            {!! Form::open([
                                'url' => route('students.training.update_number_of_training_plans', [$student, $training_record]),
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                @include('students.training.partials.training_plan_box', ['_plan' => $plan, 'edit_button' => true])
            </div>
            @endforeach
        </div>
...
$(document).ready(function(){
    ...
    $('#btnTest').on('click', function(){
        ...
        $.ajax({
            url: '{{ route('students.training.training_plans.update', [$student, $training_record]) }}',
            type: 'POST',
            data: {plans: plans},
