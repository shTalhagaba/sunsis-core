...
@section('breadcrumbs')
{{ Breadcrumbs::render('students.training.reviews.create', $student, $training_record) }}
@endsection
...
<div class="page-header">
   <h1>
      ...
      <small>
         ...
         create a new review record in the system
      </small>
   </h1>
</div><!-- /.page-header -->
<div class="row">
   <div class="col-xs-12">
        ...
        <div id="user-profile-3" class="user-profile row">
            <div class="col-sm-12">
               <div class="space"></div>
               {!! Form::open([
                    'url' => route('students.training.reviews.store', [$student, $training_record]),
