...
<head>
	...
	<title>View EPA Organisations</title>
...
<div class="row">
	<div class="col-lg-12">
		<div class="banner">
			<div class="Title" style="margin-left: 6px;">View EPA Organisations</div>
			<div class="ButtonBar">
	...
	<div class="row small">
		<div id="div_filters" style="display:none">
			<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter" name="applyFilter">
				...
				<input type="hidden" name="_action" value="view_epa_orgs" />
				...
				<div id="filterBox" class="clearfix">
					<fieldset>
						...
						<div class="field float"><label>EPA Org ID:</label><?php echo $view->getFilterHTML('filter_EPA_ORG_ID'); ?></div>
						<div class="field float"><label>EPA Org Name:</label><?php echo $view->getFilterHTML('filter_EP_Assessment_Organisations'); ?></div>
						<div class="field float"><label>City:</label><?php echo $view->getFilterHTML('filter_Contact_address4'); ?></div>
						<div class="field float"><label>Delivery Area 1:</label><?php echo $view->getFilterHTML('filter_Delivery_Area_1'); ?></div>
						<div class="field float"><label>College Flag:</label><?php echo $view->getFilterHTML('filter_flag'); ?></div>
					</fieldset>
					<fieldset>
