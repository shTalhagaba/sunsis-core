...
<head>
    ...
    <title><?php echo $so->id == ''?'Create System Owner':'Edit System Owner'; ?></title>
...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;"><?php echo $so->id == ''?'Create System Owner':'Edit System Owner'; ?></div>
            <div class="ButtonBar">
...
<div class="container-fluid">
    <form class="form-horizontal" name="frmSystemOwner" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        <input type="hidden" name="id" value="<?php echo $so->id; ?>" />
        <input type="hidden" name="main_location_id" value="<?php echo $mainLocation->id; ?>" />
        <input type="hidden" name="_action" value="save_systemowner" />
        <div class="row">
            <div class="col-sm-7">
                <div class="box box-solid box-primary">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control compulsory" name="legal_name" id="legal_name" value="<?php echo $so->legal_name; ?>" maxlength="200" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="trading_name" class="col-sm-4 control-label fieldLabel_compulsory">Trading Name:</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control compulsory" name="trading_name" id="trading_name" value="<?php echo $so->trading_name; ?>" maxlength="200" onfocus="trading_name_onfocus(this);" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="short_name" class="col-sm-4 control-label fieldLabel_compulsory">Abbreviation/Short Name:</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control compulsory" name="short_name" id="short_name" value="<?php echo $so->short_name; ?>" maxlength="20" onfocus="short_name_onfocus(this);" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="company_number" class="col-sm-4 control-label fieldLabel_optional">Company Number:</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control optional" name="company_number" id="company_number" value="<?php echo $so->company_number; ?>" maxlength="10" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="vat_number" class="col-sm-4 control-label fieldLabel_optional">VAT Number:</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control optional" name="vat_number" id="vat_number" value="<?php echo $so->vat_number; ?>" maxlength="10" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="upin" class="col-sm-4 control-label fieldLabel_optional">Provider Number (UPIN):</label>
                            <div class="col-sm-8">
                                <?php echo HTML::selectChosen('upin', $L01_dropdown, $so->upin, true, false); ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="ukprn" class="col-sm-4 control-label fieldLabel_optional">UK Provider Reference Number:</label>
                            <div class="col-sm-8">
                                <?php echo HTML::selectChosen('ukprn', $L46_dropdown, $so->ukprn, true, false); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<script language="JavaScript">
    ...
    function save()
    {
        var myForm = document.forms["frmSystemOwner"];
