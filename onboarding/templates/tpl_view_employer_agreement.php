                                ...
                                <tr>
                                    ...
                                    <td class="text-blue">
                                        <span class="text-blue">
                                            ...
                                            echo $tp_location->postcode != '' ? $tp_location->postcode : '';
                                            ?>
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <?php if($agreement->status == EmployerAgreement::TYPE_COMPLETED){?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                             echo DB_NAME != "am_ela" ? 
                                                DAO::getSingleValue($link, "SELECT CONCAT(firstnames, ' ', surname) FROM users WHERE id = '{$agreement->provider_sign_id}'"): 
                                                $agreement->provider_sign_name;
                                            ?>
                                        </td>
                                        <td>
