...
<div class="row">
    <div class="col-sm-12">
        <table class="table row-border">
            ...
            <tr>
                <td>When you were in secondary school, were you eligible for free school meals?</td>
...
<div class="row">
    <div class="col-sm-12">
        ...
        <table class="table row-border">
            ...
            <tr>
                <td>Have you been asked to contribute to the cost of this programme?</td>
	...
	<table class="table row-border">
	    ...
	    <tr>
            ...
            <tr>
                <td>Are you attending School or College for any other Further or Higher Education training apart from this programme?</td>
        ...
        <table class="table">
            ...
            <tr><td>Date of first entry to the UK:</td><td><input class="datecontrol compulsory form-control" type="text" id="date_of_first_uk_entry" name="date_of_first_uk_entry" value="<?php echo Date::toShort($tr->date_of_first_uk_entry); ?>" size="10" maxlength="10" placeholder="dd/mm/yyyy" /></td></tr>
            <tr><td>Date of most recent entry to the UK (excluding holidays):</td><td><input class="datecontrol compulsory form-control" type="text" id="date_of_most_recent_uk_entry" name="date_of_most_recent_uk_entry" value="<?php echo Date::toShort($tr->date_of_most_recent_uk_entry); ?>" size="10" maxlength="10" placeholder="dd/mm/yyyy" /></td></tr>
            <tr>
                ...
                <td>
                    <input type="file" class="form-control optional" name="evidence_ilr" id="evidence_ilr" value=""  />
                    <?php 
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <input type="file" class="form-control optional" name="evidence_previous_uk_study_visa" id="evidence_previous_uk_study_visa" value=""  />
                    <?php 
