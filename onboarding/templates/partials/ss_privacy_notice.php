<div style="text-align: justify; text-justify: inter-word;">
    ...
    <div class="table-responsive">
        <table class="table table-bordered  text-blue">
            ...
            <tr class="bg-gray">
                <td>
                    <input class="clsICheck" type="checkbox" name="disclaimer[]" value="2" /><label>I agree to promote and adhere to Equal Opportunity and Diversity policies on race, gender, age, disability, religion or belief and sexual orientation within the Apprenticeship Programme.</label>
                </td>
            </tr>
            <tr class="bg-gray">
                <td>
                    <input class="clsICheck" type="checkbox" name="disclaimer[]" value="3" /><label>I have read and understood GDPR statement regarding my personal data.</label>
                </td>
            </tr>
        </table>
    </div>
