        ...
        <div class="well well-sm">
            <p>
                <span class="text-bold">
                    Please detail all qualifications fully or partly achieved, including any apprenticeships you may have completed or part completed, even if it is not related to the programme you are applying for.
                </span>
                (Include all qualifications that may be related to this programme, including Maths, English, ICT, Digital, Health & Safety, Manual Handling, etc.)
            </p>
        </div>
        <div style="max-height: 600px; overflow-y: scroll;">
            <table class="table table-responsive row-border cw-table-list">
                <tr><th style="width: 25%;">GCSE/A/AS Level</th><th style="width: 25%;">Subject</th><th style="width: 12%;">Predicted Grade</th><th style="width: 12%;">Actual Grade</th><th style="width: 15%;">Date Completed</th><th>Evidence available</th></tr>
                <tbody>
                <tr>
		    ...
		    <td><?php echo HTML::selectChosen("gcse_english_evi_avail", [["Yes", "Yes"], ["No", "No"]], (isset($ob_eng->evi_available) ? $ob_eng->evi_available : null), true); ?></td>
                </tr>
                <tr>
		    ...
		    <td><?php echo HTML::selectChosen("gcse_maths_evi_avail", [["Yes", "Yes"], ["No", "No"]], (isset($ob_maths->evi_available) ? $ob_maths->evi_available : null), true); ?></td>
                </tr>
                <tr>
		    ...
		    <td><?php echo HTML::selectChosen("gcse_ict_evi_avail", [["Yes", "Yes"], ["No", "No"]], (isset($ob_ict->evi_available) ? $ob_ict->evi_available : null), true); ?></td>
                </tr>
                <?php
			...
			echo '<td>' . HTML::selectChosen('evi_available'.$i, [["Yes", "Yes"], ["No", "No"]], isset($ob_q->evi_available)?$ob_q->evi_available:'', true, false, true) . '</td>';
                        echo '</tr>';
                    }
                }
		else
        ...
        <div class="callout callout-default">
            <table class="table table-responsive row-border cw-table-list">
                <tr style="background-color: #e0ffff;">
                    <td colspan="5">
                        <label>Prior Attainment / Highest Qualification Level</label>
                        <p>
