...
<div class="row">
    <div class="col-sm-8">
			<span class="btn btn-info" onclick="getSignature();">
				<?php if (is_null($skills_analysis->learner_sign)) { ?>
                ...
                <?php } else { ?>
                    <img id="img_learner_sign"
                         src="do.php?_action=generate_image&title=<?php echo $skills_analysis->learner_sign; ?>&size=20"
                         style="border: 2px solid;border-radius: 15px; width: 100%;"/>
                <?php } ?>
...
<!-- <div class="callout callout-info"><span class="fa fa-info-circle"></span> Please bring copies / or originals of your
    ...
    have an education health care plan, etc. to your on-boarding induction day if you have had trouble uploading them today.
</div> -->
