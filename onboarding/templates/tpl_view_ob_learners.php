...
<head>
    ...
    <title>Sunesis: View Onboarding Learners</title>
...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;">Onboarding Learners</div>
            <div class="ButtonBar">
                ...
                <span class="btn btn-xs btn-default" onclick="window.location.href='do.php?_action=add_edit_ob_learners';"><i class="fa fa-plus"></i> Add New Apprenticeship Learner</span>
            </div>
            <div class="ActionIconBar">
                ...
                <span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="exportToExcel('view_ViewObLearners');" title="Export to .csv file"></span>
    ...
    <div class="row">
        <div class="small" id="div_filters" style="display: none;">
            <form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" name="frmFilters">
                <input type="hidden" name="_action" value="view_ob_learners" />
                ...
                <div id="filterBox" class="clearfix">
                    <fieldset>
                        ...
                        <div class="field float"><label>Archive:</label> <?php echo $view->getFilterHTML('filter_archive'); ?></div>
