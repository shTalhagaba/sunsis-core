...
<head xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
    ...
    <title>Sunesis: View Contract Holder</title>
...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;">View Contract Holder</div>
            <div class="ButtonBar">
                <span class="btn btn-sm btn-default" onclick="window.location.href='<?php echo $_SESSION['bc']->getPrevious(); ?>';"><i class="fa fa-arrow-circle-o-left"></i> Cancel</span>
                <span class="btn btn-sm btn-default" onclick="window.location.href='do.php?_action=edit_contractholder&edit=1&id=<?php echo $vo->id; ?>';"><i class="fa fa-edit"></i> Edit</span>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <dl class="dl-horizontal">
                                ...
                                <dt>UPIN:</dt><dd><span class="text-muted"><?php echo $vo->upin; ?></span></dd>
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="active tab-pane" id="tabLocations">
                        ...
                        <div class=""><?php $this->renderLocations($link,'read_contractholder'); ?></div>
                    </div>
                    ...
                    <div class="tab-pane" id="tabCRMNotes">
                        ...
                        <div class="table-responsive"><?php $this->renderCRMNotes($link,'read_contractholder'); ?></div>
                    </div>
                    <div class="tab-pane" id="tabCRMContacts">
                        <p><span onclick="window.location.href='do.php?_action=edit_crm_contact&org_type=contractholder&org_id=<?php echo $vo->id; ?>'" class="btn btn-primary btn-xs"> <i class="fa fa-plus"></i> Add New CRM Contact</span></p>
