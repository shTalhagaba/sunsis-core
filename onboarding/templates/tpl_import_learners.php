...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;">Learners Import </div>
            <div class="ButtonBar">
...
<div class="container-fluid">
    ...
    <form class="form-horizontal" name="frmImportLearners" id="frmImportLearners"
          action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"  enctype="multipart/form-data">
        <input type="hidden" name="_action" value="import_learners" />
            ...
            <div class="col-sm-7">
                <div class="box box-solid box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-sm-12">
                            <p><br></p>
                            <input type="file" name="file_learners" />
                        </div>
                    </div>
        ...
        <div class="col-sm-12">
            <div class="table-responsive">
                <table class="table table-bordered table-condensed">
                    ...
                    <?php
                    $records = DAO::getResultset($link, "SELECT * FROM data_imports WHERE import_entity = 'learner' ORDER BY import_timestamp DESC", DAO::FETCH_ASSOC);
                    if($records == 0)
                    {
                    ...
                    else
                    {
                        foreach($records AS $row)
                        {
                            ...
                            if(is_file(Repository::getRoot() . "/DataImports/learners/" . $row['import_file']))
                            {
                                $file = new RepositoryFile(Repository::getRoot() . "/DataImports/learners/" . $row['import_file']);
...
<script language="JavaScript">
    ...
    {
        var req = ajaxRequest('do.php?_action=import_learners&subaction=removeEntry&import_id='+encodeURIComponent(import_id));
        if(req)
        {
