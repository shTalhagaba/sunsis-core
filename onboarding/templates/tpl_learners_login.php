...
<head>
    ...
    <title>Sunesis | Learners Login </title>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="box box-default">
                <div class="box-header with-border"><i class="fa fa-warning"></i><h3 class="box-title">Disclaimer</h3></div>
                <div class="box-body">
        ...
        <div class="col-sm-6">
            <div class="login-box">
                <form style="margin-top: 15px;" role="form" name="login"
                      action="<?php echo $_SERVER['PHP_SELF'] . '?_action=learners_login' ?>" method="post" autocomplete="off">
                    ...
                    <div class="form-group">
                        <input type="checkbox" name="chkAgreeDisclaimer" id="chkAgreeDisclaimer"/><label>I agree to
                            disclaimer</label>
                    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="text-center">
                ...
                | <a href="#" id="myBtn">Privacy Policy</a>
                <br>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding:10px 10px; max-height: 450px; overflow-y: scroll;">
                <div class="row">
                    <div class="col-sm-12">
                        <p class="text-center"><h3 class="text-bold text-center">Privacy Policy</h3></p>
                        ...
                        <p><i>It is important to point out that we may amend this Privacy Policy from time to time. We will post any changes here</i></p>
                        <p class="text-bold">1. What does this policy cover?</p>
                        <p>This policy applies to personal data which we process on behalf of and strictly upon instruction of our client, the Controller.</p>
                        ...
                        <p style="margin-left: 35px; font-style: italic;">
                            3rd Party service providers who process your data are:
                            Blue Copper Technology Ltd ? Hosting Service ? UK Based
