...
<head>
    ...
    <script type="text/javascript">
	    ...
	    var phpClient = '<?php echo DB_NAME; ?>';
        var phpLearnerSignature = '<?php echo $tr->getSign($link); ?>';
        var phpAgeAtStart = '<?php echo $ageAtStart; ?>';
    </script>
    ...
    <div class="container" id="main_container" style="min-height: 500px;">
        <content id="landingPage" >
            <div style="background:transparent !important" class="jumbotron text-center">
                ...
                <div class="callout callout-default text-left">
                    <p>As part of our apprenticeship programme of <span class="text-info"> <?php echo $framework->title; ?></span>, you are required to complete this Skills Analysis questionnaire. </p>
                    <p>Please click "Start Skills Analysis" button and complete your skills analysis. </p>
            ...
            <div class="text-center">
                <button id="btnStartOnboarding" onclick="$('#landingPage').hide(); $('#contentForm').show();$('#main_container').removeClass('container');$('#main_container').removeClass('container-fluid')" style=" padding-left: 50px; padding-right: 50px;" class="btn btn-lg btn-primary text-uppercase">
                    <strong>Start Skills Analysis</strong>&nbsp; <i class="fa fa-play"></i>
                </button>
        ...
        <content id="contentForm" style="display: none;">
            <div class="nts-secondary-teaser-gradient">
                <div class="container">
                    <h3>Apprenticeship Skills Analysis for <?php echo $ob_learner->firstnames . ' ' . $ob_learner->surname; ?></h3>
                </div>
            </div>
            <br>
            <form class="form-horizontal" name="frmSkillsScan" id="frmSkillsScan" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" autocomplete="off" enctype="multipart/form-data">
                <input type="hidden" name="_action" value="<?php echo (DB_NAME == "am_ela" && $tr->practical_period_start_date > '2023-06-31') ? "save_form_skills_scan_ela" : "save_form_skills_scan"; ?>" />
		...
		<?php } ?>
                ...
                <step id="step5">
                    ...
                    <?php include_once(__DIR__ . '/partials/ss_ksb_.php'); ?>
                </step>
