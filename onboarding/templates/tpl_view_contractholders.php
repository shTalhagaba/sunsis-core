...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;">Contract Holders</div>
            <div class="ButtonBar">
                <span class="btn btn-sm btn-default" onclick="window.location.href='<?php echo $_SESSION['bc']->getPrevious(); ?>';"><i class="fa fa-arrow-circle-o-left"></i> Cancel</span>
                <?php if($_SESSION['user']->isAdmin()) { ?><span class="btn btn-sm btn-default" onclick="window.location.href='do.php?_action=edit_contractholder';"><i class="fa fa-plus"></i> Add New</span><?php } ?>
            </div>
            <div class="ActionIconBar">
                ...
                <span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="exportToExcel('view_ViewContractHolders');" title="Export to .CSV file"></span>
    ...
    <div class="row">
        <div id="div_filters" style="display: none;">
            <form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" name="frmFilters">
                <input type="hidden" name="_action" value="view_contractholders" />
