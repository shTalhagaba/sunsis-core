...
<head>
    ...
    <title>Sunesis: View Learners</title>
    ...
    <div class="col-lg-12">
        <div class="banner">
            ...
            <div class="ButtonBar">
                ...
                <span class="btn btn-xs btn-default" onclick="window.location.href='do.php?_action=view_home_page_learners_list&id=&employer_id=';"><i class="fa fa-plus"></i> Add New</span>
            </div>
            <div class="ActionIconBar">
                ...
                <span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="exportToExcel('view_HomePageLearnersList');" title="Export to .csv file"></span>
    ...
    <div class="row">
        <div class="small" id="div_filters" style="display: none;">
            <form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" name="frmFilters">
                <input type="hidden" name="_action" value="view_home_page_learners_list" />
