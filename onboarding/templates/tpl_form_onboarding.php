...
<head>
    ...
    <title>Sunesis | Onboarding Questionnaire</title>
    ...
    <div class="container" id="main_container" style="min-height: 500px;">
        <content id="landingPage" >
            <div style="background:transparent !important" class="jumbotron text-center">
                ...
                <div class="callout callout-default text-left">
                    <p>As part of our apprenticeship programme of <span class="text-info"> <?php echo $framework->title; ?></span>, you are required to confirm your details and complete Onboarding Questionnaire.</p>
        ...
        <content id="contentForm" style="display: none;">
            <div class="nts-secondary-teaser-gradient">
                <div class="container">
                    <h3>Apprenticeship Enrolment / Training Plan for <?php echo $ob_learner->firstnames . ' ' . $ob_learner->surname; ?></h3>
                </div>
            </div>
            <br>
            <form class="form-horizontal" name="frmOnboarding" id="frmOnboarding" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" autocomplete="off" enctype="multipart/form-data">
                ...
                <step id="step3">
                    ...
                    <?php 
                    // if($tr->practical_period_start_date >= '2023-08-01' && (in_array(DB_NAME, ['am_ela', 'am_demo', 'am_sd_demo', 'am_superdrug'])) && !in_array($tr->id, OnboardingHelper::UlnsToSkip($link)) )
                    //     include_once(__DIR__ . '/partials/ob_als_ela.php'); 
                    // else    
                    //     include_once(__DIR__ . '/partials/ob_als.php');
                    include_once(__DIR__ . '/partials/ob_als_ela.php'); 
                    ?>
                </step>
