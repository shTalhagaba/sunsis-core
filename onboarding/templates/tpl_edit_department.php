...
<head>
    ...
    <title><?php echo $department->id == ''?'Create Department':'Edit Department'; ?></title>
...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;"><?php echo $department->id == ''?'Create Department':'Edit Department'; ?></div>
            <div class="ButtonBar">
...
<div class="container-fluid">
    <form class="form-horizontal" name="frmDepartment" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        <input type="hidden" name="id" value="<?php echo $department->id; ?>" />
        <input type="hidden" name="main_location_id" value="<?php echo $mainLocation->id; ?>" />
        <input type="hidden" name="_action" value="save_department" />
        <div class="row">
            <div class="col-sm-7">
                <div class="box box-solid box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="company_number" class="col-sm-4 control-label fieldLabel_compulsory">Department Code:</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control compulsory" name="company_number" id="company_number" value="<?php echo $department->company_number; ?>" maxlength="10" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="legal_name" class="col-sm-4 control-label fieldLabel_compulsory">Department Name:</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control compulsory" name="legal_name" id="legal_name" value="<?php echo $department->legal_name; ?>" maxlength="200" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="legal_name" class="col-sm-4 control-label fieldLabel_compulsory">Delivery Partner:</label>
                            <div class="col-sm-8">
                                <?php echo HTML::selectChosen('delivery_partner', $providers, $department->delivery_partner, true, true); ?>
                            </div>
                        </div>
                        <input type="hidden" class="form-control compulsory" name="full_name" id="full_name" value="<?php echo $mainLocation->full_name == '' ? 'Main Site' : $mainLocation->full_name; ?>" maxlength="50" />
                        <div class="callout callout-default">
                            <h5 class="text-bold text-blue">Address</h5>
                            <div class="form-group">
                                <label for="address_line_1" class="col-sm-4 control-label fieldLabel_compulsory">Line 1:</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <label for="address_line_2" class="col-sm-4 control-label fieldLabel_optional">Line 2:</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <label for="address_line_3" class="col-sm-4 control-label fieldLabel_optional">Line 3:</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                <label for="address_line_4" class="col-sm-4 control-label fieldLabel_optional">Line 4:</label>
                                <div class="col-sm-8">
                        ...
                        <div class="callout callout-default">
                            <h5 class="text-bold text-blue">Head of Department Details</h5>
                            <div class="form-group">
                                <label for="contact_name" class="col-sm-4 control-label fieldLabel_optional">Name:</label>
                                <div class="col-sm-8">
...
<script language="JavaScript">
    ...
    function save()
    {
        var myForm = document.forms["frmDepartment"];
