    ...
    <div class="col-lg-12">
        <div class="banner">
            ...
            <div class="ButtonBar">
                ...
                <?php if($_SESSION['user']->isAdmin() || in_array($_SESSION['user']->username, ["sjenkins", "srodway1", "adickens"]) ){ ?>
                    <span class="btn btn-xs btn-default" onclick="window.location.replace('do.php?_action=edit_qualification&id=<?php echo rawurlencode($vo->id); ?>&internaltitle=<?php echo rawurlencode($internaltitle);?>&auto_id=<?php echo $vo->auto_id; ?>');"><i class="fa fa-edit"></i> Edit</span>
                    <span class="btn btn-xs btn-default" onclick="window.location.replace('do.php?_action=view_qualification_tabular&id=<?php echo rawurlencode($vo->id); ?>&clients=<?php echo rawurlencode($clients)?>&internaltitle=<?php echo rawurlencode($internaltitle);?>&auto_id=<?php echo $vo->auto_id;?>');">Tabular View</span>
                <?php } ?>
            </div>
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr><th>Provider Code</th><td class="bg-success"><?php echo $vo->ebs_ui_code; ?></td></tr>
                        ...
                        <tr><th>Description</th><td class="bg-success"><?php echo nl2br($vo->description); ?></td></tr>
                        <tr><th>Assessment Method</th><td class="bg-success"><?php echo nl2br($vo->assessment_method); ?></td></tr>
