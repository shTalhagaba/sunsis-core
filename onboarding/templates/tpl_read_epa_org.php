	...
	<div class="col-sm-4">
		<div class="box box-primary">
            ...
            <div class="box-footer">
                <span class="btn btn-sm btn-primary" onclick="addRemoveFlagOnEpaOrg('<?php echo $EPA_Org->EPA_ORG_ID; ?>');">
                    <i class="fa fa-flag"></i> <?php echo $exists_in_client_db > 0 ? 'Remove Flag' : 'Set Flag'; ?>
                </span>
            </div>
		</div>
	</div>
							...
							<div class="table-responsive">
								<table class="table table-bordered table-hover">
									...
									foreach($EPA_Org_Standards AS $Standard)
									{
										...
										echo "<td>";
										echo "Effective&nbsp;From:&nbsp;" . str_replace(" ", "&nbsp;", Date::toShort($Standard['EffectiveFrom'])) . "<br>";
										echo "Effective&nbsp;To:&nbsp;" . str_replace(" ", "&nbsp;", Date::toShort($Standard['EffectiveTo'])) . "<br>";
										echo "</td>";
...
<script>
	...
	function addRemoveFlagOnEpaOrg(EPA_ORG_ID)
    {
        if(EPA_ORG_ID == '')
            return ;

        var client = ajaxRequest('do.php?_action=ajax_helper&subaction=addRemoveFlagOnEpaOrg&EPA_ORG_ID='+encodeURIComponent(EPA_ORG_ID));
        if(client)
        {
