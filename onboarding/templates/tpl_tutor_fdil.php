                ...
                <div class="row vertical-center-row">
                    <div class="col-sm-12" style="background-color: white;">
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="frmFdil">
                            <input type="hidden" name="_action" value="save_tutor_fdil">
			    ...
			    <?php if($funding_year == 2023) {?>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <td>
                                                <?php echo nl2br($fdil->learner_comments); ?>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-center">
                                    <img src="do.php?_action=generate_image&<?php echo $fdil->learner_sign != '' ? $fdil->learner_sign : 'title=Not yet signed&font=Signature_Regular.ttf&size=25'; ?>" style="border: 2px solid;border-radius: 15px;" /><br>
                                    <br>
                                </div>
                                <div class="col-sm-3">
                                    <?php echo $fdil->learner_sign_date != '' ? Date::toShort($fdil->learner_sign_date) : ''; ?>
                                </div>
                            </div>

                            <div class="row">
                                <div class="col-sm-3">
                                    <input type="text" name="tutor_sign_name" id="tutor_sign_name" value="<?php echo $fdil->tutor_sign_name != '' ? $fdil->tutor_sign_name : $fdil->fdil_trainer_name; ?>" maxlength="70" />
                                </div>
                                <div class="col-sm-6 text-center">
                                    <span class="btn btn-info" onclick="getSignature();">
                                        <img id="img_tutor_sign" src="do.php?_action=generate_image&title=Click here to sign&font=Signature_Regular.ttf&size=20" style="border: 2px solid;border-radius: 15px; width: 100%;" />
                                        <input type="hidden" name="tutor_sign" id="tutor_sign" value="" />
                                    </span>
                                </div>
                                <div class="col-sm-3">
                                    <?php echo date('d/m/Y'); ?>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $( "#panel_signature" ).dialog({
                ...
                buttons: {
                    'Add': function() {
                        $("#img_tutor_sign").attr('src',$('.sigboxselected').children('img')[0].src);
                        $("#tutor_sign").val($('.sigboxselected').children('img')[0].src);
                        $(this).dialog('close');
                    },
        ...
        function getSignature(user) {
            $('#signature_text').val($('#tutor_sign_name').val());
        ...
        function submitInformation() {
            ...
            var tutor_sign = frmFdil.elements["tutor_sign"];


            if (tutor_sign.value.trim() == '') {
