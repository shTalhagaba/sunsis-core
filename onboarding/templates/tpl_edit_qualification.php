...
<div class="banner">
    <div class="Title">Create / Edit Qualification [<?php echo htmlspecialchars($vo->title); ?>]</div>
    <div class="ButtonBar">
...
<div id="demo" class="yui-navset" style="margin-top:10px">
    ...
    <div class="yui-content">
            ...
            <form name="form1" action="" method="POST">
                ...
                <table border="0" cellspacing="4" cellpadding="4">
                    ...
                    <tr>
                        ...
                        <td><input class="optional" type="text" id="tqt" name="tqt" value="<?php echo $vo->tqt; ?>" size="4" maxlength="4" onkeypress="return numbersonly(this);" /></td>
                    </tr>
                    <tr>
        ...
        <div id="tab2">
            <h3> Internal Title: <?php echo htmlspecialchars($vo->title); ?> <img id="globe5" src="/images/rotatingGlobe.gif" style="vertical-align:text-bottom;visibility:hidden;" /></h3>
