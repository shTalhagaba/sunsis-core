...
<div class="row">
	<div class="col-lg-12">
		<div class="banner">
			<div class="Title" style="margin-left: 6px;">Providers</div>
			<div class="ButtonBar">
				...
				<?php if($_SESSION['user']->isAdmin()) { ?><span class="btn btn-xs btn-default" onclick="window.location.href='do.php?_action=edit_trainingprovider';"><i class="fa fa-plus"></i> Add New</span><?php } ?>
			</div>
