...
<body>
    <div class="row">
        <div class="col-sm-12">
            <div class="banner">
                <div class="Title" style="margin-left: 6px;">Employer Health & Safety Form</div>
                <div class="ButtonBar">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header text-center">
            <h1><strong>Work Placement Health and Safety Checklist</strong></h1>
        </section>
                ...
                <div class="row vertical-center-row">
                    <div class="col-sm-12" style="background-color: white;">
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="frmEmployerHsForm">
                            <input type="hidden" name="_action" value="save_employer_health_safety_form">
                                ...
                                <div class="col-sm-12">
                                    <table class="table table-bordered">
                                            ...
                                            <td>
                                                <table class="table row-border">
                                                    <tr>
                                                        ...
                                                        <td><?php echo isset($employer_rep_contact->contact_name) ? $employer_rep_contact->contact_name : ''; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Telephone Number</th>
                                                        <td><?php echo isset($employer_rep_contact->contact_telephone) ? $employer_rep_contact->contact_telephone : ''; ?></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><?php echo $employer->site_employees; ?></td>
                                            <td>
                                                <table class="table row-border">
                                                    <tr>
                                                        <th>Health & Safety contact name and email</th>
                                                        <td><?php echo isset($hs_contact->contact_name) ? $hs_contact->contact_name : ''; ?><br><?php echo isset($hs_contact->contact_name) ? $hs_contact->contact_email : ''; ?></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <table class="table row-border">
                                                    <tr>
                                                        <th>Telephone</th>
                                                        <td><?php echo $mainLocation->telephone; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Fax</th>
                                                        <td><?php echo $mainLocation->fax; ?></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2"><?php echo $employer->url; ?></td>
                                        </tr>
                                        <tr>
                                            <th>ERN</th>
                                            <td colspan="2"><?php echo $employer->edrs; ?></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="box box-success box-solid small">
                                        <div class="box-header">
                                            <span class="box-title text-center">Health and Safety Action Plan</span>
                                        </div>
                                        <div class="box-body">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    for ($i = 1; $i <= 3; $i++) {
                                                        ...
                                                        echo '<tr>';
                                                        echo '<td>';
                                                        echo isset($detail->$ref) ?
                                                            '<input class="form-control" type="text" size="5" name="' . $ref . '" id="' . $ref . '" value="' . $detail->$ref . '">' :
                                                            '<input class="form-control" type="text" size="5" name="' . $ref . '" id="' . $ref . '">';
                                                        echo '</td>';
                                                        echo '<td>';
                                                        echo isset($detail->$action) ?
                                                            '<textarea rows="3"  style="width: 100%;" name="' . $action . '" id="' . $action . '">' . nl2br($detail->$action) . '</textarea>' :
                                                            '<textarea rows="3"  style="width: 100%;" name="' . $action . '" id="' . $action . '"></textarea>';
                                                        echo '</td>';
                                                        echo '<td>';
                                                        echo isset($detail->$by) ?
                                                            '<input class="form-control" type="text" name="' . $by . '" id="' . $by . '" value="' . $detail->$by . '">' :
                                                            '<input class="form-control" type="text" name="' . $by . '" id="' . $by . '">';
                                                        echo '</td>';
                                                        echo isset($detail->$rd) ? '<td>' . HTML::datebox($rd, $detail->$rd) . '</td>' : '<td>' . HTML::datebox($rd, '') . '</td>';
                                                        echo '<td align="center">';
                                                        echo isset($detail->comp) ? '<input type="checkbox" name="' . $comp . '" id="' . $comp . '" checked>' : '<input type="checkbox" name="' . $comp . '" id="' . $comp . '">';
                                                        echo '</td>';
                                                        echo '</tr>';
                                                    }
                                                    ?>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="box box-success box-solid small">
                                        <div class="box-header">
                                            <span class="box-title text-center">Health and Safety Assessment Outcome</span>
                                        </div>
                                        <div class="box-body">
                                            <table class="table table-bordered">
                                                <tr>
                                                    ...
                                                    <th class="text-success text-center">
                                                        Suitable <br>
                                                        <input type="radio" name="recommendation" value="1" <?php echo (isset($detail->recommendation) && $detail->recommendation == '1') ? 'checked' : ''; ?> />
                                                    </th>
                                                    <th class="text-info text-center">
                                                        Suitable with action plan<br>
                                                        <input type="radio" name="recommendation" value="2" <?php echo (isset($detail->recommendation) && $detail->recommendation == '2') ? 'checked' : ''; ?> />
                                                    </th>
                                                    <th class="text-danger text-center">
                                                        Unsuitable <br>
                                                        <input type="radio" name="recommendation" value="3" <?php echo (isset($detail->recommendation) && $detail->recommendation == '3') ? 'checked' : ''; ?> />
                                                    </th>
                                                </tr>
                                                <tr>
                                                    <th>Risk Category</th>
                                                    <th class="text-danger text-center">
                                                        High <br>
                                                        <input type="radio" name="risk_category" value="High" <?php echo (isset($detail->risk_category) && $detail->risk_category == 'High') ? 'checked' : ''; ?> />
                                                    </th>
                                                    <th class="text-info text-center">
                                                        Medium<br>
                                                        <input type="radio" name="risk_category" value="Medium" <?php echo (isset($detail->risk_category) && $detail->risk_category == 'Medium') ? 'checked' : ''; ?> />
                                                    </th>
                                                    <th class="text-success text-center">
                                                        Low <br>
                                                        <input type="radio" name="risk_category" value="Low" <?php echo (isset($detail->risk_category) && $detail->risk_category == 'Low') ? 'checked' : ''; ?> />
                                                    </th>
                                                </tr>
                                            </table>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="box box-success box-solid small">
                                        <div class="box-header">
                                            <span class="box-title text-center">Health and Safety Assessment Type</span>
                                        </div>
                                        <div class="box-body">
                                            <table class="table table-bordered">
                                                <tr>
                                                    <th class="text-center">
                                                        ...
                                                        <input type="radio" name="assessment_type" value="1" <?php echo $hs->assessment_type == 1 ? 'checked' : '';?> />
                                                    </th>
                                                    <th class="text-center">
                                                        Re-Assessment <br>
                                                        <input type="radio" name="assessment_type" value="2" <?php echo $hs->assessment_type == 2 ? 'checked' : '';?> />
                                                    </th>
                                                    <th class="text-center">
                                                        Other (please specify) <br>
                                                        <input type="radio" name="assessment_type" value="3" <?php echo $hs->assessment_type == 3 ? 'checked' : '';?> /> <br>
                                                        <textarea name="assessment_type_other" id="assessment_type_other" style="width: 100%;" rows="2"><?php echo nl2br($hs->assessment_type_other); ?></textarea>
                                                    </th>
                                                </tr>
                                            </table>
                            ...
                            <div class="row">
                                <div class="col-sm-12 table-responsive">
                                    <table style="margin-top: 5px;" class="table table-bordered">
                                        <tr>
                                            <th colspan="4" class="bg-gray">Signatures</th>
                                        </tr>
                                        <tr>
                                            <th>&nbsp;</th>
                                            <th>Name</th>
                                        ...
                                        <tr>
                                            <td>Employer</td>
                                            <td>
                                                <?php echo $hs->employer_sign_name; ?>
                                            </td>
                                            <td>
                                                <img id="img_m_sign" src="do.php?_action=generate_image&<?php echo $hs->employer_sign; ?>" style="border: 2px solid;border-radius: 15px;" />
                                            </td>
                                            <td>
                                                <?php echo Date::toShort($hs->employer_sign_date); ?>
                                            </td>
                                        </tr>
                                        <?php if ($hs->provider_sign == '') { ?>
                                        <tr>
                                            <td>Provider</td>
                                            <td>
                                            ...
                                            <td>
                                                <span class="btn btn-info" onclick="getSignature('provider');">
                                                    <img id="img_provider_sign" src="do.php?_action=generate_image&<?php echo $hs->provider_sign != '' ? $hs->provider_sign : 'title=Click here to sign&font=Signature_Regular.ttf&size=25'; ?>" style="border: 2px solid;border-radius: 15px;" />
                                                    <input type="hidden" name="provider_sign" id="provider_sign" value="<?php echo $hs->provider_sign; ?>" />
                                                </span>
                                            </td>
                                            <td>
                                                <?php echo $hs->provider_sign_date != '' ? Date::toShort($hs->provider_sign_date) : date('d/m/Y'); ?>
                                            </td>
                                        </tr>
                                        <?php } else { ?>
                                            <tr>
                                                <td>Provider</td>
                                                <td>
                                                    <?php echo $hs->provider_sign_name; ?>
                                                </td>
                                                <td>
                                                    <img src="do.php?_action=generate_image&<?php echo $hs->provider_sign; ?>" style="border: 2px solid;border-radius: 15px;" />
                                                </td>
                                                <td>
                                                    <?php echo Date::toShort($hs->provider_sign_date); ?>
                                                </td>
                                            </tr>
                                        <?php } ?>                                        
                                    </table>
    ...
    <script type="text/javascript">
        var phpProviderSignature = '<?php echo is_null($hs->provider_sign) ? $_SESSION['user']->signature : $hs->provider_sign; ?>';
        // var phpVerifierSignature = '';
            ...
            $("#panel_signature").dialog({
                ...
                buttons: {
                    'Create': function() {
                        ...
                        var sign_field = '';
                        if (panel == 'provider') {
                            sign_field = 'provider_sign';
                        }
                        // if (panel == 'verifier') {
                        //     sign_field = 'verifier_sign';
                        // }
        ...
        function getSignature(user) {
            ...
            //         $('#signature_text').val('');
            //         $("#panel_signature").data('panel', 'verifier').dialog("open");
            //         return;
            //     }
            //     $('#img_verifier_sign').attr('src', 'do.php?_action=generate_image&' + window.phpVerifierSignature);
            //     $('#verifier_sign').val(window.phpVerifierSignature);
