...
<head>
	...
	<title>Standards/ Programmes</title>
...
<div class="row">
	<div class="col-lg-12">
		<div class="banner">
			<div class="Title" style="margin-left: 6px;">Standards/ Programmes</div>
			<div class="ButtonBar">
				<?php if($_SESSION['user']->type != User::TYPE_SYSTEM_VIEWER && $_SESSION['user']->type != User::TYPE_ORGANISATION_VIEWER) {?>
				<button class="btn btn-default btn-xs" onclick="window.location.href='do.php?_action=edit_framework';"><i class="fa fa-plus"></i> Create New Programmes</button>
				<?php } ?>
			</div>
			<div class="ActionIconBar">
				...
				<span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="exportToExcel('view_ViewFrameworks');" title="Export to .CSV file"></span>
				...
				<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" name="applyFilter" id="applyFilter">
					...
					<div id="filterBox" class="clearfix small">
						<fieldset>
							...
							<div class="field float"><label>Type:</label><?php echo $view->getFilterHTML('filter_framework_type'); ?></div>
