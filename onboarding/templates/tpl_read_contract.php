...
<div class="row">
	<div class="col-lg-12">
		<div class="banner">
			<div class="Title" style="margin-left: 6px;"><?php echo htmlspecialchars($vo->title); ?></div>
			<div class="ButtonBar">
...
<div class="row">
	<div class="col-sm-7">
		<div class="col-sm-12">
			<div class="callout">
				<h4><?php echo htmlspecialchars($vo->title); ?> &nbsp;  &nbsp; <i class="text-muted"><?php echo Date::toShort($vo->start_date) . ' - ' . Date::toShort($vo->end_date); ?></i> </h4>
				<dl class="dl-horizontal">
					<dt>Contract Holder: </dt><dd><?php echo htmlspecialchars($contract_holder); ?></dd>
					<dt>Location: </dt><dd><?php echo htmlspecialchars($contract_location); ?></dd>
					<dt>UKPRN: </dt><dd><?php echo htmlspecialchars($vo->ukprn); ?></dd>
					<dt>UPIN: </dt><dd><?php echo htmlspecialchars($vo->upin); ?></dd>
				</dl>
				<?php echo $vo->funded == "1" ? '<label class="label label-success">Funded</label>' : '<label class="label label-info">Non Funded</label>'; ?>
				<?php echo $vo->funding_type == "1" ? '<label class="label label-success">Included in Success Rates</label>' : '<label class="label label-info">Not Included in Success Rates</label>'; ?>
