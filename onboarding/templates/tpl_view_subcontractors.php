...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;">Subcontractors</div>
            <div class="ButtonBar">
                ...
                <?php if($_SESSION['user']->isAdmin()) { ?><span class="btn btn-xs btn-default" onclick="window.location.href='do.php?_action=edit_subcontractor';"><i class="fa fa-plus"></i> Add New</span><?php } ?>
            </div>
            <div class="ActionIconBar">
                ...
                <span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="exportToExcel('view_ViewSubcontractors');" title="Export to .csv file"></span>
    ...
    <div class="row">
        <div class="small" id="div_filters" style="display: none;">
            <form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" name="frmFilters">
                <input type="hidden" name="_action" value="view_subcontractors" />

                <div id="filterBox" class="clearfix">
                    <fieldset>
                        <div class="field float"><label>Legal Name:</label> <?php echo $view->getFilterHTML('filter_legal_name'); ?></div>
                        <div class="field float"><label>UKPRN:</label> <?php echo $view->getFilterHTML('filter_ukprn'); ?></div>
