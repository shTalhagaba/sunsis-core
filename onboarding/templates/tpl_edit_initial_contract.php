...
<head>
    ...
    <title>Sunesis | Employer Agreement - Initial Contract</title>
...
<body>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="banner">
                <div class="Title" style="margin-left: 6px;">Initial Contract</div>
                <div class="ButtonBar">
                    ...
                    <span class="btn btn-xs btn-default btn-save" onclick="submitSchedule();"><i class="fa fa-save"></i> Save Information</span>
                </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="frmSchedule">
                <input type="hidden" name="_action" value="save_initial_contract">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-bordered">
                            ...
                            <col width="20%">
                            <tr>
                                <th colspan="6" class="bg-gray">Section 1 - Employer and Apprentice Details</th>
                            </tr>
                            <tr>
                                <th rowspan="4">1.1</th>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><?php echo Date::dateDiff($tr->practical_period_start_date, $ob_learner->dob); ?></td>
                            </tr>
                            <tr>
                                <th>ULN</th>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-bordered">
                            ...
                            <col width="70%">
                            <tr>
                                <th colspan="3" class="bg-gray">Section 2 - Apprenticeship Programme</th>
                            </tr>
                            <tr>
                                <th>2.1</th>
                            ...
                            <tr>
                                <th>2.6</th>
                                <th>Proposed Practical Period Start Date</th>
                                <td>
                                    <?php 
                            ...
                            <tr>
                                <th>2.7</th>
                                <th>Proposed Practical Period End Date</th>
                                <td>
                                    <?php 
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-bordered">
                            ...
                            <col width="70%">
                            <tr>
                                <th colspan="3" class="bg-gray">Section 3 - Training Provider</th>
                            </tr>
                            <tr>
                                <th>3.1</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $selected_tp_contract_manager = isset($detail->tp_contract_manager)  ? $detail->tp_contract_manager : null;
                                    echo HTML::selectChosen(
                                        'tp_contract_manager', 
                                        DAO::getResultset($link, "SELECT id, CONCAT(firstnames, ' ', surname), null FROM users WHERE users.web_access = '1' AND users.type NOT IN (5, 26) ORDER BY firstnames"),
                                        $selected_tp_contract_manager,
                                        true
                                    );
                                    ?>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $selected_tp_op_manager = isset($detail->tp_op_manager)  ? $detail->tp_op_manager : null;
                                    echo HTML::selectChosen(
                                        'tp_op_manager', 
                                        DAO::getResultset($link, "SELECT id, CONCAT(firstnames, ' ', surname), null FROM users WHERE users.web_access = '1' AND users.type NOT IN (5, 26) ORDER BY firstnames"),
                                        $selected_tp_op_manager,
                                        true
                                    );
                                    ?>
                                </td>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-bordered">
                            ...
                            <col width="70%">
                            <tr>
                                <th colspan="3" class="bg-gray">Section 4 - Employer Actions</th>
                            </tr>
                            <tr>
                                <th>4.1</th>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-bordered">
                            ...
                            <col width="70%">
                            <tr>
                                <th colspan="3" class="bg-gray">Section 5 - End-Point Assessment (EPA) Organisation - Standards Only</th>
                            </tr>
                            <tr>
                                <th>5.1</th>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-bordered">
                            ...
                            <col width="70%">
                            <tr>
                                <th colspan="3" class="bg-gray">Section 6 - Subcontracting</th>
                            </tr>
                            <tr>
                                <th>6.1</th>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-bordered">
                            ...
                            <col width="70%">
                            <tr>
                                <th colspan="3" class="bg-gray">Section 7 - Functional Skills required for this Apprenticeship (not the individual)</th>
                            </tr>
                            <tr>
                                <th>7.1</th>
                                <th>Maths</th>
                    ...
                    <div class="col-sm-12">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="checkbox" name="wm_auth" value="1" <?php echo (isset($detail->wm_auth) && $detail->wm_auth == '1') ? 'checked' : ''; ?> /> 
                                </td>
                                <th></th>
                                <td></td>
                            </tr>
		...
		<?php } else { ?>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-bordered">
                            <tr>
                                <th class="bg-gray">Section 10 - Additional Details (details supporting the negotiated costs / reduced rates)</th>
                            </tr>
                            <tr>
                                <td>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-bordered">
                            <tr>
                                <th class="bg-gray">Section 11 - Additional Payments</th>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <p>
                                        <input class="clsICheck" type="checkbox" disabled value="1" <?php echo (isset($detail->section12) && is_array($detail->section12) && in_array(1, $detail->section12)) ? 'checked' : ''; ?> />
                                        <label>
                                    ...
                                    <p>
                                        <input class="clsICheck" type="checkbox" disabled value="2" <?php echo (isset($detail->section12) && is_array($detail->section12) && in_array(2, $detail->section12)) ? 'checked' : ''; ?> />
                                        <label>
                                    ...
                                    <p>
                                        <input class="clsICheck" type="checkbox" disabled value="3" <?php echo (isset($detail->section12) && is_array($detail->section12) && in_array(3, $detail->section12)) ? 'checked' : ''; ?> />
                                        <label>
                                            Not Applicable
                                        </label>
                                    </p>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-bordered">
                            <tr>
                                <th class="bg-gray">Section 12 - Payment Schedule</th>
                            </tr>
                            <tr>
                                <td>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-bordered">
                            <tr>
                                <th class="bg-gray">Section 13 - Mandatory Policies</th>
                            </tr>
                            <tr>
                                <td>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-bordered">
                            <tr>
                                <th class="bg-gray">Section <?php echo DB_NAME == "am_crackerjack" ? "14" : "13"; ?> - Employer Declarations</th>
                            </tr>
                            <tr>
                                <td>
                ...
                <?php if ($_SESSION['user']->isAdmin() || $_SESSION['user']->type == User::TYPE_ADMIN || $_SESSION['user']->username === 'klazell1t') { ?>
                    <div class="row">
                        <div class="col-sm-12 table-responsive">
                        <i class="fa fa-info-circle"></i> All costs shown in the contract are current however, this is subject to change.
                            <table style="margin-top: 5px;" class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        echo (isset($schedule->emp_sign_name) && $schedule->emp_sign_name != '') ? $schedule->emp_sign_name : '';
                                        ?>
                                    </td>
                                    <td>
                                        <span class="btn btn-info">
                                            <img id="img_emp_sign" src="do.php?_action=generate_image&<?php echo isset($schedule->emp_sign) ? $schedule->emp_sign : 'title=Not yet signed&font=Signature_Regular.ttf&size=25'; ?>" style="border: 2px solid;border-radius: 15px;" />
                                        </span>
                                    </td>
                                    <td>
                                        <?php
                                        echo (isset($schedule->emp_sign_date) && $schedule->emp_sign_name != '') ? Date::toShort($schedule->emp_sign_date) : '';
                                        ?>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control compulsory" name="tp_sign_name" id="tp_sign_name" value="<?php echo isset($schedule->tp_sign_name) ? $schedule->tp_sign_name : $_SESSION['user']->firstnames . ' ' . $_SESSION['user']->surname; ?>" />
                                    </td>
                                    <td>
                                        <span class="btn btn-info" onclick="getSignature('tp');">
                                            <img id="img_tp_sign" src="do.php?_action=generate_image&<?php echo isset($schedule->tp_sign) ? $schedule->tp_sign : 'title=Click here to sign&font=Signature_Regular.ttf&size=25'; ?>" style="border: 2px solid;border-radius: 15px;" />
                                            <input type="hidden" name="tp_sign" id="tp_sign" value="<?php echo isset($schedule->tp_sign) ? $schedule->tp_sign : ''; ?>" />
                                        </span>
                                    </td>
                                    <td>
                                        <?php echo isset($schedule->tp_sign_date) ? '<span class="content-max-width">' . HTML::datebox('tp_sign_date', $schedule->tp_sign_date) . '</span>' : '<span class="content-max-width">' . HTML::datebox('tp_sign_date', date('d/m/Y')) . '</span>'; ?>
                                    </td>
                                </tr>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <span class="btn btn-block btn-primary btn-lg btn-save" onclick="submitSchedule();">
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            <?php 
            if( (isset($schedule->emp_sign) && $schedule->emp_sign != '') && (isset($schedule->tp_sign) && $schedule->tp_sign != '') ) 
            {
               echo '$(".btn-save").attr("disabled", true);'; 
               echo '$(".btn-save").css("pointer-events", "none");'; 
            }
            ?>
