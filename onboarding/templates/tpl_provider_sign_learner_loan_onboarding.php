                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table class="table table-bordered">
                                    ...
                                    <?php
                                    $result = DAO::getResultset($link, "SELECT * FROM lookup_cs_declarations WHERE user_type = 'PROVIDER' AND year = '2025' AND version = 1 AND fund_model = '" . $framework->fund_model_extra . "' ORDER BY id", DAO::FETCH_ASSOC);
