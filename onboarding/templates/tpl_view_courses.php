...
<div class="row">
	<div class="col-lg-12">
		<div class="banner">
			<div class="Title" style="margin-left: 6px;">Courses</div>
			<div class="ButtonBar">
				<?php if($_SESSION['user']->isAdmin() || $_SESSION['user']->type == User::TYPE_MANAGER) {?>
				<button class="btn btn-default btn-sm" onclick="window.location.href='do.php?_action=edit_course';"><i class="fa fa-plus"></i> Create New Course</button>
				<?php } ?>
			</div>
			<div class="ActionIconBar">
				...
				<span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="exportToExcel('view_ViewCourses');" title="Export to .CSV file"></span>
	...
	<div class="row">
		<div class="col-lg-12">
			<form method="get" action="#" id="applySavedFilter" style="display: none;">
				<input type="hidden" name="_action" value="view_courses2" />
				...
				<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" name="applyFilter" id="applyFilter">
					...
					<div id="filterBox" class="clearfix small">
						<fieldset>
							...
							<div class="field float"><label>Title:</label><?php echo $view->getFilterHTML('filter_course_title'); ?></div>
							<div class="field float"><label>Programme Type:</label><?php echo $view->getFilterHTML('filter_programme_type'); ?></div>
							<div class="field float"><label>Training Provider:</label><?php echo $view->getFilterHTML('filter_provider'); ?></div>
