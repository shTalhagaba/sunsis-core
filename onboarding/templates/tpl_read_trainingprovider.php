...
<head xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
    ...
    <title>Sunesis: View Provider</title>
...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;">View Provider</div>
            <div class="ButtonBar">
                <span class="btn btn-sm btn-default" onclick="window.location.href='<?php echo $_SESSION['bc']->getPrevious(); ?>';"><i class="fa fa-arrow-circle-o-left"></i> Cancel</span>
		<?php if($_SESSION['user']->isAdmin()) {?>
                <span class="btn btn-sm btn-default" onclick="window.location.href='do.php?_action=edit_trainingprovider&edit=1&id=<?php echo $vo->id; ?>';"><i class="fa fa-edit"></i> Edit</span>
		<?php } ?>
            </div>
			...
			<?php } ?>
                ...
                <div class="tab-content">
                    <div class="active tab-pane" id="tabLocations">
                        ...
                        <div class=""><?php $this->renderLocations($link,'read_trainingprovider'); ?></div>
                    </div>
			<?php if($_SESSION['user']->isAdmin()) {?>
                    <div class="tab-pane" id="tabUsers">
                        ...
                        <p><input id="txtSearchSystemUsers" type="text" placeholder="Search.."></p>
                        <div class="divSystemUsers"><?php $this->renderSystemUsers($link); ?></div>
                    </div>
			<?php } ?>
                    <div class="tab-pane" id="tabCRMNotes">
                        ...
                        <div class="table-responsive"><?php $this->renderCRMNotes($link,'read_trainingprovider'); ?></div>
                    </div>
                    <div class="tab-pane" id="tabCRMContacts">
                        <p><span onclick="window.location.href='do.php?_action=edit_crm_contact&org_type=provider&org_id=<?php echo $vo->id; ?>'" class="btn btn-primary btn-xs"> <i class="fa fa-plus"></i> Add New CRM Contact</span></p>
...
<script>
    $(function() {
        ...
        $("#txtSearchSystemUsers").on("keyup", function() {
            var value = $(this).val().toLowerCase();
            $(".divSystemUsers .col-sm-3").filter(function() {
