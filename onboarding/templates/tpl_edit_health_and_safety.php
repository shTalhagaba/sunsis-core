...
<table border="0" cellspacing="4" cellpadding="4">
	<col width="150" />
	<tr><td class="fieldLabel">Legal name:</td><td class="fieldValue"><?php echo htmlspecialchars($vo->legal_name); ?></td>
	<td class="fieldLabel">Trading name:</td><td class="fieldValue"><?php echo htmlspecialchars($vo->trading_name); ?></td></tr>
	<tr><td class="fieldLabel">Abbreviation:</td><td class="fieldValue"><?php echo htmlspecialchars($vo->short_name); ?></td>
	<td class="fieldLabel">Category:</td><td class="fieldValue"><?php //echo htmlspecialchars($lookup_org_type[$vo->org_type_id]); ?></td></tr>
	<tr><td class="fieldLabel">Company Number:</td><td class="fieldValue"><?php echo htmlspecialchars($vo->company_number); ?></td>
	<td class="fieldLabel">VAT Number:</td><td class="fieldValue"><?php echo htmlspecialchars($vo->vat_number); ?></td></tr>
		<tr>
	...
	<td class="fieldLabel">UPIN:</td><td class="fieldValue"><?php echo htmlspecialchars($vo->upin); ?></td></tr>
...
echo '<thead><tr><th>&nbsp;</th><th>Date of <br> Last Assessment </th><th> Date of <br> Next Assessment </th><th> Assessor </th><th> Comments </th><th> Compliant </th><th>Paperwork<br>received</th>';
echo '<th colspan=3>RAG Status</th><th title="Public Liability Date">PL Date</th><th title="Public Liability Insurance">PL Insurance</th><th title="Employer Liability Date">EL Date</th><th title="Employer Liability Date">EL Insurance</th>';
...
*/
	...
	echo '<tr>';
		...
		echo "<td>" . HTML::datebox("el_date".$record, '', true) . "</td>";
		echo "<td> <input type='text' id='el_insurance" . $record . "' /></td>";
