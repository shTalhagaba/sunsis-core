...
<head xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
    ...
    <title>Sunesis: View System Owner</title>
...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;">View System Owner</div>
            <div class="ButtonBar">
                <span class="btn btn-sm btn-default" onclick="window.location.href='<?php echo $_SESSION['bc']->getPrevious(); ?>';"><i class="fa fa-arrow-circle-o-left"></i> Cancel</span>
                <span class="btn btn-sm btn-default" onclick="window.location.href='do.php?_action=edit_systemowner&edit=1&id=<?php echo $vo->id; ?>';"><i class="fa fa-edit"></i> Edit</span>
            </div>
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="active tab-pane" id="tabLocations">
                        ...
                        <div class=""><?php $this->renderLocations($link,'read_systemowner'); ?></div>
                    </div>
                    ...
                    <div class="tab-pane" id="tabCRMNotes">
                        ...
                        <div class="table-responsive"><?php $this->renderCRMNotes($link,'read_systemowner'); ?></div>
                    </div>
