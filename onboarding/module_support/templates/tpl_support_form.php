...
?>
		<div id="wrapper">
                ...
                <form name="support_form" id="support_form" action="do.php?_action=support_form&amp;subaction=send" method="post" onsubmit="return save();" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <dl>
                            ...
                            <dd><textarea name="details" id="details" class="compulsory" cols="50" rows="15"><?php echo htmlspecialchars($this->getField("details")); ?></textarea>
                            <p>
                    ...
                    <fieldset>
                        ...
                        <dl>
                            ...
                            <dd><input type="text" class="compulsory" id="email" name="email" value="<?php echo htmlspecialchars($_SESSION['user']->work_email); ?>" /></dd>
                        </dl>
                        <dl>
                            <dt><label for="telephone">Phone Number</label></dt>
                            <dd><input type="text" class="compulsory" name="telephone" id="telephone" value="<?php echo htmlspecialchars($_SESSION['user']->work_telephone); ?>" /></dd>
                        </dl>
                        <dl>
                            <dt><label for="fax">Fax Number</label></dt>
                            <dd><input type="text" class="optional" name="fax" id="fax" value="<?php echo htmlspecialchars($_SESSION['user']->work_fax); ?>" /></dd>
                        </dl>
                    </fieldset>
                    <fieldset>
                        <dl>
            ...
            <div id="help">
                ...
                <table><tbody><tr><td><a href="do.php?_action=downloader&path=/am_demo/howto/&f=On Boarding Software User Guide_Jan2021_V2.pdf" class="icon-pdf" >On Boarding Software User Guide_Jan2021_V2</a></td></tr></tbody></table>			<p>
