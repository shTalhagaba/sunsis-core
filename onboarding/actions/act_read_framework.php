...
class read_framework implements IAction
{
	public function execute(PDO $link)
	{
		...
		$_SESSION['bc']->add($link, "do.php?_action=read_framework&id=" . $framework->id, "View Standard/ Programme");
