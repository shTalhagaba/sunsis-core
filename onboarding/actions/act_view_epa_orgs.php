...
SELECT
	...
	(SELECT COUNT(*) FROM client_epa_orgs WHERE client_epa_orgs.EPA_ORG_ID = central.epa_organisations.EPA_ORG_ID) AS flag
FROM
	central.epa_organisations
;
		");
        ...
        $options = array(
            0=>array(1, 'Set ', null, ' HAVING flag > 0 '),
            1=>array(2, 'Not Set ', null, ' HAVING flag = 0 '));
        $f = new VoltDropDownViewFilter('filter_flag', $options, 1, true);
