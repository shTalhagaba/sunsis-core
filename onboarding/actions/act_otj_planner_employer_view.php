<?php
class otj_planner_employer_view implements IUnauthenticatedAction
{
    public function execute(PDO $link)
    {
        ...
        {
            if(!OnboardingHelper::isValidOtjPlannerEmployerViewUrl($link, $tr_id, $key))
            {
        ...
        if(isset($otj_planner_signatures->employer_sign) && $otj_planner_signatures->employer_sign != '')
        {
        ...
        include_once('tpl_otj_planner_employer_view.php');
    }
}