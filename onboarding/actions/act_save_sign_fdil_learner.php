<?php
class save_sign_fdil_learner implements IUnauthenticatedAction
{
    public function execute(PDO $link)
    {
        $id = isset($_REQUEST['id']) ? $_REQUEST['id'] : '';
        $fdil_id = isset($_REQUEST['fdil_id']) ? $_REQUEST['fdil_id'] : '';
