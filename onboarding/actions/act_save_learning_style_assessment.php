<?php
class save_learning_style_assessment implements IUnauthenticatedAction
{
    public function execute(PDO $link)
    {
        ...
        try
        {
            ...
            DAO::saveObjectToTable($link, "ob_learner_learning_style", $save_object);

            $employer_signatures_log = (object)[
                'entity_id' => $save_object->tr_id,
                'entity_type' => 'ob_learner_learning_style',
