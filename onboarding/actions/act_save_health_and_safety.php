	...
	public function execute(PDO $link)
	{
		...
		{	
			...
			else
			{
				...
				$dd = new Date($review->eldate);
				$el_date = "'" . $dd->getYear() . '-' . $dd->getMonth() . '-' . $dd->getDays() . "'";
			}
...
$sql2 = <<<HEREDOC
insert into 
health_safety (location_id, last_assessment, next_assessment, assessor, comments, complient, paperwork_received, age_range, pl_date, pl_insurance, el_date, el_insurance)
values 
$values;	
HEREDOC;
