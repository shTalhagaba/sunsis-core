...
class view_qualification_tabular  implements IAction
{
    public function execute(PDO $link)
    {
        ...
        $_SESSION['bc']->add($link, "do.php?_action=view_qualification_tabular&id=" . $qualification_id . "&internaltitle=" . $internaltitle . "&clients=" . $clients . "&auto_id=" . $auto_id, "View Qualification (Tabular)");
