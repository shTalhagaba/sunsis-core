<?php
class ajax_get_framework_qualification_xml implements IAction
{
	public function execute(PDO $link)
	{
		...
		$q = FrameworkQualification::loadFromDatabase($link, $qualification_id, $framework_id, $internaltitle);
