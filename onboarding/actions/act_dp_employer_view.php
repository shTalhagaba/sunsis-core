<?php
class dp_employer_view implements IUnauthenticatedAction
{
    public function execute(PDO $link)
    {
        ...
        if(isset($dp_signatures->employer_sign) && $dp_signatures->employer_sign != '')
        {
        ...
        include_once('tpl_dp_employer_view.php');
    }
