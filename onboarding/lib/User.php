...
SQL;
	...
	public function save(PDO $link, $newRecord = false)
	{
		...
		$sql = "SELECT id FROM users WHERE username = '".addslashes($this->username)."' FOR UPDATE";
		...
		$sql = "SELECT web_access FROM users WHERE username='".addslashes($this->username)."'";
		...
		// Hash password
		$this->pwd_sha1 = !is_null($this->password) ? sha1($this->password) : $this->pwd_sha1;


		DAO::saveObjectToTable($link, 'users', $this);

		// Update home telephone number in all training records
		/*		DAO::execute($link, "UPDATE tr SET home_telephone = '".addslashes($this->home_telephone)
					."' WHERE tr.username = '".addslashes($this->username)."'");*/
...
HEREDOC;
	...
	public function delete(PDO $link)
	{
		...
		$identities = "'".addslashes($this->username)."', '".addslashes($this->getFullyQualifiedName())."'";
...
HEREDOC;
			...
			while($address_count <= sizeof($number_of_keys) ) {
				if ( isset($post_data['address_postcode'][$address_count]) ) {
					...
					foreach ($new_address as $address_key => $address_value ) {
						$address_sql .= $address_key.' = "'.htmlspecialchars($address_value).'", ';
					}
					$address_sql .= 'telephone = "'.htmlspecialchars($post_data['address_telephone'][$address_count]).'", ';
					$address_sql .= 'fax = "'.htmlspecialchars($post_data['address_fax'][$address_count]).'", ';		
					$address_sql .= 'mobile = "'.htmlspecialchars($post_data['address_mobile'][$address_count]).'", ';	
					$address_sql .= 'address_title = "'.htmlspecialchars($post_data['address_title'][$address_count]).'", ';		
	...
	public function displayUserAddresses ( PDO $link )
	{
		...
		if ($l) {
			...
			$user_address_details .= '<td class="fieldValue">'.htmlspecialchars($l->telephone).'</td>';
			$user_address_details .= '</tr>';
			$user_address_details .= '<tr>';
			$user_address_details .= '<td class="fieldLabel">Mobile</td>';
			$user_address_details .= '<td class="fieldValue">'.htmlspecialchars($l->contact_mobile).'</td>';
			$user_address_details .= '</tr>';
			$user_address_details .= '<tr>';
			$user_address_details .= '<td class="fieldLabel">Fax</td>';
			$user_address_details .= '<td class="fieldValue">'.htmlspecialchars($l->fax).'</td>';
			$user_address_details .= '</tr>';
			$user_address_details .= '<tr>';
			$user_address_details .= '<td class="fieldLabel">Email</td>';
			$user_address_details .= '<td class="fieldValue"><a href="mailto:' . htmlspecialchars($this->work_email) . '">' . htmlspecialchars($this->work_email).'</td>';
			$user_address_details .= '</tr>';
		...
		$user_address_details .= '<tr>';
		$user_address_details .= '	<td class="fieldLabel">Telephone</td>';
		$user_address_details .= '	<td class="fieldValue">'.htmlspecialchars($this->home_telephone).'</td>';
		$user_address_details .= '</tr>';
		$user_address_details .= '<tr>';
		$user_address_details .= '	<td class="fieldLabel">Mobile</td>';
		$user_address_details .= '	<td class="fieldValue">'.htmlspecialchars($this->home_mobile).'</td>';
		$user_address_details .= '</tr>';
		IF(DB_NAME=="am_platinum")
		{
			$user_address_details .= '<tr>';
			$user_address_details .= '	<td class="fieldLabel">Emergency Telephone</td>';
			$user_address_details .= '	<td class="fieldValue">'.htmlspecialchars($this->tel_emergency).'</td>';
			$user_address_details .= '</tr>';
		}
		$user_address_details .= '<tr>';
		$user_address_details .= '	<td class="fieldLabel">Fax</td>';
		$user_address_details .= '	<td class="fieldValue">'.htmlspecialchars($this->home_fax).'</td>';
		$user_address_details .= '</tr>';
		$user_address_details .= '<tr>';
		$user_address_details .= '	<td class="fieldLabel">Email</td>';
		$user_address_details .= '	<td class="fieldValue"><a href="mailto:' . htmlspecialchars($this->home_email) . '">' . htmlspecialchars($this->home_email).'</td>';
		$user_address_details .= '</tr>';
		$user_address_details .= '</table>';
		...
		/*		if ( ( isset($this->user_metadata) ) && ( isset($this->user_metadata['multiple_addresses']) ) ) {
			...
			foreach ( $user_addresses as $address_label => $address_value ) {
				...
				$user_address_details .= '<h3>'.htmlspecialchars($address_value['address_title']).'</h3>';
				$user_address_details .= '<table border="0" cellspacing="4" cellpadding="4" style="margin-left:10px">';
				$user_address_details .= '	<col width="170" /><col width="400" />';
				$user_address_details .= '	<tr>';
				$user_address_details .= '		<td class="fieldLabel" valign="top">Address</td>';
				...
				$user_address_details .= '	<tr>';
				$user_address_details .= '		<td class="fieldLabel">Telephone</td>';
				$user_address_details .= '		<td class="fieldValue">'.htmlspecialchars($address_value['telephone']).'</td>';
				$user_address_details .= '	</tr>';
				$user_address_details .= '	<tr>';
				$user_address_details .= '		<td class="fieldLabel">Mobile</td>';
				$user_address_details .= '		<td class="fieldValue">'.htmlspecialchars($address_value['mobile']).'</td>';
				$user_address_details .= '	</tr>';
				$user_address_details .= '	<tr>';
				$user_address_details .= '		<td class="fieldLabel">Fax</td>';
				$user_address_details .= '		<td class="fieldValue">'.htmlspecialchars($address_value['fax']).'</td>';
				$user_address_details .= '	</tr>';
				$user_address_details .= '	<tr>';
				$user_address_details .= '		<td class="fieldLabel">Email</td>';
				$user_address_details .= '		<td class="fieldValue"><a href="mailto:'.htmlspecialchars($address_value['email']).'">'.htmlspecialchars($address_value['email']).'</td>';
				$user_address_details .= '	</tr>';
				$user_address_details .= '</table>';
			}
	...
	const TYPE_BUSINESS_DEVELOPMENT = 27;
