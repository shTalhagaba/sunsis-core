...
class EetEA 
{
    ...
    public static function generatePdf(PDO $link, EmployerAgreement $agreement, $tr_id = '')
    {
        ...
        //$mpdf=new mPDF('','Legal','10', '', 15, 15, 32); //$mode='',$format='A4',$default_font_size=0,$default_font='',$mgl=15,$mgr=15,$mgt=16,$mgb=16,$mgh=9,$mgf=9, $orientation='P'
        $mpdf = new \Mpdf\Mpdf([
            'format'            => 'Legal',
        ...
        $logoAltText = "EET Training";
        if(!is_null( $employer->delivery_partner ))
        {
            $deliveryPartner = Organisation::loadFromDatabase($link, $employer->delivery_partner);
            $logo = !is_null($deliveryPartner->provider_logo) ? $deliveryPartner->provider_logo : $logo;
            $logoAltText = $deliveryPartner->legal_name;
        }
		...
		<div>
			<table width = "100%" style="border-radius: 10px; border: 1px solid #000000;">
				<tr>
					...
					<td width = "50%" align="right"><img height="3.03cm" width="6.51cm" src="images/logos/dfe_and_sfe_combined_logo.jpeg" alt="Education & Skills Funding Agency" /></td>
				</tr>
				<tr>
        ...
        <div>
			<table width = "100%" style="border-radius: 10px; border: 1px solid #000000;">
				<tr>
					...
					<td width = "50%" align="right"><img class="img-responsive" src="{$logo}" height="1.50cm" width="5cm" alt="{$logoAltText}" /></td>
				</tr>
			</table>
		</div>
    ...
    <table cellpadding="6" cellspacing="6" style="margin-top: 25px;">
        ...
        <tr>
            <td valign="top">
                ...
                <p>
                    EET Group incorporated and registered in England and Wales with company number $tp->company_number whose registered office is at 
