	...
	public function render(PDO $link, $type)
	{
		...
		if($st)
		{
			...
			while($row = $st->fetch())
			{
				...
				echo '<td align="left">' . htmlspecialchars($row['agreed_action']) . "</td>";
				echo '<td align="left">' . htmlspecialchars($row['audit_info']) . "</td>";
				echo '</tr>';
			}
	...
	public function render_mini(PDO $link, $type)
	{
		...
		if($st)
		{
			...
			while($row = $st->fetch())
			{
				...
				echo htmlspecialchars($row['agreed_action']) . "</td>";
				echo '</tr>';
				$row_count++;
			}
			echo '</tbody></table></div align="left">';
