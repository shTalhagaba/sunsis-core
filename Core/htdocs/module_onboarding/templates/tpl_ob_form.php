...
<content id="contentForm" style="display: none;">
	<div class="">
		<div class="container"><h3>Onboarding Questionnaire</h3></div>
	</div>
	<br>
	...
	<div class="container">
		...
		<form class="form-horizontal" name="frmOnBoarding" id="frmOnBoarding"
			...
			<input type="hidden" name="_action" value="save_ob_form"/>
			...
			<step id="step2" style="font-size: medium;">
				...
				<?php include_once(__DIR__ . '/partials/onboarding_personal_details.php'); ?>
			</step>
			...
			<step id="step3" style="font-size: medium;">
				...
				<?php include_once(__DIR__ . '/partials/onboarding_prior_attainment.php'); ?>
			</step>
...
<!--				<br>-->
<!---->
<!--				--><?php //include_once(__DIR__ . '/partials/onboarding_eligibility_checklist.php'); ?>
<!--			</step>-->
			...
			<step id="step5" style="font-size: medium;">
				...
				<?php include_once(__DIR__ . '/partials/onboarding_employment_status.php'); ?>
			</step>
			...
			<step id="step6" style="font-size: medium;">
                ...
                <?php include_once(__DIR__ . '/partials/onboarding_ilp.php'); ?>
			</step>
			...
			<step id="step7" style="font-size: medium;">
				...
				<?php include_once(__DIR__ . '/partials/onboarding_app_agreement.php'); ?>
			</step>

			<h3>Confirmation & Signature</h3>
			<step id="step8" style="font-size: medium;">
				<div class="nts-secondary-teaser-gradient" style="padding: 5px; border-radius: 5px;">
					<h4>Confirmation & Signature</h4>
				</div>
				<br>

				<?php
                $signature_field = 'learner_ob_signature';
...
<script type="text/javascript">
    ...
    var phpLearnerSignature = '<?php echo $ob_learner->learner_is_signature; ?>';
...
<script src="/module_onboarding/js/ob_form.js?n=<?php echo time(); ?>"></script>
