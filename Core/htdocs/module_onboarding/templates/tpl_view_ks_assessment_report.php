	...
	<div class="row">
		<div id="div_filters" style="display:none">
			<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter" name="applyFilter">
				<input type="hidden" name="_action" value="view_ks_assessment_report" />

				<div id="filterBox" class="clearfix small">
					<fieldset>
						<div class="field float"><label>Assessment Type:</label><?php echo $view->getFilterHTML('filter_assessment'); ?></div>
					</fieldset>
					<fieldset>
...
<div id="dialogScoreGraph" style="display:none" title="Scores Graph">
	<div id="score_graph" style="width: 500px; height: 400px;"></div>
</div>
...
<script language="JavaScript">
	$(function() {
		...
		var chart = new Highcharts.chart('score_graph', <?php echo $this->score_graph; ?>);
