<?php
class onboarding_agreements implements IUnauthenticatedAction
{
	public function execute(PDO $link)
	{
		...
		if($id != '' && $key != '')
		{
			...
			$LLDD = array(array('Y', 'Yes'), array('N', 'No'));
			$LLDDCat = array(
				'4' => 'Visual impairment',
			...
			$EII_dropdown = array(array('1', '16 hours or more per week'), array('2', 'less than 16 hours per week'), array('3', '16-19 hours per week'), array('4', '20 hours or more per week'));
		...
		include_once('tpl_onboarding_agreements.php');
	}
	...
	<div class="jumbotron">
		<div class="container">
			<div class="nts-secondary-teaser-gradient" style="max-width: 450px; padding: 25px; border-radius: 25px;">
				<h2>Thanks for your help. <br>Enjoy your training with <br>Siemens</h2>
			</div>
		</div>
	</div>
</content>
