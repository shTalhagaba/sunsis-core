<?php
class ob_screening implements IUnauthenticatedAction
{
	public function execute(PDO $link)
	{
		...
		$already_completed = DAO::getSingleValue($link, "SELECT COUNT(*) FROM ob_learners WHERE id = '{$learner_id}' AND is_initial_screening_done = 'Y'");
