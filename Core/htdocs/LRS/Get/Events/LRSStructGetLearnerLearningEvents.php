<?php
/**
 * File for class LRSStructGetLearnerLearningEvents
 * @package LRS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for LRSStructGetLearnerLearningEvents originally named GetLearnerLearningEvents
 ...
 * @date 2017-08-18
 */
class LRSStructGetLearnerLearningEvents extends LRSWsdlClass
{
    /**
    ...
    public $getType;
    /**
     * Constructor method for GetLearnerLearningEvents
     ...
     * @return LRSStructGetLearnerLearningEvents
     */
    public function __construct($_invokingOrganisation,$_userType,$_vendorID,$_language,$_uln,$_givenName,$_familyName,$_dateOfBirth,$_gender,$_getType)
    {
        parent::__construct(array('invokingOrganisation'=>$_invokingOrganisation,'userType'=>$_userType,'vendorID'=>$_vendorID,'language'=>$_language,'uln'=>$_uln,'givenName'=>$_givenName,'familyName'=>$_familyName,'dateOfBirth'=>$_dateOfBirth,'gender'=>$_gender,'getType'=>$_getType),false);
    }
    /**
