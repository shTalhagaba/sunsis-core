<?php
/**
 * File for class LRSStructDeleteSavedRtaQuery
 * @package LRS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for LRSStructDeleteSavedRtaQuery originally named DeleteSavedRtaQuery
 ...
 * @date 2017-08-18
 */
class LRSStructDeleteSavedRtaQuery extends LRSWsdlClass
{
    /**
    ...
    public $saveName;
    /**
     * Constructor method for DeleteSavedRtaQuery
     ...
     * @return LRSStructDeleteSavedRtaQuery
     */
    public function __construct($_invokingOrganisation,$_userType,$_vendorId,$_language,$_uln,$_saveName)
    {
        parent::__construct(array('invokingOrganisation'=>$_invokingOrganisation,'userType'=>$_userType,'vendorId'=>$_vendorId,'language'=>$_language,'uln'=>$_uln,'saveName'=>$_saveName),false);
    }
    /**
