<?php
/**
 * File for class LRSStructExecuteRtaQuery
 * @package LRS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for LRSStructExecuteRtaQuery originally named ExecuteRtaQuery
 ...
 * @date 2017-08-18
 */
class LRSStructExecuteRtaQuery extends LRSWsdlClass
{
    /**
    ...
    public $size;
    /**
     * Constructor method for ExecuteRtaQuery
     ...
     * @param string $_size
     * @return LRSStructExecuteRtaQuery
     */
    public function __construct($_invokingOrganisation,$_userType,$_vendorId,$_language,$_uln,$_givenName,$_familyName,$_gender,$_dateOfBirth,$_lastKnownPostcode,$_accreditationNumber,$_keyword,$_level,$_targetPostCode,$_extraUnitsForCreditTowards,$_includeLearnerUnits,$_ssas,$_computeCreditsTowards,$_offeredInEngland,$_offeredInNorthernIreland,$_offeredInWales,$_structureMustContain,$_size)
    {
        parent::__construct(array('invokingOrganisation'=>$_invokingOrganisation,'userType'=>$_userType,'vendorId'=>$_vendorId,'language'=>$_language,'uln'=>$_uln,'givenName'=>$_givenName,'familyName'=>$_familyName,'gender'=>$_gender,'dateOfBirth'=>$_dateOfBirth,'lastKnownPostcode'=>$_lastKnownPostcode,'accreditationNumber'=>$_accreditationNumber,'keyword'=>$_keyword,'level'=>$_level,'targetPostCode'=>$_targetPostCode,'extraUnitsForCreditTowards'=>($_extraUnitsForCreditTowards instanceof LRSStructArrayOfstring)?$_extraUnitsForCreditTowards:new LRSStructArrayOfstring($_extraUnitsForCreditTowards),'includeLearnerUnits'=>$_includeLearnerUnits,'ssas'=>($_ssas instanceof LRSStructArrayOfstring)?$_ssas:new LRSStructArrayOfstring($_ssas),'computeCreditsTowards'=>$_computeCreditsTowards,'offeredInEngland'=>$_offeredInEngland,'offeredInNorthernIreland'=>$_offeredInNorthernIreland,'offeredInWales'=>$_offeredInWales,'structureMustContain'=>($_structureMustContain instanceof LRSStructArrayOfstring)?$_structureMustContain:new LRSStructArrayOfstring($_structureMustContain),'size'=>$_size),false);
    }
    /**
    ...
    /**
     * Set gender value
     * @uses LRSEnumGender::valueIsValid()
     * @param LRSEnumGender $_gender the gender
     * @return LRSEnumGender
     */
    public function setGender($_gender)
    {
        if(!LRSEnumGender::valueIsValid($_gender))
        {
            return false;
        }
