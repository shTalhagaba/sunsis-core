<?php
/**
 * File for class LRSStructRemoveLearnerKey
 * @package LRS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for LRSStructRemoveLearnerKey originally named RemoveLearnerKey
 ...
 * @date 2017-08-18
 */
class LRSStructRemoveLearnerKey extends LRSWsdlClass
{
    /**
    ...
    public $keyValue;
    /**
     * Constructor method for RemoveLearnerKey
     ...
     * @return LRSStructRemoveLearnerKey
     */
    public function __construct($_invokingOrganisation,$_userType,$_vendorID,$_language,$_uln,$_keyType,$_keyValue)
    {
        parent::__construct(array('invokingOrganisation'=>$_invokingOrganisation,'userType'=>$_userType,'vendorID'=>$_vendorID,'language'=>$_language,'uln'=>$_uln,'keyType'=>$_keyType,'keyValue'=>$_keyValue),false);
    }
    /**
