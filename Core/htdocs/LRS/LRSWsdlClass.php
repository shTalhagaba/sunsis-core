<?php
/**
 * File for LRSWsdlClass to communicate with SOAP service
 * @package LRS
 ...
 */
/**
 * LRSWsdlClass to communicate with SOAP service
 *
 * @package LRS
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2017-08-18
 */
class LRSWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	 ...
	 * @var string
	 */
	//const VALUE_WSDL_URL = 'https://ws.lrs.imservices.org.uk/learnerserviceR9.svc?wsdl';
	const VALUE_WSDL_URL = 'tempuri.org.wsdl';
	/**
	...
	/**
	 * Constructor
	 * @uses LRSWsdlClass::setLastError()
	 * @uses LRSWsdlClass::initSoapClient()
	 * @uses LRSWsdlClass::initInternArrayToIterate()
	 * @uses LRSWsdlClass::_set()
	...
	public static function __set_state(array $_array,$_className = __CLASS__)
	{
		if(class_exists($_className))
		{
			...
			if(is_object($object) && is_subclass_of($object,'LRSWsdlClass'))
			{
	 ...
	 * @uses LRSClassMap::classMap()
	 * @uses LRSWsdlClass::getDefaultWsdlOptions()
	 * @uses LRSWsdlClass::getSoapClientClassName()
	 * @uses LRSWsdlClass::setSoapClient()
	 * @param array $_wsdlOptions WSDL options
	 * @return void
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('LRSClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = LRSClassMap::classMap();
...
//pre($wsdlUrl);
	 ...
	 * If a class is named as {LRS}SoapClient, then this is the class that will be used.
	...
	{
		if(class_exists('LRSSoapClient') && is_subclass_of('LRSSoapClient','SoapClient'))
			return 'LRSSoapClient';
		else
			return 'SoapClient';
	}
	/**
	 * Method returning all default options values
	 * @uses LRSWsdlClass::WSDL_CACHE_WSDL
	 * @uses LRSWsdlClass::WSDL_COMPRESSION
	 * @uses LRSWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses LRSWsdlClass::WSDL_ENCODING
	 * @uses LRSWsdlClass::WSDL_EXCEPTIONS
	 * @uses LRSWsdlClass::WSDL_FEATURES
	 * @uses LRSWsdlClass::WSDL_LOGIN
	 * @uses LRSWsdlClass::WSDL_PASSWORD
	 * @uses LRSWsdlClass::WSDL_SOAP_VERSION
	 * @uses LRSWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses LRSWsdlClass::WSDL_TRACE
	 * @uses LRSWsdlClass::WSDL_TYPEMAP
	 * @uses LRSWsdlClass::WSDL_URL
	 * @uses LRSWsdlClass::VALUE_WSDL_URL
	 * @uses LRSWsdlClass::WSDL_USER_AGENT
	 * @uses LRSWsdlClass::WSDL_PROXY_HOST
	 * @uses LRSWsdlClass::WSDL_PROXY_PORT
	 * @uses LRSWsdlClass::WSDL_PROXY_LOGIN
	 * @uses LRSWsdlClass::WSDL_PROXY_PASSWORD
	 * @uses LRSWsdlClass::WSDL_LOCAL_CERT
	 * @uses LRSWsdlClass::WSDL_PASSPHRASE
	 * @uses LRSWsdlClass::WSDL_AUTHENTICATION
	 * @uses LRSWsdlClass::WSDL_SSL_METHOD
	 ...
	 * @uses LRSWsdlClass::getSoapClient()
	 * @uses LRSWsdlClass::getFormatedXml()
	 ...
	 * @uses LRSWsdlClass::getSoapClient()
	 * @uses LRSWsdlClass::convertStringHeadersToArray()
	 ...
	 * @uses LRSWsdlClass::getInternArrayToIterate()
	 * @uses LRSWsdlClass::getInternArrayToIterateIsArray()
	 * @return int
	 */
	 ...
	 * @uses LRSWsdlClass::getInternArrayToIterateOffset()
	 * @uses LRSWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses LRSWsdlClass::getInternArrayToIterateOffset()
	 * @uses LRSWsdlClass::offsetExists()
	 * @return bool true|false
	 */
	 ...
	 * @uses LRSWsdlClass::getAttributeName()
	 * @uses LRSWsdlClass::__toString()
	 * @uses LRSWsdlClass::_set()
	 * @uses LRSWsdlClass::_get()
	 * @uses LRSWsdlClass::setInternArrayToIterate()
	 * @uses LRSWsdlClass::setInternArrayToIterateIsArray()
	 * @uses LRSWsdlClass::setInternArrayToIterateOffset()
