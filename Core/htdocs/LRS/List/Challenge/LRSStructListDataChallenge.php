<?php
/**
 * File for class LRSStructListDataChallenge
 * @package LRS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for LRSStructListDataChallenge originally named ListDataChallenge
 ...
 * @date 2017-08-18
 */
class LRSStructListDataChallenge extends LRSWsdlClass
{
    /**
    ...
    /**
     * Constructor method for ListDataChallenge
     ...
     * @return LRSStructListDataChallenge
     */
    public function __construct($_invokingOrganisation,$_userType,$_vendorId,$_language,$_uln,$_dateCreatedStart,$_dateCreatedEnd)
    {
        parent::__construct(array('invokingOrganisation'=>$_invokingOrganisation,'userType'=>$_userType,'vendorId'=>$_vendorId,'language'=>$_language,'uln'=>$_uln,'dateCreatedStart'=>$_dateCreatedStart,'dateCreatedEnd'=>$_dateCreatedEnd),false);
    }
    /**
