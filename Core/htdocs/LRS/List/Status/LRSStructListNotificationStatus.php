<?php
/**
 * File for class LRSStructListNotificationStatus
 * @package LRS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for LRSStructListNotificationStatus originally named ListNotificationStatus
 ...
 * @date 2017-08-18
 */
class LRSStructListNotificationStatus extends LRSWsdlClass
{
    /**
    ...
    public $uln;
    /**
     * Constructor method for ListNotificationStatus
     ...
     * @param string $_uln
     * @return LRSStructListNotificationStatus
     */
    public function __construct($_invokingOrganisation,$_userType,$_vendorId,$_language,$_uln)
    {
        parent::__construct(array('invokingOrganisation'=>$_invokingOrganisation,'userType'=>$_userType,'vendorId'=>$_vendorId,'language'=>$_language,'uln'=>$_uln),false);
    }
    /**
