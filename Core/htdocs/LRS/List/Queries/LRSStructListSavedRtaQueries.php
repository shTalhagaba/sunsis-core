<?php
/**
 * File for class LRSStructListSavedRtaQueries
 * @package LRS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for LRSStructListSavedRtaQueries originally named ListSavedRtaQueries
 ...
 * @date 2017-08-18
 */
class LRSStructListSavedRtaQueries extends LRSWsdlClass
{
    /**
    ...
    public $saveName;
    /**
     * Constructor method for ListSavedRtaQueries
     ...
     * @return LRSStructListSavedRtaQueries
     */
    public function __construct($_invokingOrganisation,$_userType,$_vendorId,$_language,$_uln,$_givenName,$_familyName,$_dateOfBirth,$_gender,$_saveName)
    {
        parent::__construct(array('invokingOrganisation'=>$_invokingOrganisation,'userType'=>$_userType,'vendorId'=>$_vendorId,'language'=>$_language,'uln'=>$_uln,'givenName'=>$_givenName,'familyName'=>$_familyName,'dateOfBirth'=>$_dateOfBirth,'gender'=>$_gender,'saveName'=>$_saveName),false);
    }
    /**
