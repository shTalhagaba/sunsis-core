...
<title>Learner On Programme Review Digital Marketing V2</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Digital Marketing V2</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Digital Marketing V2</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td>9628-11 principles of coding test</td>
    ...
    <tr>
        ...
        <td>CIW social media strategist exam course</td>
        <td><?php echo $this->getEventStatus($events, "CIW social media strategist exam course") . "<br>" . $this->getEventDate($events,'CIW social media strategist exam course'); ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    </tr>
    <tr>
