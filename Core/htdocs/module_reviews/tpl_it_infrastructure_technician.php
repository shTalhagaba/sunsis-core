...
<title>Learner On Programme Review IT Infrastructure Technician </title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review IT Infrastructure Technician</div>
    <div class="ButtonBar">
...
<?php
echo $this->getHeaderITInfrastructureTechnician($link);
echo $this->getLearnerDetails($form_arf, $source);
echo $this->getProgrammeProgress($form_arf, $source, $link, $tr_id);
?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=5 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'9628-06 Networking and Architecture Test') . "<br>" . $this->getEventDate($events,'9628-06 Networking and Architecture Test') . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=2 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Mobility and Devices MTA Test') . "<br>" . $this->getEventDate($events,'Mobility and Devices MTA Test') . "</td>";?>
    </tr>
...
<!--    <tr>
        ...
        <?php //echo "<td rowspan=2 style='text-align:center; vertical-align:middle'>" . $tk_result['Cloud Fundamentals MTA Test'] . "</td>"; ?>
        <?php //echo "<td rowspan=2 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status11", $ss_statuses, $form_arf->skills_scan_status11, true, false, $assessor_signed) . "</td>";?>
        <?php //echo "<td rowspan=2 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Cloud Fundamentals MTA Test') . "<br>" . $this->getEventDate($events,'Cloud Fundamentals MTA Test') . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'9628-09 Coding and Logic Test') . "<br>" . $this->getEventDate($events,'9628-09 Coding and Logic Test') . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=2 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'City and Guilds 9628-10 Level 3 Award in Business Processes Test') . "<br>" . $this->getEventDate($events,'City and Guilds 9628-10 Level 3 Award in Business Processes Test') . "</td>";?>
    </tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td>Communication</td>
        <td><?php if(isset($Assessment_Plan['Communication'])) echo $Assessment_Plan['Communication']; else "&nbsp;" ?></td>
        <td>Health & Safety</td>
        <td><?php if(isset($Assessment_Plan['Health and Safety'])) echo $Assessment_Plan['Health and Safety']; else "&nbsp;" ?></td>
        <td>Remote Infrastructure</td>
        <td><?php if(isset($Assessment_Plan['Remote Infrastructure'])) echo $Assessment_Plan['Remote Infrastructure']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Data</td>
        <td><?php if(isset($Assessment_Plan['Data'])) echo $Assessment_Plan['Data']; else "&nbsp;" ?></td>
        <td>Workflow Management</td>
        <td><?php if(isset($Assessment_Plan['Workflow Management'])) echo $Assessment_Plan['Workflow Management']; else "&nbsp;" ?></td>
        <td>IT Security</td>
        <td><?php if(isset($Assessment_Plan['IT Security'])) echo $Assessment_Plan['IT Security']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Problem Solving</td>
        <td><?php if(isset($Assessment_Plan['Problem Solving'])) echo $Assessment_Plan['Problem Solving']; else "&nbsp;" ?></td>
        <td>Performance</td>
        <td><?php if(isset($Assessment_Plan['Performance'])) echo $Assessment_Plan['Performance']; else "&nbsp;" ?></td>
        <td>WEEE</td>
        <td><?php if(isset($Assessment_Plan['WEEE'])) echo $Assessment_Plan['WEEE']; else "&nbsp;" ?></td>
    </tr>
    <tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td>City and Guilds 9628-10 Level 3 Award in Business Processes Test</td>
