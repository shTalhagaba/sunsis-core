...
<title>Learner On Programme Review Business Analyst</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Business Analyst</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Business Analyst</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td>Investigatioon Techniques</td>
        <td><?php if(isset($Assessment_Plan['Investigation Techniques'])) echo $Assessment_Plan['Investigation Techniques']; else "&nbsp;" ?></td>
        <td>Business Process Modelling</td>
        <td><?php if(isset($Assessment_Plan['Business Process Modelling'])) echo $Assessment_Plan['Business Process Modelling']; else "&nbsp;" ?></td>
        <td>Requirements Engineering & Management</td>
        <td><?php if(isset($Assessment_Plan['Requirements Engineering & Management'])) echo $Assessment_Plan['Requirements Engineering & Management']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Data Modelling</td>
        <td><?php if(isset($Assessment_Plan['Data Modelling'])) echo $Assessment_Plan['Data Modelling']; else "&nbsp;" ?></td>
        <td>Gap Analysis</td>
        <td><?php if(isset($Assessment_Plan['Gap Analysis'])) echo $Assessment_Plan['Gap Analysis']; else "&nbsp;" ?></td>
        <td>Acceptance Testing</td>
        <td><?php if(isset($Assessment_Plan['Acceptance Testing'])) echo $Assessment_Plan['Acceptance Testing']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Stakeholder Analysis & Management</td>
        <td><?php if(isset($Assessment_Plan['Stakeholder Analysis & Management'])) echo $Assessment_Plan['Stakeholder Analysis & Management']; else "&nbsp;" ?></td>
        <td>Business Impact Assessment</td>
        <td><?php if(isset($Assessment_Plan['Business Impact Assessment'])) echo $Assessment_Plan['Business Impact Assessment']; else "&nbsp;" ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    </tr>
    <tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td>ISQI Agile Business Analysis</td>
