...
<title>Learner On Programme Review Infrastructure Technician V3</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Infrastructure Technician V3</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Infrastructure Technician V3</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "City & Guilds 9628-10 Level 3 Award in Business Processes Test") . "<br>" . $this->getEventDate($events,'City & Guilds 9628-10 Level 3 Award in Business Processes Test'); ?></td>
    </tr>
    <tr>
