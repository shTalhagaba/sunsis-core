...
<title>Learner On Programme Review Data Analyst</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Data Analyst</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Data Analyst</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td>Data identification, collection & migration</td>
        <td><?php if(isset($Assessment_Plan['Data identification, collection & migration'])) echo $Assessment_Plan['Data identification, collection & migration']; else "&nbsp;" ?></td>
        <td>Data Manipulation & Linking</td>
        <td><?php if(isset($Assessment_Plan['Data Manipulation & Linking'])) echo $Assessment_Plan['Data Manipulation & Linking']; else "&nbsp;" ?></td>
        <td>Data Interpretation & Application to Processes</td>
        <td><?php if(isset($Assessment_Plan['Data Interpretation & Application to Processes'])) echo $Assessment_Plan['Data Interpretation & Application to Processes']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Data compilation</td>
        <td><?php if(isset($Assessment_Plan['Data Compilation'])) echo $Assessment_Plan['Data Compilation']; else "&nbsp;" ?></td>
        <td>Database queries & analysis</td>
        <td><?php if(isset($Assessment_Plan['Database Queries & Analysis'])) echo $Assessment_Plan['Database Queries & Analysis']; else "&nbsp;" ?></td>
        <td>Statistical Analysis</td>
        <td><?php if(isset($Assessment_Plan['Statistical Analysis'])) echo $Assessment_Plan['Statistical Analysis']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Data analysis techniques</td>
        <td><?php if(isset($Assessment_Plan['Data Analysis Techniques'])) echo $Assessment_Plan['Data Analysis Techniques']; else "&nbsp;" ?></td>
        <td>Data checking & cleansing</td>
        <td><?php if(isset($Assessment_Plan['Data Checking & Cleansing'])) echo $Assessment_Plan['Data Checking & Cleansing']; else "&nbsp;" ?></td>
        <td>Data analysis tools</td>
        <td><?php if(isset($Assessment_Plan['Data Analysis Tools'])) echo $Assessment_Plan['Data Analysis Tools']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Data analysis reporting</td>
        <td><?php if(isset($Assessment_Plan['Data Analysis Reporting'])) echo $Assessment_Plan['Data Analysis Reporting']; else "&nbsp;" ?></td>
        <td>Recommendations based on analysis</td>
        <td><?php if(isset($Assessment_Plan['Recommendations Based on Analysis'])) echo $Assessment_Plan['Recommendations Based on Analysis']; else "&nbsp;" ?></td>
        <td>Data architecture</td>
        <td><?php if(isset($Assessment_Plan['Data Architecture'])) echo $Assessment_Plan['Data Architecture']; else "&nbsp;" ?></td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan=6><i>
            <?php if(SOURCE_BLYTHE_VALLEY) pre($Assessment_Plan);  if($source==1)
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td>Data Analysis Tools</td>
        <td><?php echo $this->getEventStatus($events, "Data Analysis Tools") . "<br>" . $this->getEventDate($events,'Data Analysis Tools'); ?></td>
        <td>Diploma in data analysis part 1</td>
        <td><?php echo $this->getEventStatus($events, "Diploma in data analysis part 1") . "<br>" . $this->getEventDate($events,'Diploma in data analysis part 1'); ?></td>
        <td>Diploma in data analysis part 2</td>
        <td><?php echo $this->getEventStatus($events, "Diploma in data analysis part 2") . "<br>" . $this->getEventDate($events,'Diploma in data analysis part 2'); ?></td>
    </tr>
    <tr>
        ...
        <td>Dell EMC data science associate</td>
        <td><?php echo $this->getEventStatus($events, "Dell EMC data science associate") . "<br>" . $this->getEventDate($events,'Dell EMC data science associate'); ?></td>
        <td>Dell test</td>
        <td><?php echo $this->getEventStatus($events, "Dell test") . "<br>" . $this->getEventDate($events,'Dell test'); ?></td>
    </tr>
    <tr>
        <td>Diploma in data analysis test</td>
        <td><?php echo $this->getEventStatus($events, "Diploma in data analysis test") . "<br>" . $this->getEventDate($events,'Diploma in data analysis test'); ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
