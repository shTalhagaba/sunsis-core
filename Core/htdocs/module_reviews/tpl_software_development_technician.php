...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Software Development Context and Methodologies test') . "<br>" . $this->getEventDate($events,'Software Development Context and Methodologies test') . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Programming Test') . "<br>" . $this->getEventDate($events,'Programming Test') . "</td>";?>
    </tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Logic", "Security", "Data", "Test", "Development Lifecycle", "Problem Solving", "User Interface")))
    ...
    <tr>
        ...
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Logic", "Problem Solving", "Development Support", "Communication")))
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>&nbsp;</td>";
        ?>
    ...
    <tr>
        ...
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Logic", "Problem Solving", "Communication")))
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>&nbsp;</td>";
        ?>
    ...
    <tr>
        ...
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Logic", "Development Support", "Data", "Test", "Analysis", "Development Lifecycle", "Quality", "Problem Solving", "Communication", "Business Operation", "User Interface")))
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>&nbsp;</td>";
        ?>
    ...
    <tr>
        ...
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Commination", "Test", "Analysis", "Development Lifecycle", "Problem Solving")))
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>&nbsp;</td>";
        ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td>Development Support</td>
        <td><?php if(isset($Assessment_Plan['Development Support'])) echo $Assessment_Plan['Development Support']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Logic</td>
        ...
        <td>Quality</td>
        <td><?php if(isset($Assessment_Plan['Quality'])) echo $Assessment_Plan['Quality']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Security</td>
        <td><?php if(isset($Assessment_Plan['Security'])) echo $Assessment_Plan['Security']; else "&nbsp;" ?></td>
        <td>Test</td>
        <td><?php if(isset($Assessment_Plan['Test'])) echo $Assessment_Plan['Test']; else "&nbsp;" ?></td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        echo '<td colspan=4>' . $form_arf->learner_comment . '</td>';
        ?>
    </tr>
    </tbody>
</table>
