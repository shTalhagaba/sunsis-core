...
<title>Learner On Programme Review ICT Network Technician</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review ICT Network Technician</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme ICT Network Technician</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=2>Interpret and prioritise internal or external customers requirements in line with organisations policy</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Interpret and prioritise internal or external customers requirements in line with organisations policy'] . "</td>"; ?>
        ...
        <?php $communication = isset($Assessment_Plan['Written Communication'])?$Assessment_Plan['Written Communication']:"&nbsp"; echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $communication . "</td>";?>
    </tr>

    <tr>
        <td colspan=2>Apply the appropriate tools and techniques to undertake fault finding and rectification</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Apply the appropriate tools and techniques to undertake fault finding and rectification'] . "</td>"; ?>
        ...
        <?php $it_security = isset($Assessment_Plan['Research'])?$Assessment_Plan['Research']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $it_security . "</td>";?>
    </tr>

    <tr>
        <td colspan=2>Apply Continuous Professional Development to support necessary business output and technical developments</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Apply Continuous Professional Development to support necessary business output and technical developments'] . "</td>"; ?>
        ...
        <?php $remote_infrastructure = isset($Assessment_Plan['Technologies'])?$Assessment_Plan['Technologies']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $remote_infrastructure . "</td>";?>
    </tr>

    <tr>
        <td colspan=2>Operate safely and securely across platforms and responsibilities maintaining the security of personal data of internal and external stakeholders</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Operate safely and securely across platforms and responsibilities maintaining the security of personal data of internal and external stakeholders'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Communicate with all levels of stakeholders, keeping them informed of progress and managing escalation where appropriate</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Communicate with all levels of stakeholders, keeping them informed of progress and managing escalation where appropriate'] . "</td>"; ?>
        ...
        <?php $problem_solving = isset($Assessment_Plan['Customer Service'])?$Assessment_Plan['Customer Service']:"&nbsp"; echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $problem_solving . "</td>";?>
    </tr>

    <tr>
        <td colspan=2>Develop and maintain effective working relationships with colleagues, customers, and other relevant stakeholders</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Develop and maintain effective working relationships with colleagues, customers, and other relevant stakeholders'] . "</td>"; ?>
        ...
        <?php $workflow_management = isset($Assessment_Plan['Problem Solving'])?$Assessment_Plan['Problem Solving']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $workflow_management . "</td>";?>
    </tr>

    <tr>
        <td colspan=2>Manage and prioritise the allocated workload effectively making best use of time and resources</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Manage and prioritise the allocated workload effectively making best use of time and resources'] . "</td>"; ?>
        ...
        <?php $health_safety = isset($Assessment_Plan['Analysis'])?$Assessment_Plan['Analysis']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $health_safety . "</td>";?>
    </tr>

    <tr>
        <td colspan=2>Complete documentation relevant to the task and escalate where appropriate</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Complete documentation relevant to the task and escalate where appropriate'] . "</td>"; ?>
        ...
        <?php $performance = isset($Assessment_Plan['Specialist Areas'])?$Assessment_Plan['Specialist Areas']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $performance . "</td>";?>
    </tr>

    <tr>
        <td colspan=2>Install or undertake basic software upgrades, either physically or remotely</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Install or undertake basic software upgrades, either physically or remotely'] . "</td>"; ?>
        ...
        <?php $performance = isset($Assessment_Plan['Digital Tools'])?$Assessment_Plan['Digital Tools']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $performance . "</td>";?>
    </tr>

    <tr>
        <td colspan=2>Establish and diagnose the extent of the IT support task, in line with the organisations policies and SLAs</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Establish and diagnose the extent of the IT support task, in line with the organisations policies and SLAs'] . "</td>"; ?>
        ...
        <?php $performance = isset($Assessment_Plan['Digital Analytics'])?$Assessment_Plan['Digital Analytics']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $performance . "</td>";?>
    </tr>

    <tr>
        <td colspan=2>Provide remote/F2F support to resolve customer requirements</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Provide remote/F2F support to resolve customer requirements'] . "</td>"; ?>
        ...
        <?php $performance = isset($Assessment_Plan['Implementation'])?$Assessment_Plan['Implementation']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $performance . "</td>";?>
    </tr>

    <tr>
        <td colspan=2>Use a range of Cabling or Connectors equipment in line with technical requirements for example physically or remotely</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Use a range of Cabling or Connectors equipment in line with technical requirements for example physically or remotely'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Test and evaluate network environments</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Test and evaluate network environments'] . "</td>"; ?>
        ...
        <?php $performance = isset($Assessment_Plan['Industry Developments and Practices'])?$Assessment_Plan['Industry Developments and Practices']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $performance . "</td>";?>
    </tr>

    <tr>
        <td colspan=2>Monitor performance and usage of a network</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Monitor performance and usage of a network'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Deploy applications on a network</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Deploy applications on a network'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Set up storage and data access for staff</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Set up storage and data access for staff'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Apply necessary security measures, in line with access requirements to a network</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Apply necessary security measures, in line with access requirements to a network'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Carry out routine maintenance across network systems, ensuring organisational compliance</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Carry out routine maintenance across network systems, ensuring organisational compliance'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Monitor network-related workloads including DNS and firewalls</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Monitor network-related workloads including DNS and firewalls'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Install or undertake basic upgrades, either physically or remotely</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Install or undertake basic upgrades, either physically or remotely'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Approaches to back up and storage solutions'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Basic elements of technical documentation and its interpretation'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Principles of root cause problem solving using fault diagnostics for troubleshooting'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Principles of basic network addressing for example binary'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Basic awareness of the principles of cloud and cloud-based services'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Fundamental principles of virtual networks and components'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Principles of cultural awareness and how diversity impacts on delivery of support tasks'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Methods of communication including level of technical terminology to use to technical and non-technical stakeholders'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Different types of maintenance and preventative measures to reduce the incidence of faults'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Key principles of Security including the role of People, Product and Process in secure systems for example access and encryption requirements'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Fundamentals of physical networks and components'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Approaches to documenting tasks, findings, actions taken and outcome for example, use of task tracking and ticketing systems'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Basic awareness of legislation in relation to disposal of waste materials for example Waste Electronic and Electrical regulations (WEEE)'] . "</td>"; ?>
    ...
    <tr>
        <td>Principles of OSI layers</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Principles of OSI layers'] . "</td>"; ?>
    ...
    <tr>
        <td>Principles of cloud and network architecture (including Wi-Fi)</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Principles of cloud and network architecture (including Wi-Fi)'] . "</td>"; ?>
    ...
    <tr>
        <td>Principles of DNS / DHCP</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Principles of DNS / DHCP'] . "</td>"; ?>
    ...
    <tr>
        <td>Awareness of Cloud platforms, such as AWS, Azure, or GCP</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Awareness of Cloud platforms, such as AWS, Azure, or GCP'] . "</td>"; ?>
    ...
    <tr>
        <td>Principles of LANs and WANs</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Principles of LANs and WANs'] . "</td>"; ?>
    ...
    <tr>
        <td>Approaches to virtualisation of servers, applications, and networks</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Approaches to virtualisation of servers, applications, and networks'] . "</td>"; ?>
    ...
    <tr>
        <td>Principles of network protocols</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Principles of network protocols'] . "</td>"; ?>
    ...
    <tr>
        <td>Principles of APIs and Web Services</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Principles of APIs and Web Services'] . "</td>"; ?>
    ...
    <tr>
        <td>The different types of cloud storage</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The different types of cloud storage'] . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status42!="")?$sss[$previous_review->skills_scan_status42]:"") . "</td>"; ?>
    ...
    <tr>
        <td>Back up procedures and their importance</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Back up procedures and their importance'] . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status43!="")?$sss[$previous_review->skills_scan_status43]:"") . "</td>"; ?>
    ...
    <tr>
        <td>Principles of databases and migration</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Principles of databases and migration'] . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status44!="")?$sss[$previous_review->skills_scan_status44]:"") . "</td>"; ?>
    ...
    <tr>
        <td>Key principles of Cloud Security and firewalls</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Key principles of Cloud Security and firewalls'] . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status45!="")?$sss[$previous_review->skills_scan_status45]:"") . "</td>"; ?>
    ...
    <tr>
        <td>Awareness of DevOps methodology and tools, such as Puppet, Chef, Git, Docker</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Awareness of DevOps methodology and tools, such as Puppet, Chef, Git, Docker'] . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status46!="")?$sss[$previous_review->skills_scan_status46]:"") . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Works professionally, taking initiative as appropriate and acting with an ethical approach'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Communicates technical and non-technical information in a variety of situations to support effective working with internal or external stakeholders'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Demonstrates a productive and organised approach to their work'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Self-motivated, for example takes responsibility to complete the job'] . "</td>"; ?>
        <?php echo "<td style='text-align:center'>" . (($previous_review->skills_scan_status50!="")?$sss[$previous_review->skills_scan_status50]:"") . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status50", $ss_statuses, $form_arf->skills_scan_status50, true, false, $assessor_signed) . "</td>";?>
    </tr>
    <tr>
        <td>Example</td>
        <td colspan=3><i>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td>Cisco IT Essentials Pt1</td>
        <td><?php echo $this->getEventStatus($events, "Cisco IT Essentials Pt1") . "<br>" . $this->getEventDate($events,'Cisco IT Essentials Pt1'); ?></td>
        <td>Cisco IT Essentials Pt2</td>
        <td><?php echo $this->getEventStatus($events, "Cisco IT Essentials Pt2") . "<br>" . $this->getEventDate($events,'Cisco IT Essentials Pt2'); ?></td>
        <td>Network Fundamentals</td>
        <td><?php echo $this->getEventStatus($events, "Network Fundamentals") . "<br>" . $this->getEventDate($events,'Network Fundamentals'); ?></td>
    </tr>
    <tr>
        <td>Azure Fundamentals</td>
        <td><?php echo $this->getEventStatus($events, "Azure Fundamentals") . "<br>" . $this->getEventDate($events,'Azure Fundamentals'); ?></td>
        <td>Server Fundamentals</td>
        <td><?php echo $this->getEventStatus($events, "Server Fundamentals") . "<br>" . $this->getEventDate($events,'Server Fundamentals'); ?></td>
        <td>Implementing ICT Methodologies</td>
        <td><?php echo $this->getEventStatus($events, "Implementing ICT Methodologies") . "<br>" . $this->getEventDate($events,'Implementing ICT Methodologies'); ?></td>
    </tr>
    <tr>
        <td>ICT L3 Workshop 1</td>
        <td><?php echo $this->getEventStatus($events, "ICT L3 Workshop 1") . "<br>" . $this->getEventDate($events,'ICT L3 Workshop 1'); ?></td>
        <td>ICT L3 Workshop 2</td>
        <td><?php echo $this->getEventStatus($events, "ICT L3 Workshop 2") . "<br>" . $this->getEventDate($events,'ICT L3 Workshop 2'); ?></td>
        <td>ICT L3 Workshop 3</td>
        <td><?php echo $this->getEventStatus($events, "ICT L3 Workshop 3") . "<br>" . $this->getEventDate($events,'ICT L3 Workshop 3'); ?></td>
    </tr>
    <tr>
