<?php
class CyberSecurityRiskTechnologist
{
...
<table class=\"table1\" style=\"width: 900px\">
    ...
    <tr>
        ...
        <td rowspan=1 style='text-align:center; vertical-align:middle'>" . ReviewSkillsScans::getEventStatus($events,'Certificate in Cyber Security Introduction Test') . "<br>" . ReviewSkillsScans::getEventDate($events,'Certificate in Cyber Security Introduction Test') . "</td>
    </tr>
    <tr>
   ...
   <tr>
    ...
    <tr>
        ...
        <td rowspan=1 style='text-align:center; vertical-align:middle'>" . ReviewSkillsScans::getEventStatus($events,'Certificate in Network and Digital Communications Test') . "<br>" . ReviewSkillsScans::getEventDate($events,'Certificate in Network and Digital Communications Test') . "</td>
    </tr>
    <tr>
        ...
        <td rowspan=1 style='text-align:center; vertical-align:middle'>" . ReviewSkillsScans::getEventStatus($events,'Certificate in Security Case Development and Design Good Practice Test') . "<br>" . ReviewSkillsScans::getEventDate($events,'Certificate in Security Case Development and Design Good Practice Test') . "</td>
    </tr>
    <tr>
        ...
        <td rowspan=1 style='text-align:center; vertical-align:middle'>" . ReviewSkillsScans::getEventStatus($events,'Certificate in Security Technology Building Blocks Test') . "<br>" . ReviewSkillsScans::getEventDate($events,'Certificate in Security Technology Building Blocks Test') . "</td>
    </tr>
    <tr>
        ...
        <td rowspan=1 style='text-align:center; vertical-align:middle'>" . ReviewSkillsScans::getEventStatus($events,'Certificate in Employment of Cryptography Test') . "<br>" . ReviewSkillsScans::getEventDate($events,'Certificate in Employment of Cryptography Test') . "</td>
    </tr></tbody>
</table>
<br>
<table class=\"table1\" style=\"width: 900px\">
    <thead>
    <tr></tr><th colspan=5>&nbsp;&nbsp;&nbsp;Attitudes & Behaviours</th></tr>
    </thead><tbody>
    ...
    <tr>
        ...
        if(ReviewSkillsScans::isAssessmentComplete($Assessment_Plan, Array("Core Activity 1","Core Activity 2","Core Activity 3","Core Activity 4","Technologist Activity 1 Project 1","Technologist Activity 1 Project 2","Technologist Activity 1 Project 3")))
...
<table class=\"table1\" style=\"width: 900px\">
    <thead>
    <tr></tr><th colspan=6>&nbsp;&nbsp;&nbsp;Progress Summary: Work Place Competence</th></tr>
    </thead><tbody>
