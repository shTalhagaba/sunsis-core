...
<title>Learner On Programme Review Unified Communications Technician V3</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Unified Communications Technician V3</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Unified Communications Technician V3</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Analysis'] . "</td>"; ?>
        ...
        <?php $communication = $this->isAssessmentComplete($Assessment_Plan, Array("Network Technical Support")); echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $communication . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Rectification'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Installing & Configuring'] . "</td>"; ?>
        ...
        <?php $communication = $this->isAssessmentComplete($Assessment_Plan, Array("Cabling and Installation")); echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $communication . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Diagnostic Tools'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Hardware & Software'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Interpreting Specifications'] . "</td>"; ?>
        ...
        <?php $communication = $this->isAssessmentComplete($Assessment_Plan, Array("Network Technical Support and Cabling")); echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $communication . "</td>";?>
    </tr>

    <tr>
        <td>Technical Support</td>
        <td>Respond effectively with customers and provides technical support to them in line with organisations process</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Technical Support'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Documenting Tasks'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Cabling'] . "</td>"; ?>
        ...
        <?php $communication = $this->isAssessmentComplete($Assessment_Plan, Array("Cabling")); echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $communication . "</td>";?>
    </tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Networks: data, protocols and how they relate to each other; the main routing protocols; the main factors affecting network performance including typical faults, and approaches to error control'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Cloud services / solutions, routers and switches'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['IT test or diagnostic equipment'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Cabling and connectivity'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Security principles including software, access, encryption and regulation'] . "</td>"; ?>
    ...
    <tr>
        <td>Firewalls</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Firewalls'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['VPN and Remote Access Security'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Data, including network architectures'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Back-up and storage solutions'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Service level agreements'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Digital communication technologies'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php if(isset($Assessment_Plan['Installation & Cabling Activity 1 - example 1'])) echo $Assessment_Plan['Installation & Cabling Activity 1 - example 1']; else "&nbsp;" ?></td>
        <td>Installation & Cabling Activity 1 - example 2</td>
        <td><?php if(isset($Assessment_Plan['Installation & Cabling Activity 1 - example 2'])) echo $Assessment_Plan['Installation & Cabling Activity 1 - example 2']; else "&nbsp;" ?></td>
        <td>Installation & Cabling Activity 1 - example 3</td>
        <td><?php if(isset($Assessment_Plan['Installation & Cabling Activity 1 - example 3'])) echo $Assessment_Plan['Installation & Cabling Activity 1 - example 3']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Installation & Cabling Activity 2 - Hardware</td>
        <td><?php if(isset($Assessment_Plan['Installation & Cabling Activity 2 - Hardware'])) echo $Assessment_Plan['Installation & Cabling Activity 2 - Hardware']; else "&nbsp;" ?></td>
        <td>Installation & Cabling Activity 2 - Software</td>
        <td><?php if(isset($Assessment_Plan['Installation & Cabling Activity 2 - Software'])) echo $Assessment_Plan['Installation & Cabling Activity 2 - Software']; else "&nbsp;" ?></td>
        <td>Installation & Cabling Activity 2 - Systems</td>
        <td><?php if(isset($Assessment_Plan['Installation & Cabling Activity 2 - Systems'])) echo $Assessment_Plan['Installation & Cabling Activity 2 - Systems']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Installation & Cabling Activity 3</td>
        <td><?php if(isset($Assessment_Plan['Installation & Cabling Activity 3'])) echo $Assessment_Plan['Installation & Cabling Activity 3']; else "&nbsp;" ?></td>
        <td>Network Technical Support Activity 1</td>
        <td><?php if(isset($Assessment_Plan['Network Technical Support Activity 1'])) echo $Assessment_Plan['Network Technical Support Activity 1']; else "&nbsp;" ?></td>
        <td>Network Technical Support Activity 2</td>
        <td><?php if(isset($Assessment_Plan['Network Technical Support Activity 2'])) echo $Assessment_Plan['Network Technical Support Activity 2']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Network Technical Support Activity 3</td>
        <td><?php if(isset($Assessment_Plan['Network Technical Support Activity 3'])) echo $Assessment_Plan['Network Technical Support Activity 3']; else "&nbsp;" ?></td>
        <td>Network Technical Support Activity 4</td>
        <td><?php if(isset($Assessment_Plan['Network Technical Support Activity 4'])) echo $Assessment_Plan['Network Technical Support Activity 4']; else "&nbsp;" ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    </tr>
    <tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "Cloud fundamentals MTA") . "<br>" . $this->getEventDate($events,'Cloud fundamentals MTA'); ?></td>
