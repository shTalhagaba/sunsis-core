...
<table class="table1" style="width: 900px">
    ...
    <tr><td colspan=2>Technical Knowledge</td><td>Skills Scan Grade</td><td>Current Skill Scan Status</td><td>Assessment Plan Status</td></tr>
    <tr>
        ...
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Project Management and Effective Communication in a Business') . "<br>" . $this->getEventDate($events,'Project Management and Effective Communication in a Business') . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=7 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Systems Development') . "<br>" . $this->getEventDate($events,'Systems Development') . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Project Management and Effective Communication in a Business') . "<br>" . $this->getEventDate($events,'Project Management and Effective Communication in a Business') . "</td>";?>
    ...
    <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'IT Virtualisation') . "<br>" . $this->getEventDate($events,'IT Virtualisation') . "</td>";?>
    ...
    <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Data Communication and Networks and Networking Technologies') . "<br>" . $this->getEventDate($events,'Data Communication and Networks and Networking Technologies') . "</td>";?>
    ...
    <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Emerging Technologies') . "<br>" . $this->getEventDate($events,'Emerging Technologies') . "</td>";?>
    ...
    <?php echo "<td rowspan=9 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Installing and Configuring Windows Based Server 2016') . "<br>" . $this->getEventDate($events,'Installing and Configuring Windows Based Server 2016') . "</td>";?>
    ...
    <?php echo "<td rowspan=5 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Project Management and Effective Communication in a Business') . "<br>" . $this->getEventDate($events,'Project Management and Effective Communication in a Business') . "</td>";?>
    <tr><td>2. Be able to agree the scope and objectives of a project</td></tr>
    <tr><td>3. Be able to identify the budget in order to develop a project plan</td></tr>
    <tr><td>4. Be able to implement a project plan</td></tr>
    <tr><td>5. Be able to manage a project to its conclusion</td></tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("ITP-406-PD","ITP-410-PD")))
