...
<title>Learner On Programme Review Digital Marketing V3</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Digital Marketing V3</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Digital Marketing V3</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Environment'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php if(isset($ss_result['Industry Developments and Practices']))
                echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Industry Developments and Practices'] . "</td>";
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php if(isset($Assessment_Plan['Written Communication'])) echo $Assessment_Plan['Written Communication']; else "&nbsp;" ?></td>
        <td>Research</td>
        <td><?php if(isset($Assessment_Plan['Research'])) echo $Assessment_Plan['Research']; else "&nbsp;" ?></td>
        <td>Technologies</td>
        <td><?php if(isset($Assessment_Plan['Technologies'])) echo $Assessment_Plan['Technologies']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Data</td>
        <td><?php if(isset($Assessment_Plan['Data'])) echo $Assessment_Plan['Data']; else "&nbsp;" ?></td>
        <td>Customer Service</td>
        <td><?php if(isset($Assessment_Plan['Customer Service'])) echo $Assessment_Plan['Customer Service']; else "&nbsp;" ?></td>
        <td>Problem Solving</td>
    ...
    <tr>
        ...
        <td><?php if(isset($Assessment_Plan['Implementation'])) echo $Assessment_Plan['Implementation']; else "&nbsp;" ?></td>
        <td>Specialist Areas</td>
        <td><?php if(isset($Assessment_Plan['Specialist Areas'])) echo $Assessment_Plan['Specialist Areas']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Digital Tools</td>
        <td><?php if(isset($Assessment_Plan['Digital Tools'])) echo $Assessment_Plan['Digital Tools']; else "&nbsp;" ?></td>
        <td>Digital Analytics</td>
        <td><?php if(isset($Assessment_Plan['Digital Analytics'])) echo $Assessment_Plan['Digital Analytics']; else "&nbsp;" ?></td>
        <td>Industry Developments & Practices</td>
        <td><?php if(isset($Assessment_Plan['Industry Developments and Practices'])) echo $Assessment_Plan['Industry Developments and Practices']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Effective Business Operation</td>
        <td><?php if(isset($Assessment_Plan['Effective Business Operation'])) echo $Assessment_Plan['Effective Business Operation']; else "&nbsp;" ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
