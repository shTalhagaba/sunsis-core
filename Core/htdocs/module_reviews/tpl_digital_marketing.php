...
<title>Learner On Programme Review Digital Marketing</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Digital Marketing</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Digital Marketing</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php if(isset($Assessment_Plan['Industry Developments & Practices'])) echo $Assessment_Plan['Industry Developments & Practices']; else "&nbsp;" ?></td>
    </tr>
    <tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "9828-11 principles of coding test") . "<br>" . $this->getEventDate($events,'9828-11 principles of coding test'); ?></td>
    ...
    <tr>
        ...
        <td>Digital marketing business principles</td>
        <td><?php echo $this->getEventStatus($events, "Digital marketing business principles") . "<br>" . $this->getEventDate($events,'Digital marketing business principles'); ?></td>
    </tr>
    <tr>
        <td>Digital marketing business principles test</td>
        <td><?php echo $this->getEventStatus($events, "Digital marketing business principles test") . "<br>" . $this->getEventDate($events,'Digital marketing business principles test'); ?></td>
        <td>CIW social media strategist</td>
        <td><?php echo $this->getEventStatus($events, "CIW social media strategist") . "<br>" . $this->getEventDate($events,'CIW social media strategist'); ?></td>
        <td>CIW Test</td>
        <td><?php echo $this->getEventStatus($events, "CIW Test") . "<br>" . $this->getEventDate($events,'CIW Test'); ?></td>
    </tr>
    <tr>
