...
<title>Learner On Programme Review Data Technician</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Data Technician</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Data Technician</th>
                </thead>
            </table>
        </td>
        <td>
...
<tr>
    ...
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Data Gathering EPA') . "</td>";?>
</tr>
...
<tr>
    ...
    <?php
    if(isset($Assessment_Plan['Data Gathering Workplace Project 1']) and $Assessment_Plan['Data Gathering Workplace Project 1']=="Complete" and isset($Assessment_Plan['Data Gathering Workplace Project 2']) and $Assessment_Plan['Data Gathering Workplace Project 2']=="Complete" and $this->getEventStatus($events,'Data Gathering - Workplace Competence')=="Complete")
        echo "<td style='text-align:center; vertical-align:middle'>Complete</td>";
    else
...
<tr>
    ...
    <?php
    if(isset($Assessment_Plan['Data Gathering Workplace Project 1']) and $Assessment_Plan['Data Gathering Workplace Project 1']=="Complete" and isset($Assessment_Plan['Data Gathering Workplace Project 3']) and $Assessment_Plan['Data Gathering Workplace Project 3']=="Complete" and $this->getEventStatus($events,'Data Gathering - Workplace Competence')=="Complete")
        echo "<td style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td style='text-align:center; vertical-align:middle'>&nbsp;</td>";?>
</tr>
...
<tr>
    ...
    <?php
    if(isset($Assessment_Plan['Data Gathering Workplace Project 1']) and $Assessment_Plan['Data Gathering Workplace Project 1']=="Complete" and isset($Assessment_Plan['Data Gathering Workplace Project 4']) and $Assessment_Plan['Data Gathering Workplace Project 4']=="Complete" and $this->getEventStatus($events,'Data Gathering - Workplace Competence')=="Complete")
        echo "<td style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td style='text-align:center; vertical-align:middle'>&nbsp;</td>";?>
</tr>
...
<tr>
    ...
    <?php
    if(isset($Assessment_Plan['Data Gathering Workplace Project 1']) and $Assessment_Plan['Data Gathering Workplace Project 1']=="Complete" and isset($Assessment_Plan['Data Gathering Workplace Project 5']) and $Assessment_Plan['Data Gathering Workplace Project 5']=="Complete" and $this->getEventStatus($events,'Data Gathering - Workplace Competence')=="Complete")
        echo "<td style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td style='text-align:center; vertical-align:middle'>&nbsp;</td>";?>
</tr>
...
<tr>
    ...
    <?php
    if(isset($Assessment_Plan['Data Gathering Workplace Project 1']) and $Assessment_Plan['Data Gathering Workplace Project 1']=="Complete" and isset($Assessment_Plan['Data Gathering Workplace Project 6']) and $Assessment_Plan['Data Gathering Workplace Project 6']=="Complete" and $this->getEventStatus($events,'Data Gathering - Workplace Competence')=="Complete")
        echo "<td style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td style='text-align:center; vertical-align:middle'>&nbsp;</td>";?>
</tr>
...
<tr>
    ...
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Data Analysis & Validation EPA') . "</td>";?>
</tr>
...
<tr>
    ...
    <?php
    if(isset($Assessment_Plan['Data Distribution & Dissemination Workplace Project 1']) and $Assessment_Plan['Data Distribution & Dissemination Workplace Project 1']=="Complete" and isset($Assessment_Plan['Data Distribution & Dissemination Workplace Project 2']) and $Assessment_Plan['Data Distribution & Dissemination Workplace Project 2']=="Complete" and $this->getEventStatus($events,'Data Distribution & Dissemination Workplace Competence')=="Complete")
        echo "<td style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td style='text-align:center; vertical-align:middle'>&nbsp;</td>";?>
</tr>
...
<tr>
    ...
    <?php
    if(isset($Assessment_Plan['Data Distribution & Dissemination Workplace Project 1']) and $Assessment_Plan['Data Distribution & Dissemination Workplace Project 1']=="Complete" and isset($Assessment_Plan['Data Distribution & Dissemination Workplace Project 3']) and $Assessment_Plan['Data Distribution & Dissemination Workplace Project 3']=="Complete" and $this->getEventStatus($events,'Data Distribution & Dissemination Workplace Competence')=="Complete")
        echo "<td style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td style='text-align:center; vertical-align:middle'>&nbsp;</td>";?>
</tr>
...
<tr>
    ...
    <?php
    if(isset($Assessment_Plan['Data Distribution & Dissemination Workplace Project 1']) and $Assessment_Plan['Data Distribution & Dissemination Workplace Project 1']=="Complete" and isset($Assessment_Plan['Data Distribution & Dissemination Workplace Project 4']) and $Assessment_Plan['Data Distribution & Dissemination Workplace Project 4']=="Complete" and $this->getEventStatus($events,'Data Distribution & Dissemination Workplace Competence')=="Complete")
        echo "<td style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td style='text-align:center; vertical-align:middle'>&nbsp;</td>";?>
</tr>
...
<tr>
    ...
    <?php
    if(isset($Assessment_Plan['Data Distribution & Dissemination Workplace Project 1']) and $Assessment_Plan['Data Distribution & Dissemination Workplace Project 1']=="Complete" and isset($Assessment_Plan['Data Distribution & Dissemination Workplace Project 5']) and $Assessment_Plan['Data Distribution & Dissemination Workplace Project 5']=="Complete" and $this->getEventStatus($events,'Data Distribution & Dissemination Workplace Competence')=="Complete")
        echo "<td style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td style='text-align:center; vertical-align:middle'>&nbsp;</td>";?>
</tr>
...
<tr>
    ...
    <?php
    if(isset($Assessment_Plan['Data Distribution & Dissemination Workplace Project 1']) and $Assessment_Plan['Data Distribution & Dissemination Workplace Project 1']=="Complete" and isset($Assessment_Plan['Data Distribution & Dissemination Workplace Project 6']) and $Assessment_Plan['Data Distribution & Dissemination Workplace Project 6']=="Complete" and $this->getEventStatus($events,'Data Distribution & Dissemination Workplace Competence')=="Complete")
        echo "<td style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td style='text-align:center; vertical-align:middle'>&nbsp;</td>";?>
</tr>
...
<tr>
    ...
    <?php
    if(isset($Assessment_Plan['Data Distribution & Dissemination Workplace Project 1']) and $Assessment_Plan['Data Distribution & Dissemination Workplace Project 1']=="Complete" and isset($Assessment_Plan['Data Distribution & Dissemination Workplace Project 7']) and $Assessment_Plan['Data Distribution & Dissemination Workplace Project 7']=="Complete" and $this->getEventStatus($events,'Data Distribution & Dissemination Workplace Competence')=="Complete")
        echo "<td style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td style='text-align:center; vertical-align:middle'>&nbsp;</td>";?>
</tr>
...
<tr>
    ...
    <?php $performance = isset($Assessment_Plan['Approach to Work Workplace Project'])?$Assessment_Plan['Approach to Work Workplace Project']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $performance . "</td>";?>
</tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php if(isset($Assessment_Plan['Approach to Work Workplace Project'])) echo $Assessment_Plan['Approach to Work Workplace Project']; else "&nbsp;" ?></td>
        <td>Data Gathering Workplace Project 1</td>
        <td><?php if(isset($Assessment_Plan['Data Gathering Workplace Project 1'])) echo $Assessment_Plan['Data Gathering Workplace Project 1']; else "&nbsp;" ?></td>
        <td>Data Analysis & Validation Project 1</td>
        <td><?php if(isset($Assessment_Plan['Data Analysis & Validation Project 1'])) echo $Assessment_Plan['Data Analysis & Validation Project 1']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Data Distribution & Dissemination Workplace Project 1</td>
        <td><?php if(isset($Assessment_Plan['Data Distribution & Dissemination Workplace Project 1'])) echo $Assessment_Plan['Data Distribution & Dissemination Workplace Project 1']; else "&nbsp;" ?></td>
        <td>Data Gathering Workplace Project 2</td>
        <td><?php if(isset($Assessment_Plan['Data Gathering Workplace Project 2'])) echo $Assessment_Plan['Data Gathering Workplace Project 2']; else "&nbsp;" ?></td>
        <td>Data Analysis & Validation Project 2</td>
        <td><?php if(isset($Assessment_Plan['Data Analysis & Validation Project 2'])) echo $Assessment_Plan['Data Analysis & Validation Project 2']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Data Distribution & Dissemination Workplace Project 2</td>
        <td><?php if(isset($Assessment_Plan['Data Distribution & Dissemination Workplace Project 2'])) echo $Assessment_Plan['Data Distribution & Dissemination Workplace Project 2']; else "&nbsp;" ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td>Data Analysis and Validation - Workplace Competence</td>
        <td><?php echo $this->getEventStatus($events, "Data Analysis and Validation - Workplace Competence") . "<br>" . $this->getEventDate($events,'Data Analysis and Validation - Workplace Competence'); ?></td>
        <td>Data Distribution and Dissemination - Workplace Competence</td>
        <td><?php echo $this->getEventStatus($events, "Data Distribution and Dissemination - Workplace Competence") . "<br>" . $this->getEventDate($events,'Data Distribution and Dissemination - Workplace Competence'); ?></td>
        <td>Data Gathering - EPA</td>
        <td><?php echo $this->getEventStatus($events, "Data Gathering - EPA") . "<br>" . $this->getEventDate($events,'Data Gathering - EPA'); ?></td>
    </tr>
    <tr>
        <td>Data Analysis and Validation - EPA</td>
        <td><?php echo $this->getEventStatus($events, "Data Analysis and Validation - EPA") . "<br>" . $this->getEventDate($events,'Data Analysis and Validation - EPA'); ?></td>
        <td>EPA Prep</td>
        <td><?php echo $this->getEventStatus($events, "EPA Prep") . "<br>" . $this->getEventDate($events,'EPA Prep'); ?></td>
        <td>Data Gathering - Workplace Competence</td>
        <td><?php echo $this->getEventStatus($events, "Data Gathering - Workplace Competence") . "<br>" . $this->getEventDate($events,'Data Gathering - Workplace Competence'); ?></td>
    </tr>
    <tr>
