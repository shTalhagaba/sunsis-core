...
<title>Learner On Programme Review Infrastructure Technician V5</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Infrastructure Technician V5</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Infrastructure Technician V5</th>
                </thead>
            </table>
        </td>
        <td>
