...
<title>Learner On Programme Review Unified Communications Technician V2</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Unified Communications Technician V2</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Unified Communications Technician V2</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <!--<tr>
        ...
        <?php //if(SOURCE_BLYTHE_VALLEY) pre($ss_result); "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Installing'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td>Cabling</td>
        <td><?php if(isset($Assessment_Plan['Cabling'])) echo $Assessment_Plan['Cabling']; else "&nbsp;" ?></td>
        <td>Installation</td>
        <td><?php if(isset($Assessment_Plan['Installation'])) echo $Assessment_Plan['Installation']; else "&nbsp;" ?></td>
        <td>Network Technical Support</td>
        <td><?php if(isset($Assessment_Plan['Network Technical Support'])) echo $Assessment_Plan['Network Technical Support']; else "&nbsp;" ?></td>
    </tr>
