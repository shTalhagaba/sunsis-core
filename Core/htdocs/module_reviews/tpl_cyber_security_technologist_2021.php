...
<title>Learner On Programme Review Cyber Security Technologist</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Cyber Security Technologist</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Cyber Security Technologist</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php $communication = $this->isAssessmentComplete($Assessment_Plan, Array("Core Activity 1","Core Activity 2","Core Activity 3","Core Activity 4")); echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $communication . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Design, build, test and troubleshoot a network incorporating more than one subnet with static and dynamic routes that includes servers, hubs, switches, routers and user devices'] . "</td>"; ?>
        ...
        <?php $communication = $this->isAssessmentComplete($Assessment_Plan, Array("Technologist Activity 1 Project 1","Technologist Activity 1 Project 2","Technologist Activity 1 Project 3")); echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $communication . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Analyse security requirements (functional and non-functional security requirements that may be presented in a security case) against other design requirements (e.g. usability, cost, size, weight, power, heat, supportability etc.), given for a given system or product. Identify conflicting requirements and propose, with reasoning, resolution through appropriate trade-offs'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Design and build a simple system in accordance with a simple security case to include properly implemented security controls required by the security case'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Configure relevant types of common security hardware and software components to implement a given security policy'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Design a system employing a crypto to meet defined security objectives. Develop and implement a key management plan for the given scenario/system'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Security assurance - concepts and how assurance may be achieved in practice (e.g. penetration testing is and how it contributes to assurance; and extrinsic assurance methods)'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Basics of networks: data, protocols and how they relate to each other; the main routing protocols; the main factors affecting network performance including typical failure modes in protocols and approaches to error control'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['How to build a security case: what good practice in design is; common security architectures; awareness of reputable security architectures that incorporates hardware and software components, and sources of architecture patterns and guidance. How to build a security case including context, threats, justifying the selected mitigations and security controls with reasoning and recognising the dynamic and adaptable nature of threats'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['How cyber security technology components are typically deployed in networks and systems to provide security functionality including: hardware and software'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Basics of cryptography - the main techniques, the significance of key management and the legal issues'] . "</td>"; ?>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status28", $ss_statuses, $form_arf->skills_scan_status29, true, false, $assessor_signed) . "</td>";?>
    </tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php if(isset($Assessment_Plan['Technologist Activity 1 Project 1'])) echo $Assessment_Plan['Technologist Activity 1 Project 1']; else "&nbsp;" ?></td>
        <td>Technologist Activity 1 Project 2</td>
        <td><?php if(isset($Assessment_Plan['Technologist Activity 1 Project 2'])) echo $Assessment_Plan['Technologist Activity 1 Project 2']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Technologist Activity 1 Project 3</td>
        <td><?php if(isset($Assessment_Plan['Technologist Activity 1 Project 3'])) echo $Assessment_Plan['Technologist Activity 1 Project 3']; else "&nbsp;" ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "Certificate in network and digital communications test") . "<br>" . $this->getEventDate($events,'Certificate in network and digital communications test'); ?></td>
        <td>Certificate in security case development and design good practice</td>
        <td><?php echo $this->getEventStatus($events, "Certificate in security case development and design good practice") . "<br>" . $this->getEventDate($events,'Certificate in security case development and design good practice'); ?></td>
        <td>Certificate in security case development and design good practice test</td>
        <td><?php echo $this->getEventStatus($events, "Certificate in security case development and design good practice test") . "<br>" . $this->getEventDate($events,'Certificate in security case development and design good practice test'); ?></td>
    </tr>
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "Certificate in security technology building blocks test") . "<br>" . $this->getEventDate($events,'Certificate in security technology building blocks test'); ?></td>
        <td>Certificate in employment of cryptography</td>
        <td><?php echo $this->getEventStatus($events, "Certificate in employment of cryptography") . "<br>" . $this->getEventDate($events,'Certificate in employment of cryptography'); ?></td>
    </tr>
    <tr>
        <td>Certificate in employment of cryptography test</td>
        <td><?php echo $this->getEventStatus($events, "Certificate in employment of cryptography test") . "<br>" . $this->getEventDate($events,'Certificate in employment of cryptography test'); ?></td>
