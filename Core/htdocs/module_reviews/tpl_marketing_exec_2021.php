...
<title>Learner On Programme Review Marketing Executive</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Marketing Executive</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Marketing Executive</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Coordinate and maintain key marketing channels (both digital and offline)'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Plan and deliver tactical campaigns against SMART (Specific, Measurable, Achievable, Realistic, Time-bound) objectives'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Manage the production and distribution of marketing materials, e.g. digital, print and video content as appropriate'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Produce a wide range of creative and effective communications, including ability to write and proofread clear and innovative copy, project briefs, and give confident presentations'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Able to engage and collaborate with a wide range of clients/stakeholders, across departments internally and with clients/suppliers externally to support marketing outcomes as required'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Use good project and time management to deliver projects/tasks/events as appropriate, effectively. Including the ability to divide time effectively between reporting, planning and delivery'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Coordinate several marketing campaigns/projects/events to agreed deadlines'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Effectively liaise with, and manage, internal and external stakeholders including suppliers to deliver required outcomes'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Monitor project budgets within their scope of work using appropriate systems and controls'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Evaluate the effectiveness of marketing campaigns by choosing the appropriate digital and offline data sources'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Evaluate data and research findings to derive insights to support improvements to future campaigns'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Effectively use appropriate business systems and software to deliver marketing outcomes efficiently, for example to analyse data, produce reports and deliver copy'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Use appropriate technologies to deliver marketing outcomes e.g. digital/web analytics, social media, CRM'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The fundamentals of marketing theory that support the marketing process e.g. the extended marketing mix (7Ps: Product, Price, Place, Promotion, Physical environment, Process, People), product development, and segmentation'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The concepts of brand positioning and management and implementing process to support corporate reputation'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The principles of stakeholder management and customer relationship management (CRM), both internal and external, to facilitate effective cross-functional relationships internally, and channel and customer relationships externally'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The characteristics and plans of the business and sector they work within, including their vision and values'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['How marketing contributes to achieving wider business objectives'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The target audiences decision making process and how that can influence marketing activities'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The sector specific legal, regulatory and compliance frameworks within which they must work, including current Data Protection regulations'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The principles of effective market research and how this can influence marketing activity e.g. valid data collection sources and methodologies and usage, including digital sources, and when to use quantitative and qualitative methods.'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Basic principles of product development and product/service portfolios'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The marketing landscape and how routes to market interplay most efficiently, e.g. franchise model, distribution'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The features and benefits of different marketing communications channels and media, both digital and offline, and when and how to apply these'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['A tenacious and driven approach to see projects through to completion'] . "</td>"; ?>
        <?php echo "<td style='text-align:center'>" . (($previous_review->skills_scan_status25!="")?$sss[$previous_review->skills_scan_status25]:"") . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Being a proven self-starter and have an adaptable approach to meet changing work priorities'] . "</td>"; ?>
        <?php echo "<td style='text-align:center'>" . (($previous_review->skills_scan_status26!="")?$sss[$previous_review->skills_scan_status26]:"") . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['A creative and analytical mind, with a willingness to think of new ways of doing things'] . "</td>"; ?>
        <?php echo "<td style='text-align:center'>" . (($previous_review->skills_scan_status27!="")?$sss[$previous_review->skills_scan_status27]:"") . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['They come up with ideas and solutions to support the delivery of their work'] . "</td>"; ?>
        <?php echo "<td style='text-align:center'>" . (($previous_review->skills_scan_status28!="")?$sss[$previous_review->skills_scan_status28]:"") . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['A willingness to learn from mistakes, as not all activities go to plan, and improve their own performance as a result'] . "</td>"; ?>
        <?php echo "<td style='text-align:center'>" . (($previous_review->skills_scan_status29!="")?$sss[$previous_review->skills_scan_status29]:"") . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['A high level of professionalism, reliability and dependability with a passion for the customer'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Ethical behaviour in the way they approach marketing activities and their work, valuing equality & diversity'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php if(isset($Assessment_Plan['Target Audience Workplace Project'])) echo $Assessment_Plan['Target Audience Workplace Project']; else "&nbsp;" ?></td>
        <td>Social Media Content Workplace Project</td>
        <td><?php if(isset($Assessment_Plan['Social Media Content Workplace Project'])) echo $Assessment_Plan['Social Media Content Workplace Project']; else "&nbsp;" ?></td>
        <td>Marketing Environment Project</td>
        <td><?php if(isset($Assessment_Plan['Marketing Environment Project'])) echo $Assessment_Plan['Marketing Environment Project']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Marketing Campaign Workplace Project</td>
        <td><?php if(isset($Assessment_Plan['Marketing Campaign Workplace Project'])) echo $Assessment_Plan['Marketing Campaign Workplace Project']; else "&nbsp;" ?></td>
        <td>Creative Copy Workplace Project</td>
        <td><?php if(isset($Assessment_Plan['Creative Copy Workplace Project'])) echo $Assessment_Plan['Creative Copy Workplace Project']; else "&nbsp;" ?></td>
        <td>Campaign Choice Workplace Project</td>
        <td><?php if(isset($Assessment_Plan['Campaign Choice Workplace Project'])) echo $Assessment_Plan['Campaign Choice Workplace Project']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Personal Development Evaluation Workplace Project</td>
        <td><?php if(isset($Assessment_Plan['Personal Development Evaluation Workplace Project'])) echo $Assessment_Plan['Personal Development Evaluation Workplace Project']; else "&nbsp;" ?></td>
        <td>Over & above</td>
        <td><?php if(isset($Assessment_Plan['Over & above'])) echo $Assessment_Plan['Over & above']; else "&nbsp;" ?></td>
        <td>Role overview</td>
        <td><?php if(isset($Assessment_Plan['Role overview'])) echo $Assessment_Plan['Role overview']; else "&nbsp;" ?></td>
    </tr>
    <tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "Market Research") . "<br>" . $this->getEventDate($events,'Market Research'); ?></td>
        <td>Products and Channels</td>
        <td><?php echo $this->getEventStatus($events, "Products and Channels") . "<br>" . $this->getEventDate($events,'Products and Channels'); ?></td>
        <td>EPA Prep</td>
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "Marketing Concepts and Theories") . "<br>" . $this->getEventDate($events,'Marketing Concepts and Theories'); ?></td>
        <td>Business Understanding and Commercial Awareness</td>
        <td><?php echo $this->getEventStatus($events, "Business Understanding and Commercial Awareness") . "<br>" . $this->getEventDate($events,'Business Understanding and Commercial Awareness'); ?></td>
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "Functional Skills English Reading Test") . "<br>" . $this->getEventDate($events,'Functional Skills English Reading Test'); ?></td>
        <td>Functional Skills Writing Test</td>
        <td><?php echo $this->getEventStatus($events, "Functional Skills Writing Test") . "<br>" . $this->getEventDate($events,'Functional Skills Writing Test'); ?></td>
    ...
    <tr>
        ...
        <td>SLC</td>
        <td><?php echo $this->getEventStatus($events, "SLC") . "<br>" . $this->getEventDate($events,'SLC');?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    </tr>
    <tr>
