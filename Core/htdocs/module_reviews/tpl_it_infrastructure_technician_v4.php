...
<title>Learner On Programme Review Infrastructure Technician V4</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Infrastructure Technician V4</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Infrastructure Technician V4</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><b>Prevent, Radicalisation and Extremism</b><br>Explore with learners their understanding of Prevent, Radicalisation and Extremism and British values. Educate and challenge as appropriate.</b></td>
    </tr>
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
    ...
    <tr>
        <td colspan=4><b>Additional Support Requirements</b><br>Is there any additional support you would like from Baltic Training or your Line Manager</b></td>
    </tr>
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php $tk = isset($tk_result['9628-06 Networking and Architecture Test'])?$tk_result['9628-06 Networking and Architecture Test']:""; ?>
        <?php echo "<td rowspan=5 style='text-align:center; vertical-align:middle'>" . $tk . "</td>"; ?>
    ...
    <tr>
        ...
        <?php $tk = isset($tk_result['Mobility and Devices MTA Test'])?$tk_result['Mobility and Devices MTA Test']:""; ?>
        <?php echo "<td rowspan=2 style='text-align:center; vertical-align:middle'>" . $tk . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    <thead>
    <th colspan=4>&nbsp;&nbsp;&nbsp;<b>Functional Skills Development: In the workplace - In everyday use - In training</b></th>
    </thead>
