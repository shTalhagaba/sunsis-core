...
<title>Learner On Programme Review Data Analyst V3</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Data Analyst V3</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Data Analyst V3</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Use data systems securely to meet requirements and in line with organisational procedures and legislation, including principles of Privacy by Design'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Implement the stages of the data analysis lifecycle'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Apply principles of data classification within data analysis activity'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Analyse data sets taking account of different data structures and database designs'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Assess the impact on user experience and domain context on the data analysis activity'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Identify and escalate quality risks in data analysis with suggested mitigation/resolutions as appropriate'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Undertake customer requirements analysis and implement findings in data analytics planning and outputs'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Identify data sources and the risks, challenges to combination within data analysis activity'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Apply organizational architecture requirements to data analysis activities'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Apply statistical methodologies to data analysis tasks'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Apply predictive analytics in the collation and use of data'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Collaborate and communicate with a range of internal and external stakeholders using appropriate styles and behaviours to suit the audience'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Use a range of analytical techniques such as data mining, time series forecasting and modelling techniques to identify and predict trends and patterns in data'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Collate and interpret qualitative and quantitative data and convert into infographics, reports, tables, dashboards and graphs'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Select and apply the most appropriate data tools to achieve the best outcome'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Current relevant legislation and its application to the safe use of data'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Organisational data and information security standards, policies and procedures relevant to data management activities'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Principles of the data life cycle and the steps involved in carrying out routine data analysis tasks'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Principles of data, including open and public data, administrative data, and research data'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Principles of user experience and domain context for data analytics'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Quality risks inherent in data and how to mitigate/resolve these'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Principal approaches to defining customer requirements for data analysis'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Approaches to combining data from different sources'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Approaches to organisational tools and methods for data analysis'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Organisational data architecture'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Principles of statistics for analysing datasets'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The principles of descriptive, predictive and prescriptive analytics'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The ethical aspects associated with the use of and collation of data'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Shows initiative, being resourceful when faced with a problem and taking responsibility for solving problems within their own remit'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Works independently and collaboratively'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Works logically and analytically'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Identifies issues quickly, enjoys investigating and solving complex problems and applies appropriate solutions. Has a strong desire to push to ensure the true root cause of any problem is found and a solution is identified which prevents recurrence'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Demonstrates resilience by viewing obstacles as challenges and learning from failure'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Demonstrates an ability to adapt to changing contexts within the scope of a project, direction of the organisation or Data Analyst role'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "Data Analysis Concepts") . "<br>" . $this->getEventDate($events,'Data Analysis Concepts'); ?></td>
        <td>SQL for Data Analysis</td>
        <td><?php echo $this->getEventStatus($events, "SQL for Data Analysis") . "<br>" . $this->getEventDate($events,'SQL for Data Analysis'); ?></td>
        <td>Data Analysis Using Python and R</td>
        <td><?php echo $this->getEventStatus($events, "Data Analysis Using Python and R") . "<br>" . $this->getEventDate($events,'Data Analysis Using Python and R'); ?></td>
    </tr>
    <tr>
        <td>Data Visualisation</td>
        <td><?php echo $this->getEventStatus($events, "Data Visualisation") . "<br>" . $this->getEventDate($events,'Data Visualisation'); ?></td>
        <td>Implementing Data Analysis Tools and Techniques</td>
        <td><?php echo $this->getEventStatus($events, "Implementing Data Analysis Tools and Techniques") . "<br>" . $this->getEventDate($events,'Implementing Data Analysis Tools and Techniques'); ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    </tr>
    <tr>
