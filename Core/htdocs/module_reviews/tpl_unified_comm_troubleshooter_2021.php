...
<title>Learner On Programme Review Unified Communications Troubleshooter</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Unified Communications Troubleshooter</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Unified Communications Troubleshooter</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Voice Solutions'] . "</td>"; ?>
        ...
        <?php $communication = $this->isAssessmentComplete($Assessment_Plan, Array("Voice Solutions")); echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $communication . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Data Solutions'] . "</td>"; ?>
        ...
        <?php $communication = $this->isAssessmentComplete($Assessment_Plan, Array("Data Solutions")); echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $communication . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Network Services Solutions'] . "</td>"; ?>
        ...
        <?php $communication = $this->isAssessmentComplete($Assessment_Plan, Array("Network Services Solutions")); echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $communication . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Domain Services'] . "</td>"; ?>
        ...
        <?php $communication = $this->isAssessmentComplete($Assessment_Plan, Array("Domain Services")); echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $communication . "</td>";?>
    </tr>

    <tr>
        <td rowspan=1>Networks</td>
        <td>Configure and maintain a domain service including assigning services, deploying software and applying updates</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Networks'] . "</td>"; ?>
        ...
        <?php $communication = $this->isAssessmentComplete($Assessment_Plan, Array("Networks")); echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $communication . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php $communication = $this->isAssessmentComplete($Assessment_Plan, Array("Security")); echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $communication . "</td>";?>
    </tr>

    <tr>
        <td>Servers</td>
        <td>Configure and maintain servers including storage, print services, group policy and updates</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Servers'] . "</td>"; ?>
        ...
        <?php $communication = $this->isAssessmentComplete($Assessment_Plan, Array("Servers")); echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $communication . "</td>";?>
    </tr>

    <tr>
        <td>Software</td>
        <td>Configure and maintain client software, including managing user profiles and troubleshooting user issues</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Software'] . "</td>"; ?>
        ...
        <?php $communication = $this->isAssessmentComplete($Assessment_Plan, Array("Software")); echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $communication . "</td>";?>
    </tr>
</table>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Server administration principles including storage, print services, group policy, availability, load balancing, failover clustering, back-up and disaster recovery'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Server and client architecture, features, deployment process and troubleshooting tools for client software and applications'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Security principles including software, access such as VPN, encryption and auditing'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Network fundamentals including network components and internet protocols'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Network services solutions including cloud services, SIP (Session Initiation Protocol), internet connectivity, mobility, fixed lines and hosted solutions'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Domain services including administration, user and service accounts and group policy'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Voice solutions and can identify the components of such a solution, the features, the deployment process and troubleshooting tools and techniques'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Data solutions (LAN/WAN/WLAN), the differences between the different technologies and how the components form part of a solution'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php if(isset($Assessment_Plan['Data Solutions'])) echo $Assessment_Plan['Data Solutions']; else "&nbsp;" ?></td>
        <td>Networks</td>
        <td><?php if(isset($Assessment_Plan['Networks'])) echo $Assessment_Plan['Networks']; else "&nbsp;" ?></td>
        <td>Servers</td>
        <td><?php if(isset($Assessment_Plan['Servers'])) echo $Assessment_Plan['Servers']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Voice Solutions</td>
        <td><?php if(isset($Assessment_Plan['Voice Solutions'])) echo $Assessment_Plan['Voice Solutions']; else "&nbsp;" ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "Network fundamentals MTA") . "<br>" . $this->getEventDate($events,'Network fundamentals MTA'); ?></td>
        <td>Network systems and architecture</td>
        <td><?php echo $this->getEventStatus($events, "Network systems and architecture") . "<br>" . $this->getEventDate($events,'Network systems and architecture'); ?></td>
        <td>Network security</td>
        <td><?php echo $this->getEventStatus($events, "Network security") . "<br>" . $this->getEventDate($events,'Network security'); ?></td>
    </tr>
    <tr>
        <td>BCS award in voice and data solutions</td>
        <td><?php echo $this->getEventStatus($events, "BCS award in voice and data solutions") . "<br>" . $this->getEventDate($events,'BCS award in voice and data solutions'); ?></td>
        <td>Network fundamentals MTA test</td>
        <td><?php echo $this->getEventStatus($events, "Network fundamentals MTA test") . "<br>" . $this->getEventDate($events,'Network fundamentals MTA test'); ?></td>
        <td>BCS award in server test</td>
        <td><?php echo $this->getEventStatus($events, "BCS award in server test") . "<br>" . $this->getEventDate($events,'BCS award in server test'); ?></td>
    </tr>
    <tr>
        <td>BCS award in voice and data solutions</td>
        <td><?php echo $this->getEventStatus($events, "BCS award in voice and data solutions") . "<br>" . $this->getEventDate($events,'BCS award in voice and data solutions'); ?></td>
