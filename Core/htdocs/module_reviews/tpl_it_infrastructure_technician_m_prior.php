...
<title>Learner On Programme Review IT Infrastructure Technician Microsoft</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review IT Infrastructure Technician Microsoft</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review IT Infrastructure Technician Microsoft</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td>Health & Safety</td>
        <td><?php if(isset($Assessment_Plan['Health & Safety'])) echo $Assessment_Plan['Health & Safety']; else "&nbsp;" ?></td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "Motability and devices MTA") . "<br>" . $this->getEventDate($events,'Motability and devices MTA'); ?></td>
    </tr>
    <tr>
        <td>Mobility and devices MTA test</td>
        <td><?php echo $this->getEventStatus($events, "Motability and devices MTA test") . "<br>" . $this->getEventDate($events,'Motability and devices MTA test'); ?></td>
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "ITIL business processes") . "<br>" . $this->getEventDate($events,'ITIL business processes'); ?></td>
        <td>ITIL foundation test business processes test</td>
        <td><?php echo $this->getEventStatus($events, "ITIL foundation test business processes test") . "<br>" . $this->getEventDate($events,'ITIL foundation test business processes test'); ?></td>
    ...
    <tr>
        <td>Coding and logic test</td>
        <td><?php echo $this->getEventStatus($events, "Coding and logic test") . "<br>" . $this->getEventDate($events,'Coding and logic test'); ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
