...
<title>Learner On Programme Review Data Analyst V2</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Data Analyst V2</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Data Analyst V2</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Identify, collect and migrate data to/from a range of internal and external systems'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Manipulate and link different data sets as required'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Interpret and apply the organisation data and information security Standards, policies and procedures to data management activities'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Collect and compile data from different sources'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Perform database queries across multiple tables to extract data for analysis'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Perform routine statistical analyses and ad-hoc queries'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Use a range of analytical techniques such as data mining, time series forecasting and modelling techniques to identify and predict trends and patterns in data'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Assist production of performance dashboards and reports'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Assist with data quality checking and cleansing'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Apply the tools and techniques for data analysis, data visualisation and presentation'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Assist with the production of a range of ad-hoc and standard data analysis reports'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Summarise and present the results of data analysis to a range of stakeholders making recommendations'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Works with the organisations data architecture'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The range of data protection and legal issues'] . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status13", $ss_statuses, $form_arf->skills_scan_status13, true, false, $assessor_signed) . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The different types of data, including open and public data, administrative data, and research data'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The differences between structured and unstructured data'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The fundamentals of data structures, database system design, implementation and maintenance'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The importance of the domain context for data analytics'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The quality issues that can arise with data and how to avoid and/or resolve these'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The importance of clearly defining customer requirements for data analysis'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The processes and tools used for data integration'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The steps involved in carrying out routine data analysis tasks'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['How to use and apply industry standard tools and methods for data analysis'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php if(isset($Assessment_Plan['Data Architecture & Processes Workplace Project'])) echo $Assessment_Plan['Data Architecture & Processes Workplace Project']; else "&nbsp;" ?></td>
        <td>Collecting & Cleansing Data Workplace Project 1</td>
        <td><?php if(isset($Assessment_Plan['Collecting & Cleansing Data Workplace Project 1'])) echo $Assessment_Plan['Collecting & Cleansing Data Workplace Project 1']; else "&nbsp;" ?></td>
        <td>Analysing Data Workplace Project 1</td>
        <td><?php if(isset($Assessment_Plan['Analysing Data Workplace Project 1'])) echo $Assessment_Plan['Analysing Data Workplace Project 1']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Reporting Data Workplace Project 1</td>
        <td><?php if(isset($Assessment_Plan['Reporting Data Workplace Project 1'])) echo $Assessment_Plan['Reporting Data Workplace Project 1']; else "&nbsp;" ?></td>
        <td>Collecting & Cleansing Data Workplace Project 2</td>
        <td><?php if(isset($Assessment_Plan['Collecting & Cleansing Data Workplace Project 2'])) echo $Assessment_Plan['Collecting & Cleansing Data Workplace Project 2']; else "&nbsp;" ?></td>
        <td>Analysing Data Workplace Project 2</td>
        <td><?php if(isset($Assessment_Plan['Analysing Data Workplace Project 2'])) echo $Assessment_Plan['Analysing Data Workplace Project 2']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Reporting Data Workplace Project 2</td>
        <td><?php if(isset($Assessment_Plan['Reporting Data Workplace Project 2'])) echo $Assessment_Plan['Reporting Data Workplace Project 2']; else "&nbsp;" ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "Data Analysis Concepts Part 1") . "<br>" . $this->getEventDate($events,'Data Analysis Concepts Part 1'); ?></td>
        <td>Data Analysis Concepts Part 2</td>
        <td><?php echo $this->getEventStatus($events, "Data Analysis Concepts Part 2") . "<br>" . $this->getEventDate($events,'Data Analysis Concepts Part 2'); ?></td>
        <td>Data Analysis Tools Part 1</td>
        <td><?php echo $this->getEventStatus($events, "Data Analysis Tools Part 1") . "<br>" . $this->getEventDate($events,'Data Analysis Tools Part 1'); ?></td>
    </tr>
    <tr>
        <td>Data Analysis Tools Part 2</td>
        <td><?php echo $this->getEventStatus($events, "Data Analysis Tools Part 2") . "<br>" . $this->getEventDate($events,'Data Analysis Tools Part 2'); ?></td>
        <td>BCS Level 4 Dip in Data Analysis Concepts Test</td>
        <td><?php echo $this->getEventStatus($events, "BCS Level 4 Dip in Data Analysis Concepts Test") . "<br>" . $this->getEventDate($events,'BCS Level 4 Dip in Data Analysis Concepts Test'); ?></td>
        <td>BCS Level 4 Cert in Data Analysis Tools Test</td>
        <td><?php echo $this->getEventStatus($events, "BCS Level 4 Cert in Data Analysis Tools Test") . "<br>" . $this->getEventDate($events,'BCS Level 4 Cert in Data Analysis Tools Test'); ?></td>
    </tr>
    <tr>
        <td>Implementing Data Analysis Concepts and Tools  EPA Prep Course</td>
        <td><?php echo $this->getEventStatus($events, "Implementing Data Analysis Concepts and Tools  EPA Prep Course") . "<br>" . $this->getEventDate($events,'Implementing Data Analysis Concepts and Tools  EPA Prep Course'); ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
