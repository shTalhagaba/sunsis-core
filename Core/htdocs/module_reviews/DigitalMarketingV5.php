...
<table class=\"table1\" style=\"width: 900px\">
    ...
    <tr>
        ...
        <td>"; if(isset($Assessment_Plan['Campaign 1 Activity 1'])) $html .= $Assessment_Plan['Campaign 1 Activity 1']; $html .="</td>
        <td>Campaign 1 Activity 2</td>
        <td>"; if(isset($Assessment_Plan['Campaign 1 Activity 2'])) $html .= $Assessment_Plan['Campaign 1 Activity 2']; $html .="</td>
        <td>Campaign 1 Activity 3</td>
        <td>"; if(isset($Assessment_Plan['Campaign 1 Activity 3'])) $html .= $Assessment_Plan['Campaign 1 Activity 3']; $html .= "</td>
    </tr>
    <tr>
        <td>Campaign 2 Activity 1</td>
        <td>"; if(isset($Assessment_Plan['Campaign 2 Activity 1'])) $html .= $Assessment_Plan['Campaign 2 Activity 1']; $html .= "</td>
        <td>Campaign 2 Activity 2</td>
        <td>"; if(isset($Assessment_Plan['Campaign 2 Activity 2'])) $html .= $Assessment_Plan['Campaign 2 Activity 2']; $html .= "</td>
        <td>Campaign 2 Activity 3</td>
        <td>"; if(isset($Assessment_Plan['Campaign 2 Activity 3'])) $html .= $Assessment_Plan['Campaign 2 Activity 3']; $html .= "</td>
    </tr>
    <tr>
        <td>Professional Practise Activity 1</td>
        <td>"; if(isset($Assessment_Plan['Professional Practise Activity 1'])) $html .= $Assessment_Plan['Professional Practise Activity 1']; $html .= "</td>
        <td>Professional Practise Activity 2</td>
        <td>"; if(isset($Assessment_Plan['Professional Practise Activity 2'])) $html .= $Assessment_Plan['Professional Practise Activity 2']; $html .= "</td>
        <td>Professional Practise Activity 3</td>
        <td>"; if(isset($Assessment_Plan['Professional Practise Activity 3'])) $html .= $Assessment_Plan['Professional Practise Activity 3']; $html .= "</td>
    </tr>
    <tr>
        <td>Professional Practise Activity 4</td>
        <td>"; if(isset($Assessment_Plan['Professional Practise Activity 4'])) $html .= $Assessment_Plan['Professional Practise Activity 4']; $html .= "</td>
        <td>Problem Solving</td>
