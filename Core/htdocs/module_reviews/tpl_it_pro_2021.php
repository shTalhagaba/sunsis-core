...
<title>Learner On Programme Review IT Pro V2</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review IT Pro V2</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review IT Pro V2</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Health & Safety in IT'] . "</td>"; ?>
        ...
        <?php $communication = isset($Assessment_Plan['Health & Safety Statement - Unit 102'])?$Assessment_Plan['Health & Safety Statement - Unit 102']:"&nbsp"; echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $communication . "</td>";?>
    </tr>
    <tr>
        ...
        <?php echo "<td rowspan=5 style='text-align:center; vertical-align:middle'>" . $ss_result['Develop own effectiveness & professionalism'] . "</td>"; ?>
        <?php echo "<td rowspan=5 style='text-align:center'>" . (($previous_review->skills_scan_status2!="")?$sss[$previous_review->skills_scan_status2]:"") . "</td>"; ?>
        <?php echo "<td rowspan=5 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status2", $ss_statuses, $form_arf->skills_scan_status2, true, false, $assessor_signed) . "</td>";?>
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("ITP-404-WB1","ITP-404-WB2","ITP-404-WB3")))
            echo "<td rowspan=5 style='text-align:center; vertical-align:middle'>Complete</td>";
        else
            echo "<td rowspan=5 style='text-align:center; vertical-align:middle'>&nbsp;</td>"; ?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=2 style='text-align:center; vertical-align:middle'>" . $ss_result['Software Installation and Upgrade'] . "</td>"; ?>
        <?php echo "<td rowspan=2 style='text-align:center'>" . (($previous_review->skills_scan_status3!="")?$sss[$previous_review->skills_scan_status3]:"") . "</td>"; ?>
        <?php echo "<td rowspan=2 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status3", $ss_statuses, $form_arf->skills_scan_status3, true, false, $assessor_signed) . "</td>";?>
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("ITP-308-PD","ITP-308-PRE")))
        echo "<td rowspan=2 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td rowspan=2 style='text-align:center; vertical-align:middle'>&nbsp;</td>"; ?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=5 style='text-align:center; vertical-align:middle'>" . $ss_result['IT Project Management'] . "</td>"; ?>
        <?php echo "<td rowspan=5 style='text-align:center'>" . (($previous_review->skills_scan_status4!="")?$sss[$previous_review->skills_scan_status4]:"") . "</td>"; ?>
        <?php echo "<td rowspan=5 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status4", $ss_statuses, $form_arf->skills_scan_status4, true, false, $assessor_signed) . "</td>";?>
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("ITP-441-PRE")))
        echo "<td rowspan=5 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td rowspan=5 style='text-align:center; vertical-align:middle'>&nbsp;</td>"; ?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=2 style='text-align:center; vertical-align:middle'>" . $ss_result['Investigating & Defining Requirements'] . "</td>"; ?>
        ...
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("ITP-405-PD","ITP-405-PRE")))
        echo "<td rowspan=2 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td rowspan=2 style='text-align:center; vertical-align:middle'>&nbsp;</td>"; ?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=2 style='text-align:center; vertical-align:middle'>" . $ss_result['Remote Support'] . "</td>"; ?>
        <?php echo "<td rowspan=2 style='text-align:center'>" . (($previous_review->skills_scan_status6!="")?$sss[$previous_review->skills_scan_status6]:"") . "</td>"; ?>
        <?php echo "<td rowspan=2 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status6", $ss_statuses, $form_arf->skills_scan_status6, true, false, $assessor_signed) . "</td>";?>
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("ITP-406-PD","ITP-Task A","ITP- Task C")))
        echo "<td rowspan=2 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td rowspan=2 style='text-align:center; vertical-align:middle'>&nbsp;</td>"; ?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . $ss_result['Technical advice & guidance'] . "</td>"; ?>
        <?php echo "<td rowspan=3 style='text-align:center'>" . (($previous_review->skills_scan_status7!="")?$sss[$previous_review->skills_scan_status7]:"") . "</td>"; ?>
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status7", $ss_statuses, $form_arf->skills_scan_status7, true, false, $assessor_signed) . "</td>";?>
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("ITP-410-PD","ITP - Task A","ITP - Task B")))
        echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>&nbsp;</td>"; ?>
    </tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . $tk_result['Effective Communication in Business'] . "</td>"; ?>
        <?php echo "<td rowspan=3 style='text-align:center'>" . (($previous_review->skills_scan_status8!="")?$sss[$previous_review->skills_scan_status8]:"") . "</td>"; ?>
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status8", $ss_statuses, $form_arf->skills_scan_status8, true, false, $assessor_signed) . "</td>";?>
    ...
    <tr>
        ...
        <td>1. Understand the importance of effective communication in business</td>
        <?php echo "<td rowspan=7 style='text-align:center; vertical-align:middle'>" . $tk_result['Systems Development'] . "</td>"; ?>
        <?php echo "<td rowspan=7 style='text-align:center'>" . (($previous_review->skills_scan_status9!="")?$sss[$previous_review->skills_scan_status9]:"") . "</td>"; ?>
        <?php echo "<td rowspan=7 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status9", $ss_statuses, $form_arf->skills_scan_status9, true, false, $assessor_signed) . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $tk_result['Personal & Professional Development'] . "</td>"; ?>
        <?php echo "<td rowspan=4 style='text-align:center'>" . (($previous_review->skills_scan_status10!="")?$sss[$previous_review->skills_scan_status10]:"") . "</td>"; ?>
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status10", $ss_statuses, $form_arf->skills_scan_status10, true, false, $assessor_signed) . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $tk_result['IT Virtualisation'] . "</td>"; ?>
        <?php echo "<td rowspan=4 style='text-align:center'>" . (($previous_review->skills_scan_status11!="")?$sss[$previous_review->skills_scan_status11]:"") . "</td>"; ?>
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status11", $ss_statuses, $form_arf->skills_scan_status11, true, false, $assessor_signed) . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $tk_result['Data Communications & Networks'] . "</td>"; ?>
        <?php echo "<td rowspan=4 style='text-align:center'>" . (($previous_review->skills_scan_status12!="")?$sss[$previous_review->skills_scan_status12]:"") . "</td>"; ?>
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status12", $ss_statuses, $form_arf->skills_scan_status12, true, false, $assessor_signed) . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . $tk_result['Emerging Technologies'] . "</td>"; ?>
        <?php echo "<td rowspan=3 style='text-align:center'>" . (($previous_review->skills_scan_status13!="")?$sss[$previous_review->skills_scan_status13]:"") . "</td>"; ?>
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status13", $ss_statuses, $form_arf->skills_scan_status13, true, false, $assessor_signed) . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $tk_result['Networking Technologies'] . "</td>"; ?>
        <?php echo "<td rowspan=4 style='text-align:center'>" . (($previous_review->skills_scan_status14!="")?$sss[$previous_review->skills_scan_status14]:"") . "</td>"; ?>
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status14", $ss_statuses, $form_arf->skills_scan_status14, true, false, $assessor_signed) . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=9 style='text-align:center; vertical-align:middle'>" . $tk_result['Installing and Configuring Windows Based Server'] . "</td>"; ?>
        <?php echo "<td rowspan=9 style='text-align:center'>" . (($previous_review->skills_scan_status15!="")?$sss[$previous_review->skills_scan_status15]:"") . "</td>"; ?>
        <?php echo "<td rowspan=9 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status15", $ss_statuses, $form_arf->skills_scan_status15, true, false, $assessor_signed) . "</td>";?>
    ...
    <tr>
        <td rowspan=5>IT Project Management</td>
        <td>1. Understand the principles, processes, tools and techniques of project management</td>
        <?php echo "<td rowspan=5 style='text-align:center; vertical-align:middle'>" . $tk_result['IT Project Management'] . "</td>"; ?>
        <?php echo "<td rowspan=5 style='text-align:center'>" . (($previous_review->skills_scan_status16!="")?$sss[$previous_review->skills_scan_status16]:"") . "</td>"; ?>
        <?php echo "<td rowspan=5 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status16", $ss_statuses, $form_arf->skills_scan_status15, true, false, $assessor_signed) . "</td>";?>
    <tr><td>2. Be able to agree the scope and objectives of a project</td></tr>
    <tr><td>3. Be able to identify the budget in order to develop a project plan</td></tr>
    <tr><td>4. Be able to implement a project plan</td></tr>
    <tr><td>5. Be able to manage a project to its conclusion</td></tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center'>" . (($previous_review->skills_scan_status22!="")?$sss[$previous_review->skills_scan_status22]:"") . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center'>" . (($previous_review->skills_scan_status23!="")?$sss[$previous_review->skills_scan_status23]:"") . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php if(isset($Assessment_Plan['Complaint Statement - Unit 406'])) echo $Assessment_Plan['Complaint Statement - Unit 406']; else "&nbsp;" ?></td>
        <td>Health & Safety Statement - Unit 102</td>
        <td><?php if(isset($Assessment_Plan['Health & Safety Statement - Unit 102'])) echo $Assessment_Plan['Health & Safety Statement - Unit 102']; else "&nbsp;" ?></td>
        <td>Pre-defined Decision - Unit 209</td>
        <td><?php if(isset($Assessment_Plan['Pre-defined Decision - Unit 209 '])) echo $Assessment_Plan['Pre-defined Decision - Unit 209 ']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Pre-defined Decision - Unit 308</td>
        <td><?php if(isset($Assessment_Plan['Pre-defined Decision - Unit 308'])) echo $Assessment_Plan['Pre-defined Decision - Unit 308']; else "&nbsp;" ?></td>
        <td>Pre-defined Decision - Unit 405</td>
        <td><?php if(isset($Assessment_Plan['Pre-defined Decision - Unit 405'])) echo $Assessment_Plan['Pre-defined Decision - Unit 405']; else "&nbsp;" ?></td>
        <td>Pre-defined Decision - Unit 441</td>
        <td><?php if(isset($Assessment_Plan['Pre-defined Decision - Unit 441'])) echo $Assessment_Plan['Pre-defined Decision - Unit 441']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Proactive Statement - Unit 410</td>
        <td><?php if(isset($Assessment_Plan['Proactive Statement - Unit 410'])) echo $Assessment_Plan['Proactive Statement - Unit 410']; else "&nbsp;" ?></td>
        <td>Professional Discussion - Unit 308</td>
        <td><?php if(isset($Assessment_Plan['Professional Discussion - Unit 308'])) echo $Assessment_Plan['Professional Discussion - Unit 308']; else "&nbsp;" ?></td>
        <td>Professional Discussion - Unit 405</td>
        <td><?php if(isset($Assessment_Plan['Professional Discussion - Unit 405'])) echo $Assessment_Plan['Professional Discussion - Unit 405']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Professional Discussion - Unit 406</td>
        <td><?php if(isset($Assessment_Plan['Professional Discussion - Unit 406'])) echo $Assessment_Plan['Professional Discussion - Unit 406']; else "&nbsp;" ?></td>
        <td>Professional Discussion - Unit 410</td>
        <td><?php if(isset($Assessment_Plan['Professional Discussion - Unit 410'])) echo $Assessment_Plan['Professional Discussion - Unit 410']; else "&nbsp;" ?></td>
        <td>Reactive Statement - Unit 410 & Unit 406</td>
        <td><?php if(isset($Assessment_Plan['Reactive Statement - Unit 410 & Unit 406'])) echo $Assessment_Plan['Reactive Statement - Unit 410 & Unit 406']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Workbook 1 - Unit 404</td>
        <td><?php if(isset($Assessment_Plan['Workbook 1 - Unit 404'])) echo $Assessment_Plan['Workbook 1 - Unit 404']; else "&nbsp;" ?></td>
        <td>Workbook 2 - 403 tech cert & Unit 404</td>
        <td><?php if(isset($Assessment_Plan['Workbook 2 - 403 tech cert & Unit 404'])) echo $Assessment_Plan['Workbook 2 - 403 tech cert & Unit 404']; else "&nbsp;" ?></td>
        <td>Workbook 3 - Unit 404 & Unit 406</td>
        <td><?php if(isset($Assessment_Plan['Workbook 3 - Unit 404 & Unit 406'])) echo $Assessment_Plan['Workbook 3 - Unit 404 & Unit 406']; else "&nbsp;" ?></td>
    </tr>
    <tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "Data communication and networks and networking technologies") . "<br>" . $this->getEventDate($events,'Data communication and networks and networking technologies'); ?></td>
    </tr>
    <tr>
        <td>404 diploma workshop 1</td>
        <td><?php echo $this->getEventStatus($events, "404 diploma workshop 1") . "<br>" . $this->getEventDate($events,'404 diploma workshop 1'); ?></td>
        <td>404 diploma workshop 2</td>
        <td><?php echo $this->getEventStatus($events, "404 diploma workshop 2") . "<br>" . $this->getEventDate($events,'404 diploma workshop 2'); ?></td>
        <td>404 diploma workshop 3</td>
        <td><?php echo $this->getEventStatus($events, "404 diploma workshop 3") . "<br>" . $this->getEventDate($events,'404 diploma workshop 3'); ?></td>
    </tr>
    <tr>
        <td>Emerging technologies</td>
        <td><?php echo $this->getEventStatus($events, "Emerging technologies") . "<br>" . $this->getEventDate($events,'Emerging technologies'); ?></td>
        <td>IT virtualisation</td>
        <td><?php echo $this->getEventStatus($events, "IT virtualisation") . "<br>" . $this->getEventDate($events,'IT virtualisation'); ?></td>
        <td>Installing and Configuring Windows Based Server 2016</td>
        <td><?php echo $this->getEventStatus($events, "Installing and Configuring Windows Based Server 2016") . "<br>" . $this->getEventDate($events,'Installing and Configuring Windows Based Server 2016'); ?></td>
    </tr>
    <tr>
