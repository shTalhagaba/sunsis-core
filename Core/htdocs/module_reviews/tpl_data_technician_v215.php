...
<title>Learner On Programme Review Data Technician V2 12 Months</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Data Technician V2</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Data Technician V2</th>
                </thead>
            </table>
        </td>
        <td>
...
<tr><td colspan=2>Competence - Based on Assessment Plans</td><td>Skills Scan Grade</td><td>Previous Skill Scan Status</td><td>Current Skills Scan Status</td></tr>
<tr>
    ...
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Accesses, formats, collates, blends and extracts data from multiple identified sources in line with current industry standards'] . "</td>"; ?>
    ...
    <?php
    if($this->getEventStatus($events,'Data Gathering')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status1", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Implementing Data Processes (EPA PREP)')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status1", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status1", $ss_statuses, $form_arf->skills_scan_status1, true, false, $assessor_signed) . "</td>";
    ?>
</tr>

<tr>
    <td colspan=2>Locates and migrates data from already identified sources</td>
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Locates and migrates data from already identified sources'] . "</td>"; ?>
    <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status2!="")?$sss[$previous_review->skills_scan_status2]:"") . "</td>"; ?>
    <?php
    if($this->getEventStatus($events,'Data Gathering')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status2", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Implementing Data Processes (EPA PREP)')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status2", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status2", $ss_statuses, $form_arf->skills_scan_status2, true, false, $assessor_signed) . "</td>";
    ?>
</tr>

<tr>
    <td colspan=2>Manipulates and links different data sets using tools and techniques to identify trends and patterns</td>
    <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Manipulates and links different data sets using tools and techniques to identify trends and patterns'] . "</td>"; ?>
    <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status3!="")?$sss[$previous_review->skills_scan_status3]:"") . "</td>"; ?>
    <?php
    if($this->getEventStatus($events,'Data Gathering')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status3", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Implementing Data Processes (EPA PREP)')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status3", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status3", $ss_statuses, $form_arf->skills_scan_status3, true, false, $assessor_signed) . "</td>";
    ?>
</tr>

<tr>
    <td colspan=2>Presents data in a format appropriate to the task</td>
    <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Presents data in a format appropriate to the task'] . "</td>"; ?>
    <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status4!="")?$sss[$previous_review->skills_scan_status4]:"") . "</td>"; ?>
    <?php
    if($this->getEventStatus($events,'Data Gathering')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status4", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Implementing Data Processes (EPA PREP)')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status4", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status4", $ss_statuses, $form_arf->skills_scan_status4, true, false, $assessor_signed) . "</td>";
    ?>
</tr>

<tr>
    <td colspan=2>Summarises and explains the results of the gathered data</td>
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Summarises and explains the results of the gathered data'] . "</td>"; ?>
    ...
    <?php
    if($this->getEventStatus($events,'Data Gathering')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status5", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Implementing Data Processes (EPA PREP)')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status5", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status5", $ss_statuses, $form_arf->skills_scan_status5, true, false, $assessor_signed) . "</td>";
    ?>
</tr>

<tr>
    <td colspan=2>Identifies trends and patterns in data</td>
    <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Identifies trends and patterns in data'] . "</td>"; ?>
    <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status6!="")?$sss[$previous_review->skills_scan_status6]:"") . "</td>"; ?>
    <?php
    if($this->getEventStatus($events,'Data Gathering')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status6", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Implementing Data Processes (EPA PREP)')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status6", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status6", $ss_statuses, $form_arf->skills_scan_status6, true, false, $assessor_signed) . "</td>";
    ?>
</tr>

<tr>
    <td colspan=2>Explains the different types of data sets and their formats</td>
    <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Explains the different types of data sets and their formats'] . "</td>"; ?>
    <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status7!="")?$sss[$previous_review->skills_scan_status7]:"") . "</td>"; ?>

    <?php $projects = TrainingRecord::getProjects($link, $tr_id); ?>

    <?php
    if($this->getEventStatus($events,'Data Gathering')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status7", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="In progress" or $this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="Rework" or $this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status7", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Rework" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status7", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Rework")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status7", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status7", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status7", $ss_statuses, $form_arf->skills_scan_status7, true, false, $assessor_signed) . "</td>";
    ?>
</tr>

<tr>
    <td colspan=2>Describes the value of the data to the organisation and the importance of analysis management</td>
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Describes the value of the data to the organisation and the importance of analysis management'] . "</td>"; ?>
    <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status8!="")?$sss[$previous_review->skills_scan_status8]:"") . "</td>"; ?>
    <?php
    if($this->getEventStatus($events,'Data Gathering')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status8", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="In progress" or $this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="Rework" or $this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status8", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Rework" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status8", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Rework")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status8", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status8", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status8", $ss_statuses, $form_arf->skills_scan_status8, true, false, $assessor_signed) . "</td>";
    ?>
</tr>
...
<tr>
    ...
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Describes the role of data in the digital domain (including the use of external trusted data sets) and how it underpins every digital interaction including applications, devises, IoT and customer centricity'] . "</td>"; ?>
    <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status9!="")?$sss[$previous_review->skills_scan_status9]:"") . "</td>"; ?>
    <?php
    if($this->getEventStatus($events,'Data Gathering')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status9", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="In progress" or $this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="Rework" or $this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status9", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Rework" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status9", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Rework")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status9", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status9", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status9", $ss_statuses, $form_arf->skills_scan_status9, true, false, $assessor_signed) . "</td>";
    ?>
</tr>

<tr>
    <td colspan=2>Explains the different types of data formats and data architectures including premises and cloud</td>
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Explains the different types of data formats and data architectures including premises and cloud'] . "</td>"; ?>
    <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status10!="")?$sss[$previous_review->skills_scan_status10]:"") . "</td>"; ?>
    <?php
    if($this->getEventStatus($events,'Data Gathering')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status10", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="In progress" or $this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="Rework" or $this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status10", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Rework" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status10", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Rework")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status10", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status10", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status10", $ss_statuses, $form_arf->skills_scan_status10, true, false, $assessor_signed) . "</td>";
    ?>
</tr>
...
<tr>
    ...
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Describes the characteristics of presentation tools to visualise and reviews the characteristics of data and communication tools and technologies for collaborative working'] . "</td>"; ?>
    <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status11!="")?$sss[$previous_review->skills_scan_status11]:"") . "</td>"; ?>
    <?php
    if($this->getEventStatus($events,'Data Gathering')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status11", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="In progress" or $this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="Rework" or $this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status11", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Rework" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status11", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Rework")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status11", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status11", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status11", $ss_statuses, $form_arf->skills_scan_status11, true, false, $assessor_signed) . "</td>";
    ?>
</tr>

<tr>
    <td colspan=2>Applies algorithms and basic statistical methods to identify trends in data to audit results</td>
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Applies algorithms and basic statistical methods to identify trends in data to audit results'] . "</td>"; ?>
    ...
    <?php
    if($this->getEventStatus($events,'Data Analysis and Validation')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status12", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Implementing Data Processes (EPA PREP)')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status12", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status12", $ss_statuses, $form_arf->skills_scan_status12, true, false, $assessor_signed) . "</td>";
    ?>
</tr>

<tr>
    <td colspan=2>Cross checks and filters data to identify faults</td>
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Cross checks and filters data to identify faults'] . "</td>"; ?>
    <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status13!="")?$sss[$previous_review->skills_scan_status13]:"") . "</td>"; ?>
    <?php
    if($this->getEventStatus($events,'Data Analysis and Validation')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status13", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Implementing Data Processes (EPA PREP)')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status13", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status13", $ss_statuses, $form_arf->skills_scan_status13, true, false, $assessor_signed) . "</td>";
    ?>
</tr>

<tr>
    <td colspan=2>Cleans, tests and assesses the confidence and integrity of the data</td>
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Cleans, tests and assesses the confidence and integrity of the data'] . "</td>"; ?>
    <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status14!="")?$sss[$previous_review->skills_scan_status14]:"") . "</td>"; ?>
    <?php
    if($this->getEventStatus($events,'Data Analysis and Validation')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status14", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Implementing Data Processes (EPA PREP)')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status14", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status14", $ss_statuses, $form_arf->skills_scan_status14, true, false, $assessor_signed) . "</td>";
    ?>
</tr>

<tr>
    <td colspan=2>Identifies opportunities to use automation</td>
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Identifies opportunities to use automation'] . "</td>"; ?>
    ...
    <?php
    if($this->getEventStatus($events,'Data Analysis and Validation')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status15", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Implementing Data Processes (EPA PREP)')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status15", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status15", $ss_statuses, $form_arf->skills_scan_status15, true, false, $assessor_signed) . "</td>";
    ?>
</tr>
...
<tr>
    ...
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Describes the methods of validating data how to identify common data quality and the importance of corrective action'] . "</td>"; ?>
    ...
    <?php
    if($this->getEventStatus($events,'Data Analysis and Validation')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status16", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="In progress" or $this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="Rework" or $this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status16", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Rework" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status16", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Rework")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status16", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status16", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status16", $ss_statuses, $form_arf->skills_scan_status16, true, false, $assessor_signed) . "</td>";
    ?>
</tr>
...
<tr>
    ...
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Describes communication methods, formats and techniques commonly used and how these have been applied in a range of roles including customer, manager, client, peer, technical and nontechnical'] . "</td>"; ?>
    ...
    <?php
    if($this->getEventStatus($events,'Distribution and Dissemination of Data')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status17", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Rework" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status17", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Rework")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status17", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status17", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status17", $ss_statuses, $form_arf->skills_scan_status17, true, false, $assessor_signed) . "</td>";
    ?>
</tr>

<tr>
    <td colspan=2>Explains the legal requirements of using data and the importance of using data ethically</td>
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Explains the legal requirements of using data and the importance of using data ethically'] . "</td>"; ?>
    ...
    <?php
    if($this->getEventStatus($events,'Distribution and Dissemination of Data')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status18", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Rework" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status18", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Rework")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status18", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status18", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status18", $ss_statuses, $form_arf->skills_scan_status18, true, false, $assessor_signed) . "</td>";
    ?>
</tr>
...
<tr>
    ...
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Describes how they have communicated the results of data analysis to different audiences that assists understanding'] . "</td>"; ?>
    ...
    <?php
    if($this->getEventStatus($events,'Distribution and Dissemination of Data')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status19", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Rework" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status19", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Rework")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status19", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status19", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status19", $ss_statuses, $form_arf->skills_scan_status19, true, false, $assessor_signed) . "</td>";
    ?>
</tr>
...
<tr>
    ...
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Explains the significance of customer/end user issues, problems, value to the organisation, brand awareness, cultural awareness/ diversity, accessibility to both an internal and external audience'] . "</td>"; ?>
    ...
    <?php
    if($this->getEventStatus($events,'Distribution and Dissemination of Data')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status20", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Rework" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status20", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Rework")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status20", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status20", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status20", $ss_statuses, $form_arf->skills_scan_status20, true, false, $assessor_signed) . "</td>";
    ?>
</tr>
...
<tr>
    ...
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Explains how they have stored, managed and distributed data in line with data security standards and legislation'] . "</td>"; ?>
    ...
    <?php
    if($this->getEventStatus($events,'Distribution and Dissemination of Data')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status21", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Rework" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status21", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Rework")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status21", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status21", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status21", $ss_statuses, $form_arf->skills_scan_status21, true, false, $assessor_signed) . "</td>";
    ?>
</tr>

<tr>
    <td colspan=2>Explains how they have produced clear and consistent technical documentation</td>
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Explains how they have produced clear and consistent technical documentation'] . "</td>"; ?>
    ...
    <?php
    if($this->getEventStatus($events,'Distribution and Dissemination of Data')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status22", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Rework" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status22", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Rework")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status22", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status22", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status22", $ss_statuses, $form_arf->skills_scan_status22, true, false, $assessor_signed) . "</td>";
    ?>
</tr>
...
<tr>
    ...
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Describes how they have reviewed their own development and kept up to date with developments in technologies, trends and innovation in regards to Data, Data Analysis & Data Science'] . "</td>"; ?>
    ...
    <?php
    if($this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="In progress" or $this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="Rework" or $this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status23", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Rework" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status23", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Rework")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status23", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status23", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status23", $ss_statuses, $form_arf->skills_scan_status23, true, false, $assessor_signed) . "</td>";
    ?>
</tr>
...
<tr>
    ...
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Explains how they have integrated into a multi-functional team both internally and externally to their organisation in a Data Technician role'] . "</td>"; ?>
    ...
    <?php
    if($this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="In progress" or $this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="Rework" or $this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status24", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Rework" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status24", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Rework")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status24", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status24", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status24", $ss_statuses, $form_arf->skills_scan_status24, true, false, $assessor_signed) . "</td>";
    ?>
</tr>

<tr>
    <td colspan=2>Describes how they have worked in an inclusive manner</td>
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Describes how they have worked in an inclusive manner'] . "</td>"; ?>
    ...
    <?php
    if($this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="In progress" or $this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="Rework" or $this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status25", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Rework" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status25", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Rework")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status25", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status25", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status25", $ss_statuses, $form_arf->skills_scan_status25, true, false, $assessor_signed) . "</td>";
    ?>
</tr>

<tr>
    <td colspan=2>Works independently as a Data Technician to meet required deadlines, managing stakeholder expectations</td>
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Works independently as a Data Technician to meet required deadlines, managing stakeholder expectations'] . "</td>"; ?>
    ...
    <?php
    if($this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="In progress" or $this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="Rework" or $this->getEventStatus($events,'Workshop 1: Data Gathering and Analysis')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status26", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Rework" or $this->getEventStatus($events,'Workshop 2: Data Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status26", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="In progress" or $this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Rework")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status26", $ss_statuses, "S", true, false, $assessor_signed) . "</td>";
    elseif($this->getEventStatus($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status26", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status26", $ss_statuses, $form_arf->skills_scan_status26, true, false, $assessor_signed) . "</td>";
    ?>
</tr>

<tr>
    <td colspan=2>Prioritises multiple data sets within the given task using own initiative</td>
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Prioritises multiple data sets within the given task using own initiative'] . "</td>"; ?>
    ...
    <?php
    if($this->getEventStatus($events,'Implementing Data Processes (EPA PREP)')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status27", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status27", $ss_statuses, $form_arf->skills_scan_status27, true, false, $assessor_signed) . "</td>";
    ?>
</tr>
...
<tr>
    ...
    <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Works independently as a Data Technician, following standard procedures to complete prioritised tasks on time'] . "</td>"; ?>
    ...
    <?php
    if($this->getEventStatus($events,'Implementing Data Processes (EPA PREP)')=="Uploaded")
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status28", $ss_statuses, "F", true, false, $assessor_signed) . "</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status28", $ss_statuses, $form_arf->skills_scan_status28, true, false, $assessor_signed) . "</td>";
    ?>
</tr>
</table>
...
<table class="table1" style="width: 900px">
    ...
    $projects = DAO::getResultset($link, "SELECT
                        ...
                        FROM
                        evidence_project
                        LEFT JOIN tr_projects ON tr_projects.project = evidence_project.id AND tr_projects.tr_id = '$tr_id'
                        WHERE evidence_project.course_id = '$course_id';
                        ", DAO::FETCH_ASSOC);
    ...
    {
        $project['total'] = ($project['total']==0)?1:$project['total'];
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "Excel for Data Analysis") . "<br>" . $this->getEventDate($events,'Excel for Data Analysis'); ?></td>
        <td>Data Gathering</td>
        <td><?php echo $this->getEventStatus($events, "Data Gathering") . "<br>" . $this->getEventDate($events,'Data Gathering'); ?></td>
        <td>Data Analysis and Validation</td>
        <td><?php echo $this->getEventStatus($events, "Data Analysis and Validation") . "<br>" . $this->getEventDate($events,'Data Analysis and Validation'); ?></td>
    </tr>
    <tr>
        <td>Distribution and Dissemination of Data</td>
        <td><?php echo $this->getEventStatus($events, "Distribution and Dissemination of Data") . "<br>" . $this->getEventDate($events,'Distribution and Dissemination of Data'); ?></td>
        <td>Implementing Data Processes (EPA PREP)</td>
        <td><?php echo $this->getEventStatus($events, "Implementing Data Processes (EPA PREP)") . "<br>" . $this->getEventDate($events,'Implementing Data Processes (EPA PREP)'); ?></td>
        <td>Workshop 1: Data Gathering and Analysis</td>
        <td><?php echo $this->getEventStatus($events, "Workshop 1: Data Gathering and Analysis") . "<br>" . $this->getEventDate($events,'Workshop 1: Data Gathering and Analysis'); ?></td>
    </tr>
    <tr>
        <td>Workshop 2: Data Distribution and Dissemination</td>
        <td><?php echo $this->getEventStatus($events, "Workshop 2: Data Distribution and Dissemination") . "<br>" . $this->getEventDate($events,'Workshop 2: Data Distribution and Dissemination'); ?></td>
        <td>Workshop 3: Data Gathering; Analysis and Distribution and Dissemination</td>
        <td><?php echo $this->getEventStatus($events, "Workshop 3: Data Gathering; Analysis and Distribution and Dissemination") . "<br>" . $this->getEventDate($events,'Workshop 3: Data Gathering; Analysis and Distribution and Dissemination'); ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    </tr>
    <tr>
