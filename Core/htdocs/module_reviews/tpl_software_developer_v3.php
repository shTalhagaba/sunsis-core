...
<title>Learner On Programme Review Software Development V3</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Software Development V3</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Software Development V3</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr><td colspan=2>Skills</td><td>Skills Scan Grade</td><td>Previous Skill Scan Status</td><td>Current Skills Scan Status</td></tr>
    <tr>
        <td colspan=2>S1: create logical and maintainable codes</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['S1: create logical and maintainable codes'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>S2: develop effective user interfaces</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['S2: develop effective user interfaces'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>S3: link code to data sets</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['S3: link code to data sets'] . "</td>"; ?>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status3", $ss_statuses, $form_arf->skills_scan_status3, true, false, $assessor_signed) . "</td>";?>
    </tr>
    <tr>
        <td colspan=2>S4: test code and analyse results to correct errors found using unit testing</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['S4: test code and analyse results to correct errors found using unit testing'] . "</td>"; ?>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status4", $ss_statuses, $form_arf->skills_scan_status4, true, false, $assessor_signed) . "</td>";?>
    </tr>
    <tr>
        <td colspan=2>S5: conduct a range of test types, such as Integration, System, User Acceptance, Non-Functional, Performance and Security testing</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['S5: conduct a range of test types, such as Integration, System, User Acceptance, Non-Functional, Performance and Security testing'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>S6: identify and create test scenarios</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['S6: identify and create test scenarios'] . "</td>"; ?>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status6", $ss_statuses, $form_arf->skills_scan_status6, true, false, $assessor_signed) . "</td>";?>
    </tr>
    <tr>
        <td colspan=2>S7: apply structured techniques to problem solving, can debug code and can understand the structure of programmes to identify and resolve issues</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['S7: apply structured techniques to problem solving, can debug code and can understand the structure of programmes to identify and resolve issues'] . "</td>"; ?>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status7", $ss_statuses, $form_arf->skills_scan_status7, true, false, $assessor_signed) . "</td>";?>
    </tr>
    <tr>
        <td colspan=2>S8: create simple software designs to effectively communicate understanding of the program</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['S8: create simple software designs to effectively communicate understanding of the program'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>S9: create analysis artefacts, such as use cases and/or user stories</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['S9: create analysis artefacts, such as use cases and/or user stories'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>S10: build, manage and deploy code into the relevant environment</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['S10: build, manage and deploy code into the relevant environment'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>S11: apply an appropriate software development approach according to the relevant paradigm (for example object oriented, event driven or procedural)</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['S11: apply an appropriate software development approach according to the relevant paradigm (for example object oriented, event driven or procedural)'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>S12: follow software designs and functional/technical specifications</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['S12: follow software designs and functional/technical specifications'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>S13: follow testing frameworks and methodologies</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['S13: follow testing frameworks and methodologies'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>S14: follow company, team or client approaches to continuous integration, version and source control</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['S14: follow company, team or client approaches to continuous integration, version and source control'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>S15: communicate software solutions and ideas to technical and non-technical stakeholders</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['S15: communicate software solutions and ideas to technical and non-technical stakeholders'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>S16: apply algorithms, logic and data structures</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['S16: apply algorithms, logic and data structures'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>S17: interpret and implement a given design whist remaining compliant with security and maintainability requirements</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['S17: interpret and implement a given design whist remaining compliant with security and maintainability requirements'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr><td colspan=2>Knowledge</td><td>Skills Scan Grade</td><td>Previous Skill Scan Status</td><td>Current Skills Scan Status</td></tr>
    <tr>
        <td colspan=2>K1: all stages of the software development life cycle (what each stage contains, including the inputs and outputs)</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['K1: all stages of the software development life cycle (what each stage contains, including the inputs and outputs)'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>K2: roles and responsibilities within the software development lifecycle (who is responsible for what)</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['K2: roles and responsibilities within the software development lifecycle (who is responsible for what)'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>K3: the roles and responsibilities of the project life cycle within your organisation, and your role</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['K3: the roles and responsibilities of the project life cycle within your organisation, and your role'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>K4: how best to communicate using the different communication methods and how to adapt appropriately to different audiences</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['K4: how best to communicate using the different communication methods and how to adapt appropriately to different audiences'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>K5: the similarities and differences between different software development methodologies, such as agile and waterfall</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['K5: the similarities and differences between different software development methodologies, such as agile and waterfall'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>K6: how teams work effectively to produce software and how to contribute appropriately</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['K6: how teams work effectively to produce software and how to contribute appropriately'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>K7: software design approaches and patterns, to identify reusable solutions to commonly occurring problems</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['K7: software design approaches and patterns, to identify reusable solutions to commonly occurring problems'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>K8: organisational policies and procedures relating to the tasks being undertaken, and when to follow them. For example, the storage and treatment of GDPR sensitive data</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['K8: organisational policies and procedures relating to the tasks being undertaken, and when to follow them. For example, the storage and treatment of GDPR sensitive data'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>K9: principles of algorithms, logic and data structures relevant to software development</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['K9: principles of algorithms, logic and data structures relevant to software development'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>K10: principles and uses of relational and non-relational databases</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['K10: principles and uses of relational and non-relational databases'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>K11: software designs and functional/technical specifications</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['K11: software designs and functional/technical specifications'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>K12: software testing frameworks and methodologies</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['K12: software testing frameworks and methodologies'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td>B1: Works independently and takes responsibility. For example, has a disciplined and responsible approach to risk, and stays motivated and committed when facing challenges</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['B1: Works independently and takes responsibility. For example, has a disciplined and responsible approach to risk, and stays motivated and committed when facing challenges'] . "</td>"; ?>
        <?php echo "<td style='text-align:center'>" . (($previous_review->skills_scan_status30!="")?$sss[$previous_review->skills_scan_status30]:"") . "</td>"; ?>
    ...
    <tr>
        <td>B2: Applies logical thinking. For example, uses clear and valid reasoning when making decisions related to undertaking work instructions</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['B2: Applies logical thinking. For example, uses clear and valid reasoning when making decisions related to undertaking work instructions'] . "</td>"; ?>
        <?php echo "<td style='text-align:center'>" . (($previous_review->skills_scan_status31!="")?$sss[$previous_review->skills_scan_status31]:"") . "</td>"; ?>
    ...
    <tr>
        <td>B3: Maintains a productive, professional and secure working environment</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['B3: Maintains a productive, professional and secure working environment'] . "</td>"; ?>
    ...
    <tr>
        <td>B4: Works collaboratively with a wide range of people in different roles, internally and externally, with a positive attitude to inclusion & diversity</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['B4: Works collaboratively with a wide range of people in different roles, internally and externally, with a positive attitude to inclusion & diversity'] . "</td>"; ?>
    ...
    <tr>
        <td>B5: Acts with integrity with respect to ethical, legal and regulatory ensuring the protection of personal data, safety and security</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['B5: Acts with integrity with respect to ethical, legal and regulatory ensuring the protection of personal data, safety and security'] . "</td>"; ?>
    ...
    <tr>
        <td>B6: Shows initiative for solving problems within their own remit, being resourceful when faced with a problem to solve</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['B6: Shows initiative for solving problems within their own remit, being resourceful when faced with a problem to solve'] . "</td>"; ?>
    ...
    <tr>
        <td>B7: Communicates effectively in a variety of situations to both a technical and non-technical audience</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['B7: Communicates effectively in a variety of situations to both a technical and non-technical audience'] . "</td>"; ?>
    ...
    <tr>
        <td>B8: Shows curiosity to the business context in which the solution will be used, displaying an inquisitive approach to solving the problem. This includes the curiosity to explore new opportunities, and techniques; the tenacity to improve methods and maximise performance of the solution</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['B8: Shows curiosity to the business context in which the solution will be used, displaying an inquisitive approach to solving the problem. This includes the curiosity to explore new opportunities, and techniques; the tenacity to improve methods and maximise performance of the solution'] . "</td>"; ?>
    ...
    <tr>
        <td>B9: Demonstrates creativity and tenacity in their approach to solutions and the methods used to come to a solution for example, sees the task through to the end by devising new solutions and despite obstacles and problems along the way</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['B9: Demonstrates creativity and tenacity in their approach to solutions and the methods used to come to a solution for example, sees the task through to the end by devising new solutions and despite obstacles and problems along the way'] . "</td>"; ?>
    ...
    <tr>
        ...
        <td colspan=3><i>
            <?php   if($source==1)
            echo '<textarea onblur="checkLength(event,this,4000)" onkeypress="checkLength(event,this,4000)" name="example9" style="font-family:sans-serif; font-size:10pt"  rows="5" cols="100">' . $form_arf->example9 . '</textarea>';
        else
            echo $form_arf->example9;
            ?>
        </i></td>
    </tr>

    <tr>
        <td>B10: Committed to continued professional development</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['B10: Committed to continued professional development'] . "</td>"; ?>
    ...
    <tr>
        ...
        <td colspan=3><i>
            <?php   if($source==1)
            echo '<textarea onblur="checkLength(event,this,4000)" onkeypress="checkLength(event,this,4000)" name="example10" style="font-family:sans-serif; font-size:10pt"  rows="5" cols="100">' . $form_arf->example10 . '</textarea>';
        else
            echo $form_arf->example10;
            ?>
        </i></td>
    </tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td>Analysis</td>
        <td><?php //if(isset($Assessment_Plan['Analysis'])) echo $Assessment_Plan['Analysis']; else "&nbsp;" ?></td>
        <td>Business Operation</td>
        <td><?php // if(isset($Assessment_Plan['Business Operation'])) echo $Assessment_Plan['Business Operation']; else "&nbsp;" ?></td>
        <td>Data</td>
        <td><?php //if(isset($Assessment_Plan['Data'])) echo $Assessment_Plan['Data']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Problem Solving</td>
        <td><?php //if(isset($Assessment_Plan['Problem Solving'])) echo $Assessment_Plan['Problem Solving']; else "&nbsp;" ?></td>
        <td>Development Lifecycle</td>
        <td><?php //if(isset($Assessment_Plan['Development Lifecycle'])) echo $Assessment_Plan['Development Lifecycle']; else "&nbsp;" ?></td>
        <td>Logic</td>
        <td><?php //if(isset($Assessment_Plan['Logic'])) echo $Assessment_Plan['Logic']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>User Interface</td>
        <td><?php //if(isset($Assessment_Plan['User Interface'])) echo $Assessment_Plan['User Interface']; else "&nbsp;" ?></td>
        <td>Service Level Agreements</td>
        <td><?php //if(isset($Assessment_Plan['Service Level Agreements'])) echo $Assessment_Plan['Service Level Agreements']; else "&nbsp;" ?></td>
        <td>Testing</td>
        <td><?php //if(isset($Assessment_Plan['Testing'])) echo $Assessment_Plan['Testing']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Operational Requirements</td>
        <td><?php //if(isset($Assessment_Plan['Operational Requirements'])) echo $Assessment_Plan['Operational Requirements']; else "&nbsp;" ?></td>
        <td>Deployment</td>
        <td><?php //if(isset($Assessment_Plan['Deployment'])) echo $Assessment_Plan['Deployment']; else "&nbsp;" ?></td>
        <td>Design</td>
        <td><?php //if(isset($Assessment_Plan['Design'])) echo $Assessment_Plan['Design']; else "&nbsp;" ?></td>
    </tr>
    <tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "Systems development") . "<br>" . $this->getEventDate($events,'Systems development'); ?></td>
        <td>HTML5 MTA</td>
        <td><?php echo $this->getEventStatus($events, "HTML5 MTA") . "<br>" . $this->getEventDate($events,'HTML5 MTA'); ?></td>
        <td>HTML5 MTA test</td>
        <td><?php echo $this->getEventStatus($events, "HTML5 MTA test") . "<br>" . $this->getEventDate($events,'HTML5 MTA test'); ?></td>
    </tr>
    <tr>
        <td>Project management and effective communication in a business</td>
        <td><?php echo $this->getEventStatus($events, "Project management and effective communication in a business") . "<br>" . $this->getEventDate($events,'Project management and effective communication in a business'); ?></td>
        <td>Object oriented programming</td>
        <td><?php echo $this->getEventStatus($events, "Object oriented programming") . "<br>" . $this->getEventDate($events,'Object oriented programming'); ?></td>
        <td>Database design</td>
        <td><?php echo $this->getEventStatus($events, "Database design") . "<br>" . $this->getEventDate($events,'Database design'); ?></td>
    </tr>
    <tr>
        <td>Human computer interaction</td>
        <td><?php echo $this->getEventStatus($events, "Human computer interaction") . "<br>" . $this->getEventDate($events,'Human computer interaction'); ?></td>
        <td>Design and create advanced websites</td>
        <td><?php echo $this->getEventStatus($events, "Design and create advanced websites") . "<br>" . $this->getEventDate($events,'Design and create advanced websites'); ?></td>
        <td>9628-01 software development methodologies test</td>
        <td><?php echo $this->getEventStatus($events, "9628-01 software development methodologies test") . "<br>" . $this->getEventDate($events,'9628-01 software development methodologies test'); ?></td>
    </tr>
    <tr>
