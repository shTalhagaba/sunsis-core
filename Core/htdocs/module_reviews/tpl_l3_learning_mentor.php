...
<title>Learner On Programme Review L3 Learning Mentor</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review L3 Learning Mentor</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review L3 Learning Mentor</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr><td>Knowledge</td><td>Skills Scan Grade</td><td>Current Skills Scan Status</td></tr>
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Understand effective practice in providing accurate and relevant vocational/ pastoral Careers, Education, Information Advice and Guidance'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Identify a range of effective questioning, active-listening, and assertiveness tecniques that can be used to get the best out of learners'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Describe learning programme requirements and the need to plan contextualised learning in authentic or realistic work settings involving relevant stakeholders'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Understand the roles of different practitioners, including assessors, coaches or teachers in providing practical help with assessment processes and requirements'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Explain who has a legitimate need to be kept informed of issues impacting on the learners well-being and progress during an apprenticeship programme'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Describe the learning mentors role in supporting the learners development and how to provide valid evidence of progress and achievement, and overcome any barriers'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Understand the impact of organisational and legal requirements for recording, storing and sharing information on learners progress, needs and welfare'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Explain the role of key stakeholders, such as workpplace and education provider colleagues, who contribute to learners fulfilling their agreed action plans'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Describe how learners may become physically or pshychologically at risk, and channels for reporting concerns, including organisational procedures for reporting'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Understand the opportunities available for continuing professional development, and industry requirements for maintaining CPD'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Evaluate the quality assurance requirements relating to the mentoring environment, including the internal procedures and external influences on quality'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr><td>Skills</td><td>Skills Scan Grade</td><td>Current Skills Scan Grade</td></tr>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Provide competent Career Education, Information Advice and Guidance, and supervise learners to acquire the most benefit from their learning programme'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Communicate and collaborate effectively and using a range of effective questioning, listening and assertiveness skills '] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Work with education providers, stakeholders and workplace colleagues to plan and implement structured and meaningful learning and work experience'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Liaise with different education practitioners, including assessors, coaches and/or teachers to facilitate formative and summative assessment of learners skills and knowledge'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Identify and refer issues relevant to learners progress and wellbeing, to education-providers and/ or workplace colleagues, and support those with barriers to learning'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Collaborate with wider education support team to review learners progress and to provide evidence of progress and achievement'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Maintain appropriate records for the learning programme, complying with quality, confidentiality, Data Protection, and other external requirements (OFSTED, ESFA)'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Liaise with relevant colleagues to support the implementation of learners action plans, develop rigid support plans based on learning needs and berriers to learning'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Be vigilant in safeguarding learners and others in contact with them, and follow internal and external procedures when reporting safeguarding issues'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Maintain an up to date, comprehensive CPD log to ensure the currency of their vocational skills and knowledge'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Fully comply with internal and external quality assurance requirements'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Promote an ethos of motivation aspiration and a passion for learning'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Value equality and diversity and work with others to improve equality of opportunity and inclusion, and promote this comfortably within their role'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Demonstrate, encourage and expect mutual respect in all professional contexts'] . "</td>"; ?>
