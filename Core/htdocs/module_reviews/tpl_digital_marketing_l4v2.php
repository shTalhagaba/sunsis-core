...
<title>Learner On Programme Review Level 4 Digital Marketing</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Level 4 Digital Marketing</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Level 4 Digital Marketing</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    <thead>
    <th colspan=5>&nbsp;&nbsp;&nbsp;Technical Knowledge and Competence</th>
    </thead>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $tk_result['Marketing Planning'] . "</td>"; ?>
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status1", $ss_statuses, $form_arf->skills_scan_status1, true, false, $assessor_signed) . "</td>";?>
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Marketing Planning & Ethics') . "<br>" . $this->getEventDate($events,'Legalities of Digital Marketing') . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=2 style='text-align:center; vertical-align:middle'>" . $tk_result['Ethics and Legalities of Digital Marketing'] . "</td>"; ?>
        <?php echo "<td rowspan=2 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status2", $ss_statuses, $form_arf->skills_scan_status2, true, false, $assessor_signed) . "</td>";?>
        <?php echo "<td rowspan=2 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Marketing Planning & Ethics') . "<br>" . $this->getEventDate($events,'Legalities of Digital Marketing') . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $tk_result['Business Concepts'] . "</td>"; ?>
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status3", $ss_statuses, $form_arf->skills_scan_status3, true, false, $assessor_signed) . "</td>";?>
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Business Concepts') . "<br>" . $this->getEventDate($events,'Project Management') . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $tk_result['Project Management'] . "</td>"; ?>
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status4", $ss_statuses, $form_arf->skills_scan_status4, true, false, $assessor_signed) . "</td>";?>
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Business Concepts') . "<br>" . $this->getEventDate($events,'Project Management') . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . $tk_result['Digital Marketing Metrics & Analytics'] . "</td>"; ?>
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status5", $ss_statuses, $form_arf->skills_scan_status5, true, false, $assessor_signed) . "</td>";?>
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Digital Marketing Metrics') . "<br>" . $this->getEventDate($events,'Analytics & Content Marketing') . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . $tk_result['Content Marketing'] . "</td>"; ?>
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status6", $ss_statuses, $form_arf->skills_scan_status6, true, false, $assessor_signed) . "</td>";?>
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Digital Marketing Metrics') . "<br>" . $this->getEventDate($events,'Analytics & Content Marketing') . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . $tk_result['Marketing on Mobile'] . "</td>"; ?>
        ...
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Marketing on Mobile') . "<br>" . $this->getEventDate($events,'Email Marketing') . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . $tk_result['Email Marketing'] . "</td>"; ?>
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status9", $ss_statuses, $form_arf->skills_scan_status9, true, false, $assessor_signed) . "</td>";?>
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Marketing on Mobile') . "<br>" . $this->getEventDate($events,'Email Marketing') . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . $tk_result['Retention Marketing'] . "</td>"; ?>
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status10", $ss_statuses, $form_arf->skills_scan_status10, true, false, $assessor_signed) . "</td>";?>
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Retention Marketing & Principles of Keywords') . "<br>" . $this->getEventDate($events,'Optimisation') . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . $tk_result['Video Channel Marketing'] . "</td>"; ?>
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status11", $ss_statuses, $form_arf->skills_scan_status11, true, false, $assessor_signed) . "</td>";?>
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Video Channel Marketing') . "<br>" . $this->getEventDate($events,'Using Collaborative Technologies in a Business') . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Personal & Professional Development') . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . $tk_result['Designing an Effective Web User Experience'] . "</td>"; ?>
        ...
        <?php echo "<td rowspan=3 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Designing an Effective Web User Experience') . "<br>" . $this->getEventDate($events,'CMS Website Creation') . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $tk_result['Principles of Keywords and Optimisation'] . "</td>"; ?>
        ...
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Retention Marketing & Principles of Keywords') . "<br>" . $this->getEventDate($events,'Optimisation') . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $tk_result['CMS Website Creation'] . "</td>"; ?>
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status15", $ss_statuses, $form_arf->skills_scan_status15, true, false, $assessor_signed) . "</td>";?>
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Designing an Effective Web User Experience') . "<br>" . $this->getEventDate($events,'CMS Website Creation') . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $tk_result['CMS Website Creation'] . "</td>"; ?>
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status16", $ss_statuses, $form_arf->skills_scan_status16, true, false, $assessor_signed) . "</td>";?>
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Video Channel Marketing') . "<br>" . $this->getEventDate($events,'Using Collaborative Technologies in a Business') . "</td>";?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php if(isset($Assessment_Plan['Activity 1 - Project 1 Personal and Professional Development'])) echo $Assessment_Plan['Activity 1 - Project 1 Personal and Professional Development']; else "&nbsp;" ?></td>
        <td>Activity 2 - Project 2 SWOT Analysis</td>
        <td><?php if(isset($Assessment_Plan['Activity 2 - Project 2 SWOT Analysis'])) echo $Assessment_Plan['Activity 2 - Project 2 SWOT Analysis']; else "&nbsp;" ?></td>
        <td>Activity 3 - Project 2 Dream job specification</td>
        <td><?php if(isset($Assessment_Plan['Activity 3 - Project 2 Dream job specification'])) echo $Assessment_Plan['Activity 3 - Project 2 Dream job specification']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Activity 4 - Project 2 PDP</td>
        <td><?php if(isset($Assessment_Plan['Activity 4 - Project 2 PDP'])) echo $Assessment_Plan['Activity 4 - Project 2 PDP']; else "&nbsp;" ?></td>
        <td>Activity 5 - Project 2 Learning Styles</td>
        <td><?php if(isset($Assessment_Plan['Activity 5 - Project 2 Learning Styles'])) echo $Assessment_Plan['Activity 5 - Project 2 Learning Styles']; else "&nbsp;" ?></td>
        <td>Activity 6 - Project 2/3 diary of progress</td>
        <td><?php if(isset($Assessment_Plan['Activity 6 - Project 2/3 diary of progress'])) echo $Assessment_Plan['Activity 6 - Project 2/3 diary of progress']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Activity 7 - Project 2 report</td>
        <td><?php if(isset($Assessment_Plan['Activity 7 - Project 2 report'])) echo $Assessment_Plan['Activity 7 - Project 2 report']; else "&nbsp;" ?></td>
        <td>Activity 8 - Project 3 presentation</td>
        <td><?php if(isset($Assessment_Plan['Activity 8 - Project 3 presentation'])) echo $Assessment_Plan['Activity 8 - Project 3 presentation']; else "&nbsp;" ?></td>
        <td>Activity 9 - ERR</td>
        <td><?php if(isset($Assessment_Plan['Activity 9 - ERR'])) echo $Assessment_Plan['Activity 9 - ERR']; else "&nbsp;" ?></td>
    </tr>
    <tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "Business Concepts and Project Management") . "<br>" . $this->getEventDate($events,'Business Concepts and Project Management'); ?></td>
        <td>Marketing Planning Ethics and Legalities</td>
        <td><?php echo $this->getEventStatus($events, "Marketing Planning Ethics and Legalities") . "<br>" . $this->getEventDate($events,'Marketing Planning Ethics and Legalities'); ?></td>
        <td>Mobile Marketing and Email Marketing</td>
        <td><?php echo $this->getEventStatus($events, "Mobile Marketing and Email Marketing") . "<br>" . $this->getEventDate($events,'Mobile Marketing and Email Marketing'); ?></td>
    </tr>
    <tr>
        <td>Video Channel Management and Using Collaborative Technologies</td>
        <td><?php echo $this->getEventStatus($events, "Video Channel Management and Using Collaborative Technologies") . "<br>" . $this->getEventDate($events,'Video Channel Management and Using Collaborative Technologies'); ?></td>
        <td>Designing an Effective Web User Experience and CMS Website Creation</td>
        <td><?php echo $this->getEventStatus($events, "Designing an Effective Web User Experience and CMS Website Creation") . "<br>" . $this->getEventDate($events,'Designing an Effective Web User Experience and CMS Website Creation'); ?></td>
        <td>Content Marketing and Metrics and Analytics</td>
        <td><?php echo $this->getEventStatus($events, "Content Marketing and Metrics and Analytics") . "<br>" . $this->getEventDate($events,'Content Marketing and Metrics and Analytics'); ?></td>
    </tr>
    <tr>
        <td>Retention Marketing and Principles of Keywords and Optimisation</td>
        <td><?php echo $this->getEventStatus($events, "Retention Marketing and Principles of Keywords and Optimisation") . "<br>" . $this->getEventDate($events,'Retention Marketing and Principles of Keywords and Optimisation'); ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
