...
<title>Learner On Programme Review IT Pro V1</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review IT Pro V1</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review IT Pro V1</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td>IT virtualization</td>
        <td><?php echo $this->getEventStatus($events, "IT virtualization") . "<br>" . $this->getEventDate($events,'IT virtualization'); ?></td>
        <td>Installing and configuring windows based server 2012</td>
        <td><?php echo $this->getEventStatus($events, "Installing and configuring windows based server 2012") . "<br>" . $this->getEventDate($events,'Installing and configuring windows based server 2012'); ?></td>
    </tr>
    <tr>
