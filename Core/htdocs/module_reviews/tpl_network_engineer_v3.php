...
<title>Learner On Programme Review Network Engineer V3</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Network Engineer V3</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Network Engineer V3</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=2>Apply the appropriate tools and techniques when securely operating and testing Networks</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Apply the appropriate tools and techniques when securely operating and testing Networks'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Install and configure the elements required to maintain and manage a secure Network</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Install and configure the elements required to maintain and manage a secure Network'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Implement techniques to monitor and record systems performance in line with defined specifications</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Implement techniques to monitor and record systems performance in line with defined specifications'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Maintain security and performance of the system against known and standard threats</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Maintain security and performance of the system against known and standard threats'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Apply the appropriate tools and techniques to identify systems performance issues</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Apply the appropriate tools and techniques to identify systems performance issues'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Apply the appropriate tools and techniques to gather information to troubleshoot issues and isolate, repair or escalate faults</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Apply the appropriate tools and techniques to gather information to troubleshoot issues and isolate, repair or escalate faults'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Communicate outcomes of tasks and record in line with organisational procedures and SLAs including adherence to good customer service standards</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Communicate outcomes of tasks and record in line with organisational procedures and SLAs including adherence to good customer service standards'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Upgrade, apply and test components to systems configurations ensuring that the system meets the organisation requirements and minimises downtime. This should include backup processes</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Upgrade, apply and test components to systems configurations ensuring that the system meets the organisation requirements and minimises downtime. This should include backup processes'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Record task details whether face-to-face, remote or in writing in line with organisational requirements</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Record task details whether face-to-face, remote or in writing in line with organisational requirements'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Interpret information received from a manager, customer or technical specialist and accurately implement the defined requirements</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Interpret information received from a manager, customer or technical specialist and accurately implement the defined requirements'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Monitor, identify and implement required maintenance procedures</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Monitor, identify and implement required maintenance procedures'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Implement techniques to optimise systems performance in line with defined specifications</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Implement techniques to optimise systems performance in line with defined specifications'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Organise and prioritise clients/stakeholders requests in line with SLAs and organization processes</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Organise and prioritise clients/stakeholders requests in line with SLAs and organization processes'] . "</td>"; ?>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status13", $ss_statuses, $form_arf->skills_scan_status13, true, false, $assessor_signed) . "</td>";?>
        <?php
        if(isset($Assessment_Plan['Data Architecture & Processes Workplace Project']) and $Assessment_Plan['Data Architecture & Processes Workplace Project']=="Complete")
            echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>Complete</td>";
        else
    ...
    <tr>
        <td colspan=2>Explain their job role within the business context to stakeholders to enable a clear understanding on both sides of what their remit is and convey technical constraints in appropriate language considering accessibility and diversity implications</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Explain their job role within the business context to stakeholders to enable a clear understanding on both sides of what their remit is and convey technical constraints in appropriate language considering accessibility and diversity implications'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Operate securely and apply the appropriate process, policies, and legislation within their business responsibilities</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Operate securely and apply the appropriate process, policies, and legislation within their business responsibilities'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Communicate with a range of stakeholders taking into consideration of organisations cultural awareness and technical ability</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Communicate with a range of stakeholders taking into consideration of organisations cultural awareness and technical ability'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Apply the appropriate level of responsibility when planning and prioritizing work tasks</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Apply the appropriate level of responsibility when planning and prioritizing work tasks'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Apply the relevant numerical skills (Binary, dotted decimal notation) required to meet the defines specifications</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Apply the relevant numerical skills (Binary, dotted decimal notation) required to meet the defines specifications'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Ensure compliance of network engineering outputs with change management processes</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Ensure compliance of network engineering outputs with change management processes'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Select the appropriate tools and comply with organisation policies and processes when upgrading systems</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Select the appropriate tools and comply with organisation policies and processes when upgrading systems'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td>The causes and consequences of network and IT infrastructure failures</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The causes and consequences of network and IT infrastructure failures'] . "</td>"; ?>
    ...
    <tr>
        <td>The architecture of typical IT systems, including hardware, OS, server, virtualisation, voice, cloud, and applications</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The architecture of typical IT systems, including hardware, OS, server, virtualisation, voice, cloud, and applications'] . "</td>"; ?>
    ...
    <tr>
        <td>The techniques for systems performance and optimisation</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The techniques for systems performance and optimisation'] . "</td>"; ?>
    ...
    <tr>
        <td>Diagnostic techniques and tools to interrogate and gather information regarding systems performance</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Diagnostic techniques and tools to interrogate and gather information regarding systems performance'] . "</td>"; ?>
    ...
    <tr>
        <td>Organizational procedures to deal with recording information effectively and in line with protocols</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Organizational procedures to deal with recording information effectively and in line with protocols'] . "</td>"; ?>
    ...
    <tr>
        <td>Service Level Agreements (SLAs) and their application to delivering network engineering activities in line with contractual obligations and customer service</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Service Level Agreements (SLAs) and their application to delivering network engineering activities in line with contractual obligations and customer service'] . "</td>"; ?>
    ...
    <tr>
        <td>Their role in Business Continuity and Disaster Recovery</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Their role in Business Continuity and Disaster Recovery'] . "</td>"; ?>
    ...
    <tr>
        <td>The purposes and uses of ports and protocols</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The purposes and uses of ports and protocols'] . "</td>"; ?>
    ...
    <tr>
        <td>Devices, applications, protocols, and services at their appropriate OSI and/or TCP/IP layers</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Devices, applications, protocols, and services at their appropriate OSI and/or TCP/IP layers'] . "</td>"; ?>
    ...
    <tr>
        <td>The concepts and characteristics of routing and switching</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The concepts and characteristics of routing and switching'] . "</td>"; ?>
    ...
    <tr>
        <td>The characteristics of network topologies, types, and technologies</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The characteristics of network topologies, types, and technologies'] . "</td>"; ?>
    ...
    <tr>
        <td>Wireless technologies and configurations</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Wireless technologies and configurations'] . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status32!="")?$sss[$previous_review->skills_scan_status32]:"") . "</td>"; ?>
    ...
    <tr>
        <td>Cloud concepts and their purposes</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Cloud concepts and their purposes'] . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status33!="")?$sss[$previous_review->skills_scan_status33]:"") . "</td>"; ?>
    ...
    <tr>
        <td>Functions of network services</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Functions of network services'] . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status34!="")?$sss[$previous_review->skills_scan_status34]:"") . "</td>"; ?>
    ...
    <tr>
        <td>The different types of network maintenance</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The different types of network maintenance'] . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status35!="")?$sss[$previous_review->skills_scan_status35]:"") . "</td>"; ?>
    ...
    <tr>
        <td>How current legislation relates to or impacts occupation</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['How current legislation relates to or impacts occupation'] . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status36!="")?$sss[$previous_review->skills_scan_status36]:"") . "</td>"; ?>
    ...
    <tr>
        <td>Troubleshooting methodologies for network and IT infrastructure</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Troubleshooting methodologies for network and IT infrastructure'] . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status37!="")?$sss[$previous_review->skills_scan_status37]:"") . "</td>"; ?>
    ...
    <tr>
        <td>How to integrate a server into a network</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['How to integrate a server into a network'] . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status38!="")?$sss[$previous_review->skills_scan_status38]:"") . "</td>"; ?>
    ...
    <tr>
        <td>The types of security threats to networks and IT infrastructure assets</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The types of security threats to networks and IT infrastructure assets'] . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status39!="")?$sss[$previous_review->skills_scan_status39]:"") . "</td>"; ?>
    ...
    <tr>
        <td>How to use tools to automate network tasks</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['How to use tools to automate network tasks'] . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status40!="")?$sss[$previous_review->skills_scan_status40]:"") . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status40", $ss_statuses, $form_arf->skills_scan_status40, true, false, $assessor_signed) . "</td>";?>
    </tr>

    <tr>
        <td>Approaches to change management</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Approaches to change management'] . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center'>" . (($previous_review->skills_scan_status41!="")?$sss[$previous_review->skills_scan_status41]:"") . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status41", $ss_statuses, $form_arf->skills_scan_status41, true, false, $assessor_signed) . "</td>";?>
    </tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td>Work independently and demonstrate initiative being resourceful when faced with a problem and taking responsibility for solving problems within their own remit</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Work independently and demonstrate initiative being resourceful when faced with a problem and taking responsibility for solving problems within their own remit'] . "</td>"; ?>
        <?php echo "<td style='text-align:center'>" . (($previous_review->skills_scan_status42!="")?$sss[$previous_review->skills_scan_status42]:"") . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status42", $ss_statuses, $form_arf->skills_scan_status42, true, false, $assessor_signed) . "</td>";?>
    </tr>
    <tr>
        <td>Example</td>
        <td colspan=3><i>
    ...
    <tr>
        <td>Work securely within the business</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Work securely within the business'] . "</td>"; ?>
        <?php echo "<td style='text-align:center'>" . (($previous_review->skills_scan_status43!="")?$sss[$previous_review->skills_scan_status43]:"") . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status43", $ss_statuses, $form_arf->skills_scan_status43, true, false, $assessor_signed) . "</td>";?>
    </tr>
    <tr>
        <td>Example</td>
        <td colspan=3><i>
    ...
    <tr>
        <td>Work within the goals, vision, and values of the organisation</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Work within the goals, vision, and values of the organisation'] . "</td>"; ?>
        <?php echo "<td style='text-align:center'>" . (($previous_review->skills_scan_status44!="")?$sss[$previous_review->skills_scan_status44]:"") . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status44", $ss_statuses, $form_arf->skills_scan_status44, true, false, $assessor_signed) . "</td>";?>
    </tr>
    <tr>
        <td>Example</td>
        <td colspan=3><i>
    ...
    <tr>
        <td>Take a wider view of the strategic objectives of the tasks/ projects they are working on including the implications for accessibility by users and diversity</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Take a wider view of the strategic objectives of the tasks/ projects they are working on including the implications for accessibility by users and diversity'] . "</td>"; ?>
        <?php echo "<td style='text-align:center'>" . (($previous_review->skills_scan_status45!="")?$sss[$previous_review->skills_scan_status45]:"") . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status45", $ss_statuses, $form_arf->skills_scan_status45, true, false, $assessor_signed) . "</td>";?>
    </tr>
    <tr>
        <td>Example</td>
        <td colspan=3><i>
    ...
    <tr>
        <td>Works to meet or exceed customers requirements and expectations</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Works to meet or exceed customers requirements and expectations'] . "</td>"; ?>
        <?php echo "<td style='text-align:center'>" . (($previous_review->skills_scan_status46!="")?$sss[$previous_review->skills_scan_status46]:"") . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status46", $ss_statuses, $form_arf->skills_scan_status46, true, false, $assessor_signed) . "</td>";?>
    </tr>
    <tr>
        <td>Example</td>
        <td colspan=3><i>
    ...
    <tr>
        <td>Identifies issues quickly, investigates and solves complex problems and applies appropriate solutions. Ensures the true root cause of any problem is found and a solution is identified which prevents recurrence</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Identifies issues quickly, investigates and solves complex problems and applies appropriate solutions. Ensures the true root cause of any problem is found and a solution is identified which prevents recurrence'] . "</td>"; ?>
        <?php echo "<td style='text-align:center'>" . (($previous_review->skills_scan_status47!="")?$sss[$previous_review->skills_scan_status47]:"") . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status47", $ss_statuses, $form_arf->skills_scan_status47, true, false, $assessor_signed) . "</td>";?>
    </tr>
    <tr>
        <td>Example</td>
        <td colspan=3><i>
    ...
    <tr>
        <td>Committed to continued professional development to ensure growth in professional skill and knowledge</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Committed to continued professional development to ensure growth in professional skill and knowledge'] . "</td>"; ?>
        <?php echo "<td style='text-align:center'>" . (($previous_review->skills_scan_status48!="")?$sss[$previous_review->skills_scan_status48]:"") . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status48", $ss_statuses, $form_arf->skills_scan_status48, true, false, $assessor_signed) . "</td>";?>
    </tr>
    <tr>
        <td>Example</td>
        <td colspan=3><i>
    ...
    <tr>
        <td>Work effectively under pressure showing resilience</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Work effectively under pressure showing resilience'] . "</td>"; ?>
        <?php echo "<td style='text-align:center'>" . (($previous_review->skills_scan_status49!="")?$sss[$previous_review->skills_scan_status49]:"") . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status49", $ss_statuses, $form_arf->skills_scan_status49, true, false, $assessor_signed) . "</td>";?>
    </tr>
    <tr>
        <td>Example</td>
        <td colspan=3><i>
...
;
    ...
    if(isset($project['total_criteria']) and $gt>0)
    {
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td>Network+</td>
        <td><?php echo $this->getEventStatus($events, "Network+") . "<br>" . $this->getEventDate($events,'Network+'); ?></td>
        <td>Security+</td>
        <td><?php echo $this->getEventStatus($events, "Security+") . "<br>" . $this->getEventDate($events,'Security+'); ?></td>
        <td>Implementing Network Solutions</td>
        <td><?php echo $this->getEventStatus($events, "Implementing Network Solutions") . "<br>" . $this->getEventDate($events,'Implementing Network Solutions'); ?></td>
    </tr>
    <tr>
        <td>Microsoft AZURE Administrator</td>
        <td><?php echo $this->getEventStatus($events, "Microsoft AZURE Administrator") . "<br>" . $this->getEventDate($events,'Microsoft AZURE Administrator'); ?></td>
        <td>NE L4 Workshop 1</td>
        <td><?php echo $this->getEventStatus($events, "NE L4 Workshop 1") . "<br>" . $this->getEventDate($events,'NE L4 Workshop 1'); ?></td>
        <td>NE L4 Workshop 2</td>
        <td><?php echo $this->getEventStatus($events, "NE L4 Workshop 2") . "<br>" . $this->getEventDate($events,'NE L4 Workshop 2'); ?></td>
    </tr>
    <tr>
        <td>NE L4 Workshop 3</td>
        <td><?php echo $this->getEventStatus($events, "NE L4 Workshop 3") . "<br>" . $this->getEventDate($events,'NE L4 Workshop 3'); ?></td>
        <td>NE L4 Workshop 4</td>
        <td><?php echo $this->getEventStatus($events, "NE L4 Workshop 4") . "<br>" . $this->getEventDate($events,'NE L4 Workshop 4'); ?></td>
        <td>NE L4 Workshop 5</td>
        <td><?php echo $this->getEventStatus($events, "NE L4 Workshop 5") . "<br>" . $this->getEventDate($events,'NE L4 Workshop 5'); ?></td>
    </tr>
    <tr>
