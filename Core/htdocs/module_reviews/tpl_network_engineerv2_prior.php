...
<title>Learner On Programme Review Network Engineer V2</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Network Engineer V2</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Network Engineer V2</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php if(isset($Assessment_Plan['Design Networks from a Specification'])) echo $Assessment_Plan['Design Networks from a Specification']; else "&nbsp;" ?></td>
        <td>Network Installation</td>
        <td><?php if(isset($Assessment_Plan['Network Installation'])) echo $Assessment_Plan['Network Installation']; else "&nbsp;" ?></td>
        <td>Network Performance</td>
        <td><?php if(isset($Assessment_Plan['Network Performance'])) echo $Assessment_Plan['Network Performance']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Diagnostic Tools & Techniques</td>
        <td><?php if(isset($Assessment_Plan['Diagnostic Tools & Techniques'])) echo $Assessment_Plan['Diagnostic Tools & Techniques']; else "&nbsp;" ?></td>
        <td>Troubleshooting & Repair</td>
        <td><?php if(isset($Assessment_Plan['Troubleshooting & Repair'])) echo $Assessment_Plan['Troubleshooting & Repair']; else "&nbsp;" ?></td>
        <td>Integrating Network Software</td>
        <td><?php if(isset($Assessment_Plan['Integrating Network Software'])) echo $Assessment_Plan['Integrating Network Software']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Monitor Test & Adjust Networks</td>
        <td><?php if(isset($Assessment_Plan['Monitor Test & Adjust Networks'])) echo $Assessment_Plan['Monitor Test & Adjust Networks']; else "&nbsp;" ?></td>
        <td>Logging & Responding to Calls</td>
        <td><?php if(isset($Assessment_Plan['Logging & Responding to Calls'])) echo $Assessment_Plan['Logging & Responding to Calls']; else "&nbsp;" ?></td>
    ...
    <tr>
        ...
        <td><?php if(isset($Assessment_Plan['Interpret Written Requirements and Tech Specs'])) echo $Assessment_Plan['Interpret Written Requirements and Tech Specs']; else "&nbsp;" ?></td>
        <td>Documenting</td>
        <td><?php if(isset($Assessment_Plan['Documenting'])) echo $Assessment_Plan['Documenting']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Upgrading Network Systems</td>
        <td><?php if(isset($Assessment_Plan['Upgrading Network Systems'])) echo $Assessment_Plan['Upgrading Network Systems']; else "&nbsp;" ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "9628-04 network systems and architecture test") . "<br>" . $this->getEventDate($events,'9628-04 network systems and architecture test'); ?></td>
        <td>9628-05 network security test</td>
        <td><?php echo $this->getEventStatus($events, "9628-05 network security test") . "<br>" . $this->getEventDate($events,'9628-05 network security test'); ?></td>
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "Cloud fundamentals MTA TEST") . "<br>" . $this->getEventDate($events,'Cloud fundamentals MTA TEST'); ?></td>
    </tr>
    <tr>
        <td>9628-03 Networking principles test</td>
        <td><?php echo $this->getEventStatus($events, "9628-03 Networking principles test") . "<br>" . $this->getEventDate($events,'9628-03 Networking principles test'); ?></td>
        <td>Networking principles</td>
        <td><?php echo $this->getEventStatus($events, "Networking principles") . "<br>" . $this->getEventDate($events,'Networking principles'); ?></td>
