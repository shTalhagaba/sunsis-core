...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td>Hours Currently</td><td><input onKeyPress='return numbersonly(this, event)' type="text" name="hours_currently" value="<?php echo $form_arf->hours_currently; ?>" size=10/></td>
