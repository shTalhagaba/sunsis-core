...
<title>Learner On Programme Review Network Engineer V1</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Network Engineer V1</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Network Engineer V1</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "CompTIA Server+") . "<br>" . $this->getEventDate($events,'CompTIA Server+'); ?></td>
        <td>Network Systems & Architecture Test</td>
        <td><?php echo $this->getEventStatus($events, "Network Systems & Architecture Test") . "<br>" . $this->getEventDate($events,'Network Systems & Architecture Test'); ?></td>
        <td>CompTIA Security</td>
        <td><?php echo $this->getEventStatus($events, "ISQI Agile Business Analysis") . "<br>" . $this->getEventDate($events,'ISQI Agile Business Analysis'); ?></td>
    </tr>
    <tr>
        <td>Network Security Test</td>
        <td><?php echo $this->getEventStatus($events, "Network Security Test") . "<br>" . $this->getEventDate($events,'Network Security Test'); ?></td>
        <td>CompTIA Network+</td>
        <td><?php echo $this->getEventStatus($events, "CompTIA Network+") . "<br>" . $this->getEventDate($events,'CompTIA Network+'); ?></td>
        <td>CompTIA Network+ Test</td>
        <td><?php echo $this->getEventStatus($events, "CompTIA Network+ Test") . "<br>" . $this->getEventDate($events,'CompTIA Network+ Test'); ?></td>
    </tr>
    <tr>
