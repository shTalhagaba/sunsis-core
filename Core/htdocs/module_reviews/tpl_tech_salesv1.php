...
<title>Learner On Programme Review Technical Sales V1</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Technical Sales V1</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Technical Sales V1</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php if(isset($Assessment_Plan['Customer Experience'])) echo $Assessment_Plan['Customer Experience']; else "&nbsp;" ?></td>
        <td>Data Security</td>
        <td><?php if(isset($Assessment_Plan['Data Security'])) echo $Assessment_Plan['Data Security']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Problem Solving</td>
        <td><?php if(isset($Assessment_Plan['Problem Solving'])) echo $Assessment_Plan['Problem Solving']; else "&nbsp;" ?></td>
        <td>Assess & qualify sales leads</td>
        <td><?php if(isset($Assessment_Plan['Assess & qualify sales leads'])) echo $Assessment_Plan['Assess & qualify sales leads']; else "&nbsp;" ?></td>
        <td>Project management</td>
        <td><?php if(isset($Assessment_Plan['Project management'])) echo $Assessment_Plan['Project management']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Legislation</td>
        <td><?php if(isset($Assessment_Plan['Legislation'])) echo $Assessment_Plan['Legislation']; else "&nbsp;" ?></td>
        <td>Sales Process</td>
        <td><?php if(isset($Assessment_Plan['Sales Process'])) echo $Assessment_Plan['Sales Process']; else "&nbsp;" ?></td>
        <td>Technical</td>
        <td><?php if(isset($Assessment_Plan['Technical'])) echo $Assessment_Plan['Technical']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Database & campaign management</td>
        <td><?php if(isset($Assessment_Plan['Database & campaign management'])) echo $Assessment_Plan['Database & campaign management']; else "&nbsp;" ?></td>
        <td>Context & CPD</td>
        <td><?php if(isset($Assessment_Plan['Context & CPD'])) echo $Assessment_Plan['Context & CPD']; else "&nbsp;" ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    </tr>
    <tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "Sales Fundamentals") . "<br>" . $this->getEventDate($events,'Sales Fundamentals'); ?></td>
        <td>Social Selling</td>
        <td><?php echo $this->getEventStatus($events, "Social Selling") . "<br>" . $this->getEventDate($events,'Social Selling'); ?></td>
        <td>CompTIA A+ Part 1</td>
        <td><?php echo $this->getEventStatus($events, "CompTIA A+ Part 1") . "<br>" . $this->getEventDate($events,'CompTIA A+ Part 1'); ?></td>
    </tr>
    <tr>
        <td>CompTIA A+ Part 2</td>
        <td><?php echo $this->getEventStatus($events, "CompTIA A+ Part 2") . "<br>" . $this->getEventDate($events,'CompTIA A+ Part 2'); ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
