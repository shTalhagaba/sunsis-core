...
<title>Learner On Programme Review Digital Marketing V4</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Digital Marketing V4</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Digital Marketing V4</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Research'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Technologies'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Customer Service'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Problem Solving'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Specialist Areas'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Digital Tools'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Digital Analytics'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $ss_result['Implementation'] . "</td>"; ?>
        ...
        <?php $performance = isset($Assessment_Plan['Implementation'])?$Assessment_Plan['Implementation']:"&nbsp"; echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $performance . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Effective business operation'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Industry developments and practices'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The principles of coding'] . "</td>"; ?>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status13", $ss_statuses, $form_arf->skills_scan_status13, true, false, $assessor_signed) . "</td>";?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Applying basic marketing principles'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Applying the customer lifecycle'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The role of customer relationship marketing'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['How  teams work effectively to deliver digital marketing campaigns and can deliver accordingly'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The main components of Digital and Social Media Strategies'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The principles of all of the following specialist areas: search marketing, search engine optimisation, e mail marketing, web analytics and metrics, mobile apps and Pay-Per-Click and understands how these can work together'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The similarities and differences, including positives and negatives, of all the major digital and social media platforms'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Responds to the business environment and business issues related to digital marketing and customer needs'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Digital etiquette'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['How digital platforms integrate in to the working environment'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Required security levels necessary to protect data across digital and social media platforms'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Customer Service","Digital Tools","Implementation","Environment")))
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>&nbsp;</td>";
        ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td>Campaign 1 Activity 1</td>
        <td><?php if(isset($Assessment_Plan['Campaign 1 Activity 1'])) echo $Assessment_Plan['Campaign 1 Activity 1']; else "&nbsp;" ?></td>
        <td>Campaign 1 Activity 2</td>
        <td><?php if(isset($Assessment_Plan['Campaign 1 Activity 2'])) echo $Assessment_Plan['Campaign 1 Activity 2']; else "&nbsp;" ?></td>
        <td>Campaign 1 Activity 3</td>
        <td><?php if(isset($Assessment_Plan['Campaign 1 Activity 3'])) echo $Assessment_Plan['Campaign 1 Activity 3']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Campaign 2 Activity 1</td>
        <td><?php if(isset($Assessment_Plan['Campaign 2 Activity 1'])) echo $Assessment_Plan['Campaign 2 Activity 1']; else "&nbsp;" ?></td>
        <td>Campaign 2 Activity 2</td>
        <td><?php if(isset($Assessment_Plan['Campaign 2 Activity 2'])) echo $Assessment_Plan['Campaign 2 Activity 2']; else "&nbsp;" ?></td>
        <td>Campaign 2 Activity 3</td>
        <td><?php if(isset($Assessment_Plan['Campaign 2 Activity 3'])) echo $Assessment_Plan['Campaign 2 Activity 3']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Professional Practise Activity 1</td>
        <td><?php if(isset($Assessment_Plan['Professional Practise Activity 1'])) echo $Assessment_Plan['Professional Practise Activity 1']; else "&nbsp;" ?></td>
        <td>Professional Practise Activity 2</td>
        <td><?php if(isset($Assessment_Plan['Professional Practise Activity 2'])) echo $Assessment_Plan['Professional Practise Activity 2']; else "&nbsp;" ?></td>
        <td>Professional Practise Activity 3</td>
        <td><?php if(isset($Assessment_Plan['Professional Practise Activity 3'])) echo $Assessment_Plan['Professional Practise Activity 3']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Professional Practise Activity 4</td>
        <td><?php if(isset($Assessment_Plan['Professional Practise Activity 4'])) echo $Assessment_Plan['Professional Practise Activity 4']; else "&nbsp;" ?></td>
        <td>Problem Solving</td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "Principles of coding") . "<br>" . $this->getEventDate($events,'Principles of coding'); ?></td>
        <td>9828-11 principles of coding test</td>
        <td><?php echo $this->getEventStatus($events, "9628-11 principles of coding test") . "<br>" . $this->getEventDate($events,'9628-11 principles of coding test'); ?></td>
        <td>Part 1: principles of online and offline marketing theory</td>
        <td><?php echo $this->getEventStatus($events, "Part 1: principles of online and offline marketing theory") . "<br>" . $this->getEventDate($events,'Part 1: principles of online and offline marketing theory'); ?></td>
    </tr>
    <tr>
        <td>Part 2: principles of online and offline marketing theory</td>
        <td><?php echo $this->getEventStatus($events, "Part 2: principles of online and offline marketing theory") . "<br>" . $this->getEventDate($events,'Part 2: principles of online and offline marketing theory'); ?></td>
        <td>9628-12 principles of online and offline marketing theory test</td>
        <td><?php echo $this->getEventStatus($events, "9628-12 principles of online and offline marketing theory test") . "<br>" . $this->getEventDate($events,'9628-12 principles of online and offline marketing theory test'); ?></td>
        <td>Google analytics IQ</td>
        <td><?php echo $this->getEventStatus($events, "Google analytics IQ") . "<br>" . $this->getEventDate($events,'Google analytics IQ'); ?></td>
    </tr>
    <tr>
        <td>Google analytics IQ test</td>
        <td><?php echo $this->getEventStatus($events, "Google analytics IQ test") . "<br>" . $this->getEventDate($events,'Google analytics IQ test'); ?></td>
