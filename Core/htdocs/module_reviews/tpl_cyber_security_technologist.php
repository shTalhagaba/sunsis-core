...
"); ?></td>
    ...
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<tr><td colspan=4><textarea name="learner_concerns" onblur="checkLength(event,this,2000)" onkeypress="checkLength(event,this,2000)" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">'.$form_arf->learner_concerns.'</textarea></td></tr>';
        else
            echo '<tr><td>' . $form_arf->learner_comment . '</td></tr>';
            ?>
        </i></td>
    </tr>
    </tbody>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Certificate in Cyber Security Introduction Test') . "<br>" . $this->getEventDate($events,'Certificate in Cyber Security Introduction Test') . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Certificate in Network and Digital Communications Test') . "<br>" . $this->getEventDate($events,'Certificate in Network and Digital Communications Test') . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Certificate in Security Case Development and Design Good Practice Test') . "<br>" . $this->getEventDate($events,'Certificate in Security Case Development and Design Good Practice Test') . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Certificate in Security Technology Building Blocks Test') . "<br>" . $this->getEventDate($events,'Certificate in Security Technology Building Blocks Test') . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Certificate in Employment of Cryptography Test') . "<br>" . $this->getEventDate($events,'Certificate in Employment of Cryptography Test') . "</td>";?>
    </tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php  if($this->isAssessmentComplete($Assessment_Plan, Array("Core Activity 1","Core Activity 2","Core Activity 3","Core Activity 4","Technologist Activity 1 Project 1","Technologist Activity 1 Project 2","Technologist Activity 1 Project 3")))
