...
<title>Learner On Programme Review Software Tester</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Software Tester</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Software Tester</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td>Implementing Software Testing</td>
        <td><?php if(isset($Assessment_Plan['Implementing Software Testing'])) echo $Assessment_Plan['Implementing Software Testing']; else "&nbsp;" ?></td>
        <td>Software Requirements</td>
        <td><?php if(isset($Assessment_Plan['Software Requirements'])) echo $Assessment_Plan['Software Requirements']; else "&nbsp;" ?></td>
        <td>Design Test Strategies</td>
        <td><?php if(isset($Assessment_Plan['Design Test Strategies'])) echo $Assessment_Plan['Design Test Strategies']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Test Plans</td>
        <td><?php if(isset($Assessment_Plan['Test Plans'])) echo $Assessment_Plan['Test Plans']; else "&nbsp;" ?></td>
        <td>Test Cases</td>
        <td><?php if(isset($Assessment_Plan['Test Cases'])) echo $Assessment_Plan['Test Cases']; else "&nbsp;" ?></td>
        <td>Developing & Collecting Data</td>
        <td><?php if(isset($Assessment_Plan['Developing & Collecting Data'])) echo $Assessment_Plan['Developing & Collecting Data']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Conduct Software Testing</td>
        <td><?php if(isset($Assessment_Plan['Conduct Software Testing'])) echo $Assessment_Plan['Conduct Software Testing']; else "&nbsp;" ?></td>
        <td>Test Outcomes</td>
        <td><?php if(isset($Assessment_Plan['Test Outcomes'])) echo $Assessment_Plan['Test Outcomes']; else "&nbsp;" ?></td>
        <td>Results Vs Expectations</td>
        <td><?php if(isset($Assessment_Plan['Results vs Expectations'])) echo $Assessment_Plan['Results vs Expectations']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Presenting Test Results</td>
        <td><?php if(isset($Assessment_Plan['Presenting Test Results'])) echo $Assessment_Plan['Presenting Test Results']; else "&nbsp;" ?></td>
        <td>Testing Tools, Techniques & Procedures</td>
        <td><?php if(isset($Assessment_Plan['Testing Tools, Techniques and Procedures'])) echo $Assessment_Plan['Testing Tools, Techniques and Procedures']; else "&nbsp;" ?></td>
        <td>Legislation</td>
        <td><?php if(isset($Assessment_Plan['Legislation'])) echo $Assessment_Plan['Legislation']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Advise and Support Others</td>
        <td><?php if(isset($Assessment_Plan['Advise and Support Others'])) echo $Assessment_Plan['Advise and Support Others']; else "&nbsp;" ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td>Software applications testing</td>
        <td><?php echo $this->getEventStatus($events, "Software applications testing") . "<br>" . $this->getEventDate($events,'Software applications testing'); ?></td>
        <td>Design an effective web user experience</td>
        <td><?php echo $this->getEventStatus($events, "Design an effective web user experience") . "<br>" . $this->getEventDate($events,'Design an effective web user experience'); ?></td>
    </tr>
    <tr>
        <td>ISTQB certified foundation tester</td>
        <td><?php echo $this->getEventStatus($events, "ISTQB certified foundation tester") . "<br>" . $this->getEventDate($events,'ISTQB certified foundation tester'); ?></td>
        <td>ISTQB certified foundation tester test</td>
        <td><?php echo $this->getEventStatus($events, "ISTQB certified foundation tester test") . "<br>" . $this->getEventDate($events,'ISTQB certified foundation tester test'); ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    </tr>
    <tr>
