...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 700px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Cyber Security Risk Analyst</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Discover vulnerabilities in a system'] . "</td>"; ?>
        ...
        <?php $communication = isset($Assessment_Plan['Core Activity 1'])?$Assessment_Plan['Core Activity 1']:"&nbsp"; echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $communication . "</td>";?>
    </tr>

    <tr>
        <td rowspan=1>Threats, hazards, risks and intelligence</td>
        <td>Analyse and evaluate security threats and hazards to a system or service or processes</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Analyse and evaluate security threats and hazards to a system or service or processes'] . "</td>"; ?>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status2", $ss_statuses, $form_arf->skills_scan_status2, true, false, $assessor_signed) . "</td>";?>
        <?php $communication = isset($Assessment_Plan['Core Activity 1'])?$Assessment_Plan['Core Activity 1']:"&nbsp"; echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $communication . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Common attack techniques and how to defend against them.  Awareness of use of  relevant external sources of vulnerabilities (e.g. OWASP)'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Security risk assessment for a simple system and basic remediation advice in the context of the employer'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Source and analyse a security case (e.g. a Common Criteria Protection Profile for a security component) and describe what threats, vulnerability or risks are mitigated and identify any residual areas of concern'] . "</td>"; ?>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status5", $ss_statuses, $form_arf->skills_scan_status5, true, false, $assessor_signed) . "</td>";?>
        <?php $it_security = isset($Assessment_Plan['Core Activity 1'])?$Assessment_Plan['Core Activity 1']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $it_security . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Develop a simple security case to include the security objectives, threats, and for every identified attack technique identify mitigation or security controls that could include technical, implementation, policy or process'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Follow organisational policies and standards for information and cyber security'] . "</td>"; ?>
        ...
        <?php $remote_infrastructure = isset($Assessment_Plan['Core Activity 1'])?$Assessment_Plan['Core Activity 1']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $remote_infrastructure . "</td>";?>
    </tr>

    <tr>
        <td>Organisational context</td>
        <td>Operate according to service level agreements or employer defined performance targets</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Operate according to service level agreements or employer defined performance targets'] . "</td>"; ?>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status8", $ss_statuses, $form_arf->skills_scan_status8, true, false, $assessor_signed) . "</td>";?>
        <?php $remote_infrastructure = isset($Assessment_Plan['Core Activity 1'])?$Assessment_Plan['Core Activity 1']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $remote_infrastructure . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Investigate different views of the future (using more than one external source) and trends in a relevant technology area and describe what this might mean for your business, with supporting reasoning'] . "</td>"; ?>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status9", $ss_statuses, $form_arf->skills_scan_status9, true, false, $assessor_signed) . "</td>";?>
        <?php $remote_infrastructure = isset($Assessment_Plan['Core Activity 1'])?$Assessment_Plan['Core Activity 1']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $remote_infrastructure . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Conduct a cyber-risk assessment against an externally (market) recognised cyber security standard using a recognised risk assessment methodology'] . "</td>"; ?>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status10", $ss_statuses, $form_arf->skills_scan_status10, true, false, $assessor_signed) . "</td>";?>
        <?php $data = isset($Assessment_Plan['Risk Analyst Activity 1'])?$Assessment_Plan['Risk Analyst Activity 1']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $data . "</td>";?>
    </tr>

    <tr>
        <td>Cyber security risk assessment</td>
        <td>Identify threats relevant to a specific organisation and/or sector. Information security policy and process</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Identify threats relevant to a specific organisation and/or sector. Information security policy and process'] . "</td>"; ?>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status11", $ss_statuses, $form_arf->skills_scan_status11, true, false, $assessor_signed) . "</td>";?>
        <?php $data = isset($Assessment_Plan['Risk Analyst Activity 1'])?$Assessment_Plan['Risk Analyst Activity 1']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $data . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Develop an information security policy or process to address an identified risk'] . "</td>"; ?>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status12", $ss_statuses, $form_arf->skills_scan_status12, true, false, $assessor_signed) . "</td>";?>
        <?php $data = isset($Assessment_Plan['Risk Analyst Activity 1'])?$Assessment_Plan['Risk Analyst Activity 1']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $data . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Develop an information security policy within a defined scope to take account of a minimum of 1 law or regulation relevant to cyber security'] . "</td>"; ?>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status13", $ss_statuses, $form_arf->skills_scan_status13, true, false, $assessor_signed) . "</td>";?>
        <?php $data = isset($Assessment_Plan['Risk Analyst Activity 1'])?$Assessment_Plan['Risk Analyst Activity 1']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $data . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Take an active part in a security audit against a recognised cyber security standard, undertake a gap analysis and make recommendations for remediation'] . "</td>"; ?>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status14", $ss_statuses, $form_arf->skills_scan_status14, true, false, $assessor_signed) . "</td>";?>
        <?php $data = isset($Assessment_Plan['Risk Analyst Activity 1'])?$Assessment_Plan['Risk Analyst Activity 1']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $data . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Develop an incident response plan for approval (within an organisations governance arrangements for incident response)'] . "</td>"; ?>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status15", $ss_statuses, $form_arf->skills_scan_status15, true, false, $assessor_signed) . "</td>";?>
        <?php $data = isset($Assessment_Plan['Risk Analyst Activity 1'])?$Assessment_Plan['Risk Analyst Activity 1']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $data . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Develop a business continuity plan for approval (within an organisations governance arrangements for business continuity)'] . "</td>"; ?>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status16", $ss_statuses, $form_arf->skills_scan_status16, true, false, $assessor_signed) . "</td>";?>
        <?php $data = isset($Assessment_Plan['Risk Analyst Activity 1'])?$Assessment_Plan['Risk Analyst Activity 1']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $data . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Assess security culture using a recognised approach'] . "</td>"; ?>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status17", $ss_statuses, $form_arf->skills_scan_status17, true, false, $assessor_signed) . "</td>";?>
        <?php $data = isset($Assessment_Plan['Risk Analyst Activity 1'])?$Assessment_Plan['Risk Analyst Activity 1']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $data . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Design and implement a simple (security awareness) campaign to address a specific aspect of a security culture'] . "</td>"; ?>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status18", $ss_statuses, $form_arf->skills_scan_status18, true, false, $assessor_signed) . "</td>";?>
        <?php $data = isset($Assessment_Plan['Risk Analyst Activity 1'])?$Assessment_Plan['Risk Analyst Activity 1']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $data . "</td>";?>
    </tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr><td>Technical Knowledge</td><td>Skills Scan Grade</td><td>Previous Skill Scan Status</td><td>Current Skills Scan Status</td><td>Assessment Plan Status</td></tr>
    <tr>
        <td>Why cyber security matters - the importance to business and society</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Why cyber security matters - the importance to business and society'] . "</td>"; ?>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Certificate in Cyber Security Introduction') . "<br>" . $this->getEventDate($events,'Certificate in Cyber Security Introduction') . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Basic theory - concepts such as security, identity, confidentiality, integrity, availability, threat, vulnerability, risk and hazard. Also how these relate to each other and lead to risk and harm'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Security assurance - concepts and how assurance may be achieved in practice (eg penetration testing is and how it contributes to assurance; and extrinsic assurance methods)'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Building a security case - deriving security objectives with reasoned justification in a representative business scenario'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Cyber security concepts applied to ICT infrastructure - the fundamental building blocks and typical architectures and identify some common vulnerabilities in networks and systems'] . "</td>"; ?>
    ...
    <tr>
        <td>Develop a simple security case to include the security objectives, threats, and for every identified attack technique identify mitigation or security controls that could include technical, implementation, policy or process</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Develop a simple security case to include the security objectives, threats, and for every identified attack technique identify mitigation or security controls that could include technical, implementation, policy or process'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Attack techniques and sources of threat, the main types of common attack techniques; also the role of human behaviour.  How attack techniques combine with motive and opportunity to become a threat'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Cyber defence - ways to defend against attack techniques'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Laws and ethics - security standards, regulations and their consequences.  The role of criminal and other law; key relevant features of UK and international law'] . "</td>"; ?>
    ...
    <tr>
        <td>Conduct a cyber - risk assessment against an externally (market) recognised cyber security standard using a recognised risk assessment methodology</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Conduct a cyber - risk assessment against an externally (market) recognised cyber security standard using a recognised risk assessment methodology'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Threat landscape - how to apply relevant techniques for horizon scanning including use of recognised sources of threat intelligence'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Threat trends - the significance of identified trends  in cyber security and  the value and risk of this analysis'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Types of risk assessment methodologies and approaches to risk treatment; can identify the vulnerabilities in organisations and security management systems; understand the threat intelligence lifecycle; describe different approaches to risk treatment. Understand the role of the risk owner and contrast that role with other stakeholders'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['The legal, standards, regulations and ethical standards relevant to cyber security: governance, organisational structure, roles, policies, standard, guidelines and how these all work together to deliver identified security outcomes. Awareness of the legal framework, key concepts applying to ISO27001 (a specification for information security management), and awareness of legal and regulatory obligations for breach notification'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Logical and creative thinking skills'] . "</td>"; ?>
        <?php echo "<td width=50px style='text-align:center'>" . (($previous_review->skills_scan_status33!="")?$sss[$previous_review->skills_scan_status33]:"") . "</td>"; ?>
        <?php echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status33", $ss_statuses, $form_arf->skills_scan_status33, true, false, $assessor_signed) . "</td>";?>
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Core Activity 1","Core Activity 2","Core Activity 3","Core Activity 4","Risk Analyst Activity 1","Risk Analyst Activity 2","Risk Analyst Activity 3","Risk Analyst Activity 4")))
        echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>&nbsp;</td>";
        ?>
    </tr>
    <tr>
        <td>Example</td>
    ...
    <tr>
        ...
        <?php echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Analytical and problem solving skills'] . "</td>"; ?>
        <?php echo "<td width=50px style='text-align:center'>" . (($previous_review->skills_scan_status34!="")?$sss[$previous_review->skills_scan_status34]:"") . "</td>"; ?>
        <?php echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status34", $ss_statuses, $form_arf->skills_scan_status34, true, false, $assessor_signed) . "</td>";?>
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Core Activity 1","Core Activity 2","Core Activity 3","Core Activity 4","Risk Analyst Activity 1","Risk Analyst Activity 2","Risk Analyst Activity 3","Risk Analyst Activity 4")))
        echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>&nbsp;</td>";
    ...
    <tr>
        ...
        <?php echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Ability to work independently and to take responsibility'] . "</td>"; ?>
        <?php echo "<td width=50px style='text-align:center'>" . (($previous_review->skills_scan_status35!="")?$sss[$previous_review->skills_scan_status35]:"") . "</td>"; ?>
        <?php echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status35", $ss_statuses, $form_arf->skills_scan_status35, true, false, $assessor_signed) . "</td>";?>
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Core Activity 1","Core Activity 2","Core Activity 3","Core Activity 4","Risk Analyst Activity 1","Risk Analyst Activity 2","Risk Analyst Activity 3","Risk Analyst Activity 4")))
        echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>&nbsp;</td>";
    ...
    <tr>
        ...
        <?php echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Can use own initiative'] . "</td>"; ?>
        <?php echo "<td width=50px style='text-align:center'>" . (($previous_review->skills_scan_status36!="")?$sss[$previous_review->skills_scan_status36]:"") . "</td>"; ?>
        <?php echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status36", $ss_statuses, $form_arf->skills_scan_status36, true, false, $assessor_signed) . "</td>";?>
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Core Activity 1","Core Activity 2","Core Activity 3","Core Activity 4","Risk Analyst Activity 1","Risk Analyst Activity 2","Risk Analyst Activity 3","Risk Analyst Activity 4")))
        echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>&nbsp;</td>";
    ...
    <tr>
        ...
        <?php echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['A thorough and organised approach'] . "</td>"; ?>
        <?php echo "<td width=50px style='text-align:center'>" . (($previous_review->skills_scan_status37!="")?$sss[$previous_review->skills_scan_status37]:"") . "</td>"; ?>
        <?php echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status37", $ss_statuses, $form_arf->skills_scan_status37, true, false, $assessor_signed) . "</td>";?>
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Core Activity 1","Core Activity 2","Core Activity 3","Core Activity 4","Risk Analyst Activity 1","Risk Analyst Activity 2","Risk Analyst Activity 3","Risk Analyst Activity 4")))
        echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>&nbsp;</td>";
    ...
    <tr>
        ...
        <?php echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Ability to work with a range of internal and external people'] . "</td>"; ?>
        <?php echo "<td width=50px style='text-align:center'>" . (($previous_review->skills_scan_status38!="")?$sss[$previous_review->skills_scan_status38]:"") . "</td>"; ?>
        <?php echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status38", $ss_statuses, $form_arf->skills_scan_status38, true, false, $assessor_signed) . "</td>";?>
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Core Activity 1","Core Activity 2","Core Activity 3","Core Activity 4","Risk Analyst Activity 1","Risk Analyst Activity 2","Risk Analyst Activity 3","Risk Analyst Activity 4")))
        echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>&nbsp;</td>";
    ...
    <tr>
        ...
        <?php echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Ability to communicate effectively in a variety of situations'] . "</td>"; ?>
        <?php echo "<td width=50px style='text-align:center'>" . (($previous_review->skills_scan_status39!="")?$sss[$previous_review->skills_scan_status39]:"") . "</td>"; ?>
        <?php echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status39", $ss_statuses, $form_arf->skills_scan_status39, true, false, $assessor_signed) . "</td>";?>
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Core Activity 1","Core Activity 2","Core Activity 3","Core Activity 4","Risk Analyst Activity 1","Risk Analyst Activity 2","Risk Analyst Activity 3","Risk Analyst Activity 4")))
        echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>&nbsp;</td>";
    ...
    <tr>
        ...
        <?php echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Maintain productive, professional and secure working environment'] . "</td>"; ?>
        <?php echo "<td width=50px style='text-align:center'>" . (($previous_review->skills_scan_status40!="")?$sss[$previous_review->skills_scan_status40]:"") . "</td>"; ?>
        <?php echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status40", $ss_statuses, $form_arf->skills_scan_status40, true, false, $assessor_signed) . "</td>";?>
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Core Activity 1","Core Activity 2","Core Activity 3","Core Activity 4","Risk Analyst Activity 1","Risk Analyst Activity 2","Risk Analyst Activity 3","Risk Analyst Activity 4")))
        echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td width=50px rowspan=1 style='text-align:center; vertical-align:middle'>&nbsp;</td>";
