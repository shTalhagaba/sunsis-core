...
<title>Learner On Programme Review Network Engineer</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Network Engineer</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Network Engineer</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "CompTIA security+") . "<br>" . $this->getEventDate($events,'CompTIA security+'); ?></td>
    </tr>
    <tr>
        <td>9628-05 Network security test</td>
        <td><?php echo $this->getEventStatus($events, "9628-05 Network security test") . "<br>" . $this->getEventDate($events,'CompTIA security'); ?></td>
