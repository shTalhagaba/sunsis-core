...
<title>Learner On Programme Review Software Development</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review Software Development</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review Software Development</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['User Interface'] . "</td>"; ?>
        ...
        <?php $it_security = isset($Assessment_Plan['User Interface'])?$Assessment_Plan['User Interface']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $it_security . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php $remote_infrastructure = isset($Assessment_Plan['Data'])?$Assessment_Plan['Data']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $remote_infrastructure . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Testing'] . "</td>"; ?>
        ...
        <?php $data = isset($Assessment_Plan['Testing'])?$Assessment_Plan['Testing']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $data . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php $problem_solving = isset($Assessment_Plan['Problem Solving'])?$Assessment_Plan['Problem Solving']:"&nbsp"; echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $problem_solving . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Design'] . "</td>"; ?>
        ...
        <?php $workflow_management = isset($Assessment_Plan['Design'])?$Assessment_Plan['Design']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $workflow_management . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Deployment'] . "</td>"; ?>
        ...
        <?php $performance = isset($Assessment_Plan['Deployment'])?$Assessment_Plan['Deployment']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $performance . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Development Lifecycle'] . "</td>"; ?>
        ...
        <?php $performance = isset($Assessment_Plan['Development Lifecycle'])?$Assessment_Plan['Development Lifecycle']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $performance . "</td>";?>
    </tr>
<!--
    <tr>
        <td rowspan=1>Good Practice</td>
        <td>Apply good practice approaches according to the relevant paradigm (for example object oriented, event driven or procedural</td>
        <?php //echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Good Practice'] . "</td>"; ?>
        ...
        <?php //$performance = isset($Assessment_Plan['Good Practice'])?$Assessment_Plan['Good Practice']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $performance . "</td>";?>
    </tr>

    <tr>
        <td rowspan=4>Interpret</td>
        <td>Software designs and functional/technical specifications</td>
        <?php //echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $ss_result['Interpret'] . "</td>"; ?>
        ...
        <?php //if(isset($Assessment_Plan['Business Environment']) && $Assessment_Plan['Business Environment']=="Complete")
                //if(isset($Assessment_Plan['Operational Requirements']) && $Assessment_Plan['Operational Requirements']=="Complete")
                  //  if(isset($Assessment_Plan['Service Level Agreements']) && $Assessment_Plan['Service Level Agreements']=="Complete")
                    //    if(isset($Assessment_Plan['User Interface']) && $Assessment_Plan['User Interface']=="Complete")
                      //      if(isset($Assessment_Plan['Design']) && $Assessment_Plan['Design']=="Complete")
                        //        if(isset($Assessment_Plan['Testing']) && $Assessment_Plan['Testing']=="Complete")
                          //          if(isset($Assessment_Plan['Problem Solving']) && $Assessment_Plan['Problem Solving']=="Complete")
                            //            if(isset($Assessment_Plan['Deployment']) && $Assessment_Plan['Deployment']=="Complete")
                              //              if(isset($Assessment_Plan['Analysis']) && $Assessment_Plan['Analysis']=="Complete")
                                //                if(isset($Assessment_Plan['Development Lifecycle']) && $Assessment_Plan['Development Lifecycle']=="Complete")
                                  //                  if(isset($Assessment_Plan['Data']) && $Assessment_Plan['Data']=="Complete")
                                    //                    if(isset($Assessment_Plan['Good Pratice']) && $Assessment_Plan['Good Practice']=="Complete")
                                      //                      if(isset($Assessment_Plan['Adaptability']) && $Assessment_Plan['Adaptability']=="Complete")
                                        //                        if(isset($Assessment_Plan['Logic']) && $Assessment_Plan['Logic']=="Complete")
                                          //                         $performance = "Complete";
                                            //                    else
                                              //                      $performance = "&nbsp;";
        //echo "<td rowspan=4 style='text-align:center; vertical-align:middle'>" . $performance . "</td>";?>
    </tr>
    <tr><td>Company defined 'coding standards' or industry good practice for coding</td></tr>
    <tr><td>Testing frameworks and methodologies</td></tr>
    <tr><td>Company, team or client approaches to continuous integration, version and source control</td></tr>
-->
    <tr>
    ...
    <!--
    <tr>
        <td rowspan=1>Effectiveness</td>
        <td>Operate effectively in their own business's, their customers' and the industry's environments</td>
        <?php //echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Effectiveness'] . "</td>"; ?>
        ...
        <?php //if(isset($Assessment_Plan['Operational Requirements']) and $Assessment_Plan['Operational Requirements']=="Complete")
               // if(isset($Assessment_Plan['Service Level Agreements']) and $Assessment_Plan['Service Level Agreements']=="Complete")
                //    $performance = "Complete";
                //else
                  //  $performance = "&nbsp;";

        // echo "<td style='text-align:center; vertical-align:middle'>" . $performance . "</td>";?>
    </tr>
    <tr>
        <td rowspan=1>Maths Application</td>
        <td>Apply the maths required to be a software developer (e.g. algorithms, logic and data structures)</td>
        <?php //echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Maths Application'] . "</td>"; ?>
        ...
        <?php //$performance = isset($Assessment_Plan['Data'])?$Assessment_Plan['Data']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $performance . "</td>";?>
    </tr>
-->
</table>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Operate at all stages of the software development lifecycle'] . "</td>"; ?>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'9628-01 Software Development Methodologies Test') . "<br>" . $this->getEventDate($events,'9628-01 Software Development Methodologies Test') . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Similarities and differences (taking into account positives and negatives of both approaches) between agile and waterfall software development methodologies'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['How teams work effectively to produce software and contributes appropriately'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Apply software design approaches and patterns and can interpret and implement a given design, compliant with security and maintainability requirements'] . "</td>"; ?>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'HTML5 MTA Test') . "<br>" . $this->getEventDate($events,'HTML5 MTA Test') . "</td>";?>
    </tr>

    <tr>
        <td>Respond to the business environment and business issues related to software development</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Respond to the business environment and business issues related to software development'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Applies the maths required to be a software developer (e.g. algorithms, logic and data structures)'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Logic","User Interface", "Test", "Problem Solving", "Design", "Analysis", "Deployment", "Good Practice", "Interpret", "Business Environment", "Maths Application")))
    ...
    <tr>
        ...
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Logic", "Data", "Test", "Problem Solving", "Analysis", "Development Lifecycle", "Business Environment", "Effectiveness", "Maths Application")))
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>&nbsp;</td>";
        ?>
    ...
    <tr>
        ...
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Logic", "User Interface", "Data", "Test", "Problem Solving", "Design", "Analysis", "Deployment", "Development Lifecycle","Good Practice", "Interpret", "Business Environment", "Effectiveness", "Maths Application")))
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>&nbsp;</td>";
        ?>
    ...
    <tr>
        ...
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Logic", "User Interface", "Data", "Test", "Problem Solving", "Design", "Deployment", "Business Environment", "Effectiveness")))
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>&nbsp;</td>";
        ?>
    ...
    <tr>
        ...
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Logic", "User Interface", "Data", "Test", "Problem Solving", "Design", "Analysis", "Deployment", "Development Lifecycle", "Business Environment", "Effectiveness", "Maths Application")))
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>&nbsp;</td>";
        ?>
    ...
    <tr>
        ...
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("User Interface", "Test", "Problem Solving", "Business Environment")))
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>&nbsp;</td>";
        ?>
    ...
    <tr>
        ...
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Test", "Problem Solving", "Business Environment")))
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>&nbsp;</td>";
        ?>
