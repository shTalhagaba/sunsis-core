...
<title>Learner On Programme Review L4 Learning Mentor</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review L4 Learning Mentor</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme Review L4 Learning Mentor</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr><td>Knowledge</td><td>Skills Scan Grade</td><td>Current Skills Scan Grade</td></tr>

    <tr>
        <td>Sources of, and how to access, up-to-date and valid IAG</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Sources of, and how to access, up-to-date and valid IAG'] . "</td>"; ?>
    ...
    <tr>
        <td>Relevant forms of assessment to identify individual needs</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Relevant forms of assessment to identify individual needs'] . "</td>"; ?>
    ...
    <tr>
        <td>How to agree individual programmes that inspire and challenge learners to achieve current work-related knowledge and skills</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['How to agree individual programmes that inspire and challenge learners to achieve current work-related knowledge and skills'] . "</td>"; ?>
    ...
    <tr>
        <td>Additional support for learners available through workplace and provider-based colleagues</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Additional support for learners available through workplace and provider-based colleagues'] . "</td>"; ?>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status19", $ss_statuses, $form_arf->skills_scan_status19, true, false, $assessor_signed) . "</td>";?>
    </tr>

    <tr>
        <td>Strategies for inspiring learners, increasing their resilience in overcoming barriers and obstacles, and in raising concerns</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Strategies for inspiring learners, increasing their resilience in overcoming barriers and obstacles, and in raising concerns'] . "</td>"; ?>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status20", $ss_statuses, $form_arf->skills_scan_status20, true, false, $assessor_signed) . "</td>";?>
    </tr>

    <tr>
        <td>Maths and English underpinning vocational skills and how to access additional support</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Maths and English underpinning vocational skills and how to access additional support'] . "</td>"; ?>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status21", $ss_statuses, $form_arf->skills_scan_status21, true, false, $assessor_signed) . "</td>";?>
    </tr>

    <tr>
        <td>Effective practice in giving feedback to guide progress and achievement</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Effective practice in giving feedback to guide progress and achievement'] . "</td>"; ?>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status22", $ss_statuses, $form_arf->skills_scan_status22, true, false, $assessor_signed) . "</td>";?>
    </tr>

    <tr>
        <td>Ways of supporting the learners well-being</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Ways of supporting the learners well-being'] . "</td>"; ?>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status23", $ss_statuses, $form_arf->skills_scan_status23, true, false, $assessor_signed) . "</td>";?>
    </tr>

    <tr>
        <td>Current and emerging technologies that could safely and effectively support learner autonomy and the Assessor-Coach role</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Current and emerging technologies that could safely and effectively support learner autonomy and the Assessor-Coach role'] . "</td>"; ?>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status24", $ss_statuses, $form_arf->skills_scan_status24, true, false, $assessor_signed) . "</td>";?>
    </tr>

    <tr>
        <td>Administrative procedures for recording, storing and sharing information that is legally compliant</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Administrative procedures for recording, storing and sharing information that is legally compliant'] . "</td>"; ?>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status25", $ss_statuses, $form_arf->skills_scan_status25, true, false, $assessor_signed) . "</td>";?>
    </tr>

    <tr>
        <td>The effective use of active listening, assertiveness and questioning skills to support retention, progress and achievement</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['The effective use of active listening, assertiveness and questioning skills to support retention, progress and achievement'] . "</td>"; ?>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status26", $ss_statuses, $form_arf->skills_scan_status26, true, false, $assessor_signed) . "</td>";?>
    </tr>

    <tr>
        <td>The quality and safety requirements of assessment and procedures for reporting concerns</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['The quality and safety requirements of assessment and procedures for reporting concerns'] . "</td>"; ?>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status27", $ss_statuses, $form_arf->skills_scan_status27, true, false, $assessor_signed) . "</td>";?>
    </tr>

    <tr>
        <td>Internal and External quality procedures and the role of peer review</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Internal and External quality procedures and the role of peer review'] . "</td>"; ?>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status28", $ss_statuses, $form_arf->skills_scan_status28, true, false, $assessor_signed) . "</td>";?>
    </tr>

    <tr>
        <td>Organisational and legislative requirements for reporting concerns about quality and safeguarding</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Organisational and legislative requirements for reporting concerns about quality and safeguarding'] . "</td>"; ?>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status29", $ss_statuses, $form_arf->skills_scan_status29, true, false, $assessor_signed) . "</td>";?>
    </tr>

    <tr>
        <td>How to maintain occupational currency and ways to improve coaching and professional practice</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['How to maintain occupational currency and ways to improve coaching and professional practice'] . "</td>"; ?>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status30", $ss_statuses, $form_arf->skills_scan_status30, true, false, $assessor_signed) . "</td>";?>
    </tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr><td>Skills</td><td>Skills Scan Grade</td><td>Current Skills Scan Status</td></tr>
    <tr>
        <td>Facilitate access to relevant, current information advice and guidance (IAG)</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Facilitate access to relevant, current information advice and guidance (IAG)'] . "</td>"; ?>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . HTML::select("skills_scan_status1", $ss_statuses, $form_arf->skills_scan_status1, true, false, $assessor_signed) . "</td>";?>
    </tr>

    <tr>
        <td>Apply or reference relevant initial and diagnostic assessment</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Apply or reference relevant initial and diagnostic assessment'] . "</td>"; ?>
    ...
    <tr>
        <td>Agree a programme of development and assessment, setting realistic but challenging goals that meet learners and employers needs</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Agree a programme of development and assessment, setting realistic but challenging goals that meet learners and employers needs'] . "</td>"; ?>
    ...
    <tr>
        <td>Liaise with employers, colleagues and others to support learners development</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Liaise with employers, colleagues and others to support learners development'] . "</td>"; ?>
    ...
    <tr>
        <td>Anticipate and overcome barriers to progress and inspire achievement, ensuring that learning is inclusive and supports diversity</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Anticipate and overcome barriers to progress and inspire achievement, ensuring that learning is inclusive and supports diversity'] . "</td>"; ?>
    ...
    <tr>
        <td>Highlight learners mathematics and English needs, and signposts to appropriate support</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Highlight learners mathematics and English needs, and signposts to appropriate support'] . "</td>"; ?>
    ...
    <tr>
        <td>Give timely feedback on progress towards mastery of relevant skills and knowledge</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Give timely feedback on progress towards mastery of relevant skills and knowledge'] . "</td>"; ?>
    ...
    <tr>
        <td>Provide access to pastoral support and guidance</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Provide access to pastoral support and guidance'] . "</td>"; ?>
    ...
    <tr>
        <td>Promote the safe and effective use of digital and mobile technologies to support learners and the Assessor-Coach role</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Promote the safe and effective use of digital and mobile technologies to support learners and the Assessor-Coach role'] . "</td>"; ?>
    ...
    <tr>
        <td>Agree and record targets and progress, complying with quality, confidentiality and data protection requirements</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Agree and record targets and progress, complying with quality, confidentiality and data protection requirements'] . "</td>"; ?>
    ...
    <tr>
        <td>Use effective listening, assertiveness and questioning to support learners to engage with their learning plans and with assessment criteria and processes</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Use effective listening, assertiveness and questioning to support learners to engage with their learning plans and with assessment criteria and processes'] . "</td>"; ?>
    ...
    <tr>
        <td>Comply with awarding organisation requirements and local quality and safety guidelines</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Comply with awarding organisation requirements and local quality and safety guidelines'] . "</td>"; ?>
    ...
    <tr>
        <td>Support peer review and quality assurance procedures</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Support peer review and quality assurance procedures'] . "</td>"; ?>
    ...
    <tr>
        <td>Report concerns about quality and safeguarding through appropriate channels</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Report concerns about quality and safeguarding through appropriate channels'] . "</td>"; ?>
    ...
    <tr>
        <td>Maintain the currency of their own knowledge and skills, with reference to workplace practice and feedback from others</td>
        <?php echo "<td style='text-align:center; vertical-align:middle'>" . $tk_result['Maintain the currency of their own knowledge and skills, with reference to workplace practice and feedback from others'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    <thead>
    <th colspan=3>&nbsp;&nbsp;&nbsp;Attitudes & Behaviours</th>
    </thead>
    <tr><td>Attitudes & Behaviours</td><td>Skills Scan Grade</td><td>Current Skills Scan Status</td></tr>

    <tr>
        <td>Inspire, motivate and raise learners aspirations through their passion for the sector</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Inspire, motivate and raise learners aspirations through their passion for the sector'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Operate at all times to ethical and legal standards and within professional boundaries'] . "</td>"; ?>
    ...
    <tr>
        <td>Model and encourage mutual respect, displaying a deep understanding of equality and diversity, with and between learners, colleagues and appropriate agencies</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Model and encourage mutual respect, displaying a deep understanding of equality and diversity, with and between learners, colleagues and appropriate agencies'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Be resilient and adaptable when dealing with challenge and change, maintaining focus and self-control'] . "</td>"; ?>
    ...
    <tr>
        <td>Value the importance of maths, English and ICT skills in the learners future economic and social wellbeing</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Value the importance of maths, English and ICT skills in the learners future economic and social wellbeing'] . "</td>"; ?>
    ...
    <tr>
        <td>Evaluate and improve their own professional practice in relation to the Professional Standards for Teachers and Educators in the Education and Training Sector</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ab_result['Evaluate and improve their own professional practice in relation to the Professional Standards for Teachers and Educators in the Education and Training Sector'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    <thead>
    <th colspan=6>&nbsp;&nbsp;&nbsp;Progress Summary - Workplace Competence</th>
    </thead>
