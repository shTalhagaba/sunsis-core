...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php if(isset($Assessment_Plan['Business Environment'])) echo $Assessment_Plan['Business Environment']; else "&nbsp;" ?></td>
    ...
    <tr>
        ...
        <td>Good Practice</td>
        <td><?php if(isset($Assessment_Plan['Good Practice'])) echo $Assessment_Plan['Good Practice']; else "&nbsp;" ?></td>
    </tr>
    <tr>
        <td>Logic</td>
