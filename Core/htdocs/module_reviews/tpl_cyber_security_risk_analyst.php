...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php $workflow_management = isset($Assessment_Plan['Risk Analyst Activity 1'])?$Assessment_Plan['Risk Analyst Activity 1']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $workflow_management . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php $health_safety = isset($Assessment_Plan['Risk Analyst Activity 1'])?$Assessment_Plan['Risk Analyst Activity 1']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $health_safety . "</td>";?>
    </tr>
