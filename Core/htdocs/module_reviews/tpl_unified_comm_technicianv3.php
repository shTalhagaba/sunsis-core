...
<table class="table1" style="width: 900px">
    ...
    <!--<tr>
        <td>Installing</td>
        <td>Install and work with a variety of digital communications mediums as appropriate to the organisation</td>
        <?php //echo "<td style='text-align:center; vertical-align:middle'>" . $ss_result['Installing'] . "</td>"; ?>
        ...
        <?php //$communication = $this->isAssessmentComplete($Assessment_Plan, Array("Network Technical Support","Cabling","Installation")); echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $communication . "</td>";?>
    </tr>-->
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'9628-06 Networking and Architecture Test') . "<br>" . $this->getEventDate($events,'9628-06 Networking and Architecture Test') . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Cloud Fundamentals MTA') . "<br>" . $this->getEventDate($events,'Cloud Fundamentals MTA') . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Mobility and Devices MTA') . "<br>" . $this->getEventDate($events,'Mobility and Devices MTA') . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Cyber Security Introduction') . "<br>" . $this->getEventDate($events,'Cyber Security Introduction') . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Business Processes') . "<br>" . $this->getEventDate($events,'Business Processes') . "</td>";?>
    </tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Network Technical Support","Cabling","Installation")))
    ...
    <tr>
        ...
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Network Technical Support")))
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>Complete</td>";
    else
        echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>&nbsp;</td>";
        ?>
