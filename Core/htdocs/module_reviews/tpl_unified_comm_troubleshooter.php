...
<table class="table1" style="width: 900px">
    ...
    <tr><td colspan=1>Competence</td><td>Skills Scan Grade</td><td>Current Skill Scan Status</td><td>Assessment Plan Status</td></tr>
    <tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'BCS Award in Server Test') . "<br>" . $this->getEventDate($events,'BCS Award in Server Test') . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Network Security') . "<br>" . $this->getEventDate($events,'Network Security') . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Network Fundamentals MTA Test') . "<br>" . $this->getEventDate($events,'Network Fundamentals MTA Test') . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'BCS Award in Voice') . "<br>" . $this->getEventDate($events,'BCS Award in Voice') . "</td>";?>
    </tr>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $this->getEventStatus($events,'Data Solutions Test') . "<br>" . $this->getEventDate($events,'Data Solutions Test') . "</td>";?>
    </tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php   if($this->isAssessmentComplete($Assessment_Plan, Array("Voice Solutions","Data Solutions","Networks","Servers")))
