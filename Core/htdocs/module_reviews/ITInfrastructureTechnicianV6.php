<?php
class ITInfrastructureTechnicianV6
{

    public static function getSkillsScan($link, $form_arf, $review_id, $tr_id, $source, $ss_result, $tk_result, $ab_result, $Assessment_Plan, $ss_statuses, $events, $previous_review,$course_id = 0)
    {
        ...
        $html = "<table class=\"table1\" style=\"width: 900px\">
            ...
            <tr>
                ...
                <td rowspan=3 style='text-align:center'>" . (($previous_review->skills_scan_status1!="")?$sss[$previous_review->skills_scan_status1]:"") . "</td>
        ...
        $html .= "<td style='text-align:center; vertical-align:middle'>" . $health_safety . "</td>
            ...
            <tr>
                ...
                <td rowspan=2 style='text-align:center'>" . (($previous_review->skills_scan_status8!="")?$sss[$previous_review->skills_scan_status8]:"") . "</td>
        ...
        <table class=\"table1\" style=\"width: 900px\">
            ...
            <tr>
                ...
                <td rowspan=5 style='text-align:center'>" . (($previous_review->skills_scan_status9!="")?$sss[$previous_review->skills_scan_status9]:"") . "</td>
            ...
            <tr>
                ...
                <td rowspan=2 style='text-align:center'>" . (($previous_review->skills_scan_status10!="")?$sss[$previous_review->skills_scan_status10]:"") . "</td>
            ...
            <tr>
                ...
                <td rowspan=2 style='text-align:center'>" . (($previous_review->skills_scan_status13!="")?$sss[$previous_review->skills_scan_status13]:"") . "</td>
    ...
    <tbody><tr><td colspan=2>Project</td><td>Status</td></tr>";
    ...
    $html.= '<tr><td colspan=2 style="background-color: lightblue">Evidence % </td><td align=center style="background-color: lightblue">' . $per . '%</td></tr></tbody></table><br>';
...
;
    ...
    $html.= '<tbody><tr><td>Competency</td><td>Completed Criteria</td><td>Status</td></tr>';
    $total = 0;
    $gt=0;
    foreach($projects AS $project)
    {
        ...
        $html.= '<td>'. str_replace(",","<br>",$project['completed']) .'</td>';
        $html.= '<td align=center>' . $matrix . ' / ' . $project['total_criteria'] . '</td></tr>';
    }

    if(isset($project['total_criteria']))
    {
        $html.= '<tr><td style="background-color: lightgreen">Total</td><td style="background-color: lightgreen"></td><td align=center style="background-color: lightgreen">' . $total . ' / ' . $gt . '</td></tr>';
        $per = round($total/$gt*100);
    }
    else
    {
        $html.= '<tr><td style="background-color: lightgreen">Total</td><td style="background-color: lightgreen"></td><td align=center style="background-color: lightgreen">' . $total . ' / 0' . '</td></tr>';
        $per = round($total/1*100);
    }
    ...
    <tr>
        <td colspan=6><i>";
            if($source==1)
            $html.= '<textarea onblur="checkLength(event,this,3000)" onkeypress="checkLength(event,this,3000)" name="workplace_competence" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">'. $form_arf->workplace_competence.'</textarea>';
        else
            $html.= $form_arf->workplace_competence;
        $html.= "</i></td>
    </tr>
</tbody></table>
<br>";
