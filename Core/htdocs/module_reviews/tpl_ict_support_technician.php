...
<title>Learner On Programme Review ICT Support Technician</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Learner On Programme Review ICT Support Technician</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner On Programme ICT Support Technician</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=2>Maintain a safe working environment for own personal safety and others in line with Health & Safety appropriate to the task</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Maintain a safe working environment for own personal safety and others in line with Health & Safety appropriate to the task'] . "</td>"; ?>
        ...
        <?php $performance = isset($Assessment_Plan['Effective Business Operation'])?$Assessment_Plan['Effective Business Operation']:"&nbsp"; echo "<td style='text-align:center; vertical-align:middle'>" . $performance . "</td>";?>
    </tr>

    <tr>
        <td colspan=2>Identify and scope the best solution informed by the system data associated with the task</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Identify and scope the best solution informed by the system data associated with the task'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Test and evaluate the systems performance and compliance with customer requirement</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Test and evaluate the systems performance and compliance with customer requirement'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Escalate non routine problems in line with procedures</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Escalate non routine problems in line with procedures'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Use basic scripting to execute the relevant tasks for example PowerShell, Linux</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Use basic scripting to execute the relevant tasks for example PowerShell, Linux'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Carry out routine maintenance across systems, (such as IT, Communications), ensuring organisational compliance at all times</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Carry out routine maintenance across systems, (such as IT, Communications), ensuring organisational compliance at all times'] . "</td>"; ?>
    ...
    <tr>
        <td colspan=2>Apply the necessary security, in line with access and/or encryption requirements</td>
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $ss_result['Apply the necessary security, in line with access and/or encryption requirements'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Fundamental principles of operating systems, hardware system architectures and devices'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Principles of remote operation of devices including how to deploy and securely integrate mobile devices into a network'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Fundamental principles of peripherals for example: printers and scanners'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Principles of virtualisation of servers, applications and networks'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Principles of disaster recovery, how a disaster recovery plan works and their role within it'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Principles of Test Plans, their role and significance'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Fundamentals of purpose, creation and maintenance of asset registers'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Approaches to system upgrades and updates and their significance'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Approaches to interpretation of log files, event viewer and system tools'] . "</td>"; ?>
    ...
    <tr>
        ...
        <?php echo "<td rowspan=1 style='text-align:center; vertical-align:middle'>" . $tk_result['Basic elements of network infrastructure architectures including Wi-Fi and wired networks'] . "</td>"; ?>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td>Mobility and Devices</td>
        <td><?php echo $this->getEventStatus($events, "Mobility and Devices") . "<br>" . $this->getEventDate($events,'Mobility and Devices'); ?></td>
    ...
    <tr>
        ...
        <td>ICT Support Tech L3 Workshop 1</td>
        <td><?php echo $this->getEventStatus($events, "ICT Support Tech L3 Workshop 1") . "<br>" . $this->getEventDate($events,'ICT Support Tech L3 Workshop 1'); ?></td>
    </tr>
    <tr>
        <td>ICT Support Tech L3 Workshop 2</td>
        <td><?php echo $this->getEventStatus($events, "ICT Support Tech L3 Workshop 2") . "<br>" . $this->getEventDate($events,'ICT Support Tech L3 Workshop 2'); ?></td>
        <td>ICT Support Tech L3 Workshop 3</td>
        <td><?php echo $this->getEventStatus($events, "ICT Support Tech L3 Workshop 3") . "<br>" . $this->getEventDate($events,'ICT Support Tech L3 Workshop 3'); ?></td>
