<?php
class validate_ilr2012 implements IAction
{
	public function execute(PDO $link)
	{
		...
		{
			DAO::execute($link, "update ilr set is_valid = 1 where submission='$sub' and tr_id=$tr_id and contract_id=$contract_id");
            DAO::execute($link, "update tr set ilr_status = 1 where id=$tr_id");
			header("Content-Type: text/xml");
