<?php
class view_ia_report implements IAction
{
	public function execute(PDO $link)
	{
		...
		$_SESSION['bc']->index=0;
		$_SESSION['bc']->add($link, "do.php?_action=view_ia_report", "View Initial Assessment Report");

		$view = ViewIAReport::getInstance($link);
		...
		require_once('tpl_view_ia_report.php');
	}
