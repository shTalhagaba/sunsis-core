<?php
class ajax_get_student_elements implements IAction
{
	public function execute(PDO $link)
	{
		...
		$q = StudentQualificationElement::loadFromDatabase($link, $id, $qual_id, $fid, $tr_id);
		...
		{
			echo "<?xml version=\"1.0\" encoding=\"iso-8859-1\"?><error>No qualification found with id: $qual_id</error>";
		}
	}
