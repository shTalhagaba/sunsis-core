<?php
class ajax_get_student_qualification_xml implements IAction
{
	public function execute(PDO $link)
	{
		...
		$q = StudentQualification::loadFromDatabase($link, $qualification_id, $framework_id, $tr_id, $internaltitle);
		...
		{
			throw new Exception($qualification_id . "-" . $framework_id . "-" . $tr_id . "-" . $internaltitle);
			echo "<?xml version=\"1.0\" encoding=\"iso-8859-1\"?><error>No qualification found with id: $qualification_id</error>";
		}
	}
