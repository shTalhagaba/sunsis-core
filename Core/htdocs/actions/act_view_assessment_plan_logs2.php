<?php
class view_assessment_plan_logs2 implements IAction
{
    public function execute(PDO $link)
    {
        $view = ViewAssessmentPlanLogs2::getInstance($link);
        $subaction = isset($_REQUEST['subaction']) ? $_REQUEST['subaction'] : '';

        $view->refresh($link, $_REQUEST);

        $_SESSION['bc']->index=0;
        $_SESSION['bc']->add($link, "do.php?_action=view_assessment_plan_logs2", "View Assessment Plan Logs Report 2");
        ...
        require_once('tpl_view_assessment_plan_logs2.php');
    }
