<?php
class ajax_sr_classroom_region implements IAction
{
...
//		exit;
	...
	private function generateSuccessRates(PDO $link)
	{
		...
		$regions = DAO::getSingleColumn($link, "select distinct region from tbl_success_rates where region is not null and programme_type='Classroom'" . $this->username_where_clause);
		$regions[] = "All regions";
