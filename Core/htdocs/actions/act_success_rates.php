...
class success_rates implements IAction
{
    public function execute(PDO $link)
    {
        ...
        if(DB_NAME=="am_presentation" or DB_NAME=="am_demo")
        {
            return true;
        }
        ...
        {
            for($year = $current_contract_year; $year>= ($current_contract_year-5); $year--)
            {
                if($_SESSION['user']->isAdmin() OR $_SESSION['user']->type==12 OR $_SESSION['user']->type==3)
                {
                ...
                if($st)
                {
                    while($row = $st->fetch())
                    {
                        if($row['contract_year']<2012)
                        {
                            ...
                            {
                                if(((string)$ilr->programmeaim->A15!="99" && (string)$ilr->programmeaim->A15!="" && (string)$ilr->programmeaim->A15!="0"))
                                {
                                    $programme_type = "Apprenticeship";
                                    $start_date = Date::toMySQL((string)$ilr->programmeaim->A27);
                                    $end_date = Date::toMySQL((string)$ilr->programmeaim->A28);

                                    // Age Band Calculation
                                    if((string)$ilr->learnerinformation->L11!='00/00/0000' && (string)$ilr->learnerinformation->L11!='00000000')
                                    {
                                        $dob = (string)$ilr->learnerinformation->L11;
                                    ...
                                    if((string)$ilr->programmeaim->A31!='00000000' && (string)$ilr->programmeaim->A31!='00/00/0000' && (string)$ilr->programmeaim->A31!='')
                                        $actual_date = Date::toMySQL((string)$ilr->programmeaim->A31);
                                    else
                                        $actual_date = "0000-00-00";

                                    $comp_status = (string)$ilr->programmeaim->A34;
                                    $outcome = (string)$ilr->programmeaim->A35;
                                    if((string)$ilr->programmeaim->A40!='00000000' && (string)$ilr->programmeaim->A40!='00/00/0000' && (string)$ilr->programmeaim->A40!='')
                                        $achievement_date = Date::toMySQL((string)$ilr->programmeaim->A40);
                                    else
                                        $achievement_date = "0000-00-00";

                                    $level = (string)$ilr->programmeaim->A15;


                                    // Calculation for p_prog_status for apprenticeship only
                                    if((string)$ilr->programmeaim->A15=='2' || (string)$ilr->programmeaim->A15=='3' || (string)$ilr->programmeaim->A15=='10')
                                    {
                                        $p_prog_status = 7;
                                        ...
                                        if($achievement_date!='' && $achievement_date!='0000-00-00')
                                            $p_prog_status = 1;
                                        if($actual_date!='0000-00-00' && ((string)$ilr->programmeaim->A35==4 || (string)$ilr->programmeaim->A35==5) && (string)$achievement_date!='0000-00-00')
                                            $p_prog_status = 3;
                                        if((string)$ilr->aims[0]->A40!='00000000' && $actual_date!='0000-00-00' && $achievement_date=='0000-00-00')
                                            $p_prog_status = 4;
                                        if((string)$ilr->aims[0]->A40!='00000000' && $actual_date=='0000-00-00')
                                            $p_prog_status = 5;
                                        if((string)$ilr->aims[0]->A40=='00000000' && $actual_date!='0000-00-00' && $achievement_date=='0000-00-00')
                                            $p_prog_status = 6;
                                        if((string)$ilr->programmeaim->A34==3)
                                            $p_prog_status = 13;
                                        if((string)$ilr->programmeaim->A34==4 || (string)$ilr->programmeaim->A34==5)
                                            $p_prog_status = 8;
                                        if((string)$ilr->programmeaim->A50==2)
                                            $p_prog_status = 9;
                                        if((string)$ilr->programmeaim->A50==7)
                                            $p_prog_status = 10;
                                        if((string)$ilr->programmeaim->A34==6)
                                            $p_prog_status = 11;
                                        if(((string)$ilr->programmeaim->A40!='00000000' || (string)$ilr->programmeaim->A40!='') && (string)$ilr->programmeaim->A34==6)
                                            $p_prog_status = 12;

                                    }

                                    $a23 = (string)$ilr->programmeaim->A23;
                                    ...
                                    $a26 = (string)$ilr->programmeaim->A26;
                                    $a09 = (string)$ilr->aims[0]->A09;

                                    $ukprn = (string)$ilr->aims[0]->A22;
                                    ...
                                    $ethnicity = (string)$ilr->learnerinformation->L12;
                                    $lldd = (string)$ilr->learnerinformation->L14;
                                    $gender = (string)$ilr->learnerinformation->L13;
                                    if((string)$ilr->programmeaim->A16=='08' or (string)$ilr->programmeaim->A16=='11')
                                        $restart=1;
                                    else
                                        $restart=0;
                                ...
                                else
                                {
                                    ...
                                    for($a = 0; $a<=$ilr->subaims; $a++)
                                    {
                                        ...
                                        if( ((string)$ilr->aims[$a]->A10=='45' || (string)$ilr->aims[$a]->A10=='46' || (string)$ilr->aims[$a]->A10=='60') && ((string)$ilr->aims[$a]->A15!='2' && (string)$ilr->aims[$a]->A15!='3' && (string)$ilr->aims[$a]->A15!='10') && ((string)$ilr->aims[$a]->A46a!='83' && (string)$ilr->aims[$a]->A46b!='83'))
                                        {

                                            // Age Band Calculation
                                            if(((string)$ilr->aims[$a]->A18=='24' || (string)$ilr->aims[$a]->A18=='23' || (string)$ilr->aims[$a]->A18=='22') && (string)$ilr->aims[$a]->A46a!='125')
                                                $programme_type = "Workplace";
                                            elseif((string)$ilr->aims[$a]->A18=='1' || (string)$ilr->aims[$a]->A46a=='125')
                                                $programme_type = "Classroom";
                                            else
                                                $programme_type = "Unknown";
                                            $start_date = Date::toMySQL((string)$ilr->aims[$a]->A27);
                                            $end_date = Date::toMySQL((string)$ilr->aims[$a]->A28);

                                            if((string)$ilr->learnerinformation->L11!='00/00/0000')
                                            {
                                                $dob = (string)$ilr->learnerinformation->L11;
                                                $dob = Date::toMySQL($dob);
                                                $age = DAO::getSingleValue($link, "SELECT DATE_FORMAT(FROM_DAYS(TO_DAYS('$start_date')-TO_DAYS('$dob')), '%Y')+0");
                                            ...
                                            if((string)$ilr->aims[$a]->A31!='00000000' && (string)$ilr->aims[$a]->A31!='00/00/0000' && (string)$ilr->aims[$a]->A31!='')
                                                $actual_date = Date::toMySQL($ilr->aims[$a]->A31);
                                            else
                                                $actual_date = "0000-00-00";

                                            $comp_status = (string)$ilr->aims[$a]->A34;
                                            $outcome = (string)$ilr->aims[$a]->A35;

                                            if((string)$ilr->aims[$a]->A40!='00000000' && (string)$ilr->aims[$a]->A40!='00/00/0000' && (string)$ilr->aims[$a]->A40!='')
                                                $achievement_date = Date::toMySQL((string)$ilr->aims[$a]->A40);
                                            else
                                                $achievement_date = "0000-00-00";

                                            $level = (string)$ilr->aims[$a]->A15;
                                            $a09 = (string)$ilr->aims[$a]->A09;
                                            ...
                                            if($achievement_date!='0000-00-00')
                                                $p_prog_status = 1;
                                            if($actual_date!='0000-00-00' && ((string)$ilr->aims[$a]->A35==4 || (string)$ilr->aims[$a]->A35==5) && (string)$achievement_date=='0000-00-00')
                                                $p_prog_status = 3;
                                            if($actual_date!='0000-00-00' && $achievement_date=='0000-00-00')
                                                $p_prog_status = 6;
                                            if((string)$ilr->aims[$a]->A34==3)
                                                $p_prog_status = 13;
                                            if((string)$ilr->aims[$a]->A34==4 || (string)$ilr->aims[$a]->A34==5)
                                                $p_prog_status = 8;
                                            if((string)$ilr->aims[$a]->A50==2)
                                                $p_prog_status = 9;
                                            if((string)$ilr->aims[$a]->A50==7)
                                                $p_prog_status = 10;
                                            if((string)$ilr->aims[$a]->A34==6)
                                                $p_prog_status = 11;
                                            ...
                                            $a09 = (string)$ilr->aims[0]->A09;
                                            $a26 = (string)$ilr->aims[0]->A26;


                                            $ukprn = (string)$ilr->aims[$a]->A22;
                                            if($ukprn!='' && $ukprn!='00000000' && $ukprn!='        ')
                                            {
                                                $provider = DAO::getSingleValue($link, "select legal_name from organisations where ukprn = '$ukprn'");
                                            }
                                            ...
                                            $lldd = (string)$ilr->learnerinformation->L14;
                                            $gender = (string)$ilr->learnerinformation->L13;
                                            if((string)$ilr->aims[$a]->A16=='08' or (string)$ilr->aims[$a]->A16=='11')
                                                $restart=1;
                                            else
                                                $restart=0;
                        ...
                        elseif($row['contract_year']>=2012)
                        {
                            ...
                            {
                                $WithdrawReason = (string)$delivery->WithdrawReason;
                                if((string)$delivery->AimType==1 && (string)$delivery->ProgType!='99' && (string)$delivery->ProgType!='24' && ((string)$delivery->ProgType)!='' && $WithdrawReason!='40' && (string)$delivery->FundModel!='99')
                                {
                                    if((string)$delivery->ProgType=='24')
                                        $programme_type = "Traineeship";
                                    else
                                        $programme_type = "Apprenticeship";
                                    $a26 = (string)$delivery->FworkCode;
                                    $StdCode = (string)$delivery->StdCode;
                                    $PwayCode = (string)$delivery->PwayCode;
                                    $EmpOutcome = (string)$delivery->EmpOutcome;
                                    ...
                                    $LearnActEndDate = (string)$delivery->LearnActEndDate;
                                    if($LearnActEndDate!='00000000' && $LearnActEndDate!='00/00/0000' && $LearnActEndDate!='')
                                        $actual_date = Date::toMySQL($LearnActEndDate);
                                    else
                                        $actual_date = "0000-00-00";

                                    $comp_status = (string)$delivery->CompStatus;
                                    $outcome = (string)$delivery->Outcome;
                                    $AchDate = (string)$delivery->AchDate;
                                    if($AchDate!='00000000' && $AchDate!='00/00/0000' && $AchDate!='')
                                        $achievement_date = Date::toMySQL($AchDate);
                                    else
                                        $achievement_date = "0000-00-00";

                                    $level = (string)$delivery->ProgType;

                                    // Calculation for p_prog_status for apprenticeship only
                                    if((string)$delivery->ProgType=='2' || (string)$delivery->ProgType=='3' || (string)$delivery->ProgType=='10' || (string)$delivery->ProgType=='20' || (string)$delivery->ProgType=='24' || (string)$delivery->ProgType=='25')
                                    {
                                        $p_prog_status = 7;
                                        if($actual_date=='0000-00-00')
                                            $p_prog_status = 0;
                                        if($achievement_date!='' && $achievement_date!='0000-00-00')
                                            $p_prog_status = 1;
                                        if($actual_date!='0000-00-00' && ((string)$delivery->Outcome=='4' || (string)$delivery->Outcome=='5') && $achievement_date!='0000-00-00')
                                            $p_prog_status = 3;
                                        if((string)$delivery->CompStatus=='2' && (string)$delivery->Outcome=='1')
                                            $p_prog_status = 1;
                                        ...
                                        if($achievement_date!='0000-00-00' && $actual_date!='0000-00-00' && $achievement_date=='0000-00-00')
                                            $p_prog_status = 6;
                                        if((string)$delivery->CompStatus=='3')
                                            $p_prog_status = 13;
                                        if((string)$delivery->CompStatus==4 || (string)$delivery->CompStatus==5)
                                            $p_prog_status = 8;
                                        if((string)$delivery->WithdrawReason==2)
                                            $p_prog_status = 9;
                                        if((string)$delivery->WithdrawReason==7)
                                            $p_prog_status = 10;
                                        if((string)$delivery->CompStatus==6)
                                            $p_prog_status = 11;
                                        if( ((string)$delivery->AchDate!='00000000' || (string)$delivery->AchDate!='') && (string)$delivery->CompStatus==6)
                                            $p_prog_status = 12;
                                    }
                                    $a23 = (string)$delivery->DelLocPostCode;
                                    $local_authority = DAO::getSingleValue($link, "select local_authority from central.lookup_postcode_la where postcode='$a23' limit 0,1");
                                    /*if($local_authority=='')
                                    {
                                        $postcode = str_replace(" ","",$a23);
                                    ...
                                    $lldd = (string)$ilr->LLDDHealthProb;
                                    $gender = (string)$ilr->Sex;

                                    $restart = 0;
                                    foreach($delivery->LearningDeliveryFAM as $ldf)
                                    {
                                        if((string)$ldf->LearnDelFAMType=='RES' and (string)$ldf->LearnDelFAMCode='1')
                                            $restart = 1;
                                    }
                                    $d = array();
                                    $d['l03'] = $l03;
                                ...
                                {
                                    if((string)$delivery->AimType!='1' && (string)$delivery->ProgType!='25' && (string)$delivery->ProgType!='25' && (string)$delivery->ProgType!='2' && (string)$delivery->ProgType!='3' && (string)$delivery->ProgType!='20' && (string)$delivery->ProgType!='21' && (string)$delivery->ProgType!='22'&& (string)$delivery->ProgType!='23' && (string)$delivery->StdCode=='')
                                    {
                                        if(DB_NAME=='am_baltic' && (string)$delivery->FundModel=='99')
                                            continue;
                                        if($row['contract_year']<2013)
                                        {
                                            ...
                                            foreach($delivery->LearningDeliveryFAM as $ldf)
                                            {
                                                if((string)$ldf->LearnDelFAMType=='LDM')
                                                    if((string)$ldf->LearnDelFAMCode=='125')
                                                        $ldm = 'Classroom';
                                            }
                                        ...
                                        else
                                        {
                                            ...
                                            foreach($delivery->LearningDeliveryFAM as $ldf)
                                            {
                                                if((string)$ldf->LearnDelFAMType=='WPL')
                                                    if((string)$ldf->LearnDelFAMCode=='1')
                                                        $ldm = 'Workplace';
                                            }

                                            if((string)$delivery->ProgType=='24')
                                                $programme_type = "Traineeship";
                                            elseif((string)$ldm=='Workplace')
                                                $programme_type = "Workplace";
                                            else
                                                $programme_type = "Classroom";
                                        ...
                                        $level = (string)$delivery->ProgType;
                                        $a09 = (string)$delivery->LearnAimRef;
                                        $a09 = "";
                                        $Outcome = (string)$delivery->Outcome;
                                        // Calculation for p_prog_status for apprenticeship only
                                        $p_prog_status = -1;
                                        ...
                                        $ukprn = (string)$delivery->PartnerUKPRN;
                                        if($ukprn!='' && $ukprn!='00000000' && $ukprn!='        ')
                                        {
                                            $provider = DAO::getSingleValue($link, "select legal_name from organisations where ukprn = '$ukprn'");
                                        }
...
*/
    ...
    public function createTempTable(PDO $link)
    {
        ...
        $sql = <<<HEREDOC
CREATE TEMPORARY TABLE IF NOT EXISTS `success_rates` (
