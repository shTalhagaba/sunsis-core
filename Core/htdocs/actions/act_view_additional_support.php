<?php
class view_additional_support implements IAction
{
    public function execute(PDO $link)
    {
        $view = ViewAdditionalSupport::getInstance($link);
        $subaction = isset($_REQUEST['subaction']) ? $_REQUEST['subaction'] : '';

        $view->refresh($link, $_REQUEST);

        $_SESSION['bc']->index=0;
        $_SESSION['bc']->add($link, "do.php?_action=view_additional_support", "View Additional Support Report");
        ...
        require_once('tpl_view_additional_support.php');
    }
