<?php
class view_co_investment implements IAction
{
    public function execute(PDO $link)
    {
        $view = ViewCoInvestment::getInstance($link);
        $subaction = isset($_REQUEST['subaction']) ? $_REQUEST['subaction'] : '';

        $view->refresh($link, $_REQUEST);

        $_SESSION['bc']->index = 0;
        $_SESSION['bc']->add($link, "do.php?_action=view_co_investment", "View Co Investment");
        ...
        require_once('tpl_view_co_investment.php');
    }
