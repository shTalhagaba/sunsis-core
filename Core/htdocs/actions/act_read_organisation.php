<?php
class read_organisation implements IAction
{
	public function execute(PDO $link)
	{
		...
		// Presentation
		include('tpl_read_organisation.php');
	}
	

	private function renderLocations(PDO $link, Organisation $vo)
	{
	...
	private function renderPersonnel(PDO $link, Organisation $vo)
	{
	...
	private function renderLearners(PDO $link, Organisation $vo)
	{
