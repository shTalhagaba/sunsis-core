<?php
class view_emails implements IAction
{
    public function execute(PDO $link)
    {
        $view = ViewEmails::getInstance($link);
        $subaction = isset($_REQUEST['subaction']) ? $_REQUEST['subaction'] : '';

        $view->refresh($link, $_REQUEST);

        $_SESSION['bc']->index=0;
        $_SESSION['bc']->add($link, "do.php?_action=view_emails", "View Emails");
        ...
        require_once('tpl_view_emails.php');
    }
