<?php
class edit_client implements IAction
{
	public function execute(PDO $link)
	{
		...
		if($vo->id == 0)
		{
			$js_cancel = "window.location.replace('do.php?_action=view_clients');";
		}
		else
		{
			$js_cancel = "window.location.replace('do.php?_action=read_client&id={$vo->id}');";
		}		
