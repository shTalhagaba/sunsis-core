<?php
class test_invoice3 implements IAction
{
    public function execute(PDO $link)
    {
        ...
        $pdf = new FPDI();
        $pagecount = $pdf->setSourceFile('invoice2.pdf');
        ...
        $pdf->Text(150,65, ("Invoice No:".$vo->invoice));

        $pdf->Text(65,78,Date::toMedium($vo->sales_date));
        $pdf->Text(65,84,$p->reg_mark);
        $pdf->Text(65,90,$make . ', ' . $model);
        $pdf->Text(65,96,$p->mileage);
//        $pdf->Text(65,106,$chassis);
        $pdf->Text(65,108,$vo->c_name);
        $pdf->Text(65,114,$vo->c_address);
        //$pdf->Text(65,125,$vo->c_phone);
