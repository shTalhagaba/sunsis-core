<?php
class view_employer_contact implements IAction
{
    public function execute(PDO $link)
    {
        $view = ViewEmployerContact::getInstance($link);
        $subaction = isset($_REQUEST['subaction']) ? $_REQUEST['subaction'] : '';

        $view->refresh($link, $_REQUEST);

        $_SESSION['bc']->index = 0;
        $_SESSION['bc']->add($link, "do.php?_action=view_employer_contact", "View Employer Contact");
        ...
        require_once('tpl_view_employer_contact.php');
    }
