<?php
class validate_ilr0809 implements IAction
{
	public function execute(PDO $link)
	{
		...
		$ilr = Ilr2008::loadFromXML($xml);
		$validator = new ValidateILR0809();
		...
		*/
		...
		else
		{
			...
			$sql = "update ilr set is_valid = 1 where submission='$sub' and tr_id=$tr_id and L03='$qan' and contract_id=$contract_id";
			DAO::execute($link, $sql);
			header("Content-Type: text/xml");
