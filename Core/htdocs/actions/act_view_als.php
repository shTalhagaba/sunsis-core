<?php
class view_als implements IAction
{
    public function execute(PDO $link)
    {
        ...
        $_SESSION['bc']->index=0;
        $_SESSION['bc']->add($link, "do.php?_action=view_als", "View ALS Reports");

        $view = ViewALSReports::getInstance($link);
        $view->refresh($link, $_REQUEST);

        require_once('tpl_view_als.php');
    }
}
?>