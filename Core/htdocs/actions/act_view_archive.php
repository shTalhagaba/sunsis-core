<?php
class view_archive implements IAction
{
    public function execute(PDO $link)
    {
        $view = ViewArchives::getInstance($link);
        $subaction = isset($_REQUEST['subaction']) ? $_REQUEST['subaction'] : '';

        $view->refresh($link, $_REQUEST);

        $_SESSION['bc']->index=0;
        $_SESSION['bc']->add($link, "do.php?_action=view_archive", "View Archive");
        ...
        require_once('tpl_view_archive.php');
    }
