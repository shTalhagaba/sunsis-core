<?php
class view_learning_difficulty_graph implements IAction
{
	public function execute(PDO $link)
	{
		
		$view = ViewLearningDifficultyGraph::getInstance();
		...
		require_once('tpl_view_learning_difficulty_graph.php');
	}
