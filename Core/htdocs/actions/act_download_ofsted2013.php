...
class download_ofsted2013 implements IAction
{
...
WHERE locate('Unfunded',contracts.title)=0 and (tr.closure_date >= '2012-08-01' OR tr.`closure_date` IS NULL) AND contracts.`contract_holder` IN (SELECT id FROM organisations WHERE organisation_type = 4 AND ukprn IN (SELECT ukprn FROM organisations WHERE organisation_type = 1));
HEREDOC;
        } else {
            $sql = <<<HEREDOC
SELECT
...
HEREDOC;
                ...
                if ($ilr->learnerinformation->L08 != "Y") {
                    ...
                    foreach ($ilr->LearningDelivery as $delivery) {
                        if ($delivery->AimType == 1 && $delivery->ProgType != '99' && ("" . $delivery->ProgType) != '') {
                            ...
                            if (($delivery->AimType == 4 || $delivery->AimType == 5) && $delivery->FundModel != '99' && $delivery->FundModel != '') {
        ...
        DAO::execute($link, "update ofsted INNER JOIN lad201314.all_annual_values on all_annual_values.LEARNING_AIM_REF = ofsted.a09 INNER JOIN lad201314.ssa_tier1_codes on ssa_tier1_codes.SSA_TIER1_CODE = all_annual_values.SSA_TIER1_CODE set ssa1 = CONCAT(lad201314.ssa_tier1_codes.SSA_TIER1_CODE,' ',lad201314.ssa_tier1_codes.SSA_TIER1_DESC)");
        DAO::execute($link, "UPDATE ofsted INNER JOIN lad201314.all_annual_values ON all_annual_values.LEARNING_AIM_REF = ofsted.a09 INNER JOIN lad201314.ssa_tier2_codes ON ssa_tier2_codes.SSA_TIER2_CODE = all_annual_values.SSA_TIER2_CODE SET ssa2 = CONCAT(lad201314.ssa_tier2_codes.SSA_TIER2_CODE,' ',lad201314.ssa_tier2_codes.SSA_TIER2_DESC);");

        DAO::execute($link, "update ofsted set ssa1 = '14 Preparation for Life and Work', ssa2='14.2 Preparation for Work' where programme_type='Classroom'");

        DAO::execute($link, "Drop table IF EXISTS ofsted2;");
        DAO::execute($link, "create table ofsted2 select * from ofsted");

        $m1 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted where programme_type='Apprenticeship' AND start_date < '2013-08-01';");
        $m2 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted where programme_type!='Apprenticeship' AND start_date < '2013-08-01';");
        $m3 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted WHERE LEVEL <= 1 AND (age_band = '14-16' OR age_band = '16-18') AND programme_type != 'Apprenticeship' AND start_date < '2014-08-01';");
        $m4 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted WHERE LEVEL <= 1 AND (age_band = '19-24' OR age_band = '25+') AND programme_type != 'Apprenticeship' AND start_date < '2014-08-01';");
        $m5 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted WHERE LEVEL = 2 AND (age_band = '14-16' OR age_band = '16-18') AND programme_type != 'Apprenticeship' AND start_date < '2014-08-01';");
        $m6 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted WHERE LEVEL = 2 AND (age_band = '19-24' OR age_band = '25+') AND programme_type != 'Apprenticeship' AND start_date < '2014-08-01';");
        $m7 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted WHERE LEVEL = 3 AND (age_band = '14-16' OR age_band = '16-18') AND programme_type != 'Apprenticeship' AND start_date < '2014-08-01';");
        $m8 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted WHERE LEVEL = 3 AND (age_band = '19-24' OR age_band = '25+') AND programme_type != 'Apprenticeship' AND start_date < '2014-08-01';");
        $m9 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted WHERE LEVEL >= 4 AND (age_band = '14-16' OR age_band = '16-18') AND programme_type != 'Apprenticeship' AND start_date < '2014-08-01';");
        $m10 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted WHERE LEVEL >= 4 AND (age_band = '19-24' OR age_band = '25+') AND programme_type != 'Apprenticeship' AND start_date < '2014-08-01';");
        $m11 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted WHERE LEVEL = 3 AND (age_band = '14-16' OR age_band = '16-18') AND programme_type = 'Apprenticeship' AND start_date < '2014-08-01';");
        $m12 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted WHERE LEVEL = 3 AND (age_band = '19-24' OR age_band = '25+') AND programme_type = 'Apprenticeship' AND start_date < '2014-08-01';");
        $m13 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted WHERE LEVEL = 2 AND (age_band = '14-16' OR age_band = '16-18') AND programme_type = 'Apprenticeship' AND start_date < '2014-08-01';");
        $m14 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted WHERE LEVEL = 2 AND (age_band = '19-24' OR age_band = '25+') AND programme_type = 'Apprenticeship' AND start_date < '2014-08-01';");
        $m15 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted WHERE LEVEL > 3 AND (age_band = '14-16' OR age_band = '16-18') AND programme_type = 'Apprenticeship' AND start_date < '2014-08-01';");
        $m16 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted WHERE LEVEL > 3 AND (age_band = '19-24' OR age_band = '25+') AND programme_type = 'Apprenticeship' AND start_date < '2014-08-01';");
        $m17 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted WHERE locate('PETP',contract_title)>1 or locate('BRS',contract_title)>1 AND start_date < '2014-08-01'");
        $m18 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted WHERE programme_type = 'Traineeship' AND start_date < '2014-08-01' and age_band='16-18';");
        $m19 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted WHERE programme_type = 'Traineeship' AND start_date < '2014-08-01' and age_band='19-24';");
        ...
        $n9 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted WHERE LEVEL >= 4 AND (age_band = '14-16' OR age_band = '16-18') AND programme_type != 'Apprenticeship' AND actual_end_date IS NULL;");
        $n10 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted WHERE LEVEL >= 4 AND (age_band = '19-24' OR age_band = '25+') AND programme_type != 'Apprenticeship' AND actual_end_date IS NULL;");
        ...
        $n15 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted WHERE LEVEL > 3 AND (age_band = '14-16' OR age_band = '16-18') AND programme_type = 'Apprenticeship' AND actual_end_date IS NULL;");
        $n16 = DAO::getSingleValue($link, "SELECT COUNT(DISTINCT l03) FROM ofsted WHERE LEVEL > 3 AND (age_band = '19-24' OR age_band = '25+') AND programme_type = 'Apprenticeship' AND actual_end_date IS NULL;");
        ...
        //mkdir("../uploads/am_lcurve/ofsted");
...
HEREDOC;
        ...
        DAO::execute($link, "update success_rates set ssa1 = '14 Preparation for Life and Work', ssa2='14.2 Preparation for Work' where programme_type='Classroom'");
...
HEREDOC;
        ...
        // Populate PDF
        $pdf = new FPDI();
        $pagecount = $pdf->setSourceFile('ofsted2013.pdf');
        ...
        $pdf->Text(161, 145, $m8);
        $pdf->Text(175, 145, $m9);
        $pdf->Text(188, 145, $m10);
        $pdf->Text(100, 165, $m11);
        $pdf->Text(115, 165, $m12);
        $pdf->Text(132, 165, $m13);
        $pdf->Text(148, 165, $m14);
        $pdf->Text(167, 165, $m15);
        $pdf->Text(183, 165, $m16);
        //$pdf->Text(132,199,$m17);
        $pdf->Text(110, 180, $m18);
        $pdf->Text(148, 180, $m19);
        ...
        $ssas = DAO::getResultSet($link, "SELECT DISTINCT ssa1 FROM success_rates WHERE programme_type = 'Classroom';");
        foreach ($ssas as $ssa) {
...
, COUNT(IF(start_date>='2013-08-01' AND start_date<='2014-07-31',1,NULL)) AS y2013
 FROM success_rates WHERE programme_type = 'Classroom' and ssa1 = '$s' GROUP BY a09  ORDER BY COUNT(a09) DESC LIMIT 0,10");
            $index = 0;
        ...
        $stlast = $link->query("SELECT DISTINCT ssa2,programme_type,a09 FROM ofsted2 WHERE actual_end_date IS NULL ORDER BY ssa2,programme_type;");
        $index = 0;
        while ($rowlast = $stlast->fetch()) {
            ...
            $pdf->Text($col + 62, $row, substr($rowlast[2], 0, 15));
            $a09 = $rowlast[2];
            $ptype = $rowlast[1];
            if ($ptype == 'Traineeship') {
                $t = DAO::getSingleValue($link, "select count(distinct l03) from ofsted2 where actual_end_date IS NULL  and a09 = '$a09' and programme_type = '$ptype'");
                $pdf->Text($col + 112, $row, substr($t, 0, 15));
            } elseif ($ptype == 'Apprenticeship' or $ptype == 'Classroom' or $ptype == 'Workplace') {
                $app1 = DAO::getSingleValue($link, "select count(distinct l03) from ofsted2 WHERE actual_end_date IS NULL and a09 = '$a09' and programme_type = '$ptype' and level = 1");
                $pdf->Text($col + 126, $row, substr($app1, 0, 15));
                $app2 = DAO::getSingleValue($link, "select count(distinct l03) from ofsted2 where actual_end_date IS NULL and a09 = '$a09' and programme_type = '$ptype' and level = 3");
                $pdf->Text($col + 137, $row, substr($app2, 0, 15));
                $app3 = DAO::getSingleValue($link, "select count(distinct l03) from ofsted2 where actual_end_date IS NULL and a09 = '$a09' and programme_type = '$ptype' and level = 2");
                $pdf->Text($col + 148, $row, substr($app3, 0, 15));
                $app4 = DAO::getSingleValue($link, "select count(distinct l03) from ofsted2 where actual_end_date IS NULL and a09 = '$a09' and programme_type = '$ptype' and level = 20");
                $pdf->Text($col + 159, $row, substr($app4, 0, 15));
            }
        ...
        /*
        $ssas = DAO::getResultSet($link, "SELECT DISTINCT ssa1 FROM success_rates WHERE programme_type = 'Workplace';");
        foreach($ssas as $ssa)
        {
...
, COUNT(IF(start_date>='2012-08-01' AND start_date<='2013-07-31',1,NULL)) AS y2012
, COUNT(IF(start_date>='2013-08-01' AND start_date<='2014-07-31',1,NULL)) AS y2013
 FROM success_rates WHERE programme_type = 'Workplace' and ssa1 = '$s' GROUP BY a09  ORDER BY COUNT(a09) DESC LIMIT 0,10");
            $index = 0;
            foreach($quals as $qual)
            {
                $index++;
                ...
                $a09  = $qual[0];
                $overallrate2010 = 0;
                $overallachievers = $this->getOverallAchievers($link, "2010", "Workplace", "", "", "", $s,"","","","","",""," and a09 = '$a09'");
                $overallleavers = $this->getOverallLeaver($link, "2010", "Workplace", "", "", "", $s,"","","","","","","  and a09 = '$a09'");
                if($overallleavers!=0)
                {
                    $overallrate2010 = ($overallachievers / $overallleavers * 100);
                }
                $overallrate2011 = 0;
                $overallachievers = $this->getOverallAchievers($link, "2011", "Workplace", "", "", "", $s,"","","","","",""," and a09 = '$a09'");
                $overallleavers = $this->getOverallLeaver($link, "2011", "Workplace", "", "", "", $s,"","","","","","","  and a09 = '$a09'");
                if($overallleavers!=0)
                {
                    $overallrate2011 = ($overallachievers / $overallleavers * 100);
                }
                $overallrate2012 = 0;
                $overallachievers = $this->getOverallAchievers($link, "2012", "Workplace", "", "", "", $s,"","","","","",""," and a09 = '$a09'");
                $overallleavers = $this->getOverallLeaver($link, "2012", "Workplace", "", "", "", $s,"","","","","","","  and a09 = '$a09'");
                if($overallleavers!=0)
                {
                    $overallrate2012 = ($overallachievers / $overallleavers * 100);
                }
                $overallrate2013 = 0;
                $overallachievers = $this->getOverallAchievers($link, "2013", "Workplace", "", "", "", $s,"","","","","",""," and a09 = '$a09'");
                $overallleavers = $this->getOverallLeaver($link, "2013", "Workplace", "", "", "", $s,"","","","","","","  and a09 = '$a09'");
                if($overallleavers!=0)
                {
                    $overallrate2013 = ($overallachievers / $overallleavers * 100);
                }
