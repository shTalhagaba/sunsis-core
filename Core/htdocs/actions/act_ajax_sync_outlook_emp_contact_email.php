<?php
class ajax_sync_outlook_emp_contact_email implements IAction
{
...
//throw new Exception("SELECT id FROM candidate_email_notes WHERE org_id = " . $vo->org_id . " AND sender_name = '" . $vo->sender_name . "'" . " AND sender_email = '" . $vo->sender_email . "'" . " AND receiver_name = '" . $vo->receiver_name . "'" . " AND receiver_email = '" . $vo->receiver_email . "'" . " AND date_sent = '" . $vo->date_sent . "'" . " AND time_sent = '" . $vo->time_sent . "'" . " AND subject = '" . $vo->subject . "'" . " AND sent_from_sunesis = '" . $vo->sent_from_sunesis . "'");
			$newEmail = DAO::getSingleValue($link, "SELECT id FROM employer_contact_email_notes WHERE org_id = " . $vo->org_id . " AND sender_name = '" . $vo->sender_name . "'" . " AND sender_email = '" . $vo->sender_email . "'" . " AND receiver_name = '" . $vo->receiver_name . "'" . " AND receiver_email = '" . $vo->receiver_email . "'" . " AND date_sent = '" . $vo->date_sent . "'" . " AND time_sent = '" . $vo->time_sent . "'" . " AND subject = '" . $vo->subject . "'" . " AND sent_from_sunesis = '" . $vo->sent_from_sunesis . "'");
