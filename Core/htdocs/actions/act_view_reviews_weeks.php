<?php
class view_reviews_weeks implements IAction
{
    public function execute(PDO $link)
    {
        $view = ViewReviewsWeeks::getInstance($link);
        $subaction = isset($_REQUEST['subaction']) ? $_REQUEST['subaction'] : '';

        $view->refresh($link, $_REQUEST);

        $_SESSION['bc']->index=0;
        $_SESSION['bc']->add($link, "do.php?_action=view_reviews_weeks", "View Reviews Weeks");
        ...
        require_once('tpl_view_reviews_weeks.php');
    }
