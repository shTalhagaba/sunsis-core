<?php
class ilr0809_pdf implements IAction
{
	public function execute(PDO $link)
	{
		...
		$vo = Ilr2008::loadFromDatabase($link, $submission, $contract_id, $tr_id);
		...
		if($submission!='W01')
		{
			...
			$previous_vo = Ilr2008::loadFromDatabase($link, $previous_submission, $contract_id, $tr_id);
		...
		$L44_dropdown = "SELECT Code, LEFT(CONCAT(Code,' ', Name),50),null from LSC order by Code;";
		...
		if($pdf==1)
			require_once('tpl_ilr0809_pdf.php');
		else
