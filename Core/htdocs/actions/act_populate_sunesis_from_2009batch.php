<?php
class populate_sunesis_from_2009batch implements IAction
{
...
//		$handle = fopen("lw.w13","r");		
		...
		while(!feof($handle))
		{
			...
			if($a04=='10')
			{
				...
				$l15 = substr($st,99,2);
				$l16 = substr($st,101,2);
				$l17 = addslashes(substr($st,103,8));
				$l18 = addslashes(substr($st,111,30));
				$l19 = addslashes(substr($st,141,30));
				$l20 = addslashes(substr($st,171,30));
				...
				$sql = "insert into learner values('0','$l01','$l02','$l03','$l04','$l05','$l07','$l08','$l09','$l10',$l11,'$l12','$l13','$l14','$l15','$l16','$l17','$l18','$l19','$l20','$l21','$l22','$l23','$l24','$l25','$l26','$l27','$l28a','$l28b','$l29','$l31','$l32','$l33','$l34a','$l34b','$l34c','$l34d','$l35','$l36','$l37','$l39','$l40a','$l40b','$l41a','$l41b','$l42a','$l42b','$l44','$l45','$l46','$l47',$l48,'$l49a','$l49b','$l49c','$l49d','0','0',0,0,0);";
			...
			elseif($a04=='35' || $a04=='30')
			{
				...
				$sql = "insert into aim values('0','$a01','$a02','$a03','$a04','$a05','$a07','$a08','$a09','$a10','$a11a','$a11b','$a13','$a14','$a15','$a16','$a17','$a18','$a19','$a20','$a21','$a22','$a23','$a26','$a27','$a28',$a31,'$a32','$a34','$a35','$a36',$a40,'$a44','$a45','$a46a','$a46b','$a47a','$a47b','$a48a','$a48b','$a49','$a50','$a51a','$a52','$a53','$a54','$a55','$a56','$a57','$a58','$a59','$a60','$a61','$a62','$a63','$a64','$a65','$a66','$a67','$a68','0','','0','','');";
...
//				$emp_id = DAO::getSingleValue($link, "SELECT organisations.id FROM organisations INNER JOIN locations ON locations.organisations_id = organisations.id WHERE CONCAT(organisations.legal_name,locations.postcode) = '$a4445'");
		...
		// Create training records and ILRs;
			$sql = <<<HEREDOC
		SELECT DISTINCT L03,A15,A26,A27,A16 FROM learner INNER JOIN aim ON aim.A03 = learner.L03
HEREDOC;
		...
		if($st) 
		{
			while($row = $st->fetch())
			{
				...
				$a27 = $row['A27'];
				$a16 = $row['A16'];
				$sql2 = "SELECT learner.*,aim.* FROM learner INNER JOIN aim ON aim.A03 = learner.L03 WHERE learner.L03 = '$l03' AND aim.a15 = '$a15' AND aim.a26 = '$a26' and aim.a27 = '$a27' and aim.a16 = '$a16';"; 
				$st2 = $link->query($sql2);
				if($st2) 
				{
					$subaim = '';
					...
					while($row2 = $st2->fetch())
					{
						...
						else
						{
							...
							if($row2['A10']=='46' || ($row2['A10']=='70' && $row2['A09']!='ZESF0001') || ($row2['A10']=='21' && $row2['A09']=='XE2E0001') || ($row2['A04']=='30' && $row2['A10']=='21' && $row2['A05']=='2'))
							{
								$mainaim = "<main>" . $this->createAim($row2) . "</main>";
								$A09m = $row2['A09'];
							}
							
							if($row2['A04']=='30' && $row2['A09']!='ZESF0001' && $row2['A09']!='XE2E0001' && ($row2['A10']=='45' || $row2['A10']=='99' || $row2['A10']=='21') || ($row2['A04']=='30' && $row2['A10']=='21' && $row2['A05']!='2'))
							{
