<?php
class validate_ilr2023 implements IAction
{
    public function execute(PDO $link)
    {
        ...
        else
        {
            ...
            echo '<?xml version="1.0"?><report><success l03="' . htmlspecialchars((string)$ilr->LearnRefNumber) . '" /></report>';
