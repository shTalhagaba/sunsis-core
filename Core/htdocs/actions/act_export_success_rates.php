<?php
class export_success_rates implements IAction
{
	public function execute(PDO $link)
	{
        ...
        if($funding==1 or $funding==2)
        {
            //$learners = MonthlyFunding::getMonthlyFunding($link, $start_date, $start_date);
            //$trs_array = explode(",",$trs);
            ...
            if($funding==1)
                $learners = DAO::getResultSet($link, "select distinct TRID, LearnRefNumber, GivenNames, FamilyName, LearnAimRef from monthly_funding where TRID in ($trs)");
            elseif($funding==2)
            ...
            foreach($learners as $learner)
            {
                ...
                if(strtotime($start_date)>=strtotime("$contract_year-08-01"))
                {
                    $funding = DAO::getObject($link, "select OnProgPayment AS OnProgPayment
                                                            ...
                                                            ,FUBalancingPayment
                                                            ,FUCompletionPayment
                                                            from monthly_funding where TRID = '$learner[0]' and LearnAimRef = '$learner[4]' and Period = '2021-08-01'");
                ...
                if(strtotime($start_date)>=strtotime("$contract_year-09-01"))
                {
                    $funding = DAO::getObject($link, "select OnProgPayment AS OnProgPayment
                                                            ...
                                                            ,FUBalancingPayment
                                                            ,FUCompletionPayment
                                                            from monthly_funding where TRID = '$learner[0]' and LearnAimRef = '$learner[4]' and Period = '2021-09-01'");
                    $data.= "," . $funding->OnProgPayment . "," . $funding->BalancingPayment . "," . $funding->CompletionPayment . "," . $funding->EnglishMathsPayment . "," . $funding->EnglishMathsBalancing . "," . $funding->LSFPayment . "," . $funding->DisadvantagePayment . "," . $funding->Employer . "," . $funding->Provider . "," . $funding->FUOnProgPayment . "," . $funding->FUBalancingPayment . "," . $funding->FUCompletionPayment;
                    $opp += $funding->OnProgPayment;
                    $bal += $funding->BalancingPayment;
                    $com += $funding->CompletionPayment;
                ...
                if(strtotime($start_date)>=strtotime("$contract_year-10-01"))
                {
                    $funding = DAO::getObject($link, "select OnProgPayment AS OnProgPayment
                                                            ...
                                                            ,FUBalancingPayment
                                                            ,FUCompletionPayment
                                                            from monthly_funding where TRID = '$learner[0]' and LearnAimRef = '$learner[4]' and Period = '2021-10-01'");
                    $data.= "," . $funding->OnProgPayment . "," . $funding->BalancingPayment . "," . $funding->CompletionPayment . "," . $funding->EnglishMathsPayment . "," . $funding->EnglishMathsBalancing . "," . $funding->LSFPayment . "," . $funding->DisadvantagePayment . "," . $funding->Employer . "," . $funding->Provider . "," . $funding->FUOnProgPayment . "," . $funding->FUBalancingPayment . "," . $funding->FUCompletionPayment;
                    $opp += $funding->OnProgPayment;
                    $bal += $funding->BalancingPayment;
                    $com += $funding->CompletionPayment;
                ...
                if(strtotime($start_date)>=strtotime("$contract_year-11-01"))
                {
                    $funding = DAO::getObject($link, "select OnProgPayment AS OnProgPayment
                                                            ...
                                                            ,FUBalancingPayment
                                                            ,FUCompletionPayment
                                                            from monthly_funding where TRID = '$learner[0]' and LearnAimRef = '$learner[4]' and Period = '2021-11-01'");
                    $data.= "," . $funding->OnProgPayment . "," . $funding->BalancingPayment . "," . $funding->CompletionPayment . "," . $funding->EnglishMathsPayment . "," . $funding->EnglishMathsBalancing . "," . $funding->LSFPayment . "," . $funding->DisadvantagePayment . "," . $funding->Employer . "," . $funding->Provider . "," . $funding->FUOnProgPayment . "," . $funding->FUBalancingPayment . "," . $funding->FUCompletionPayment;
                    $opp += $funding->OnProgPayment;
                    $bal += $funding->BalancingPayment;
                    $com += $funding->CompletionPayment;
                ...
                if(strtotime($start_date)>=strtotime("$contract_year-12-01"))
                {
                    $funding = DAO::getObject($link, "select OnProgPayment AS OnProgPayment
                                                            ...
                                                            ,FUBalancingPayment
                                                            ,FUCompletionPayment
                                                            from monthly_funding where TRID = '$learner[0]' and LearnAimRef = '$learner[4]' and Period = '2021-12-01'");
                    $data.= "," . $funding->OnProgPayment . "," . $funding->BalancingPayment . "," . $funding->CompletionPayment . "," . $funding->EnglishMathsPayment . "," . $funding->EnglishMathsBalancing . "," . $funding->LSFPayment . "," . $funding->DisadvantagePayment . "," . $funding->Employer . "," . $funding->Provider . "," . $funding->FUOnProgPayment . "," . $funding->FUBalancingPayment . "," . $funding->FUCompletionPayment;
                    $opp += $funding->OnProgPayment;
                    $bal += $funding->BalancingPayment;
                    $com += $funding->CompletionPayment;
                ...
                if(strtotime($start_date)>=strtotime("$contract_yearp-01-01"))
                {
                    $funding = DAO::getObject($link, "select OnProgPayment AS OnProgPayment
                                                            ...
                                                            ,FUBalancingPayment
                                                            ,FUCompletionPayment
                                                            from monthly_funding where TRID = '$learner[0]' and LearnAimRef = '$learner[4]' and Period = '2022-01-01'");
                    $data.= "," . $funding->OnProgPayment . "," . $funding->BalancingPayment . "," . $funding->CompletionPayment . "," . $funding->EnglishMathsPayment . "," . $funding->EnglishMathsBalancing . "," . $funding->LSFPayment . "," . $funding->DisadvantagePayment . "," . $funding->Employer . "," . $funding->Provider . "," . $funding->FUOnProgPayment . "," . $funding->FUBalancingPayment . "," . $funding->FUCompletionPayment;
                    $opp += $funding->OnProgPayment;
                    $bal += $funding->BalancingPayment;
                    $com += $funding->CompletionPayment;
                ...
                if(strtotime($start_date)>=strtotime("$contract_yearp-02-01"))
                {
                    $funding = DAO::getObject($link, "select OnProgPayment AS OnProgPayment
                                                            ...
                                                            ,FUBalancingPayment
                                                            ,FUCompletionPayment
                                                            from monthly_funding where TRID = '$learner[0]' and LearnAimRef = '$learner[4]' and Period = '2022-02-01'");
                    $data.= "," . $funding->OnProgPayment . "," . $funding->BalancingPayment . "," . $funding->CompletionPayment . "," . $funding->EnglishMathsPayment . "," . $funding->EnglishMathsBalancing . "," . $funding->LSFPayment . "," . $funding->DisadvantagePayment . "," . $funding->Employer . "," . $funding->Provider . "," . $funding->FUOnProgPayment . "," . $funding->FUBalancingPayment . "," . $funding->FUCompletionPayment;
                    $opp += $funding->OnProgPayment;
                    $bal += $funding->BalancingPayment;
                    $com += $funding->CompletionPayment;
                ...
                if(strtotime($start_date)>=strtotime("$contract_yearp-03-01"))
                {
                    $funding = DAO::getObject($link, "select OnProgPayment AS OnProgPayment
                                                            ...
                                                            ,FUBalancingPayment
                                                            ,FUCompletionPayment
                                                            from monthly_funding where TRID = '$learner[0]' and LearnAimRef = '$learner[4]' and Period = '2022-03-01'");
                    $data.= "," . $funding->OnProgPayment . "," . $funding->BalancingPayment . "," . $funding->CompletionPayment . "," . $funding->EnglishMathsPayment . "," . $funding->EnglishMathsBalancing . "," . $funding->LSFPayment . "," . $funding->DisadvantagePayment . "," . $funding->Employer . "," . $funding->Provider . "," . $funding->FUOnProgPayment . "," . $funding->FUBalancingPayment . "," . $funding->FUCompletionPayment;
                    $opp += $funding->OnProgPayment;
                    $bal += $funding->BalancingPayment;
                    $com += $funding->CompletionPayment;
                ...
                if(strtotime($start_date)>=strtotime("$contract_yearp-04-01"))
                {
                    $funding = DAO::getObject($link, "select OnProgPayment AS OnProgPayment
                                                            ...
                                                            ,FUBalancingPayment
                                                            ,FUCompletionPayment
                                                            from monthly_funding where TRID = '$learner[0]' and LearnAimRef = '$learner[4]' and Period = '2022-04-01'");
                    $data.= "," . $funding->OnProgPayment . "," . $funding->BalancingPayment . "," . $funding->CompletionPayment . "," . $funding->EnglishMathsPayment . "," . $funding->EnglishMathsBalancing . "," . $funding->LSFPayment . "," . $funding->DisadvantagePayment . "," . $funding->Employer . "," . $funding->Provider . "," . $funding->FUOnProgPayment . "," . $funding->FUBalancingPayment . "," . $funding->FUCompletionPayment;
                    $opp += $funding->OnProgPayment;
                    $bal += $funding->BalancingPayment;
                    $com += $funding->CompletionPayment;
                ...
                if(strtotime($start_date)>=strtotime("$contract_yearp-05-01"))
                {
                    $funding = DAO::getObject($link, "select OnProgPayment AS OnProgPayment
                                                            ...
                                                            ,FUBalancingPayment
                                                            ,FUCompletionPayment
                                                            from monthly_funding where TRID = '$learner[0]' and LearnAimRef = '$learner[4]' and Period = '2022-05-01'");
                    $data.= "," . $funding->OnProgPayment . "," . $funding->BalancingPayment . "," . $funding->CompletionPayment . "," . $funding->EnglishMathsPayment . "," . $funding->EnglishMathsBalancing . "," . $funding->LSFPayment . "," . $funding->DisadvantagePayment . "," . $funding->Employer . "," . $funding->Provider . "," . $funding->FUOnProgPayment . "," . $funding->FUBalancingPayment . "," . $funding->FUCompletionPayment;
                    $opp += $funding->OnProgPayment;
                    $bal += $funding->BalancingPayment;
                    $com += $funding->CompletionPayment;
                ...
                if(strtotime($start_date)>=strtotime("$contract_yearp-06-01"))
                {
                    $funding = DAO::getObject($link, "select OnProgPayment AS OnProgPayment
                                                            ...
                                                            ,FUBalancingPayment
                                                            ,FUCompletionPayment
                                                            from monthly_funding where TRID = '$learner[0]' and LearnAimRef = '$learner[4]' and Period = '2022-06-01'");
                    $data.= "," . $funding->OnProgPayment . "," . $funding->BalancingPayment . "," . $funding->CompletionPayment . "," . $funding->EnglishMathsPayment . "," . $funding->EnglishMathsBalancing . "," . $funding->LSFPayment . "," . $funding->DisadvantagePayment . "," . $funding->Employer . "," . $funding->Provider . "," . $funding->FUOnProgPayment . "," . $funding->FUBalancingPayment . "," . $funding->FUCompletionPayment;
                    $opp += $funding->OnProgPayment;
                    $bal += $funding->BalancingPayment;
                    $com += $funding->CompletionPayment;
                ...
                if(strtotime($start_date)>=strtotime("$contract_yearp-07-01"))
                {
                    $funding = DAO::getObject($link, "select OnProgPayment AS OnProgPayment
                                                            ...
                                                            ,FUBalancingPayment
                                                            ,FUCompletionPayment
                                                            from monthly_funding where TRID = '$learner[0]' and LearnAimRef = '$learner[4]' and Period = '2022-07-01'");
                    $data.= "," . $funding->OnProgPayment . "," . $funding->BalancingPayment . "," . $funding->CompletionPayment . "," . $funding->EnglishMathsPayment . "," . $funding->EnglishMathsBalancing . "," . $funding->LSFPayment . "," . $funding->DisadvantagePayment . "," . $funding->Employer . "," . $funding->Provider . "," . $funding->FUOnProgPayment . "," . $funding->FUBalancingPayment . "," . $funding->FUCompletionPayment;
                    $opp += $funding->OnProgPayment;
                    $bal += $funding->BalancingPayment;
                    $com += $funding->CompletionPayment;
        ...
        //DAO::execute($link,"insert into zprogs(ilr) values('$trs');");
...
SELECT
	...
	IF(tr.`gender` = 'M', 'Male', IF(tr.`gender` = 'F', 'Female', IF(tr.`gender`='U', 'Not Known', IF(tr.`gender`='W', 'Witheld', '')))) AS gender,
	(SELECT LEFT(CONCAT(Ethnicity_Code, ' ', Ethnicity_Desc), 50) FROM lis201112.ilr_l12_ethnicity WHERE Ethnicity_Code = tr.`ethnicity`) AS ethnicity,
...
QUERY;
		...
		if($st)
		{
			$data = "TRID,Learner Reference Number,Firstname,Surname,DOB,Gender,Ethnicity,Start Date,Planned End Date,Actual End Date,Completion Status,Outcome,Framework,Contract,Provider,Employer" . "\r\n";
			while($row = $st->fetch())
			{
				$data .= $row['trid'] . "," . $row['l03'] . "," . $row['firstnames'] . "," . $row['surname'] . "," . $row['dob'] . "," . $row['gender'] . "," . $row['ethnicity'] . "," . $row['start_date'] . "," . $row['planned_end_date'] . "," . $row['actual_end_date'] . "," . $row['completion_status'] . "," . $row['outcome'] . "," . $row['framework'] . "," . $row['contract'] . "," . $row['provider'] . "," . $row['employer'] . "\r\n";
			}
			$data .= "\r\n";
		}
        // Now check negatives
        $st = $link->query("select * from success_rates2 where tr_id in ($trs)");
        $trs_array = explode(",",$trs);
        if($st)
        {
            while($row = $st->fetch())
            {
                foreach($trs_array as $tr)
                {
                    if($tr<0 and $tr==$row['tr_id'])
                    {
                        $data .= $row['l03'] . "," . "" . "," . "" . "," . $row['dob'] . "," . $row['gender'] . "," . $row['ethnicity'] . "," . $row['start_date'] . "," . $row['planned_end_date'] . "," . $row['actual_end_date'] . "," . $row['completion_status'] . "," . $row['outcome'] . "," . $row['FworkCode'] . "," . "" . "," . $row['provider'] . "," . $row['employer'] . "\r\n";
                    }
                }
            }
            $data .= "\r\n";
