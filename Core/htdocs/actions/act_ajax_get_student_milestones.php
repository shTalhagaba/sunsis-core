<?php
class ajax_get_student_milestones implements IAction
{
...
FROM
	student_milestones 
where framework_id = '$framework_id' and qualification_id = '$qualification_id' and internaltitle = '$internaltitle' and tr_id='$tr_id'
HEREDOC;
			$st = $link->query($sql);
			if($st) 
			{
