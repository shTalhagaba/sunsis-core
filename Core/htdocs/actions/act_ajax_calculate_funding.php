<?php
class ajax_calculate_funding implements IAction
{
    public function execute(PDO $link)
    {
        ...
        if($export == 'export')
        {
            $data = "<table><tr><td>&nbsp;</td><td colspan=3>16-18</td><td colspan=3>19-24</td><td colspan=3>25+</td><td>&nbsp;</td></tr>";
            $data .= "<tr><td>Period</td><tD>OPP</td><td>Ach:</td><td>Total</td><td>OPP</td><td>Ach:</td><td>Total</td><td>OPP</td><td>Ach:</td><td>Total</td><td>Grand Total</td></tr>";
        }
        else
        {
            $data = "<table cellpadding=6 ><thead><th>&nbsp;</th><th colspan=3>16-18</th><th colspan=3>19-24</th><th colspan=3>25+</th><th>&nbsp;</th></thead>";
            $data .= "<thead><th>Period</th><th>OPP</th><th>Ach:</th><th>Total</th><th>OPP</th><th>Ach:</th><th>Total</th><th>OPP</th><th>Ach:</th><th>Total</th><th>Grand Total</th>";
        }
        foreach($results->start as $result)
        {
	        ...
	        //$sln2 = DAO::getSingleValue($link, "SELECT LARS_FundingRate FROM lad201314.LARS_Funding1314 WHERE LARS_FundUnitMeasure = 'GBP' AND LARS_LearnAimRef = '$result->component2' AND LARS_FundCategory = 'APP_ACT_COST' AND LARS_FundingRateType = '20' ORDER BY LARS_FundRateDateEffFrom DESC LIMIT 0,1;");
...
//			$months = array("","Aug ","Sep ","Oct ","Nov ","Dec ","Jan ","Feb ","Mar ","Apr ","May ","Jun ","Jul ","Aug ","Sep ");
            ...
            for($a=1; $a<=$result->duration+12; $a++)
            {
                if($sixteen1_opps[$a]>0 || $sixteen2_opps[$a]>0 || $sixteen3_opps[$a]>0 || $sixteen4_opps[$a]>0 || $sixteen5_opps[$a]>0 || $ninteen1_opps[$a]>0 || $ninteen2_opps[$a]>0 || $ninteen3_opps[$a]>0 || $ninteen4_opps[$a]>0 || $ninteen5_opps[$a]>0 || $twenty1_opps[$a]>0 || $twenty2_opps[$a]>0 || $twenty3_opps[$a]>0 || $twenty4_opps[$a]>0 || $twenty5_opps[$a]>0)
                {
                    $data .= "<tr><td style='border-right:1px solid #C1DAD7; border-bottom: 1px solid #C1DAD7; background: #fff; color: #6D929B'>" . $months[$a] . "</td><td align=right style='border-right:1px solid #C1DAD7; border-bottom: 1px solid #C1DAD7; background: #fff; color: #6D929B'>&pound; " . sprintf("%.2f",($sixteen1_opps[$a]+$sixteen2_opps[$a]+$sixteen3_opps[$a]+$sixteen4_opps[$a]+$sixteen5_opps[$a])) . "</td><td align=right style='border-right:1px solid #C1DAD7; border-bottom: 1px solid #C1DAD7; background: #fff; color: #6D929B'>&pound; " . sprintf("%.2f",($sixteen1_ach[$a]+$sixteen2_ach[$a]+$sixteen3_ach[$a]+$sixteen4_ach[$a]+$sixteen5_ach[$a])) . "</td><td align=right style='border-right:1px solid #C1DAD7; border-bottom: 1px solid #C1DAD7; background: #fff; color: #6D929B'>&pound; " . sprintf("%.2f",($sixteen1_opps[$a]+$sixteen2_opps[$a]+$sixteen3_opps[$a]+$sixteen4_opps[$a]+$sixteen5_opps[$a]+$sixteen1_ach[$a]+$sixteen2_ach[$a]+$sixteen3_ach[$a]+$sixteen4_ach[$a]+$sixteen5_ach[$a])) . "</td>";
                    $data .= "<td align=right style='border-right:1px solid #C1DAD7; border-bottom: 1px solid #C1DAD7; background: #fff; color: #6D929B'>&pound; " . sprintf("%.2f",($ninteen1_opps[$a]+$ninteen2_opps[$a]+$ninteen3_opps[$a]+$ninteen4_opps[$a]+$ninteen5_opps[$a])) . "</td><td align=right style='border-right:1px solid #C1DAD7; border-bottom: 1px solid #C1DAD7; background: #fff; color: #6D929B'>&pound; " . sprintf("%.2f",($ninteen1_ach[$a]+$ninteen2_ach[$a]+$ninteen3_ach[$a]+$ninteen4_ach[$a]+$ninteen5_ach[$a])) . "</td><td align=right style='border-right:1px solid #C1DAD7; border-bottom: 1px solid #C1DAD7; background: #fff; color: #6D929B'>&pound; " . sprintf("%.2f",($ninteen1_opps[$a]+$ninteen2_opps[$a]+$ninteen3_opps[$a]+$ninteen4_opps[$a]+$ninteen5_opps[$a]+$ninteen1_ach[$a]+$ninteen2_ach[$a]+$ninteen3_ach[$a]+$ninteen4_ach[$a]+$ninteen5_ach[$a])) . "</td>";
                    $data .= "<td align=right style='border-right:1px solid #C1DAD7; border-bottom: 1px solid #C1DAD7; background: #fff; color: #6D929B'>&pound; " . sprintf("%.2f",($twenty1_opps[$a]+$twenty2_opps[$a]+$twenty3_opps[$a]+$twenty4_opps[$a]+$twenty5_opps[$a])) . "</td><td align=right style='border-right:1px solid #C1DAD7; border-bottom: 1px solid #C1DAD7; background: #fff; color: #6D929B'>&pound; " . sprintf("%.2f",($twenty1_ach[$a]+$twenty2_ach[$a]+$twenty3_ach[$a]+$twenty4_ach[$a]+$twenty5_ach[$a])) . "</td><td align=right style='border-right:1px solid #C1DAD7; border-bottom: 1px solid #C1DAD7; background: #fff; color: #6D929B'>&pound; " . sprintf("%.2f",($twenty1_opps[$a]+$twenty2_opps[$a]+$twenty3_opps[$a]+$twenty4_opps[$a]+$twenty5_opps[$a]+$twenty1_ach[$a]+$twenty2_ach[$a]+$twenty3_ach[$a]+$twenty4_ach[$a]+$twenty5_ach[$a])) . "</td>";
                    $data .= "<td align=right style='border-right:1px solid #C1DAD7; border-bottom: 1px solid #C1DAD7; background: #fff; color: #6D929B'>&pound; " . sprintf("%.2f", ($sixteen1_opps[$a] + $sixteen2_opps[$a] + $sixteen3_opps[$a] + $sixteen4_opps[$a] + $sixteen5_opps[$a] + $sixteen1_ach[$a] + $sixteen2_ach[$a] + $sixteen3_ach[$a] + $sixteen4_ach[$a] + $sixteen5_ach[$a] + $ninteen1_opps[$a] + $ninteen2_opps[$a]  + $ninteen3_opps[$a]  + $ninteen4_opps[$a]  + $ninteen5_opps[$a] + $ninteen1_ach[$a] + $ninteen2_ach[$a] + $ninteen3_ach[$a] + $ninteen4_ach[$a] + $ninteen5_ach[$a] + $twenty1_opps[$a]  + $twenty2_opps[$a]  + $twenty3_opps[$a] + $twenty4_opps[$a]  + $twenty5_opps[$a]  + $twenty1_ach[$a] + $twenty2_ach[$a] + $twenty3_ach[$a] + $twenty4_ach[$a] + $twenty5_ach[$a])) . "</td></tr>";

                    $sixteen_opps_total += $sixteen1_opps[$a]+$sixteen2_opps[$a]+$sixteen3_opps[$a]+$sixteen4_opps[$a]+$sixteen5_opps[$a];
                    $sixteen_ach_total += $sixteen1_ach[$a]+$sixteen2_ach[$a]+$sixteen3_ach[$a]+$sixteen4_ach[$a]+$sixteen5_ach[$a];
                    $ninteen_opps_total += $ninteen1_opps[$a]+$ninteen2_opps[$a]+$ninteen3_opps[$a]+$ninteen4_opps[$a]+$ninteen5_opps[$a];
                    $ninteen_ach_total += $ninteen1_ach[$a]+$ninteen2_ach[$a]+$ninteen3_ach[$a]+$ninteen4_ach[$a]+$ninteen5_ach[$a];
                    $twenty_opps_total += $twenty1_opps[$a]+$twenty2_opps[$a]+$twenty3_opps[$a]+$twenty4_opps[$a]+$twenty5_opps[$a];
                    $twenty_ach_total += $twenty1_ach[$a]+$twenty2_ach[$a]+$twenty3_ach[$a]+$twenty4_ach[$a]+$twenty5_ach[$a];
                }
            }
            $data .= "<tr><td style='border-right:1px solid #C1DAD7; border-bottom: 1px solid #C1DAD7; background: #fff; color: #6D929B'>Total</td><td align=right style='border-right:1px solid #C1DAD7; border-bottom: 1px solid #C1DAD7; background: #fff; color: #6D929B'>&pound; " . sprintf("%.2f",$sixteen_opps_total) . "</td><td align=right style='border-right:1px solid #C1DAD7; border-bottom: 1px solid #C1DAD7; background: #fff; color: #6D929B'>&pound; " . sprintf("%.2f",$sixteen_ach_total) . "</td><td align=right style='border-right:1px solid #C1DAD7; border-bottom: 1px solid #C1DAD7; background: #fff; color: #6D929B'>&pound; " . sprintf("%.2f",($sixteen_opps_total+$sixteen_ach_total)) . "</td>";
