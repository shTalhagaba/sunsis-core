<?php
class mobile_1 implements IUnauthenticatedAction

{
	public function execute( PDO $link )
	{
		...
		else
		{
			...
			$cand_interests = DAO::getResultset($link, 'SELECT id, description FROM lookup_candidate_interests ORDER BY description');

			require_once('tpl_mobile_2.php');
		}
	}
