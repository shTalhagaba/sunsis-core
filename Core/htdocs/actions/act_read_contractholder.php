...
class read_contractholder implements IAction
{
	public function execute(PDO $link)
	{
		...
		$_SESSION['bc']->add($link, "do.php?_action=read_contractholder&id=" . $id, "View Contract Holder");
		...
		// Presentation
		include('tpl_read_contractholder.php');
	}

	private function renderLocations(PDO $link, ContractHolder $vo)
	{
	...
	private function renderPersonnel(PDO $link, ContractHolder $vo)
	{
	...
	private function renderLearners(PDO $link, ContractHolder $vo)
	{
