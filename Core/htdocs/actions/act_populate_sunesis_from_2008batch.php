<?php
class populate_sunesis_from_2008batch implements IAction
{
	public function execute(PDO $link)
	{
		...
		while(!feof($handle))
		{
			...
			if($a04=='10')
			{
				...
				$l26 = substr($st,261,9);
				$l27 = substr($st,270,1);
				$l28a = substr($st,271,2);
				$l28b = substr($st,273,2);
				$l29 = substr($st,275,2);
				$l31 = substr($st,277,6);
				$l32 = substr($st,283,2);
				$l33 = substr($st,285,6);
				$l34a = substr($st,291,2);
				$l34b = substr($st,293,2);
				$l34c = substr($st,295,2);
				$l34d = substr($st,297,2);
				$l35 = substr($st,299,2);
				$l36 = substr($st,301,2);
				$l37 = substr($st,303,2);
				$l38 = substr($st,305,2);
				$l39 = substr($st,307,2);
				$l40a = substr($st,309,2);
				$l40b = substr($st,311,2);
				$l41a = substr($st,313,12);
				$l41b = substr($st,325,12);
				$l42a = substr($st,337,12);
				$l42b = substr($st,349,12);
				$l44 = substr($st,361,3);
				$l45 = substr($st,364,10);
				$l46 = substr($st,374,8);
				$l47 = substr($st,382,2);
				$l48 = substr($st,384,2) . "/" . substr($st,386,2) . "/" . substr($st,388,4);
				if($l48!='00/00/0000')
					$l48 = "'" . Date::toMySQL($l48) . "'";
				else
					$l48 = 'NULL';					
				$l49a = substr($st,392,2);
				$l49b = substr($st,394,2);
				$l49c = substr($st,396,2);
				$l49d = substr($st,398,2);
			...
			elseif($a04=='35' || $a04=='30')
			{
				...
				$a24 = substr($st,85,4);
				$a26 = substr($st,89,3);
				$a27 = substr($st,92,2) . "/" . substr($st,94,2) . "/" . substr($st,96,4);
				$a27 = Date::toMySQL($a27);
				$a28 = substr($st,100,2) . "/" . substr($st,102,2) . "/" . substr($st,104,4);
				$a28 = Date::toMySQL($a28);
				$a31 = substr($st,108,2) . "/" . substr($st,110,2) . "/" . substr($st,112,4);
				if($a31!='00/00/0000')
				...
				$a38 = substr($st,133,2);
				$a39 = substr($st,135,1);
				$a40 = substr($st,136,2) . "/" . substr($st,138,2) . "/" . substr($st,140,4);
				if($a40!='00/00/0000')
					$a40 = "'" . Date::toMySQL($a40) . "'";
				else
					$a40 = 'NULL';	
				$a43 = substr($st,144,8);				
				$a44 = substr($st,152,30);
				$a45 = substr($st,182,8);
				$a46a = substr($st,190,3);
				$a46b = substr($st,193,3);
				$a47a = substr($st,196,12);
				$a47b = substr($st,208,12);
				$a48a = substr($st,220,12);
				$a48b = substr($st,232,12);
				$a49 = substr($st,244,5);
				$a50 = substr($st,249,2);
				$a51a = substr($st,251,2);
				$a52 = substr($st,253,5);
				$a53 = substr($st,258,2);
				$a54 = substr($st,260,10);
				$a55 = substr($st,270,10);
				$a56 = substr($st,280,8);
				$a57 = substr($st,288,2);
				$a58 = substr($st,290,2);
				$a59 = substr($st,292,3);
				...
				$sql = "insert into aim values('0','$a01','$a02','$a03','$a04','$a05','$a07','$a08','$a09','$a10','$a11a','$a11b','$a13','$a14','$a15','$a16','$a17','$a18','$a19','$a20','$a21','$a22','$a23','$a26','$a27','$a28',$a31,'$a32','$a34','$a35','$a36',$a40,'$a44','$a45','$a46a','$a46b','$a47a','$a47b','$a48a','$a48b','$a49','$a50','$a51a','$a52','$a53','$a54','$a55','$a56','$a57','$a58','$a59','$a60','$a61','$a62','$a63','$a64','$a65','$a66','$a67','$a68',0,'','$a24');";
				DAO::execute($link, $sql);
...
HEREDOC;
				...
				if($st2) 
				{
					...
					while($row2 = $st2->fetch())
					{
						...
						else
						{
							...
							if($row2['A10']=='46' || ($row2['A10']=='70' && $row2['A09']!='ZESF0001') || ($row2['A10']=='21' && $row2['A09']=='XE2E0001'))
							{
								$mainaim = "<main>" . $this->createAim($row2) . "</main>";
								$A09m = $row2['A09'];
							}
							
							if($row2['A04']=='30' && $row2['A09']!='ZESF0001' && $row2['A09']!='XE2E0001' && ($row2['A10']=='45' || $row2['A10']=='99' || $row2['A10']=='21'))
							{
	...
	function createAim($row2)
	{
		...
		$ilr .= "<A24>" . $row2['A24'] . "</A24>";	//	Delivery location postcode
