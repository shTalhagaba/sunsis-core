<?php
class ajax_sr_classroom_contractor implements IAction
{
...
//		exit;
	...
	private function generateSuccessRates(PDO $link)
	{
		...
		$regions = DAO::getSingleColumn($link, "select distinct contractor from tbl_success_rates where contractor is not null and programme_type='Classroom'" . $this->username_where_clause);
