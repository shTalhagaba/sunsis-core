<?php
class populate_sunesis_from_2010batch implements IAction
{
	public function execute(PDO $link)
	{
		...
		while(!feof($handle))
		{
			...
			elseif($a04=='35' || $a04=='30')
			{
				...
				$sql = "insert into aim values('0','$a01','$a02','$a03','$a04','$a05','$a07','$a08','$a09','$a10','$a11a','$a11b','$a13','$a14','$a15','$a16','$a17','$a18','$a19','$a20','$a21','$a22','$a23','$a26','$a27','$a28',$a31,'$a32','$a34','$a35','$a36',$a40,'$a44','$a45','$a46a','$a46b','$a47a','$a47b','$a48a','$a48b','$a49','$a50','$a51a','$a52','$a53','$a54','$a55','$a56','$a57','$a58','$a59','$a60','$a61','$a62','$a63','$a64','$a65','$a66','$a67','$a68','$a69','$a70','0','','');";
				DAO::execute($link, $sql);
...
//				$emp_id = DAO::getSingleValue($link, "SELECT organisations.id FROM organisations INNER JOIN locations ON locations.organisations_id = organisations.id WHERE CONCAT(organisations.legal_name,locations.postcode) = '$a4445'");
		...
		$sql = "SELECT DISTINCT A03, A15, A26 FROM aim WHERE A15!=99 AND A26!=0 AND A34=6;";
		$submission = DAO::getSingleValue($link, "select submission from central.lookup_submission_dates where contract_type = '2' and last_submission_date>=CURDATE() and contract_year = '2011' order by last_submission_date LIMIT 1;");
		$st = $link->query($sql);
		if($st)
		{
			while($row = $st->fetch())
			{
				...
				$a15 = $row['A15'];
				$a26 = $row['A26'];
				$sql2 = "SELECT learner.*,aim.* FROM learner INNER JOIN aim ON aim.A03 = learner.L03 WHERE learner.L03 = '$l03' AND aim.a15 = '$a15' AND aim.a26 = '$a26' and aim.A34=6";
				$st2 = $link->query($sql2);
				if($st2)
				{
					$sub = '';
					$zprog = '';
					$main = '';
					$L05 = DAO::getSingleValue($link,"SELECT count(*) FROM learner INNER JOIN aim ON aim.A03 = learner.L03 WHERE learner.L03 = '$l03' AND aim.a15 = '$a15' AND aim.a26 = '$a26' and aim.A34=6;");
				...
				DAO::execute($link, "update aim set processid = {$tr->id} WHERE a03 = '$l03' AND a15 = '$a15' AND a26 = '$a26' and A34=6;");
		...
		// Create Apps training records and ILRs excluding break in learning;
		$sql = "SELECT DISTINCT A03, A15, A26 FROM aim WHERE A15!=99 AND A26!=0 and A34!=6;";
		$submission = DAO::getSingleValue($link, "select submission from central.lookup_submission_dates where contract_type = '2' and last_submission_date>=CURDATE() and contract_year = '2011' order by last_submission_date LIMIT 1;");
		$st = $link->query($sql);
		if($st)
