<?php
class view_ap_submission implements IAction
{
    public function execute(PDO $link)
    {
        $view = ViewAPSubmission::getInstance($link);
        $subaction = isset($_REQUEST['subaction']) ? $_REQUEST['subaction'] : '';

        $view->refresh($link, $_REQUEST);

        $_SESSION['bc']->index=0;
        $_SESSION['bc']->add($link, "do.php?_action=view_ap_submission", "View Assessment Plan Submissions Report");
        ...
        require_once('tpl_view_ap_submission.php');
    }
