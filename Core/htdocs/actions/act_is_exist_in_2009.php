<?php
class is_exist_in_2009 implements IAction
{
	public function execute(PDO $link)
	{
		...
		$tr_id = DAO::getSingleValue($link, "select count(*) from ilr where tr_id = '$tr_id' and contract_id in (select id from contracts where contract_year=2009)");
