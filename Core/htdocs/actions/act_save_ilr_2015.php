<?php
class save_ilr_2015 implements IAction
{
...
//			$this->saveAuditTrailEntryDetails($link, $ilrAuditId, $previous_ilr, $vo);
			...
			{
                //throw new Exception("update tr set target_date = '$target_date', start_date='$start_date',home_email = '$home_email', l42a = '$l42a', l42b = '$l42b', uln = '$uln', ilr_status = '$ilr_status', status_code = '$status_code', outcome='$outcome', closure_date = $closure_date, ethnicity = '$ethnicity' where id = '$tr_id'");
        ...
        Ilr2015::MigrateDeMigrate($link,$tr_id,$contract_id);
	}
