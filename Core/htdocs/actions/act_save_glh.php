<?php
class save_glh implements IAction
{
	public function execute(PDO $link)
	{
		...
		try
		{
			$vo->save($link);
	        	...
	        	$target_directory = "/{$tr_username}/GLH Diaries/{$vo->id}";
		...
		http_redirect('do.php?_action=read_training_record&glh_tab=1&id=' . $vo->tr_id);
	}
}
