<?php
class sla_kpi_graphs_dashboard implements IAction
{
    public function execute(PDO $link)
	{
        ...
        $filter_dtls = $obj_sla_kpi_reports->get_filter_details($link, $mode="from_filter_id", $idarray=array($filter_id));//from_user_id_and_report_type
        ...
        include('tpl_sla_kpi_graphs_dashboard.php');
	}
}
?>