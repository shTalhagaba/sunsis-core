<?php
class read_client implements IAction
{
	public function execute(PDO $link)
	{
		...
		$vo = Client::loadFromDatabase($link, $id);
		...
		//$vo5 = ViewClientEmployerGroups::getInstance($link, $id);
		...
		// Presentation
		include('tpl_read_client.php');
	}

	private function renderLocations(PDO $link, Client $vo)
	{
	...
	private function renderPersonnel(PDO $link, Client $vo)
	{
	...
	private function renderLearners(PDO $link, Client $vo)
	{
