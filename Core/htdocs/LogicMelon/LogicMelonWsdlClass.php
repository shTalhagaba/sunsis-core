<?php
/**
 * File for LogicMelonWsdlClass to communicate with SOAP service
 * @package LogicMelon
 * @date 2014-09-22
 ...
 */
/**
 * LogicMelonWsdlClass to communicate with SOAP service
 * Documentation : <h1>API SOAP Interface</h1><h2>Introduction</h2><p>A set of SOAP based API services to interact with the multiple job posting and applicant tracking system.</p><p>Many of the methods will not require any further input for a user except for posting where the user will be required to complete the process interactively</p><ul><li><strong>sCultureID</strong> optionally target a specific language culture</li><li><strong>sAPIKey</strong> api key required</li><li><strong>sUsername</strong> The username of the user</li><li><strong>sPassword</strong> The password of the user</li><li><strong>sAdvertIdentifier</strong> The advert identifier in your system</li><li><strong>sAdvertReference</strong> The reference sent to job boards and for user consumption</li><li><strong>sSearchDays</strong> By default the system will look for adverts in the last 30 dates when reducing duplication. -1 will indicate all time any other number indicates the numbers of days in the past to look for a duplicate.</li></ul><h2>Service Description</h2>
 * @package LogicMelon
 * @date 2014-09-22
 * @author Mikaël DELSOL
 * @version 1
 */
class LogicMelonWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'http://api.logicmelon.co.uk/SOAP/multiposter.asmx?WSDL';
    /**
    ...
    /**
     * Constructor
     * @uses LogicMelonWsdlClass::setLastError()
     * @uses LogicMelonWsdlClass::initSoapClient()
     * @uses LogicMelonWsdlClass::initInternArrayToIterate()
     * @uses LogicMelonWsdlClass::_set()
     ...
     * @return LogicMelonWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'LogicMelonWsdlClass'))
            {
     ...
     * @uses LogicMelonClassMap::classMap()
     * @uses LogicMelonWsdlClass::getDefaultWsdlOptions()
     * @uses LogicMelonWsdlClass::getSoapClientClassName()
     * @uses LogicMelonWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('LogicMelonClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = LogicMelonClassMap::classMap();
     ...
     * If a class is named as {LogicMelon}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('LogicMelonSoapClient') && is_subclass_of('LogicMelonSoapClient','SoapClient'))
            return 'LogicMelonSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses LogicMelonWsdlClass::WSDL_CACHE_WSDL
     * @uses LogicMelonWsdlClass::WSDL_COMPRESSION
     * @uses LogicMelonWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses LogicMelonWsdlClass::WSDL_ENCODING
     * @uses LogicMelonWsdlClass::WSDL_EXCEPTIONS
     * @uses LogicMelonWsdlClass::WSDL_FEATURES
     * @uses LogicMelonWsdlClass::WSDL_LOGIN
     * @uses LogicMelonWsdlClass::WSDL_PASSWORD
     * @uses LogicMelonWsdlClass::WSDL_SOAP_VERSION
     * @uses LogicMelonWsdlClass::WSDL_STREAM_CONTEXT
     * @uses LogicMelonWsdlClass::WSDL_TRACE
     * @uses LogicMelonWsdlClass::WSDL_TYPEMAP
     * @uses LogicMelonWsdlClass::WSDL_URL
     * @uses LogicMelonWsdlClass::VALUE_WSDL_URL
     * @uses LogicMelonWsdlClass::WSDL_USER_AGENT
     * @uses LogicMelonWsdlClass::WSDL_PROXY_HOST
     * @uses LogicMelonWsdlClass::WSDL_PROXY_PORT
     * @uses LogicMelonWsdlClass::WSDL_PROXY_LOGIN
     * @uses LogicMelonWsdlClass::WSDL_PROXY_PASSWORD
     * @uses LogicMelonWsdlClass::WSDL_LOCAL_CERT
     * @uses LogicMelonWsdlClass::WSDL_PASSPHRASE
     * @uses LogicMelonWsdlClass::WSDL_AUTHENTICATION
     * @uses LogicMelonWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses LogicMelonWsdlClass::getSoapClient()
     * @uses LogicMelonWsdlClass::getFormatedXml()
     ...
     * @uses LogicMelonWsdlClass::getSoapClient()
     * @uses LogicMelonWsdlClass::convertStringHeadersToArray()
     ...
     * @uses LogicMelonWsdlClass::count()
     * @return int
     */
     ...
     * @uses LogicMelonWsdlClass::getInternArrayToIterate()
     * @uses LogicMelonWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses LogicMelonWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses LogicMelonWsdlClass::getInternArrayToIterateOffset()
     * @uses LogicMelonWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses LogicMelonWsdlClass::getInternArrayToIterateOffset()
     * @uses LogicMelonWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see LogicMelonWsdlClass::offsetGet()
     * @uses LogicMelonWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses LogicMelonWsdlClass::getAttributeName()
     * @uses LogicMelonWsdlClass::__toString()
     * @uses LogicMelonWsdlClass::_set()
     * @uses LogicMelonWsdlClass::_get()
     * @uses LogicMelonWsdlClass::setInternArrayToIterate()
     * @uses LogicMelonWsdlClass::setInternArrayToIterateIsArray()
     * @uses LogicMelonWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses LogicMelonWsdlClass::item()
     * @uses LogicMelonWsdlClass::length()
     * @return mixed
     */
