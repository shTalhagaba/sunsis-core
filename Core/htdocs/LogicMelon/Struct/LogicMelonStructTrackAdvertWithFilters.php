<?php
/**
 * File for class LogicMelonStructTrackAdvertWithFilters
 * @package LogicMelon
 * @subpackage Structs
 * @date 2014-09-22
 ...
 */
/**
 * This class stands for LogicMelonStructTrackAdvertWithFilters originally named TrackAdvertWithFilters
 ...
 * @version 1
 */
class LogicMelonStructTrackAdvertWithFilters extends LogicMelonWsdlClass
{
    /**
     * The sCultureID
     * Meta informations extracted from the WSDL
    ...
    public $Filters;
    /**
     * Constructor method for TrackAdvertWithFilters
     ...
     * @return LogicMelonStructTrackAdvertWithFilters
     */
