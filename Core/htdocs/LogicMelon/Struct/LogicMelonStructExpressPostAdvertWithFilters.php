<?php
/**
 * File for class LogicMelonStructExpressPostAdvertWithFilters
 * @package LogicMelon
 * @subpackage Structs
 * @date 2014-09-22
 ...
 */
/**
 * This class stands for LogicMelonStructExpressPostAdvertWithFilters originally named ExpressPostAdvertWithFilters
 ...
 * @version 1
 */
class LogicMelonStructExpressPostAdvertWithFilters extends LogicMelonWsdlClass
{
    /**
     * The sCultureID
     * Meta informations extracted from the WSDL
    ...
    public $Filters;
    /**
     * Constructor method for ExpressPostAdvertWithFilters
     ...
     * @return LogicMelonStructExpressPostAdvertWithFilters
     */
    public function __construct($_sCultureID = NULL,$_sAPIKey = NULL,$_sUsername = NULL,$_sUserIdentifier = NULL,$_sStartOrganisation = NULL,$_sAdvertIdentifier = NULL,$_sAdvertReference = NULL,$_sAdvertID = NULL,$_sSearchDays = NULL,$_destinations = NULL,$_filters = NULL)
    {
        parent::__construct(array('sCultureID'=>$_sCultureID,'sAPIKey'=>$_sAPIKey,'sUsername'=>$_sUsername,'sUserIdentifier'=>$_sUserIdentifier,'sStartOrganisation'=>$_sStartOrganisation,'sAdvertIdentifier'=>$_sAdvertIdentifier,'sAdvertReference'=>$_sAdvertReference,'sAdvertID'=>$_sAdvertID,'sSearchDays'=>$_sSearchDays,'Destinations'=>($_destinations instanceof LogicMelonStructArrayOfString)?$_destinations:new LogicMelonStructArrayOfString($_destinations),'Filters'=>($_filters instanceof LogicMelonStructArrayOfNameValue)?$_filters:new LogicMelonStructArrayOfNameValue($_filters)),false);
    }
    /**
