<?php
/**
 * File for class LogicMelonStructUserFeedsAndQuota
 * @package LogicMelon
 * @subpackage Structs
 * @date 2014-09-22
 ...
 */
/**
 * This class stands for LogicMelonStructUserFeedsAndQuota originally named UserFeedsAndQuota
 ...
 * @version 1
 */
class LogicMelonStructUserFeedsAndQuota extends LogicMelonWsdlClass
{
    /**
     * The sCultureID
     * Meta informations extracted from the WSDL
    ...
    public $sPassword;
    /**
     * Constructor method for UserFeedsAndQuota
     * @see parent::__construct()
     * @param string $_sCultureID
     * @param string $_sAPIKey
     * @param string $_sUsername
     * @param string $_sPassword
     * @return LogicMelonStructUserFeedsAndQuota
     */
    public function __construct($_sCultureID = NULL,$_sAPIKey = NULL,$_sUsername = NULL,$_sPassword = NULL)
    {
        parent::__construct(array('sCultureID'=>$_sCultureID,'sAPIKey'=>$_sAPIKey,'sUsername'=>$_sUsername,'sPassword'=>$_sPassword),false);
    }
    /**
