<?php
/**
 * File for class LogicMelonStructGetAdvertWithValuesPaged
 * @package LogicMelon
 * @subpackage Structs
 * @date 2014-09-22
 ...
 */
/**
 * This class stands for LogicMelonStructGetAdvertWithValuesPaged originally named GetAdvertWithValuesPaged
 ...
 * @version 1
 */
class LogicMelonStructGetAdvertWithValuesPaged extends LogicMelonWsdlClass
{
    /**
     * The CurrentPage
     * Meta informations extracted from the WSDL
    ...
    public $OrderBy;
    /**
     * Constructor method for GetAdvertWithValuesPaged
     ...
     * @return LogicMelonStructGetAdvertWithValuesPaged
     */
    public function __construct($_currentPage,$_rowsPerPage,$_sCultureID = NULL,$_sAPIKey = NULL,$_sUsername = NULL,$_sUserIdentifier = NULL,$_sStartOrganisation = NULL,$_sAdvertIdentifier = NULL,$_sAdvertReference = NULL,$_sAdvertID = NULL,$_sSearchDays = NULL,$_fieldIDsAsCSV = NULL,$_destinationsAsCSV = NULL,$_sAdvertStatusIDs = NULL,$_sHideFutureJobs = NULL,$_orderBy = NULL)
    {
