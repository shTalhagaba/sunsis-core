<?php
/**
 * File for class LogicMelonStructGetAdvertWithFilters
 * @package LogicMelon
 * @subpackage Structs
 * @date 2014-09-22
 ...
 */
/**
 * This class stands for LogicMelonStructGetAdvertWithFilters originally named GetAdvertWithFilters
 ...
 * @version 1
 */
class LogicMelonStructGetAdvertWithFilters extends LogicMelonWsdlClass
{
    /**
     * The sCultureID
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for GetAdvertWithFilters
     ...
     * @return LogicMelonStructGetAdvertWithFilters
     */
    public function __construct($_sCultureID = NULL,$_sAPIKey = NULL,$_sUsername = NULL,$_sUserIdentifier = NULL,$_sStartOrganisation = NULL,$_sAdvertIdentifier = NULL,$_sAdvertReference = NULL,$_sAdvertID = NULL,$_sSearchDays = NULL,$_filters = NULL,$_sAdvertStatusIDs = NULL,$_sHideFutureJobs = NULL)
    {
