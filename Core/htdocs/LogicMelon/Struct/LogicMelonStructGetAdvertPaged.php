<?php
/**
 * File for class LogicMelonStructGetAdvertPaged
 * @package LogicMelon
 * @subpackage Structs
 * @date 2014-09-22
 ...
 */
/**
 * This class stands for LogicMelonStructGetAdvertPaged originally named GetAdvertPaged
 ...
 * @version 1
 */
class LogicMelonStructGetAdvertPaged extends LogicMelonWsdlClass
{
    /**
     * The CurrentPage
     * Meta informations extracted from the WSDL
    ...
    public $OrderBy;
    /**
     * Constructor method for GetAdvertPaged
     ...
     * @return LogicMelonStructGetAdvertPaged
     */
    public function __construct($_currentPage,$_rowsPerPage,$_sCultureID = NULL,$_sAPIKey = NULL,$_sUsername = NULL,$_sUserIdentifier = NULL,$_sStartOrganisation = NULL,$_sAdvertIdentifier = NULL,$_sAdvertReference = NULL,$_sAdvertID = NULL,$_sSearchDays = NULL,$_sAdvertStatusIDs = NULL,$_sHideFutureJobs = NULL,$_orderBy = NULL)
    {
        parent::__construct(array('CurrentPage'=>$_currentPage,'RowsPerPage'=>$_rowsPerPage,'sCultureID'=>$_sCultureID,'sAPIKey'=>$_sAPIKey,'sUsername'=>$_sUsername,'sUserIdentifier'=>$_sUserIdentifier,'sStartOrganisation'=>$_sStartOrganisation,'sAdvertIdentifier'=>$_sAdvertIdentifier,'sAdvertReference'=>$_sAdvertReference,'sAdvertID'=>$_sAdvertID,'sSearchDays'=>$_sSearchDays,'sAdvertStatusIDs'=>$_sAdvertStatusIDs,'sHideFutureJobs'=>$_sHideFutureJobs,'OrderBy'=>$_orderBy),false);
    }
    /**
