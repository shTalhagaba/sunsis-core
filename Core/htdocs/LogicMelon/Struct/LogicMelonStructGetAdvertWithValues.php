<?php
/**
 * File for class LogicMelonStructGetAdvertWithValues
 * @package LogicMelon
 * @subpackage Structs
 * @date 2014-09-22
 ...
 */
/**
 * This class stands for LogicMelonStructGetAdvertWithValues originally named GetAdvertWithValues
 ...
 * @version 1
 */
class LogicMelonStructGetAdvertWithValues extends LogicMelonWsdlClass
{
    /**
     * The sCultureID
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for GetAdvertWithValues
     ...
     * @param string $_fieldIDsAsCSV
     * @param string $_destinationsAsCSV
     * @param string $_sAdvertStatusIDs
     * @param string $_sHideFutureJobs
     * @return LogicMelonStructGetAdvertWithValues
     */
    public function __construct($_sCultureID = NULL,$_sAPIKey = NULL,$_sUsername = NULL,$_sUserIdentifier = NULL,$_sStartOrganisation = NULL,$_sAdvertIdentifier = NULL,$_sAdvertReference = NULL,$_sAdvertID = NULL,$_sSearchDays = NULL,$_fieldIDsAsCSV = NULL,$_destinationsAsCSV = NULL,$_sAdvertStatusIDs = NULL,$_sHideFutureJobs = NULL)
    {
        parent::__construct(array('sCultureID'=>$_sCultureID,'sAPIKey'=>$_sAPIKey,'sUsername'=>$_sUsername,'sUserIdentifier'=>$_sUserIdentifier,'sStartOrganisation'=>$_sStartOrganisation,'sAdvertIdentifier'=>$_sAdvertIdentifier,'sAdvertReference'=>$_sAdvertReference,'sAdvertID'=>$_sAdvertID,'sSearchDays'=>$_sSearchDays,'FieldIDsAsCSV'=>$_fieldIDsAsCSV,'DestinationsAsCSV'=>$_destinationsAsCSV,'sAdvertStatusIDs'=>$_sAdvertStatusIDs,'sHideFutureJobs'=>$_sHideFutureJobs),false);
    }
    /**
    ...
    /**
     * Get FieldIDsAsCSV value
     * @return string|null
     */
    public function getFieldIDsAsCSV()
    {
        return $this->FieldIDsAsCSV;
    }
    /**
     * Set FieldIDsAsCSV value
     * @param string $_fieldIDsAsCSV the FieldIDsAsCSV
     * @return string
     */
    public function setFieldIDsAsCSV($_fieldIDsAsCSV)
    {
        return ($this->FieldIDsAsCSV = $_fieldIDsAsCSV);
    }
    /**
