<?php
/**
 * File for class LogicMelonStructGetAdvertWithValuesWithFiltersPaged
 * @package LogicMelon
 * @subpackage Structs
 * @date 2014-09-22
 ...
 */
/**
 * This class stands for LogicMelonStructGetAdvertWithValuesWithFiltersPaged originally named GetAdvertWithValuesWithFiltersPaged
 ...
 * @version 1
 */
class LogicMelonStructGetAdvertWithValuesWithFiltersPaged extends LogicMelonWsdlClass
{
    /**
     * The CurrentPage
     * Meta informations extracted from the WSDL
     ...
     * @return LogicMelonStructGetAdvertWithValuesWithFiltersPaged
     */
    public function __construct($_currentPage,$_rowsPerPage,$_sCultureID = NULL,$_sAPIKey = NULL,$_sUsername = NULL,$_sUserIdentifier = NULL,$_sStartOrganisation = NULL,$_sAdvertIdentifier = NULL,$_sAdvertReference = NULL,$_sAdvertID = NULL,$_sSearchDays = NULL,$_fieldIDs = NULL,$_destinations = NULL,$_filters = NULL,$_sAdvertStatusIDs = NULL,$_sHideFutureJobs = NULL,$_orderBy = NULL)
    {
