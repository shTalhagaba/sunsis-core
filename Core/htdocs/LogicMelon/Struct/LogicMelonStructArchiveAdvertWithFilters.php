<?php
/**
 * File for class LogicMelonStructArchiveAdvertWithFilters
 * @package LogicMelon
 * @subpackage Structs
 * @date 2014-09-22
 ...
 */
/**
 * This class stands for LogicMelonStructArchiveAdvertWithFilters originally named ArchiveAdvertWithFilters
 ...
 * @version 1
 */
class LogicMelonStructArchiveAdvertWithFilters extends LogicMelonWsdlClass
{
    /**
     * The sCultureID
     * Meta informations extracted from the WSDL
    ...
    public $Filters;
    /**
     * Constructor method for ArchiveAdvertWithFilters
     ...
     * @return LogicMelonStructArchiveAdvertWithFilters
     */
