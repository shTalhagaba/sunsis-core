<?php
/**
 * File for class LogicMelonStructUnarchiveAdvertWithFilters
 * @package LogicMelon
 * @subpackage Structs
 * @date 2014-09-22
 ...
 */
/**
 * This class stands for LogicMelonStructUnarchiveAdvertWithFilters originally named UnarchiveAdvertWithFilters
 ...
 * @version 1
 */
class LogicMelonStructUnarchiveAdvertWithFilters extends LogicMelonWsdlClass
{
    /**
     * The sCultureID
     * Meta informations extracted from the WSDL
    ...
    public $Filters;
    /**
     * Constructor method for UnarchiveAdvertWithFilters
     ...
     * @return LogicMelonStructUnarchiveAdvertWithFilters
     */
    public function __construct($_sCultureID = NULL,$_sAPIKey = NULL,$_sUsername = NULL,$_sUserIdentifier = NULL,$_sStartOrganisation = NULL,$_sAdvertIdentifier = NULL,$_sAdvertReference = NULL,$_sAdvertID = NULL,$_sSearchDays = NULL,$_filters = NULL)
    {
