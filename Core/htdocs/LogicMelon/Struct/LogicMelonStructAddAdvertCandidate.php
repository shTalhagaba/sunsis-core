<?php
/**
 * File for class LogicMelonStructAddAdvertCandidate
 * @package LogicMelon
 * @subpackage Structs
 * @date 2014-09-22
 ...
 */
/**
 * This class stands for LogicMelonStructAddAdvertCandidate originally named AddAdvertCandidate
 ...
 * @version 1
 */
class LogicMelonStructAddAdvertCandidate extends LogicMelonWsdlClass
{
    /**
     * The sCultureID
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for AddAdvertCandidate
     ...
     * @return LogicMelonStructAddAdvertCandidate
     */
