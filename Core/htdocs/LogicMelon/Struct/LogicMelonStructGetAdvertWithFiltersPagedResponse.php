<?php
/**
 * File for class LogicMelonStructGetAdvertWithFiltersPagedResponse
 * @package LogicMelon
 * @subpackage Structs
 * @date 2014-09-22
 ...
 */
/**
 * This class stands for LogicMelonStructGetAdvertWithFiltersPagedResponse originally named GetAdvertWithFiltersPagedResponse
 ...
 * @version 1
 */
class LogicMelonStructGetAdvertWithFiltersPagedResponse extends LogicMelonWsdlClass
{
    /**
     * The AdvertPaged
     * Meta informations extracted from the WSDL
    ...
    public $AdvertPaged;
    /**
     * Constructor method for GetAdvertWithFiltersPagedResponse
