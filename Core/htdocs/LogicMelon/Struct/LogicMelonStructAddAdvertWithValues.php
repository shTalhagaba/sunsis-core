<?php
/**
 * File for class LogicMelonStructAddAdvertWithValues
 * @package LogicMelon
 * @subpackage Structs
 * @date 2014-09-22
 ...
 */
/**
 * This class stands for LogicMelonStructAddAdvertWithValues originally named AddAdvertWithValues
 ...
 * @version 1
 */
class LogicMelonStructAddAdvertWithValues extends LogicMelonWsdlClass
{
    /**
    ...
    /**
     * Constructor method for AddAdvertWithValues
     ...
     * @return LogicMelonStructAddAdvertWithValues
     */
    public function __construct($_futurePostDateTimeInUtc,$_sCultureID = NULL,$_sAPIKey = NULL,$_sUsername = NULL,$_sPassword = NULL,$_sAdvertIdentifier = NULL,$_sAdvertReference = NULL,$_sSearchDays = NULL,$_sOnDuplicate = NULL,$_sJobTitle = NULL,$_sJobType = NULL,$_sJobHours = NULL,$_sPrimaryLocation = NULL,$_sIndustry = NULL,$_sSalaryFrom = NULL,$_sSalaryTo = NULL,$_sSalaryCurrency = NULL,$_sSalaryPer = NULL,$_sSalaryBenefits = NULL,$_sContactName = NULL,$_sContactEmail = NULL,$_sJobDescription = NULL,$_sApplicationURL = NULL,$_destinations = NULL,$_sRedirectDomain = NULL,$_advertValues = NULL,$_sAdvertStatusID = NULL)
    {
        parent::__construct(array('FuturePostDateTimeInUtc'=>$_futurePostDateTimeInUtc,'sCultureID'=>$_sCultureID,'sAPIKey'=>$_sAPIKey,'sUsername'=>$_sUsername,'sPassword'=>$_sPassword,'sAdvertIdentifier'=>$_sAdvertIdentifier,'sAdvertReference'=>$_sAdvertReference,'sSearchDays'=>$_sSearchDays,'sOnDuplicate'=>$_sOnDuplicate,'sJobTitle'=>$_sJobTitle,'sJobType'=>$_sJobType,'sJobHours'=>$_sJobHours,'sPrimaryLocation'=>$_sPrimaryLocation,'sIndustry'=>$_sIndustry,'sSalaryFrom'=>$_sSalaryFrom,'sSalaryTo'=>$_sSalaryTo,'sSalaryCurrency'=>$_sSalaryCurrency,'sSalaryPer'=>$_sSalaryPer,'sSalaryBenefits'=>$_sSalaryBenefits,'sContactName'=>$_sContactName,'sContactEmail'=>$_sContactEmail,'sJobDescription'=>$_sJobDescription,'sApplicationURL'=>$_sApplicationURL,'Destinations'=>($_destinations instanceof LogicMelonStructArrayOfString)?$_destinations:new LogicMelonStructArrayOfString($_destinations),'sRedirectDomain'=>$_sRedirectDomain,'AdvertValues'=>($_advertValues instanceof LogicMelonStructArrayOfNameValue)?$_advertValues:new LogicMelonStructArrayOfNameValue($_advertValues),'sAdvertStatusID'=>$_sAdvertStatusID),false);
    }
    /**
