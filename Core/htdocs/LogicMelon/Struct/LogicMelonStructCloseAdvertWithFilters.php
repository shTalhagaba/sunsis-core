<?php
/**
 * File for class LogicMelonStructCloseAdvertWithFilters
 * @package LogicMelon
 * @subpackage Structs
 * @date 2014-09-22
 ...
 */
/**
 * This class stands for LogicMelonStructCloseAdvertWithFilters originally named CloseAdvertWithFilters
 ...
 * @version 1
 */
class LogicMelonStructCloseAdvertWithFilters extends LogicMelonWsdlClass
{
    /**
     * The sCultureID
     * Meta informations extracted from the WSDL
    ...
    public $Filters;
    /**
     * Constructor method for CloseAdvertWithFilters
     ...
     * @return string|null
     */
    public function getSArchive()
    {
        return $this->sArchive;
    }
    /**
     * Set sArchive value
     * @param string $_sArchive the sArchive
     * @return string
     */
    public function setSArchive($_sArchive)
    {
        return ($this->sArchive = $_sArchive);
    }
    /**
