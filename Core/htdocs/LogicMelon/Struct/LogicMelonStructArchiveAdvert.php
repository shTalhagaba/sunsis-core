<?php
/**
 * File for class LogicMelonStructArchiveAdvert
 * @package LogicMelon
 * @subpackage Structs
 * @date 2014-09-22
 ...
 */
/**
 * This class stands for LogicMelonStructArchiveAdvert originally named ArchiveAdvert
 ...
 * @version 1
 */
class LogicMelonStructArchiveAdvert extends LogicMelonWsdlClass
{
    /**
     * The sCultureID
     * Meta informations extracted from the WSDL
    ...
    public $sSearchDays;
    /**
     * Constructor method for ArchiveAdvert
     ...
     * @return LogicMelonStructArchiveAdvert
     */
