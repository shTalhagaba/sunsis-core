...
<head>
	...
	<title>Programmes Summary</title>
...
<div class="row">
	<div class="col-lg-12">
		<div class="banner">
			<div class="Title" style="margin-left: 6px;">Programmes Summary</div>
			<div class="ButtonBar">
				<?php if(SOURCE_BLYTHE_VALLEY || $_SESSION['user']->op_access != 'R'){?>
				<span class="btn btn-sm btn-default" onclick="window.location.href='edit_operations_tracker';"><i class="fa fa-plus"></i> New Programme</span>
				<?php } ?>
			</div>
			<div class="ActionIconBar">
				...
				<span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="exportToExcel('view_operations_trackers');" title="Export to .CSV file"></span>
	...
	<div class="row">
		<div id="div_filters" style="display:none">
			<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" name="frmFilters">
				<input type="hidden" name="_action" value="view_operations_trackers" />

				<div id="filterBox" class="clearfix">
					<fieldset>
						<legend>General</legend>
						<div class="field float"><label>Programme Title:</label><?php echo $view->getFilterHTML('filter_title'); ?></div>
						<div class="field float"><label>Framework:</label><?php echo $view->getFilterHTML('filter_framework'); ?></div>
						<div class="field float"><label>Unit Ref.:</label><?php echo $view->getFilterHTML('filter_unit_ref'); ?></div>
					</fieldset>
					<fieldset>
