...
<head>
	...
	<title>View Sessions Registers</title>
...
<div class="row">
	<div class="col-lg-12">
		<div class="banner">
			<div class="Title" style="margin-left: 6px;">View Sessions Registers</div>
			<div class="ButtonBar">
			</div>
			<div class="ActionIconBar">
				...
				<span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="exportToExcel('view_ViewSessionsRegisters');" title="Export to .CSV file"></span>
...
<div class="container-fluid">
	...
	<div class="row">
		<div id="div_filters" style="display:none" class="small">
			...
			<form name="filters" method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter">
				<input type="hidden" name="_action" value="view_sessions_registers" />
				...
				<div id="filterBox" class="clearfix">
					<fieldset>
						...
						<div class="field float"><label>Register Status:</label><?php echo $view->getFilterHTML('filter_reg_status'); ?></div>
						<div class="field float"><label>Trainer:</label><?php echo $view->getFilterHTML('filter_trainer'); ?></div>
						<div class="field newrow"></div>
						<div class="field float"><label>Event Type:</label><?php echo $view->getFilterHTML('filter_event_type'); ?></div>
	...
	<div class="row">
		<div class="col-sm-12">
			<?php $view->renderDayNavigation("view_sessions_registers", "filter_date"); ?>
		</div>
	</div>
	<div class="row">
...
<script type="text/javascript">
	var phpView = 'ViewSessionsRegisters_';
</script>
