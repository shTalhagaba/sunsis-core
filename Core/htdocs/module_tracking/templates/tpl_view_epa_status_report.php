...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;">EPA Status Report</div>
            <div class="ButtonBar">
            ...
            <div class="ActionIconBar">
                ...
                <span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="window.location.href='do.php?_action=view_epa_status_report&subaction=export'" title="Export to .CSV file"></span>
    ...
    <div class="row">
        <div id="div_filters" style="display:none">
            <form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter" name="applyFilter">
                ...
                <input type="hidden" name="_action" value="view_epa_status_report" />
			...
			<div class="field float">
                            <label>Order By:</label> <?php echo $view->getFilterHTML(VoltView::KEY_ORDER_BY); ?>
                        </div>
                    </fieldset>
