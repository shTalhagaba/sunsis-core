...
<head>
	...
	<title>View EPA Result Learners</title>
...
<div class="row">
	<div class="col-lg-12">
		<div class="banner">
			<div class="Title" style="margin-left: 6px;">View EPA Results</div>
			<div class="ButtonBar">
				<span class="btn btn-sm btn-default" onclick="window.location.href='<?php echo $_SESSION['bc']->getPrevious(); ?>';"><i class="fa fa-arrow-circle-o-left"></i> Cancel</span>
			</div>
			<div class="ActionIconBar">
				<span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="window.location.href='do.php?_action=view_epa_dash_learners&subaction=export_csv'" title="Export to .CSV file"></span>
			</div>
		</div>
	</div>
</div>
			...
			<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter" name="applyFilter">
				...
				<div id="filterBox" class="clearfix small">
					<fieldset>
						...
						<div class="field float"><label>ID:</label><?php echo $view->getFilterHTML('filter_ids'); ?></div>
					</fieldset>
