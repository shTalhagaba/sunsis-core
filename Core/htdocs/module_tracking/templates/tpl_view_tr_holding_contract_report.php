...
<head>
	...
	<title>Holding Contract Report</title>
...
<div class="row">
	<div class="col-lg-12">
		<div class="banner">
			<div class="Title" style="margin-left: 6px;">Holding Contract Report</div>
			<div class="ButtonBar">
			...
			<div class="ActionIconBar">
				...
				<span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="window.location.href='do.php?_action=view_tr_holding_contract_report&subaction=export_csv'" title="Export to .CSV file"></span>
	...
	<div class="row">
		<div id="div_filters" style="display:none" class="small">
			<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter" name="applyFilter">
				<input type="hidden" name="_action" value="view_tr_holding_contract_report" />
				...
				<div id="filterBox" class="clearfix">
					<fieldset>
						...
						<div class="field float"><label>HC. Date Removed:</label><?php echo $view->getFilterHTML('filter_date_removed'); ?></div>
`					</fieldset>
					<fieldset>
