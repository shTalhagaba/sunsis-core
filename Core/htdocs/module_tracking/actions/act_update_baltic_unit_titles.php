...
class update_baltic_unit_titles implements IAction
{
	...
	{
	pre('stop');
        $old_title = 'Install Configure and Upgrade Cloud and On-Premises Network Architecture pt2';
        $new_title = 'Cloud and On Premises Network Installation Part 2';
        $framework_id = '431';
        $tracker_id = '72'; // make sure only one tracker contains that framework
        $framework_qual_id = 'Z0001896';
