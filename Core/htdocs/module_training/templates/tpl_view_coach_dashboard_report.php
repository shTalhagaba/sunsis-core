...
<head>
	...
	<title>Coaches Dashboard Report</title>
...
<div class="row">
	<div class="col-lg-12">
		<div class="banner">
			<div class="Title" style="margin-left: 6px;">Coaches Dashboard Report</div>
			<div class="ButtonBar">
			</div>
			<div class="ActionIconBar">
				...
				<span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="alert('Under development, please check back later.');//exportToExcel('view_ViewCoachDashboardReport');" title="Export to .CSV file"></span>
		...
		<div class="col-lg-12">
			<div id="div_filters" style="display: none;">
				<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" name="applyFilter" id="applyFilter">
					<input type="hidden" name="_action" value="view_coach_dashboard_report" />

					<div id="filterBox" class="clearfix small">
						<fieldset>
							<legend>General</legend>
							<div class="field float"><label>Learner Status:</label><?php echo $view->getFilterHTML('filter_status_code'); ?></div>
							<div class="field float"><label>Learner FirstName:</label><?php echo $view->getFilterHTML('filter_firstnames'); ?></div>
							<div class="field float"><label>Learner Surname:</label><?php echo $view->getFilterHTML('filter_surname'); ?></div>
							<div class="field float"><label>Coach:</label><?php echo $view->getFilterHTML('filter_coach'); ?></div>
