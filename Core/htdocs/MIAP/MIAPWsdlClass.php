<?php
/**
 * File for MIAPWsdlClass to communicate with SOAP service
 * @package MIAP
 * @date 2014-08-05
 ...
 */
/**
 * MIAPWsdlClass to communicate with SOAP service
 * 
 * @package MIAP
 * @date 2014-08-05
 * @author Mikaël DELSOL
 * @version 1
 */
class MIAPWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    //const VALUE_WSDL_URL = 'https://ws.lrs.imservices.org.uk/learnerservice.svc?singleWsdl';
	const VALUE_WSDL_URL = 'miap.wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses MIAPWsdlClass::setLastError()
     * @uses MIAPWsdlClass::initSoapClient()
     * @uses MIAPWsdlClass::initInternArrayToIterate()
     * @uses MIAPWsdlClass::_set()
    ...
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'MIAPWsdlClass'))
            {
     ...
     * @uses MIAPClassMap::classMap()
     * @uses MIAPWsdlClass::getDefaultWsdlOptions()
     * @uses MIAPWsdlClass::getSoapClientClassName()
     * @uses MIAPWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('MIAPClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = MIAPClassMap::classMap();
     ...
     * If a class is named as {MIAP}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('MIAPSoapClient') && is_subclass_of('MIAPSoapClient','SoapClient'))
            return 'MIAPSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses MIAPWsdlClass::WSDL_CACHE_WSDL
     * @uses MIAPWsdlClass::WSDL_COMPRESSION
     * @uses MIAPWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses MIAPWsdlClass::WSDL_ENCODING
     * @uses MIAPWsdlClass::WSDL_EXCEPTIONS
     * @uses MIAPWsdlClass::WSDL_FEATURES
     * @uses MIAPWsdlClass::WSDL_LOGIN
     * @uses MIAPWsdlClass::WSDL_PASSWORD
     * @uses MIAPWsdlClass::WSDL_SOAP_VERSION
     * @uses MIAPWsdlClass::WSDL_STREAM_CONTEXT
     * @uses MIAPWsdlClass::WSDL_TRACE
     * @uses MIAPWsdlClass::WSDL_TYPEMAP
     * @uses MIAPWsdlClass::WSDL_URL
     * @uses MIAPWsdlClass::VALUE_WSDL_URL
     * @uses MIAPWsdlClass::WSDL_USER_AGENT
     * @uses MIAPWsdlClass::WSDL_PROXY_HOST
     * @uses MIAPWsdlClass::WSDL_PROXY_PORT
     * @uses MIAPWsdlClass::WSDL_PROXY_LOGIN
     * @uses MIAPWsdlClass::WSDL_PROXY_PASSWORD
     * @uses MIAPWsdlClass::WSDL_LOCAL_CERT
     * @uses MIAPWsdlClass::WSDL_PASSPHRASE
     * @uses MIAPWsdlClass::WSDL_AUTHENTICATION
     * @uses MIAPWsdlClass::WSDL_SSL_METHOD
    ...
    public static function getDefaultWsdlOptions()
    {
        return array(
                    ...
                    self::WSDL_SSL_METHOD=>'SOAP_SSL_METHOD_SSLv3');
    }
    /**
     ...
     * @uses MIAPWsdlClass::getSoapClient()
     * @uses MIAPWsdlClass::getFormatedXml()
     ...
     * @uses MIAPWsdlClass::getSoapClient()
     * @uses MIAPWsdlClass::convertStringHeadersToArray()
     ...
     * @uses MIAPWsdlClass::getInternArrayToIterate()
     * @uses MIAPWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses MIAPWsdlClass::getInternArrayToIterateOffset()
     * @uses MIAPWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses MIAPWsdlClass::getInternArrayToIterateOffset()
     * @uses MIAPWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @uses MIAPWsdlClass::getAttributeName()
     * @uses MIAPWsdlClass::__toString()
     * @uses MIAPWsdlClass::_set()
     * @uses MIAPWsdlClass::_get()
     * @uses MIAPWsdlClass::setInternArrayToIterate()
     * @uses MIAPWsdlClass::setInternArrayToIterateIsArray()
     * @uses MIAPWsdlClass::setInternArrayToIterateOffset()
