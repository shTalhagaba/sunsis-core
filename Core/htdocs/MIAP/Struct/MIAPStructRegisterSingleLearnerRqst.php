<?php
/**
 * File for class MIAPStructRegisterSingleLearnerRqst
 * @package MIAP
 * @subpackage Structs
 * @date 2014-08-05
 ...
 */
/**
 * This class stands for MIAPStructRegisterSingleLearnerRqst originally named RegisterSingleLearnerRqst
 ...
 * @version 1
 */
class MIAPStructRegisterSingleLearnerRqst extends MIAPWsdlClass
{
    /**
     * The OrgPassword
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 1
     * - nillable : false
     * @var MIAPStructLearnerToRegister
     */
    public $Learner;
    /**
     * The OrganisationRef
    ...
    public $UKPRN;
    /**
     * Constructor method for RegisterSingleLearnerRqst
     * @see parent::__construct()
     * @param string $_orgPassword
     * @param string $_userName
     * @param MIAPStructLearnerToRegister $_learner
     * @param string $_organisationRef
     * @param string $_uKPRN
     * @return MIAPStructRegisterSingleLearnerRqst
     */
    ...
    /**
     * Set Learner value
     * @param MIAPStructLearnerToRegister $_learner the Learner
     * @return MIAPStructLearnerToRegister
     */
