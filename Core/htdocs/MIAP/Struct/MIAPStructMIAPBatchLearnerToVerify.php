<?php
/**
 * File for class MIAPStructMIAPBatchLearnerToVerify
 * @package MIAP
 * @subpackage Structs
 * @date 2014-08-05
 ...
 */
/**
 * This class stands for MIAPStructMIAPBatchLearnerToVerify originally named MIAPBatchLearnerToVerify
 ...
 * @version 1
 */
class MIAPStructMIAPBatchLearnerToVerify extends MIAPWsdlClass
{
    /**
     * The ULN
     * Meta informations extracted from the WSDL
    ...
    public $Gender;
    /**
     * Constructor method for MIAPBatchLearnerToVerify
     ...
     */
    public function __construct($_uLN,$_familyName,$_givenName,$_mISIdentifier = NULL,$_dateOfBirth = NULL,$_gender = NULL)
    {
        parent::__construct(array('ULN'=>$_uLN,'FamilyName'=>$_familyName,'GivenName'=>$_givenName,'MISIdentifier'=>$_mISIdentifier,'DateOfBirth'=>$_dateOfBirth,'Gender'=>$_gender),false);
    }
    /**
     * Get ULN value
     * @return string
