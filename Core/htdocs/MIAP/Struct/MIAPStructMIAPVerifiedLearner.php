<?php
/**
 * File for class MIAPStructMIAPVerifiedLearner
 * @package MIAP
 * @subpackage Structs
 * @date 2014-08-05
 ...
 */
/**
 * This class stands for MIAPStructMIAPVerifiedLearner originally named MIAPVerifiedLearner
 ...
 * @version 1
 */
class MIAPStructMIAPVerifiedLearner extends MIAPWsdlClass
{
    /**
     * The SearchedULN
     * Meta informations extracted from the WSDL
    ...
    public $FailureFlag;
    /**
     * Constructor method for MIAPVerifiedLearner
     ...
     */
    public function __construct($_searchedULN,$_searchedFamilyName,$_searchedGivenName,$_responseCode,$_searchedDateOfBirth = NULL,$_searchedGender = NULL,$_uLN = NULL,$_familyName = NULL,$_givenName = NULL,$_dateOfBirth = NULL,$_gender = NULL,$_failureFlag = NULL)
    {
        parent::__construct(array('SearchedULN'=>$_searchedULN,'SearchedFamilyName'=>$_searchedFamilyName,'SearchedGivenName'=>$_searchedGivenName,'ResponseCode'=>$_responseCode,'SearchedDateOfBirth'=>$_searchedDateOfBirth,'SearchedGender'=>$_searchedGender,'ULN'=>$_uLN,'FamilyName'=>$_familyName,'GivenName'=>$_givenName,'DateOfBirth'=>$_dateOfBirth,'Gender'=>$_gender,'FailureFlag'=>$_failureFlag),false);
    }
    /**
