<?php
/**
 * File for class MIAPStructRetrieveULNsRqst
 * @package MIAP
 * @subpackage Structs
 * @date 2014-08-05
 ...
 */
/**
 * This class stands for MIAPStructRetrieveULNsRqst originally named RetrieveULNsRqst
 ...
 * @version 1
 */
class MIAPStructRetrieveULNsRqst extends MIAPWsdlClass
{
    /**
     * The OrgPassword
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs : 1
     * - nillable : false
     * @var MIAPStructMIAPULNsToRetrieve
     */
    public $ULNsToRetrieve;
    /**
     * The OrganisationRef
     * Meta informations extracted from the WSDL
     * - maxOccurs : 1
    ...
    public $UKPRN;
    /**
     * Constructor method for RetrieveULNsRqst
     * @see parent::__construct()
     * @param string $_orgPassword
     * @param string $_userName
     * @param MIAPStructMIAPULNsToRetrieve $_uLNsToRetrieve
     * @param string $_organisationRef
     * @param string $_uKPRN
     * @return MIAPStructRetrieveULNsRqst
     */
    public function __construct($_orgPassword,$_userName,$_uLNsToRetrieve,$_organisationRef = NULL,$_uKPRN = NULL)
    {
        parent::__construct(array('OrgPassword'=>$_orgPassword,'UserName'=>$_userName,'ULNsToRetrieve'=>$_uLNsToRetrieve,'OrganisationRef'=>$_organisationRef,'UKPRN'=>$_uKPRN),false);
    }
    /**
    ...
    /**
     * Set ULNsToRetrieve value
     * @param MIAPStructMIAPULNsToRetrieve $_uLNsToRetrieve the ULNsToRetrieve
     * @return MIAPStructMIAPULNsToRetrieve
     */
    public function setULNsToRetrieve($_uLNsToRetrieve)
    {
        return ($this->ULNsToRetrieve = $_uLNsToRetrieve);
    }
    /**
