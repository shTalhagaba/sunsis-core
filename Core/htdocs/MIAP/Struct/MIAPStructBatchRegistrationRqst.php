<?php
/**
 * File for class MIAPStructBatchRegistrationRqst
 * @package MIAP
 * @subpackage Structs
 * @date 2014-08-05
 ...
 */
/**
 * This class stands for MIAPStructBatchRegistrationRqst originally named BatchRegistrationRqst
 ...
 * @version 1
 */
class MIAPStructBatchRegistrationRqst extends MIAPWsdlClass
{
    /**
     * The OrgPassword
     * Meta informations extracted from the WSDL
    ...
    public $UKPRN;
    /**
     * Constructor method for BatchRegistrationRqst
     * @see parent::__construct()
     * @param string $_orgPassword
     * @param string $_userName
     * @param string $_jobType
     * @param int $_learnerRecordCount
     * @param MIAPStructBatchLearner $_learner
     * @param string $_organisationRef
     * @param string $_uKPRN
     * @return MIAPStructBatchRegistrationRqst
     */
    public function __construct($_orgPassword,$_userName,$_jobType,$_learnerRecordCount,$_learner,$_organisationRef = NULL,$_uKPRN = NULL)
    {
        parent::__construct(array('OrgPassword'=>$_orgPassword,'UserName'=>$_userName,'JobType'=>$_jobType,'LearnerRecordCount'=>$_learnerRecordCount,'Learner'=>$_learner,'OrganisationRef'=>$_organisationRef,'UKPRN'=>$_uKPRN),false);
    }
    /**
    ...
    /**
     * Set JobType value
     * @param string $_jobType the JobType
     * @return string
     */
    public function setJobType($_jobType)
    {
        return ($this->JobType = $_jobType);
    }
    /**
    ...
    /**
     * Set Learner value
     * @param MIAPStructBatchLearner $_learner the Learner
     * @return MIAPStructBatchLearner
     */
