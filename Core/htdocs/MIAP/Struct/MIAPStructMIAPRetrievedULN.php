<?php
/**
 * File for class MIAPStructMIAPRetrievedULN
 * @package MIAP
 * @subpackage Structs
 * @date 2014-08-05
 ...
 */
/**
 * This class stands for MIAPStructMIAPRetrievedULN originally named MIAPRetrievedULN
 ...
 * @version 1
 */
class MIAPStructMIAPRetrievedULN extends MIAPWsdlClass
{
    /**
     * The ULN
     * Meta informations extracted from the WSDL
    ...
    public $Gender;
    /**
     * Constructor method for MIAPRetrievedULN
     ...
     */
    public function __construct($_uLN,$_masterULN = NULL,$_responseCode = NULL,$_familyName = NULL,$_givenName = NULL,$_dateOfBirth = NULL,$_gender = NULL)
    {
        parent::__construct(array('ULN'=>$_uLN,'MasterULN'=>$_masterULN,'ResponseCode'=>$_responseCode,'FamilyName'=>$_familyName,'GivenName'=>$_givenName,'DateOfBirth'=>$_dateOfBirth,'Gender'=>$_gender),false);
    }
    /**
     * Get ULN value
     * @return string
