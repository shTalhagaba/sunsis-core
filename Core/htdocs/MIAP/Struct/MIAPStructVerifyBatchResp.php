<?php
/**
 * File for class MIAPStructVerifyBatchResp
 * @package MIAP
 * @subpackage Structs
 * @date 2014-08-05
 ...
 */
/**
 * This class stands for MIAPStructVerifyBatchResp originally named VerifyBatchResp
 ...
 * @version 1
 */
class MIAPStructVerifyBatchResp extends MIAPWsdlClass
{
    /**
     * The ResponseCode
     * Meta informations extracted from the WSDL
    ...
    public $JobID;
    /**
     * Constructor method for VerifyBatchResp
