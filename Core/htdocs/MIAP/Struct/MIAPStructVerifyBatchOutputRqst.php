<?php
/**
 * File for class MIAPStructVerifyBatchOutputRqst
 * @package MIAP
 * @subpackage Structs
 * @date 2014-08-05
 ...
 */
/**
 * This class stands for MIAPStructVerifyBatchOutputRqst originally named VerifyBatchOutputRqst
 ...
 * @version 1
 */
class MIAPStructVerifyBatchOutputRqst extends MIAPWsdlClass
{
    /**
     * The OrgPassword
     * Meta informations extracted from the WSDL
    ...
    public $UKPRN;
    /**
     * Constructor method for VerifyBatchOutputRqst
     ...
     * @param string $_uKPRN
     * @return MIAPStructVerifyBatchOutputRqst
     */
