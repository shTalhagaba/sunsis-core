<?php
class edit_rm_employer implements IAction
{
	public function execute(PDO $link)
	{
		...
		$_SESSION['bc']->add($link, "do.php?_action=edit_rm_employer&id=" . $id, $page_title);
		...
		// Presentation
		include('tpl_edit_rm_employer.php');
	}
}
?>