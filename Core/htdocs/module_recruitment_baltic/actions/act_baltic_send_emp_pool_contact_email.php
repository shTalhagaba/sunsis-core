<?php
class baltic_send_emp_pool_contact_email implements IAction
{
	public function execute(PDO $link)
	{
		...
		$_SESSION['bc']->add($link, "do.php?_action=send_candidate_email&contact_id=" . $contact_id , "Send Email to Candidate");
...
//			http_redirect("/do.php?_action=read_candidate_crm&contact_id=$contact_id");
		}
		...
		// Presentation
		include('tpl_baltic_send_emp_pool_contact_email.php');
	}
