...
class baltic_update_candidate implements IAction
{
	public function execute(PDO $link) {
		//if(SOURCE_BLYTHE_VALLEY)pre($_REQUEST);
		...
		$registration->has_been_screened = 1;
		...
		$this->update_qualifications($link, $registration);
	...
	function update_qualifications(PDO $link, Candidate $registration)
	{
		// save qualifications
