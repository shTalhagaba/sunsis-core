...
<div class="banner">
	...
	<div class="ActionIconBar">
		...
		<button onclick="window.location.href='do.php?_action=view_vacancies&export=csv'" title="Export to .CSV file">
			<img src="/images/btn-excel.gif"/></button>
...
?>
<div id="infoblock">
	<?php $_SESSION['bc']->render($link); ?><?php echo $view->getFilterCrumbs() ?><br><br>
	...
	<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter">
		...
		<div id="filterBox" class="clearfix">
			...
			<fieldset>
				...
				<div class="field float">
					<label>Location Postcode:</label> <?php echo $view->getFilterHTML('filter_employerpostcode'); ?>
				</div>
				<div class="field float">
					<label>Vacancy Sector:</label> <?php echo $view->getFilterHTML('filter_sectortype'); ?>
				</div>
				<div class="field float">
					<label>Vacancy BRM:</label> <?php echo $view->getFilterHTML('filter_brm'); ?>
				</div>
				<div class="field float">
					<label>Vacancy Filled/Not Filled:</label> <?php echo $view->getFilterHTML('filter_vacancy_live'); ?>
				</div>
				<div class="field float">
					<label>Recruitment Stage:</label><?php echo $view->getFilterHTML('filter_rec_stage'); ?>
				</div>
				<div class="field float">
					<label>Vacancy Code/Reference:</label><?php echo $view->getFilterHTML('filter_vacancy_code'); ?>
				</div>
				<div class="field newrow">
					<label>Vacancy Region:</label><?php echo $view->getFilterHTML('filter_region'); ?>
				</div>
				<div class="field float">
					<label>Year Expected To Fill:</label><?php echo $view->getFilterHTML('filter_year_expected_to_fill'); ?>
				</div>
				<div class="field float">
					<label>Month Expected To Fill:</label><?php echo $view->getFilterHTML('filter_month_expected_to_fill'); ?>
				</div>
			</fieldset>
			<fieldset>
				<legend>Dates</legend>
			...
			<fieldset>
				<input type="submit" value="Apply"/>&nbsp;<input type="button"
				                                                 onclick="resetViewFilters(document.forms[1]);"
				                                                 value="Reset"/>&nbsp;<input type="button"
				                                                                             name="saveFilter"
				                                                                             value="Save"
				                                                                             onclick="doSaveFilter(); return false;"/>
			</fieldset>
		</div>
	</form>
</div>
