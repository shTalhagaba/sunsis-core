...
<body>
<div class="banner">
	<div class="Title">Forecast Vacancies</div>
	<div class="ButtonBar">
	</div>
	<div class="ActionIconBar">
		...
		<button onclick="exportToExcel('view_ViewForecastVacancies')" title="Export to .CSV file"><img src="/images/btn-excel.gif" width="16" height="16" style="vertical-align:text-bottom" alt="" /></button>
...
<form method="get" action="#" id="applySavedFilter">
	<input type="hidden" name="_action" value="view_forecast_vacancies" />
...
<input type="hidden" name="_action" value="baltic_view_forecast_vacancies" />
