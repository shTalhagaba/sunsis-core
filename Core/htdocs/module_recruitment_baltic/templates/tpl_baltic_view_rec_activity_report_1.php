<?php /* @var $view ViewRecActivityReport1 */  ?>
...
<body>
<div class="banner">
	<div class="Title">View Recruitment Activity Report (Prospect)</div>
	<div class="ButtonBar">
	</div>
	<div class="ActionIconBar">
		...
		<button onclick="exportToExcel('view_ViewRecActivityReport1')" title="Export to .CSV file"><img src="/images/btn-excel.gif" width="16" height="16" style="vertical-align:text-bottom" alt="" /></button>
...
<div id="div_filters" style="display: none">
	...
	<form method="get" action="#" id="applySavedFilter">
		<input type="hidden" name="_action" value="baltic_view_rec_activity_report_1" />
	...
	<form method="get" name="filters" action="<?php echo $_SERVER['PHP_SELF']; ?>" id="applyFilter">
		...
		<div id="filterBox" class="clearfix">
			...
			<fieldset>
				...
				<div class="field float">
					<label>CRM Subject:</label><?php echo $view->getFilterHTML('filter_subject'); ?>
				</div>
				<div class="field float">
					<label>CRM Next Action:</label><?php echo $view->getFilterHTML('filter_next_action'); ?>
				</div>
			</fieldset>
