<?php /* @var $view ViewRecActivityReport */  ?>
...
<body>
<div class="banner">
	<div class="Title">View Recruitment Activity Report (Candidate)</div>
	<div class="ButtonBar">
	</div>
	<div class="ActionIconBar">
		...
		<button onclick="exportToExcel('view_ViewRecActivityReport')" title="Export to .CSV file"><img src="/images/btn-excel.gif" width="16" height="16" style="vertical-align:text-bottom" alt="" /></button>
...
<div id="div_filters" style="display: none">
	...
	<form method="get" action="#" id="applySavedFilter">
		<input type="hidden" name="_action" value="baltic_view_rec_activity_report" />
