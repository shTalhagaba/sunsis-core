<?php /* @var $vo ViewProspectCRMNotesReport */  ?>
...
<body>
<div class="banner">
	<div class="Title">View Prospect CRM Notes Report</div>
	<div class="ButtonBar">
	</div>
	<div class="ActionIconBar">
		...
		<button onclick="exportToExcel('view_ViewProspectCRMNotesReport')" title="Export to .CSV file"><img src="/images/btn-excel.gif" width="16" height="16" style="vertical-align:text-bottom" alt="" /></button>
...
<div id="div_filters" style="display: none">
	...
	<form method="get" action="#" id="applySavedFilter">
		<input type="hidden" name="_action" value="baltic_view_prospect_crm_notes_report" />
