...
<head>
	...
	<meta property="og:url" content="https://baltic.sunesis.uk.net/do.php?_action=view_candidate_vacancies"/>
	...
	<title>Baltic Training Services - Vacancies</title>
		...
		<form action="do.php">
			...
			<div id="registration_2" class="formentry" >
				...
				if(DB_NAME=="am_demo" || DB_NAME=="am_baltic_demo" || DB_NAME=="am_baltic")
					echo $view->render_candidate_for_baltic($link);
				else
