...
<body>
    ...
    <div class="container-fluid">
        <h1 class="text-center">Digital Skills Bootcamp Registration Form</h1>

        <content id="landingPage" >
            <div style="background:transparent !important" class="jumbotron text-center">
                <h2>
                    Welcome, <?php echo $learner->firstnames . ' ' . $learner->surname; ?>
                </h2>
        ...
        <content id="contentForm" style="display: none;">
            <h3 class="text-center">Registration for <?php echo $learner->firstnames . ' ' . $learner->surname; ?></h3>
            <form class="form-horizontal" name="frmOnboarding" id="frmOnboarding" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" autocomplete="off" enctype="multipart/form-data">
                <input type="hidden" name="_action" value="save_bc_form_learner_registration"/>
                <input type="hidden" name="id" value="<?php echo $learner->id; ?>"/>
                <input type="hidden" name="key" value="<?php echo $key; ?>"/>
                <input type="hidden" name="is_finished" value="<?php $extraInfo->is_finished; ?>"/>
