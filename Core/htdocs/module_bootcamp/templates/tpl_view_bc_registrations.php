...
<body>
    <div class="row">
        <div class="col-lg-12">
            <div class="banner">
                <div class="Title" style="margin-left: 6px;">Applicants</div>
                <div class="ButtonBar">
                    <span class="btn btn-xs btn-default" onclick="window.location.href='do.php?_action=create_bc_registration'">
                        <i class="fa fa-plus"></i><i class="fa fa-user"></i> Create Applicant
                    </span>
                </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <form method="get" action="#" id="applySavedFilter" style="display: none;">
                    <input type="hidden" name="_action" value="view_bc_registrations" />
                    ...
                    <form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" name="applyFilter" id="applyFilter">
                        ...
                        <div id="filterBox" class="clearfix small">
                            <fieldset>
                                ...
                                <div class="field float"><label>Signed date between:</label><?php echo $view->getFilterHTML('filter_from_learner_sign_date'); ?> &nbsp;and&nbsp; <?php echo $view->getFilterHTML('filter_to_learner_sign_date'); ?></div>
                            </fieldset>
                            <fieldset>
