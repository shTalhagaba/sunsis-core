...
<div class="row">
	<div class="col-lg-12">
		<div class="banner">
			<div class="Title" style="margin-left: 6px;">View Opportunities</div>
			<div class="ButtonBar">
...
<!--				<span class="btn btn-sm btn-default" onclick="window.location.href='do.php?_action=edit_opportunity&id=';"><i class="fa fa-plus"></i> Create New</span>-->
			</div>
			<div class="ActionIconBar">
				...
				<span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="window.location.href='do.php?_action=view_opportunities&subaction=export_csv'" title="Export to .CSV file"></span>
	...
	<div class="row">
		<div id="div_filters" style="display:none">
			<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter" name="applyFilter">
				...
				<input type="hidden" name="_action" value="view_opportunities" />
...
<script language="JavaScript">
	...
	function show_graphs()
	{
		...
		myForm.elements['_action'].value = 'view_opportunities';
		myForm.submit();
	}
