...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;">Edit HS Form</div>
            <div class="ButtonBar">
...
<div class="content-wrapper" >
    ...
    <section class="content">
        <form role="form" name="frmHs" id="frmHs" method="post"
            ...
            <input type="hidden" name="_action" value="update_duplex_hs_form">
            <input type="hidden" name="id" value="<?php echo $hs_form->id; ?>">
            <input type="hidden" name="learner_id" value="<?php echo $hs_form->learner_id; ?>">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-condensed">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-bold">DOB: </span> <br><?php echo Date::toShort($learner->dob); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <span class="text-bold">Job Role: </span> <input type="text" name="job_role" id="job_role" class="form-control" value="<?php echo $learner->job_role; ?>">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <span class="text-bold">Home Postcode: </span>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <span class="text-bold">Line Manager: </span><br>
                                                <?php
                                                echo $learner->line_manager . '<br>' . $learner->line_manager_tel . '<br>' . $learner->line_manager_email;
                                                ?>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-condensed">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="checkbox" name="s2c1" id="s2c1" value="1" <?php echo $hs_form->s2c1 == 1 ? 'checked' : ''; ?> >
                                            </td>
                                            <td style="width: 30%;">
                                                <textarea name="s2d1" id="s2d1" style="width: 100%" rows="3"><?php echo $hs_form->s2d1; ?></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 60%;">
                                            ...
                                            <td>
                                                <input type="checkbox" name="s2c2" id="s2c2" value="1" <?php echo $hs_form->s2c2 == 1 ? 'checked' : ''; ?>>
                                            </td>
                                            <td style="width: 30%;">
                                                <textarea name="s2d2" id="s2d2" style="width: 100%" rows="3"> <?php echo $hs_form->s2d2; ?></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 60%;">
                                            ...
                                            <td>
                                                <input type="checkbox" name="s2c3" id="s2c3" value="1" <?php echo $hs_form->s2c3 == 1 ? 'checked' : ''; ?>>
                                            </td>
                                            <td style="width: 30%;">
                                                <textarea name="s2d3" id="s2d3" style="width: 100%" rows="3"> <?php echo $hs_form->s2d3; ?></textarea>
                                            </td>
                                        </tr>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-condensed">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="radio" name="s3c1" value="0" <?php echo (!is_null($hs_form->s3c1) && $hs_form->s3c1 == 0) ? 'checked' : ''; ?>>&nbsp;&nbsp;No</td>
                                            <td><input type="radio" name="s3c1" value="1" <?php echo (!is_null($hs_form->s3c1) && $hs_form->s3c1 == 1) ? 'checked' : ''; ?>>&nbsp;&nbsp;Yes</td>
                                        </tr>
                                        <tr>
                                            <td style="width: 80%;">Do you have, or require the use of, an ICD (implantable cardioverter defibrillator)?</td>
                                            <td><input type="radio" name="s3c4" value="0" <?php echo (!is_null($hs_form->s3c4) && $hs_form->s3c4 == 0) ? 'checked' : ''; ?>>&nbsp;&nbsp;No</td>
                                            <td><input type="radio" name="s3c4" value="1" <?php echo (!is_null($hs_form->s3c4) && $hs_form->s3c4 == 1) ? 'checked' : ''; ?>>&nbsp;&nbsp;Yes</td>
                                        </tr>
                                        <tr>
                                            <td style="width: 80%;">Do you have, or require the use of, an insulin pump?</td>
                                            <td><input type="radio" name="s3c5" value="0" <?php echo (!is_null($hs_form->s3c5) && $hs_form->s3c5 == 0) ? 'checked' : ''; ?>>&nbsp;&nbsp;No</td>
                                            <td><input type="radio" name="s3c5" value="1" <?php echo (!is_null($hs_form->s3c5) && $hs_form->s3c5 == 1) ? 'checked' : ''; ?>>&nbsp;&nbsp;Yes</td>
                                        </tr>
                                        <tr>
                                            <td style="width: 80%;">
                                            ...
                                            <td><input type="radio" name="s3c2" value="0" <?php echo (!is_null($hs_form->s3c2) && $hs_form->s3c2 == 0) ? 'checked' : ''; ?>>&nbsp;&nbsp;No</td>
                                            <td><input type="radio" name="s3c2" value="1" <?php echo (!is_null($hs_form->s3c2) && $hs_form->s3c2 == 1) ? 'checked' : ''; ?>>&nbsp;&nbsp;Yes</td>
                                        </tr>
                                        <tr>
                                            <td style="width: 80%;">
                                                Do you have any learning difficulties that we need to be aware of?
                                            </td>
                                            <td><input type="radio" name="s3c6" value="0" <?php echo (!is_null($hs_form->s3c6) && $hs_form->s3c6 == 0) ? 'checked' : ''; ?>>&nbsp;&nbsp;No</td>
                                            <td><input type="radio" name="s3c6" value="1" <?php echo (!is_null($hs_form->s3c6) && $hs_form->s3c6 == 1) ? 'checked' : ''; ?>>&nbsp;&nbsp;Yes</td>
                                        </tr>                                        
                                        <tr>
                                            <td colspan="3">
                                                If yes, please provide details about your learning difficulty:<br>
                                                <textarea name="s3c6_detail" id="s3c6_detail" style="width: 100%;"><?php echo nl2br($hs_form->s3c6_detail); ?></textarea>
                                            </td>
                                        </tr>
			...
			<div class="row">
                            <div class="col-sm-12">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-condensed">
                                        ...
                                        <tr>
                                            <td style="width: 80%;">I can clearly distinguish the colour <span class="text-bold">"orange"</span>.</td>
                                            <td><input type="radio" name="s3c3" value="1" <?php echo (!is_null($hs_form->s3c3) && $hs_form->s3c3 == 1) ? 'checked' : ''; ?>>&nbsp;&nbsp;Yes <i class="fa fa-smile-o text-green"></i></td>
                                            <td><input type="radio" name="s3c3" value="0" <?php echo (!is_null($hs_form->s3c3) && $hs_form->s3c3 == 0) ? 'checked' : ''; ?>>&nbsp;&nbsp;No <i class="fa fa-meh-o"></i></td>
                                        </tr>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-condensed">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="checkbox" name="s4c1" id="s4c1" value="1" <?php echo $hs_form->s4c1 == 1 ? 'checked' : ''; ?>>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 80%;">
                                            ...
                                            <td>
                                                <input type="checkbox" name="s4c2" id="s4c2" value="1" <?php echo $hs_form->s4c2 == 1 ? 'checked' : ''; ?>>
                                            </td>
                                        </tr>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-condensed">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="checkbox" name="gdpr1" id="gdpr1" value="1" <?php echo $hs_form->gdpr1 == 1 ? 'checked' : ''; ?>>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 80%;">
                                            ...
                                            <td>
                                                <input type="checkbox" name="gdpr2" id="gdpr2" value="1" <?php echo $hs_form->gdpr2 == 1 ? 'checked' : ''; ?>>
                                            </td>
                                        </tr>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <button type="submit" class="btn btn-success btn-block btn-md"><i class="fa fa-save"></i> Save Information</button>
                            </div>
                        </div>
