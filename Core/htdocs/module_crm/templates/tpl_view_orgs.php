...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;">View Organisations</div>
            <div class="ButtonBar">
            ...
            <div class="ActionIconBar">
                ...
                <span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="window.location.href='do.php?_action=view_orgs&subaction=export_csv'" title="Export to .CSV file"></span>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div id="div_filters" style="display:none">
                <form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter" name="applyFilter">
                    ...
                    <input type="hidden" name="_action" value="view_orgs" />
			    ...
			    <div class="field float"><label>Employer/Pool:</label><?php echo $view->getFilterHTML('filter_org_type'); ?></div>	
...
<script language="JavaScript">
    ...
    function show_graphs()
    {
        ...
        myForm.elements['_action'].value = 'view_orgs';
        myForm.submit();
    }
