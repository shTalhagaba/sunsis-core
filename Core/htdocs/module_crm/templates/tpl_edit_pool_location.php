...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-7">
            <div class="callout">
                <span class="lead text-bold"><?php echo $pool->legal_name; ?></span>
            </div>
            <form class="form-horizontal" name="frmLocation" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                <input type="hidden" name="_action" value="save_pool_location" />
                <input type="hidden" name="id" value="<?php echo $location->id; ?>" />
                <input type="hidden" name="pool_id" value="<?php echo $location->pool_id; ?>" />

                <div class="box box-solid box-primary">
                    <div class="box-header with-border">
                        <h2 class="box-title">Pool Location Details</h2>
                    </div>
                    <div class="box-body">
