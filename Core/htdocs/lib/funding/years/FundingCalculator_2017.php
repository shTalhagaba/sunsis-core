...
class FundingCalculator_2017 extends FundingCalculator
{
    ...
    public function getData($link, $hook_fields = '', $hook_joins = '', $hook_where = '')
    {
        ...
        {
            $ilr = Ilr2017::loadFromXML($rowxml['ilr']);
                ...
                if($a10!='99' && $a10!='')
                {
                    ...
                    if($xmlarray['FundModel']=='36')
                        if($xmlarray['StdCode']!='')
                            ...
                            $xmlarray['LevyCap'] = DAO::getSingleValue($link, "SELECT MaxEmployerLevyCap FROM lars201718.Core_LARS_ApprenticeshipFunding WHERE ApprenticeshipType = 'FWK' AND ApprenticeshipCode='{$xmlarray['FworkCode']}' and PwayCode='{$xmlarray['PwayCode']}' AND EffectiveFrom<='$a27' and (EffectiveTO is null or EffectiveTo>='$a27')");
