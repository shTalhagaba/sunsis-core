...
class FundingCalculator_2021 extends FundingCalculator
{
    ...
    public function getData($link, $hook_fields = '', $hook_joins = '', $hook_where = '')
    {
        ...
        {
            $ilr = Ilr2021::loadFromXML($rowxml['ilr']);
...
//        $learners = $ilrs->getElementsByTagName("Learner");
        ...
        $the_first_day_of_the_current_funding_year = "2020-08-01";
        $the_last_day_of_the_current_funding_year = "2021-07-31";
