...
class FundingCalculator_2024 extends FundingCalculator
{
    ...
    public function getData($link, $hook_fields = '', $hook_joins = '', $hook_where = '')
    {
        ...
        {
            $ilr = Ilr2024::loadFromXML($rowxml['ilr']);
...
//        $learners = $ilrs->getElementsByTagName("Learner");
        ...
        $the_first_day_of_the_current_funding_year = "2024-08-01";
        $the_last_day_of_the_current_funding_year = "2025-07-31";
