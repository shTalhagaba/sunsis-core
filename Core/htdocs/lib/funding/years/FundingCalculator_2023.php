...
class FundingCalculator_2023 extends FundingCalculator
{
    ...
    public function getData($link, $hook_fields = '', $hook_joins = '', $hook_where = '')
    {
        ...
        {
            $ilr = Ilr2023::loadFromXML($rowxml['ilr']);
...
//        $learners = $ilrs->getElementsByTagName("Learner");
        ...
        $the_first_day_of_the_current_funding_year = "2023-08-01";
        $the_last_day_of_the_current_funding_year = "2024-07-31";
