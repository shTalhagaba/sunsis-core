...
class KPI_Report_newstarts_period6 extends KPI_Report
{
	...
	protected function getData($link)
	{
		...
		$sql = "
			...
			WHERE 
				tr.start_date >= '2011-08-01' and tr.start_date <= '2012-07-31' $where ORDER BY tr.start_date, tr.surname ASC;";
