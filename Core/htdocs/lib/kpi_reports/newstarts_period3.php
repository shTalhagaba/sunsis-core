...
class KPI_Report_newstarts_period3 extends KPI_Report
{
	...
	protected function getData($link)
	{
		...
		$sql = "
			...
			LEFT JOIN
				central.lookup_submission_dates on tr.start_date >= central.lookup_submission_dates.census_start_date and tr.start_date <= central.lookup_submission_dates.census_end_date and submission!='W13'
			LEFT JOIN
			...
			WHERE 
				status_code = 1 AND tr.start_date >= '2008-08-01' and tr.start_date <= '2009-07-31' $where ORDER BY tr.start_date, tr.surname ASC";
