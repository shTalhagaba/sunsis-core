    ...
    private function rule_Learning_Delivery_Rules($link, $ilr)
    {
        ...
        foreach($ilr->LearningDelivery as $delivery)
        {
            ...
            if(isset($AchDate_Date))
                if($AchDate_Date->after("31/07/2018"))
            ...
            //AimType_06
            if($AimType=='5' && $LearnStartDate_Date->after("31/08/2018") && $FundModel=='25')
            {
            ...
            //LearnStartDate_03
            if($DD07=="N" && $ProgType!='24' && $LearnStartDate_Date->after("31/07/2018"))
            ...
            */
            ...
            $DateOfBirth_25_Under19 = DAO::getSingleValue($link, "SELECT IF(DATE_ADD('$DateOfBirth',INTERVAL 19 YEAR)>DATE_ADD('2017-08-31',INTERVAL 1 DAY),1,0);");
            ...
            if($LearnStartDate_Date->after("2016-07-31") and $DateOfBirth_46_Under16 != '1' and ($FundModel=='36' or $FundModel=='81') and $ProgType=='25' and $AimType=='1' and $LearnStartDate_46_date->after(Date::toMySQL($LearnPlanEndDate)))
