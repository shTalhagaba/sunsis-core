<?php
class ACLearner extends Entity
{
	/**
	 * @static
	 * @param PDO $link
	...
	public static function loadFromDatabaseById(PDO $link, $id)
	{
		...
		$username = DAO::getSingleValue($link, "SELECT username FROM ac_learners WHERE id=" . $link->quote($id));
		if (!$username) {
			return null;
		}
...
HEREDOC;
    ...
    public $most_recent_otj_progress_review = null;
    public $most_recent_otj_attendance = null;
    public $total_recorded_otj = null;
    public $development_coach = null;
    public $latest_attendance = null;
    public $latest_attendance_type = null;
    public $most_recent_review_date = null;
	public $most_recent_otj_my_portfolio = null;
