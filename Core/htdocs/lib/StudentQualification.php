...
/*		$counter = 1;
	...
	*/
	...
	{
		$qid = addslashes((string)$this->id);
		$fid = addslashes((string)$this->framework_id);
		$tr_id = addslashes((string)$this->tr_id);
...
HEREDOC;
	...
	public function toXML($prefix = null, $namespace = null)
	{
		...
		$xml = "<{$p}qualification $xmlns "
			...
			.$p.'aptitude="'.htmlspecialchars((string)$this->aptitude).'" '
			.$p.'attitude="'.htmlspecialchars((string)$this->attitude).'" '
			.$p.'comments="'.htmlspecialchars((string)$this->comments).'" '
			.$p.'level="'.htmlspecialchars((string)$this->level).'" '
			.$p.'qualification_type="'.htmlspecialchars((string)$this->qualification_type).'" '
	...
	public $onefile_learning_aim_id = NULL;
	public $pending = NULL;
	public $exemption_evidence = NULL;
	public $marker = null;
	public $fs_opt_in = NULL;
