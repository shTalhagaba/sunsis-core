...
class ValidateILR2023
{
    ...
    private function rule_Learning_Delivery_Rules($link, $ilr)
    {
        ...
        foreach($ilr->LearningDelivery as $delivery)
        {
            ...
            //R121
            if($LatestACTToDate->after("1900-01-01") && Date::isDate($delivery->AchDate) && !$LatestACTToDate->equals($delivery->AchDate))
            {
            ...
            if(isset($AchDate_Date))
                if($AchDate_Date->after("31/07/2024"))
            ...
            //LearnStartDate_03
            if($DD07=="N" && $ProgType!='24' && $LearnStartDate_Date->after("31/07/2024"))
            ...
            */
            ...
            $DateOfBirth_25_Under19 = DAO::getSingleValue($link, "SELECT IF(DATE_ADD('$DateOfBirth',INTERVAL 19 YEAR)>DATE_ADD('2023-08-31',INTERVAL 1 DAY),1,0);");
            ...
            foreach($delivery->LearningDeliveryFAM as $ldf)
            {
                if($ldf->LearnDelFAMCode!='' && $ldf->LearnDelFAMCode!='undefined')
                {
                    ...
                    if(!in_array($value,$ldm))
                        ...
                        return "R52: No two Learning Delivery FAM records should have the same UKPRN,  Learner Reference number, Aim Sequence number, LearningDeliveryFAM code and LearningDeliveryFAM type  (".$delivery->LearnAimRef. $value . ")";
                }
            }
        }
    }
