<?php
class ValidateILR2009
{
	public function validate(PDO $link, Ilr2009 $ilr)
	{
		...
		$linklis = new PDO("mysql:host=".DB_HOST.";dbname=lis200910;port=".DB_PORT, DB_USER, DB_PASSWORD);
	...
	// Field Level Validations (A Series)
			...
			private function rule_A01_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A02_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{

					if(trim($ilr->aims[$sa]->A02)!='12' && trim($ilr->aims[$sa]->A02)!='99')
					{

						return "A02_2[".$sa."]: Contract type must be 12 or 99 ";

					}
				}
			}

			private function rule_A04_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A05_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A07_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A08_3(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A09_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A09_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A10_4(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A11a_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A11b_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A13_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A14_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
...
/*			
			private function rule_A14_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
...
*/
			private function rule_A15_3(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A16_3(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					...
					if($A16!='00' && $A16!='' && $A16!='0' && $A16!=$ilr->aims[$sa]->A16)
					{
			...
			private function rule_A17_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A18_3(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A19_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A20_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A21_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{

					$query = "select Franchised_Partnership_Code from ilr_a21_franch_partnerships where franchised_partnership_code = '{$ilr->aims[0]->A21}'";
					$A21 = DAO::getSingleValue($linklis, $query);

					if($A21!='' && $A21!=$ilr->aims[$sa]->A21)
					{
						return "A21_1[".$sa."]: Franchised out partnership arrangements must be on the table if entered";
					}
				}
			}


			private function rule_A23_3(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A23_4(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A26_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A27_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A27_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A27_4(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A27_6(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A28_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A28_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A31_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A31_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A32_3(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A34_3(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A35_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A36_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A40_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A40_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A44_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A45_3(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A45_4(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A46a_7(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A46b_7(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A47a_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A47b_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A48a_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A48b_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A49_3(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
...
/*			private function rule_A50_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
...
*/
			...
			private function rule_A50_3(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A51a_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A52_3(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A53_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A54_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A54_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A55_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A56_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A57_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A58_4(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A59_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A60_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A61_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A62_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A64_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A65_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
	...
	// Single Field Validation (L Series) 		
			...
			private function rule_L01_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L02_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L03_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L03_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				$L03 = trim($ilr->learnerinformation->L03);
...
/*			private function rule_L06_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
...
*/	
			...
			private function rule_L07_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L08_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L09_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L09_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				$L09 = trim($ilr->learnerinformation->L09);
				$L09 = str_replace("&apos;","'",$L09);
			...
			private function rule_L10_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L10_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				$L10 = trim($ilr->learnerinformation->L10);
				$st="⌡♪ÑabcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ -'";
			...
			private function rule_L11_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L11_3(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L11_6(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				try
				{
					$L11 = new Date($ilr->learnerinformation->L11);
			...
			private function rule_L12_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L13_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L14_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L15_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L16_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L17_3(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L17_4(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L18_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L18_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L19_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L20_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L21_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L22_3(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L22_4(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L23_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L24_3(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L25_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L26_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L27_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L28a_8(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L28b_8(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L29_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L31_4(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L32_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L33_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L34a_6(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L34b_6(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L34c_6(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L34d_6(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L35_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L36_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L37_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L39_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L40a_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L40b_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L41a_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L41b_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L42a_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L42b_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L44_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L44_3(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L45_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			
				if(($ilr->learnerinformation->L45!='') && ((int)$ilr->learnerinformation->L45 < 1000000000 || (int)$ilr->learnerinformation->L45 > 9999999999))
				{
			...
			private function rule_L46_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L47_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L48_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L48_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L49a_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L49b_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L49c_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L49d_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A05_L05_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
...
/*			private function rule_A04_A09_LAD_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				...
				{
					return "A04_A09_LAD_1: If learning aim is a programme aim, the learning aim reference code must be ZPROG001 or a Diploma (14-19)�qualification or a Generic diploma programme aim code \n";
				}
			}
*/			
			private function rule_A04_A27_A66_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					...
					{
							return "whyA04_A27_A66_1[".$sa."]: Employment status on day before starting learning aim must be completed for all learning aims that started on or after 1 August 2009. \n";
					}
				}
			}
			
			private function rule_A09_A10_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					$A09 = trim($ilr->aims[$sa]->A09); 
					if( ($A09=='XESF0001' || $A09=='ZESF0001' || $A09=='ZESF0002') && trim($ilr->aims[$sa]->A10)!='70')
					{
						return "A09_A10_1[".$sa."]: If the learning aim is XESF0001 or ZESF0001 or ZESF0002 the LSC funding stream must be <70> LSC ESF co-financed \n";
					}
				}
			}
/*
			private function rule_A09_A10_A15_AD05_LAD_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
	...
	*/
			...
			private function rule_A09_A10_A15_AD05_LAD_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A09_A10_AD05_LAD_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A09_A10_LAD_14(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					...
					if( $A10!='80' && $A10!='70' && $learning_aim_type_code=='1438')
					{
			...
			private function rule_A09_A10_LAD_6(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					$A10 = trim($ilr->aims[$sa]->A10);
					...
					$query = "select LSC_EMP_RESP_STATUS_CODE from LSC_EMPLOYER_ANNUAL_VALUES where ACADEMIC_YEAR_CODE='0910' and learning_aim_ref='{$ilr->aims[$sa]->A09}'";
					$data = trim(DAO::getSingleValue($linklad, $query));
					
					if(($A10=='45' || $A10=='46') && $data!='1' && $data!='2' && $data!='3')
					{
						return "A09_A10_LAD_6[".$sa."]: Must exist on Employer responsive Annual Values table for year 2009/10 with valid status (1, 2 or 3) for employer responsive funded aims \n";
					}
				}
			}

			private function rule_A09_A10_LAD_7(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					$A10 = trim($ilr->aims[$sa]->A10);
					...
					$query = "select  NON_LSC_FUNDED_STATUS_CODE from all_annual_values where ACADEMIC_YEAR_CODE='0910' and learning_aim_ref='{$ilr->aims[$sa]->A09}'";
					$data = trim(DAO::getSingleValue($linklad, $query));
					
					if(($A10=='70' || $A10=='80' || $A10=='99') && $data!='1' && $data!='2')
					{
						return "A09_A10_LAD_7[".$sa."]: Must exist on All Annual Values table for year 2009/10 with valid status (1 or 2) for aims which are not learner responsive, employer responsive or ASL funded \n";
					}
				}
			}
			
			private function rule_A09_A46a_A46b_LAD_3(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A04_A10_A15_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					$A04 = trim($ilr->programmeaim->A04);
					...
					{
						return "A04_A10_A15_1[".$sa."]: The programme aim for an apprenticeship, advanced apprenticeship or higher level apprenticeship programme must have a funding stream of employer responsive \n";
					}
				}
			}
			
			private function rule_A14_L11_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
...
/*			private function rule_L28a_L28b_A10_A14_AD04_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				...
				try
				{
					for($sa=0;$sa<=$ilr->subaims;$sa++)
					{
						...
						if($A14=='01' && ($A10=='45' || $A10=='46') && $AD04>1 && $L28a != '15' && $L28b!='15')
						{
							"L28a_L28b_A10_A14_AD04_1[".$sa."]: The Reason for full funding/co-funding of learning aim must not be '16-18 year old learner' for employer responsive funded learning aims if the learner's age at the start is 19 or over unless the learner's Eligibility for enhanced funding is 'entitlement to 16-18 employer responsive funding' \n";
						}
					}
				}
				catch(Exception $e)
...
*/
			private function rule_L35_A14_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_L35_A14_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A04_A15_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					$A04 = trim($ilr->aims[$sa]->A04);
			...
			private function rule_A10_A15_A27_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					try
			...
			private function rule_A10_A15_A16_A27_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					try
			...
			private function rule_A10_A16_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A15_A16_3(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A15_A16_4(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A15_A16_5(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				...
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					...
					if(($A15!='02' && $A15!='10') && ($A16=='03' || $A16=='15'))
					{
						...
						return "A15_A16_5[".$sa."]: If programme entry route is 'progress to advanced apprenticeship from young apprenticeship' or 'progress to advanced apprenticeship from programme led pathway delivered in FE' the programme type must be advanced apprenticeship or higher level apprenticeship \n";

					}
				}
			}

			private function rule_A15_A16_6(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A16_A27(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					try
			...
			private function rule_A16_AD06(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					try
					...
					{
						return "A16_AD06[".$sa."]: the programme entry type must be not be direct for programmes starting on or after 1 August 2003 \n";
					}
				}
			}
			
			
			private function rule_A15_A18_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A04_A21_A27_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					try
					{
						...
						$A27 = new Date($ilr->aims[$sa]->A27);
						$check = new Date('01/08/2009');
	
						if($A04=='30' && $A21=='' && $A27->getDate()>=$check->getDate())
						{
							return "A04_A21_A27_1[".$sa."]: Franchised Out and Partnership arrangement must be entered for all learning aims except programme aims if the learning aim started on or after 1 August 2009 \n";
						}
					}
					catch(Exception $e)
					{
			...
			private function rule_A21_A22_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					$A21 = trim($ilr->aims[$sa]->A21);
					...
					if($A21=='99' && trim($A22!=''))
					{
						return "A21_A22_1[".$sa."]: The franchise and partnership delivery provider number must be blank if the franchised out and partnership arrangements indicate that the provision is not franchised out or delivered by a partner \n";
					}
				}
			}
			
			private function rule_A21_A22_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					$A21 = trim($ilr->aims[$sa]->A21);
					...
					if( ($A21!='99' && $A21!='00' && $A21!='') && trim($A22==''))
					{
						return "A21_A22_2[".$sa."]: The franchise and partnership delivery provider number must be present if the franchised out and partnership arrangements indicate that the provision is franchised out or delivered by a partner\n";
					}
				}
			}
			
			private function rule_A10_A23_A27_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
...
/*			private function rule_A09_A10_A15_A26_A27_LAD_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				try
				{
					for($sa=0;$sa<=$ilr->subaims;$sa++)
...
*/
			...
			private function rule_A15_A26_3(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A15_A26_4(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A09_A10_A15_A26_A27_AD05_LAD_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A10_A27_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					try
			...
			private function rule_A10_A27_T08_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A27_L11_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					try
			...
			private function rule_A27_A28_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A27_A28_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A27_A31_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A31_A34_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A31_A34_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A31_T08_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A27_A28_A32_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A34_A35_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A34_A35_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A35_A40_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A09_A36_LAD_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A35_A36_3(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A27_A40_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A31_A40_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A31_A40_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A35_A40_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A40_T08_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A10_A15_A27_AD03_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				...
				for($sa=0;$sa<=0;$sa++)
				{
					...
					try
					{
						...
						if($A10=='45' && $A15=='99' && $A27->getDate()>= $ed->getDate() && ($AD03=='T' || $A44=='999999999'))
						{
			...
			private function rule_A10_A27_A44_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				...
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					try
					{
						...
						{
							return "A10_A27_A44_1[".$sa."]: If learning aim is employer responsive funded and is a main aim of an apprenticeship programme and started after 1 August 2008 the employer identifier must be completed\n";
						}
					}
					catch(Exception $e)
					{
			...
			private function rule_A44_A46a_A46b_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A10_A27_AD03_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				...
				for($sa=0;$sa<=0;$sa++)
				{
					...
					try
					{
						...
						$A15 = trim($ilr->aims[$sa]->A15);
						$A27 = new Date($ilr->aims[$sa]->A27);
						$ed = new Date('01/08/2009');
						
						if($A10=='46' && $A27->getDate()>= $ed->getDate() && $AD03=='T' && $A44!='999999999')
						{
							return "A10_A27_AD03_1[".$sa."]: If the learning aim start date is on or after 1 August 2009 and is the main aim of an ER funded apprenticeship programme then the employer identifier must contain a valid EDRS number or be 999999999 \n";
						}
					}
					catch(Exception $e)
					{
			...
			private function rule_AD03_A44_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				...
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					...
					if($AD03!='T' && $AD03!=substr($A44,8,1) && $A44!='999999999')
					{
			...
			private function rule_AD03_A46a_A46b_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A27_A46a_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A27_A46b_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A10_A46a_A46b_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A10_L35_A46a_A46b_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A10_A31_A50_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A31_A50_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A46a_A46b_A50_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A46a_A46b_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A04_A53_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A10_A15_A27_A54_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A46a_A46b_A54_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A04_A09_A27_A59_LAD_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A04_A09_A27_A35_A60_LAD_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					$query = "select FFA_TYPE_CODE from learning_aim where LEARNING_AIM_REF='{$ilr->aims[$sa]->A09}'";
			...
			private function rule_A10_A61_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					$A10 = trim($ilr->aims[$sa]->A10); 
					...
					if($A10 == '70' && $A61 == '')
					{
						return "A10_A61_1[".$sa."]: If the learning aim is ESF co-financed the Project dossier number must be entered. \n";
					}
				}
			}

			private function rule_A10_A62_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					$A10 = trim($ilr->aims[$sa]->A10); 
					...
					if($A10 == '70' && $A62 == '')
					{
						return "A10_A62_1[".$sa."]: If the learning aim is ESF co-financed the ESF local project number must be entered. \n";
					}
				}
			}

			
			private function rule_A04_A63_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					$A04 = trim($ilr->aims[$sa]->A04); 
			...
			private function rule_A10_A66_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					$A10 = trim($ilr->aims[$sa]->A10); 
					...
					{
						return "A10_A66_1[".$sa."]: If the learning aim is ESF co-financed the Employment status on day before starting learning aim must be entered and not be 'not known/not provided' \n";
					}
				}
			}
			
			private function rule_A66_A67_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					$A66 = trim($ilr->aims[$sa]->A66); 
			...
			private function rule_A66_A67_3(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					$A66 = trim($ilr->aims[$sa]->A66); 
			...
			private function rule_A66_A67_4(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					$A66 = trim($ilr->aims[$sa]->A66); 
	...
	/*		private function rule_L05_L08_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				...
				if($L08=='Y' && (int)$L05!=0)
				{
					return "L05_L08_1: If the delete flag is set, the learner must have no aims \n";
				}
			}
	*/		
			private function rule_L05_L08_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A09_A10_A15_A27_A46a_A46b_AD04_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A10_A15_A27_A46a_A46b_AD04_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_A10_A27_L11_5(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A27_L14_L15_L16_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L14_L15_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L14_L15_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L14_L16_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L14_L16_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L17_L24_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			// TODO A10_L01_L25_ER_LR_1
			// TODO L01_L25_A10_A61_A62_1

			private function rule_L25_A10_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			
				$L25 = $ilr->learnerinformation->L25;	
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					$A10 = trim($ilr->aims[$sa]->A10); 
					...
					if($A10 == '70' && $L25 == '000')
					{
						return "L25_A10_1[".$sa."]: If the learning aim is ESF funded then the LSC number must not be 000. \n";
					}
				}
			}

			private function rule_L25_A46a_A46b_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				...
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
					...
					{
						return "L25_A46a_A46b_1[".$sa."]: The Basic Skills Project for National Employers is only available for providers who contract with the National Employer Service  \n";
					}
				}
			}

			private function rule_L25_L44_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
		
				$L25 = trim($ilr->learnerinformation->L25);
				$L44 = trim($ilr->learnerinformation->L44);
		
				if( ($L25=='002' || $L25=='2' || $L25=='003' || $L25=='3') && $L44=='')
				{
					return "L25_L44_1: Delivery locations must be present for NES/NAS contracts \n";
				}
			}
		
			private function rule_L27_L39_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L28a_L28b_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L34abcd_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L34bcd_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L34cd_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A27_L37_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L37_L47_L48_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A04_A31_L39_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L39_A10_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				$L39 = $ilr->learnerinformation->L39;
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			private function rule_L40a_L40b_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_L25_L44_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
		
				$L25 = trim($ilr->learnerinformation->L25);
				$L44 = trim($ilr->learnerinformation->L44);
		
				if($L44!='' && ($L25!='002' && $L25!='003'))
				{
					return "L25_L44_2: Non NES/NAS contracts must not fill in L44 \n";
				}
			}
			...
			private function rule_A27_L47_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A09_A10_A15_A26_LAD_1(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
			...
			private function rule_A09_A10_A15_A26_LAD_2(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
			{
				for($sa=0;$sa<=$ilr->subaims;$sa++)
				{
			...
			//TODO L01_L03_LD04_WBL_1
			
			//TODO L25_T04_1
			
			

	private function rule_R03(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
	{
	...
	private function rule_R04(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
	{
		for($sa=0;$sa<=$ilr->subaims;$sa++)
		{
	...
	private function rule_R23(PDO $link, PDO $linklad, PDO $linklis, ILR2009 $ilr)
	{
		$L39 = trim($ilr->learnerinformation->L39);
		$flag = "N";
		for($sa=0;$sa<=$ilr->subaims;$sa++)
