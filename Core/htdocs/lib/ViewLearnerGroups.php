<?php
class ViewLearnerGroups extends View
{
...
HEREDOC;
			...
			$view = $_SESSION[$key] = new ViewLearnerGroups();
			$view->setSQL($sql);
	...
	public function render(PDO $link)
	{
		...
		if($st) 
		{
			...
			while($row = $st->fetch())
			{
				...
				echo HTML::viewrow_opening_tag('do.php?_action=view_learnergroup_learners&id=' . rawurlencode($row['id']));
