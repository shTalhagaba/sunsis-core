<?php
class ViewEthnicityGraph extends View
{
	...
	public static function getInstance()
	{
		...
		if(!isset($_SESSION[$key]))
		{
			...
			$sql = <<<HEREDOC
SELECT
	tr.surname, tr.firstnames, tr.gender, dropdown0708.description,
...
FROM
	...
	LEFT JOIN dropdown0708 on dropdown0708.value = tr.ethnicity and dropdown0708.code='L12'
...
HEREDOC;
			...
			$view = $_SESSION[$key] = new ViewEthnicityGraph();
			$view->setSQL($sql);
	...
	public function save_graph_data(PDO $link)
	{
		...
		if($st) 
		{
			...
			while($row = $st->fetch())
			{
				...
				$sql2 = "insert into graph_data values('$value','1')";
	...
	public function render(PDO $link)
	{
		...
		if($st) 
		{
			...
			echo '<thead><tr><th>&nbsp;</th><th>Ethnicity</th><th>Learners</th></tr></thead>';
			echo '<tbody>';
