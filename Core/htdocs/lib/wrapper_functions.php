...
function _strspn($str1, $str2, $start=null, $length=null) {
    ...
    if (PHP_VER_LOWER43 == 1) {
        if (isset($length)) {
            $str1 = substr((string) $str1, $start, $length);
        } else {
            $str1 = substr((string) $str1, $start);
        }
    }

    if ($numargs == 2 || PHP_VER_LOWER43 == 1) {
        return strspn((string) $str1, (string) $str2);
    } else if ($numargs == 3) {
        return strspn((string) $str1, (string) $str2, (int) $start);
    } else {
        return strspn((string) $str1, (string) $str2, (int) $start, (int) $length);
    }
}
