<?php
class ViewDisabilityGraph extends View
{
...
FROM
	...
	LEFT JOIN dropdown0708 on dropdown0708.value = tr.disability and dropdown0708.code='L15'
...
HEREDOC;
			...
			$view = $_SESSION[$key] = new ViewDisabilityGraph();
			$view->setSQL($sql);
	...
	public function render(PDO $link)
	{
		...
		if($st) 
		{
			...
			echo '<thead><tr><th>&nbsp;</th><th>Disability</th><th>Learners</th></tr></thead>';
			echo '<tbody>';
