    ...
    private function rule_Learning_Delivery_Rules($link, $ilr)
    {
        ...
        foreach($ilr->LearningDelivery as $delivery)
        {
            ...
            if(isset($AchDate_Date))
                if($AchDate_Date->after("31/07/2021"))
            ...
            //LearnActEndDate_04
            if(isset($LearnActEndDate) and Date::isDate($LearnActEndDate) and $LearnActEndDate_Date->after(date('Y-m-d')))
            	$errors[] = "LearnActEndDate_04: If returned, the Learning actual end date must not be after the current date";
            ...
            //AimType_06
            if($AimType=='5' && $LearnStartDate_Date->after("31/08/2021") && $FundModel=='25')
            {
            ...
            //LearnStartDate_03
            if($DD07=="N" && $ProgType!='24' && $LearnStartDate_Date->after("31/07/2021"))
            ...
            */
            ...
            $DateOfBirth_25_Under19 = DAO::getSingleValue($link, "SELECT IF(DATE_ADD('$DateOfBirth',INTERVAL 19 YEAR)>DATE_ADD('2020-08-31',INTERVAL 1 DAY),1,0);"); 
