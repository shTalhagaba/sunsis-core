<?php
class ViewAgeRangeGraph extends View
{
	...
	public static function getInstance()
	{
		...
		if(!isset($_SESSION[$key]))
		{
			...
			$sql = <<<HEREDOC
SELECT
	tr.surname, tr.firstnames, tr.gender, (DATEDIFF(tr.start_date, tr.dob)/365) as age_range,
...
HEREDOC;
			...
			$view = $_SESSION[$key] = new ViewAgeRangeGraph();
			$view->setSQL($sql);
	...
	public function render(PDO $link)
	{
		...
		if($st) 
		{
			...
			if($stnew) 
			{
				...
				echo '<thead><tr><th>&nbsp;</th><th>Age Range</th><th>Learners</th></tr></thead>';
				echo '<tbody>';
