...
//----------------------------------------------------------------------------------------------------
    ...
    function set_styles()
    {
        if ($this->graphBGColor) {
            $this->cssGRAPH .= 'background-color:' . $this->graphBGColor . ';';
        }
        if ($this->graphBorder) {
            $this->cssGRAPH .= 'border:' . $this->graphBorder . ';';
        }
        if ($this->barBorder) {
            $this->cssBAR .= 'border:' . $this->barBorder . ';';
        }
        if ($this->barBGColor) {
            $this->cssBARBG .= 'background-color:' . $this->barBGColor . ';';
        }
        if ($this->titleColor) {
            $this->cssTITLE .= 'color:' . $this->titleColor . ';';
        }
        if ($this->titleBGColor) {
            $this->cssTITLE .= 'background-color:' . $this->titleBGColor . ';';
        }
        if ($this->titleBorder) {
            $this->cssTITLE .= 'border:' . $this->titleBorder . ';';
        }
        if ($this->titleFont) {
            $this->cssTITLE .= 'font-family:' . $this->titleFont . ';';
        }
        if ($this->titleAlign) {
            $this->cssTITLE .= 'text-align:' . $this->titleAlign . ';';
        }
        if ($this->titleSize) {
            $this->cssTITLE .= 'font-size:' . $this->titleSize . 'px;';
        }
        if ($this->titleBGColor) {
            $this->cssTITLE .= 'background-color:' . $this->titleBGColor . ';';
        }
        if ($this->titlePadding) {
            $this->cssTITLE .= 'padding:' . $this->titlePadding . 'px;';
        }
        if ($this->labelColor) {
            $this->cssLABEL .= 'color:' . $this->labelColor . ';';
        }
        if ($this->labelBGColor) {
            $this->cssLABEL .= 'background-color:' . $this->labelBGColor . ';';
        }
        if ($this->labelBorder) {
            $this->cssLABEL .= 'border:' . $this->labelBorder . ';';
        }
        if ($this->labelFont) {
            $this->cssLABEL .= 'font-family:' . $this->labelFont . ';';
        }
        if ($this->labelSize) {
            $this->cssLABEL .= 'font-size:' . $this->labelSize . 'px;';
        }
        if ($this->labelAlign) {
            $this->cssLABEL .= 'text-align:' . $this->labelAlign . ';';
        }
        if ($this->labelBGColor) {
            $this->cssLABELBG .= 'background-color:' . $this->labelBGColor . ';';
        }
        if ($this->legendColor) {
            $this->cssLEGEND .= 'color:' . $this->legendColor . ';';
        }
        if ($this->legendFont) {
            $this->cssLEGEND .= 'font-family:' . $this->legendFont . ';';
        }
        if ($this->legendSize) {
            $this->cssLEGEND .= 'font-size:' . $this->legendSize . 'px;';
        }
        if ($this->legendBGColor) {
            $this->cssLEGENDBG .= 'background-color:' . $this->legendBGColor . ';';
        }
        if ($this->legendBorder) {
            $this->cssLEGENDBG .= 'border:' . $this->legendBorder . ';';
        }
        if ($this->absValuesColor) {
            $this->cssABSVALUES .= 'color:' . $this->absValuesColor . ';';
        }
        if ($this->absValuesBGColor) {
            $this->cssABSVALUES .= 'background-color:' . $this->absValuesBGColor . ';';
        }
        if ($this->absValuesBorder) {
            $this->cssABSVALUES .= 'border:' . $this->absValuesBorder . ';';
        }
        if ($this->absValuesFont) {
            $this->cssABSVALUES .= 'font-family:' . $this->absValuesFont . ';';
        }
        if ($this->absValuesSize) {
            $this->cssABSVALUES .= 'font-size:' . $this->absValuesSize . 'px;';
        }
        if ($this->percValuesColor) {
            $this->cssPERCVALUES .= 'color:' . $this->percValuesColor . ';';
        }
        if ($this->percValuesFont) {
            $this->cssPERCVALUES .= 'font-family:' . $this->percValuesFont . ';';
        }
        if ($this->percValuesSize) {
            $this->cssPERCVALUES .= 'font-size:' . $this->percValuesSize . 'px;';
        }
    }
    ...
    function build_bar($value, $width, $height, $color)
    {
        ...
        // relmes - change for upgrade to php 5.3
    ...
    function build_value($val, $max_dec, $sum = 0, $align = '')
    {
        ...
        if ($sum) {
            $value .= ' / ' . $this->absValuesPrefix . $sum . $this->absValuesSuffix;
        }
        $value .= '&nbsp;</td>';
        return $value;
    }
    ...
    function build_hTitle($titleLabel, $titleValue, $titleBar)
    {
        ...
        if ($titleValue != '') {
            $title .= '<td style="' . $this->cssTITLE . '">' . $titleValue . '</td>';
        }
    ...
    function create_hBar($value, $percent, $mPerc, $mPerc_neg, $max_neg, $mul, $valSpace, $bColor, $border, $spacer, $spacer_neg)
    {
        ...
        if ($percent < 0) {
            $percent *= -1;
            $bar .= '<td style="' . $this->cssLABELBG . '" height="' . $this->barWidth . '" width="' . round(($mPerc_neg - $percent) * $mul + $valSpace) . '" align="right" nowrap="nowrap">';
            if ($this->showValues < 2) {
                $bar .= '<span style="' . $this->cssPERCVALUES . '">' . number_format($percent, $this->percValuesDecimals) . '%</span>';
            }
            ...
            if ($percent) {
                ...
                $bar .= '<td><img width="1" height="' . ($this->barWidth + ($border * 2)) . '" alt="" /></td>';
            }
            $bar .= '<td style="' . $this->cssPERCVALUES . '" width="' . round(($mPerc - $percent) * $mul + $valSpace) . '" align="left" nowrap="nowrap">';
            if ($this->showValues < 2) {
                $bar .= '&nbsp;' . number_format($percent, $this->percValuesDecimals) . '%';
            }
            $bar .= '&nbsp;</td>';
        }
        $bar .= '</tr></table>';
    ...
    function create_vBar($value, $percent, $mPerc, $mPerc_neg, $max_neg, $mul, $valSpace, $bColor, $border, $spacer, $spacer_neg)
    {
        ...
        if ($percent < 0) {
            ...
            $bar .= '<td style="' . $this->cssLABELBG . '" height="' . round(($mPerc_neg - $percent) * $mul + $valSpace) . '" nowrap="nowrap">';
            $bar .= ($this->showValues < 2) ? '<span style="' . $this->cssPERCVALUES . '">' . number_format($percent, $this->percValuesDecimals) . '%</span>' : '&nbsp;';
            $bar .= '</td>';
        } else {
            $bar .= '<td style="' . $this->cssPERCVALUES . '" valign="bottom" height="' . round(($mPerc - $percent) * $mul + $valSpace) . '" nowrap="nowrap">';
            if ($this->showValues < 2) {
                $bar .= number_format($percent, $this->percValuesDecimals) . '%';
            }
            $bar .= '</td>';
            if ($percent) {
                ...
                $bar .= '</tr><tr><td><img width="' . ($this->barWidth + ($border * 2)) . '" height="1" /></td>';
            }
            if ($max_neg) {
    ...
    function create()
    {
        ...
        if (is_array($this->titles)) {
            ...
            $t = (strlen($this->titles) > 1) ? explode(',', $this->titles) : array();
        }
        if (is_array($this->labels)) {
            $r = $this->labels;
        } else {
            $r = (strlen($this->labels) > 1) ? explode(',', $this->labels) : array();
        }
        if ($this->barColors) {
            $drc = (is_array($this->barColors)) ? $this->barColors : explode(',', $this->barColors);
        } else {
            $drc = array();
        }
        $val = $bc = array();
        if ($this->barLength < 0.1) {
            $this->barLength = 0.1;
        } else {
            if ($this->barLength > 2.9) {
                $this->barLength = 2.9;
            }
        }
        ...
        if ($this->type == 'pbar' || $this->type == 'fader') {
            if (!$this->barBGColor) {
                $this->barBGColor = $this->labelBGColor;
            }
        ...
        for ($i = $sum = $max = $max_neg = $max_dec = $ccnt = $lcnt = $chart = 0; $i < $bars; $i++) {
            ...
            for ($j = $dec = 0; $j < count($drv); $j++) {
                ...
                if (empty($bc[$j])) {
                    if ($ccnt >= count($this->colors)) {
                        $ccnt = 0;
                    }
                    $bc[$j] = (empty($drc[$j]) || strlen($drc[$j]) < 3) ? $this->colors[$ccnt++] : trim($drc[$j]);
                }
            }
            $lcnt++;
        }
        ...
        if ($this->showValues < 2) {
            if ($this->type == 'hbar') {
                ...
                $valSpace = $this->percValuesSize * 1.2;
            }
        } else {
            $valSpace = $this->percValuesSize;
        }
        ...
        for ($chart = $lcnt = 0; $chart < count($val); $chart++) {
            ...
            if ($this->type == 'hbar') {
                if (count($t) > 0) {
                    $graph .= $this->build_hTitle($titleLabel, $titleValue, $titleBar);
                }
                ...
                for ($i = 0; $i < count($val[$chart]); $i++, $lcnt++) {
                    ...
                    for ($j = 0; $j < count($val[$chart][$i]); $j++) {
                        ...
                        // #167 - error being thrown by number_format
                        //	  - first parameter not being a double
                        if (!is_double($val[$chart][$i][$j])) {
                            $val[$chart][$i][$j] = 0.0;
                        }
                        ...
                        $graph .= '</td></tr>';
                        if ($j < count($val[$chart][$i]) - 1) {
                            $graph .= '<tr>';
                        }
                    }
                    if ($this->labelSpace && $i < count($val[$chart]) - 1) {
                        $graph .= '<tr><td colspan="3" height="' . $this->labelSpace . '"></td></tr>';
                    }
                }
            } else {
                if ($this->type == 'vbar') {
                    ...
                    for ($i = 0; $i < count($val[$chart]); $i++) {
                        ...
                        if ($this->labelSpace) {
                            $graph .= '<td width="' . $this->labelSpace . '"></td>';
                        }
                    }
                    if ($this->showValues == 1 || $this->showValues == 2) {
                        $graph .= '</tr><tr align="center">';
                        if ($titleValue != '') {
                            $graph .= '<td style="' . $this->cssTITLE . '">' . $titleValue . '</td>';
                        }
                    ...
                    $graph .= '</tr><tr>';
                    if ($titleLabel != '') {
                        $graph .= '<td style="' . $this->cssTITLE . '">' . $titleLabel . '</td>';
                    }
                    ...
                    if ($this->type == 'pbar' || $this->type == 'fader') {
                        ...
                        for ($i = 0; $i < count($val[$chart]); $i++, $lcnt++) {
                            ...
                            if ($this->type == 'fader') {
                                $graph .= $this->build_fader($value, round($this->barWidth / 2), $this->barWidth, round($percent * $mul), $bColor);
                            } else {
                                $graph .= $this->build_bar($value, round($percent * $mul), $this->barWidth, $bColor);
                            }
                            $graph .= '</td><td width="' . round((100 - $percent) * $mul) . '"></td>';
                            $graph .= '</tr></table></td>';
                            if ($this->showValues < 2) {
                                $graph .= '<td style="' . $this->cssPERCVALUES . '" nowrap>&nbsp;' . number_format($percent, $this->percValuesDecimals) . '%</td>';
                            }
                            $graph .= '</tr>';
                            if ($this->labelSpace && $i < count($val[$chart]) - 1) {
                                $graph .= '<td colspan="3" height="' . $this->labelSpace . '"></td>';
                            }
                        }
                    } else {
                        $graph .= '<tr><td>' . $this->err_type . '</td></tr>';
                    }
                }
            }
