<?php
class WBMeetingRegulationsAndLegislation extends Workbook
{
	public function __construct($tr_id)
	{
		$this->wb_title = 'WBMeetingRegulationsAndLegislation';
		$this->tr_id = $tr_id;
	...
	public static function getBlankXML()
	{
		...
		$xml = <<<XML
<Workbook title="meeting_regulations_and_legislation">
...
XML;
	...
	{
		return '2,5,7,8,9,10,11,12,13,14,16,17,18,19,20,21,22,25,26';
	}
	...
	public function getPageTopLine()
	{
		if($this->savers_or_sp == 'savers')
			return '<p class="topLine"><span style="color: blue;">Meeting regulations & legislation</span> <span style="color: red;">Meeting regulations & legislation</span> </p>';
		else
			return '<p class="topLine"><span style="color: pink;">Meeting regulations & legislation</span> <span style="color: gray;">Meeting regulations & legislation</span> </p>';
	}

	public function getPageBottomLine()
	{
		if($this->savers_or_sp == 'savers')
			return '<p class="bottomLine"><span style="color: blue;">Meeting regulations & legislation</span> <span style="color: red;">Meeting regulations & legislation</span> </p>';
		else
			return '<p class="bottomLine"><span style="color: pink;">Meeting regulations & legislation</span> <span style="color: gray;">Meeting regulations & legislation</span> </p>';
	}
