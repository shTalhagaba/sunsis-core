<?php
class ViewLearningDifficultyGraph extends View
{
...
FROM
	...
	LEFT JOIN dropdown0708 on dropdown0708.value = tr.learning_difficulty and dropdown0708.code='L16'
...
HEREDOC;
			...
			$view = $_SESSION[$key] = new ViewLearningDifficultyGraph();
			$view->setSQL($sql);
	...
	public function render(PDO $link)
	{
		...
		if($st) 
		{
			...
			echo '<thead><tr><th>&nbsp;</th><th>Learning Difficulties</th><th>Learners</th></tr></thead>';
			echo '<tbody>';
