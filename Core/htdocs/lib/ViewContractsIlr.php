<?php
class ViewContractsIlr extends View
{
...
HEREDOC;
			...
			$view = $_SESSION[$key] = new ViewContractsIlr();
			$view->setSQL($sql);
	...
	public function render(PDO $link)
	{
		...
		if($st) 
		{
			...
			echo '<thead><tr><th>&nbsp;</th><th>Training Provider</th><th>Funding Source</th><th>Contract Type</th><th>Start Date</th><th>End Date</th></tr></thead>';
			...
			{
				$a++;
				echo HTML::viewrow_opening_tag('/do.php?_action=view_training_records_ilr&id=' . $row['id']); 
				echo '<td>' . $row['id'] .'</td>';
