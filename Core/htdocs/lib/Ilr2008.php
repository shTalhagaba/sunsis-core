...
class Ilr2008 extends Entity
{
	...
	public static function generateStream3(PDO $link, $submission, $contracts, $con1, $L25, $transmission)
	{
		...
		//	print(str_pad($L25,3,'0',STR_PAD_LEFT));
			print(str_pad('',3,'9',STR_PAD_LEFT));
			print('0809');
			print($submission);
...
*/
				...
				if($learner->L08!="Y")
				{
					...
					{
						if($aim->A15!='99' && $aim->A15!='' && $aim->A15!='0')
						{
							$no_of_aims++;
					...
					foreach($ilr->main as $aim)
					{
						...
						if($aim->A06=='01')
						{
							...
							print($aim->E06);
							print($aim->E07);
							print(substr($aim->E08,0,2).substr($aim->E08,3,2).substr($aim->E08,6,4));
							print(substr($aim->E09,0,2).substr($aim->E09,3,2).substr($aim->E09,6,4));
							print(substr($aim->E10,0,2).substr($aim->E10,3,2).substr($aim->E10,6,4));
							print($aim->E11);
							print($aim->E12);
							print($aim->E13);
							print($aim->E14);
							print($aim->E15);
							print(str_pad($aim->E16a,1,' ',STR_PAD_LEFT));
							print(str_pad($aim->E16b,1,' ',STR_PAD_LEFT));
							print(str_pad($aim->E16c,1,' ',STR_PAD_LEFT));
							print(str_pad($aim->E16d,1,' ',STR_PAD_LEFT));
							print(str_pad($aim->E16e,1,' ',STR_PAD_LEFT));
							print(str_pad($aim->E17a,1,' ',STR_PAD_LEFT));
							print(str_pad($aim->E17b,1,' ',STR_PAD_LEFT));
							print(str_pad($aim->E17c,1,' ',STR_PAD_LEFT));
							print(str_pad($aim->E17d,1,' ',STR_PAD_LEFT));
							print(str_pad($aim->E17e,1,' ',STR_PAD_LEFT));
							print(str_pad($aim->E18a,1,' ',STR_PAD_LEFT));
							print(str_pad($aim->E18b,1,' ',STR_PAD_LEFT));
							print(str_pad($aim->E18c,1,' ',STR_PAD_LEFT));
							print(str_pad($aim->E18d,1,' ',STR_PAD_LEFT));
							print(str_pad($aim->E19a,1,' ',STR_PAD_LEFT));
							print(str_pad($aim->E19b,1,' ',STR_PAD_LEFT));
							print(str_pad($aim->E19c,1,' ',STR_PAD_LEFT));
							print(str_pad($aim->E19d,1,' ',STR_PAD_LEFT));
							print(str_pad($aim->E19e,1,' ',STR_PAD_LEFT));
							print($aim->E20a);
							print($aim->E20b);
							print($aim->E20c);
							print($aim->E21);
							print(str_pad($aim->E22,9,' ',STR_PAD_LEFT));
							print($aim->E23);
							print($aim->E24);
							print($aim->E25);
							print(str_pad(" ",281));
					...
					foreach($ilr->subaim as $aim)
					{
						...
						if($aim->A28!='00000000' && $aim->A28!='dd/mm/yyyy' && $aim->A28!='')
							...
							print(str_pad($aim->A28,8,'0',STR_PAD_LEFT));
						if($aim->A31!='00000000' && $aim->A31!='dd/mm/yyyy' && $aim->A31!='' && $aim->A31!='        ')
							print(substr($aim->A31,0,2).substr($aim->A31,3,2).substr($aim->A31,6,4));
						else
							print(str_pad($aim->A31,8,'0',STR_PAD_LEFT));
						print(str_pad($aim->A32,5,'0',STR_PAD_LEFT));
	...
	public static function getFilename(PDO $link, $contract_id, $submission, $L01)
	{
		...
		if($st)
		{
			...
			$transmission = DAO::getSingleValue($link, "select transmission from submissions where submission='$submission' and contract_year='$con1->contract_year'");
			if($transmission=='')
			{
				DAO::execute($link, "insert into submissions (submission, transmission, contract_year) values($submission, 1, 2008)");
				$transmission = 1;
			}
			else
			{
				$transmission += 1;
				DAO::execute($link, "update submissions set transmission = $transmission where submission = '$submission' and contract_year = 2008 ");
			}
			
			$file.= $contract->L25. '0809' . str_pad($transmission,3,'0',STR_PAD_LEFT) . '01.';
