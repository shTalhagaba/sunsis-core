...
HEREDOC;
        ...
        if(preg_match('/^(\d\d:\d\d)/', $review->review_start_time, $matches))
        {
            $review->review_start_time = $matches[1];
        }

        if(preg_match('/^(\d\d:\d\d)/', $review->review_end_time, $matches))
        {
            $review->review_end_time = $matches[1];
        }
    ...
    public function save(PDO $link)
    {
        ...
        return DAO::saveObjectToTable($link, 'reviews', $this);
    }
    ...
    public $review_start_time = NULL;
    public $review_end_time = NULL;
    public $review_type = NULL;
    public $interviewer = NULL;
    public $review_status = NULL;
    public $review_rgb_status = NULL;
    public $review_paperwork = NULL;
    public $review_module = NULL;
    public $review_comments = NULL;
    public $tr_id = NULL;
