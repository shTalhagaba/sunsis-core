...
class ValidateILR2024
{
    ...
    private function rule_Learning_Delivery_Rules($link, $ilr)
    {
        ...
        foreach($ilr->LearningDelivery as $delivery)
        {
            ...
            //R121
            if(Date::isDate($delivery->AchDate) && (!$LatestACTToDate->equals($delivery->AchDate) or $LatestACTToDate->equals("1900-01-01")))
            {
            ...
            if(isset($AchDate_Date))
                if($AchDate_Date->after("31/07/2025"))
            ...
            //Outcome_07
            if($AimType=='1' && $delivery->ProgType=='24' && ($Outcome=='2' || $Outcome=='3' || $Outcome=='6' || $Outcome=='7') && (!$no_of_dp_records))
                $errors[] = "Outcome_07: If the Outcome of a traineeship programme is 'Not achieved' there must be a Destination and progression record recorded" . $delivery->ProgType;
            ...
            //LearnStartDate_03
            if($DD07=="N" && $ProgType!='24' && $LearnStartDate_Date->after("31/07/2025"))
            ...
            */
            ...
            $DateOfBirth_25_Under19 = DAO::getSingleValue($link, "SELECT IF(DATE_ADD('$DateOfBirth',INTERVAL 19 YEAR)>DATE_ADD('2024-08-31',INTERVAL 1 DAY),1,0);");
