<?php
class TestPurchase extends Entity
{
...
HEREDOC;
    ...
    {
        return DAO::saveObjectToTable($link, 'test_purchase', $this);
    }
    ...
    public $repair = NULL;
    public $valet = NULL;
    public $engine_size = NULL;
    public $mileage = NULL;
    public $transmission = NULL;
    public $sva_fee = NULL;
    public $registration_fee = NULL;
    public $speedo_meter_change = NULL;
    public $immobiliser = NULL;
    public $custom_duty = NULL;
    public $vat = NULL;
