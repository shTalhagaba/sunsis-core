...
class FPDF_TPL extends FPDF
{
     ...
     */
    // relmes - changed signature for php 5.3 ( see FPDF::Image ) 
    function Image($file, $x = null, $y = null, $w = 0, $h = 0, $type = '', $link = '', $align = '', $resize = false, $dpi = 300)
    {
