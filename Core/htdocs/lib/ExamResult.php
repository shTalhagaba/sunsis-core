...
//		$this->created = ($this->id == "") ? date('Y-m-d H:i:s') : $this->created;
        ...
        return DAO::saveObjectToTable($link, 'exam_results', $this);
    }
    ...
    public $unit_reference = NULL;
    public $unit_title = NULL;
    public $attempt_no = NULL;
    public $exam_result = NULL;
    public $result_date = NULL;
    public $comments = NULL;
    public $exam_date = NULL;
    public $exam_booked_date = NULL;
    public $exam_type = NULL;
    public $exam_status = NULL;
    public $exam_subtype = NULL;
    public $exam_score = NULL;
