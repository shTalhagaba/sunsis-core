<?php
class ViewEmployerPoolContacts extends View
{
	...
	public static function getInstance($link, $id)
	{
		...
		if(!isset($_SESSION[$key]))
		{
			...
			$sql = "SELECT contact_title, contact_name, contact_mobile, contact_telephone, contact_email, contact_department FROM prospect_contact WHERE org_id = '".addslashes((string)$id)."' ";
			$sql .= "UNION ";
			...
			$view = $_SESSION[$key] = new ViewEmployerPoolContacts();
			$view->setSQL($sql);
	...
	public function render(PDO $link)
	{
		...
		$sql = "SELECT contact_title, contact_name, contact_mobile, contact_telephone, contact_email, contact_department FROM prospect_contact WHERE org_id = '".addslashes((string)$this->org_id)."' ";
		$sql .= "UNION ";
	...
	public function renderContacts(PDO $link)
	{
		...
		/* @var $result pdo_result */
		$sql = "SELECT contact_id, contact_title, contact_name, contact_mobile, contact_telephone, contact_email, contact_department FROM prospect_contact WHERE org_id = '".addslashes((string)$this->org_id)."' ";
