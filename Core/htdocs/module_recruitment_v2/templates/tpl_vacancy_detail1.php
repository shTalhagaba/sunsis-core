	...
	<div class="row animated fadeInDown">
		<div class="col-sm-7"><br>
			<div class="box" style="box-shadow: 5px 5px 20px 0px rgba(255,105,180,0.95);">
				<div class="box-header with-border">
					<h4 class="pull-left"><?php echo $vacancy->vacancy_title; ?></h4>
					<div class="mobile-only button pull-right">
						<span data-toggle="modal" data-target="#applicationModal" class="btn btn-primary"><i class="fa fa-briefcase"></i>  Apply</span>
					</div>
				</div>
				<div class="box-body" >
					<div class="">
						<h4>Description</h4>
						<?php echo $vacancy->full_description; ?>
					</div>
				</div>
			</div>
		</div>
		<div class="col-sm-5"><br>
			<div class="box" style="box-shadow: 5px 5px 20px 0px rgba(255,105,180,0.95);">
				...
				<div class="box-body" >
					<div class="well">
						<?php echo $vacancy->personal_qualities; ?>
					</div>
					<div class="well"><hr>
						<?php echo $vacancy->qualifications_required; ?>
					</div>
				</div>
			</div>
		</div>
