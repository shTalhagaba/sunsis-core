...
<head>
	...
	<title>Vacancies Questions</title>
...
<body>
<div class="banner">
	<div class="Title">Vacancies Questions</div>
	<div class="ButtonBar">
		<button onclick="window.location.href='do.php?_action=rec_edit_question';"> New </button>
	</div>
	<div class="ActionIconBar">
		<button onclick="showHideBlock('div_filters');showHideBlock('div_filter_crumbs');" title="Show/hide filters"><img src="/images/btn-filter.gif" width="16" height="16" style="vertical-align:text-bottom" /></button>
		<button onclick="window.print()" title="Print-friendly view"><img src="/images/btn-printer.gif" width="16" height="16" style="vertical-align:text-bottom" /></button>
		<button onclick="exportToExcel('view_RecViewQuestions')" title="Export to .CSV file"><img src="/images/btn-excel.gif" width="16" height="16" style="vertical-align:text-bottom" alt="" /></button>
...
<div id="div_filters" style="display:none">
	...
	<form method="get" action="#" id="applySavedFilter">
		<input type="hidden" name="_action" value="rec_view_questions" />
		...
		<div id="filterBox" class="clearfix">
			<fieldset>
				...
				<div class="field float">
					<label>Description:</label><?php echo $view->getFilterHTML('filter_description'); ?>
				</div>
				<div class="field float">
