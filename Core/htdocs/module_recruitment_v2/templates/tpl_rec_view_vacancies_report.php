<?php /* @var $view ViewVacanciesReport1 */  ?>
...
<body>
<div class="banner">
	<div class="Title">View Vacancies Report</div>
	<div class="ButtonBar">
	</div>
	<div class="ActionIconBar">
		...
		<button onclick="exportToExcel('view_ViewVacanciesReport1')" title="Export to .CSV file"><img src="/images/btn-excel.gif" width="16" height="16" style="vertical-align:text-bottom" alt="" /></button>
...
<div id="div_filters" style="display: none">
	...
	<form method="get" action="#" id="applySavedFilter">
		<input type="hidden" name="_action" value="baltic_view_vacancies_report_1" />
		...
		<div id="filterBox" class="clearfix">
			...
			<fieldset>
				<div class="field float">
					<label>Vacancy Active/Inactive:</label> <?php echo $view->getFilterHTML('filter_isactive'); ?>
				</div>
				<div class="field float">
			...
			<fieldset>
				<legend>Dates</legend>
				<div class="field">
					<label>Vacancies created date between</label><?php echo $view->getFilterHTML('filter_from_created'); ?>
