...
<div id="maincontent" style="" >
	...
	<div id="col2" class="column">
		<div class="block">
				...
				<p></p>
				<?php  echo RecVacanciesHome::homepageDashboard($link); ?>
		</div>
		...
		<div class="block">
			...
			<form action="do.php" name="find_candidate">
				...
				<label for="RecViewCandidates_filter_firstnames">Firstname:</label><br/>
				<input id="RecViewCandidates_filter_firstnames" type="text" value="" name="RecViewCandidates_filter_firstnames">
				<br/>
				<label for="RecViewCandidates_filter_surname">Surname:</label><br/>
				<input id="RecViewCandidates_filter_surname" type="text" value="" name="RecViewCandidates_filter_surname">
		...
		<div class="block">
			...
			<form action="do.php" name="find_candidate">
				<input type="hidden" name="_action" value="rec_view_candidates" />
				<input type="hidden" name="_reset" value="1" />
				<label for="RecViewCandidates_filter_postcodes">Postcode:</label>&nbsp;
				<input id="RecViewCandidates_filter_postcodes" type="text" value="" name="RecViewCandidates_filter_postcodes">
				<input id="RecViewCandidates_filter_distance" type="hidden" value="10" name="RecViewCandidates_filter_distance">
				<input type="submit" name="search_candidates" value="go &raquo;" />
			</form>
		</div>
...
<script language="javascript" type="text/javascript">
	...
	{
		var request = ajaxRequest('do.php?_action=rec_vacancies_crm','cand_start_date='+cand_start+'&diary_filter_region='+diary_filter_region);
