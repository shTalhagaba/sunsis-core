        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <div class="callout callout-default table-responsive">
                    ...
                    <table class="table table-bordered table-condensed">
                        <tr>
                            <th class="bg-teal-active" width="25%;">
                                Date of Activity:
                            </th>
                            <td>
                                <?php echo HTML::datebox('date_of_activity', $review->date_of_activity, true); ?>
                            </td>
                            <th class="bg-teal-active" width="30%;">
                                Total Learning Hours for session:
                            </th>
                            <td>
            ...
            <div class="col-sm-12">
                <div class="table-responsive callout callout-default">
                    <table class="table table-condensed">
                        ...
                        <tr>
                            <td><br>
                                <span class="text-bold lead" style="color: #777;">Exceptions to the above and additional information</span>
                    ...
                    <table class="text-center table table-bordered table-condensed">
                        ...
                        foreach($student_qualifications_result AS $student_qualification_row)
                        {
                            ...
                            echo in_array($student_qualification_row['auto_id'], $learning_aims_completed_in_this_session) ?
                                '<td><input name="learning_aims_completed_in_this_session[]" value="'.$student_qualification_row['auto_id'].'" type="checkbox" checked /></td>' :
                                '<td><input name="learning_aims_completed_in_this_session[]" value="'.$student_qualification_row['auto_id'].'" type="checkbox" /></td>';
                        }
                        echo '</tr>';
                        ?>
                    </table>
            ...
            <div class="col-sm-12">
                <div class="table-responsive callout callout-default">
                    <table class="text-center table table-bordered table-condensed">
                        ...
                        <tr>
                            <td><input value="1" name="end" type="checkbox" <?php echo $review->end == 1 ? 'checked' : ''; ?>></td>
                            <td><input value="1" name="safeguarding" type="checkbox" <?php echo $review->safeguarding == 1 ? 'checked' : ''; ?>></td>
                            <td><input value="1" name="prevent" type="checkbox" <?php echo $review->prevent == 1 ? 'checked' : ''; ?>></td>
                            <td><input value="1" name="british_values" type="checkbox" <?php echo $review->british_values == 1 ? 'checked' : ''; ?>></td>
                            <td><input name="hot_topic_no" type="text" value="<?php echo $review->hot_topic_no; ?>"></td>
                        </tr>
                    </table>
                </div>
            </div>
                ...
                <div class="table-responsive callout callout-default">
                    <table class="table table-bordered table-condensed">
                        <tr>
                            ...
                            <td>
                                <input value="1" type="radio" name="has_the_learner_progressed_to_sf" <?php echo $review->has_the_learner_progressed_to_sf == 1 ? 'checked' : ''; ?> > Yes &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;
                                <input value="0" type="radio" name="has_the_learner_progressed_to_sf" <?php echo $review->has_the_learner_progressed_to_sf == 0 ? 'checked' : ''; ?>> No
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="col-sm-12">
                <div class="table-responsive callout callout-default">
                    <table class="table table-bordered table-condensed">
                        ...
                        <tr>
                            <td>
                                <textarea name="learner_reflection_on_learning_to_date" id="learner_reflection_on_learning_to_date" style="width: 100%;" rows="5"><?php echo $review->learner_reflection_on_learning_to_date; ?></textarea>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="table-responsive callout callout-default">
                    <table class="table table-bordered table-condensed">
                        ...
                        <tr class="bg-gray-active">
                            ...
                            <th>Skills</th>
                            <th>Behaviour</th>
                            <th>Eng. Completion %age</th>
                            <th>Maths. Completion %age</th>
                        ...
                        <tr>
                            ...
                            <td><input type="text" maxlength="5" name="eng_comp_percentage" id="eng_comp_percentage" value="<?php echo $review->eng_comp_percentage != '' ? $review->eng_comp_percentage : $fs_progress['eng']; ?>" onkeypress="return numbersonlywithpoint();"></td>
                            <td><input type="text" maxlength="5" name="math_comp_percentage" id="math_comp_percentage" value="<?php echo $review->math_comp_percentage != '' ? $review->math_comp_percentage : $fs_progress['math']; ?>" onkeypress="return numbersonlywithpoint();"></td>
                            <td><input type="text" maxlength="5" name="otj_monthly_target" id="otj_monthly_target" value="<?php echo $review->otj_monthly_target; ?>" onkeypress="return numbersonlywithpoint();"></td>
                            <td>
                                <input type="text" maxlength="5" name="otj_to_date" id="otj_to_date" value="<?php echo $review->otj_to_date; ?>" onkeypress="return numbersonlywithpoint();">
                            </td>
                            <td>
                                <input type="text" maxlength="5" name="total_otj_req" id="total_otj_req" value="<?php echo $review->total_otj_req; ?>" onkeypress="return numbersonlywithpoint();">
                            </td>
                            <td>
                                <?php echo HTML::select('risk_rating', [['R', 'Red'], ['A', 'Amber'], ['G', 'Green']], $review->risk_rating, true); ?>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="col-sm-12">
                <div class="table-responsive callout callout-default">
                    <table class="table table-bordered table-condensed">
                        ...
                        <tr>
                            <th>3.</th><td><textarea name="t3" id="t3" style="width: 100%" rows="2"><?php echo $review->t3; ?></textarea></td>
                        </tr>
                        <tr>
                            <th>4.</th><td><textarea name="t4" id="t4" style="width: 100%" rows="2"><?php echo $review->t4; ?></textarea></td>
                        </tr>
                        <tr>
                            <th>5.</th><td><textarea name="t5" id="t5" style="width: 100%" rows="2"><?php echo $review->t5; ?></textarea></td>
                        </tr>
                        <tr>
                            <th>6.</th><td><textarea name="t6" id="t6" style="width: 100%" rows="2"><?php echo $review->t6; ?></textarea></td>
                        </tr>
                        <tr>
                            <th>7.</th><td><textarea name="t7" id="t7" style="width: 100%" rows="2"><?php echo $review->t7; ?></textarea></td>
                        </tr>
                        <tr>
                            <th>8.</th><td><textarea name="t8" id="t8" style="width: 100%" rows="2"><?php echo $review->t8; ?></textarea></td>
                        </tr>
                    </table>
                    <table class="table table-bordered table-condensed">
                        <caption class="lead text-bold">
