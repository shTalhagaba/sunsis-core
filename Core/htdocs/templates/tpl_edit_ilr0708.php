...
function toXML()
{
	...
	xml += "<L04>" + "10" + "</L04>";
	xml += "<L05>" + (parseInt(window.aims_counter)+parseInt(1)) + "</L05>";
	xml += "<L06>" + "00" + "</L06>";
	xml += "<L07>" + "00" + "</L07>";
	xml += "<L08>" + "N" + "</L08>";
...
function validation()
{
	...
	var client = ajaxRequest('do.php?_action=validate_ilr', postData);
	if(client != null)
	{
...
function loadFieldsFromNDAQ()
{
	...
	if(request == null)
	{
		alert("Could not create XMLHTTPRequest object in order to connect to the Apprenticeship Manager server");
	}
	...
	<tr>
		...
		<?php 
			if(trim($vo->learnerinformation->L03)==trim($previous_vo->learnerinformation->L03)) 
				echo "<input class='compulsory' type='text' value='" . $vo->learnerinformation->L03 . "' style='' id='L03' name='L03' maxlength=12 size=12 onKeyPress='return validLearnerReference(this, event)'> </td>";
			else
				echo "<input class='compulsory' type='text' value='" . $vo->learnerinformation->L03 . "' style='background-color:yellow' id='L03' name='L03' maxlength=12 size=12 onKeyPress='return validLearnerReference(this, event)'> </td>";
		?>
	...
	<tr>
		...
		<?php 
			if(trim($vo->learnerinformation->L09)==trim($previous_vo->learnerinformation->L09)) 
				echo "<input class='compulsory' type='text' value='" . $vo->learnerinformation->L09 . "' style='' id='L09' name='L09' maxlength=20 size=30 onKeyPress='return validName(this, event)'> </td>";
			else
		...
		<?php 
			if(trim($vo->learnerinformation->L10)==trim($previous_vo->learnerinformation->L10)) 
				echo "<input class='compulsory' type='text' value='" . $vo->learnerinformation->L10 . "' style='' id='L10' name='L10' maxlength=40 size=40 onKeyPress='return validName(this, event)'> </td>";
			else
				echo "<input class='compulsory' type='text' value='" . $vo->learnerinformation->L10 . "' style='background-color: yellow' id='L10' name='L10' maxlength=40 size=40 onKeyPress='return validName(this, event)'> </td>";
		?>
        </tr>
        <tr>
		...
		<?php 
			if(trim($vo->learnerinformation->L17)==trim($previous_vo->learnerinformation->L17)) 
				echo "<input class='compulsory' type='text' value='" . $vo->learnerinformation->L17 . "' style='' id='L17' name='L17' maxlength=8 size=8> </td>";
			else
		...
		<?php 
			if(trim($vo->aims[0]->A03)==trim($previous_vo->aims[0]->A03)) 
				echo "<input class='compulsory' type='text' value='" . $vo->aims[0]->A03 . "' style='' id='A03' name='A03' maxlength=12 size=12></td>";
			else
				echo "<input class='compulsory' type='text' value='" . $vo->aims[0]->A03 . "' style='background-color: yellow' id='A03' name='A03' maxlength=12 size=12></td>";
		?>
		...
		<?php 
			if(trim($vo->aims[0]->A49)==trim($previous_vo->aims[0]->A49)) 
				echo "<input class='optional' type='text' value='" . $vo->aims[0]->A49 . "' style='' id='A49' name='A49' maxlength=5 size=5></td>";
			else
				echo "<input class='optional' type='text' value='" . $vo->aims[0]->A49 . "' style='background-color: yellow' id='A49' name='A49' maxlength=5 size=5></td>";
		?>
		</tr>
		<tr>
		...
		<?php 
			if(trim($vo->aims[0]->A45)==trim($previous_vo->aims[0]->A45)) 
				echo "<input class='compulsory' type='text' value='" . $vo->aims[0]->A45 . "' style='' id='A45' name='A45' maxlength=8 size=8></td>";
			else
		...
		for($a=1; $a<=$vo->subaims; $a++)
		{
			...
			echo "</script>";
			                        ...
			                        <tr>
											...
											<td class="fieldLabel_optional"> A31 Learning Actual End Date <br>
											<?php 
											if($vo->aims[$a]->A31!='00000000' && $vo->aims[$a]->A31!='' && $vo->aims[$a]->A31!='00/00/0000')
