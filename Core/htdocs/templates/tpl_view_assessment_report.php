...
<div id="div_filters" style="display:none">
	...
	<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter">
		...
		<input type="hidden" name="_action" value="view_assessment_report" />
		...
		<div id="filterBox" class="clearfix">
			...
			<fieldset>
				<div class="field float">
					<label>Completion Status:</label> <?php echo $view->getFilterHTML('filter_record_status'); ?>
				</div>
			</fieldset>
			<fieldset>
			...
			<!--<fieldset>
				<legend>Last Review Dates</legend>
				<div class="field">
					<label>Start date:</label><?php /*echo $view->getFilterHTML('last_start_date'); */?>
			...
			<fieldset>
				...
				<div class="field">
					...
					<div class="field float">
						<label>Learner First Name:</label><?php echo $view->getFilterHTML('filter_firstnames'); ?>
					</div>
				</div>
			</fieldset>
			<fieldset>
