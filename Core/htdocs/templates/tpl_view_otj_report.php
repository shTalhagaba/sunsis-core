...
<body>
<div class="banner">
    <div class="Title">Off-the-job hours Report</div>
    <div class="ButtonBar">
...
<div id="div_filters" style="display:none">
    ...
    <form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter">
        ...
        <input type="hidden" name="_action" value="view_otj_report" />
        ...
        <div id="filterBox" class="clearfix">
            ...
            <fieldset>
                ...
                <div class="field float">
                    <label>OTJ Type</label><?php echo $view->getFilterHTML('filter_otj_type'); ?>
                </div>
            </fieldset>
            <fieldset>
