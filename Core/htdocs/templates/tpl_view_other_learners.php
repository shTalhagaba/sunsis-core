...
<body>
<div class="banner">
	<div class="Title">Other Learners</div>
	<div class="ButtonBar">
		<button onclick="window.location.href='do.php?_action=edit_user&people=<?php echo "Other Learner"; ?>&people_type=<?php echo 6; ?>';">New</button>
	</div>
