...
<body>
<div class="banner">
    <div class="Title">FS Progress Report</div>
    <div class="ButtonBar">
    ...
    <div class="ActionIconBar">
        ...
        <button onclick="window.location.href='do.php?_action=view_fs_progress2&export=1>'" title="Export to .CSV file"><img src="/images/btn-excel.gif" width="16" height="16" style="vertical-align:text-bottom" alt="" /></button>
...
<div id="div_filters" style="display:none">
    ...
    <form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter">
        <input type="hidden" name="_action" value="view_fs_progress2" />
        ...
        <div id="filterBox" class="clearfix">
            ...
            <fieldset>
                ...
                <div class="field float">
                    <label>Report:</label><?php echo $view->getFilterHTML('filter_report_type'); ?>
                </div>
            </fieldset>
            <fieldset>
