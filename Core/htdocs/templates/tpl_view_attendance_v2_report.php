...
<div class="banner">
	...
	<div class="ActionIconBar">
		...
		<button onclick="exportToExcel('view_ViewAttendanceV2Report')" title="Export to .CSV file"><img src="/images/btn-excel.gif" width="16" height="16" style="vertical-align:text-bottom" alt="" /></button>
...
<div id="div_filters" style="display:none">
	...
	<form method="get" action="#" id="applySavedFilter">
		<input type="hidden" name="_action" value="view_attendance_v2_report" />
