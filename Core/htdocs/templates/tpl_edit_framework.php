...
<head>
    ...
    <title><?php echo $vo->id == ''?'Create Programme':'Edit Programme'; ?></title>
...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;"><?php echo $vo->id == ''?'Create New Programme':'Edit Programme'; ?></div>
            <div class="ButtonBar">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="box box-primary">
                <div class="box-header with-border"><h2 class="box-title">Programme Details</small></h2>
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control optional" name="first_review" id="first_review" value="<?php echo $vo->first_review; ?>" onkeypress="return numbersonly(this);" maxlength="3" />&nbsp;<i class="text-info">(weeks)</i>
                                    </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                ?>                                
                                                <br>
                                                <button type="button" class="btn btn-sm btn-info" id="btnOnefileRefresh" onclick="refresh_onefile_fwk_tpls();"><i class="fa fa-refresh"></i> Refresh</span></td>
                                            </div>
                                        </div>
...
<script language="JavaScript">
    ...
    function refresh_onefile_fwk_tpls()
    {
        ...
        function onefileRefreshCallback()
        {
            ...
            $("button#btnOnefileRefresh").html('<i class="fa fa-refresh"></i> Refresh');
        }
