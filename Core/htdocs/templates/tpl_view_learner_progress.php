...
<head>
    ...
    <title>View Learner Progress</title>
...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;">View Learner Progress</div>
            <div class="ButtonBar">
            ...
            <div class="ActionIconBar">
                ...
                <span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="window.location.href='do.php?_action=view_learner_progress&subaction=export_csv'" title="Export to .CSV file"></span>
    ...
    <div class="row">
        <div id="div_filters" style="display:none">
            ...
            <form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter">
                <input type="hidden" name="_action" value="view_learner_progress" />
                ...
                <div id="filterBox" class="clearfix small">
                    <fieldset>
                        ...
                        <div class="field float"><label>Learner Status:</label><?php echo $view->getFilterHTML('filter_record_status_operations'); ?></div>
                        <div class="field float"><label>Programme Manager:</label><?php echo $view->getFilterHTML('filter_manager'); ?></div>
                    ...
                    <fieldset>
                        ...
                        <div class="field float"><label>Gateway forecast date between</label><?php echo $view->getFilterHTML('gateway_forecast_date_from'); ?>&nbsp;and <?php echo $view->getFilterHTML('gateway_forecast_date_to'); ?></div>
                        <!--<div class="field newrow"></div>
