<div id="header" style="margin-top: 5px; border-top: 12px solid green;" width="100%" ></div>
<center>
<div style="margin-left: 100px; margin-top: 20px; ">

<span><h2>ATG Training</h2> </span>
...
<div id="main" style='margin-top: 5px; display: block; margin-left: auto; margin-right: auto; width: 960px;'>
	...
	<center>
		...
		<tr>
			<td>Username:</td>
			<td><input style="border: 1px solid green" id="txtUsername" type="text" name="username" value="" /></td>
		</tr>
		<tr>
			<td>Password:</td>
			<td><input style="border: 1px solid green"  type="password" name="password" value="" /></td>
		</tr>
		<tr>
			<td></td>
