...
<head>
    ...
    <script src="/js/ilr2018.js?n=<?php echo time(); ?>"></script>
</head>
...
<div class="banner">
    <table border="0" cellspacing="0" cellpadding="0" height="100%" width="100%">
        <tr class="head">
            <td valign="bottom">
                <?php if ($template != 1) { ?>
                <?php echo $vo->GivenNames . ' ' . $vo->FamilyName; ?> 2018/19 ILR
                <?php } else { ?>
                ILR Template
                <?php }  ?>
            </td>
...
//echo "<input class='compulsory validate[required]' type='text' value='" . $add1 . "' style='' id='AddLine1' name='AddLine1' maxlength=30 size=28 onKeyPress='return validAddress(this, event)'>";
            ...
            <tr>
                <?php
                $this->dynamic_field_display('OTJHours', "<input class='optional' type='text' value='" . $vo->OTJHours . "' style='' id='OTJHours' name='OTJHours' maxlength=4 size=4 onKeyPress='return numbersonly(this, event)'>");
                ?>
            </tr>
...
foreach ($vo->LearningDelivery as $delivery) {
    ...
    echo '<tr>';
    $this->dynamic_field_display('EPAOrgID', "<input class='optional tooltip' type='text' value='" . $delivery->EPAOrgID . "' style='' id='EPAOrgID' name='EPAOrgID' maxlength=7 size=7 >");
    echo '</tr>';
...
<form  name="pdf" id="pdf" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
    <input type="hidden" name="_action" value="pdf_from_ilr2018" />
