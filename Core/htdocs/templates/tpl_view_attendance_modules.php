<?php /* @var $view ViewAttendanceModules */ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
	"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
	<title>Attendance Modules</title>
...
<body>
<div class="banner">
	<div class="Title">Attendance Modules</div>
	<div class="ButtonBar">
		<?php if(true || $_SESSION['user']->isAdmin()){ ?>
		<button onclick="window.location.href='do.php?_action=edit_attendance_module';">New</button>
		<?php } ?>
	</div>
	<div class="ActionIconBar">
		<button onclick="showHideBlock('div_filters');showHideBlock('div_filter_crumbs');" title="Show/hide filters"><img src="/images/btn-filter.gif" width="16" height="16" style="vertical-align:text-bottom" /></button>
		<button onclick="window.print()" title="Print-friendly view"><img src="/images/btn-printer.gif" width="16" height="16" style="vertical-align:text-bottom" /></button>
		<button onclick="exportToExcel('view_ViewAttendanceModules')" title="Export to .CSV file"><img src="/images/btn-excel.gif" width="16" height="16" style="vertical-align:text-bottom" alt="" /></button>
	...
	<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter">
		...
		<div id="filterBox" class="clearfix">
			<fieldset>
				...
				<div class="field float">
					<label>Qualification Number:</label><?php echo $view->getFilterHTML('filter_qualification_id'); ?>
				</div>
				<div class="field float">
