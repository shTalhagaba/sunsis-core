...
<head>
	...
	<title>Manager Comments Report</title>
...
<div class="row">
	<div class="col-lg-12">
		<div class="banner">
			<div class="Title" style="margin-left: 6px;">Manager Comments Report</div>
			<div class="ButtonBar">
			</div>
			<div class="ActionIconBar">
				...
				<span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="exportToExcel('view_manager_comments_report');" title="Export to .CSV file"></span>
		...
		<div class="col-lg-12">
			<div id="div_filters" style="display: none;">
				<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" name="applyFilter" id="applyFilter">
					<input type="hidden" name="_action" value="view_manager_comments_report" />
					...
					<div id="filterBox" class="clearfix small">
						<fieldset>
							...
							<div class="field float"><label>L03:</label><?php echo $view->getFilterHTML('filter_l03'); ?></div>
							<div class="field float"><label>Surname:</label><?php echo $view->getFilterHTML('filter_surname'); ?></div>
							<div class="field float"><label>Comment Type:</label><?php echo $view->getFilterHTML('filter_comment_type'); ?></div>
