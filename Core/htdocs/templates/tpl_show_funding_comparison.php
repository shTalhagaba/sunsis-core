...
<head>
    ...
    <title>Funding Comparison</title>
    ...
    <script type="text/javascript">
            ...
            foreach($business_codes as $business_code)
            {
                ...
                $(function () {
                    $('#container<?php echo $index++;?>').highcharts({
                        ...
                        title: {
                        text: 'Funding Comparison Profile Values vs PFR Values'
                        },
                        subtitle: {
                        ...
                        series: [{
                        name: 'Profile Values',
                            data: [<?php echo join(",", $profile[$business_code]);?>]
                        }, {
                        name: 'PFR Values',
        ...
        $(function () {
            $('#container').highcharts({
                ...
                series: [{
                    name: 'Profile Values',
                    data: [<?php echo join($profile,",");?>]
                }, {
                    name: 'PFR Values',
                    data: [<?php echo join($pfr,",");?>]
                }]
            });
        });
        <?php } ?>
...
<div class="banner">
    <div class="Title">Funding Comparison</div>
    <div class="ButtonBar">
            <button onclick="toggleComparison();">Comparison</button>
            <button onclick="toggleProfileValues();">Profile Values</button>
...
<div id="tab1" style="display:none">
    <form method="post" id="frmBusiness">
        ...
        <h4>Profile Values</h4>
        <p><span class="button" onclick="saveForm();">&nbsp;&nbsp;&nbsp;Save&nbsp;&nbsp;&nbsp;</span> </p>
        <?php echo $this->renderBusinessCodes($link, $current_year); ?>
    </form>
</div>
...
<div id="tab2" style="display:none">
    <form method="post" id="frmBusiness2">
        ...
        <h4>Settings</h4>
        <?php
            $single_multi_dropdown = array(array('Single', 'Combined chart for all contracts'), array('Multi', 'Multiple Charts per contract'));
...
<?php
    ...
    else
    {
        ...
        echo "<table class='table1'><tr><td>Cost Centres: " . implode(", ",$business_codes) . "</td></tr></table>";
    }
?>
</div>
