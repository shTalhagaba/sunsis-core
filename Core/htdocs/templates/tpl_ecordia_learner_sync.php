...
<title>Ecordia: Learner Sync</title>
...
<script type="text/javascript">
	...
	function onFilterClick(e) {
		...
		$('div#content').load('do.php?_action=ecordia_learner_sync&subaction=rendercontent' + filters, null, onContentLoad);
	}
...
*/
	function linkRecords(e)
	{
		...
		showProgressAnimation('loading51.gif');
		var client = ajaxRequest('do.php?_action=ecordia_learner_sync&subaction=linkrecords' + data);
		if (!client) {
			//
		}
		//$('div#content').load('do.php?_action=sa_learner_sync&subaction=rendercontent', null, onContentLoad);
	...
	function unlinkRecords(e)
	{
		...
		showProgressAnimation('loading51.gif');
		var client = ajaxRequest('do.php?_action=ecordia_learner_sync&subaction=unlinkrecords' + data);
		if (!client) {
			//
		}
		//$('div#content').load('do.php?_action=sa_learner_sync&subaction=rendercontent', null, onContentLoad);
	...
	function createRecordsinSunesis(e)
	{
		...
		showProgressAnimation('loading51.gif');
		var client = ajaxRequest('do.php?_action=ecordia_learner_sync&subaction=createrecordsinsunesis' + data);
...
<body>
<div class="banner">
	<div class="Title">Ecordia: Learner Synchronisation</div>
	<div class="ButtonBar">
...
<div style="width:1150px;">
	...
	<div class="Newspaper">
		<p class="introduction">Ecordia Learners data may be imported into Sunesis.</p>
		<p class="introduction">To import learner data into Sunesis the learner must have a ULN within Ecordia. These learners will then appear in the <strong>Ecordia learner with no record in Sunesis</strong> section below with the option to Import.</p>
		<p class="introduction">Learners who are currently in both Sunesis and Ecordia will be shown under the <strong>Linked Learner Records</strong> section if ULN is same in both systems</p>
		<p class="introduction">After this process, you will need to set up training records for the learners by enrolling them onto courses.</p>
	</div>
	...
	<div id="Filters">
		<table width="100%">
			...
			<tr>
				...
				<td><?php echo HTML::checkboxGrid('filter_sections', $filterSectionsOptions, $filterSections, 2, true); ?></td>
