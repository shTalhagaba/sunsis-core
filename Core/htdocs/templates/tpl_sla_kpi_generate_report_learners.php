...
<div class="banner">
	...
	<div class="ActionIconBar">
        <input type="button" value="< Back to Dashboard" onclick="window.location.href='?_action=sla_kpi_rep_achievers&report_type=sla_kpi_rep_learners'" style="float:left;margin: 0 0 10px;">
	...
	<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter">
		...
		<div id="filterBox" class="clearfix" style="text-align: left; display: none;">
            ...
            <tr>
                ...
                <td colspan="7">
                    <?php echo $view->getFilterHTML('filter_record_status'); ?>
                </td>
            </tr>
            ...
            <!--<tr>
                <td><label><b>Work experience period</b></label></td>
                <td colspan="7">
                    From : <?php echo $view->getFilterHTML('work_experience_start_date'); ?> to <?php echo $view->getFilterHTML('work_experience_end_date'); ?>
                </td>
            </tr>-->
            </table>
