...
<body>
<div class="banner">
	<div class="Title">Copy Framework</div>
	<div class="ButtonBar">
...
<?php echo $viewf->getFilterCrumbs() ?>
...
<table>
	<tr>
		...
		<td><?php echo $viewf->getFilterHTML(View::KEY_PAGE_SIZE); ?></td>
	</tr>
	<tr>
		<td>Sort by:</td>
		<td><?php echo $viewf->getFilterHTML('order_by'); ?></td>
	</tr>
</table>
