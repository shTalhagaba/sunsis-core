...
function toXML()
{
	...
	xml += "<L04>" + "10" + "</L04>";
	xml += "<L05>" + window.aims_counter+1 + "</L05>";
	xml += "<L06>" + "00" + "</L06>";
	xml += "<L07>" + "00" + "</L07>";
	xml += "<L08>" + "N" + "</L08>";
	...
	if(document.ilr.A49.value!='')
		xml += "<A49>" + document.ilr.A49.value + "</A49>";
	else
		xml += "<A49>" + "     " + "</A49>";
	...
	for(subaims = 1; subaims <= window.aims_counter; subaims++)
	{
		...
		xml += "<A04>" + "30" + "</A04>";
		if(subaims>9)
			xml += "<A05>" + (subaims+1) + "</A05>";
		else
			xml += "<A05>" + "0"+(subaims+1) + "</A05>";
...
function save()
{
	...
	var client = ajaxRequest('do.php?_action=save_new_ilr', postData);
	if(client != null)
	{
...
function validation()
{
	...
	var client = ajaxRequest('do.php?_action=validate_new_ilr', postData);
	if(client != null)
	{
...
<div class="banner">
	<div class="Title">Individual Learner Record</div>
	<div class="ButtonBar">
		<?php 
		...
		<?php ?>
		<button onclick="return validation();">Validate</button>
...
<table border="0" cellspacing="4" cellpadding="4">
	...
	<tr>
		...
		<?php echo HTML::select('L25', $L25_dropdown, $vo->learnerinformation->L25, true, true); ?></td>
	...
	<tr>
		...
		<?php echo HTML::select('L01', $L01_dropdown, $vo->learnerinformation->L01, true, true); ?></td>
		<td class="fieldLabel_compulsory"> L03 Learner Reference Number <br>
		<input class="compulsory" type="text" value="<?php echo $vo->learnerinformation->L03;?>" style="font-family:monospace" id="L03" name="L03" maxlength=12 size=12 onKeyPress="return validLearnerReference(this, event)"> </td>
	</tr>
	<tr>
		<td class="fieldLabel_compulsory"> L46 UK Provider Reference No. <br>
		<?php echo HTML::select('L46', $L46_dropdown, $vo->learnerinformation->L46, true, true); ?></td>
		<td class="fieldLabel_compulsory"> L45 Unique Learner No.  <br>
		<input type="text" class="compulsory" value="<?php echo $vo->learnerinformation->L45;?>" id="L45" name="L45" maxlength=10 size=10 onKeyPress="return numbersonly(this, event)"></td>
		<tr> <td> &nbsp </td> </tr>

        <tr cellpadding="5" borders="all">           
               <td border=1 colspan=4 bgcolor="darkseagreen" align="center"> <b> <font size=3> Individual Learner Record - PART A - Learner Information - WBL/ESF/TtG </font> </b> </td>
        </tr> 
        <tr>
		...
		<input class="compulsory" type="text" value="<?php echo $vo->learnerinformation->L09;?>" style="font-family:monospace" id="L09" name="L09" maxlength=20 size=30 onKeyPress="return validName(this, event)"> </td>
		<td class="fieldLabel_compulsory"> L10 Learner's Forenames <br>
		<input class="compulsory" type="text" value="<?php echo $vo->learnerinformation->L10;?>" style="font-family:monospace" id="L10" name="L10" maxlength=40 size=40 onKeyPress="return validName(this, event)"> </td>
        </tr>
        <tr>
		<td class="fieldLabel_compulsory"> L26 National Insurance No. <br>
		<input class="compulsory" type="text" value="<?php echo $vo->learnerinformation->L26;?>" style="font-family:monospace" id="L26" name="L26" maxlength=9 size=20> </td>
		<td class="fieldLabel_compulsory">L17 Home Postcode (of Permanent Address before enrolment) <br>
		<input class="compulsory" type="text" value="<?php echo $vo->learnerinformation->L17;?>" style="font-family:monospace" id="L17" name="L17" maxlength=8 size=8> </td>
		</tr>
		<tr>		
		<td class="fieldLabel_compulsory">L11 Date of Birth <br>
		<?php
			if($vo->learnerinformation->L11!='00000000' && $vo->learnerinformation->L11!='')
		...
		<input class="compulsory" type="text" value="<?php echo $vo->learnerinformation->L18;?>" style="font-family:monospace" id="L18" name="L18" maxlength=30 size=28 onKeyPress="return validAddress(this, event)"> </td>
		<td class="fieldLabel_compulsory"> L19 Suburb/ Village <br>
		<input class="compulsory" type="text" value="<?php echo $vo->learnerinformation->L19;?>" style="font-family:monospace" id="L19" name="L19" maxlength=30 size=35 onKeyPress="return validAddress(this, event)"> </td>
		</tr>
		<tr>		
		<td class="fieldLabel_compulsory"> L20 Town/ City <br>
		<input class="compulsory" type="text" value="<?php echo $vo->learnerinformation->L20;?>" style="font-family:monospace" id="L20" name="L20" maxlength=30 size=30 onKeyPress="return validAddress(this, event)"> </td>
		<td class="fieldLabel_compulsory"> L21 County <br>
		<input class="compulsory" type="text" value="<?php echo $vo->learnerinformation->L21;?>" style="font-family:monospace" id="L21" name="L21" maxlength=30 size=35 onKeyPress="return validAddress(this, event)"> </td>
		</tr>
		<tr>
		<td class="fieldLabel_compulsory">L22 Current Postcode <br> 
		<input class="compulsory" type="text" value="<?php echo $vo->learnerinformation->L22;?>" style="font-family:monospace" id="L22" name="L22" maxlength=8 size=8> </td>
		<td class="fieldLabel_optional">L23 Contact Telephone No (inc STD Code) <br> 
		<input type="text" class="optional" value="<?php echo $vo->learnerinformation->L23;?>" id="L23" name="L23" maxlength=15 size=15 onKeyPress="return numbersonly(this, event)"></td>
		</tr>
        <tr>
		...
		<input type="text" class="compulsory" value="<?php echo $vo->learnerinformation->L34a;?>"  id="L34a" name="L34a" maxlength=2 size=2 onKeyPress="return numbersonly(this, event)">
		<input type="text" class="compulsory" value="<?php echo $vo->learnerinformation->L34b;?>"  id="L34b" name="L34b" maxlength=2 size=2 onKeyPress="return numbersonly(this, event)">
		<input type="text" class="compulsory" value="<?php echo $vo->learnerinformation->L34c;?>"  id="L34c" name="L34c" maxlength=2 size=2 onKeyPress="return numbersonly(this, event)">
		<input type="text" class="compulsory" value="<?php echo $vo->learnerinformation->L34d;?>"  id="L34d" name="L34d" maxlength=2 size=2 onKeyPress="return numbersonly(this, event)"></td>
		...
		<?php 
		if($vo->learnerinformation->L48!='00000000' && $vo->learnerinformation->L48!='')
        ...
        <tr>
		<td valign="top"><input type="checkbox" name="L27a">
		<b> L27a: Tick box L27a if you do not wish to be contacted by the LSC or its partners in respect of surveys and research. The LSC values your views on the education and training which you receive, and will use these to help bring about improvement for learners in England </b><br></td>
		<td valign="top"><input type="checkbox" name="L27b">
		<b> L27b: Tick box L27b The LSC or its partners may wish to contact you from time to time about courses, or learning opportunities relevant to you. Please tick box L27b if you do not wish to be contacted about courses or learning opportunities by post.<br></td>
		</tr>
		<tr>
		...
		<input class="optional" type="text" value="<?php echo $vo->learnerinformation->L41a;?>" style="font-family:monospace" id="L41a" name="L41a" maxlength=12 size=30 onKeyPress="return numbersonly(this, event)"> </td>
		</tr>
		<tr>
		<td class="fieldLable_optional"> L41 Local LSC Learner Monitoring <br>
		<input class="optional" type="text" value="<?php echo $vo->learnerinformation->L41b;?>" style="font-family:monospace" id="L41b" name="L41b" maxlength=12 size=30 onKeyPress="return numbersonly(this, event)"> </td>
		</tr>
		
		<tr>
		<td class="fieldLabel_optional"> L42 Provider Specified Learner Data <br>
		<input class="optional" type="text" value="<?php echo $vo->learnerinformation->L42a;?>" style="font-family:monospace" id="L42a" name="L42a" maxlength=12 size=30"> </td>
		<td class="fieldLable_optional"> L42 Provider Specified Learner Data <br>
		<input class="optional" type="text" value="<?php echo $vo->learnerinformation->L42b;?>" style="font-family:monospace" id="L42b" name="L42b" maxlength=12 size=30"> </td>
		</tr>
		</table>
		</div>	
		<br><br>
		...
		<?php echo HTML::select('A01', $A01_dropdown, $vo->aims[0]->A01, true, true); ?></td>
		</tr>
		<tr>
		<td class="fieldLabel_compulsory">A03 Learner Reference Number <br>
		<input type="text" class="compulsory" value="<?php echo $vo->aims[0]->A03;?>" id="A03" name="A03" maxlength=12 size=12></td>
		<td class="fieldLabel_compulsory"> A56 UK Provider reference Number <br> 
		<?php echo HTML::select('A56', $A56_dropdown, $vo->aims[0]->A56, true, true); ?></td>
		</tr>
		<tr>
		<td class="fieldLabel_compulsory"> A55 Unique Learner Number <br>
		<input type="text" class="compulsory" value="<?php echo $vo->aims[0]->A55;?>" id="A55" name="A55" maxlength=10 size=10></td>
		<tr><td> &nbsp </td></tr>		
        <tr cellpadding="5" borders="all">           
               <td width=100% colspan=4 border=1 bgcolor="darkseagreen" align="Center"> <b> <font size=3> Individual Learner Record - Part B - Main Aim Information - WBL/ESF/TtG </font> </b> </td>
        </tr> 
        <tr>
		...
		<input type="text" class="compulsory" value="<?php echo $vo->aims[0]->A09;?>" id="A09" name="A09" maxlength=8 size=8></td>
		...
		<tr>
		<td class="fieldLabel_compulsory"> A18 Main Delivery Method <br>
		<?php echo HTML::select('A18', $A18_dropdown, $vo->aims[0]->A18, true, true); ?></td>
		<td class="fieldLabel_compulsory"> A27 Learning Start Date <br>
		<?php 
		if($vo->aims[0]->A27!='00000000' && $vo->aims[0]->A27!='')
			echo HTML::datebox('A27', $vo->aims[0]->A27, true);
		else
			echo HTML::datebox('A27',''); 
		 ?></td>
        </tr>
        <tr>
		<td class="fieldLabel_compulsory"> A28 Planned End Date <br>
		<?php 
		if($vo->aims[0]->A28!='00000000' && $vo->aims[0]->A28!='')
			echo HTML::datebox('A28', $vo->aims[0]->A28, true);
		else
			echo HTML::datebox('A28','');
		?></td>
		...
		<input type="text" class="compulsory" value="<?php echo $vo->aims[0]->A32;?>" id="A32" name="A32" maxlength=5 size=5 onKeyPress="return numbersonly(this, event)"></td>
        </tr>
		<tr>     	
		<td class="fieldLabel_compulsory"> A51a Proportion of Funding <br>
		<input type="text" class="compulsory" value="<?php echo $vo->aims[0]->A51a;?>" id="A51a" name="A51a" maxlength=2 size=2 onKeyPress="return numbersonly(this, event)"></td>
		...
		<input type="text" class="optional" value="<?php echo $vo->aims[0]->A49;?>" id="A49" name="A49" maxlength=5 size=5></td>
		</tr>
		<tr>
		<td class="fieldLabel_compulsory"> A44 Employer Identifier <br>
		<input type="text" class="compulsory" value="<?php echo $vo->aims[0]->A44;?>" id="A44" name="A44" maxlength=30 size=30"></td>
		<td class="fieldLabel_compulsory"> A45 Workplace Location Postcode <br>
		<input type="text" class="compulsory" value="<?php echo $vo->aims[0]->A45;?>" id="A45" name="A45" maxlength=8 size=8></td>
        </tr>
        <tr>
		<td class="fieldLabel_compulsory"> A23 Delivery Location Postcode <br>
		<input type="text" class="compulsory" value="<?php echo $vo->aims[0]->A23;?>" id="A23" name="A23" maxlength=8 size=8></td>
		...
		<?php 
		if($vo->aims[0]->A40!='00000000' && $vo->aims[0]->A40!='') 
		...
		<?php 
		if($vo->aims[0]->A31!='00000000' && $vo->aims[0]->A31!='')
		...
		<?php echo HTML::select('A34', $A34_dropdown, $vo->aims[0]->A34, true, true); ?></td>
		...
		<input type="text" class="compulsory" value="<?php echo $vo->aims[0]->A37;?>" id="A37" name="A37" maxlength=2 size=2 onKeyPress="return numbersonly(this, event)"></td>
		<td class="fieldLabel_compulsory"> A38 Total number of units required to achieve full learning aim <br>
		<input type="text" class="compulsory" value="<?php echo $vo->aims[0]->A38;?>" id="A38" name="A38" maxlength=2 size=2 onKeyPress="return numbersonly(this, event)"></td>
        </tr>
        <tr>
		...
		<?php 
		if($vo->aims[0]->A43!='00000000' && $vo->aims[0]->A43!='')
		...
		<input type="text" class="optional" value="<?php echo $vo->aims[0]->A47a;?>" id="A47a" name="A47a" maxlength=12 size=35 onKeyPress="return numbersonly(this, event)"></td>
		<td class="fieldLabel_optional"> A47 Local LSC Learning Aim Monitoring <br>
		<input type="text" class="optional" value="<?php echo $vo->aims[0]->A47b;?>" id="A47b" name="A47b" maxlength=12 size=35 onKeyPress="return numbersonly(this, event)"></td>
		</tr>
		<tr>
		<td class="fieldLabel_optional"> A48 Provider Specified Learning Aim Data <br>
		<input type="text" class="optional" value="<?php echo $vo->aims[0]->A48a;?>" id="A48a" name="A48a" maxlength=12 size=35"></td>
		<td class="fieldLabel_optional"> A48 Provider Specified Learning Aim Data <br>
		<input type="text" class="optional" value="<?php echo $vo->aims[0]->A48b;?>" id="A48b" name="A48b" maxlength=12 size=35"></td>
		</tr>
		<tr>
		...
		for($a=1; $a<=$vo->subaims; $a++)
		{
			...
			echo "</script>";
											...
											<table>
											<tr cellpadding='5' borders='all'>           
											<td border=1 colspan=4 bgcolor='darkseagreen' align='Center'> <b> <font size=3> Individual Learner Record - Part C - Subsidiary Aim Information - WBL/ESF </font> </b> 
								            ...
								            <td colspan=4>&nbsp;</td>
								   			...
								   			<tr>
											<td class='fieldLabel_compulsory'> A09 Learning Aim Reference Number <br>
											<input type='text' class='compulsory' value='<?php echo $vo->aims[$a]->A09; ?>' id='SA09' name='SA09' maxlength=8 size=8></td>
											<td class='fieldLabel_compulsory'> A10 LSC Funding Stream  <br>
		            			    ...
		            			    <tr>
											<td class="fieldLabel_compulsory"> A27 Learning Start Date <br>
											<?php 
											if($vo->aims[$a]->A27!='00000000' && $vo->aims[$a]->A27!='')
												echo HTML::datebox('SA27', $vo->aims[$a]->A27);
											else
												echo HTML::datebox('SA27', '');
											?></td>
											<td class="fieldLabel_compulsory"> A26 Sector Code <br>
            			            ...
            			            <tr>
											<td class="fieldLabel_compulsory"> A28 Planned End Date <br>
											<?php 
											if($vo->aims[$a]->A28!='00000000' && $vo->aims[$a]->A28!='')
												echo HTML::datebox('SA28', $vo->aims[$a]->A28);
											else
												echo HTML::datebox('SA28', '');
											?></td>
											<td class="fieldLabel_compulsory"> A06 ESF Data Set <br>
		            			    ...
		            			    <tr>
											...
											<td class="fieldLabel_compulsory"> A51a Proportion of Funding <br>
											<input type="text" class="compulsory" value='<?php echo $vo->aims[$a]->A51a; ?>' id="SA51a" name="SA51a" maxlength=2 size=2 onKeyPress="return numbersonly(this, event)"></td>
			                        </tr>
			                        <tr>
											<td class="fieldLabel_compulsory"> A40 Achievement Date <br>
											<?php 
											if($vo->aims[$a]->A40!='00000000' && $vo->aims[$a]->A40!='')
											...
											<td class="fieldLabel_optional"> A31 Learning Actual End Date <br>
											<?php 
											if($vo->aims[$a]->A31!='00000000' && $vo->aims[$a]->A31!='')
		            			    ...
		            			    <tr>
											<td class="fieldLabel_compulsory"> A34 Completion Status <br>
											<?php echo HTML::select('SA34', $A34_dropdown, $vo->aims[$a]->A34, true, true); ?></td>
											<td class="fieldLabel_compulsory"> A35 Learning Outcome <br>
											<?php echo HTML::select('SA35', $A35_dropdown, $vo->aims[$a]->A35, true, true); ?></td>
									</tr>
		            			    <tr>
											<td class="fieldLabel_compulsory"> A37 No. of units completed from a learning aim <br>
											<input type="text" class="compulsory" value='<?php echo $vo->aims[$a]->A37; ?>' id="SA37" name="SA37" maxlength=2 size=2 onKeyPress="return numbersonly(this, event)"></td>
											<td class="fieldLabel_compulsory"> A38 Total number of units required to achieve full learning aim <br>
											<input type="text" class="compulsory" value='<?php $vo->aims[$a]->A38; ?>' id="SA38" name="SA38" maxlength=2 size=2 onKeyPress="return numbersonly(this, event)"></td>
									</tr>
		            			    <tr>
										...
										<td class="fieldLabel_optional"> A47 Local LSC Learning Aim Monitoring <br>
										<input type="text" class="optional" value="<?php echo $vo->aims[$a]->A47a;?>" id="SA47a" name="SA47a" maxlength=12 size=35 onKeyPress="return numbersonly(this, event)"></td>
									</tr>
		            			    <tr>
										<td class="fieldLabel_optional"> A47 Local LSC Learning Aim Monitoring <br>
										<input type="text" class="optional" value="<?php echo $vo->aims[$a]->A47b;?>" id="SA47b" name="SA47b" maxlength=12 size=35 onKeyPress="return numbersonly(this, event)"></td>
										<td class="fieldLabel_optional"> A48 Provider Specified Learning Aim Data <br>
										<input type="text" class="optional" value="<?php echo $vo->aims[$a]->A48a;?>" id="SA48a" name="SA48a" maxlength=12 size=35"></td>
									</tr>
		            			    <tr>
										<td class="fieldLabel_optional"> A48 Provider Specified Learning Aim Data <br>
										<input type="text" class="optional" value="<?php echo $vo->aims[$a]->A48b;?>" id="SA48b" name="SA48b" maxlength=12 size=35"></td>
								        </tr>
										</table>
		...
		?>
	   				...
	   				<table>
			                        <tr cellpadding="5" borders="all">           
			                               <td border=1 colspan=4 bgcolor="darkseagreen" align="Center"> <b> <font size=3> Individual Learner Record - Part C - Subsidiary Aim Information - WBL/ESF </font> </b> <button id='butt' onClick='addAim(this);'> + </button> <button id='butt' onClick='deleteAim(this);'> X </button> </td>
			                        </tr>
			                        <tr>
                                           <td colspan=4 align="center" valign="middle"> <b> <ul> Section 8 Subsidiary Aim (Including Technical Certificates and Key Skills)  </ul> </b> </td>
			                        </tr>
            			            ...
            			            <tr>
											<td class="fieldLabel_compulsory"> A27 Learning Start Date <br>
											<?php echo HTML::datebox('SA27', null) ?></td>
											<td class="fieldLabel_compulsory"> A26 Sector Code <br>
											<?php echo HTML::select('SA26', $A26_dropdown, null, true, true); ?></td>
			                        </tr>
            			            <tr>
											<td class="fieldLabel_compulsory"> A28 Planned End Date <br>
											<?php echo HTML::datebox('SA28', null) ?></td>
											<td class="fieldLabel_compulsory"> A06 ESF Data Set <br>
            			            ...
            			            <tr>
											<td class="fieldLabel_compulsory"> A34 Completion Status<br>
											<?php echo HTML::select('SA34', $A34_dropdown, null, true, true); ?></td>
											<td class="fieldLabel_compulsory"> A35 Learning Outcome<br>
