...
<div id="div_filters" style="display:none">
	...
	<form name="filters" method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" onsubmit="return validateFilters(this);" id="applyFilter">
		<input type="hidden" name="_action" value="view_attendance_summary2" />
		...
		<div id="filterBox" class="clearfix">
			...
			<fieldset>
				...
				<div class="field float">
					<label>Group Assessor:</label><?php echo $view->getFilterHTML('filter_group_assessor'); ?> <img id="globe2" src="/images/rotatingGlobe.gif" style="vertical-align:text-bottom;display:none" />
				</div>
				<div class="field float">
					<label>Training Record Assessor:</label><?php echo $view->getFilterHTML('filter_tr_assessor'); ?> <img id="globe2" src="/images/rotatingGlobe.gif" style="vertical-align:text-bottom;display:none" />
				</div>
			</fieldset>			
			<fieldset>
