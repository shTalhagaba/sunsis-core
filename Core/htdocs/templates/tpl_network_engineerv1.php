...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "CompTIA Server+"); ?></td>
        <td>Network Systems & Architecture Test</td>
        <td><?php echo $this->getEventStatus($events, "Network Systems & Architecture Test"); ?></td>
        <td>CompTIA Security</td>
        <td><?php echo $this->getEventStatus($events, "ISQI Agile Business Analysis"); ?></td>
    </tr>
    <tr>
        <td>Network Security Test</td>
        <td><?php echo $this->getEventStatus($events, "Network Security Test"); ?></td>
        <td>CompTIA Network+</td>
        <td><?php echo $this->getEventStatus($events, "CompTIA Network+"); ?></td>
        <td>CompTIA Network+ Test</td>
        <td><?php echo $this->getEventStatus($events, "CompTIA Network+ Test"); ?></td>
    </tr>
    <tr>
