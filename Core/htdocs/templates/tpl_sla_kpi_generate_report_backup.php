...
<title>SLA / KPI Achievers report</title>
...
<body>
<div class="banner">
	<div class="Title">SLA / KPI Achievers Report</div>
	<div class="ButtonBar">
	...
	<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter">
		...
		<div id="filterBox" class="clearfix">
			...
			<fieldset>
                ...
                <div class="field float">
					<label>Drilldown by : </label> <?php echo $view->getFilterHTML("filter_drilldown"); ?>
				</div>
			</fieldset>

            <fieldset>
				<legend>Achievement Date</legend>
				<div class="field">
				From :
