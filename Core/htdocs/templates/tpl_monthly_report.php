...
<head>
	...
	<script language="JavaScript">
		...
		function toggleSubs()
		{
			showHideBlock(document.getElementById("subs1"));
			showHideBlock(document.getElementById("subs2"));
			showHideBlock(document.getElementById("subs3"));
			showHideBlock(document.getElementById("subs4"));
			showHideBlock(document.getElementById("subs5"));
			showHideBlock(document.getElementById("subs6"));
            showHideBlock(document.getElementById("subs7"));
            showHideBlock(document.getElementById("subs8"));
		}

		function exportMonthlyReport(category)
		{
			window.location.href = "do.php?_action=monthly_report&export=csv&category="+category;
		}
	</script>
...
<div class="banner">
	...
	<div class="ButtonBar">
		<input type = checkbox onclick = "toggleSubs()">By Frameworks </input>
	</div>
...
<div id="div_filters" style="display:none">
	<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>">
		...
		<input type="hidden" name="_action" value="monthly_report" />
		<table>
			<!--<tr>
	...
	-->
            <tr>
                <td>Assessor:</td>
                <td><?php echo $view->getFilterHTML('filter_assessor'); ?></td>
            </tr>
			<tr>
                <td>FS Tutor:</td>
