...
<body>
<div class="banner">
	<div class="Title">Success Rates Report</div>
	<div class="ButtonBar">
		<button onclick="window.history.go(-1);">Back</button>
		<button  id="b4" onclick="PDF();">Summary</button>
	</div>
...
<div id="div_filters" style="display:none">
	...
	<input type="hidden" name="_action" value="view_app_achievers" />
	...
	<div id="filterBox" class="clearfix">
		<fieldset>
				<legend>Contract</legend>	
					...
					<tr>
						<td>
							<label>Submission:</label><?php echo $view->getFilterHTML('filter_submission'); ?>
						</td>
					</tr>
		</fieldset>
		<fieldset>
				<legend>Report</legend>	
					<tr>
						<td>
							<label>Report:</label><?php echo $view->getFilterHTML('filter_report'); ?>
						</td>
					</tr>
					<tr>
						<td>
...
<input type="hidden" name="_action" value="pdf_success_rates" />
<input type="hidden" name="achievers" value="<?php echo $view->total_achievers;?>" />
<input type="hidden" name="timely_achievers" value="<?php echo $view->total_timely_achievers;?>" />
<input type="hidden" name="leavers" value="<?php echo $view->total_leavers;?>" />
<input type="hidden" name="timely_leavers" value="<?php echo $view->total_timely_leavers;?>" />
<input type="hidden" name="submission" value="<?php echo $view->getFilterValue('filter_submission'); ?>" />
</form>
