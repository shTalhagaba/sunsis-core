...
<div class="row">
	<div class="col-lg-12">
		<div class="banner">
			<div class="Title" style="margin-left: 6px;">Programme Details</div>
			<div class="ButtonBar">
				<?php if($_SESSION['user']->type != User::TYPE_SYSTEM_VIEWER && $_SESSION['user']->type != User::TYPE_ORGANISATION_VIEWER) {?>
				<button class="btn btn-default btn-sm" onclick="window.location.href='do.php?_action=edit_framework';"><i class="fa fa-plus"></i> Create New Programme</button>
				<?php } ?>
			</div>
