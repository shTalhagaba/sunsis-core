...
<div class="banner">
	...
	<div class="ButtonBar">
		<?php if($_SESSION['user']->type==7 || $_SESSION['user']->isAdmin() || $_SESSION['user']->type==8 || $_SESSION['user']->type==1){ ?>
		<?php } ?>
	</div>
...
<div id="div_filters" style="display:none">
	...
	<input type="hidden" name="_action" value="view_candidate_employers" />
...
<!-- 			<fieldset>
				...
				<div class="field float">
					<label>Manufacturer/ Brand:</label><?php //echo $view->getFilterHTML('filter_manufacturer'); ?>
				</div>
				<div class="field float">
