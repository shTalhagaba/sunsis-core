...
<div class="banner">
	...
	<div class="ActionIconBar">
        <input type="button" value="< Back to Dashboard" onclick="window.location.href='?_action=sla_kpi_rep_achievers&report_type=sla_kpi_rep_last_visit'" style="float:left;margin: 0 0 10px;">
