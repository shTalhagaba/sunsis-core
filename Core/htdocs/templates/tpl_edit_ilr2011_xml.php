...
function toXML()
{
	...
	else if(FDL=="3" && (EIIFDL=="1" || EIIFDL==""))
	{
		xml += "<L37>18</L37>";
	}
	else if(FDL=="3" && EIIFDL=="2")
	{
		xml += "<L37>19</L37>";
	}
	...
	// Calculation of L47
	CES = document.ilr.CES.value;
	EIICES = document.ilr.EIICES.options[document.ilr.EIICES.selectedIndex].value;
	RFUCES = document.ilr.RFUCES.options[document.ilr.RFUCES.selectedIndex].value;
	BSICES = document.ilr.BSICES.options[document.ilr.BSICES.selectedIndex].value;


	if(CES=="1" && EIICES=="" && RFUCES=="" && BSICES=="")
	{
		xml += "<L47>1</L47>";
	}
	else if(CES=="4" && EIICES=="" && RFUCES=="" && BSICES=="")
	{
		xml += "<L47>5</L47>";
	}	
	else if(CES=="4" && EIICES=="" && RFUCES=="1" && BSICES=="")
	{
		xml += "<L47>10</L47>";
	}	
	else if(CES=="4" && EIICES=="" && RFUCES=="2" && BSICES=="")
	{
		xml += "<L47>4</L47>";
	}	
	else if(CES=="1" && EIICES=="1" && RFUCES=="" && BSICES=="")
	{
		xml += "<L47>6</L47>";
	}	
	else if(CES=="1" && EIICES=="2" && RFUCES=="" && BSICES=="")
	{
		xml += "<L47>7</L47>";
	}	
	else if(CES=="4" && EIICES=="" && RFUCES=="1" && BSICES=="1")
	{
		xml += "<L47>8</L47>";
	}	
	else if(CES=="4" && EIICES=="" && RFUCES=="1" && BSICES=="2")
	{
		xml += "<L47>9</L47>";
	}	
	else if(CES=="4" && EIICES=="" && RFUCES=="1" && BSICES=="")
	...
	else if(CES=="4" && EIICES=="" && RFUCES=="2" && BSICES=="1")
	{
		xml += "<L47>11</L47>";
	}	
	else if(CES=="4" && EIICES=="" && RFUCES=="2" && BSICES=="2")
	{
		xml += "<L47>12</L47>";
	}	
	else if(CES=="4" && EIICES=="" && RFUCES=="2" && BSICES=="")
	...
	else if(CES=="4" && EIICES=="" && RFUCES=="" && BSICES=="1")
	{
		xml += "<L47>14</L47>";
	}	
	else if(CES=="4" && EIICES=="" && RFUCES=="" && BSICES=="2")
	{
		xml += "<L47>15</L47>";
	}	
	else if(CES=="6" && EIICES=="" && RFUCES=="" && BSICES=="")
	{
		xml += "<L47>17</L47>";
	}	
	else if(CES=="98" && EIICES=="" && RFUCES=="" && BSICES=="")
	{
		xml += "<L47>98</L47>";
	}
	else if(CES=="3" && (EIICES=="1" || EIICES==""))
	{
		xml += "<L47>18</L47>";
	}
	else if(CES=="3" && EIICES=="2")
	{
		xml += "<L47>19</L47>";
	}
	else
	...
	if(document.ilr.PA04.value==1)
		A04 = '35';
	else
		A04 = document.ilr.PA04.value;
	...
	// A53 Calculation 
	ALN = document.ilr.ALN.checked;
	ASN = document.ilr.ASN.checked;
	if(ALN && (!ASN))
	{
		xml += "<A53>11</A53>";
	}
	...
	xml += "<A69>" + document.ilr.PA69.options[document.ilr.PA69.selectedIndex].value + "</A69>";
	...
	xml += "<A44b>" + document.ilr.CESA44.value + "</A44b>";
	xml += "<A45b>" + document.ilr.CESA45.value + "</A45b>";
	xml += "<A46a>" + document.ilr.PA46a.options[document.ilr.PA46a.selectedIndex].value + "</A46a>";
	xml += "<A46b>" + document.ilr.PA46b.options[document.ilr.PA46b.selectedIndex].value + "</A46b>";
	xml += "<A47a></A47a>";
	xml += "<A47b></A47b>";
...
<div class="banner">
	...
	<div class="ButtonBar">
		...
		<button disabled id="b5" onclick="if(prompt('Password','')=='pscd2011')changeL03();">Change LRN</button>
...
<table border="0" cellspacing="4" cellpadding="4">
	...
	<tr colspan=2>
		...
		<td valign="top"> By post&nbsp;<input type="checkbox" checked name="L52a"> </input>
		By phone&nbsp;<input type="checkbox" name="L52b"> </input>
		By e-mail&nbsp;<input type="checkbox" name="L52c"> </input> </td>
		<?php }elseif($vo->learnerinformation->L52=='2') { ?>
		<td valign="top"> By post&nbsp;<input type="checkbox" name="L52a"> </input>
		By phone&nbsp;<input type="checkbox" checked name="L52b"> </input>
		By e-mail&nbsp;<input type="checkbox" name="L52c"> </input> </td>
		<?php }elseif($vo->learnerinformation->L52=='3') { ?>
		<td valign="top"> By post&nbsp;<input type="checkbox" name="L52a"> </input>
		By phone&nbsp;<input type="checkbox" name="L52b"> </input>
		By e-mail&nbsp;<input type="checkbox" checked name="L52c"> </input> </td>
	...
	<tr>
		...
		<?php }elseif($l37=='18' || $l37=='19') { ?>
		<?php echo "<input class='optional' type='text' value='3' id='FDL' name='FDL' maxlength=1 size=1></td>"; ?>
		<?php }elseif($l37=='98') { ?>
	...
	<tr>
		<td class="fieldLabel_compulsory"> Employer ID <br>
		<?php echo "<input class='compulsory' type='text' value='" . $vo->aims[0]->A44 . "' style='' id='A44' name='A44' maxlength=30 size=30></td>"; ?>
		<td class="fieldLabel_compulsory"> Workplace Location Postcode <br>
		<?php echo "<input class='compulsory' type='text' value='" . $vo->aims[0]->A45 . "' style='background-color: white' id='A45' name='A45' maxlength=8 size=8></td>"; ?>	
	</tr>
	...
	<tr>
		...
		<?php $l37 = $vo->learnerinformation->L37; if($l37=='6' || $l37=='18') { ?>
		<?php echo HTML::select('EIIFDL', $EII_dropdown, '1', true, true); ?></td>
		<?php }elseif($l37=='7' || $l37=='19') { ?>
	...
	<tr>
		...
		<?php echo HTML::select('RFUFDL', $RFU_dropdown, '2', true, true); ?></td>
		<?php }else { ?>
		<?php echo HTML::select('RFUFDL', $RFU_dropdown, '', true, true); ?></td>
		<?php } ?>
	...
	<tr>
		...
		<?php $l47 = $vo->learnerinformation->L47; if($l47=='1' || $l47=='6' || $l47=='7') { ?>
		<?php echo "<input class='optional' type='text' value='1' id='CES' name='CES' maxlength=1 size=1></td>"; ?>
		<?php }elseif($l47=='2' || $l47=='3' || $l47=='4' || $l47=='5' || $l47=='8' || $l47=='9' || $l47=='10' || $l47=='11' || $l47=='12' || $l47=='13' || $l47=='14' || $l47=='15' || $l47=='16') { ?>
		<?php echo "<input class='optional' type='text' value='4' id='CES' name='CES' maxlength=1 size=1></td>"; ?>
		<?php }elseif($l47=='17') { ?>
		<?php echo "<input class='optional' type='text' value='6' id='CES' name='CES' maxlength=1 size=1></td>"; ?>
		<?php }elseif($l47=='18' || $l47=='19') { ?>
		<?php echo "<input class='optional' type='text' value='3' id='CES' name='CES' maxlength=1 size=1></td>"; ?>
		<?php }elseif($l47=='98') { ?>
		<?php echo "<input class='optional' type='text' value='98' id='CES' name='CES' maxlength=1 size=1></td>"; ?>
		<?php }else { ?>
		<?php echo "<input class='optional' type='text' value='' id='CES' name='CES' maxlength=1 size=1></td>"; ?>
		<?php } ?>
		<td class="fieldLabel_compulsory">Date status applies to<br>
		<?php 
	...
	<tr>
		...
		<?php
			...
			if($vo->aims[0]->A45b=='')
				...
				$a45b = $vo->aims[0]->A45b;
		?>
		<?php echo "<input class='compulsory' type='text' value='" . $a44b . "' style='' id='CESA44' name='CESA44' maxlength=30 size=30></td>"; ?>
		<td class="fieldLabel_compulsory"> Workplace Location Postcode <br>
		<?php echo "<input class='compulsory' type='text' value='" . $a45b . "' style='background-color: white' id='CESA45' name='CESA45' maxlength=8 size=8></td>"; ?>
	</tr>
	...
	<tr>
		...
		<td class="fieldLabel_compulsory"> EII <br>  
		<?php $EII_dropdown = array (array('1','1 Learner is employed full time') , array('2','2 Learner is employed part time')); ?>
		<?php $l47 = $vo->learnerinformation->L47; if($l47=='6' || $l47=='18') { ?>
		<?php echo HTML::select('EIICES', $EII_dropdown, '1', true, true); ?></td>
		<?php }elseif($l47=='7' || $l47=='19') { ?>
		<?php echo HTML::select('EIICES', $EII_dropdown, '2', true, true); ?></td>
		<?php }else { ?>
		<?php echo HTML::select('EIICES', $EII_dropdown, '', true, true); ?></td>
		<?php } ?>
	</tr>
	...
	<tr>
		<td class="fieldLabel_compulsory"> RFU <br>  
		<?php $RFU_dropdown = array (array('1','1 Learner is unemployed due to redundancy') , array('2','2 Learner is unemployed for reason(s) other than redundancy')); ?>
		<?php $l47 = $vo->learnerinformation->L47; if($l47=='3' || $l47=='8' || $l47=='9' || $l47=='10') { ?>
		<?php echo HTML::select('RFUCES', $RFU_dropdown, '1', true, true); ?></td>
		<?php }elseif($l47=='4' || $l47=='11' || $l47=='12' || $l47=='13') { ?>
		<?php echo HTML::select('RFUCES', $RFU_dropdown, '2', true, true); ?></td>
		<?php }else { ?>
		<?php echo HTML::select('RFUCES', $RFU_dropdown, '', true, true); ?></td>
		<?php } ?>
		<td class="fieldLabel_compulsory"> BSI <br>  
		<?php $BSI_dropdown = array (array('1','1 Learner is in receipt of Job Seekers Allowance (JSA)') , array('2','2 Learner is in receipt of Employment Support Allowance')); ?>
		<?php $l47 = $vo->learnerinformation->L47; if($l47=='8' || $l47=='11' || $l47=='14') { ?>
		<?php echo HTML::select('BSICES', $BSI_dropdown, '1', true, true); ?></td>
		<?php }elseif($l47=='9' || $l47=='12' || $l47=='15') { ?>
		<?php echo HTML::select('BSICES', $BSI_dropdown, '2', true, true); ?></td>
		<?php }else { ?>
		<?php echo HTML::select('BSICES', $BSI_dropdown, '', true, true); ?></td>
		<?php } ?>
	</tr>
	...
	<td class="fieldLabel_compulsory"> Funding Model <br>
		...
		<?php 
		if($vo->programmeaim->A70=="")
			echo HTML::select('PA70', $A70_dropdown, $vo->aims[0]->A70, true, true); 
		else
			echo HTML::select('PA70', $A70_dropdown, $vo->programmeaim->A70, true, true); 
		?></td>
	</tr>
	...
	<tr>
		<td class="fieldLabel_compulsory"> Programme entry route <br>
    ...
    <tr>
		...
		<?php echo "<input class='compulsory' type='text' value='" . $vo->programmeaim->A64 . "' style='' id='PA64' name='PA64' maxlength=5 size=2 onKeyPress='return numbersonly(this, event)'></td>"; ?>
		</td>
		<td class="fieldLabel_compulsory"> Planned one-to-one contact hours <br>
		<?php echo "<input class='compulsory' type='text' value='" . $vo->programmeaim->A65 . "' style='' id='PA65' name='PA65' maxlength=5 size=2 onKeyPress='return numbersonly(this, event)'></td>"; ?>
		</td>
	</tr>
    ...
    <tr>
		...
		<?php echo HTML::select('PA69', $A69_dropdown, $vo->programmeaim->A69, true, true); ?></td>
	</tr>

    <tr>
		<td class="fieldLabel_compulsory"> LDM <br>
		<?php 
		if($vo->programmeaim->A46a=="")
			echo HTML::select('PA46a', $A46_dropdown, $vo->aims[0]->A46a, true, true); 
		else
			echo HTML::select('PA46a', $A46_dropdown, $vo->programmeaim->A46a, true, true); 
		?></td>
		<td class="fieldLabel_compulsory"> LDM <br>
		<?php 
		if($vo->programmeaim->A46b=="")
			echo HTML::select('PA46b', $A46_dropdown, $vo->aims[0]->A46b, true, true); 
		else
			echo HTML::select('PA46b', $A46_dropdown, $vo->programmeaim->A46b, true, true); 
		?></td>
    </tr>
    ...
    <tr>
		...
		<?php
			if($vo->programmeaim->A34=='4')
				echo HTML::select('PA34', $A34_dropdown, '3', false, true);
			else
				echo HTML::select('PA34', $A34_dropdown, $vo->programmeaim->A34, false, true);
		?></td>
	</tr>
	...
	<tr>
		...
		<?php if($vo->programmeaim->A34=='3' || $vo->programmeaim->A50=='97') 
			echo HTML::select('PAWith', $Withdraw_dropdown, $vo->programmeaim->A50, true, true); 
				elseif($vo->programmeaim->A34=='4')
					echo HTML::select('PAWith', $Withdraw_dropdown, '40', true, true);
				else
    ...
    <tr>
		...
		<tr>
			...
			<td valign="top"><br>ALN &nbsp;<input type="checkbox" checked name="ALN"> ASN &nbsp;<input type="checkbox" name="ASN"> </input> </td>
			<?php } elseif($vo->aims[0]->A53=='12') { ?>
			<td valign="top"><br>ALN &nbsp;<input type="checkbox" name="ALN"> 	ASN &nbsp;<input type="checkbox" checked name="ASN"> </input> </td>
			<?php }elseif($vo->aims[0]->A53=='13') { ?>
			<td valign="top"><br>ALN &nbsp;<input type="checkbox" checked name="ALN">  ASN &nbsp;<input type="checkbox" checked name="ASN"> </input> </td>
			<?php }else { ?>
			<td valign="top"><br>ALN &nbsp;<input type="checkbox" name="ALN">  ASN &nbsp;<input type="checkbox" name="ASN"> </input> </td>
			<?php } ?>
		</tr>
...
//		else
		...
		<tr>
			...
			<?php
				if($vo->aims[0]->A34=='4')
					echo HTML::select('A34', $A34_dropdown, '3', false, true);
				else
					echo HTML::select('A34', $A34_dropdown, $vo->aims[0]->A34, false, true);
				?></td>
		</tr>
		...
		<tr>
			<td class="fieldLabel_compulsory"> Withdrawal reason <br>
			<?php $Withdraw_dropdown = array (array('1','1 Learner ALSN (Additional learning or social needs)') , array('2','2 Learner transferred to another provider'), array('3','3 Learner injury / illness'), array('7','7 Learner transferred between providers due to inter'), array('27','27 OLASS learner withdrawn due to circumstances within'), array('28','28 OLASS learner withdrawn due to circumstances outsi'), array('29','29 Learner has been made redundant'), array('40','40 The learner has transferred to a new learning aim'), array('97','97 Other'), array('98','98 Reason not known')); ?>
			<?php if($vo->aims[0]->A34=='3' || $vo->aims[0]->A50=='97') 
				echo HTML::select('MainWith', $Withdraw_dropdown, $vo->aims[0]->A50, true, true); 
					elseif($vo->aims[0]->A34=='4')
						echo HTML::select('MainWith', $Withdraw_dropdown, '40', true, true);
					else
		...
		//		else
				...
				<tr>
					...
					<?php
						if($vo->aims[$a]->A34=='4')
							echo HTML::select('SA34', $A34_dropdown, '3', false, true);
						else
							echo HTML::select('SA34', $A34_dropdown, $vo->aims[$a]->A34, false, true);
				...
				<tr>
					<td class="fieldLabel_compulsory"> Withdrawal reason <br>
					<?php $Withdraw_dropdown = array (array('1','1 Learner ALSN (Additional learning or social needs)') , array('2','2 Learner transferred to another provider'), array('3','3 Learner injury / illness'), array('7','7 Learner transferred between providers due to inter'), array('27','27 OLASS learner withdrawn due to circumstances within'), array('28','28 OLASS learner withdrawn due to circumstances outsi'), array('29','29 Learner has been made redundant'), array('40','40 The learner has transferred to a new learning aim'), array('97','97 Other'), array('98','98 Reason not known')); ?>
					<?php if($vo->aims[$a]->A34=='3' || $vo->aims[$a]->A50=='97') 
						echo HTML::select('SubWith', $Withdraw_dropdown, $vo->aims[$a]->A50, true, true); 
							elseif($vo->aims[$a]->A34=='4')
								echo HTML::select('SubWith', $Withdraw_dropdown, '40', true, true);
							else
          ...
          <fieldset>
		    <legend style='width: 801px'>ILR 2011/12 - Part 4 - Subsidiary Aim Information - Required for all types of apprenticeships programmes <button id='butt' onClick='deleteAim(this);'> X </button></legend>
	   		<table>
                ...
                <tr>
					<td class="fieldLabel_compulsory"> Learning start date <br>
					<?php echo HTML::datebox('SA27', '', true, true); ?></td>
					<td class="fieldLabel_compulsory"> Learning planned end date <br>
					<?php echo HTML::datebox('SA28', '', true, true);?></td>
                </tr>
				...
				<tr>
					...
					<td valign="top">ALN &nbsp;<input type="checkbox" name="SALN"> ASN &nbsp;<input type="checkbox" name="SASN"> </input> </td>
                </tr>
