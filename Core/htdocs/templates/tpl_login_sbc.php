<div id="header" style="margin-top: 5px; border-top: 12px solid rgb(98,103,154);" width="100%" ></div>
<center>
<div style="margin-top: 20px; ">

<span><h2>South Birmingham College</h2> </span>
...
<div id="main" style='margin-top: 5px; display: block; margin-left: auto; margin-right: auto; width: 960px;'>
	...
	<center>
		...
		<tr>
			<td>Username:</td>
			<td><input style="border: 1px solid rgb(98,103,154)" id="txtUsername" type="text" name="username" value="" /></td>
		</tr>
		<tr>
			<td>Password:</td>
			<td><input style="border: 1px solid rgb(98,103,154)"  type="password" name="password" value="" /></td>
		</tr>
		<tr>
			<td></td>
