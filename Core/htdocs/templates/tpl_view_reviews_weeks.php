...
<head>
    ...
    <title>View Reviews Weeks</title>
...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;">View Reviews Weeks</div>
            <div class="ButtonBar">
            ...
            <div class="ActionIconBar">
                ...
                <span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="window.location.href='do.php?_action=view_reviews_weeks&subaction=export_csv'" title="Export to .CSV file"></span>
    ...
    <div class="row">
        <div id="div_filters" style="display:none">
            ...
            <form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter">
                <input type="hidden" name="_action" value="view_reviews_weeks" />
                ...
                <div id="filterBox" class="clearfix small">
                    ...
                    <fieldset>
                        ...
                        <!--<div class="field float"><label>Actual date between</label><?php echo $view->getFilterHTML('actual_start_date'); ?>&nbsp;and <?php echo $view->getFilterHTML('actual_end_date'); ?></div>-->
                        <!--<div class="field newrow"></div>
