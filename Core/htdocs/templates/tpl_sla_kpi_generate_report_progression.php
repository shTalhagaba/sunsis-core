...
<div class="banner">
	...
	<div class="ActionIconBar">
        ...
        {
        ?>
            <input type="button" value="< Back to Dashboard" onclick="window.location.href='?_action=sla_kpi_rep_achievers&report_type=sla_kpi_rep_progression_l2tol3'" style="float:left;margin: 0 0 10px;">
        <?php
        }
        else
        {
        ?>
            <input type="button" value="< Back to Dashboard" onclick="window.location.href='?_action=sla_kpi_rep_achievers&report_type=sla_kpi_rep_progression'" style="float:left;margin: 0 0 10px;">
        <?php
        }
        ?>
...
<div id="div_filters" align="center" style="width:1230px;">
	...
	<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter">
		...
		<input type="hidden" name="show_only" value="<?php echo $_REQUEST['show_only'];?>" />
		...
		<div id="filterBox" class="clearfix" style="text-align: left; display: none;">
            ...
            <tr>
                ...
                <td colspan="7">
                    <?php echo $view->getFilterHTML('filter_ethnicity'); ?>
                </td>
            </tr>
