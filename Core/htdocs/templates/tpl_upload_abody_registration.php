...
<title>Awarding Body Registration Update</title> 
...
<body>
<div class="banner">
	<div class="Title">Awarding Body Registration Update</div>
	<div class="ButtonBar">
...
<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>?_action=save_upload_abody_registration" ENCTYPE="multipart/form-data">
<input type="hidden" name="_action" value="save_upload_abody_registration" />
