...
<title>Assessor Review Form - Introduction Review </title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Assessor Review Form Introduction</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Learner Introduction Review</th>
                </thead>
            </table>
        </td>
        <td>
