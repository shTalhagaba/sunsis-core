...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td><?php echo $this->getEventStatus($events, "Sales Fundamentals"); ?></td>
        <td>Social Selling</td>
        <td><?php echo $this->getEventStatus($events, "Social Selling"); ?></td>
        <td>CompTIA A+ Part 1</td>
        <td><?php echo $this->getEventStatus($events, "CompTIA A+ Part 1"); ?></td>
    </tr>
    <tr>
        <td>CompTIA A+ Part 2</td>
        <td><?php echo $this->getEventStatus($events, "CompTIA A+ Part 2"); ?></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
