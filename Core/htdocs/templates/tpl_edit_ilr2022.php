...
<head>
    ...
    <script src="/js/ilr2022.js?n=<?php echo time(); ?>"></script>
</head>
...
<div class="banner">
    <table border="0" cellspacing="0" cellpadding="0" height="100%" width="100%">
        <tr class="head">
            <td valign="bottom">
                <?php if ($template != 1) { ?>
                <?php echo $vo->GivenNames . ' ' . $vo->FamilyName; ?> 2022/23 ILR
                <?php } else { ?>
                ILR Template
                <?php }  ?>
            </td>
         ...
         <tr>
            <td valign="top" align="left" class="left">
                <div class="button_wrap">
                    ...
                    if(DB_NAME=='am_ela' or DB_NAME=='am_demo')
...
foreach ($vo->LearningDelivery as $delivery) {
    ...
    if((DB_NAME=='am_baltic' or DB_NAME=='am_ela') && $delivery->AimType!='1')
    {
    ...
    $this->dynamic_field_display('FFI', HTML::select('FFI', $FFI_dropdown, $ffi, true, false, true, 1, 'title = "' . $delivery->AimType . '" '));
    echo '</tr>';
        ...
        for(var i = 0; i < elements.length; i++)
        {
                ...
                || (elements[i].type == "radio" && elements[i].checked) )
            {

                {
                    ...
                    if(elements[i].name == "LearnActEndDate_" + qan)
                    {
                        elements[i].value = document.forms['frmEndInfo'].endInfoActEndDate.value;
                    }
                    if(elements[i].name == "AchDate_" + qan)
                    {
