...
<table width="100%" border="0" style="height:100%">
	<tr>
		...
		<h4>Sorry, the server has been unable to complete your request</h4>
			<div class="message"><?php echo nl2br(htmlspecialchars((string)$message)); ?></div>
			
			<?php if(SOURCE_BLYTHE_VALLEY || SOURCE_LOCAL) {?>
			<div class="details" align="left">
			<p style="text-align:center; background-color:#3A4D16;color:white">The details below are visible to Perspective developers and users from Blythe Valley only</p>
				<table border="0" cellspacing="4" cellpadding="2">
					<col width="60"/><col/>
					<tr>
						<td style="font-weight:bold;">Code</td>
						<td style="word-wrap:break-word;"><?php echo htmlspecialchars((string)$code); ?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td style="word-wrap:break-word;"><?php echo htmlspecialchars((string)$line); ?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td style="word-wrap:break-word;font-size:8pt;" valign="top"><?php echo Text::abbreviate(str_replace("\t", "&nbsp;&nbsp;&nbsp;", nl2br(htmlspecialchars((string)$extra_info))), 3072, "..."); ?></td>
					</tr>
					<?php } ?>
				</table>
			</div>
