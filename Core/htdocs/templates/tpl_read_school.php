...
<script language="JavaScript">
	function deleteRecord()
	{
		...
		{
			window.location.replace('do.php?_action=delete_school&id=<?php echo $vo->id; ?>');
		}
	}
...
<div class="banner">
	...
	<div class="ButtonBar">
		...
		<button onclick="window.location.replace('do.php?id=<?php echo $vo->id; ?>&_action=edit_school');">Edit</button>
<!-- 			<button onclick="window.location.replace('do.php?id=<?php //echo $vo->id; ?>&_action=edit_health_and_safety');">Health & Safety</button>
		&nbsp; -->
...
<?php } $view2->render($link,'read_school'); ?>

<h3>Locations</h3>
<?php if((int)$_SESSION['user']->type!=14){?>
<span class="button" style="margin-bottom: 15px;" onclick="window.location.href='do.php?_action=edit_location&organisations_id=<?php echo $vo->id; ?>&back=<?php echo "school"; ?>'"> Add new location </span>
<?php }$locations->render($link, 'read_school'); ?>

<h3>Students</h3>
<?php if((int)$_SESSION['user']->type!=14){?>
<span class="button" onclick="window.location.href='do.php?_action=edit_user&organisations_id=<?php echo $vo->id; ?>&people=<?php echo "Learner"; ?>&people_type=<?php echo 5; ?>'"> Add new student </span>
<?php }$vo3->render($link);  ?>


<!--
<h3>Other employees</h3>
<span class="button" onclick="window.location.href='do.php?_action=edit_user&organisations_id=<?php echo $vo->id; ?>&people=<?php echo "Other Learner"; ?>&people_type=<?php echo 6; ?> '"> Add other learner </span>
<?php //$vo5->render($link);?>
-->
...
<span class="button" onclick="window.location.href='do.php?_action=edit_user&organisations_id=<?php echo $vo->id; ?>&people=<?php echo "School Viewer"; ?>&people_type=<?php echo 14; ?> '"> Add school viewer </span>
<?php }$vo5->render($link);?>
...
<h3>Vacancies</h3>
<span class="button" onclick="window.location.href='do.php?_action=edit_vacancy&employer_id=<?php echo $vo->id; ?>'"> Add new vacancy </span>
<?php //$vacancies->render($link); ?>
