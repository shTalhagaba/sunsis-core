...
<script type="text/javascript">
    ...
    function getData()
    {
        ...
        if(<?php echo '"' . $qualification_id . '"' ?>!='')
        {
            ...
            request.open("GET", expandURI('do.php?_action=ajax_get_qualification_xml&id=' + <?php echo '"' . $qualification_id . '"';?> + '&clients=' + <?php echo '"' . $clients . '"' ?> + '&internaltitle=' + <?php echo  '"' . htmlspecialchars((string)$internaltitle) . '"';?> + '&auto_id=' + <?php echo $vo->auto_id; ?>), false);
