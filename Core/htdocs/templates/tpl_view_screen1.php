...
<body>
<div class="banner">
	<div class="Title">Goods Receipt Notes</div>
	<div class="ButtonBar">
		<button onclick="window.location.href='do.php?_action=edit_screen1';">New</button>
	</div>
	<div class="ActionIconBar">
		<button onclick="showHideBlock('div_filters');showHideBlock('div_filter_crumbs');" title="Show/hide filters"><img src="/images/btn-filter.gif" width="16" height="16" style="vertical-align:text-bottom" /></button>
		<button onclick="window.print()" title="Print-friendly view"><img src="/images/btn-printer.gif" width="16" height="16" style="vertical-align:text-bottom" /></button>
		<button onclick="exportToExcel('view_ViewScreen1')" title="Export to .CSV file"><img src="/images/btn-excel.gif" width="16" height="16" style="vertical-align:text-bottom" alt="" /></button>
...
<div id="div_filters" style="display:none">
	...
	<form method="get" action="#" id="applySavedFilter">
		<input type="hidden" name="_action" value="view_screen1" />
		...
		<div id="filterBox" class="clearfix">
			<fieldset>
				...
				<div class="field float">
					<label>Search by CPS:</label><?php echo $view->getFilterHTML('filter_cps'); ?>
				</div>
				<div class="field float">
					<label>Search by NATO:</label><?php echo $view->getFilterHTML('filter_nato'); ?>
				</div>
			</fieldset>
			<fieldset>
...
<div align="center" style="margin-top:50px;">
	<?php unset($temp);$view->render($link, $view->getSelectedColumns($link)); ?>
</div>
