...
<div class="banner">
	...
	<div class="ButtonBar">
		...
		&nbsp;&nbsp;
		<input type="checkbox" name="showProgressStats" value="1" onclick="showHideBlock('datatable')"/>Data Table
	</div>
...
<input type="hidden" name="_action" value="view_learning_difficulty_graph" />
<table>
	<tr>
		<td>Record status: </td>
...
<table>
<tr><td>
<h3>Graph By Learning Difficulties </h3>
</td>
</tr>
<tr>
<td>
...
<?php
	...
	$graph->titles = "Learning Difficulties, Learners";
	$graph->barLength = "2.9";
	$graph->showValues = "0";
	echo $graph->create();
?>
