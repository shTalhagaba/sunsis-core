...
<input type="hidden" name="_action" value="save_assessor_review_form" />
<input type="hidden" name="review_id" value="<?php echo $review_id; ?>" />
<input type="hidden" name="source" value="<?php echo $source; ?>" />
<input type="hidden" name="signature_learner_font" id="signature_learner_font" value="<?php echo $form->signature_learner_font; ?>" />
...
<table class="table1" style="width: 900px">
    ...
    <tbody>
        <tr>
            ...
            <td>Date of Birth:</td>
            <td> <?php echo HTML::datebox("learner_dob", $form->learner_dob, true, false); ?> </td>
        </tr>
        <tr>
            <td>Reviewer/ Assessor:</td>
            <td><input type="text" name="learner_assessor" value="<?php echo $form->learner_assessor; ?>" size=30/></td>
            <td>NI Number:</td>
            <td><input type="text" name="learner_ni" value="<?php echo $form->learner_ni; ?>" size=30/></td>
        </tr>
        <tr>
            <td>Employer Name:</td>
            <td><input type="text" name="learner_employer" value="<?php echo $form->learner_employer; ?>" size=30/></td>
            <td>Line Manager:</td>
            <td><input type="text" name="learner_manager" value="<?php echo $form->learner_manager; ?>" size=30/></td>
        </tr>
        <tr>
            <td>Programme:</td>
            <td><input type="text" name="learner_programme" value="<?php echo $form->learner_programme; ?>" size=30/></td>
            <td>Qualification Title:</td>
            <td><input type="text" name="learner_qualification" value="<?php echo $form->learner_qualification; ?>" size=30/></td>
        </tr>
        <tr>
            <td>Start Date:</td>
            <td> <?php echo HTML::datebox("start_date", $form->start_date, true, false); ?> </td>
            <td>Registration Number:</td>
            <td><input type="text" name="registration_number" value="<?php echo $form->registration_number; ?>" size=30/></td>
        </tr>
        <tr>
            <td>Expected Completion Date:</td>
            <td> <?php echo HTML::datebox("planned_end_date", $form->planned_end_date, true, false); ?> </td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><textarea name="plagiarism" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123"><?php echo $form->plagiarism; ?></textarea></td>
    </tr>
    </tbody>
</table>
<br>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><textarea name="employer_previous_comments" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123"><?php echo $form->employer_previous_comments; ?></textarea></td>
    </tr>
    </tbody>
</table>
<br>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><textarea name="significant_achievement" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123"><?php echo $form->significant_achievement; ?></textarea></td>
    </tr>
    </tbody>
</table>
<br>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><textarea name="safeguarding" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123"><?php echo $form->safeguarding; ?></textarea></td>
    </tr>
    </tbody>
</table>
<br>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><textarea name="prevent" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123"><?php echo $form->prevent; ?></textarea></td>
    </tr>
    </tbody>
</table>
<br>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><textarea name="health_wellbeing" style="font-family:sans-serif; font-size:10pt"  rows="15" cols="123"><?php echo $form->health_wellbeing; ?></textarea></td>
    </tr>
    </tbody>
</table>
<br>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><textarea name="concerns" style="font-family:sans-serif; font-size:10pt"  rows="20" cols="123"><?php echo $form->concerns; ?></textarea></td>
    </tr>
    </tbody>
</table>
<br>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><textarea name="additional_support" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123"><?php echo $form->additional_support; ?></textarea></td>
    </tr>
    </tbody>
</table>
<br>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><textarea name="progress" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123"><?php echo $form->progress; ?></textarea></td>
    </tr>
    </tbody>
</table>
<br>
...
<table class="table1" style="width: 900px">
    <thead>
    <!--<th colspan=4>&nbsp;&nbsp;&nbsp;Learning Log Discussion (must link in with learner/tutor off the job learning logs)</th>-->
    ...
    <tr>
        <td colspan=4><textarea name="discussion" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123"><?php echo $form->discussion; ?></textarea></td>
    </tr>
    </tbody>
</table>
<br>
...
<table class="table1" style="width: 900px">
    ...
    <tbody>
    <tr>
        <td colspan=4><textarea name="err" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123"><?php echo $form->err; ?></textarea></td>
    </tr>
    </tbody>
</table>
<br>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4>
            <table>
                <tr>
                    <td>&nbsp;Unit&nbsp;</td>
                    <td><input name="main_name_unit1" type=text size=5 value="<?php echo $form->main_name_unit1; ?>"/></td>
                    <td>&nbsp;Unit&nbsp;</td>
                    <td><input name="main_name_unit2" type=text size=5 value="<?php echo $form->main_name_unit2; ?>"/></td>
                    <td>&nbsp;Unit&nbsp;</td>
                    <td><input name="main_name_unit3" type=text size=5 value="<?php echo $form->main_name_unit3; ?>"/></td>
                    <td>&nbsp;Unit&nbsp;</td>
                    <td><input name="main_name_unit4" type=text size=5 value="<?php echo $form->main_name_unit4; ?>"/></td>
                    <td>&nbsp;Unit&nbsp;</td>
                    <td><input name="main_name_unit5" type=text size=5 value="<?php echo $form->main_name_unit5; ?>"/></td>
                    <td>&nbsp;Unit&nbsp;</td>
                    <td><input name="main_name_unit6" type=text size=5 value="<?php echo $form->main_name_unit6; ?>"/></td>
                </tr>
                <tr>
                    <td colspan=2><input name="main_perc_unit1" type=text size=13 value="<?php echo $form->main_perc_unit1; ?>"/></td>
                    <td colspan=2><input name="main_perc_unit2" type=text size=13 value="<?php echo $form->main_perc_unit2; ?>"/></td>
                    <td colspan=2><input name="main_perc_unit3" type=text size=13 value="<?php echo $form->main_perc_unit3; ?>"/></td>
                    <td colspan=2><input name="main_perc_unit4" type=text size=13 value="<?php echo $form->main_perc_unit4; ?>"/></td>
                    <td colspan=2><input name="main_perc_unit5" type=text size=13 value="<?php echo $form->main_perc_unit5; ?>"/></td>
                    <td colspan=2><input name="main_perc_unit6" type=text size=13 value="<?php echo $form->main_perc_unit6; ?>"/></td>
                </tr>
                <tr>
                    <td>Unit</td>
                    <td><input name="main_name_unit7" type=text size=5 value="<?php echo $form->main_name_unit7; ?>"/></td>
                    <td>Unit</td>
                    <td><input name="main_name_unit8" type=text size=5 value="<?php echo $form->main_name_unit8; ?>"/></td>
                    <td>Unit</td>
                    <td><input name="main_name_unit9" type=text size=5 value="<?php echo $form->main_name_unit9; ?>"/></td>
                    <td>Unit</td>
                    <td><input name="main_name_unit10" type=text size=5 value="<?php echo $form->main_name_unit10; ?>"/></td>
                    <td>Unit</td>
                    <td><input name="main_name_unit11" type=text size=5 value="<?php echo $form->main_name_unit11; ?>"/></td>
                    <td>Unit</td>
                    <td><input name="main_name_unit12" type=text size=5 value="<?php echo $form->main_name_unit12; ?>"/></td>
                </tr>
                <tr>
                    <td colspan=2><input name="main_perc_unit7" type=text size=13 value="<?php echo $form->main_perc_unit7; ?>"/></td>
                    <td colspan=2><input name="main_perc_unit8" type=text size=13 value="<?php echo $form->main_perc_unit8; ?>"/></td>
                    <td colspan=2><input name="main_perc_unit9" type=text size=13 value="<?php echo $form->main_perc_unit9; ?>"/></td>
                    <td colspan=2><input name="main_perc_unit10" type=text size=13 value="<?php echo $form->main_perc_unit10; ?>"/></td>
                    <td colspan=2><input name="main_perc_unit11" type=text size=13 value="<?php echo $form->main_perc_unit11; ?>"/></td>
                    <td colspan=2><input name="main_perc_unit12" type=text size=13 value="<?php echo $form->main_perc_unit12; ?>"/></td>
                </tr>
            </table>
        </td>
    <tr>
        <td>
            <table>
                ...
                <tr>
                    <td><input name="workshop1" type=text size=34 value="<?php echo $form->workshop1; ?>"/></td>
                    <td><input name="workshop2" type=text size=34 value="<?php echo $form->workshop2; ?>"/></td>
                    <td><input name="workshop3" type=text size=34 value="<?php echo $form->workshop3; ?>"/></td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
        <td colspan=4><textarea name="main_progress" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123"><?php echo $form->main_progress; ?></textarea></td>
    </tr>
    </tbody>
</table>
<br>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4>
            <table>
                <tr>
                    <td>&nbsp;Unit&nbsp;</td>
                    <td><input name="tech_name_unit1" type=text size=5 value="<?php echo $form->tech_name_unit1; ?>"/></td>
                    <td>&nbsp;Unit&nbsp;</td>
                    <td><input name="tech_name_unit2" type=text size=5 value="<?php echo $form->tech_name_unit2; ?>"/></td>
                    <td>&nbsp;Unit&nbsp;</td>
                    <td><input name="tech_name_unit3" type=text size=5 value="<?php echo $form->tech_name_unit3; ?>"/></td>
                    <td>&nbsp;Unit&nbsp;</td>
                    <td><input name="tech_name_unit4" type=text size=5 value="<?php echo $form->tech_name_unit4; ?>"/></td>
                    <td>&nbsp;Unit&nbsp;</td>
                    <td><input name="tech_name_unit5" type=text size=5 value="<?php echo $form->tech_name_unit5; ?>"/></td>
                    <td>&nbsp;Unit&nbsp;</td>
                    <td><input name="tech_name_unit6" type=text size=5 value="<?php echo $form->tech_name_unit6; ?>"/></td>
                <tr>
                </tr>
                    <td colspan=2><input name="tech_perc_unit1" type=text size=13 value="<?php echo $form->tech_perc_unit1; ?>"/></td>
                    <td colspan=2><input name="tech_perc_unit2" type=text size=13 value="<?php echo $form->tech_perc_unit2; ?>"/></td>
                    <td colspan=2><input name="tech_perc_unit3" type=text size=13 value="<?php echo $form->tech_perc_unit3; ?>"/></td>
                    <td colspan=2><input name="tech_perc_unit4" type=text size=13 value="<?php echo $form->tech_perc_unit4; ?>"/></td>
                    <td colspan=2><input name="tech_perc_unit5" type=text size=13 value="<?php echo $form->tech_perc_unit5; ?>"/></td>
                    <td colspan=2><input name="tech_perc_unit6" type=text size=13 value="<?php echo $form->tech_perc_unit6; ?>"/></td>
                <tr>
                </tr>
                    <td>&nbsp;Unit&nbsp;</td>
                    <td><input name="tech_name_unit7" type=text size=5 value="<?php echo $form->tech_name_unit7; ?>"/></td>
                    <td>&nbsp;Unit&nbsp;</td>
                    <td><input name="tech_name_unit8" type=text size=5 value="<?php echo $form->tech_name_unit8; ?>"/></td>
                    <td>&nbsp;Unit&nbsp;</td>
                    <td><input name="tech_name_unit9" type=text size=5 value="<?php echo $form->tech_name_unit9; ?>"/></td>
                    <td>&nbsp;Unit&nbsp;</td>
                    <td><input name="tech_name_unit10" type=text size=5 value="<?php echo $form->tech_name_unit10; ?>"/></td>
                    <td>&nbsp;Unit&nbsp;</td>
                    <td><input name="tech_name_unit11" type=text size=5 value="<?php echo $form->tech_name_unit11; ?>"/></td>
                    <td>&nbsp;Unit&nbsp;</td>
                    <td><input name="tech_name_unit12" type=text size=5 value="<?php echo $form->tech_name_unit12; ?>"/></td>
                </tr>
                <tr>
                    <td colspan=2><input name="tech_perc_unit7" type=text size=13 value="<?php echo $form->tech_perc_unit7; ?>"/></td>
                    <td colspan=2><input name="tech_perc_unit8" type=text size=13 value="<?php echo $form->tech_perc_unit8; ?>"/></td>
                    <td colspan=2><input name="tech_perc_unit9" type=text size=13 value="<?php echo $form->tech_perc_unit9; ?>"/></td>
                    <td colspan=2><input name="tech_perc_unit10" type=text size=13 value="<?php echo $form->tech_perc_unit10; ?>"/></td>
                    <td colspan=2><input name="tech_perc_unit11" type=text size=13 value="<?php echo $form->tech_perc_unit11; ?>"/></td>
                    <td colspan=2><input name="tech_perc_unit12" type=text size=13 value="<?php echo $form->tech_perc_unit12; ?>"/></td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
        <td colspan=4><textarea name="tech_progress" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123"><?php echo $form->tech_progress; ?></textarea></td>
    </tr>
    </tbody>
</table>
<br>
        ...
        <td colspan=4>
            <table>
                ...
                <tr>
                    ...
                    <td><input name="knowledge_module_3" type=text size=16 value="<?php echo $form->knowledge_module_3; ?>"/></td>
                    <td><input name="knowledge_status_3" type=text size=10 value="<?php echo $form->knowledge_status_3; ?>"/></td>
                </tr>
                <tr>
                    <td>&nbsp;Knowledge Module&nbsp;</td>
                    <td>&nbsp;Status&nbsp;</td>
                ...
                <tr>
                    <td><input name="knowledge_module_4" type=text size=16 value="<?php echo $form->knowledge_module_4; ?>"/></td>
                    <td><input name="knowledge_status_4" type=text size=10 value="<?php echo $form->knowledge_status_4; ?>"/></td>
                    <td><input name="knowledge_module_5" type=text size=16 value="<?php echo $form->knowledge_module_5; ?>"/></td>
                    <td><input name="knowledge_status_5" type=text size=10 value="<?php echo $form->knowledge_status_5; ?>"/></td>
                    <td><input name="knowledge_module_6" type=text size=16 value="<?php echo $form->knowledge_module_6; ?>"/></td>
                    <td><input name="knowledge_status_6" type=text size=10 value="<?php echo $form->knowledge_status_6; ?>"/></td>
                </tr>
                <tr>
                    <td>&nbsp;Knowledge Module&nbsp;</td>
                    <td>&nbsp;Status&nbsp;</td>
                ...
                <tr>
                    <td><input name="knowledge_module_7" type=text size=16 value="<?php echo $form->knowledge_module_7; ?>"/></td>
                    <td><input name="knowledge_status_7" type=text size=10 value="<?php echo $form->knowledge_status_7; ?>"/></td>
                    <td><input name="knowledge_module_8" type=text size=16 value="<?php echo $form->knowledge_module_8; ?>"/></td>
                    <td><input name="knowledge_status_8" type=text size=10 value="<?php echo $form->knowledge_status_8; ?>"/></td>
                    <td><input name="knowledge_module_9" type=text size=16 value="<?php echo $form->knowledge_module_9; ?>"/></td>
                    <td><input name="knowledge_status_9" type=text size=10 value="<?php echo $form->knowledge_status_9; ?>"/></td>
                </tr>
                <tr>
                    <td>&nbsp;Knowledge Module&nbsp;</td>
                    <td>&nbsp;Status&nbsp;</td>
                ...
                <tr>
                    <td><input name="knowledge_module_10" type=text size=16 value="<?php echo $form->knowledge_module_10; ?>"/></td>
                    <td><input name="knowledge_status_10" type=text size=10 value="<?php echo $form->knowledge_status_10; ?>"/></td>
                    <td><input name="knowledge_module_11" type=text size=16 value="<?php echo $form->knowledge_module_11; ?>"/></td>
                    <td><input name="knowledge_status_11" type=text size=10 value="<?php echo $form->knowledge_status_11; ?>"/></td>
                    <td><input name="knowledge_module_12" type=text size=16 value="<?php echo $form->knowledge_module_12; ?>"/></td>
                    <td><input name="knowledge_status_12" type=text size=10 value="<?php echo $form->knowledge_status_12; ?>"/></td>
                </tr>
            </table>
        </td>
    </tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4>
            <table>
                <tr>
                    <td style="text-align: center; width: 100px">English</td><td><?php echo HTML::checkbox("english_exempt", 1, $form->english_exempt, true, false); ?></td>
                    <td style="text-align: center; width: 100px">Maths</td><td><?php echo HTML::checkbox("math_exempt", 1, $form->math_exempt, true, false); ?></td>
                    <td style="text-align: center; width: 100px">ICT</td><td><?php echo HTML::checkbox("ict_exempt", 1, $form->ict_exempt, true, false); ?></td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
        <td colspan=4><textarea name="use_functional" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123"><?php echo $form->use_functional; ?></textarea></td>
    </tr>
    </tbody>
</table>
<br>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4>
            <table>
                ...
                <tr>
                    <td>%</td>
                    <td><input name="english_l1" type=text size=8 value="<?php echo $form->english_l1; ?>"/></td>
                    <td><input name="english_l2" type=text size=8 value="<?php echo $form->english_l2; ?>"/></td>
                    <td><input name="math_l1" type=text size=8 value="<?php echo $form->math_l1; ?>"/></td>
                    <td><input name="math_l2" type=text size=8 value="<?php echo $form->math_l2; ?>"/></td>
                    <td><input name="ict_l1" type=text size=8 value="<?php echo $form->ict_l1; ?>"/></td>
                    <td><input name="ict_l2" type=text size=8 value="<?php echo $form->ict_l2; ?>"/></td>
                    <td><input name="plts" type=text size=8 value="<?php echo $form->plts; ?>"/></td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
        <td colspan=4><textarea name="functional_progress" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123"><?php echo $form->functional_progress; ?></textarea></td>
    </tr>
    </tbody>
</table>
<br>
    ...
    <tr>
        <td colspan=4>
            <table>
                ...
                <tr>
                    <td><textarea name="specific" rows="10" cols="26"><?php echo $form->specific; ?></textarea></td>
                    <td><textarea name="measurable" rows="10" cols="26"><?php echo $form->measurable; ?></textarea></td>
                    <td><textarea name="achievable" rows="10" cols="26"><?php echo $form->achievable; ?></textarea></td>
                    <td><textarea name="timebound" rows="10" cols="26"><?php echo $form->timebound; ?></textarea></td>
                </tr>
            </table>
        </td>
    </tr>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><textarea id="learner_comment" name="learner_comment" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123"><?php echo $form->learner_comment; ?></textarea></td>
    </tr>
    </tbody>
</table>
<br>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><textarea id="employer_progress_review" name="employer_progress_review" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123"><?php echo $form->employer_progress_review; ?></textarea></td>
    </tr>
    <tr>
        ...
        <td>
            <table>
                ...
                <tr>
                    ...
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("attendance", 1, ($form->attendance==1)?true:false, true, false); ?></td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("attendance", 2, ($form->attendance==2)?true:false, true, false); ?></td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("attendance", 3, ($form->attendance==3)?true:false, true, false); ?></td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("attendance", 4, ($form->attendance==4)?true:false, true, false); ?></td>
                </tr>
                <tr>
                    <td style="width: 200px; text-align: left">Punctuality/Timekeeping</td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("punctuality", 1, ($form->punctuality==1)?true:false, true, false); ?></td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("punctuality", 2, ($form->punctuality==2)?true:false, true, false); ?></td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("punctuality", 3, ($form->punctuality==3)?true:false, true, false); ?></td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("punctuality", 4, ($form->punctuality==4)?true:false, true, false); ?></td>
                </tr>
                <tr>
                    <td style="width: 200px; text-align: left">Attitude</td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("attitude", 1, ($form->attitude==1)?true:false, true, false); ?></td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("attitude", 2, ($form->attitude==2)?true:false, true, false); ?></td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("attitude", 3, ($form->attitude==3)?true:false, true, false); ?></td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("attitude", 4, ($form->attitude==4)?true:false, true, false); ?></td>
                </tr>
                <tr>
                    <td style="width: 200px; text-align: left">Communication</td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("communication", 1, ($form->communication==1)?true:false, true, false); ?></td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("communication", 2, ($form->communication==2)?true:false, true, false); ?></td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("communication", 3, ($form->communication==3)?true:false, true, false); ?></td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("communication", 4, ($form->communication==4)?true:false, true, false); ?></td>
                </tr>
                <tr>
                    <td style="width: 200px; text-align: left">Enthusiasm</td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("enthusiasm", 1, ($form->enthusiasm==1)?true:false, true, false); ?></td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("enthusiasm", 2, ($form->enthusiasm==2)?true:false, true, false); ?></td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("enthusiasm", 3, ($form->enthusiasm==3)?true:false, true, false); ?></td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("enthusiasm", 4, ($form->enthusiasm==4)?true:false, true, false); ?></td>
                </tr>
                <tr>
                    <td style="width: 200px; text-align: left">Commitment to the role</td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("commitment2", 1, ($form->commitment2==1)?true:false, true, false); ?></td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("commitment2", 2, ($form->commitment2==2)?true:false, true, false); ?></td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("commitment2", 3, ($form->commitment2==3)?true:false, true, false); ?></td>
                    <td style="width: 200px; text-align: center"><?php echo HTML::radio("commitment2", 4, ($form->commitment2==4)?true:false, true, false); ?></td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
        <td>
            <table>
                <tr>
                    <td>Behaviours:</td>
                    <td colspan=3><textarea id="behaviours" name="behaviours"  rows="4" cols="100"><?php echo $form->behaviours; ?></textarea></td>
                </tr>
                <tr>
                    <td>Ability:</td>
                    <td colspan=3><textarea id="ability" name="ability" rows="4" cols="100"><?php echo $form->ability; ?></textarea></td>
                </tr>
                <tr>
                    <td>Skills and Knowledge:</td>
                    <td colspan=3><textarea id="skills_knowledge" name="skills_knowledge" rows="4" cols="100"><?php echo $form->skills_knowledge; ?></textarea></td>
                </tr>
                <tr>
                    <td>Achievements/ progress at work:</td>
                    <td colspan=3><textarea id="achievements" name="achievements" rows="4" cols="100"><?php echo $form->achievements; ?></textarea></td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
        ...
        <?php
                if($form->signature_learner_font!='')
                    echo '<td><div onclick="getSignature(2)" class = "sigbox" width="300px" id="LearnerSignatureDiv"><img id = "learner_signature" src = ' . str_replace(" ","%20",$form->signature_learner_font) .  ' height="49" width="285"/></div></td>';
                else
        ...
        ?>
        <td style="text-align: center"><input id="signature_learner_name" name="signature_learner_name" type="text" size=30 value="<?php echo $form->signature_learner_name; ?>"/></td>
        <td style="text-align: center"> <?php echo HTML::datebox("signature_learner_date", $form->signature_learner_date, false, false); ?> </td>
    </tr>
    <tr>
        <td>Reviewer</td>
...
<script type="text/javascript">
	...
	function timePicker(vr)
	{
		...
		else
		{
			...
			$.post('do.php?_action=save_assessor_review_form.php',$('#form1').serialize(),function(r)
			{
