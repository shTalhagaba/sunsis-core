...
<div class="banner">
	...
	<div class="ButtonBar">
		<button onclick="window.location.href='do.php?_action=view_clients';">Close</button>
		<button onclick="window.location.replace('do.php?id=<?php echo $vo->id; ?>&_action=edit_client');">Edit</button>
...
<h3>Locations</h3>
<span class="button" style="margin-bottom: 15px;" onclick="window.location.href='do.php?_action=edit_location&organisations_id=<?php echo $vo->id; ?>&back=<?php echo "client"; ?>'"> Add new location </span>
<?php $locations->render($link); ?>
<!-- 
<h3>Apprentices</h3>
