...
<fieldset>
<legend style='width: 801px'>ILR 2011/12 - Part 1 - Learner Information - Learner Responsive/ESF</legend>
<table border="0" cellspacing="4" cellpadding="4">
	...
	<tr>
		...
		<?php echo "<input class='optional' type='text' value='" . $vo->learnerinformation->L33 . "' style='' id='L33' name='L33' maxlength=6 size=6 onKeyPress='return numbersonly(this, event)'></td>"; ?>
		</tr>
		<tr>
		...
		<tr>
		<td class="fieldLabel_optional"> L51 Email Address <br>
		<?php 
		...
		<td class="fieldLable_optional"> L52 Restricted use contact method <br>
		...
		<fieldset>
		<legend style='width: 801px'> ILR 2011/12 - Part 3 - Main Aim Information - Learner Responsive/ESF <input value = '+' type='button' onClick='addAimFromMain(this);'/></legend>
