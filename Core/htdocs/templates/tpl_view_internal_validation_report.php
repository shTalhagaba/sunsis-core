...
<div class="banner">
	...
	<div class="ActionIconBar">
		...
		<button onclick="window.location.href='do.php?_action=view_internal_validation_report&subaction=export_to_csv'" title="Export to .CSV file"><img src="/images/btn-excel.gif" width="16" height="16" style="vertical-align:text-bottom" alt="" /></button>
...
<div id="div_filters" style="display:none">
	...
	<form method="get" action="#" id="applySavedFilter">
		<input type="hidden" name="_action" value="view_internal_validation_report" />
