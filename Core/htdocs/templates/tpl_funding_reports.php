...
<!--<div class="well">
    <div id="logo">-->
        ...
        //echo '</tr></table>';
        //echo '<table><tr><td class="label2">Funding Reports</td></tr></table>';
        ?>
   <!-- </div>
</div> -->
</div>
<div class="row">
    ...
    <div class="col-sm-2" style='cursor: pointer' onclick='click_tab("demographics");'>
        <div class="panel panel-primary">
            <?php if($tab=='demographics') echo '<div class="panel-heading" style="background: darkgrey; "><b>Contracts</b></div>'; else echo '<div class="panel-heading">Contracts</div>'; ?>
        </div>
    </div>
    <div class="col-sm-2" style='cursor: pointer' onclick='click_tab("ssa");'>
        <div class="panel panel-primary">
            <?php if($tab=='ssa') echo '<div class="panel-heading" style="background: darkgrey; "><b>Utilisation</b></div>'; else echo '<div class="panel-heading">Utilisation</div>'; ?>
        </div>
    </div>
    <div class="col-sm-2" style='cursor: pointer' onclick='click_tab("framework");'>
        <div class="panel panel-primary">
            <?php if($tab=='framework') echo '<div class="panel-heading" style="background: darkgrey; "><b>Utilisation Accumulated</b></div>'; else echo '<div class="panel-heading">Utilisation Accumulated</div>'; ?>
        </div>
    </div>
    <!--<div class="col-sm-2" style='cursor: pointer' onclick="window.location.href='do.php?_action=edit_allocation'">
        <div class="panel panel-primary">
            <?php //if($tab=='leavers') echo '<div class="panel-heading" style="background: darkgrey; "><b>Set Allocation</b></div>'; else echo '<div class="panel-heading">Set Allocation</div>'; ?>
        </div>
    </div>-->
</div>
...
<?php if($tab=='summary') { ?>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-primary">
                <div class="panel-heading"><b>Provider Funding Summary</b></div>
                <div class="table-responsive"><div class="chart-panel-body " id="OverallSummary"></div></div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-primary">
                <div class="panel-heading"><b>Funding Summary Chart</b></div>
                <div class="table-responsive"><div class="chart-panel-body " id="FundingSummaryChart"></div></div>
            </div>
        </div>
    </div>
    <!--<div class="row">
        <div class="col-sm-12">
            <div class="panel panel-primary">
                ...
                <div class="table-responsive"><div class="chart-panel-body " id="OverallRetention"></div></div>
            </div>
        </div>
    </div>-->
        <?php } ?>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-primary">
                ...
                <div class="table-responsive"><div class="chart-panel-body " id="TimelySummary"></div></div>
            </div>
        </div>
    </div>
    <div class="row">
...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-primary">
            <div class="panel-heading"><b>Funding By Contracts</b></div>
            <div class="table-responsive"><div class="chart-panel-body " id="FundingByBusiness"></div></div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-primary">
            <div class="panel-heading"><b>Monthly Allocation Utilisation (Non-accumulated)</b></div>
            <div class="table-responsive"><div class="chart-panel-body " id="MonthlyUtilisation"></div></div>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-primary">
            <div class="panel-heading"><b>Monthly Allocation Utilisation Chart (Non-accumulated)</b></div>
            <div class="chart-panel-body " id="MonthlyUtilisationChart"></div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-primary">
            <div class="panel-heading"><b>Monthly Allocation Utilisation (Accumulated)</b></div>
            <div class="table-responsive"><div class="chart-panel-body " id="MonthlyUtilisationAccumulated"></div></div>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-primary">
            <div class="panel-heading"><b>Monthly Funding/ Allocation comparison</b></div>
            <div class="chart-panel-body " id="MonthlyUtilisationComparison"></div>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-primary">
            <div class="panel-heading"><b>Funding Utilisation Summary</b></div>
            <div class="chart-panel-body " id="FundingUtilisationSummary"></div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-primary">
            <div class="panel-heading"><b>Edit Allocation</b></div>
            <div class="chart-panel-body "  onclick="window.location.href='do.php?_action=edit_allocation'"></div>
        </div>
    </div>
</div>
    <?php } ?>
...
<?php if($tab=='summary') { ?>
    ...
    <?php if($qar_type_filter=='Overall') { ?>
        ...
        Highcharts.chart('FundingSummaryChart', {
            chart: {
                type: 'column'
            },
            title: {
                text: 'Provider Funding'
            },
            subtitle: {
                text: ''
            },
        ...
        $.ajax({
            url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&panel=getOverallSummary&tab=summary',
            type:"GET",
            async:true,
        ...
        $.ajax({
            url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&panel=getLineChartOverallTrend&tab=summary',
            type:"GET",
            async:true,
            beforeSend:function (data) {
        ...
        $.ajax({
            url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&panel=getRetentionSummary&tab=summary',
            type:"GET",
            async:true,
            beforeSend:function (data) {
    ...
    <?php if($qar_type_filter=='Timely') { ?>
        ...
        $.ajax({
            url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&panel=getTimelySummary&tab=summary',
            type:"GET",
            async:true,
            beforeSend:function (data) {
        ...
        $.ajax({
            url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&panel=getLineChartTimelyTrend&tab=summary',
            type:"GET",
            async:true,
            beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&panel=getFundingByBusiness&tab=demographics',
        type:"GET",
        async:true,
        beforeSend:function (data) {
            $("#FundingByBusiness").html('<img id="globe1" src="/img/loading-image.gif" style="vertical-align:text-bottom;" />');
        },
        success:function (response) {
            $("#FundingByBusiness").html(response);
        }
    });

    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByGenderTable&tab=demographics',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByAgeBandTable&tab=demographics',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByLLDDTable&tab=demographics',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByEthnicityTable&tab=demographics',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=MonthlyUtilisationTable&tab=ssa',
        type:"GET",
        async:true,
        beforeSend:function (data) {
            $("#MonthlyUtilisation").html('<img id="globe1" src="/img/loading-image.gif" style="vertical-align:text-bottom;" />');
        },
        success:function (response) {
            $("#MonthlyUtilisation").html(response);
        }
    });

    Highcharts.chart('MonthlyUtilisationChart', {
        chart: {
            type: 'column'
        },
        title: {
            text: 'Allocation Vs Funding'
        },
        xAxis: {
            categories: [
                'Aug',
        ...
        yAxis: [{
            min: 0,
            title: {
                text: 'Monthly Allocation Utilisation'
            }
        }, {
            title: {
                text: 'Amount'
        ...
        series: [{
            ...
            data: [<?php echo implode(",",$allocations); ?>],
            pointPadding: 0.1,
            pointPlacement: -0.2
        }, {
            name: 'Funding',
            color: 'rgba(126,86,134,.9)',
            data: [<?php echo implode(",",$fundings); ?>],
            pointPadding: 0.3,
            pointPlacement: -0.2
        }]
    });
...
/*    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerBySSAChartApp&tab=ssa',
        type:"GET",
        async:true,
        beforeSend:function (data) {
...
*/
    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerBySSAChartEducation&tab=ssa',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=MonthlyUtilisationAccumulatedTable&tab=framework',
        type:"GET",
        async:true,
        beforeSend:function (data) {
            $("#MonthlyUtilisationAccumulated").html('<img id="globe1" src="/img/loading-image.gif" style="vertical-align:text-bottom;" />');
        },
        success:function (response) {
            $("#MonthlyUtilisationAccumulated").html(response);
        }
    });



    Highcharts.chart('MonthlyUtilisationComparison', {
        chart: {
            type: 'line'
        },
        title: {
            text: 'Monthly Funding Vs Allocation (Accumulated)'
        },
        subtitle: {
            text: ''
        },
        ...
        series: [{
            ...
            data: [<?php
                    ...
                    foreach($periods as $period)
                    {
                        ...
                        $allocation_accumulated[] = round($total_allocation);
                    }
                    echo implode(",",$allocation_accumulated);
                ?>]
        }, {
            name: 'Funding',
            data: [<?php
                ...
                foreach($periods as $period)
                {
                    ...
                    $funding_accumulated[] = round($total_funding);
                }
                echo implode(",",$funding_accumulated);
                ?>]
        }]
    });

    Highcharts.chart('FundingUtilisationSummary', {
        ...
        title: {
            text: 'Funding Utilisation Summary'
        },
        ...
        yAxis: {
            ...
            plotBands: [{
                from: 0,
                to: <?php echo round($total_allocation*.6); ?>,
                color: '#55BF3B' // green
            }, {
                from: <?php echo round($total_allocation*.6); ?>,
                to: <?php echo round($total_allocation*.9); ?>,
                color: '#DDDF0D' // yellow
            }, {
                from: <?php echo round($total_allocation*.9); ?>,
                to: <?php echo round($total_allocation); ?>,
                color: '#DF5353' // red
            }]
        },
        ...
        series: [{
            ...
            data: [<?php echo round($total_funding); ?>],
            tooltip: {
                valueSuffix: ' Funding / Allocation'
            }
        }]
    ...
    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByAssessorTable&tab=assessor',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByAssessorApp&tab=assessor',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByAssessorEducation&tab=assessor',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByLevelTable&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByLevelApp&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByLevelEducation&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=RetentionByLevelTable&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=leaversbytrend&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=leaversbytrendactual&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=leaversbytrendonprogramme&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=leavers&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=leaversbyreason&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=leaversbyimpact&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=funding_reports&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=leaversbyactual&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
...
function age_band_filter_onchange(ele) {
    window.location.href = 'do.php?_action=funding_reports&age_band=' + encodeURIComponent(ele.value) + '&level=' + $('#level_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&tab=' + tab;
}

function click_tab(ele) {
    window.location.href = 'do.php?_action=funding_reports&'  +  '&tab=' + ele;
    //window.location.href = 'do.php?_action=funding_reports&age_band=' + encodeURIComponent($('#age_band_filter').val()) + '&level=' + $('#level_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&qar_type=' + $('#qar_type_filter').val() +  '&tab=' + ele;
}

function qar_type_filter_onchange(ele) {
    window.location.href = 'do.php?_action=funding_reports&qar_type=' + encodeURIComponent(ele.value) + '&level=' + $('#level_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&age_band_type=' + $('#age_band_filter').val() + '&tab=' + tab;
}

function best_case_filter_onchange(ele) {
    window.location.href = 'do.php?_action=funding_reports&qar_type=' + $('#qar_type_filter').val() + '&level=' + $('#level_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&age_band_type=' + $('#age_band_filter').val() + '&tab=' + tab;
}

function level_filter_onchange(ele) {
    window.location.href = 'do.php?_action=funding_reports&qar_type=' + $('#qar_type_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&age_band_type=' + $('#age_band_filter').val() + '&tab=' + tab;
}
