...
<head>
    ...
    <title>Learners CRM Notes Report</title>
    ...
    <script language="JavaScript">
        ...
        function resetFilters()
        {
            ...
            if ( $('#grid_filter_subject').length )
            {
                var grid = document.getElementById('grid_filter_subject');
...
<body>
<div class="banner">
    <div class="Title">Learner Notes</div>
    <div class="ButtonBar">
    ...
    <div class="ActionIconBar">
        ...
        <button onclick="exportToExcel('view_ViewLearnerCRM')" title="Export to .CSV file"><img src="/images/btn-excel.gif" width="16" height="16" style="vertical-align:text-bottom" alt="" /></button>
...
<div id="div_filters" style="display:none">
    ...
    <form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter">
        ...
        <input type="hidden" name="_action" value="view_learner_crm" />
        ...
        <div id="filterBox" class="clearfix">
            <fieldset>
                ...
                <div class="field float">
                    <label>Learner First Name:</label><?php echo $view->getFilterHTML('filter_firstname'); ?>
                </div>
                <div class="field float">
                    <label>Learner Surname:</label><?php echo $view->getFilterHTML('filter_surname'); ?>
                </div>
                <div class="field float">
                    <label>Training Status:</label><?php echo $view->getFilterHTML('filter_tr_status'); ?>
                </div>
                <div class="field float">
		...
		<?php if(in_array(DB_NAME, ["am_baltic", "am_baltic_demo"])) {?>
                    <div class="field float">
                        <label>Rating:</label><?php echo $view->getFilterHTML('filter_rating'); ?>
                    </div>
                    <div class="field float">
                        <label>Concerns:</label><?php echo $view->getFilterHTML('filter_concerns'); ?>
                    </div>
                    <div class="field float">
                        <label>Reason:</label><?php echo $view->getFilterHTML('filter_reason'); ?>
                    </div>
		    <div class="field float">
                        <label>Coordinator:</label><?php echo $view->getFilterHTML('filter_coordinator'); ?>
                    </div>	
                <?php } ?>
		<div class="field float">
