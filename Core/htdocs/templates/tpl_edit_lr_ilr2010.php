...
function toXML()
{
	...
	xml += "<L28>" + document.ilr.L28.options[document.ilr.L28.selectedIndex].value + "</L28>";
	xml += "<L29>" + document.ilr.L29.options[document.ilr.L29.selectedIndex].value + "</L29>";
...
//	xml += "<A02></A02>";
	...
	xml += "<A12a>" + "000" + "</A12a>";
	xml += "<A12b>" + "000" + "</A12b>";
	xml += "<A13>" + document.ilr.A13.value + "</A13>";
	...
	xml += "<A19>" + document.ilr.A19.options[document.ilr.A19.selectedIndex].value + "</A19>";
	xml += "<A20>" + document.ilr.A20.options[document.ilr.A20.selectedIndex].value + "</A20>";
	...
	xml += "<A52>" + document.ilr.A52.value + "</A52>";
	xml += "<A54></A54>";
	...
	xml += "<A56>" + document.ilr.L46.options[document.ilr.L46.selectedIndex].value + "</A56>";
	xml += "<A57>" + document.ilr.A57.options[document.ilr.A57.selectedIndex].value + "</A57>";
	xml += "<A58>" + document.ilr.A58.options[document.ilr.A58.selectedIndex].value + "</A58>";
...
//		+ '&submission_date=' + document.ilr.AA.value
	...
	var client = ajaxRequest('do.php?_action=validate_ilr2010', postData);
	if(client != null)
	{
...
<div class="banner">
	<div class="Title">
		<?php if($template!=1) { ?>
			Individual Learner Record 2010/11
		<?php } else { ?>
			ILR Template
		<?php }  ?>
	</div>
	<div class="ButtonBar">
		...
		<?php if(DB_NAME=='am_imi' || DB_NAME=='am_demo' || DB_NAME=='am_baltic' || DB_NAME=='am_baltic_demo' || DB_NAME=='am_exg' || DB_NAME=='ams' || DB_NAME=='am_learningworld' || DB_NAME=='am_peopleserve' || DB_NAME=='am_superdrug') { ?>
		...
		<button onclick="if(prompt('Password','')=='pscd2010')changeDates();">Change Dates</button>
		<?php } ?>
...
<fieldset>
<legend style='width: 801px'>ILR 2010/11 - Part 1 - Learner Information - Learner Responsive/ESF</legend>
	...
	<tr>
		...
		<?php 
			...
			if(trim($vo->learnerinformation->L09)==trim($previous_vo->learnerinformation->L09)) 
				echo "<input class=compulsory type=text value='" . htmlspecialchars((string)$vo->learnerinformation->L09) . "' id='L09' name='L09' maxlength=20 size=30 onKeyPress='return validName(this, event)'> </td>";
			else
		...
		<b> L27a: Tick this box if you do not wish to be contacted in respect of surveys and research by mail or phone </b></font><br></td>
		<td valign="top"><input type="checkbox" <?php echo $c2; ?>name="L27b">
		<b> L27b: Tick this box if you do not wish to be contacted about courses and learning opportunities by post</font><br></td>
		...
		<td class="fieldLabel_compulsory">L28 Eligibility for 16-18 funding<br>
		<?php echo HTML::select('L28', $L28_dropdown, $vo->learnerinformation->L28, true, true); ?></td>
		</tr>
		<tr>
		<td class="fieldLabel_compulsory">L29 Aditional Support <br>
		<?php echo HTML::select('L29', $L29_dropdown, $vo->learnerinformation->L29, true, true); ?></td>
		<td class="fieldLabel_optional"> L31 Additional Learning Support Cost <br>
		<?php echo "<input class='optional' type='text' value='" . $vo->learnerinformation->L31 . "' style='' id='L31' name='L31' maxlength=6 size=6 onKeyPress='return numbersonly(this, event)'></td>"; ?>
		</tr>
		<tr>
		<td class="fieldLabel_compulsory">L32 Eligibility for disadvantage uplift<br>
		<?php echo HTML::select('L32', $L32_dropdown, $vo->learnerinformation->L32, true, true); ?></td>
		<td class="fieldLabel_optional"> L33 Disadvantage uplift factor <br>
		<?php echo "<input class='optional' type='text' value='" . $vo->learnerinformation->L33 . "' style='' id='L33' name='L33' maxlength=6 size=6 ></td>"; ?>
		</tr>
		<tr>
		<td class="fieldLabel_compulsory">L49a Discretionary support funds<br>
		<?php echo HTML::select('L49a', $L49_dropdown, $vo->learnerinformation->L49a, true, true); ?></td>
		<td class="fieldLabel_compulsory">L49b Discretionary support funds<br>
		<?php echo HTML::select('L49b', $L49_dropdown, $vo->learnerinformation->L49b, true, true); ?></td>
		</tr>
		<tr>
		<td class="fieldLabel_compulsory">L49c Discretionary support funds<br>
		<?php echo HTML::select('L49c', $L49_dropdown, $vo->learnerinformation->L49c, true, true); ?></td>
		<td class="fieldLabel_compulsory">L49d Discretionary support funds<br>
		...
		<fieldset>
		<legend style='width: 801px'>ILR 2010/11 - Part 2 - Programme Aim Information - Required for all types of apprenticeship programmes</legend>
		...
		<fieldset>
		<legend style='width: 801px'> ILR 2010/11 - Part 3 - Main Aim Information - Learner Responsive/ESF <input value = '+' type='button' onClick='addAimFromMain(this);'/></legend>
		<div id="MainAim" name="MainAim" Style="Display: Block" class="Unit2">
		<table>
        <tr>
               <td colspan=4 align="center" valign="middle"> <b> <ul> Section 1 - Start Information - Required for all Learner Responsive Funded Provision</ul> </b> </td>
        </tr>
        <tr>
               <td colspan=4>&nbsp;</td>
        </tr>
...
<!--  	<td class="fieldLabel_compulsory"> A16 Programme Entry Route <br> -->
		...
		<td class="fieldLabel_compulsory"> A13 Tuition fee received for year <br>
		<?php echo "<input class='compulsory' type='text' value='" . $vo->aims[0]->A13 . "' style='' id='A13' name='A13' maxlength=5 size=5 onKeyPress='return numbersonly(this, event)'></td>"; ?>
		</tr>
		<tr>
		<td class="fieldLabel_compulsory"> A27 Learning Start Date <br>
		<?php 
		...
		?>
		<td class="fieldLabel_compulsory"> A17 Delivery Mode <br>
		...
		<td class="fieldLabel_optional"> A19 Employer role <br>
		<?php echo HTML::select('A19', $A19_dropdown, $vo->aims[0]->A19, true, false); ?></td>
		</tr>		
        <tr>
		<td class="fieldLabel_optional"> A20 Retake <br>
		<?php echo HTML::select('A20', $A20_dropdown, $vo->aims[0]->A20, true, false); ?></td>
		<td class="fieldLabel_optional"> A32 Guided Learning Hours<br>
		<?php echo "<input class='compulsory' type='text' value='" . $vo->aims[0]->A32 . "' style='background-color: white' id='A32' name='A32' maxlength=5 size=5></td>";?>	
		</tr>
		<tr>
		...
		<tr>
		<td class="fieldLabel_optional"> A52 Distance learning SLN<br>
		<?php echo "<input class='compulsory' type='text' value='" . $vo->aims[0]->A52 . "' style='background-color: white' id='A52' name='A52' maxlength=5 size=5></td>";?>	
		<td class="fieldLabel_compulsory"> A57 Source of tuition fees <br>
		<?php echo HTML::select('A57', $A57_dropdown, $vo->aims[0]->A57, true, true); ?></td>
		</tr>		
		<tr>
		<td class="fieldLabel_compulsory"> A58 Source of tuition fees <br>
...
-->
		...
		<!-- div id="aimsContainer" -->
		    <?php 
		        ...
		        for($a=1; $a<=$vo->subaims; $a++)
		        {
			        ...
			        echo "<fieldset>";
					echo "<legend style='width: 801px;'>ILR 2010/11 - Part 4 - Subsidiary Aim Information - Required for all types of apprenticeship programmes/ESF <button id='butt".$a."' onClick='deleteAim(this);'> X </button></legend>";	        
		        ?>
			    <table>
			      <tr>
				...
				?>
									...
									<tr>
										...
										?>
										<td class="fieldLabel_compulsory"> A13 Tuition fee received for year <br>
										<?php echo "<input class='compulsory' type='text' value='" . $vo->aims[$a]->A13 . "' style='' id='SA13' name='SA13' maxlength=5 size=5 onKeyPress='return numbersonly(this, event)'></td>"; ?>
										</tr>
		            			    <tr>
											<td class="fieldLabel_compulsory"> A46 National Learning Aim Monitoring <br>
									...
									<tr>
									<td class="fieldLabel_optional"> A19 Employer role <br>
									<?php echo HTML::select('SA19', $A19_dropdown, $vo->aims[$a]->A19, true, false); ?></td>
									<td class="fieldLabel_optional"> A20 Retake <br>
									<?php echo HTML::select('SA20', $A20_dropdown, $vo->aims[$a]->A20, true, false); ?></td>
									</tr>		
									<tr>
									<td class="fieldLabel_optional"> A32 Guided Learning Hours<br>
									<?php echo "<input class='compulsory' type='text' value='" . $vo->aims[$a]->A32 . "' style='background-color: white' id='SA32' name='SA32' maxlength=5 size=5></td>";?>	
									<td class="fieldLabel_optional"> A52 Distance learning SLN<br>
									<?php echo "<input class='compulsory' type='text' value='" . $vo->aims[$a]->A52 . "' style='background-color: white' id='SA52' name='SA52' maxlength=5 size=5></td>";?>	
									</tr>	
									<tr>
									<td class="fieldLabel_compulsory"> A57 Source of tuition fees <br>
		...
		?>
          ...
          <fieldset>
		    <legend style='width: 801px'>ILR 2010/11 - Part 4 - Subsidiary Aim Information - Required for all types of apprenticeships programmes <button id='butt' onClick='deleteAim(this);'> X </button></legend>
	   		<table>
			                        <tr>
									...
									<tr>
										...
										?>
										<td class="fieldLabel_compulsory"> A13 Tuition fee received for year <br>
										<?php echo "<input class='compulsory' type='text' style='' id='SA13' name='SA13' maxlength=5 size=5 onKeyPress='return numbersonly(this, event)'></td>"; ?>
									</tr>
									<tr>
											<td class="fieldLabel_compulsory"> A46 National Learning Aim Monitoring <br>
									...
									<tr>
											<td class="fieldLabel_optional"> A19 Employer role <br>
											<?php echo HTML::select('SA19', $A19_dropdown, null, true, false); ?></td>
											<td class="fieldLabel_optional"> A20 Retake <br>
											<?php echo HTML::select('SA20', $A20_dropdown, null, true, false); ?></td>
									</tr>		
									<tr>
											<td class="fieldLabel_optional"> A32 Guided Learning Hours<br>
											<?php echo "<input class='compulsory' type='text' style='background-color: white' id='SA32' name='SA32' maxlength=5 size=5></td>";?>	
											<td class="fieldLabel_optional"> A52 Distance learning SLN<br>
											<?php echo "<input class='compulsory' type='text' style='background-color: white' id='SA52' name='SA52' maxlength=5 size=5></td>";?>	
									</tr>		
									<tr>
											<td class="fieldLabel_compulsory"> A57 Source of tuition fees <br>
											<?php echo HTML::select('SA57', $A57_dropdown, null, true, true); ?></td>
											<td class="fieldLabel_compulsory"> A58 Source of tuition fees <br>
											<?php echo HTML::select('SA58', $A58_dropdown, null, true, true); ?></td>
									</tr>	
									<tr>
											<td class="fieldLabel_optional"> A63 National Skills Academy <br>
									...
									<tr>
											...
											<td class="fieldLabel_compulsory"> A17 Delivery Mode <br>
											<?php echo HTML::select('SA17', $A17_dropdown, null, true, true); ?></td>
...
<input type="hidden" name="_action" value="pdf_from_ilr2010" />
