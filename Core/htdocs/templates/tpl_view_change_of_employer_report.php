...
<head>
	...
	<title>Change of Employer Report</title>
...
<div class="row">
	<div class="col-lg-12">
		<div class="banner">
			<div class="Title" style="margin-left: 6px;">Change of Employer Report</div>
			<div class="ButtonBar">
			...
			<div class="ActionIconBar">
				...
				<span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="window.location.href='do.php?_action=view_change_of_employer_report&subaction=export_csv'" title="Export to .CSV file"></span>
	...
	<div class="row">
		<div id="div_filters" style="display:none" class="small">
			<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter" name="applyFilter">
				<input type="hidden" name="_action" value="view_change_of_employer_report" />
				...
				<div id="filterBox" class="clearfix">
					<fieldset>
						...
						<div class="field float"><label>COE Process Complete:</label><?php echo $view->getFilterHTML('filter_process_complete'); ?></div>
`					</fieldset>
					<fieldset>
