...
<body>
<div class="banner">
	<div class="Title">Destiny XML Update</div>
	<div class="ButtonBar">
...
<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>?_action=save_upload_destiny_xml" ENCTYPE="multipart/form-data">
<input type="hidden" name="_action" value="save_upload_destiny_xml" />
