...
<title>Gateway Review - Preparation for Interview</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Gateway Review - Preparation for Interview</div>
    <div class="ButtonBar">
        ...
        if(isset($_SESSION['user']) and $_SESSION['user']->type!=User::TYPE_SYSTEM_VIEWER)
            if($form_arf->signature_employer_font=='' || $form_arf->signature_learner_font=='')
            {
                ...
                if($form_arf->signature_assessor_font=="")
                    echo '<button onclick="window.location.replace(\'do.php?_action=arf_introduction&convert=1&source=1&review_id=' . $review_id . '&tr_id=' . $tr_id .  '\')">Convert to General Gateway</button>';
            }
            else
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Gateway Review - Preparation for Interview</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tbody>
    <tr>
        <td colspan=4>Discuss the importance of them being able to familiarise their self with their portfolio: knowing and understanding their evidence and knowing how their evidence meets the standard - ask for specific examples</td>
    </tr>
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
    ...
    <tr>
        <td colspan=4>Discuss their need to be able to describe what their evidence shows and how it shows they are competent in their job role - ask for specific examples</td>
    </tr>
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
    ...
    <tr>
        <td colspan=4>Discuss additional tasks, projects, work that they have been involved in, or areas that they have improved in related to the competencies in their portfolio - ask for specific examples</td>
    </tr>
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
...
<table class="table1" style="width: 900px">
    <thead>
    <th colspan=4>&nbsp;&nbsp;&nbsp;Additional Comments/Discussions: </th>
    </thead>
    <tbody>
    <tr>
        <td colspan=4><i>
