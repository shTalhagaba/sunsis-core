...
<head>
	...
	<title>Appointments Summary</title>
	...
	<script language="JavaScript">
		...
		{
			var group_id = s.id.substring(4);
			$("table tr[group="+group_id+"]").toggle();
		}
	</script>
	<style type="text/css">
		td.greenl
...
<body>
<div class="banner">
	<div class="Title">Appointments Summary</div>
	<div class="ButtonBar">
	</div>
	<div class="ActionIconBar">
		<button onclick="showHideBlock('div_filters');showHideBlock('div_filter_crumbs');" title="Show/hide filters"><img src="/images/btn-filter.gif" width="16" height="16" style="vertical-align:text-bottom" /></button>
		<button onclick="window.print()" title="Print-friendly view"><img src="/images/btn-printer.gif" width="16" height="16" style="vertical-align:text-bottom" /></button>
		<!--<button onclick="window.location.href='do.php?_action=view_appointments_summary&export=excel'" title="Export to .CSV file"><img src="/images/btn-excel.gif" width="16" height="16" style="vertical-align:text-bottom" alt="" /></button>-->
...
<div id="div_filters" style="display:none">
	...
	<form method="get" action="#" id="applySavedFilter">
		<input type="hidden" name="_action" value="view_appointments_summary" />
	...
	<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter">
		...
		<div id="filterBox" class="clearfix">
			...
			<fieldset>
				...
				<div class="field float">
					<label>Appointment Status:</label><?php echo $view->getFilterHTML('filter_appointment_status'); ?>
				</div>
				<div class="field float">
					<label>Appointment Type:</label><?php echo $view->getFilterHTML('filter_appointment_type'); ?>
				</div>
				<div class="field float">
					<label>Appointment GYR Status:</label><?php echo $view->getFilterHTML('filter_appointment_rgb_status'); ?>
				</div>
				<!--<div class="field float">
					<label>Appointment Paperwork:</label><?php /*echo $view->getFilterHTML('filter_appointment_paperwork'); */?>
				</div>-->
				<div class="field float">
					<label>Appointment Sessions:</label><?php echo $view->getFilterHTML('filter_sessions'); ?>
				</div>
				<div class="field float">
					<label>Forward / Past:</label><?php echo $view->getFilterHTML('filter_forward_past'); ?>
				</div>
				<div class="field newrow">
					<label>Appointment Date Between</label><?php echo $view->getFilterHTML('filter_from_appointment_date'); ?>
					&nbsp;and <?php echo $view->getFilterHTML('filter_to_appointment_date'); ?>
				</div>
			</fieldset>
			<?php if(DB_NAME == "am_reed_demo" || DB_NAME == "am_reed") { ?>
			<fieldset>
