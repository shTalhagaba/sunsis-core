...
<body>
<div class="banner">
	<div class="Title">ILR Report &nbsp; - &nbsp; <?php echo $vo->title;?> - &nbsp; <?php echo $submission;?>	</div>
	<div class="ButtonBar">
		<button onclick="window.history.go(-1);">Back</button>
		<button onclick="window.open('http://www.theia.org.uk/NR/rdonlyres/FC7215F8-5CD3-43E3-955B-2A83218CFA28/0/FullILRSpecification201011_30jul2010_v3.pdf');">ILR Specification Guidance </button>
	</div>
	<div class="ActionIconBar">
		<button onclick="showHideBlock('div_filters');showHideBlock('div_filter_crumbs');" title="Show/hide filters"><img src="/images/btn-filter.gif" width="16" height="16" style="vertical-align:text-bottom" /></button>
		<button onclick="window.print()" title="Print-friendly view"><img src="/images/btn-printer.gif" width="16" height="16" style="vertical-align:text-bottom" /></button>
		<?php $member_numbers = $view->getFilterValue('filter_ilr_fields'); ?>
		<button onclick="window.location.href='do.php?_action=ilr_report_export&contract_id=<?php echo $contract_id ?>&submission=<?php echo htmlspecialchars((string)$submission); ?>&member_numbers=<?php echo htmlspecialchars((string)$member_numbers);?>'" title="Export to .CSV file"><img src="/images/btn-excel.gif" width="16" height="16" style="vertical-align:text-bottom" /></button>
...
<div id="div_filters" style="display:none">
	...
	<input type="hidden" id="contract" name="contract" value="<?php echo $contract_id?>" />
