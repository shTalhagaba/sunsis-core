...
<body>
<div class="banner">
	<div class="Title">Send Email to Employer Contacts</div>
	<div class="ButtonBar">
		<?php if($_SESSION['user']->isAdmin() || $_SESSION['user']->type==7 || $_SESSION['user']->type==8 || $_SESSION['user']->type==1 || $_SESSION['user']->type==3 || $_SESSION['user']->type==4 || (DB_NAME=="am_pathway" && $_SESSION['user']->type==22)|| (DB_NAME=="am_baltic" && $_SESSION['user']->type==23)) { ?>
...
<div id="maincontent">
	<?php $_SESSION['bc']->render($link); ?>
		...
		<form id="mainForm" name="mainForm"  action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
			<input type="hidden" name="_action" value="send_emp_contact_email" />
			<input type="hidden" name="id" value="<?php echo $organisation_id; ?>" />
