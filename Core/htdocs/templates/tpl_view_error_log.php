...
function clearLog()
{
	...
	if(response == '')
	{
		uri = 'do.php?_action=clear_error_log';
	}
	else
	{
		...
		uri = 'do.php?_action=clear_error_log&date=' + encodeURIComponent(response);
	}
	
	var req = ajaxRequest(uri);
	if(req != null)
	{
...
<div class="banner">
	...
	<div class="ButtonBar">
		...
		<?php if(SOURCE_LOCAL || SOURCE_BLYTHE_VALLEY || $_SESSION['user']->isAdmin()) { ?>
...
<div id="div_filters" style="display:none">
	...
	<input type="hidden" name="_action" value="view_error_log" />
