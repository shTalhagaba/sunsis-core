...
<div class="banner">
	...
	<div class="ActionIconBar">
        ...
        {
        ?>
        <input type="button" value="< Back to Dashboard" onclick="window.location.href='?_action=sla_kpi_rep_achievers&report_type=sla_kpi_rep_overall_success'" style="float:left;margin: 0 0 10px;">
        <?php
        }
        else if($report == "timely_success")
        {
        ?>
        <input type="button" value="< Back to Dashboard" onclick="window.location.href='?_action=sla_kpi_rep_achievers&report_type=sla_kpi_rep_timely_success'" style="float:left;margin: 0 0 10px;">
        <?php
        }
        ?>
	...
	<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter">
		...
		<div id="filterBox" class="clearfix" style="text-align: left; display: none;">
            ...
            <!--<tr>
                ...
                <td colspan="7">
                    <?php echo $view->getFilterHTML('filter_progress'); ?>&nbsp;&nbsp;
            ...
            <tr>
                ...
                <td colspan="7">
                    <?php echo $view->getFilterHTML('filter_group'); ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="7">
                    <?php echo $view->getFilterHTML('filter_gender'); ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="7">
                    <?php echo $view->getFilterHTML('filter_course'); ?>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="7">
                    <?php echo $view->getFilterHTML('filter_framework'); ?>
                </td>
            </tr>
            ...
            <tr>
                <td>Valid : </td>
                <td colspan="7">
                    <?php echo $view->getFilterHTML('filter_valid'); ?>
    				&nbsp;&nbsp;
                    Active : <?php echo $view->getFilterHTML('filter_active');?>
                </td>
            </tr>
            ...
            <tr>
                <td>Submission : </td>
                <td colspan="7">
                    <?php echo $view->getFilterHTML('filter_submission'); ?>
    				&nbsp;&nbsp;
                    Contract year : <?php echo $view->getFilterHTML('filter_contract_year');?>
                </td>
            </tr>
            -->
            ...
            <tr>
                <td>Assessor : </td>
                <td colspan="7">
                    <?php echo $view->getFilterHTML('filter_assessor'); ?>
    				&nbsp;&nbsp;
            ...
            <tr>
                <td>Employer : </td>
                <td colspan="7">
                    <?php echo $view->getFilterHTML('filter_employer'); ?>
        				&nbsp;&nbsp;
            ...
            <tr>
                <td>Age band : </td>
                <td colspan="7">
                    <?php echo $view->getFilterHTML('filter_age_band'); ?>
        				&nbsp;&nbsp;
                    Program type : <?php echo $view->getFilterHTML('filter_programme_type'); ?>
                </td>
            </tr>

            <tr>
                <td>Sector Subject Area (SSA) : </td>
                <td colspan="7">
                    <?php echo $view->getFilterHTML('filter_ssa'); ?>
        				&nbsp;&nbsp;
                    Ethnicity : <?php echo $view->getFilterHTML('filter_ethnicity'); ?>
                </td>
            </tr>
            </table>
            ...
            <!--<table>
            <tr>
                <td colspan="8"><h2>Dates</h2></td>
            </tr>
            <tr>
                <td><label><b>Start Date</b></label></td>
                <td colspan="7">
                    From : <?php echo $view->getFilterHTML('start_date'); ?> to <?php echo $view->getFilterHTML('end_date'); ?>
                </td>
            </tr>

            <tr>
                <td><label><b>Projected end date</b></label></td>
                <td colspan="7">
                    From : <?php echo $view->getFilterHTML('target_start_date'); ?> to <?php echo $view->getFilterHTML('target_end_date'); ?>
                </td>
            </tr>

            <tr>
                <td><label><b>Closure Date</b></label></td>
                <td colspan="7">
                    From : <?php echo $view->getFilterHTML('closure_start_date'); ?> to <?php echo $view->getFilterHTML('closure_end_date'); ?>
                </td>
            </tr>
