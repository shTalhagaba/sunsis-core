                            ...
                            <div class="col-sm-12">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>Name of Bank</td>
                                        <td>
                                            <input type="text" class="form-control compulsory" name="bank_name" value="<?php echo $agreement->bank_name; ?>" maxlength="149" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Account Name</td>
                                        <td>
                                            <input type="text" class="form-control compulsory" name="account_name" value="<?php echo $agreement->account_name; ?>" maxlength="149" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Sort Code</td>
                                        <td>
                                            <input type="text" class="form-control compulsory" name="sort_code" value="<?php echo $agreement->sort_code; ?>" maxlength="8" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Account Number</td>
                                        <td>
                                            <input type="text" class="form-control compulsory" name="account_number" value="<?php echo $agreement->account_number; ?>" maxlength="10" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="col-sm-12 table-responsive">
                                <table style="margin-top: 5px;" class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>Employer</td>
                                        <td>
                                            <?php echo '<input type="text" class="form-control compulsory" name="employer_sign_name" id="employer_sign_name" value="' . $agreement->employer_sign_name . '" />'; ?>
                                        </td>
                                        <td>
