...
<body>
<div class="banner">
	<div class="Title">All Reviews Report</div>
	<div class="ButtonBar">
	...
	<div class="ActionIconBar">
		...
		<button onclick="exportToExcel('view_ViewReviewsReport')" title="Export to .CSV file"><img src="/images/btn-excel.gif" width="16" height="16" style="vertical-align:text-bottom" alt="" /></button>
...
<div id="div_filters" style="display:none">
	...
	<input type="hidden" name="_action" value="view_reviews_report" />
	...
	<div id="filterBox" class="clearfix">
		...
		<fieldset>
				<legend>Next Review Dates</legend>
			<div class="field">
		...
		<fieldset>
				<legend>Review Dates</legend>
				<div class="field">
					<label>From:</label><?php echo $view->getFilterHTML('last_start_date'); ?>
				&nbsp;to <?php echo $view->getFilterHTML('last_end_date'); ?>
				</div>		
		</fieldset>
		<fieldset>
				...
				<div class="field float">
					<label>Person Reviewed:</label><?php echo $view->getFilterHTML('filter_person_reviewed'); ?>
				</div>
				<div class="field float">
				...
				<div class="field float">
					<label>Employer Manufacturer/Brand:</label><?php echo $view->getFilterHTML('filter_manufacturer'); ?>
				</div>
				<div class="field float">
					<label>Learner surname:</label><?php echo $view->getFilterHTML('surname'); ?>
				</div>
				<div class="field float">
					<label>Paperwork Received:</label><?php echo $view->getFilterHTML('filter_paperwork'); ?>
				</div>
				<div class="field float">
					<label>Learner ULN:</label><?php echo $view->getFilterHTML('filter_uln'); ?>
				</div>
				<div class="field float">
					<label>Area Code:</label><?php echo $view->getFilterHTML('filter_area_code'); ?>
				</div>
				<div class="field float">
