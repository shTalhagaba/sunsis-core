...
<title>Ecordia: Learner Progress Sync</title>
...
<script type="text/javascript">
	...
	function onFilterClick(e) {
		...
		$('div#content').load('do.php?_action=ec_progresstracking_sync&subaction=rendercontent' + filters, null, onContentLoad);
	}
	...
	function onContentLoad(responseText, textStatus, xmlHttpRequest)
	{
		...
		$('input#BtnUpdateProgress').click(updateProgress);
	...
	function updateProgress(e)
	{
		...
		if ($selectedBoxes.length == 0) {
			alert("Please select one or more pairs of records to update progress in Sunesis");
			return;
		}
		...
		showProgressAnimation('loading51.gif');
		var client = ajaxRequest('do.php?_action=ec_progresstracking_sync&subaction=updateprogress', data);
		if (!client) {
			//
		}
...
<body>
<div class="banner">
	<div class="Title">Ecordia: Progress Synchronisation</div>
	<div class="ButtonBar">
...
<div style="width:1150px;">
	...
	<div class="Newspaper">
		<p class="introduction">This page provides the facility to update progress in Sunesis from Ecordia, only for linked training records.</p>
		<p class="introduction">The overall percentage completed and percentage completed per aim will be imported from Ecordia.</p>
	</div>
