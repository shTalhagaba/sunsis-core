...
<head>
    ...
    <script src="/js/ilr2024.js?n=<?php echo time(); ?>"></script>
    <style>
    #NINumber,
    #CurrentPostcode,
    ...
    <div class="banner">
        <table border="0" cellspacing="0" cellpadding="0" height="100%" width="100%">
            <tr class="head">
                <td valign="bottom">
                    <?php if ($template != 1) { ?>
                    <?php echo $vo->GivenNames . ' ' . $vo->FamilyName; ?> 2024/25 ILR
                    <?php } else { ?>
                    ILR Template
                    <?php }  ?>
                </td>
        ...
        <table border="0" cellspacing="0" cellpadding="0" height="100%" width="100%">
            <tr>
                <td valign="top" align="left" class="left">
                    ...
                    if ($template != 1) {
                        ?>
                        <div class="button_header ui-icon-circle-close" id="b3" onclick="confirm_on_cancel();"><img
                                src="../images/close_icon.gif" height="15" width="15" /> Cancel
                        </div>
                        <?php } ?>

                        <?php if (false) { ?>
                        <div class="button_header" id="b1" onclick="return save();"><img src="../images/save.png"
                                height="15" width="15" /> Save & Close</div>
                        <div class="button_header" id="b11" onclick="return save_and_stay();"><img
                                src="../images/save.png" height="15" width="15" /> Save & Stay</div>
                        <?php
                    }
                    ...
                    if ($template != 1) {
                        ...
                        <div class="button_header" id="b2" onclick="return validation();"><img
                                src="../images/validate.png" height="15" width="15" /> Validate</div>
                        <!-- <div class="button_header" id="b4" onclick="PDF();"><img src="../images/pdf_icon.png" height="15" width="15" /> PDF</div> -->
                        <?php } ?>

                        <?php if ($_SESSION['user']->isAdmin()) { ?>
                        <div class="button_header addTab" id="addaim"><img src="../images/plus.png" height="15"
                                width="15" /> Add Aim</div>
                        <?php
                    }
            ...
            ?>
                ...
                ?>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <fieldset>
                                                    <legend>Tick any of the following boxes if Learner does not wish to
                                                        be contacted:</legend>
                                                    <table border="0" cellspacing="4" cellpadding="4">
                                                        <tr>
                                                            <td colspan="2" class="tooltip"
                                                                title="To take into account learners' wishes about the use of their data. The data held in this field is used by the FE Choices.">
                                                                <?php
                                $RUI_dropdown = array(
                                ...
                                ?>
                                                        ...
                                                        <tr>
                                                            <td colspan="2" class="tooltip"
                                                                title="To take into account learners' wishes about contact methods for surveys, research and learning opportunities.">
                                                                <?php
                                $PMC_dropdown = array(
                                    array('1', 'By post'),
                                    array('2', 'By phone'),
            ...
            ?>
                    ...
                    ?>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <fieldset class="innerFieldset">
                                                    <legend>Does the learner have any of the following (tick those that
                                                        apply)</legend>
                                                    <table border="0" cellspacing="4" cellpadding="4">
                                                        <tr>
                                                            <td colspan="2" class="tooltip"
                                                                title="Education Health Care plan: To indicate if the learner has an Education Health Care Plan.<br>
...
SQL;
                            ...
                            ?>
                                                    ...
                                                    <table>
                                                        <tr><?php $this->dynamic_field_display('ALSCost', "<input class='optional' type='text' value='" . $vo->ALSCost . "' id='ALSCost' name='ALSCost' maxlength=40 size=40 onKeyPress='return numbersonly(this, event)'>"); ?>
                                                        </tr>
                                                    </table>
                                                </fieldset>
                                            </td>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <fieldset class="innerFieldset tooltip"
                                                    title="Eligibility for EFA disadvantage funding">
        ...
        echo '<table>';
            ...
            ?>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <fieldset class="innerFieldset tooltip"
                                                        title="To identify and report on learners that are in receipt of different types of learner support and to assist in the evaluation of its effectiveness.">
                                                        <legend>Learner Support Reason (select up to 4 that apply)
                                                        </legend>
                                                        <table border="0" cellspacing="4" cellpadding="4">
                                                            <tr>
                                                                <td>
                            ...
                            ?>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <fieldset class="innerFieldset tooltip"
                                                        title="To identify any additional monitoring characteristics required for the learner.">
                ...
                ?>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <fieldset class="innerFieldset tooltip"
                                                        title="English and Maths Grades">
                            ...
                            ?>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <fieldset class="innerFieldset tooltip"
                                                        title="Learner eligibility for Pupil Premium Funding">
                                                        <legend>Free Meals and Pupil premium funding eligibility
                                                        </legend>
                                                        <table border="0" cellspacing="4" cellpadding="4">
                                                            <tr>
                                                                <td colspan="2" class="tooltip">
...
SQL;
            ...
            echo '	      <legend><img style="cursor: pointer;" src="/images/info-icon.png" alt="Information" height="15" width="15" title="Click for information" onclick="HHSDetail();" />Household Situation (select up to 2 that apply) - (Aim Reference: ' . (string)$delivery->LearnAimRef . ', Aim Type: ' . (string)$delivery->AimType . ')</legend>';
            echo '	        <table border="0" cellspacing="4" cellpadding="4">';
            echo '	          <tr>';
            echo '	            <td>';
            $HHS_dropdown = array(
...
foreach ($vo->LearnerEmploymentStatus as $empstatus) {
    ...
    if($tr_start_date->after(Date::toShort($empstatus->DateEmpStatApp)))
    {
        ...
        //if($empstatus->EmployerId=="")
        //    echo HTML::select($EmployerId, $employers, $training_record->employer_id, true, false);
        //else
            echo HTML::select($EmployerId, $employers, $empstatus->EmployerId, true, false);
        echo '</td>';
        echo '</tr>';
...
?>
    ...
    <div id="endInfoDialog" title="Learning End Information">
        ...
        <form name="frmEndInfo">
            <table id="tblEndInfo" border="0" class="resultset" cellspacing="4" cellpadding="4"
                style="margin-left:10px">
                <tr>
                    <th>Learning Actual End Date: </th>
                    <td><?php echo HTML::datebox('endInfoActEndDate', ''); ?></td>
                </tr>
                <tr>
                    <th>Completion Status: </th>
                    <td><?php echo HTML::select('endInfoCompStatus', $CompStatus_dropdown, '', false); ?></td>
                </tr>
                <tr>
                    <th>Outcome: </th>
                    <td><?php echo HTML::select('endInfoOutcome', $Outcome_dropdown, '', true); ?></td>
                </tr>
                <tr>
                    <th>Achievement Date: </th>
                    <td><?php echo HTML::datebox('endInfoAchDate', ''); ?></td>
                </tr>
                <tr>
                    <th>Withdrawl Reason: </th>
                    <td><?php echo HTML::select('endInfoWithdrawReason', $WithdrawReason_dropdown, '', true); ?></td>
                </tr>
                <tr>
                    <th>Outcome Grade: </th>
                    <td><?php echo HTML::select('endInfoOutGrade', $OutGrade_dropdown, '', true); ?></td>
                </tr>
                <tr>
                    <th>Actual OTJ: </th>
                    <td><input class='optional' type='text' value='' style='' id='endInfoActOTJ' name='endInfoActOTJ'
        ...
        if (div != null) {
            ...
            for (var i = 0; i < elements.length; i++) {
                if (elements[i] != "radio" || (elements[i].type == "radio" && elements[i].checked)) {
                    if (elements[i].name == "LearnAimRef" && (elements[i].value == "119EP" || elements[i].value ==
                            "119GW"))
                        comp_status = 0;
                }
            }
    ...
    jQuery(document).ready(function($) {
        ...
        var tabbedNav = $("#tabbed-nav3").zozoTabs({
            ...
            add = function(e) {
                ...
                tabbedNav.data("zozoTabs").add("New Aim", document.getElementById("deliveriesTab").appendChild(
                    newAim));
                a = 0;
                $('.Unit').each(function() {
                    a++;
