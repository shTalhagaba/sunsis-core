...
<script language="JavaScript">
	...
	var phpUsername = "<?php echo addslashes((string)$user->username); ?>";
	var phpFirstnames = "<?php echo addslashes((string)$user->firstnames); ?>";
	var phpSurname = "<?php echo addslashes((string)$user->surname); ?>";
	var phpOrgLegalName = "<?php echo addslashes((string)$user->org->legal_name); ?>";
	var phpOrgShortName = "<?php echo addslashes((string)$user->org->short_name); ?>";

	$("input[name=password1").on("keypress", function(e){
		if(e.which == 163)
		{
			e.preventDefault();
