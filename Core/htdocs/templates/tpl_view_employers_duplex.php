    ...
    <div class="col-lg-12">
        <div class="banner">
            ...
            <div class="ButtonBar">
                ...
                <button class="btn btn-default btn-xs" onclick="window.location.href='do.php?_action=edit_employer';"><i class="fa fa-plus"></i> Add New Employer</button>
            </div>
            <div class="ActionIconBar">
                ...
                <span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="exportToExcel('view_ViewEmployersV2');" title="Export to .CSV file"></span>
                ...
                <form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" name="applyFilter" id="applyFilter">
                    ...
                    <div id="filterBox" class="clearfix small">
                        <fieldset>
                            ...
                            <div class="field float"><label>Status:</label><?php echo $view->getFilterHTML('filter_org_status'); ?></div>
                            ...
                            <div class="field float"><label>Region:</label><?php echo $view->getFilterHTML('filter_region'); ?></div>
                            <div class="field float"><label>Employer Telephone:</label><?php echo $view->getFilterHTML('filter_employer_telephone'); ?></div>
                            <div class="field float"><label>Employer Contact Telephone:</label><?php echo $view->getFilterHTML('filter_employer_contact_telephone'); ?></div>
                        </fieldset>
                        <fieldset>
                            <legend>Dates</legend>
