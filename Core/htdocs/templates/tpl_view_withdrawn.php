...
<head>
    ...
    <title>Withdrawn Restart Report</title>
...
<body>
<div class="banner">
    <div class="Title">Withdrawn Restart Report</div>
    <div class="ButtonBar">
    ...
    <div class="ActionIconBar">
        ...
        <button onclick="window.location.href='do.php?_action=view_withdrawn&export=export'" title="Export to .CSV file"><img src="/images/btn-excel.gif" width="16" height="16" style="vertical-align:text-bottom" alt="" /></button>
