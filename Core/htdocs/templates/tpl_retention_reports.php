...
<div class="banner">
	<div class="Title">Retention Reports</div>
...
<div id="demo" class="yui-navset">
	<ul class="yui-nav">
		<li class="selected"><a href="#tab1"><em>Apps by AoL</em></a></li>
		<li class=""><a href="#tab2"><em>Apps by Gender</em></a></li>
		<li class=""><a href="#tab3"><em>Apps by Framework</em></a></li>
		<li class=""><a href="#tab4"><em>Apps by Assessor</em></a></li>
		<li class=""><a href="#tab5"><em>Apps by Employer</em></a></li>
        <li class=""><a href="#tab6"><em>ER/LR by AoL</em></a></li>
        <li class=""><a href="#tab7"><em>ER/LR by Gender</em></a></li>
        <li class=""><a href="#tab8"><em>ER/LR by Assessor</em></a></li>
        <li class=""><a href="#tab9"><em>ER/LR by Employer</em></a></li>
        <li class=""><a href="#tab10"><em>FL by AoL</em></a></li>
        <li class=""><a href="#tab11"><em>FL by Gender</em></a></li>
        <li class=""><a href="#tab12"><em>FL by Framework</em></a></li>
        <li class=""><a href="#tab13"><em>FL by Assessor</em></a></li>
        <li class=""><a href="#tab14"><em>FL by Employer</em></a></li>
	...
	<div class="yui-content" style='background: white'>
		<div id="tab1"><p>
			<div align="center" style="margin-top:50px;">
				...
				<?php
				echo "<h3>Area of Learning (By Qualifications)</h3>";
                echo $contract_title;
                if(isset($report_apps_by_aol))
                {
                    echo $report_apps_by_aol->to('HTML');
                    echo "<h3>Pie Chart</h3>";
                    echo $report_apps_by_aol->to('PieChart');
                }
				?>
		...
		<div id="tab2">
			...
			<div align="center" style="margin-top:50px;">
				...
				echo "<h3>Gender</h3>";
                echo $contract_title;
                if(isset($report_apps_by_gender))
                {
                    echo $report_apps_by_gender->to('HTML');
                    echo "<h3>Pie Chart</h3>";
                    echo $report_apps_by_gender->to('PieChart');
                }
				?>
		...
		<div id="tab3">
			...
			<div align="center" style="margin-top:50px;">
				...
				<?php
				echo "<h3>Frameworks</h3>";
                echo $contract_title;
                if(isset($report_apps_by_framework))
                {
                    echo $report_apps_by_framework->to('HTML');
                    echo "<h3>Pie Chart</h3>";
                    echo $report_apps_by_framework->to('PieChart');
                }
				?>
		...
		<div id="tab4">
			...
			<div align="center" style="margin-top:50px;">
				...
				echo "<h3>Assessor</h3>";
                echo $contract_title;
                if(isset($report_apps_by_assessor))
                {
                    echo $report_apps_by_assessor->to('HTML');
                    echo "<h3>Pie Chart</h3>";
                    echo $report_apps_by_assessor->to('PieChart');
                }
				?>
		...
		<div id="tab5">
            ...
            <div align="center" style="margin-top:50px;">
                ...
                echo "<h3>Employer</h3>";
                echo $contract_title;
                if(isset($report_apps_by_employer))
                {
                    echo $report_apps_by_employer->to('HTML');
                    echo "<h3>Pie Chart</h3>";
                    echo $report_apps_by_employer->to('PieChart');
                }
				?>
			</div>
			</p>
        ...
        <div id="tab6"><p>
            <div align="center" style="margin-top:50px;">
                ...
                echo "<h3>Area of Learning (By Qualifications)</h3>";
                echo $contract_title;
                if(isset($report_other_by_aol))
                {
                    echo $report_other_by_aol->to('HTML');
                    echo "<h3>Pie Chart</h3>";
                    echo $report_other_by_aol->to('PieChart');
                }
                ?>
        ...
        <div id="tab7">
            ...
            <div align="center" style="margin-top:50px;">
                ...
                echo "<h3>Gender</h3>";
                echo $contract_title;
                if(isset($report_other_by_gender))
                {
                    echo $report_other_by_gender->to('HTML');
                    echo "<h3>Pie Chart</h3>";
                    echo $report_other_by_gender->to('PieChart');
                }
                ?>
        ...
        <div id="tab8">
            ...
            <div align="center" style="margin-top:50px;">
                ...
                echo "<h3>Assessor</h3>";
                echo $contract_title;
                if(isset($report_other_by_assessor))
                {
                    echo $report_other_by_assessor->to('HTML');
                    echo "<h3>Pie Chart</h3>";
                    echo $report_other_by_assessor->to('PieChart');
                }
                ?>
        ...
        <div id="tab9">
            ...
            <div align="center" style="margin-top:50px;">
                ...
                echo "<h3>Employer</h3>";
                echo $contract_title;
                if(isset($report_other_by_employer))
                {
                    echo $report_other_by_employer->to('HTML');
                    echo "<h3>Pie Chart</h3>";
                    echo $report_other_by_employer->to('PieChart');
                }
                ?>
            </div>
            </p>
        ...
        <div id="tab10"><p>
            <div align="center" style="margin-top:50px;">
                ...
                echo "<h3>Area of Learning (By Qualifications)</h3>";
                echo $contract_title;
                if(isset($report_fl_by_aol))
                {
                    echo $report_fl_by_aol->to('HTML');
                    echo "<h3>Pie Chart</h3>";
                    echo $report_fl_by_aol->to('PieChart');
                }
                ?>
        ...
        <div id="tab11">
            ...
            <div align="center" style="margin-top:50px;">
                ...
                echo "<h3>Gender</h3>";
                echo $contract_title;
                if(isset($report_fl_by_gender))
                {
                    echo $report_fl_by_gender->to('HTML');
                    echo "<h3>Pie Chart</h3>";
                    echo $report_fl_by_gender->to('PieChart');
                }
                ?>
        ...
        <div id="tab12">
            ...
            <div align="center" style="margin-top:50px;">
                ...
                echo "<h3>Frameworks</h3>";
                echo $contract_title;
                if(isset($report_fl_by_framework))
                {
                    echo $report_fl_by_framework->to('HTML');
                    echo "<h3>Pie Chart</h3>";
                    echo $report_fl_by_framework->to('PieChart');
                }
                ?>
        ...
        <div id="tab13">
            ...
            <div align="center" style="margin-top:50px;">
                ...
                echo "<h3>Assessor</h3>";
                echo $contract_title;
                if(isset($report_fl_by_assessor))
                {
                    echo $report_fl_by_assessor->to('HTML');
                    echo "<h3>Pie Chart</h3>";
                    echo $report_fl_by_assessor->to('PieChart');
                }
                ?>
        ...
        <div id="tab14">
            ...
            <div align="center" style="margin-top:50px;">
                ...
                echo "<h3>Employer</h3>";
                echo $contract_title;
                if(isset($report_fl_by_employer))
                {
                    echo $report_fl_by_employer->to('HTML');
                    echo "<h3>Pie Chart</h3>";
                    echo $report_fl_by_employer->to('PieChart');
                }
                ?>
            </div>
            </p>
