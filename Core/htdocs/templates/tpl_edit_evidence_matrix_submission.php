...
function reducedProjects(reduced)
{
    if(reduced.checked)
    {
        ...
        if(document.getElementById('input_completion_date').value=="" || document.getElementById('input_completion_date').value=="dd/mm/yyyy")
        {
            document.getElementById('input_completion_date').value = day + "/" + month + "/" + year;
        }
    }
}
</script>
...
<body>
        ...
        <div class="col-lg-12">
            <div class="banner">
                ...
                <div class="ButtonBar">
                    ...
                    <?php } ?>
                    <?php if ($submission_id != '' && ($_SESSION['user']->type==3 or in_array($_SESSION['user']->id, array(12338,13245,21095,22063,22213,23461,26302,26835,28924,29481,31790, 21074, 26302, 26924)))) { ?>
    ...
    <form class="form-horizontal" name="form1" action="do.php?_action=save_evidence_matrix_submission" method="post">
        ...
        <div class="row">
            <div class="col-sm-12">
                <p class="text-center">
                    <span onclick="showHideBlock('matrix')" class="btn btn-primary btn-xs"><i class="fa fa-bars"></i> Show/Hide Evidence Matrix</span>
                </p>
                <div style="display:block; margin-bottom: 5px;" id="matrix" class="table-responsive">
                    <?php
                        ...
                        if($course_id==490)
                        {
                            ...
                            FROM lookup_assessment_plan_log_mode WHERE framework_id = (SELECT framework_id FROM courses WHERE id = $course_id) order by seq;", DAO::FETCH_ASSOC);
                        }
                        else
                        {
                            $competencies = DAO::getResultset($link, "SELECT
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="input_actual_date" class="col-sm-4 control-label fieldLabel_optional">Extension Date:</label>
                            <div class="col-sm-8">
                                <?php
                                echo HTML::datebox('extension_date', $vo->extension_date);
                                ?>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="contract_holder" class="col-sm-4 control-label fieldLabel_optional">Reason for extension:</label>
                            <div class="col-sm-8">
                                <?php echo HTML::selectChosen('extension_reason', $extension_reasons, $vo->extension_reason, true); ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="input_actual_date" class="col-sm-4 control-label fieldLabel_optional">Reduced Projects:</label>
                            <div class="col-sm-8">
                                <?php
                                    if($vo->reduced_projects==1)
                                        echo '<td align=center><input name="reduced_projects" checked type = checkbox onClick="reducedProjects(this)">';
                                    else
                                        echo '<td align=center><input name="reduced_projects" type = checkbox onClick="reducedProjects(this)">';
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="contract_holder" class="col-sm-4 control-label fieldLabel_optional">Word Count:</label>
                            <div class="col-sm-8">
                                <input type="text" name="word_count" value=" <?php echo $vo->word_count; ?>" size=10 onKeyPress='return numbersonly(this, event)'/>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="contract_holder" class="col-sm-4 control-label fieldLabel_optional">Page Count:</label>
                            <div class="col-sm-8">
                                <input type="text" name="page_count" value="<?php echo $vo->page_count; ?>" size=10 onKeyPress='return numbersonly(this, event)'/>
                            </div>
                        </div>
                ...
                <?php if ($vo->id == '') { ?>
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h2 class="box-title">Other learners this plan to be created for</h2>
                        </div>
                        <div class="box-body">
                            <div class="form-group">
                                <div class="col-sm-8">
            ...
            <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <?php if (in_array($_SESSION['user']->username, array("cthomas1","hcoatesa","kpattisona","mthompson16","davmiller","bblackett1","aspence1","dmartindale"))) { ?>
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h2 class="box-title">IQA</h2>
                                </div>
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <?php echo HTML::selectChosen('iqa_rag', $rags, $vo->iqa_rag, true); ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="contract_holder" class="col-sm-4 control-label fieldLabel_optional">RAG:</label>
                                        <div class="col-sm-8">
                                            <?php echo HTML::selectChosen('iqa_rag', $rags, $vo->iqa_rag, true, false, false); ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="description" class="col-sm-4 control-label fieldLabel_optional">Feedback Summary:</label>
                    ...
                    <div class="col-sm-12">
                        <?php if (in_array($_SESSION['user']->username, array("cthomas1","hcoatesa","kpattisona","mthompson16","davmiller","bblackett1","aspence1","dmartindale"))) { ?>
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h2 class="box-title">Summative</h2>
                                </div>
                                <div class="box-body">

                                    <div class="form-group">
                                        <label for="contract_holder" class="col-sm-4 control-label fieldLabel_optional">Summative Status:</label>
                                        <div class="col-sm-8">
                                            <?php echo HTML::selectChosen('summative_status', $summative_statuses, $vo->summative_status, true); ?>
                                        </div>
                                    </div>
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="contract_holder" class="col-sm-4 control-label fieldLabel_optional">Summative Status:</label>
                                        <div class="col-sm-8">
                                            <?php echo HTML::selectChosen('summative_status', $summative_statuses, $vo->summative_status, true, false, false); ?>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function save() {
            ...
            postData = 'save_iqa=1' 
            + '&id=' + <?php echo $vo->id ?>
            + '&iqa_status=' + $('#iqa_status').val()
            + '&acc_rej_date=' + $('#input_acc_rej_date').val()
            + '&iqa_reason=' + $('#iqa_reason').val()
            + '&attempt=' + $('#attempt').val()
            + '&feedback_summary=' + $('#feedback_summary').val();

            var client = ajaxRequest('do.php?_action=save_evidence_matrix_submission', postData);
