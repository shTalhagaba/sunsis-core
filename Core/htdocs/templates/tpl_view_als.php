...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;">ALS Reports</div>
            <div class="ButtonBar">
            </div>
            <div class="ActionIconBar">
                ...
                <span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="exportToExcel('view_ViewALSReports');" title="Export to .csv file"></span>
    ...
    <div class="row">
        <div id="div_filters" style="display: none;">
            <form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" name="frmFilters" class="small">
                <input type="hidden" name="_action" value="view_als" />
                ...
                <div id="filterBox" class="clearfix">
                    ...
                    <fieldset>
                        <div class="field float"><label>Support Required:</label> <?php echo $view->getFilterHTML('filter_support_required'); ?></div>
                    </fieldset>
                    <fieldset>
