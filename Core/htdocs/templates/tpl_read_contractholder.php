...
<script language="JavaScript">
	...
	{
		if(window.confirm("Delete this Contract Holder?"))
		{
...
<div class="banner">
	...
	<div class="ButtonBar">
		...
		&nbsp;
		<button onclick="window.location.replace('do.php?id=<?php echo $vo->id; ?>&_action=edit_contractholder');">Edit</button>
		&nbsp;&nbsp;
...
-->
<h3>System Users</h3>
<span class="button" onclick="window.location.href='do.php?_action=edit_user&organisations_id=<?php echo $vo->id; ?>&route=1&people_type=<?php echo 16; ?>'"> Add contract manager </span>
