...
<div class="banner">
    ...
    <div class="ButtonBar">
        ...
        if(isset($_SESSION['user']) and $_SESSION['user']->type!=User::TYPE_SYSTEM_VIEWER)
            if($form_employer->signature_employer_font=='' || $form_learner->signature_learner_font=='')
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<textarea onblur="checkLength(event,this,3000)" onkeypress="checkLength(event,this,3000)" name="plagiarism" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">' . $form_assessor1->plagiarism . '</textarea>';
        else
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<textarea onblur="checkLength(event,this,3000)" onkeypress="checkLength(event,this,3000)" name="employer_previous_comments" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">'.$form_assessor1->employer_previous_comments.'</textarea>';
        else
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<textarea onblur="checkLength(event,this,3000)" onkeypress="checkLength(event,this,3000)" name="significant_achievement" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">'. $form_assessor1->significant_achievement.'</textarea>';
        else
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<textarea onblur="checkLength(event,this,2000)" onkeypress="checkLength(event,this,2000)" name="equality_diversity" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">'. $form_assessor2->equality_diversity.'</textarea>';
        else
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<textarea name="safeguarding" onblur="checkLength(event,this,2000)" onkeypress="checkLength(event,this,2000)" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">'. $form_assessor2->safeguarding.'</textarea>';
        else
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<textarea name="prevent" onblur="checkLength(event,this,3000)" onkeypress="checkLength(event,this,3000)" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">'. $form_assessor2->prevent.'</textarea>';
        else
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<textarea name="health_wellbeing" onblur="checkLength(event,this,2000)" onkeypress="checkLength(event,this,2000)" style="font-family:sans-serif; font-size:10pt"  rows="15" cols="123">'.$form_assessor3->health_wellbeing.'</textarea>';
        else
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<textarea name="concerns" onblur="checkLength(event,this,3000)" onkeypress="checkLength(event,this,3000)" style="font-family:sans-serif; font-size:10pt"  rows="20" cols="123">'. $form_assessor3->concerns . '</textarea>';
        else
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<textarea name="commitment" onblur="checkLength(event,this,2000)" onkeypress="checkLength(event,this,2000)" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">'. $form_assessor3->commitment.'</textarea>';
        else
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<textarea name="additional_support" onblur="checkLength(event,this,2000)" onkeypress="checkLength(event,this,2000)" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">'.$form_assessor4->additional_support.'</textarea>';
        else
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<textarea name="progress" onblur="checkLength(event,this,2000)" onkeypress="checkLength(event,this,2000)" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">'.$form_assessor4->progress.'</textarea>';
        else
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<textarea name="discussion" onblur="checkLength(event,this,1000)" onkeypress="checkLength(event,this,1000)" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">'. $form_assessor4->discussion.'</textarea>';
        else
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<textarea name="err" onblur="checkLength(event,this,5000)" onkeypress="checkLength(event,this,5000)" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">'.$form_assessor4->err.'</textarea>';
        else
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<textarea name="main_progress" onblur="checkLength(event,this,3000)" onkeypress="checkLength(event,this,3000)" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">'.$form_assessor2->main_progress.'</textarea>';
        else
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<textarea name="tech_progress" onblur="checkLength(event,this,3000)" onkeypress="checkLength(event,this,3000)" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">'.$form_assessor3->tech_progress.'</textarea>';
        else
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<textarea name="knowledge_module" onblur="checkLength(event,this,2000)" onkeypress="checkLength(event,this,2000)" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">'.$form_assessor4->knowledge_module.'</textarea>';
        else
    ...
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<textarea name="workplace_competence" onblur="checkLength(event,this,2000)" onkeypress="checkLength(event,this,2000)" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">'.$form_assessor4->workplace_competence.'</textarea>';
        else
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<textarea name="use_functional" onblur="checkLength(event,this,8000)" onkeypress="checkLength(event,this,8000)" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">'.$form_assessor4->use_functional.'</textarea>';
        else
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<textarea name="functional_progress" onblur="checkLength(event,this,5000)" onkeypress="checkLength(event,this,5000)" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">'.$form_assessor4->functional_progress.'</textarea>';
        else
        ...
        <td colspan=4>
            <table>
                ...
                <tr>
                    <td><i>
                        <?php   if(true)
                        echo '<textarea name="specific" onblur="checkLength(event,this,2000)" onkeypress="checkLength(event,this,2000)" rows="10" cols="26">'.$form_assessor4->specific.'</textarea>';
                    else
                    ...
                    <td><i>
                        <?php   if(true)
                        echo '<textarea name="measurable" onblur="checkLength(event,this,2000)" onkeypress="checkLength(event,this,2000)" rows="10" cols="26">'.$form_assessor4->measurable.'</textarea>';
                    else
                    ...
                    <td><i>
                        <?php   if(true)
                        echo '<textarea name="achievable" onblur="checkLength(event,this,2000)" onkeypress="checkLength(event,this,2000)" rows="10" cols="26">'.$form_assessor4->achievable.'</textarea>';
                    else
                    ...
                    <td><i>
                        <?php   if(true)
                        echo '<textarea name="timebound" onblur="checkLength(event,this,2000)" onkeypress="checkLength(event,this,2000)" rows="10" cols="26">'.$form_assessor4->timebound.'</textarea>';
                    else
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><textarea id="learner_comment" name="learner_comment" onblur="checkLength(event,this,2000)" onkeypress="checkLength(event,this,2000)" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123"><?php echo $form_learner->learner_comment; ?></textarea></td>
    </tr>
    </tbody>
</table>
<br>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><textarea tabindex="-1" id="employer_progress_review" name="employer_progress_review" onblur="checkLength(event,this,5000)" onkeypress="checkLength(event,this,5000)" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123"><?php echo $form_employer->employer_progress_review; ?></textarea></td>
    </tr>
    <tr>
    ...
    <tr>
        <td>
            <table>
                <tr>
                    <td>Behaviours:</td>
                    <td colspan=3><textarea id="behaviours" name="behaviours"  onblur="checkLength(event,this,2000)" onkeypress="checkLength(event,this,2000)" rows="15" cols="100"><?php echo $form_employer->behaviours; ?></textarea></td>
                </tr>
                <tr>
                    <td>Ability:</td>
                    <td colspan=3><textarea id="ability" name="ability" onblur="checkLength(event,this,2000)" onkeypress="checkLength(event,this,2000)" rows="15" cols="100"><?php echo $form_employer->ability; ?></textarea></td>
                </tr>
                <tr>
                    <td>Skills and Knowledge:</td>
                    <td colspan=3><textarea id="skills_knowledge" name="skills_knowledge" onblur="checkLength(event,this,2000)" onkeypress="checkLength(event,this,2000)" rows="15" cols="100"><?php echo $form_employer->skills_knowledge; ?></textarea></td>
                </tr>
                <tr>
                    <td>Achievements/ progress at work:</td>
                    <td colspan=3><textarea id="achievements" name="achievements" onblur="checkLength(event,this,2000)" onkeypress="checkLength(event,this,2000)" rows="15" cols="100"><?php echo $form_employer->achievements; ?></textarea></td>
                </tr>
            </table>
        </td>
    </tr>
