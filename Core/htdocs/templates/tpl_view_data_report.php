...
<div class="row">
	<div class="col-lg-12">
		<div class="banner">
			<div class="Title" style="margin-left: 6px;">View Data Report</div>
			<div class="ButtonBar">
			</div>
			<div class="ActionIconBar">
                ...
                <span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="window.location.href='do.php?_action=view_data_report&subaction=export_csv'" title="Export to .CSV file"></span>
	...
	<div class="row small">
		<div id="div_filters" style="display:none">
			...
			<form autocomplete="off" method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter">
				<input type="hidden" name="_action" value="view_data_report" />
