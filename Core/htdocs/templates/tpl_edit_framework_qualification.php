...
<div id="tab1"><p>
	...
	<form name="form1" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
		...
		<input type="hidden" name="duration_in_months" value="<?php echo htmlspecialchars((string)$vo->duration_in_months); ?>" />
		<!-- <input type="hidden" name="start_date" value="<?php //echo htmlspecialchars((string)$framework_start_date); ?>" />
<input type="hidden" name="end_date" value="<?php //echo htmlspecialchars((string)$framework_end_date); ?>" /> -->
		...
		<table border="0" cellspacing="4" cellpadding="4">
			...
			<tr>
				...
				<td><input class="compulsory" style="font-family:monospace" type="text" name="id" value="<?php echo htmlspecialchars((string)$vo->id); ?>" onchange="id_onchange(this);"/>
