...
function populateFields(xmlDoc)
{
	...
	if(xmlUnits != null)
	{
	    ...
	    tree = new YAHOO.widget.TreeView("treeDiv1");     
        root = tree.getRoot();
	    myobjx = { label: "<div class='Root'>QUALIFICATION: " + <?php echo ('"' . htmlspecialchars((string)$vo->title) . '"') ?> + "</div>" ,title: 'root', type: 'root'};
...
<div class="banner">
	<div class="Title">View Qualification [<?php echo htmlspecialchars((string)$vo->title); ?>] of Framework [<?php echo $framework_title ?>]</div>
	<div class="ButtonBar">
