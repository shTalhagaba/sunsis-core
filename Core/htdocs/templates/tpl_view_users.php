...
<head>
	...
	<title>View <?php echo $people; ?></title>
...
<div class="row">
	<div class="col-lg-12">
		<div class="banner">
			<div class="Title" style="margin-left: 6px;">View <?php echo $people; ?></div>
			<div class="ButtonBar">
			</div>
		...
		<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" name="frmFilters" class="small">
			...
			<div id="filterBox" class="clearfix">
				<fieldset>
					...
					<div class="field float"><label>Organisation:</label><?php echo $view->getFilterHTML('organisation'); ?></div>
					<?php } ?>
				...
				<fieldset>
                    <legend>Dates</legend>
                    <div class="field float"><label>Created between:</label><?php echo $view->getFilterHTML('from_created'); ?> &nbsp;and&nbsp; <?php echo $view->getFilterHTML('to_created'); ?></div>
                </fieldset>
				<fieldset>
