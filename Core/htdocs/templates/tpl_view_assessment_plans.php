...
<head>
    ...
    <title>Assessment Plans Report</title>
...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;">Assessment Plans Report</div>
            <div class="ButtonBar">
            ...
            <form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter">
                ...
                <div id="filterBox" class="clearfix small">
                    <fieldset>
                        ...
                        <div class="field float"><label>Planned/ Unplanned:</label><?php echo $view->getFilterHTML('filter_planned'); ?></div>
                    </fieldset>
                    <fieldset>
                        <legend>Dates:</legend>
