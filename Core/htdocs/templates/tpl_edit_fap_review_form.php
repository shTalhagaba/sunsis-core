...
<body id="candidates">
<div class="banner">
    <div class="Title">Feedback Action Plan</div>
    <div class="ButtonBar">
        <?php if($source==1) { ?>
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Feedback Action Plan</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    <thead>
    <th colspan=4>&nbsp;&nbsp;&nbsp;General Feedback</th>
    </thead>
    <tbody>
    <tr>
        <td colspan=4>This is to include information of what the learner has been doing in the workplace, referencing training received from <?php echo $client; ?>.</td>
    </tr>
    <tr>
...
<table class="table1" style="width: 900px">
    <thead>
    <th colspan=4>&nbsp;&nbsp;&nbsp;Significant Achievement over the past 4 weeks</th>
    </thead>
    <tbody>
    <tr>
...
<table class="table1" style="width: 900px">
    <thead>
    <th colspan=4>&nbsp;&nbsp;&nbsp;Safeguarding, Equality & Diversity and Health & Safety</th>
    </thead>
    <tbody>
    <tr>
...
<table class="table1" style="width: 900px">
    <thead>
    <th colspan=4>&nbsp;&nbsp;&nbsp;Functional Skills: English, Maths and ICT Level 2</th>
    </thead>
    <tbody>
    <tr>
        <td colspan=4>
            <table>
                <tr>
                    ...
                    <td style="text-align: center; width: 70px">English</td><td><input name="english_exempt" type="text" size=13 value="<?php echo $form->english_exempt; ?>"/></td>
                    <td style="text-align: center; width: 70px">Maths</td><td><input name="math_exempt" type="text" size=13 value="<?php echo $form->math_exempt; ?>"/></td>
                    <td style="text-align: center; width: 70px">ICT</td><td><input name="ict_exempt" type="text" size=13 value="<?php echo $form->ict_exempt; ?>"/></td>
                </tr>
            </table>
        </td>
    </tr>
...
<table class="table1" style="width: 900px">
    <thead>
    <th colspan=4>&nbsp;&nbsp;&nbsp;Functional Skills Feedback</th>
    </thead>
    <tbody>
    <tr>
    ...
    <tr>
        <td colspan=4><textarea name="functional_feedback" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123"><?php echo $form->functional_feedback; ?></textarea></td>
    </tr>
    </tbody>
</table>
<br>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><textarea name="learner_log" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123"><?php echo $form->learner_log; ?></textarea></td>
    </tr>
    </tbody>
</table>
<br>
...
<table class="table1" style="width: 900px">
    <thead>
        <th colspan=4>&nbsp;Learner</th>
    </thead>
    <tbody>
    <tr>
        <td>Print Name</td>
        <td style="text-align: center"> <?php echo $training_record->firstnames . ' ' . $training_record->surname; ?> </td>
    </tr>
    </tbody>
</table>
<table class="table1" style="width: 900px">
