...
<script src="/js/ilr2015new.js?n=<?php echo time(); ?>"></script>
...
<?php if(DB_NAME == "am_pera") { ?>
	...
	var client = ajaxRequest('do.php?_action=save_ilr_2015', postData);
	if( client != null )
	{
...
function validation() {
	...
	var postData = 'id=' + document.getElementById('LearnRefNumber').value
		...
		+'&tr_id=' + <?php echo $tr_id;?>;
	$.ajax({
		url: "do.php?_action=validate_ilr2015",
		type: "post",
		async: true,
		data: postData,
		//dataType: "xml",
