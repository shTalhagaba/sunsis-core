...
<title>Ecordia: Training Record Sync</title>
...
<script type="text/javascript">
	...
	function onFilterClick(e) {
		...
		$('div#content').load('do.php?_action=ecordia_tr_sync&subaction=rendercontent' + filters, null, onContentLoad);
	}
	...
	function unlinkRecords(e)
	{
		...
		showProgressAnimation('loading51.gif');
		var client = ajaxRequest('do.php?_action=ecordia_tr_sync&subaction=unlinkrecords' + data);
		if (!client) {
			//
		}
	...
	function linkRecords(e)
	{
		...
		showProgressAnimation('loading51.gif');
		var client = ajaxRequest('do.php?_action=ecordia_tr_sync&subaction=linkrecords' + data);
		if (!client) {
			//
		}
		$('input#btnFilter').click();
...
<body>
<div class="banner">
	<div class="Title">Ecordia: Training Records Synchronisation</div>
	<div class="ButtonBar">
...
<div style="width:1150px;">
	...
	<div class="Newspaper">
		<p class="introduction">To be able to update progress within Sunesis from Ecordia you must first link the learners Training Records.</p>
		<p class="introduction">This page shows you the current linked and unlinked Training Records.</p>
		<p class="introduction">Training record can only be linked if it has same ULN, Start and Planned End Date in both systems. If these three items can be matched then an option will appear beside the Unlinked Training Records giving you the option to link.</p>
		<p class="introduction">After Training Records have been linked you are now able to update progress.</p>
	</div>
