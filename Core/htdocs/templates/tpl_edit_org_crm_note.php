<?php /* @var $crm_note OrganisationCRMNote */ ?>
...
<head>
    ...
    <title><?php echo $crm_note->id == ''?'Create Organisation CRM Note':'Edit Organisation CRM Note'; ?></title>
...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;"><?php echo $crm_note->id == ''?'Create Organisation CRM Note':'Edit Organisation CRM Note'; ?></div>
            <div class="ButtonBar">
                ...
                <?php if($crm_note->id != "" && $_SESSION['user']->isAdmin()) { ?>
                    <span class="btn btn-sm btn-default" onclick="deleteNote();"><i class="fa fa-remove"></i> Delete</span>
                <?php } ?>
            </div>
                ...
                <div class="box-body with-border">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 callout">
                                ...
                                <div class="col-sm-8">
                                    <div class="callout">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control compulsory" type="text" name="contact_name" id="contact_name" value="" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="job_role" class="col-sm-4 control-label fieldLabel_optional">Job Role:</label>
                                            <div class="col-sm-8">
                                                <?php echo HTML::selectChosen('job_role', $ddlJobRoles, '', false); ?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="type_of_contact" class="col-sm-4 control-label fieldLabel_optional">Type of Contact:</label>
                                <div class="col-sm-8">
                                    <?php echo HTML::selectChosen('type_of_contact', $ddlContactTypes, $crm_note->type_of_contact, true, false); ?>
                            ...
                            <div class="form-group">
                                <label for="subject" class="col-sm-4 control-label fieldLabel_optional">Subject:</label>
                                <div class="col-sm-8">
                                    <?php echo HTML::selectChosen('subject', $ddlSubjects, $crm_note->subject, true, false); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 callout">
                            ...
                            <div class="form-group">
                                <label for="by_whom_position" class="col-sm-4 control-label fieldLabel_optional">Position:</label>
                                <div class="col-sm-8">
                                    <input class="form-control " type="text" name="by_whom_position" id="by_whom_position" value="<?php echo $crm_note->by_whom_position == '' ? $_SESSION['user']->job_role:$crm_note->by_whom_position; ?>" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 callout">
                            <div class="form-group">
                                <label for="next_action_id" class="col-sm-4 control-label <?php echo in_array(DB_NAME, ["am_duplex"]) ? 'fieldLabel_optional' : 'fieldLabel_compulsory'; ?>">Next Action:</label>
                                <div class="col-sm-8">
                                    <?php
                                    echo in_array(DB_NAME, ["am_duplex"]) ?
                                        HTML::selectChosen('next_action_id', $ddlNextActions, $crm_note->next_action_id, true, false) :
                                        HTML::selectChosen('next_action_id', $ddlNextActions, $crm_note->next_action_id, true, true); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <?php echo in_array(DB_NAME, ["am_duplex"]) ?
                                        HTML::datebox('next_action_date', $crm_note->next_action_date, false) :
                                        HTML::datebox('next_action_date', $crm_note->next_action_date, true); ?>
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea class="optional" name="agreed_action" id="agreed_action" rows="10" style="width: 100%;"><?php echo htmlspecialchars((string)$crm_note->agreed_action); ?></textarea>
                        </div>
                    </div>
                    <?php
                    if($crm_note->id == '')
...
<script language="JavaScript">
    ...
    function isAlreadyExisted(table, value)
    {
        var client = ajaxRequest('do.php?_action=edit_org_crm_note&subaction=isAlreadyExisted&table='+encodeURIComponent(table)+'&value='+encodeURIComponent(value));
    ...
    function saveNewContactType()
    {
        ...
        if(isAlreadyExisted('lookup_crm_contact_type', $('#txtNewContactType').val().trim()) > 0)
        {
            alert('This value is already in the list.');
            return;
        }
    ...
    function saveNewSubject()
    {
        ...
        if(isAlreadyExisted('lookup_crm_subject', $('#txtNewSubject').val().trim()) > 0)
        {
            alert('This value is already in the list.');
            return;
        }
        ...
        var client = ajaxRequest('do.php?_action=edit_org_crm_note&subaction=new_subject&value='+encodeURIComponent($('#txtNewSubject').val().trim()));
    ...
    function saveNewOrganisationContact()
    {
        ...
        var parameters = 'contact_title='+encodeURIComponent($('#contact_title').val().trim()) +
            ...
            //'&job_role='+encodeURIComponent($('#job_role').val().trim()) +
            ...
            '&org_id='+encodeURIComponent('<?php echo $organisation->id; ?>');
    ...
    function saveNewNextAction()
    {
        ...
        if(isAlreadyExisted('lookup_crm_regarding', $('#txtNewNextAction').val().trim()) > 0)
        {
            alert('This value is already in the list.');
            return;
        }
        ...
        var form = document.forms['frmOrgCRMNote'];
        var next_action_id = form.elements['next_action_id'];
        ajaxPopulateSelect(next_action_id, 'do.php?_action=edit_org_crm_note&subaction=load_next_action');
    }
    ...
    function deleteNote()
    {
        ...
        {
            window.location.replace('do.php?_action=delete_organisation_crm_note&id=<?php echo $crm_note->id; ?>');
        }
    }
