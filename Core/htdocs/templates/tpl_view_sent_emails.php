...
<head>
    ...
    <title>View sent emails to learners</title>
...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;">View sent emails to learners</div>
            <div class="ButtonBar">
            </div>
            <div class="ActionIconBar">
                ...
                <span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="exportToExcel('view_ViewSentEmails')" title="Export to .CSV file"></span>
        ...
        <div class="col-sm-12">
            ...
            <div id="div_filters" style="display:none" class="small">
                ...
                <form name="filters" method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter">
                    <input type="hidden" name="_action" value="view_sent_emails" />
                    ...
                    <div id="filterBox" class="clearfix">
                        ...
                        <fieldset>
                            <legend>Email</legend>
                            <div class="field float"><label>Type:</label><?php echo $view->getFilterHTML('filter_email_type'); ?></div>
                            <div class="field float"><label>Auto Emails:</label><?php echo $view->getFilterHTML('filter_auto_emails'); ?></div>
                        </fieldset>
                        <fieldset>
                            <legend>Options:</legend>
                            <div class="field float"><label>Records per page:</label> <?php echo $view->getFilterHTML(VoltView::KEY_PAGE_SIZE); ?></div>
                            <div class="field float"><label>Sort By:</label> <?php echo $view->getFilterHTML(VoltView::KEY_ORDER_BY); ?></div>
                        </fieldset>
                        <fieldset>
