...
<body>
<div class="banner">
	<div class="Title"><?php echo $people; ?></div>
	<div class="ButtonBar">
	...
	<div class="ActionIconBar">
		...
		<button onclick="exportToExcel('view_ViewAdministrator');" title="Export to .CSV file"><img src="/images/btn-excel.gif" width="16" height="16" style="vertical-align:text-bottom" /></button>
...
<div id="div_filters" style="display:none">
	...
	<form method="get" name="filters" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter">
		<input type="hidden" name="people_type" value="<?php echo 1; ?>" />
		<input type="hidden" name="employer_id" value="<?php echo $emp; ?>" />
		<input type="hidden" name="_action" value="view_administrators" />
