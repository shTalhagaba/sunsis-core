...
<body>
<div class="banner">
	<div class="Title">Select an employer to dettach</div>
	<div class="ButtonBar">
		<button onclick="window.location.href='do.php?_action=view_employers&id=<?php echo $emp_group_id; ?>'"> Cancel </button>
	</div>
...
<?php echo $view->render($link, $emp_group_id); ?>
</div>
