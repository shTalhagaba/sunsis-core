...
<head>
    ...
    <title>Evidence Matrix Submission Report</title>
...
<script>
function ViewEvidenceMatrixSubmissions_filter_programme_onchange(course)
{
    // Lock this element
    course.disabled = true;

    var f = document.forms['filters'];
    var group = f.elements['ViewEvidenceMatrixSubmissions_filter_project'];
    ...
    else
    {
        ...
        var url = 'do.php?_action=ajax_load_project_dropdown&course_id=' + course.value;
...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;">Evidence Matrix Submission Report</div>
            <div class="ButtonBar">
            ...
            <div class="ActionIconBar">
                ...
                <span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="window.location.href='do.php?_action=view_evidence_matrix_submissions&subaction=export_csv'" title="Export to .CSV file"></span>
    ...
    <div class="row">
        <div id="div_filters" style="display:none">
            ...
            <form method="get" name="filters" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter">
                <input type="hidden" name="_action" value="view_evidence_matrix_submissions" />
                ...
                <div id="filterBox" class="clearfix small">
                    <fieldset>
                        ...
                        <div class="field float"><label>Assessor signed off:</label><?php echo $view->getFilterHTML('filter_signed_off'); ?></div>
                        <div class="field float"><label>Submission No.:</label><?php echo $view->getFilterHTML('filter_submission_count'); ?></div>
                        <div class="field float"><label>Manager:</label><?php echo $view->getFilterHTML('filter_manager'); ?></div>
                    </fieldset>
                    <fieldset>
                        <legend>IQA</legend>
                        <div class="field float"><label>Reduced Sample:</label><?php echo $view->getFilterHTML('filter_reduced_sample'); ?></div>
                        <div class="field float"><label>Programme:</label><?php echo $view->getFilterHTML('filter_programme'); ?></div>
                        <div class="field float"><label>Project:</label><?php echo $view->getFilterHTML('filter_project'); ?></div>
                    </fieldset>
