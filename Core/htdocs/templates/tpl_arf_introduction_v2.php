...
<title>Welcome Review Form</title>
...
<body id="candidates">
<div class="banner">
    <div class="Title">Welcome Review Form</div>
    <div class="ButtonBar">
...
<table style="width: 900px">
    <tr>
        <td>
            <table class="table1">
                <thead>
                <th style="width: 800px">&nbsp;&nbsp;&nbsp;Welcome Review Form</th>
                </thead>
            </table>
        </td>
        <td>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        ...
        <td>
            <?php   if($source==1)
            echo HTML::datebox("review_date", $form_arf->review_date, false, false);
        else
...
<table class="table1" style="width: 900px">
    ...
    <tbody>
    <tr>
        <td colspan=4>Does the learner have any concerns or wish to raise any Safeguarding, Equality & Diversity, Health & Safety or Health & Wellbeing issues?</td>
    </tr>
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
...
<table class="table1" style="width: 900px">
    ...
    <tbody>
    <tr>
        <td colspan=4>Is there anything the learner would like to disclose which could prevent them from completing the 12-15 month Apprenticeship?</td>
    </tr>
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<textarea name="apprenticeship_commitment" onblur="checkLength(event,this,2000)" onkeypress="checkLength(event,this,2000)" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">'.$form_arf->apprenticeship_commitment.'</textarea>';
        else
            echo $form_arf->apprenticeship_commitment;
            ?>
        </i></td>
    </tr>
    </tbody>
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><i>
            <?php   if($source==1)
            echo '<textarea name="learner_comment" onblur="checkLength(event,this,2000)" onkeypress="checkLength(event,this,2000)" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">'.$form_arf->learner_comment.'</textarea>';
        else
...
<table class="table1" style="width: 900px">
    <thead>
    <th colspan=8>Next Review Session</th>
    </thead>
    <tbody>
    <tr>
    ...
    <tr>
        <td colspan=4>&nbsp;&nbsp;&nbsp;Adobe Link:</td>
        <td style="text-align: center">
            <?php   if($source==1)
            echo '<input type="text" name="adobe" value="' . $form_arf->adobe . '" size=60/>';
        else
            echo $form_arf->adobe;
            ?>
        </td>
...
<table class="table1" style="width: 900px">
    <thead>
    <th colspan=4>&nbsp;&nbsp;&nbsp;Smart Assessor</th>
    </thead>
    <tbody>
    <tr>
        <td colspan=4>Provide Smart Assessor link and learner login details</td>
    </tr>
    <tr>
        <td colspan=4><i>
            <?php   /*if($source==1)
...
<table class="table1" style="width: 900px">
    ...
    <tr>
        <td colspan=4><i>
            <?php   /*if($source==1)
            echo '<textarea name="otj" onblur="checkLength(event,this,1000)" onkeypress="checkLength(event,this,1000)" style="font-family:sans-serif; font-size:10pt"  rows="10" cols="123">'. $form_arf->otj.'</textarea>';
        else
            echo $form_arf->otj;*/
?>
        </i></td>
