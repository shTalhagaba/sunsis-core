...
<script language="JavaScript">
	function deleteRecord()
	{
		...
		{
			window.location.replace('do.php?_action=delete_subcontractor&id=<?php echo $vo->id; ?>');
		}
	}
...
<div class="banner">
	...
	<div class="ButtonBar">
		<button onclick="window.location.href='do.php?_action=view_contractholders';">Close</button>
		<button onclick="window.location.replace('do.php?id=<?php echo $vo->id; ?>&_action=edit_subcontractor');">Edit</button>
		<?php if($isSafeToDelete){ ?>
...
<h3>Locations</h3>
<span class="button" style="margin-bottom: 15px;" onclick="window.location.href='do.php?_action=edit_location&organisations_id=<?php echo $vo->id; ?>&back=<?php echo "subcontractor"; ?>'"> Add new location </span>
<?php $locations->render($link,'read_subcontractor'); ?>
...
<h3>System Users</h3>
<!-- <span class="button" onclick="window.location.href='do.php?_action=edit_user&organisations_id=<?php echo $vo->id; ?>&route=1'"> Add new employee </span> -->
