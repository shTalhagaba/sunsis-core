            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input class="form-control compulsory" type="text" name="title" value="<?php echo htmlspecialchars((string)$c_vo->title); ?>" />
                        </div>
                    </div>
                    <?php if(DB_NAME=='am_baltic' or DB_NAME=='am_baltic_demo') { ?>
                    <div class="form-group">
                            <label for="text" class="col-sm-4 control-label fieldLabel_optional">Apprenticeship Title:</label>
                            <div class="col-sm-8">
                                <?php echo HTML::selectChosen('apprenticeship_title', $apprenticeship_titles, $c_vo->apprenticeship_title, true, false); ?>
                            </div>
                    </div>
                    <div class="form-group">
                        <label for="text" class="col-sm-4 control-label fieldLabel_optional">Routways:</label>
                        <div class="col-sm-8">
                            <?php echo HTML::selectChosen('routway', $routways, $c_vo->routway, true, false); ?>
                        </div>
                    </div>
                    <?php } ?>
                    <div class="form-group">
                        <label for="framework_id" class="col-sm-4 control-label fieldLabel_compulsory" style="cursor:help" title="A group of frameworks with distinctive structural characteristics.">Framework/Standard:</label>
                        <div class="col-sm-8">
                            <?php
                            if($hasLearners)
                            {
                            ...
                            else
                            {
                                ...
                                echo '<span class="text-muted small"><i class="fa fa-info-circle"></i> List of active frameworks/standards</span>';
                            }
                            ?>
                    ...
                    <div class="form-group">
                        <label for="programme_type" class="col-sm-4 control-label fieldLabel_compulsory">Programme Type:</label>
                        <div class="col-sm-8">
                            <?php echo HTML::selectChosen('programme_type', $programme_type, $c_vo->programme_type, true, true); ?>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="callout">
                                ...
                                <?php } ?>
                                <?php if(SystemConfig::getEntityValue($link, 'tab_glh')){?>
                                <div class="form-group">
                                    <label for="glh" class="col-sm-4 control-label fieldLabel_optional">Guided Learning Hours:</label>
                                    <div class="col-sm-8">
                                        <input class="form-control optional" type="text" id="glh" name="glh" value="<?php echo $c_vo->glh; ?>" maxlength="4" onkeypress="return numbersonly();" />
                                    </div>
                                </div>
                                <?php } ?>
                                <div class="form-group">
                                    <label for="course_capacity" class="col-sm-4 control-label fieldLabel_optional">Capacity:</label>
                                    <div class="col-sm-8">
                                        <input class="form-control optional" type="text" id="course_capacity" name="course_capacity" value="<?php echo $c_vo->course_capacity; ?>" maxlength="4" onkeypress="return numbersonly();" />
                                    </div>
                                </div>
				<?php if(in_array(DB_NAME, ["am_demo"])){ ?>                                    
                                <div class="form-group">
                                    <label for="course_price" class="col-sm-4 control-label fieldLabel_optional">Price:</label>
                                    <div class="col-sm-8">
                                        <input class="form-control optional" type="text" id="course_price" name="course_price" value="<?php echo $c_vo->course_price; ?>" maxlength="5" onkeypress="return numbersonly();" />
                                    </div>
                                </div>                                    
                                <?php } ?>                                    
                            </div>
