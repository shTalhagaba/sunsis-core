...
function save()
{
	...
	// Ajax request
//	var postData = 'submission=' + 	submission
//		+ '&xml=' + xml;

//	var request = ajaxRequest('do.php?_action=generate_batch_file',postData);
...
<input type="hidden" name="_action" value="migrate_ilrs" />
<input type="hidden" name="xml" value="" />
<input type="hidden" name="sync" value="<?php echo $sync; ?>" />
