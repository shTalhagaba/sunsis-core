...
<head>
    ...
    <script src="/js/ilr2019.js?n=<?php echo time(); ?>"></script>
</head>
...
<div class="banner">
    <table border="0" cellspacing="0" cellpadding="0" height="100%" width="100%">
        <tr class="head">
            <td valign="bottom">
                <?php if ($template != 1) { ?>
                <?php echo $vo->GivenNames . ' ' . $vo->FamilyName; ?> 2019/20 ILR
                <?php } else { ?>
                ILR Template
                <?php }  ?>
            </td>
        ...
        <tr>
            <td valign="top" align="left" class="left">
                <div class="button_wrap">
                    ...
                    <?php if ($_SESSION['user']->isAdmin() || ($_SESSION['user']->type == User::TYPE_MANAGER && DB_NAME != 'am_reed_demo' && DB_NAME != "am_reed") and (false) ) { ?>
...
<form  name="pdf" id="pdf" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
    <input type="hidden" name="_action" value="<?php echo in_array(DB_NAME, ["am_demo"]) ? 'export_ilr_to_pdf' : (SOURCE_BLYTHE_VALLEY ? 'export_ilr_to_pdf' : 'pdf_from_ilr2019'); ?>" />
