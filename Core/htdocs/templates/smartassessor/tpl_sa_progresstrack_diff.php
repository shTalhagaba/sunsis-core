...
<head>
	...
	<title>Smart Assessor: Progress Track Comparison</title>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('div#content').load('do.php?_action=sa_progresstrack_diff&subaction=rendercontent', null, onContentLoad);
		});
...
<body>
<div class="banner">
	<div class="Title">Smart Assessor: Progress Track Comparison</div>
	<div class="ButtonBar">
...
<div style="width:800px;margin-left:auto;margin-right:auto;">
	...
	<div class="Newspaper">
		<p class="introduction">This report details the differences (if any) in progress track records linked between
