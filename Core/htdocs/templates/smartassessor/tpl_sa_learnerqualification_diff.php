...
<head>
	...
	<title>Smart Assessor: Learner Qualification Comparison</title>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('div#content').load('do.php?_action=sa_learnerqualification_diff&subaction=rendercontent', null, onContentLoad);
		});
...
<body>
<div class="banner">
	<div class="Title">Smart Assessor: Learner Qualification Comparison</div>
	<div class="ButtonBar">
...
<div style="width:800px;margin-left:auto;margin-right:auto;">
	...
	<div class="Newspaper">
		<p class="introduction">This report details the differences (if any) in learner qualification records linked between
