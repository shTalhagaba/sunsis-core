...
//	+ '&submission_date=' + ''
	...
	var client = ajaxRequest('do.php?_action=migrate_single2010', postData);
...
function toXML()
{
	...
	xml += "<A19>" + "0" + "</A19>";
	xml += "<A20>" + "0" + "</A20>";
	xml += "<A21>" + document.ilr.A21.options[document.ilr.A21.selectedIndex].value + "</A21>";
...
//		return true;
	...
	if(client != null)
	{
		...
		if(tags.length > 0)
		{
			...
			if(submission=='W13')
			{
				var client = ajaxRequest('do.php?_action=is_exist_in_2010', postData);
				response = client.responseText;
				
				if(response=='ILRFound')
				{
					alert("You need to update 2010/11 ILR too");
				}
				else if(response=='NeedToMigrate')
				{
					answer = confirm("Do you want to migrate this learner to 2010/11 ILR's?");
					if(answer)
					{
...
//		+ '&submission_date=' + document.ilr.AA.value
	...
	var client = ajaxRequest('do.php?_action=validate_ilr2009', postData);
	if(client != null)
	{
...
{
	<?php if(in_array($submission,$max_submission)) { ?>			
...
<div class="banner">
	<div class="Title">
		<?php if($template!=1) { ?>
			Individual Learner Record 2009/10
		<?php } else { ?>
			ILR Template
		<?php }  ?>
	</div>
	<div class="ButtonBar">
		...
		<?php if(DB_NAME=='am_imi' || DB_NAME=='am_demo' || DB_NAME=='am_baltic' || DB_NAME=='am_exg' || DB_NAME=='ams' || DB_NAME=='am_fareham' || DB_NAME=='am_learningworld' || DB_NAME=='am_peopleserve' || DB_NAME=='am_superdrug'  || DB_NAME=='am_accenture' || DB_NAME == 'am_midkent' || DB_NAME == 'am_portsmouth') { ?>
...
<table border="0" cellspacing="4" cellpadding="4">
	...
	<tr>
		...
		<?php echo HTML::select('L36', $L36_dropdown, $vo->learnerinformation->L36, false, false, false); ?></td>
		</tr>
		<tr>
		...
		<?php echo HTML::select('PA02', $A02_dropdown, $vo->programmeaim->A02, true, true); ?></td>
		...
		<?php 
			if(trim($vo->programmeaim->A23)==trim($previous_vo->programmeaim->A23)) 
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->programmeaim->A23 . "' style='' id='PA23' name='PA23' maxlength=8 size=8></td>";
			else
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->programmeaim->A23 . "' style='background-color: yellow' id='PA23' name='PA23' maxlength=8 size=8></td>";
		?>
        ...
        <tr>
		<td class="fieldLabel_compulsory"> A64 Planned group-based hours <br>
		<?php 
			if(trim($vo->programmeaim->A64)==trim($previous_vo->programmeaim->A64)) 
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->programmeaim->A64 . "' style='' id='PA64' name='PA64' maxlength=5 size=2 onKeyPress='return numbersonly(this, event)'></td>";
			else
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->programmeaim->A64 . "' style='background-color: yellow' id='PA64' name='PA64' maxlength=2 size=2 onKeyPress='return numbersonly(this, event)'></td>";
		?>
		</td>
		<td class="fieldLabel_compulsory"> A65 Planned one-to-one contact hours <br>
		<?php 
			if(trim($vo->programmeaim->A65)==trim($previous_vo->programmeaim->A65)) 
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->programmeaim->A65 . "' style='' id='PA65' name='PA65' maxlength=5 size=2 onKeyPress='return numbersonly(this, event)'></td>";
			else
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->programmeaim->A65 . "' style='background-color: yellow' id='PA65' name='PA65' maxlength=2 size=2 onKeyPress='return numbersonly(this, event)'></td>";
		?>
		</td>
		</tr>
		<tr>
		...
		<?php 
			if(trim($vo->programmeaim->A51a)==trim($previous_vo->programmeaim->A51a)) 
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->programmeaim->A51a . "' style='' id='PA51a' name='PA51a' maxlength=3 size=3 onKeyPress='return numbersonly(this, event)'></td>";
			else
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->programmeaim->A51a . "' style='background-color: yellow' id='PA51a' name='PA51a' maxlength=3 size=3 onKeyPress='return numbersonly(this, event)'></td>";
		?>
        </tr>
        <tr>
		...
		if($vo->programmeaim->A40!='00000000' && $vo->programmeaim->A40!='' && $vo->programmeaim->A40!='00/00/0000') 
			echo HTML::datebox('PA40', $vo->programmeaim->A40,'',$disabled2);
		else
			echo HTML::datebox('PA40', '','',$disabled2);
		?></td>
		...
		<?php echo HTML::select('PA34', $A34_dropdown, $vo->programmeaim->A34, false, true, $disabled2); ?></td>
		<td class="fieldLabel_compulsory"> A35 Learning Outcome <br>
		<?php echo HTML::select('PA35', $A35_dropdown, $vo->programmeaim->A35, true, true, $disabled2); ?></td>
		</tr>
        <tr>
        ...
        <tr>  
		<td class="fieldLabel_compulsory"> A02 Contract Type <br>
		<?php echo HTML::select('A02', $A02_dropdown, $vo->aims[0]->A02, true, true); ?></td>
		...
		<?php 
			if(trim($vo->aims[0]->A03)==trim($previous_vo->aims[0]->A03)) 
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->aims[0]->A03 . "' style='' id='A03' name='A03' maxlength=12 size=12></td>";
			else
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->aims[0]->A03 . "' style='background-color: yellow' id='A03' name='A03' maxlength=12 size=12></td>";
		?>
		...
		<?php 
			...
			if($vo->aims[0]->A55=='')
				$vo->aims[0]->A55 = '9999999999';		
			if(trim($vo->aims[0]->A55)==trim($previous_vo->aims[0]->A55)) 
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->aims[0]->A55 . "' style='' id='A55' name='A55' maxlength=10 size=10></td>";
			else
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->aims[0]->A55 . "' style='background-color: yellow' id='A55' name='A55' maxlength=10 size=10></td>";
		?>
		...
		<?php 
			if(trim($vo->aims[0]->A09)==trim($previous_vo->aims[0]->A09)) 
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->aims[0]->A09 . "' style='' id='A09' name='A09' maxlength=8 size=8></td>";
			else
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->aims[0]->A09 . "' style='background-color: yellow' id='A09' name='A09' maxlength=8 size=8></td>";
		?>
		...
		<?php 
			if(trim($vo->aims[0]->A23)==trim($previous_vo->aims[0]->A23)) 
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->aims[0]->A23 . "' style='' id='A23' name='A23' maxlength=8 size=8></td>";
			else
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->aims[0]->A23 . "' style='background-color: yellow' id='A23' name='A23' maxlength=8 size=8></td>";
		?>
		<td class="fieldLabel_compulsory"> A51a Proportion of Funding <br>
		<?php 
			if(trim($vo->aims[0]->A51a)==trim($previous_vo->aims[0]->A51a)) 
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->aims[0]->A51a . "' style='' id='A51a' name='A51a' maxlength=3 size=3 onKeyPress='return numbersonly(this, event)'></td>";
			else
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->aims[0]->A51a . "' style='background-color: yellow' id='A51a' name='A51a' maxlength=3 size=3 onKeyPress='return numbersonly(this, event)'></td>";
		?>
		</tr>
		<tr>
		<td class="fieldLabel_optional"> A14 Reason for Full/ Co Funding<br>
		...
		<?php 
			if(trim($vo->aims[0]->A44)==trim($previous_vo->aims[0]->A44)) 
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->aims[0]->A44 . "' style='' id='A44' name='A44' maxlength=30 size=30></td>";
			else
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->aims[0]->A44 . "' style='background-color: yellow' id='A44' name='A44' maxlength=30 size=30></td>";
		?>
		</tr>
		<tr>
		...
		<?php 
			if(trim($vo->aims[0]->A45)==trim($previous_vo->aims[0]->A45)) 
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->aims[0]->A45 . "' style='background-color: white' id='A45' name='A45' maxlength=8 size=8></td>";
			else
				echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->aims[0]->A45 . "' style='background-color: yellow' id='A45' name='A45' maxlength=8 size=8></td>";
		?>	
		...
		<tr>
		<td class="fieldLabel_optional"> A21 Franchised out and partnership arrangement <br>
		<?php echo HTML::select('A21', $A21_dropdown, $vo->aims[0]->A21, true, false); ?></td>
		...
		<?php echo HTML::select('A66', $E12_dropdown, $vo->aims[0]->A66, true, true); ?></td>
		<td class="fieldLabel_compulsory"> A67 Length of unemployment before starting ESF Project <br>
		<?php echo HTML::select('A67', $E14_dropdown, $vo->aims[0]->A67, true, true); ?></td>
		</tr>
        <tr>
		...
		if($vo->aims[0]->A31!='00000000' && $vo->aims[0]->A31!='dd/mm/yyyy' && $vo->aims[0]->A31!='00/00/0000')
			echo HTML::datebox('A31', $vo->aims[0]->A31,'',$disabled2);
		else
			echo HTML::datebox('A31', '','',$disabled2);
		?></td>
		<td class="fieldLabel_compulsory"> A40 Achievement Date <br>
		<?php 
		if($vo->aims[0]->A40!='00000000' && $vo->aims[0]->A40!='' && $vo->aims[0]->A40!='00/00/0000') 
			echo HTML::datebox('A40', $vo->aims[0]->A40,'',$disabled2);
		else
			echo HTML::datebox('A40', '','',$disabled2);
		?></td>
		</tr>	
		<tr>
...
-->
			...
			echo "</script>";
		            			    ...
		            			    <tr>
										...
										<?php 
											...
											//else
												echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->aims[$a]->A23 . "' style='background-color: yellow' id='SA23' name='SA23' maxlength=8 size=8></td>";
										?>
										</td>
											<td class="fieldLabel_compulsory"> A51a Proportion of Funding <br>
											<?php 
												//if(trim($vo->aims[$a]->A51a)==trim($previous_vo->aims[$a]->A51a)) 
												//	echo "<input class='compulsory' type='text' value='" . $vo->aims[$a]->A51a . "' style='' id='SA51a' name='SA51a' maxlength=3 size=3 onKeyPress='return numbersonly(this, event)'></td>";
												//else
													echo "<input $disabled1 class='compulsory' type='text' value='" . $vo->aims[$a]->A51a . "' style='background-color: yellow' id='SA51a' name='SA51a' maxlength=3 size=3 onKeyPress='return numbersonly(this, event)'></td>";
											?>
									...
									<tr>
									<td class="fieldLabel_optional"> A21 Franchised out and partnership arrangement <br>
									<?php echo HTML::select('SA21', $A21_dropdown, $vo->aims[$a]->A21, true, false); ?></td>
									...
									<tr>
									<td class="fieldLabel_compulsory"> A66 Employment Status on day before starting learning aim <br>
									<?php echo HTML::select('SA66', $E12_dropdown, $vo->aims[$a]->A66, true, true); ?></td>
									<td class="fieldLabel_compulsory"> A67 Length of unemployment before starting ESF Project <br>
									<?php echo HTML::select('SA67', $E14_dropdown, $vo->aims[$a]->A67, true, true); ?></td>
									</tr>
									<tr>
									<td class="fieldLabel_optional"> A31 Learning Actual End Date <br>
									<?php 
									if($vo->aims[$a]->A31!='00000000' && $vo->aims[$a]->A31!='00/00/0000' && $vo->aims[$a]->A31!='dd/mm/yyyy')
										echo HTML::datebox('SA31', $vo->aims[$a]->A31,'',$disabled2);
									else
										echo HTML::datebox('SA31', null,'',$disabled2);
									?></td>
			                        ...
			                        <tr>
											...
											if($vo->aims[$a]->A40!='00000000' && $vo->aims[$a]->A40!='00/00/0000' && $vo->aims[$a]->A40!='dd/mm/yyyy')
												echo HTML::datebox('SA40', $vo->aims[$a]->A40,'',$disabled2);
											else
												echo HTML::datebox('SA40', null,'',$disabled2); 
											?></td>
											<td class="fieldLabel_compulsory"> A34 Completion Status <br>
		...
		?>
	   				...
	   				<table>
			                        <tr cellpadding="5" borders="all">           
			                               <td border=1 colspan=4 bgcolor="darkseagreen" align="Center"> <b> <font size=3> Individual Learner Record - Part 4 - Subsidiary Aim Information - Required for all types of apprenticeships programmes</font> </b> 
			                            <!--     <button id='butt' onClick='addAim(this);'> + </button> -->
			                            <button id='butt' onClick='deleteAim(this);'> X </button> </td>
			                        </tr>
			                        <tr>
									...
									<tr>
											<td class="fieldLabel_optional"> A21 Franchised out and partnership arrangement <br>
											<?php echo HTML::select('SA21', $A21_dropdown, null, true, true); ?></td>
											<td class="fieldLabel_optional"> A22 Franchise and partnership delivery provider number <br>
									...
									<tr>
										<td class="fieldLabel_compulsory"> A66 Employment Status on day before starting learning aim <br>
										<?php echo HTML::select('SA66', $E12_dropdown, null, true, true); ?></td>
										<td class="fieldLabel_compulsory"> A67 Length of unemployment before starting ESF Project <br>
										<?php echo HTML::select('SA67', $E14_dropdown, null, true, true); ?></td>
									</tr>
									<tr>
											<td class="fieldLabel_optional"> A31 Learning Actual End Date <br>
...
<input type="hidden" name="_action" value="pdf_from_ilr2009" />
