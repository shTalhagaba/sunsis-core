<div id="header" style="margin-top: 5px; border-top: 12px solid rgb(69,69,69);" width="100%" ></div>
<center>
<div style="margin-top: 20px; ">

<span><h2>Thatcham automotive academy</h2> </span>
...
<img style="border: solid 2px rgb(69,69,69)" src='/images/thatcham2.jpg' />
</div>
</center>
...
<div id="main" style='margin-top: 5px; display: block; margin-left: auto; margin-right: auto; width: 960px;'>
	...
	<center>
		...
		<tr>
			<td>Username:</td>
			<td><input style="border: 1px solid rgb(69,69,69)" id="txtUsername" type="text" name="username" value="" /></td>
		</tr>
		<tr>
			<td>Password:</td>
			<td><input style="border: 1px solidrgb(69,69,69)"  type="password" name="password" value="" /></td>
		</tr>
		<tr>
			<td></td>
