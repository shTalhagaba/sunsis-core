...
<div class="row">
	<div class="col-lg-12">
		<div class="banner">
			<div class="Title" style="margin-left: 6px;">Training Records Search</div>
			<div class="ButtonBar">
			</div>
...
<div class="container-fluid">
	<div class="row">
		...
		<form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" name="frmFilters">
			<input type="hidden" name="_action" value="view_all_training_records" />

			<div id="filterBox" class="clearfix">
				<fieldset>
					<legend>Organisation:</legend>
					<div class="field float"><label>Employer:</label><?php echo $view->getFilterHTML('organisation'); ?></div>
					<div class="field float"><label>Employer Sector:</label><?php echo $view->getFilterHTML('filter_sector'); ?></div>
					<div class="field float"><label>Training Provider:</label><?php echo $view->getFilterHTML('provider'); ?></div>
				</fieldset>
				<fieldset>
					...
					<div class="field float"><label>Enrolment No.:</label><?php echo $view->getFilterHTML('filter_member'); ?></div>
					...
					<div class="field float"><label>Date of Birth:</label><?php echo $view->getFilterHTML('filter_dob'); ?></div>
				</fieldset>
				<fieldset>
...
<script language="JavaScript">
	...
	$(function(){
		$('#tblAllTrainingRecords').DataTable({
			"paging": false,
			"lengthChange": false,
			"searching": true,
			"ordering": true,
