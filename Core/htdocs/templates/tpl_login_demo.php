...
<span><h2>Perspective Ltd ( Sunesis Demo )</h2> </span>
...
<img src='/images/SUNlogo.jpg' style="box-shadow:2px 3px 6px #ccc;" />
</div>
</center>
...
<div id="main" style='margin-top: 5px; display: block; margin-left: auto; margin-right: auto; width: 960px;'>
	...
	<center>
		...
		<tr>
			<td>Username:</td>
			<td><input style="border: 1px solid rgb(120,163,47)" id="txtUsername" type="text" name="username" value="" /></td>
		</tr>
		<tr>
			<td>Password:</td>
			<td><input style="border: 1px solid rgb(120,163,47)"  type="password" name="password" value="" /></td>
		</tr>
		<tr>
			<td></td>
