...
function downloadArchive(username)
{
    window.location.href="do.php?_action=download_archive&mode=1&username=" + encodeURIComponent(username);
}

function deleteFile(username)
{
    window.location.href="do.php?_action=delete_archive&mode=1&username=" + encodeURIComponent(username);
}
...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;">View Learners for archive</div>
            <div class="ButtonBar">
    ...
    <div class="row">
        <div id="div_filters" style="display:none">
            ...
            <form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter">
                <input type="hidden" name="_action" value="view_archive" />
                ...
                <div id="filterBox" class="clearfix small">
                    ...
                    <fieldset>
                        ...
                        <div class="field float"><label>Start date between</label><?php echo $view->getFilterHTML('actual_start_date'); ?>&nbsp;and <?php echo $view->getFilterHTML('actual_end_date'); ?></div>
                        <div class="field float"><label>End date between</label><?php echo $view->getFilterHTML('end_date_from'); ?>&nbsp;and <?php echo $view->getFilterHTML('end_date_to'); ?></div>
                        <!--<div class="field newrow"></div>
