...
//	this.form.fc.checked = false;
			...
			for(y=1; y<=months; y++)
			{
				...
				c.align = 'center';
				//c.style = 'FieldValue';
				c.innerHTML = "<input style='text-align:center' type='text' size='2' onKeyPress='return numbersonly(this, event)' name = 'unit_reference" + unitReferences[unitCount-1].owner_reference+y + "'>";
...
function check50094579(reference, owner_reference)
{
	...
	var arr = [{
		key: "H6013305", value: "004"
	}, {
		key: "K6013323", value: "007"
	},{
		key: "J6013491", value: "009"
	},{
		key: "H6013496", value: "011"
	},{
		key: "F6015465", value: "001"
	},{
		key: "R6015471", value: "003"
	},{
		key: "L6015470", value: "002"
	},{
		key: "Y6013236", value: "006"
	},{
		key: "M6013498", value: "012"
	},{
		key: "D6017403", value: "014"
	},{
		key: "T6017407", value: "010"
	},{
		key: "H6013336", value: "021"
	},{
		key: "H6011697", value: "028"
	},{
		key: "A6016517", value: "019"
	}];

	for(var i = 0, len = arr.length; i < len; i++) {
		if( arr[ i ].key === reference && arr[ i ].value === owner_reference)
			return true;
	}
	return false;
...
function showTreeRecurse(xmlUnits, parent)
{
	...
	*/
				...
				var is50094579 = false;
			<?php if(str_replace('/','',$vo->id)=="50094579") {?>
				is50094579 = true;
				<?php } ?>
				if(check50094579(xmlUnits.childNodes[i].getAttribute('reference'), xmlUnits.childNodes[i].getAttribute('owner_reference')) && is50094579 )
				{
					myobj2new = { label: "<div id='" + divCount + "' class='Unit'><table><tr><td width='99%'><b>UNITsssss: </b> "+ xmlUnits.childNodes[i].getAttribute('title') + " [" + xmlUnits.childNodes[i].getAttribute('proportion') + "]" + "</td><td align='right' width='1%'><div align='right'>" + "(" + unitPercentage + "%)" + "</div></td></tr></table></div>" + marker, type: 'unit',
...
<div class="banner">
	<div class="Title">Qualification New Screen for Crackerjack</div>
	<div class="ButtonBar">
...
<div id="unitDialog">
	...
	<form>
		<table border="0" cellspacing="4" cellpadding="4" style="margin-left:10px">
			...
			<tr>
				<td class="fieldLabel_optional">Title</td>
				<td><input class="optional" type="text" name="unitTitle" size="60" /></td>
			</tr>
			<tr>
			<tr>
