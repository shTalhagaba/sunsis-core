...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-primary">
            <div class="panel-heading"><b><?php if(DB_NAME=='am_siemens' or DB_NAME=='am_siemens_demo') echo "QAR by Apprenticeship Coordinator"; else echo "QAR by Region"; ?></b></div>
...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-primary">
            <div class="panel-heading"><b><?php if(DB_NAME=='am_siemens' or DB_NAME=='am_siemens_demo') echo "QAR by Apprenticeship Coordinator (Apprenticeships)"; else echo "QAR by Region (Apprenticeships)"; ?></b></div>
...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-primary">
            <div class="panel-heading"><b><?php if(DB_NAME=='am_siemens' or DB_NAME=='am_siemens_demo') echo "QAR by Apprenticeship Coordinator (Education & Training)"; else echo "QAR by Region (Education & Training)"; ?></b></div>
...
<?php if($tab=='summary') { ?>
    ...
    <?php if($qar_type_filter=='Overall') { ?>
        ...
        $.ajax({
            url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&panel=getOverallSummary&tab=summary',
            type:"GET",
            async:true,
        ...
        $.ajax({
            url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&panel=getLineChartOverallTrend&tab=summary',
            type:"GET",
            async:true,
            beforeSend:function (data) {
        ...
        $.ajax({
            url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&panel=getRetentionSummary&tab=summary',
            type:"GET",
            async:true,
            beforeSend:function (data) {
    ...
    <?php if($qar_type_filter=='Timely') { ?>
        ...
        $.ajax({
            url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&panel=getTimelySummary&tab=summary',
            type:"GET",
            async:true,
            beforeSend:function (data) {
        ...
        $.ajax({
            url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&panel=getLineChartTimelyTrend&tab=summary',
            type:"GET",
            async:true,
            beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByGenderTable&tab=demographics',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByAgeBandTable&tab=demographics',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByLLDDTable&tab=demographics',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByEthnicityTable&tab=demographics',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerBySSATable&tab=ssa',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerBySSAChartApp&tab=ssa',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerBySSAChartEducation&tab=ssa',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByFrameworkTable&tab=framework',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByFrameworkChartApp&tab=framework',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByAssessorTable&tab=assessor',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByAssessorApp&tab=assessor',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByAssessorEducation&tab=assessor',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByLevelTable&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByLevelApp&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=LearnerByLevelEducation&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=RetentionByLevelTable&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=leaversbytrend&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=leaversbytrendactual&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=leaversbytrendonprogramme&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=leavers&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=leaversbyreason&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=leaversbyimpact&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
    ...
    $.ajax({
        url:'do.php?_action=qar_esfa_data&age_band=' + $('#age_band_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&panel=leaversbyactual&tab=level',
        type:"GET",
        async:true,
        beforeSend:function (data) {
...
function age_band_filter_onchange(ele) {
    window.location.href = 'do.php?_action=qar_esfa_data&age_band=' + encodeURIComponent(ele.value) + '&level=' + $('#level_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&qar_type=' + $('#qar_type_filter').val() + '&tab=' + tab;
}

function click_tab(ele) {
    window.location.href = 'do.php?_action=qar_esfa_data&age_band=' + encodeURIComponent($('#age_band_filter').val()) + '&level=' + $('#level_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&qar_type=' + $('#qar_type_filter').val() +  '&tab=' + ele;
}

function qar_type_filter_onchange(ele) {
    window.location.href = 'do.php?_action=qar_esfa_data&qar_type=' + encodeURIComponent(ele.value) + '&level=' + $('#level_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&age_band_type=' + $('#age_band_filter').val() + '&tab=' + tab;
}

function best_case_filter_onchange(ele) {
    window.location.href = 'do.php?_action=qar_esfa_data&qar_type=' + $('#qar_type_filter').val() + '&level=' + $('#level_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&age_band_type=' + $('#age_band_filter').val() + '&tab=' + tab;
}

function level_filter_onchange(ele) {
    window.location.href = 'do.php?_action=qar_esfa_data&qar_type=' + $('#qar_type_filter').val() + '&best_case=' + $('#best_case_filter').val() + '&level=' + $('#level_filter').val() + '&age_band_type=' + $('#age_band_filter').val() + '&tab=' + tab;
}
