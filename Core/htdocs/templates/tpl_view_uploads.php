...
<body>
<div class="banner">
    <div class="Title"><?php if(DB_NAME=='am_exg') echo "Web Service Uploads"; else echo "Import Learners"; ?></div>
    <div class="ButtonBar">
    </div>
...
<?php if(DB_NAME=='am_demo' || DB_NAME=='ams' || DB_NAME=='am_traintogether' || DB_NAME=='am_doncaster' || DB_NAME=='am_donc_demo' || DB_NAME=='am_siemens') { ?>
<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>?_action=save_import_learners" ENCTYPE="multipart/form-data" id="frm_import_learners">
    <input type="hidden" name="_action" value="save_import_learners" />
    <table border="0" cellpadding="4" cellspacing="4" style="margin-left:10px">
        ...
        <tr>
            ...
            <td><button type="submit" onclick="if(!validateForm(document.getElementById('frm_import_learners'))){return false;} ">Import</Button></td>
        </tr>
    </table>
</form>
<?php }?>
