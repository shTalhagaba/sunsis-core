...
<nav class="navbar navbar-light" role="navigation">
	<div class="container-fluid">
		<div class="page-signin-header bg-white" style="max-height: 150px;">
			...
			?>
			<img src="images/logos/<?php echo $filename; ?>" class="img-responsive center-block"
			...
			<div class="login-box" style="background-color: #fff; padding: 3%;">
				<form style="margin-top: 15px;" role="form" name="login"
					...
					<input type="hidden" name="destination"
					       value="<?php echo (isset($_REQUEST['destination']) ? htmlspecialchars((string)$_REQUEST['destination']) : ''); ?>"/>
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<p>In addition we use contractors and service providers to process your data on our behalf for the purposes
							described in this statement. We contractually require our service providers to adhere to the General Data
