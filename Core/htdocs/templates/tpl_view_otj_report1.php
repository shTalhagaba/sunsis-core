...
<div class="row">
    <div class="col-lg-12">
        <div class="banner">
            <div class="Title" style="margin-left: 6px;">View Otj Report</div>
            <div class="ButtonBar">
            ...
            <div class="ActionIconBar">
                ...
                <span class="btn btn-sm btn-info fa fa-file-excel-o" onclick="window.location.href='do.php?_action=view_otj_report1&subaction=export_csv'" title="Export to .CSV file"></span>
    ...
    <div class="row">
        <div id="div_filters" style="display:none">
            <form method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>" id="applyFilter" name="applyFilter">
                ...
                <input type="hidden" name="_action" value="view_otj_report1" />

                <div id="filterBox" class="clearfix small">
                    <fieldset>
                        <legend>General</legend>
                        <div class="field float"><label>Status:</label><?php echo $view->getFilterHTML('filter_status_code'); ?></div>
...
<script language="JavaScript">
    ...
    function show_graphs()
    {
        ...
        myForm.elements['_action'].value = 'view_otj_report1';
        myForm.submit();
    }
