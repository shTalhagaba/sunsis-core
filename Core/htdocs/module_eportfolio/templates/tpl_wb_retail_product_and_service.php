<?php /* @var $wb WBRetailProductAndService */ ?>
<!DOCTYPE html>
...
<input type="hidden" name="_action" value="save_wb_retail_product_and_service" />
	...
	<div class="row">
		<div class="col-2m-12 table-responsive">
			<table class="table table-bordered table-striped">
				...
				<?php
				$items = WBRetailProductAndService::getLearningJourneyItems();
				$j = 0;
				foreach($items AS $i)
				{
					$key = 'DC'.++$j;
...
<div class="step-content">
	...
	<div class="row">
		<div class="col-sm-12" <?php echo $feedback->ProductAndService->Status->__toString() == 'A'?'style="pointer-events:none;"':''; ?>>
			...
			<p class="text-bold"><img src="module_eportfolio/assets/images/wb2_img1.png" /> &nbsp;What do you think <?php echo ucfirst($wb->savers_or_sp); ?>'s Unique Service Offer (USO) is? Speak to your team to see what they think and make some notes in the box below. </p>
			<textarea name="ProductAndService" rows="5" style="width: 100%;"><?php echo $answers->ProductAndService->__toString(); ?></textarea>
		</div>
	</div>
...
<div class="step-content">
	...
	<div class="row">
		<div class="col-sm-12">
			<p>In Team Superdrug, Vision, Mission and Values is our way to communicate where Superdrug wants to be, both now and in the future.  It also gives us an overview of how we think we can get there.  It is a guide for us all on how we should operate, both individually and as a company, to achieve our goal and to win locally in Beauty and Health.</p>
			<img class="img-responsive center-block" src="module_eportfolio/assets/images/wb_r06_pg4_img1.png" /><p><br></p>
			<img class="img-responsive center-block" src="module_eportfolio/assets/images/wb_r06_pg4_img2.png" /><p><br></p>
			<img class="img-responsive center-block" src="module_eportfolio/assets/images/wb_r06_pg4_img3.png" /><p><br></p>
		</div>
	</div>
	<p><br></p>
	<?php echo $wb->getPageTopLine(); ?>
...
<div class="row">
	<div class="col-sm-6">
		<p class="text-bold">Team members</p>
		<ul style="margin-left: 15px; margin-bottom: 10px;">
			<li>Have their own role to play in the work of the team</li>
			<li>Must work towards the common goals of the team</li>
		</ul>
	</div>
	<div class="col-sm-6">
		<div style="border: #000000 solid 2px; padding: 15px;" class="bg-light-blue text-center">
			<p>Team</p>
			<p>A team can be described as a group of people with the skills required to undertake a task or a project.</p>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-sm-6">
		<div style="border: #add8e6 solid 3px; padding: 15px;" class="text-center">
			<p>Teamwork</p>
			<p>Teamwork is the way that workers operate as team members not just as individuals.</p>
		</div>
	</div>
	<div class="col-sm-6">
		<p>This involves taking responsibility for your own tasks whilst:</p>
		<p class="text-bold">Considering the needs of other team members</p>
		<p>Communicating effectively with the rest of the team Giving help and asking for help when there are difficulties
		</p>
	</div>
</div>
<div class="row">
	<div class="col-sm-12">
		<p><span class="text-bold"> Teamwork </span>is essential to the efficient running of retail businesses. One person cannot manage all the tasks required and numbers of people pulling in different directions will not work effectively</p>
		<p class="text-bold"><img src="module_eportfolio/assets/images/wb2_img1.png" /> &nbsp;Complete the activity below, to show what you think are the benefits of teamwork</p>
		<img class="img-responsive center-block" src="module_eportfolio/assets/images/wb_r06_pg5_img1.png" /><p><br></p>
	</div>
</div>
<div class="row">
	...
	<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 text-center">
		<p><textarea name="PreparingToDeliverQuestion5" style="width: 100%;"><?php echo $answers->PreparingToDeliver->Question5->__toString(); ?></textarea></p>
	</div>
</div>
<div class="row">
	<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 text-center">
	...
	<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 text-center">
		<p><textarea name="PreparingToDeliverQuestion6" style="width: 100%;"><?php echo $answers->PreparingToDeliver->Question6->__toString(); ?></textarea></p>
	</div>
</div>
...
<div class="row">
	<div class="col-sm-12"  <?php echo $feedback->PreparingToDeliver->Status->__toString() == 'A'?'style="pointer-events:none;"':''; ?>>
		...
		<div class="row">
			...
			<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 text-center">
				<p><textarea name="PreparingToDeliverQuestion1" style="width: 100%;"><?php echo $answers->PreparingToDeliver->Question1->__toString(); ?></textarea></p>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 text-center">
			...
			<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 text-center">
				<p><textarea name="PreparingToDeliverQuestion2" style="width: 100%;"><?php echo $answers->PreparingToDeliver->Question2->__toString(); ?></textarea></p>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 text-center">
			...
			<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 text-center">
				<p><textarea name="PreparingToDeliverQuestion3" style="width: 100%;"><?php echo $answers->PreparingToDeliver->Question3->__toString(); ?></textarea></p>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 text-center">
			...
			<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 text-center">
				<p><textarea name="PreparingToDeliverQuestion4" style="width: 100%;"><?php echo $answers->PreparingToDeliver->Question4->__toString(); ?></textarea></p>
			</div>
		</div>
	</div>
</div>
<div class="row">
	...
	<div class="col-sm-6" <?php echo $feedback->PreparingToDeliver->Status->__toString() == 'A'?'style="pointer-events:none;"':''; ?>>
		...
		<textarea name="OtherSkills" rows="5" style="width: 100%; "><?php echo $answers->PreparingToDeliver->OtherSkills->__toString(); ?></textarea>
	</div>
	<div class="col-sm-12">
...
<div class="step-content">
	...
	<div class="row">
		<div class="col-sm-12" <?php echo $feedback->KnowingYourProducts->Status->__toString() == 'A'?'style="pointer-events:none;"':''; ?>>
			...
			<p class="text-bold"><img src="module_eportfolio/assets/images/wb2_img1.png" /> &nbsp;What are the names of any in store magazines or resources that you have access to which can help you with your product knowledge? </p>
			<textarea name="KnowingYourProducts" rows="5" style="width: 100%; "><?php echo $answers->KnowingYourProducts->__toString(); ?></textarea>
...
<div class="step-content">
	...
	<div class="row">
		...
		<div class="col-sm-12" <?php echo $feedback->FeaturesAndBenefits->Status->__toString() == 'A'?'style="pointer-events:none;"':''; ?>>
			...
			<?php $departments = WBRetailProductAndService::getDepartmentsList(); ?>
			<div class="table-responsive">
				<table class="table table-bordered text-center">
					...
					{
						echo '<tr>';
						if($wb->savers_or_sp == 'savers' && $d == 'Electricals')
							echo '<th>Household</th>';
						else
							echo '<th>' . $d . '</th>';
						...
						echo '<td><textarea name="' . $d . '_Product" style="width: 100%;">' . $answers->FeaturesAndBenefits->$d->Product->__toString() . '</textarea></td>';
						echo '<td><textarea name="' . $d . '_Feature" style="width: 100%;">' . $answers->FeaturesAndBenefits->$d->Feature->__toString() . '</textarea></td>';
						echo '<td><textarea name="' . $d . '_Benefit" style="width: 100%;">' . $answers->FeaturesAndBenefits->$d->Benefit->__toString() . '</textarea></td>';
						echo '</tr>';
					}
					?>
				</table>
...
<div class="step-content">
	...
	<div class="row">
		...
		<div class="col-sm-6">
			...
			<textarea rows="7" name="CurrentStartBuysOffers" style="width: 100%;"><?php echo $answers->ActiveLinkSelling->CurrentStartBuysOffers->__toString(); ?></textarea>
...
<div class="step-content">
		...
		<div class="col-sm-12" <?php echo $feedback->IdentifyingCustomerNeeds->Status->__toString() == 'A'?'style="pointer-events:none;"':''; ?>>
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					$i = 0;
					foreach(WBRetailProductAndService::getClosedOpenProbingQuestionsList() AS $q)
					{
						echo '<tr>';
						if($wb->savers_or_sp == 'savers' && $q == 'Have you seen our Star Buys this week?')
							echo '<td>Have you seen razor packs are on offer this week?</td>';
						else
							echo '<td>' . $q . '</td>';
						$key = 'Question'.++$i;
			...
			<textarea name="OpenQuestionKeyWords" rows="5" style="width: 100%;"><?php echo $IdentifyingCustomerNeeds->OpenQuestionKeyWords->__toString(); ?></textarea>
		</div>
	</div>
	...
	<div class="row" <?php echo $feedback->IdentifyingCustomerNeeds->Status->__toString() == 'A'?'style="pointer-events:none;"':''; ?>>
		...
		<div class="col-sm-6">
			...
			<textarea name="ExampleAskingQuestions" rows="5" style="width: 100%;"><?php echo $IdentifyingCustomerNeeds->ExampleAskingQuestions->__toString(); ?></textarea>
			...
			<textarea name="ExampleToDoBetter" rows="5" style="width: 100%;"><?php echo $IdentifyingCustomerNeeds->ExampleToDoBetter->__toString(); ?></textarea>
		</div>
		<div class="col-sm-6">
			<p class="text-bold">
			...
			<textarea name="IncorrectQuestionResult" rows="5" style="width: 100%;"><?php echo $IdentifyingCustomerNeeds->IncorrectQuestionResult->__toString(); ?></textarea>
...
<div class="step-content">
	...
	<div class="row">
		<div class="col-sm-12" <?php echo $feedback->ExcellentService->Status->__toString() == 'A'?'style="pointer-events:none;"':''; ?>>
			...
			<textarea name="ExcellentService" rows="5" style="width: 100%;"><?php echo $answers->ExcellentService->__toString(); ?></textarea>
		</div>
	</div>
	<div class="row">
...
<div class="step-content">
	...
	<div class="row">
		<div class="col-sm-12">
			<p class="text-bold">Customer feedback</p>
			<p>Customers' needs and expectations should be at the heart of any changes and improvements to customer service. </p>
			<img class="img-responsive pull-right" src="module_eportfolio/assets/images/wb4_pg1_img1.png" /><p><br></p>
			<p class="text-bold">You can do this in two main ways:</p>
			<ul style="margin-left: 15px; margin-bottom: 10px;">
				<li>By receiving and recording unsolicited feedback</li>
				<li>By gathering solicited feedback and unsolicited feedback</li>
			</ul>
			<p class="text-bold">When feedback is unsolicited it means that it has not been asked for. </p>
			<ul style="margin-left: 15px; margin-bottom: 10px;">
				...
				<li>Things you have overheard</li>
			</ul>
			<p>One of the main benefits of unsolicited feedback is that customers tell you about the things that are important to them. These may not be the areas you would question them about if you were asking for feedback. </p>
			<p><span class="text-bold">Solicited feedback </span>is the feedback that customers have been asked to provide. It may be gathered using surveys and questionnaires. Retailers decide what they want customers to tell them about. They often ask customers to rate aspects of service (from poor to very good). The results are collated to give a cross section of opinions. The combined feedback can be used to influence future decisions.</p>
			<p class="text-bold">Customer complaints</p>
			<p>All retail businesses receive complaints from customers from time to time. Complaints are an example of unsolicited feedback and should be welcomed by retailers as a means to develop relationships with customers and increase customer loyalty. </p>
			<p><img class="pull-right img-responsive" src="module_eportfolio/assets/images/wb3_pg13_img1.png" /></p>
			<p class="text-bold">In most retail businesses complaints will fall into one of three categories.</p>
			<p>Complaints about:</p>
			<ul style="margin-left: 15px; margin-bottom: 10px;">
			...
			<div class="row well">
				...
				<div class="pull-left col-lg-6 col-md-4 col-sm-4 col-xs-4 text-center">
					<div class="row">
						...
						<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 text-center">
							<p><textarea name="DealConflictQ1" rows="4" style="width: 100%;"><?php echo $answers->DealConflict->Question1->__toString(); ?></textarea></p>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 text-center">
						...
						<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 text-center">
							<p><textarea name="DealConflictQ2" rows="4" style="width: 100%;"><?php echo $answers->DealConflict->Question2->__toString(); ?></textarea></p>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 text-center">
						...
						<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 text-center">
							<p><textarea name="DealConflictQ3" rows="4" style="width: 100%;"><?php echo $answers->DealConflict->Question3->__toString(); ?></textarea></p>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 text-center">
						...
						<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 text-center">
							<p><textarea name="DealConflictQ4" rows="4" style="width: 100%;"><?php echo $answers->DealConflict->Question4->__toString(); ?></textarea></p>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 text-center">
						...
						<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 text-center">
							<p><textarea name="DealConflictQ5" rows="4" style="width: 100%;"><?php echo $answers->DealConflict->Question5->__toString(); ?></textarea></p>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 text-center">
						...
						<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 text-center">
							<p><textarea name="DealConflictQ6" rows="4" style="width: 100%;"><?php echo $answers->DealConflict->Question6->__toString(); ?></textarea></p>
						</div>
					</div>
				</div>
			</div>
...
<div class="step-content">
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<p class="text-bold">Key points</p>
			<ul style="margin-left: 15px; margin-bottom: 15px;">
				<li>Customer satisfaction occurs when customer needs and expectations are met or exceeded</li>
				<li>Customers are individuals and treating them as such enhances their experience and loyalty</li>
				<li>It is important to know what your authority levels are and who to escalate a problem to</li>
			</ul>
			<p>Having varied methods to measure how effectively you are at delivering customer service is important. If a customer receives good service they are likely to tell 2 to 3 other people. If they receive poor service they are likely to tell 10 to 12 others.s</p>
		</div>
	</div>
	<p><br></p>
	<div class="row"><div class="col-sm-12"><div class="pull-right"><?php echo HTML::renderWorkbookIcons('', true); ?></div></div></div>
...
<div class="step-content">
	...
	<div class="row">
		<div class="col-sm-12">
			<p class="text-bold"><img src="module_eportfolio/assets/images/wb2_pg18_img1.png" /> &nbsp; Ask your manager/mentor for a copy of your latest mystery shop report and save it with this module. Ask them to explain and discuss this with you and then answer the following questions:</p>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-8">
			<p>1. What is the purpose of having a Mystery Shop report?</p>
			<p><textarea rows="4" name="QualificationQuestions1" style="width: 100%;"><?php echo $answers->QualificationQuestions->Question1->__toString(); ?></textarea> </p>
			<p>2. What does the Mystery Shopper do when they visit a store?</p>
			<p><textarea rows="4" name="QualificationQuestions2" style="width: 100%;"><?php echo $answers->QualificationQuestions->Question2->__toString(); ?></textarea> </p>
			<p>3. How often will you get a Mystery Shop visit to your store?</p>
			<p><textarea rows="4" name="QualificationQuestions3" style="width: 100%;"><?php echo $answers->QualificationQuestions->Question3->__toString(); ?></textarea> </p>
			<p>4. What was your last Mystery Shop result?</p>
			<p><textarea rows="4" name="QualificationQuestions4" style="width: 100%;"><?php echo $answers->QualificationQuestions->Question4->__toString(); ?></textarea> </p>
			<p>5. What went well?</p>
			<p><textarea rows="4" name="QualificationQuestions5" style="width: 100%;"><?php echo $answers->QualificationQuestions->Question5->__toString(); ?></textarea> </p>
			<p>6. What didn't go well?</p>
			<p><textarea rows="4" name="QualificationQuestions6" style="width: 100%;"><?php echo $answers->QualificationQuestions->Question6->__toString(); ?></textarea> </p>
			<p>7. What do you and your team need to do to improve or to ensure you keep getting a good score?</p>
			<p><textarea rows="4" name="QualificationQuestions7" style="width: 100%;"><?php echo $answers->QualificationQuestions->Question7->__toString(); ?></textarea> </p>
		</div>
		<div class="col-sm-4">
			<img class="img-responsive center-block" src="module_eportfolio/assets/images/wb3_pg21_img1.png" />
			<img class="img-responsive center-block" src="module_eportfolio/assets/images/wb3_pg20_img1.png" />
			<img class="img-responsive center-block" src="module_eportfolio/assets/images/wb3_pg22_img1.png" />
		</div>
	</div>
...
<div class="step-content">
	...
	<div class="row"><div class="col-sm-12"><div class="pull-right">
		<?php
		if($feedback->QQuestions->Status->__toString() == 'NA')
			echo HTML::renderWorkbookIcons('QQuestions', false, 'btn-danger');
		else
			echo HTML::renderWorkbookIcons('QQuestions', false, 'btn-success');
		?>
	</div></div></div>
	...
	<div class="row">
		<div class="col-sm-12" <?php echo $feedback->QQuestions->Status->__toString() == 'A'?'style="pointer-events:none;"':''; ?>>
			<p class="text-center"><h3 class="text-center text-bold">Qualification questions</h3></p>
			<p class="text-bold">Now you have completed the workbook on Product and Service please answer the following questions:</p>
			<p class="text-bold">Unit 1 - 3.1: Identify how customer feedback can be obtained</p>
			<textarea name="QQuestion1" rows="7" style="width: 100%;"><?php echo $answers->QQuestions->QQuestion1->__toString(); ?></textarea>
			<p class="text-bold">Unit 1 - 3.2: Describe how customer feedback can help to improve own quality of service provision</p>
			<textarea name="QQuestion2" rows="7" style="width: 100%;"><?php echo $answers->QQuestions->QQuestion2->__toString(); ?></textarea>
		</div>
	</div>
	...
	<div class="row well">
		<div class="col-sm-12">
			<div class="box box-success box-solid">
				<div class="box-header with-border"><h3 class="box-title">Assessor Feedback</h3></div>
				<div class="box-body assessorFeedback" <?php echo $feedback->QQuestions->Status->__toString() == 'A'?'style="pointer-events:none;"':''; ?>>
					<div class="form-group">
						<label for="status_QQuestions" class="col-sm-12 control-label">Status:</label>
						<div class="col-sm-12">
							<?php
							echo HTML::selectChosen('status_QQuestions', $answer_status, $feedback->QQuestions->Status->__toString() == 'A'?$feedback->QQuestions->Status->__toString():'', false, true); ?>
						</div>
					</div>
					<div class="form-group">
						<label for="comments_QQuestions" class="col-sm-12 control-label">Comments:</label>
						<div class="col-sm-12">
							<textarea name="comments_QQuestions" rows="7" style="width: 100%;"><?php echo $feedback->QQuestions->Comments->__toString(); ?></textarea>
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	...
	function partialSave()
	{
		...
		$.ajax({
			type:'POST',
			url:'do.php?_action=save_wb_retail_product_and_service',
