<?php /* @var $wb WBMeetingRegulationsAndLegislation */ ?>
...
<head>
	...
	<title>Meeting regulations and legislation</title>
...
<form name="frm_wb_meeting_regulations_and_legislation" id="frm_wb_meeting_regulations_and_legislation" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
<input type="hidden" name="_action" value="save_wb_meeting_regulations_and_legislation" />
...
<?php echo $wb->savers_or_sp == 'savers' ? '<section class="content-header"><h1 style="color: #0000ff;">Meeting regulations <span class="text-red">&</span> legislation</h1></section>' : '<section class="content-header"><h1>Meeting regulations & legislation</h1></section>' ?>

<section class="content">

<div id="wizard">

<h1>Meeting regulations and legislation</h1>
<div class="step-content">
	<?php echo $wb->getPageTopLine(); ?>
	<div style="position: absolute; top: 40%; right: 50%;" class="lead">
		<?php echo $wb->savers_or_sp == 'savers' ? '<h2 class="text-bold" style="color: #0000ff;">Meeting regulations <span class="text-red">&</span> legislation</h2>' : '<h2 class="text-bold">Meeting regulations & legislation</h2>' ?>
		<p class="text-center" >Module 11</p>
	</div>
...
<div class="step-content">
	...
	<div class="row">
		<div class="col-sm-12">
			<p><b>This module is about meeting regulations & legislation in the workplace and what you need to know and do. When working in retail it is important to ensure that you are familiar with and adhere to the policies and procedures that exist within the organisation.</b></p>
			<p><b>Organisations and individuals that work for them must operate within these frameworks to ensure the brand promise and service offer are delivered as well as ensuring all legal and ethical needs are met.</b></p>
			<p><b>In this module you will look at:</b></p>
			<ul style="margin-left: 15px; margin-bottom: 15px;">
				<li>Your own regulations and legislation training</li>
				<li>Definition of Regulations and Legislation</li>
				<li>Consumer Rights Act</li>
				<li>Consumer Protection from Unfair Trading Regulations</li>
				<li>The Consumer Credit Act</li>
				<li>The Data Protection Act</li>
				<li>Weights and Measures Act</li>
				<li>The Consumer Contracts Regulations</li>
				<li>Licensing laws</li>
				<li>Age related legislation</li>
				<li>Health and Safety at Work Act</li>
				<li>Security legislation</li>
				<li>Emergencies</li>
				<li>Legal and commercial implications of contravening legislation</li>
			</ul>
		</div>
		<div class="col-sm-12">
			<img src="module_eportfolio/assets/images/wb11_pg2_img1.png" />
		</div>
	</div>
...
<div class="step-content">
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="row">
				<div class="col-sm-12 table-responsive">
					<table class="table table-bordered table-striped">
						...
						<?php
						//$items = WBMeetingRegulationsAndLegislation::getLearningJourneyItems();
			...
			<p><br></p>
			<p>All retail businesses develop their own policies and procedures. This is to help ensure that they remain legally compliant. In <?php echo ucfirst($wb->savers_or_sp); ?> you can find the full list of policies and procedures in the big red book that is usually found in the staffroom. This manual contains information on the company policies such as breaks, holiday and maternity leave to name a few.</p>
			...
			<p>In order to make yourself aware of these requirements, refer to the latest manual either in store or on the Hub. Ask your manager for guidance on any legal and ethical requirements which may apply. There are a range of legal requirements that have an impact on the delivery of customer service. The main pieces of legislation include: Health and Safety, Consumer Rights Act and Data Protection</p>
			<p class="text-center"><img src="module_eportfolio/assets/images/wb11_pg3_img1.png" /></p>
		</div>
	</div>
...
<div class="step-content">
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="pull-left" style="margin: 30px; border: #adff2f 3px solid; padding: 15px;">
				<p class="text-center text-bold">Regulations</p>
				<p class="text-center">A rule or directive made and maintained by an authority</p>
			</div>
			<div class="pull-left" style="margin: 30px; border: #adff2f 3px solid; padding: 15px;">
				<p class="text-center text-bold">Legislation</p>
				<p class="text-center">Law or set of laws suggested by a government and made official by a parliament</p>
			</div>
			...
			<div>
				<p>The Consumer Rights Act 2015 became law on 01 October 2015, replacing three major pieces of consumer legislation - the Sale of Goods Act, Unfair Terms in Consumer Contracts Regulations and the Supply of Goods and Services Act.</p>
		...
		<div class="col-sm-12" <?php echo $feedback->Scenarios->Status->__toString() == 'A'?'style="pointer-events:none;"':''; ?>>
			<table class="table">
				...
				<tr>
					...
					<td><textarea name="Scenario1" rows="5" style="width: 100%;"><?php echo $answers->Scenarios->Scenario1->__toString(); ?></textarea> </td>
				</tr>
				<tr>
					...
					<td><textarea name="Scenario2" rows="5" style="width: 100%;"><?php echo $answers->Scenarios->Scenario2->__toString(); ?></textarea> </td>
				</tr>
			</table>
		</div>
	</div>
		...
		<div class="col-sm-12">
			...
			<table class="table">
				<tr>
					...
					<td><img class="pull-right" src="module_eportfolio/assets/images/wb2_img2.png" /></td>
				</tr>
			</table>
...
<div class="step-content">
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<p class="text-bold text-center">NB: The Data Protection Act 1998 has been updated and the new General Data Protection Regulation (GDPR) applies in the UK since 25 May 2018. Go to <a href="https://ico.org.uk/" target="_blank">https://ico.org.uk/</a> for more information.</p>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-sm-12" <?php echo $feedback->DataProtectionAct->Status->__toString() == 'A'?'style="pointer-events:none;"':''; ?>>
			...
			<textarea name="DPAWhatInfo" rows="5" style="width: 100%;"><?php echo $answers->DataProtectionAct->WhatInfo->__toString(); ?></textarea>
			<p class="text-bold"><img class="pull-left" src="module_eportfolio/assets/images/wb2_img1.png" /> &nbsp; What are your responsibilities for keeping information confidential? Think about customers, colleagues and company information.</p>
			<textarea name="DPAHowToKeepInfo" rows="5" style="width: 100%;"><?php echo $answers->DataProtectionAct->HowToKeepInfo->__toString(); ?></textarea>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<p><textarea <?php echo $feedback->DataProtectionAct->Status->__toString() == 'A'?'style="pointer-events:none;"':''; ?> name="DPAAdminFee" style="width: 100%;"><?php echo $answers->DataProtectionAct->AdminFee->__toString(); ?></textarea></p>
	...
	<div class="col-sm-12">
		<div class="table-responsive">
			<table class="table" <?php echo $feedback->WeightsAndMeasuresAct->Status->__toString() == 'A'?'style="pointer-events:none;"':''; ?>>
				<tr><td colspan="2"><div style="padding: 15px; border: #adff2f 2px solid;"><p class="text-center text-bold">Weights and Measures Act 1985?</p><p class="text-center">An act to consolidate certain enactments relating to weights and measures</p> </div></td></tr>
...
<div class="step-content">
	...
	<div class="row"><div class="col-sm-12"><div class="pull-right">
		<?php
		if($feedback->ConsumerContractsRegulations->Status->__toString() == 'NA')
			echo HTML::renderWorkbookIcons('ConsumerContractsRegulations', false, 'btn-danger');
		else
			echo HTML::renderWorkbookIcons('ConsumerContractsRegulations', false, 'btn-success');
		?>
	</div></div></div>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="table-responsive">
				<table class="table" <?php echo $feedback->ConsumerContractsRegulations->Status->__toString() == 'A'?'style="pointer-events:none;"':''; ?>>
					<tr><td colspan="2"><div style="padding: 15px; border: #adff2f 2px solid;"><p class="text-center text-bold">The Consumer Contracts Regulations 2013</p><p class="text-bold text-center">Gives you rights when shopping online so you are covered if things go wrong</p> </div></td></tr>
					<tr><td colspan="2" align="center" class="text-center"><img src="module_eportfolio/assets/images/wb11_img1.png" /></td></tr>
					<tr><td colspan="2" align="center" class="text-center"><div style="background-color: #adff2f; padding: 5px; border: #000000 solid 2px;"><p class="text-bold">What did you find out about this Act?</p><p class="text-bold">What type of business would it apply to?</p></div> </td></tr>
					<tr><td colspan="2" align="center" class="text-center"><img src="module_eportfolio/assets/images/wb11_img1.png" /></td></tr>
					<tr><td colspan="2" align="center" class="text-center"><textarea rows="6" name="CCRInformation" style="width: 100%;"><?php echo $answers->ConsumerContractsRegulations->Information->__toString(); ?></textarea> </td></tr>
					<tr><td align="center" class="text-center"><img src="module_eportfolio/assets/images/wb11_img1.png" /></td><td align="center" class="text-center"><img src="module_eportfolio/assets/images/wb11_img1.png" /></td></tr>
					<tr><td align="center" class="text-center text-bold"><div style="background-color: #adff2f; padding: 5px; border: #000000 solid 2px;">How does it protect consumers?</div> </td><td align="center" class="text-center text-bold"><div style="background-color: #adff2f; padding: 5px; border: #000000 solid 2px;">How does it impact a business?</div> </td></tr>
					<tr><td align="center" class="text-center"><img src="module_eportfolio/assets/images/wb11_img1.png" /></td><td align="center" class="text-center"><img src="module_eportfolio/assets/images/wb11_img1.png" /></td></tr>
					<tr><td align="center"><textarea name="CCRHowProtect" style="width: 100%;" rows="9"><?php echo $answers->ConsumerContractsRegulations->HowProtect->__toString(); ?></textarea> </td><td align="center"><textarea name="CCRHowImpact" style="width: 100%;" rows="9"><?php echo $answers->ConsumerContractsRegulations->HowImpact->__toString(); ?></textarea> </td></tr>
				</table>
			</div>
		</div>
	</div>
	...
	<div class="row well">
		<div class="col-sm-12">
			<div class="box box-success box-solid">
				<div class="box-header with-border"><h3 class="box-title">Assessor Feedback</h3></div>
				<div class="box-body assessorFeedback" <?php echo $feedback->ConsumerContractsRegulations->Status->__toString() == 'A'?'style="pointer-events:none;"':''; ?>>
					<div class="form-group">
						<label for="status_ConsumerContractsRegulations" class="col-sm-12 control-label">Status:</label>
						<div class="col-sm-12">
							<?php
							echo HTML::selectChosen('status_ConsumerContractsRegulations', $answer_status, $feedback->ConsumerContractsRegulations->Status->__toString() == 'A'?$feedback->ConsumerContractsRegulations->Status->__toString():'', false, true); ?>
						</div>
					</div>
					<div class="form-group">
						<label for="comments_ConsumerContractsRegulations" class="col-sm-12 control-label">Comments:</label>
						<div class="col-sm-12">
							<textarea name="comments_ConsumerContractsRegulations" rows="7" style="width: 100%;"><?php echo $feedback->ConsumerContractsRegulations->Comments->__toString(); ?></textarea>
						</div>
					</div>
				</div>
			</div>
...
<div class="step-content">
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<p <?php echo $feedback->HealthAndSafetyNotes->Status->__toString() == 'A'?'style="pointer-events:none;"':''; ?>><textarea rows="7" name="HealthAndSafetyNotes" style="width: 100%;"><?php echo $answers->HealthAndSafetyNotes->__toString(); ?></textarea></p>
		...
		<div class="col-sm-12">
			...
			<table class="table" <?php echo $feedback->RiskAssessment->Status->__toString() == 'A'?'style="pointer-events:none;"':''; ?>>
				...
				for($i = 1; $i <= 3; $i++)
				{
					$key = 'Set'.$i;
					echo '<tr>';
					echo '<td><textarea rows="5" name="RA'.$key.'Type" style="width: 100%;">'.$answers->RiskAssessment->InStore->$key->Type->__toString().'</textarea></td>';
					echo '<td><textarea rows="5" name="RA'.$key.'Frequency" style="width: 100%;">'.$answers->RiskAssessment->InStore->$key->Frequency->__toString().'</textarea></td>';
					echo '<td><textarea rows="5" name="RA'.$key.'Impact" style="width: 100%;">'.$answers->RiskAssessment->InStore->$key->Impact->__toString().'</textarea></td>';
					echo '</tr>';
				}
				?>
			</table>
...
<div class="step-content">
	...
	<div class="row">
		...
		<div class="col-sm-6">
			<img class="img-responsive pull-right" src="module_eportfolio/assets/images/wb2_img2.png" />
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="table-responsive">
				...
				<td><textarea rows="5" <?php echo $feedback->HSVideo->Status->__toString() == 'A'?'style="pointer-events:none;"':''; ?> name="RegionalHSContact" style="width: 100%;"><?php echo $answers->HSVideo->RegionalHSContact->__toString(); ?></textarea> </td>
...
<div class="step-content">
	...
	<div class="row">
		<div class="col-sm-6">
			...
			<textarea <?php echo $feedback->SecurityMeasures->Status->__toString() == 'A'?'style="pointer-events:none;"':''; ?> name="OtherMeasuresForProtection" style="width: 100%;"><?php echo $answers->SecurityMeasures->OtherMeasuresForProtection->__toString(); ?></textarea>
		</div>
		<div class="col-sm-6">
...
<div class="step-content">
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<p class="text-bold"><img class="img-responsive pull-left" src="module_eportfolio/assets/images/wb2_img1.png" /> &nbsp; Let’s look at some examples of contravening legislation. For each read the text and then explain what implications this could have on the business and those involved. &nbsp; <img class="img-responsive pull-right" src="module_eportfolio/assets/images/wb2_img2.png" /></p>
		</div>
		<div class="col-sm-12 table-responsive">
	...
	<div class="row">
		<div class="col-sm-12">
			<table class="table table-bordered table-striped">
				...
				<?php
				$records = DAO::getResultset($link, "SELECT * FROM lookup_wb_age_restrictions ORDER BY id", DAO::FETCH_ASSOC);
				foreach($records AS $row)
				{
					echo '<tr>';
					echo '<td>' . $row['goods'] . '</td><td>' . $row['age_restriction'] . '</td>';
					echo '</tr>';
				}
				?>
			</table>
...
<div class="step-content">
	...
	<div class="row">
		<div class="col-sm-12">
			<p class="text-bold"><img class="img-responsive pull-left" src="module_eportfolio/assets/images/wb2_img1.png" /> &nbsp; Below are a number of age restricted products. There are also a number of different penalties if these items are sold to someone underage. Your task is to match them up. &nbsp; <img class="img-responsive pull-right" src="module_eportfolio/assets/images/wb2_img2.png" /></p>
...
<div class="step-content">
	...
	<div class="row">
		<div class="col-sm-12" <?php echo $feedback->QualificationQuestions->Status->__toString() == 'A'?'style="pointer-events:none;"':''; ?>>
			...
			<p><h4 class="text-bold">Unit 4: Meeting regulations and legislation within a customer service environment</h4> </p>
			<p>To achieve learning outcome 1 (Know the legislation and regulatory requirements that affect their organisation) answer the following questions in as much detail as you can.</p>
			<p class="text-bold">Unit 4 – 1.1: Describe legislation and regulatory requirements relevant to own role and organisation</p>
			<textarea name="QQuestion1" rows="10" style="width: 100%;"><?php echo $answers->QualificationQuestions->Question1->__toString(); ?></textarea>
			<p class="text-bold">Unit 4 – 1.2: Explain how the relevant legislation and regulations affect the organisation’s customer service provision</p>
			<textarea name="QQuestion2" rows="10" style="width: 100%;"><?php echo $answers->QualificationQuestions->Question2->__toString(); ?></textarea>
			<p class="text-bold">Unit 4 – 1.3: Explain how a code of practice or ethical standards affects customer service</p>
			<textarea name="QQuestion3" rows="10" style="width: 100%;"><?php echo $answers->QualificationQuestions->Question3->__toString(); ?></textarea>
			<p><br></p>
			<p class="text-bold">To achieve learning outcome 2 (Know how to apply legislation and regulatory requirements when delivering service to customers) answer the following questions in as much detail as you can.</p>
			<p class="text-bold">Unit 4 – 2.1: State your responsibilities for keeping information confidential in the organisation</p>
			<textarea name="QQuestion4" rows="10" style="width: 100%;"><?php echo $answers->QualificationQuestions->Question4->__toString(); ?></textarea>
			<p class="text-bold">Unit 4 – 2.2: State the responsibilities of employers and employees under the Health and Safety at Work Act</p>
			<textarea name="QQuestion5" rows="10" style="width: 100%;"><?php echo $answers->QualificationQuestions->Question5->__toString(); ?></textarea>
			<p class="text-bold">Unit 4 – 2.3: Explain how to apply legislation and regulatory requirements relevant to <?php echo ucfirst($wb->savers_or_sp); ?> or your role when delivering service to customers</p>
			<textarea name="QQuestion6" rows="10" style="width: 100%;"><?php echo $answers->QualificationQuestions->Question6->__toString(); ?></textarea>
			<p class="text-bold">Unit 4 – 2.4: State the potential impact on <?php echo ucfirst($wb->savers_or_sp); ?> if it fails to adhere to each of the relevant regulations</p>
			<textarea name="QQuestion7" rows="10" style="width: 100%;"><?php echo $answers->QualificationQuestions->Question7->__toString(); ?></textarea>
		</div>
	</div>
	...
	<?php echo $wb->getPageBottomLine(); ?>
</div> <!--.page 33, 34, 35, half 36 ends-->
...
<div class="step-content">
	...
	<div class="row">
		<div class="col-sm-12 table-responsive">
			<table class="table"  <?php echo $_SESSION['user']->type == User::TYPE_LEARNER || !$wb->enableForUser() ?'style="pointer-events:none;"':''; ?>>
				<?php
				$criteria_met = explode(',', $wb->wb_content->CriteriaMet->__toString());
				?>
				<tr><th>Amplification / Indicative content</th><th>Criteria met?</th></tr>
				<tr>
					<td>
						<p>1.1 – Learners must be able to give information about the most common legislation and regulations that affect them directly in their work roles. Learners must show how they are expected to work in line with the:</p>
						<ul style="margin-left: 15px; margin-bottom: 15px;">
							<li>Consumer Rights Act 2015</li>
							<li>Data Protection</li>
							<li>Equality and Diversity</li>
							<li>Consumer Contracts Regulations</li>
							<li>Consumer Credit Act</li>
							<li>Health and Safety</li>
						</ul>
						<p>These may vary depending on the requirements of the organisation which may also have to adhere to specific procedures</p>
					</td>
					<td>
				...
				<tr>
					<td>
						<p>1.2 – Learners are expected to show a basic understanding of how each of the above legislation affect the organisation’s customer service provision</p>
					</td>
					<td>
						<input class="clsCriteriaMet" name="CriteriaMet[]" type="checkbox" value="2" <?php echo in_array(1, $criteria_met) ? 'checked="checked"' : ''; ?> />
					</td>
				</tr>
				<tr>
					<td>
						<p>2.2 – Learners must ensure that both employer and employee responsibilities are covered</p>
					</td>
					<td>
						<input class="clsCriteriaMet" name="CriteriaMet[]" type="checkbox" value="3" <?php echo in_array(1, $criteria_met) ? 'checked="checked"' : ''; ?> />
					</td>
				</tr>
			</table>
		</div>
	...
	<?php echo $wb->getPageBottomLine(); ?>
</div> <!--.page other half of 36 ends-->
...
<script type="text/javascript">
	...
	<?php if($disable_answers){?>
		...
		$("#frm_wb_meeting_regulations_and_legislation :input").not(".clsCriteriaMet, .assessorFeedback :input, #signature_text, #frm_wb_meeting_regulations_and_legislation :input[type=hidden], .btnViewSectionHistory, .btnViewAssessorComments, #iv_status, #iv_comments, #reopen_comments").prop("disabled", true);
	...
	<?php } ?>
		...
		$("#wizard").steps({
			...
			onStepChanging:function (event, currentIndex, newIndex) {
				if(currentIndex == 21)
				{
					...
					if(fileName != '')
					{
						alert('Please click on "Upload File" button to upload Floor Plan evidence');
						return false;
					}
				}
				return true;
			...
			<?php if($_SESSION['user']->type == User::TYPE_LEARNER){ ?>
				...
				$('<div></div>').html('Are you sure, you want to save this workbook as COMPLETED and send it to your assessor?').dialog({
					...
					buttons:{
						"Yes":function () {
							var myForm = document.forms['frm_wb_meeting_regulations_and_legislation'];
		...
		$('input[type=checkbox]').iCheck({checkboxClass: 'icheckbox_flat-green'});
	});
	...
	function uploadFloorPlanEvidence()
	{
		...
		$('#frm_wb_meeting_regulations_and_legislation').submit();

	}

	function partialSave()
	{
		$('#frm_wb_meeting_regulations_and_legislation :input[name=full_save]').val('N');
		$($('#frm_wb_meeting_regulations_and_legislation').serializeArray()).each(function(i, field)
		{
			document.forms["frm_wb_meeting_regulations_and_legislation"].elements[field.name].value = field.value.replace(/£/g, "GBP");
		});
		$.ajax({
			type:'POST',
			url:'do.php?_action=save_wb_meeting_regulations_and_legislation',
			data: $('#frm_wb_meeting_regulations_and_legislation').serialize(),
			async: false,
			beforeSend: function(){
			...
			success: function(data, status, xhr) {
				...
				{
					$('#frm_wb_meeting_regulations_and_legislation').sisyphus().manuallyReleaseData();
...
<script>
	...
	$( function() {
		$( "#frm_wb_meeting_regulations_and_legislation" ).sisyphus({
			customKeySuffix: "<?php echo $wb->id; ?>",
			autoRelease: true,
			onRestore: function(){
				$.post('do.php?_action=save_wb_meeting_regulations_and_legislation',$('#frm_wb_meeting_regulations_and_legislation').serialize(),function(data, status, xhr)
				{
					console.log(data);
					console.log(status);
					console.log(xhr);
